...
void ScriptMgr::OnPlayerChat(Player* player, uint32 type, uint32 lang, std::string& msg)
{
	...
	Eluna::getScript()->OnChat(PLAYER_EVENT_ON_CHAT, player, type, lang, msg);
}
...
void ScriptMgr::OnPlayerChat(Player* player, uint32 type, uint32 lang, std::string& msg, Group* group)
{
	...
	Eluna::getScript()->OnChat(PLAYER_EVENT_ON_GROUP_CHAT, player, type, lang, msg, group);
}
...
void ScriptMgr::OnPlayerChat(Player* player, uint32 type, uint32 lang, std::string& msg, Guild* guild)
{
	...
	Eluna::getScript()->OnChat(PLAYER_EVENT_ON_GUILD_CHAT, player, type, lang, msg, guild);
}

void ScriptMgr::OnPlayerChat(Player* player, uint32 type, uint32 lang, std::string& msg, Channel* channel)
{
    FOREACH_SCRIPT(PlayerScript)->OnChat(player, type, lang, msg, channel);
	Eluna::getScript()->OnChat(PLAYER_EVENT_ON_CHANNEL_CHAT, player, type, lang, msg, channel);
}
