-- Add support for Hadronox's event and achievement "Hadronox Denied" based on Trista's work
...
UPDATE `creature_template` SET `ScriptName`='TW_npc_anub_ar_crusher' WHERE `entry` IN (28922); -- Anub'Ar Crusher
UPDATE `creature_template` SET `ScriptName`='TW_npc_anub_ar_champion' WHERE `entry` IN (29117,28924,29096,29062); -- Anub'Ar Champions
UPDATE `creature_template` SET `ScriptName`='TW_npc_anub_ar_necromancer' WHERE `entry` IN (29119,28925,29064,29098); -- Anub'Ar Necromancers
UPDATE `creature_template` SET `ScriptName`='TW_npc_anub_ar_crypt_fiend' WHERE `entry` IN (29118,29051,29063,29097); -- Anub'Ar Crypt Fiends
...
(53035, 'TW_spell_trigger_large_aoi_summon_anubar_champion_periodic'),
(53037, 'TW_spell_trigger_large_aoi_summon_anubar_crypt_fiend_periodic'),
(53036, 'TW_spell_trigger_large_aoi_summon_anubar_necromancer_periodic'),
(53255, 'TW_spell_hadronox_event_check_reset'),
(@WEB_FRONT_DOORS, 'TW_spell_hadronox_web_front_doors'),
(@WEB_SIDE_DOOR, 'TW_spell_hadronox_web_side_door');
...
(4244,11,0,0, 'TW_achievement_hadronox_denied');
