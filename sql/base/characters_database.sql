...
CREATE TABLE `character_stats` (
  ...
  `blockPct` float NOT NULL DEFAULT '0' CHECK (blockPct >= 0),
  `dodgePct` float NOT NULL DEFAULT '0' CHECK (dodgePct >= 0),
  `parryPct` float NOT NULL DEFAULT '0' CHECK (parryPct >= 0),
  `critPct` float NOT NULL DEFAULT '0' CHECK (critPct >= 0),
  `rangedCritPct` float NOT NULL DEFAULT '0' CHECK (rangedCritPct >= 0),
  `spellCritPct` float NOT NULL DEFAULT '0' CHECK (spellCritPct >= 0),
...
CREATE TABLE `item_loot_items` (
  ...
  `follow_rules` tinyint NOT NULL DEFAULT '0' COMMENT 'follow loot rules',
  `ffa` tinyint NOT NULL DEFAULT '0' COMMENT 'free-for-all',
  `blocked` tinyint NOT NULL DEFAULT '0',
  `counted` tinyint NOT NULL DEFAULT '0',
  `under_threshold` tinyint NOT NULL DEFAULT '0',
  `needs_quest` tinyint NOT NULL DEFAULT '0' COMMENT 'quest drop',
