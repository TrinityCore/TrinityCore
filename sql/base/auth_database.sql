...
CREATE TABLE `realmlist` (
  ...
  `gamebuild` int(10) unsigned NOT NULL DEFAULT '22293',
...
INSERT INTO `realmlist` VALUES (1,'Trinity','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,2,1,0,0,22293,2,1);
