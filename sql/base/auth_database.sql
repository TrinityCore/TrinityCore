...
--
-- Table structure for table `packet_limits`
--
...
--
-- Dumping data for table `packet_limits`
--

LOCK TABLES `packet_limits` WRITE;
/*!40000 ALTER TABLE `packet_limits` DISABLE KEYS */;
INSERT INTO `packet_limits` VALUES
...
/*!40000 ALTER TABLE `packet_limits` ENABLE KEYS */;
UNLOCK TABLES;
