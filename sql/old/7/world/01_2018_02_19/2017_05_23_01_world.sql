DELETE FROM `quest_request_items` WHERE `ID` IN (28757,28762,28763,28764,28765,28766,28767,29078,31139,28759,28769,28770,28771,28772,28773,28774,29079,31140,28791,28792,28793,28794,28795,28796,28797,29081,31144,28806,28808,28809,28810,28811,28812,28813,29082);
...
(31139,1,1,0,0,0,0,0,0, 'You''ve bought us a little time, $n, but we''ve got even bigger problems to deal with now.',0),
...
(31140,21,1,5,0,0,0,0,0, 'Excellent work, $n. You''ve turned out to be quite an asset to this garrison. It''s time for you to train!',0),
...
(31145,1,1,1,5,0,0,0,0, 'With your help we have managed to secure the northern and western sectors of Northshire. We still have a rather large contingency of Blackrock orcs to the east and they''ve begun burning down the forest!',0);
...
DELETE FROM `quest_template_addon` WHERE `ID` IN (31139,31140,31143,31144,31145);
INSERT INTO `quest_template_addon` (`ID`,`AllowableClasses`,`PrevQuestID`,`NextQuestID`) VALUES
(31139,512,0,31140),(31140,512,31139,31143),(31143,512,31140,31144),(31144,512,31143,31145),(31145,512,31144,26389);

UPDATE `creature_queststarter` SET `id`=197 WHERE `quest` IN (28780,28784,28785,28786,28787,28788,28789,29080,31143);
...
INSERT INTO `creature_queststarter` (`id`,`quest`) VALUES (197,31140),(823,31144),(823,31145);
