...
INSERT INTO `creature` (`guid`,`id`,`map`,`spawnMask`,`phaseId`,`position_x`,`position_y`,`position_z`,`orientation`,`spawntimesecs`,`spawndist`,`movementtype`,`VerifiedBuild`) VALUES
(@CGUID+0,16218,533,24,169,3527.807,-2952.382,319.3258,3.909538,0,0,0,0),
(@CGUID+1,16218,533,24,169,3487.762,-2911.198,319.4061,3.909538,0,0,0,0);
INSERT INTO `creature_addon` (`guid`,`auras`) VALUES
(@CGUID+0,28109),
(@CGUID+1,28097);

-- tesla coil search trigger range (index 30 is 500 yards)
-- TODO: find a way how to handle it in 6x
...
INSERT INTO `gameobject` (`guid`,`id`,`map`,`spawnMask`,`phaseId`,`position_x`,`position_y`,`position_z`,`orientation`,`rotation0`,`rotation1`,`rotation2`,`rotation3`,`spawntimesecs`,`VerifiedBuild`) VALUES
(@OGUID+0,181477,533,24,169,3527.94,-2952.263,318.8983,3.141593,0,0,-1,0,0,0),
(@OGUID+1,181478,533,24,169,3487.324,-2911.383,318.8983,3.141593,0,0,-1,0,0,0);
