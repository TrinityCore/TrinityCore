...
(1209, '|- %06llu (map #%03u \'%s\' at %s)'),
(1210, 'Failed to teleport you to spawn point %llu for boss \'%s\' (creature #%05u) - are you missing an attunement for map \'%s\'?'),
(1211, 'Teleported you to spawn point for boss \'%s\' (creature #%05u, spawnid %llu)');
