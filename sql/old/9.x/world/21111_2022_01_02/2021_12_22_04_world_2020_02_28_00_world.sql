...
-- 
DELETE FROM `npc_text` WHERE `ID` IN (9680,14230,14645);
INSERT INTO `npc_text` (`ID`,  `Probability0`, `BroadcastTextID0`, `Probability1`, `BroadcastTextID1`, `Probability2`, `BroadcastTextID2`, `Probability3`, `BroadcastTextID3`, `Probability4`, `BroadcastTextID4`) VALUES
(9680, 1, 49959, 1, 49960, 1, 49961, 1, 24535, 1, 24536),
(14230, 1, 33121, 0, 0, 0, 0, 0, 0, 0, 0),
(14645, 1, 35101, 0, 0, 0, 0, 0, 0, 0, 0);
