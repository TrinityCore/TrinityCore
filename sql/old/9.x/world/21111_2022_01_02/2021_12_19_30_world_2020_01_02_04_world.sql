...
(280, 0, 0, "Where is Tirth's assistant?", 2769, 1, 1, 0),
(282, 0, 0, "Where is Tirth's assistant?", 2779, 1, 1, 0),
(434, 0, 0, "Where is Tirth's assistant?", 2779, 1, 1, 0);

DELETE FROM `gossip_menu_option_action` WHERE `MenuID` IN (21211,21212,280,282,434,21217);
