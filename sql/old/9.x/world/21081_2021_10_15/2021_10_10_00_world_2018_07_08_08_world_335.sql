...
(2951,0,0,"How the hell did you get in there to begin with?",6079,1,1,0),
(2994,0,0,"I'm all ears.",6081,1,1,0),
(2995,0,0,"So let me get this straight. You were swimming, nay, doing backstrokes in molten lava with this... this lava suit of yours? Yes? And out of nowhere, this here beast swallowed you whole?",6083,1,1,0),
(2996,0,0,"I must know something: How did you go to the bathroom with that thing on?",6085,1,1,0),
(2997,0,0,"Oh?",6087,1,1,0),
(2998,0,0,"I'll consider that the next time I run into one of these things.",6089,1,1,0),
(2999,0,0,"To Malyfous, I assume.",6092,1,1,0);

DELETE FROM `gossip_menu_option_action` WHERE `MenuId` IN (2951,2994,2995,2996,2997,2998);
