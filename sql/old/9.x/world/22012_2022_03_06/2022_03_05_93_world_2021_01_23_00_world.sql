...
UPDATE `serverside_spell` SET `ProcChance` = 101 WHERE `Id` = 51133;
DELETE FROM `serverside_spell_effect` WHERE `SpellID` IN (51133);
INSERT INTO `serverside_spell_effect` (`SpellID`, `EffectIndex`, `Effect`, `EffectAura`, `EffectMiscValue1`, `ImplicitTarget1`) VALUES
(51133, 0, 6, 56, 28259, 1);
...
UPDATE `serverside_spell` SET `ProcChance` = 101 WHERE `Id` = 52558;
DELETE FROM `serverside_spell_effect` WHERE `SpellID` IN (52558);
INSERT INTO `serverside_spell_effect` (`SpellID`, `EffectIndex`, `Effect`, `EffectAura`, `EffectMiscValue1`, `ImplicitTarget1`) VALUES
(52558, 0, 6, 56, 28853, 1);
