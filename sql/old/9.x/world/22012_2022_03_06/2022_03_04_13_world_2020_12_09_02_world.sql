...
UPDATE `spell_target_position` SET `PositionX` = -208.411, `PositionY` = -263.652, `PositionZ` = 17.169733, `VerifiedBuild` = 15595 WHERE `ID` = 33582;
UPDATE `spell_target_position` SET `PositionX` = -208.411, `PositionY` = -263.652, `PositionZ` = 17.086313, `VerifiedBuild` = 15595 WHERE `ID` = 33566;

-- Copied from portal spells, a - a, b - b and so on
UPDATE `spell_target_position` SET `PositionX` = -261.676, `PositionY` = -297.69, `PositionZ` = 17.087011 WHERE `ID` = 33583;
UPDATE `spell_target_position` SET `PositionX` = -282.272, `PositionY` = -240.432, `PositionZ` = 12.683899 WHERE `ID` = 33584;
UPDATE `spell_target_position` SET `PositionX` = -291.833, `PositionY` = -268.595, `PositionZ` = 12.682546 WHERE `ID` = 33585;
UPDATE `spell_target_position` SET `PositionX` = -303.966, `PositionY` = -255.759, `PositionZ` = 12.683405 WHERE `ID` = 33586;

DELETE FROM `spell_target_position` WHERE `ID` IN (33614,33615,33567,33616);
INSERT INTO `spell_target_position` (`ID`,`EffectIndex`,`MapID`,`PositionX`,`PositionY`,`PositionZ`,`VerifiedBuild`) VALUES
(33614,1,555,-261.676,-297.69,17.087011,15595),
(33615,2,555,-282.272,-240.432,12.683899,15595),
(33567,0,555,-291.833,-268.595,12.682546,15595),
(33616,1,555,-303.966,-255.759,12.683405,15595);
