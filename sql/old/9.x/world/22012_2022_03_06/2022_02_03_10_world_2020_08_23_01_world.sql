...
(SELECT (
        CASE
            ...
            WHEN `SourceTypeOrReferenceId` = 28 THEN 'CONDITION_SOURCE_TYPE_AREATRIGGER'
            WHEN `SourceTypeOrReferenceId` = 29 THEN 'CONDITION_SOURCE_TYPE_CONVERSATION_LINE'
            WHEN `SourceTypeOrReferenceId` = 30 THEN 'CONDITION_SOURCE_TYPE_AREATRIGGER_CLIENT_TRIGGERED'
            WHEN `SourceTypeOrReferenceId` = 31 THEN 'CONDITION_SOURCE_TYPE_TRAINER_SPELL'
            WHEN `SourceTypeOrReferenceId` = 32 THEN 'CONDITION_SOURCE_TYPE_OBJECT_ID_VISIBILITY'
    ...
    (
        CASE
            ...
            WHEN `SourceTypeOrReferenceId` = 31 THEN 'CONDITION_OBJECT_ENTRY_GUID_LEGACY'
            WHEN `SourceTypeOrReferenceId` = 32 THEN 'CONDITION_TYPE_MASK_LEGACY'
            ...
            WHEN `SourceTypeOrReferenceId` = 51 THEN 'CONDITION_OBJECT_ENTRY_GUID'
            WHEN `SourceTypeOrReferenceId` = 52 THEN 'CONDITION_TYPE_MASK'
