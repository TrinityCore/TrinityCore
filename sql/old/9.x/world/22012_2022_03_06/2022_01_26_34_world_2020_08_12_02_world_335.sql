...
-- Applied modern expansion nerfs
...
UPDATE `creature_template` SET `mingold` = 25*100*100, `maxgold` = 30*100*100 WHERE `entry` = 19516;
...
UPDATE `creature_template` SET `mingold` = 20*100*100, `maxgold` = 25*100*100 WHERE `entry` = 18805;
...
UPDATE `creature_template` SET `mingold` = 30*100*100, `maxgold` = 35*100*100 WHERE `entry` = 19514;
...
UPDATE `creature_template` SET `mingold` = 30*100*100, `maxgold` = 35*100*100 WHERE `entry` = 19622;

-- SSC
UPDATE `creature_template` SET `mingold` = 25*100*100, `maxgold` = 30*100*100 WHERE `entry` IN (21213,21214,21215,21216,21217);
UPDATE `creature_template` SET `mingold` = 75*100*100, `maxgold` = 85*100*100 WHERE `entry` = 21212;
-- Hyjal
UPDATE `creature_template` SET `mingold` = 35*100*100, `maxgold` = 40*100*100 WHERE `entry` IN (17767,17808,17888,17842);
UPDATE `creature_template` SET `mingold` = 50*100*100, `maxgold` = 55*100*100 WHERE `entry` = 17968;
...
UPDATE `creature_template` SET `mingold` = 20*100*100, `maxgold` = 25*100*100 WHERE `entry` = 17257;
...
-- Pretty unrealistic
UPDATE `creature_template` SET `mingold` = 5*100*100, `maxgold` = 10*100*100 WHERE `entry` = 18831;
...
UPDATE `creature_template` SET `mingold` = 10*100*100, `maxgold` = 15*100*100 WHERE `entry` = 19044;

-- Black Temple
UPDATE `creature_template` SET `mingold` = 30*100*100, `maxgold` = 35*100*100 WHERE `entry` IN (22887,22898,22841,22871,22948,23420,22947);
UPDATE `creature_template` SET `mingold` = 8*100*100, `maxgold` = 10*100*100 WHERE `entry` IN (22949,22950,22951,22952);
UPDATE `creature_template` SET `mingold` = 32*100*100, `maxgold` = 37*100*100 WHERE `entry` = 22917;

-- Sunwell Plateau
UPDATE `creature_template` SET `mingold` = 20*100*100, `maxgold` = 25*100*100 WHERE `entry` IN (24892,24882,25038,25840);
UPDATE `creature_template` SET `mingold` = 40*100*100, `maxgold` = 45*100*100 WHERE `entry` IN (25165,25166);
UPDATE `creature_template` SET `mingold` = 500*100*100, `maxgold` = 55*100*100 WHERE `entry` = 25315;

-- Karazhan
-- Same as in Zul'Aman 34 - 42, Zul'Aman requires no changes
UPDATE `creature_template` SET `mingold` = 4*100*100, `maxgold` = 5*100*100 WHERE `entry` IN (
