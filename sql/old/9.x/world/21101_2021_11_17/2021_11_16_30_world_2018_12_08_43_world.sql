-- 
DELETE FROM `gossip_menu_option` WHERE (`MenuId`=6644 AND `OptionIndex`=1) OR (`MenuId`=6644 AND `OptionIndex`=0);
...
(6644, 1, 0, 'Please teleport me to the final chamber.', 12851, 1, 1, 28153),
-- Needs the Twin Emporers Dead to show. Teleport destination xyzo Mapid: -8971.805, 1321.432, -104.249, 0.845, 531
(6644, 0, 0, 'Teleport me to the lair of the Twin Emperors, please.', 12849, 1, 1, 28153);
...
(6660, 180745, 531, 0, 0, '9', 0, -8660.628, 2022.399, 108.5774, 3.647741, 0, 0, -0.9681473, 0.2503814, 7200, 255, 1, 28153),
(6663, 180745, 531, 0, 0, '9', 0, -8652.204, 2020.923, 108.5774, 0.2443456, 0, 0, 0.1218691, 0.9925462, 7200, 255, 1, 28153), 
(6665, 180745, 531, 0, 0, '9', 0, -8663.34, 2029.898, 108.5774, 4.450591, 0, 0, -0.7933531, 0.6087617, 7200, 255, 1, 28153);
