...
UPDATE `serverside_spell` SET `SpellLevel`=0, `EquippedItemSubClassMask`=0, `SpellFamilyName`=0 WHERE `Id`=12602;
UPDATE `serverside_spell_effect` SET `Effect`=24,`EffectBasePoints`=4,`Variance`=0.5,`EffectAura`=0,`EffectItemType`=34127,`EffectMiscValue1`=0 WHERE `SpellID`=12602 AND `EffectIndex`=0;
