...
UPDATE `spell_dbc` SET `EffectTriggerSpell1` = 0 WHERE `Id` = 30576;

-- Restore original DBC values
UPDATE `spell_dbc` SET `AttributesEx3` = 0, `EffectImplicitTargetA1` = 18, `EffectRadiusIndex1` = 0, `MaxAffectedTargets` = 0, `RangeIndex` = 1 WHERE `Id` = 30630;
