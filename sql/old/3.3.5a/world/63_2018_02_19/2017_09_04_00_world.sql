...
(@GUID, 34014, 603, 0, 0, 2, 1, 0, 0, 1944.99, 35.473570, 411.3606, 2.74932, 604800, 0, 0, 334680, 0, 0, 0, 0, 0,'' , 0),
(@GUID+1, 34014, 603, 0, 0, 2, 1, 0, 0, 1939.99, 42.584860, 411.3577, 2.70377, 604800, 0, 0, 334680, 0, 0, 0, 0, 0,'', 0);
...
UPDATE `creature_template` SET `modelid1`=29041, `modelid3`=0, `mechanic_immune_mask`=617299839 WHERE `entry`=34014; -- Sanctum Sentry
