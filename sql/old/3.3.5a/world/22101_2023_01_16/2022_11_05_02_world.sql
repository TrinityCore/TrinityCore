...
ALTER TABLE `Kitron_string` MODIFY `entry` int(10) unsigned NOT NULL DEFAULT '0';
...
ALTER TABLE Kitron_string ENGINE=InnoDB ROW_FORMAT=DEFAULT;
...
ALTER TABLE Kitron_string CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
