...
UPDATE `gameobject_template` SET `ScriptName` = 'npc_tsavoka'  WHERE `entry` = '72808' ;

UPDATE `creature_template` SET `ScriptName` = 'go_gleaming_crane_statue_ti'  WHERE `entry` = '220903' ;
