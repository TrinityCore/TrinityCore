...
INSERT INTO `gossip_menu_option` (`MenuID`, `GossipOptionID`, `OptionID`, `OptionNpc`, `OptionText`, `OptionBroadcastTextID`) VALUES
(@GOSSIP,-(@GOSSIP<<8),0,0, 'Yes, I am ready to travel to Venture Bay!',26605);
