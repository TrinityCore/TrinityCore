...
(9908,194200,603,0,0,'14,33',0,2036.169921875,-201.842605590820312,432.686798095703125,3.141592741012573242,0,0,-1,0,604800,255,1,'',NULL,0);
...
--
UPDATE `serverside_spell` SET `DurationIndex` = 327 WHERE `Id` = 64899;
UPDATE `serverside_spell_effect` SET `ImplicitTarget1` = 22 /*18*/, `ImplicitTarget2` = 15 /*16*/ WHERE `SpellID` = 64899 AND `EffectIndex` = 0;

DELETE FROM `serverside_spell_effect` WHERE `SpellID` = 64899 AND `EffectIndex` = 1;
INSERT INTO `serverside_spell_effect` (`SpellID`, `EffectIndex`, `Effect`, `EffectAura`, `EffectRadiusIndex1`, `ImplicitTarget1`, `ImplicitTarget2`) VALUES
(64899, 1, 6, 4, 28, 22, 15);
