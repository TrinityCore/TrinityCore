-- Honor Hold Defender
SET @NPC=16842;
DELETE FROM `creature_equip_template` WHERE `CreatureID`=@NPC AND `ID` IN (1,2,6);
INSERT INTO `creature_equip_template` (`CreatureID`, `ID`, `ItemID1`, `ItemID2`, `ItemID3`, `VerifiedBuild`) VALUES
(@NPC, 1, 12944, 143, 0, 59185),
(@NPC, 2, 1903, 143, 0, 59185),
(@NPC, 6, 1905, 2558, 0, 42010);
...
DELETE FROM `creature_template_gossip` WHERE `CreatureID`=16842 AND `MenuID`=7300;
INSERT INTO `creature_template_gossip` (`CreatureID`, `MenuID`, `VerifiedBuild`) VALUES
(16842, 7300, 67823); -- Honor Hold Defender
...
UPDATE `gossip_menu` SET `VerifiedBuild`=67823 WHERE `MenuID`=7300 AND `TextID`=8656;
-- Stormwind Infantry
...
UPDATE `gossip_menu_option` SET `GossipOptionID`=34388, `OptionBroadcastTextID`=10182, `VerifiedBuild`=67823 WHERE `MenuID`=7957 AND `OptionID`=0;
-- Corporal Ironridge
