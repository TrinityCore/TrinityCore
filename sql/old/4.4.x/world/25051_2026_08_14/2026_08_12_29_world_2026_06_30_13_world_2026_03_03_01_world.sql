-- Saragosa
DELETE FROM `creature_template_difficulty` WHERE `Entry` = 26231 AND `DifficultyID` = 0;
UPDATE `creature_template_difficulty` SET `DifficultyID` = 0, `StaticFlags1` = 0x10080066 WHERE `Entry` = 26231 AND `DifficultyID` = 1;
