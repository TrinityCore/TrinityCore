...
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000, `VerifiedBuild`=63305 WHERE (`Entry`=520 AND `DifficultyID`=0); -- 520 (Brack) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0, `VerifiedBuild`=63305 WHERE (`Entry`=846 AND `DifficultyID`=0); -- 846 (Rotten Ghoul) -
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x0, `VerifiedBuild`=63305 WHERE (`Entry`=572 AND `DifficultyID`=0); -- 572 (Leprithus) -
