--
UPDATE `serverside_spell` SET `RangeIndex`= 12, `ProcChance` = 101 WHERE `Id` = 47680;
DELETE FROM `serverside_spell_effect` WHERE `SpellID`=47680;
INSERT INTO `serverside_spell_effect` (`SpellID`,`Effect`,`EffectTriggerSpell`,`ImplicitTarget1`) VALUES
(47680,140,47681,25);
