-- Questchains
DELETE FROM `quest_template_addon` WHERE `ID` IN (14093,14098,14094,14286,14290,14288,14285,14289,14287,14291,24930,28850,14154,26129,14204,14214,14293,14294,14212,14218,14221,14222);
