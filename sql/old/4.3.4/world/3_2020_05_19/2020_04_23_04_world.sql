UPDATE `creature_template_addon` SET `auras`= '95480' WHERE `entry` IN (49588, 49590);
UPDATE `creature_template_addon` SET `auras`= '95479' WHERE `entry` IN (49586, 49587);

UPDATE `creature_template` SET `npcflag`= 1 | 128, `gossip_menu_id`= 12656 WHERE `entry` IN (49588, 49590, 49586, 49587);

DELETE FROM `gossip_menu_option` WHERE `MenuId`=12656;
INSERT INTO `gossip_menu_option` (`MenuId`, `OptionIndex`, `OptionIcon`, `OptionText`, `OptionBroadcastTextId`, `OptionType`, `OptionNpcFlag`, `VerifiedBuild`) VALUES
(12656, 0, 1, 'I want to browse your goods.', 2823, 3, 128, 15595);
