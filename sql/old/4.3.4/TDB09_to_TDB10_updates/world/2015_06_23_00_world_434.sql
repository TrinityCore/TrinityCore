...
CHANGE `data24` `Data24` INT(10) UNSIGNED NOT NULL DEFAULT '0',
CHANGE `data25` `Data25` INT(10) UNSIGNED NOT NULL DEFAULT '0',
CHANGE `data26` `Data26` INT(10) UNSIGNED NOT NULL DEFAULT '0',
CHANGE `data27` `Data27` INT(10) UNSIGNED NOT NULL DEFAULT '0',
CHANGE `data28` `Data28` INT(10) UNSIGNED NOT NULL DEFAULT '0',
CHANGE `data29` `Data29` INT(10) UNSIGNED NOT NULL DEFAULT '0',
CHANGE `data30` `Data30` INT(10) UNSIGNED NOT NULL DEFAULT '0',
CHANGE `data31` `Data31` INT(10) UNSIGNED NOT NULL DEFAULT '0';
