...
-- Ashtongue Ruse
UPDATE `serverside_spell` SET `ProcChance` = 101 WHERE `Id` = 39555;
DELETE FROM `serverside_spell_effect` WHERE `SpellID` = 39555;
INSERT INTO `serverside_spell_effect` (`SpellID`, `Effect`, `EffectAura`, `ImplicitTarget1`) VALUES
(39555, 6, 4, 1);
UPDATE `serverside_spell` SET `ProcChance` = 101 WHERE `Id` = 39701;
DELETE FROM `serverside_spell_effect` WHERE `SpellID` = 39701;
...
-- Flame Patch
UPDATE `serverside_spell_effect` SET `Effect` = 28, `EffectAura` = 0, `EffectMiscValue2` = 64 WHERE `SpellID` = 29218 AND `EffectIndex` = 0;

-- Ember Blast (damage component)
UPDATE `serverside_spell` SET `ProcChance` = 101 WHERE `Id` = 41910;
DELETE FROM `serverside_spell_effect` WHERE `SpellID` = 41910;
INSERT INTO `serverside_spell_effect` (`SpellID`, `Effect`, `EffectBasePoints`, `ImplicitTarget1`) VALUES
(41910, 2, 70000, 38);
...
UPDATE `serverside_spell` SET `ProcChance` = 101, `EquippedItemSubClassMask` = -1 WHERE `Id` = 41824;

DELETE FROM `serverside_spell_effect` WHERE `SpellID` = 41824;
INSERT INTO `serverside_spell_effect` (`SpellID`, `Effect`, `EffectBasePoints`, `EffectMiscValue1`, `EffectMiscValue2`, `EffectRadiusIndex1`, `ImplicitTarget1`) VALUES (41824, 28, 1, 19551, 64, 13, 72);

DELETE FROM `serverside_spell_effect` WHERE `SpellID` = 39110;
INSERT INTO `serverside_spell_effect` (`SpellID`, `Effect`, `EffectBasePoints`, `EffectMiscValue1`, `EffectMiscValue2`, `EffectRadiusIndex1`, `ImplicitTarget1`) VALUES (39110, 28, 2, 19551, 64, 13, 72);
