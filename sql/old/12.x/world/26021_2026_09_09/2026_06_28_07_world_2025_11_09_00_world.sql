...
-- Skarvald
DELETE FROM `creature_loot_template` WHERE `Entry` = 24201 AND `ItemType` = 1 AND `Item` = 35045;
DELETE FROM `creature_loot_template` WHERE `Entry` = 31656 AND `ItemType` = 0 AND `Item` = 47241;
DELETE FROM `creature_loot_template` WHERE `Entry` = 31656 AND `ItemType` = 1 AND `Item` = 35049;
