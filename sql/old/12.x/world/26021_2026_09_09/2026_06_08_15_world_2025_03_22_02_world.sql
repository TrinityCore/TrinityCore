...
UPDATE `waypoint_path_node` SET `PositionX`=-713.90032958984375, `PositionY`=7929.8349609375, `PositionZ`=59.13791656494140625 WHERE `PathId`=14455201 AND `NodeId`=1;
...
DELETE FROM `waypoint_path_node` WHERE `PathId`=144553;
INSERT INTO `waypoint_path_node` (`PathId`, `NodeId`, `PositionX`, `PositionY`, `PositionZ`, `Orientation`, `Delay`) VALUES
(144553, 1, -720.218, 7914.135, 55.22982, NULL, 0),
(144553, 2, -720.4691, 7905.346, 50.42057, NULL, 0),
(144553, 3, -715.9375, 7896.43, 48.30074, NULL, 0);
