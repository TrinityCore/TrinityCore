...
CREATE TABLE `quest_template` (
  ...
  `ReqSpellCast1` int(11) signed NOT NULL DEFAULT '0',
  `ReqSpellCast2` int(11) signed NOT NULL DEFAULT '0',
  `ReqSpellCast3` int(11) signed NOT NULL DEFAULT '0',
  `ReqSpellCast4` int(11) signed NOT NULL DEFAULT '0',
