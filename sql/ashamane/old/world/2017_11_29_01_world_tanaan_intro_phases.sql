...
(@PHASE_172,        @AREA_PATH_OF_GLORY,    @QUEST_TRIP_TO_TOP_OF_TANK,             @QUEST_TASTE_OF_IRON,                   @TEAM_BOTH,         @QUEST_STATUS_COMPLETED_REWARDED,   @QUEST_TAKEN                        ),
(@PHASE_172,        @AREA_PATH_OF_GLORY,    @QUEST_TASTE_OF_IRON,                   @QUEST_THE_HOME_STRETCH_A,              @TEAM_ALLIANCE,     @QUEST_STATUS_COMPLETED_REWARDED,   @QUEST_TAKEN                        ),
(@PHASE_172,        @AREA_PATH_OF_GLORY,    @QUEST_TASTE_OF_IRON,                   @QUEST_THE_HOME_STRETCH_H,              @TEAM_HORDE,        @QUEST_STATUS_COMPLETED_REWARDED,   @QUEST_TAKEN                        ),
