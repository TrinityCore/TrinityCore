...
UPDATE `creature` SET `position_x`= -4821.111,`position_y`= -970.1805,`position_z`=464.7921,`orientation`= 1.269122 WHERE `guid`=302915;
...
INSERT INTO `creature_template_scaling` (`Entry`,`VerifiedBuild`) VALUES 
(118889, 25996);
