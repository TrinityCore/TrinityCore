...
INSERT INTO `quest_offer_reward_locale` VALUES ('12848', 'frFR', 'Comme je m\’y attendais, mon chevalier a triomphé ! Vous êtes prêt, $N.', '0');
INSERT INTO `quest_offer_reward_locale` VALUES ('12636', 'frFR', 'Il sera bientôt temps de verser le sang de nos ennemis. Vous devez d’abord apprendre à connaître ce que vous cherchez à détruire, avant de vous jeter à corps perdu dans la bataille. C’est ce qui différencie le chevalier de la mort de la simple goule.$B$BJe vais vous faire don de la vision par-delà la vision, champion. Vous utiliserez l\’œil d’Achérus pour voler les secrets de nos ennemis.', '0');
INSERT INTO `quest_offer_reward_locale` VALUES ('12641', 'frFR', 'Comme prévu, ils se préparent pour la bataille. Mais il y a autre chose… Je sens un ancien ennemi. Un ennemi que j\’ai détruit il y a déjà bien longtemps…$B$BCe n\’est pas grave. Nous allons envoyer toute la puissance du Fléau contre eux avant qu\’ils aient une chance d’évacuer leurs maisons et de mettre en place leurs défenses.', '0');
INSERT INTO `quest_offer_reward_locale` VALUES ('12657', 'frFR', 'Les cors de guerre retentiront bientôt sur cette terre, réveillant les morts et appelant les machines de guerre du Fléau. Je plains ceux qui se dresseront sur notre route !$B$BVous et les vôtres dirigerez l’assaut, $N. La prochaine fois que je regarderai les terres écarlates, ma vision sera noircie par les légions d\’Achérus. La marche vers la Nouvelle-Avalon débute maintenant.', '0');
INSERT INTO `quest_offer_reward_locale` VALUES ('12850', 'frFR', 'La guerre a commencé, chevalier de la mort ! Je vais vous placer sur l\un de mes meilleurs griffons et vous envoyer à Brèche-de-Mort. Chaos, mort, destruction ! Vous serez le messager de tout ceci et bien plus encore !', '0');
INSERT INTO `quest_offer_reward_locale` VALUES ('12849', 'frFR', 'Vous trouverez les trois écoles du sang, du givre et de l’impie ici, dans la salle de commande. Chacune a un maître qui pourra vous enseigner les arts ténébreux.$B$BJe suis le seigneur Thorval, le maître du sang. Dame Alistra règne sur l’impie, et l’archi-liche Amal’thazad gouverne le givre.$B$BRevenez vous entraîner lorsque vous monterez en puissance !', '0');
INSERT INTO `quest_offer_reward_locale` VALUES ('12670', 'frFR', 'Sentez-vous ça ?$B$B<Valanar renifle l\’air.>$B$BDe la viande fraîche… L\’odeur des croisés écarlates flotte dans l\’air.$B$B<Valanar salive.>$B$BExcusez-moi, $C. Mon goût pour la gastronomie ne vous intéresse probablement pas. Vous êtes ici pour travailler ! Pour mener l\’assaut ! Oui... Je sais. le roi-liche m\’a raconté tout ce que j\’ai besoin de savoir sur vous, $n.$B$BLe bain de sang va commencer.', '0');
INSERT INTO `quest_offer_reward_locale` VALUES ('12680', 'frFR', 'Et maintenant, la véritable épreuve. Saurez-vous maîtriser un destrier non attaché et prendre ce que vous désirez le plus ?', '0');
...
UPDATE `quest_request_items` SET `CompletionText` = '' WHERE (ID = 12842);
UPDATE `quest_request_items` SET `CompletionText` = '' WHERE (ID = 12733);
UPDATE `quest_request_items` SET `CompletionText` = '' WHERE (ID = 12680);
UPDATE `quest_request_items` SET `CompletionText` = '' WHERE (ID = 12687);
