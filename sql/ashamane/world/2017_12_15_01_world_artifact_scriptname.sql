DELETE FROM spell_script_names WHERE scriptname IN ("spell_arti_dru_half_moon", "spell_arti_mage_immolation", "spell_arti_mage_phoenix_flames", "spell_arti_mage_phoenix_flames_trigger", "spell_arti_sha_servant_of_the_queen", "spell_arti_sha_caress_of_the_tidemother", "spell_arti_warl_deadwind_harvest", "spell_arti_warl_reap_souls", "spell_arti_warl_dimensional_rift", "npc_warl_chaos_tear", "npc_warl_shadowy_tear", "spell_arti_warl_thalkiels_consumption", "spell_dh_fury_of_the_illidari");
