...
SET @START_GUID_CHARS := 1;
SET @START_GUID_ITEMS := 1;
SET @START_GUID_GROUP := 1;
SET @START_GUID_PETS  := 1;
SET @START_GUID_MAILS := 1;
SET @START_GUID_EQUIP := 1;
...
UPDATE `character_aura` JOIN `tmp_guid_table` ON `character_aura`.`item_guid` = `tmp_item_instance_table`.`guid` SET `character_aura`.`item_guid` = `tmp_item_instance_table`.`guid_new`;
