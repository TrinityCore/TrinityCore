...
INSERT INTO `world_state_value` SELECT `entry`, `value` FROM `worldstates` WHERE `entry` NOT BETWEEN 20001 AND 20009;

INSERT INTO `world_variable` SELECT 'NextArenaPointDistributionTime', ws.`value` FROM `worldstates` ws WHERE ws.entry = 20001;
