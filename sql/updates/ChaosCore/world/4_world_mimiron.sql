-- Mimiron Tram
UPDATE `gameobject_template` SET `flags` = 32, `data2` = 3000, `ScriptName` = 'go_call_tram' WHERE `entry` IN (194914, 194438, 194912, 194437);
...
DELETE FROM `spell_script_names` WHERE `spell_id` = 63387;
INSERT INTO `spell_script_names` (`spell_id`, `ScriptName`) VALUES (63387, 'spell_rapid_burst');
-- Aerial Command Unit
