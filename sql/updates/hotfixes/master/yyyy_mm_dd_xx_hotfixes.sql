--
-- Table structure for table `pvp_scoreboard_layout`
--

DROP TABLE IF EXISTS `pvp_scoreboard_layout`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pvp_scoreboard_layout` (
  `ID` int(10) unsigned NOT NULL DEFAULT '0',
  `PVPStatID` int(11) NOT NULL DEFAULT '0',
  `PVPScoreboardColumnHeaderID` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `pvp_scoreboard_layout`
--

LOCK TABLES `pvp_scoreboard_layout` WRITE;
/*!40000 ALTER TABLE `pvp_scoreboard_layout` DISABLE KEYS */;
/*!40000 ALTER TABLE `pvp_scoreboard_layout` ENABLE KEYS */;
UNLOCK TABLES;
