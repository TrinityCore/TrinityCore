...
CREATE TABLE `flight_capability` (
  ...
  `Field_10_0_0_44167_002` tinyint unsigned NOT NULL DEFAULT '0',
  `DoubleJumpVelMod` tinyint unsigned NOT NULL DEFAULT '0',
  `LiftCoefficient` tinyint unsigned NOT NULL DEFAULT '0',
