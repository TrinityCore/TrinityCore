...
*/
-- Variables
SET @TRIGGER_GUID = 3106179; -- 10 of them
SET @BOAR_GUID = 3106189; -- 8 of them

-- Template update
UPDATE `creature_template` SET `AIName`='',`ScriptName`='npc_shadowmoon_tuber_node',`modelid2`=0,`flags_extra`=`flags_extra`|128 WHERE `entry`=21347;
UPDATE `gameobject_template` SET `data1`=2 WHERE `entry`=184701;

-- Spawn triggers next to GOs
