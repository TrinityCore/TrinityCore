...
UPDATE `creature_template` SET `unit_flags` = 33685510  WHERE `entry` IN( 34047, 34110, 34050, 34071, 34068);
...
DELETE FROM `creature_template_addon` WHERE `entry` IN (34047, 34148, 33836, 34149, 34147, 33670, 34363, 34121, 34068); 
