...
(15, 3502,0, 0,0,  9,0, 5742, 0,0,0,0,0, '', 'Show gossip menu option 3502 only if Quest 5742 is taken (active)'),
(15, 3502,0, 0,0, 41,0,    1, 1,0,0,0,0, '', 'Show gossip menu option 3502 only if player is sitting (any type)');
