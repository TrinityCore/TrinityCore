...
-- Add target for portal spells
DELETE FROM `spell_target_position` WHERE `id` IN (28444,72617,72613);
INSERT INTO `spell_target_position` (`id`, `target_map`, `target_position_x`, `target_position_y`, `target_position_z`, `target_orientation`) VALUES
(28444, 533, 3005.4558, -3433.9599, 304.1948, 3.593),
(72617, 533, 3497.448, -5354.668, 144.975, 1.321),
(72613, 533, 3004.579, -3392.532, 298., 5.796);
