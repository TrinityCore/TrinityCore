...
DELETE FROM `command` WHERE `name`='modify power' and `permission`='1010';
INSERT INTO `command` (`name`, `permission`, `help`) VALUES ('modify power', 1010, 'Syntax: .modify power #powercount \r\n\r\nModify the power of the selected player. If no player is selected, modify your power.');
