DELETE FROM spell_script_names WHERE ScriptName IN ('spell_pri_premonition_talent', 'spell_pri_premonition_of_insight', 'spell_pri_premonition_of_piety', 'spell_pri_premonition_of_solace', 'spell_pri_premonition_of_insight_aura', 'spell_pri_premonition_of_piety_aura', 'spell_pri_premonition_of_piety_heal', 'spell_pri_premonition_of_solace_aura', 'spell_pri_premonition_of_solace_absorb', 'spell_pri_premonition_visual_next');
INSERT INTO spell_script_names (spell_id, ScriptName) VALUES
(428924, 'spell_pri_premonition_talent'),
...
(450796, 'spell_pri_premonition_visual_next');
...
DELETE FROM `spell_proc` WHERE `SpellId` IN (450796); -- TODO fix
INSERT INTO `spell_proc` (`SpellId`,`SchoolMask`,`SpellFamilyName`,`SpellFamilyMask0`,`SpellFamilyMask1`,`SpellFamilyMask2`,`SpellFamilyMask3`,`ProcFlags`,`ProcFlags2`,`SpellTypeMask`,`SpellPhaseMask`,`HitMask`,`AttributesMask`,`DisableEffectsMask`,`ProcsPerMinute`,`Chance`,`Cooldown`,`Charges`) VALUES
(450796,0x00,6,0x00000000,0x00000000,0x00000000,0x00000000,0x11000,0x0,0x0,0x2,0x0,0x0,0x0,0,101,0,0); -- Premonition
