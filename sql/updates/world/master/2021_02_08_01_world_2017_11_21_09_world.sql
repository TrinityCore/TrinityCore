-- 
UPDATE `creature` SET `spawndist` = 0, `MovementType` = 0, `PhaseId` =170, `spawntimesecs`=120 WHERE `id` = 28529;
UPDATE `creature` SET `spawndist` = 0, `MovementType` = 2, `PhaseId` =170, `spawntimesecs`=120 WHERE `id` = 28530;
