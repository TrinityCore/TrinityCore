...
(53587,     1, 34385, 100, 0, 1, 1,  6,  6, 'Baleroc 25N - Gear');
...
(53589,     1, 34386, 100, 0, 1, 1,  6,  6, 'Baleroc 25H - Gear'),
...
UPDATE `creature_template` SET `minlevel`=88, `maxlevel`=88, `faction`=14, `speed_walk`=1.14286, `speed_run`=2, `unit_flags`=32768, `unit_flags2`=2099200, `type_flags2`=128, `mechanic_immune_mask`=617561975, `flags_extra`=1073741825 WHERE `entry` IN (53587, 53588, 53589);
