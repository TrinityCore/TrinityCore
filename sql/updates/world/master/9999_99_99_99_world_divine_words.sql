...
DELETE FROM `areatrigger_create_properties` WHERE `Id` = 35546 AND `IsCustom` = 0;
...
VALUES (35546, 0, 29620, 0, 0, 0, 0, 0, 0, -1, 0, 0, 372784, 15000, 0, 0, 4, 10, 10, 4, 4, 0.3, 0.3, 0, 0, '', 0);

DELETE FROM `areatrigger_create_properties` WHERE `Id` = 25138 AND `IsCustom` = 0;
INSERT INTO `areatrigger_create_properties` (`Id`, `IsCustom`, `AreaTriggerId`, `IsAreatriggerCustom`, `Flags`, `MoveCurveId`, `ScaleCurveId`, `MorphCurveId`, `FacingCurveId`, `AnimId`, `AnimKitId`, `DecalPropertiesId`, `SpellForVisuals`, `TimeToTargetScale`, `Speed`, `SpeedIsTime`, `Shape`, `ShapeData0`, `ShapeData1`, `ShapeData2`, `ShapeData3`, `ShapeData4`, `ShapeData5`, `ShapeData6`, `ShapeData7`, `ScriptName`, `VerifiedBuild`) 
VALUES (25138, 0, 29620, 0, 0, 0, 0, 0, 0, -1, 0, 0, 372784, 15000, 0, 0, 4, 10, 10, 4, 4, 0.3, 0.3, 0, 0, '', 0);

DELETE FROM `spell_script_names` WHERE `ScriptName` IN ('spell_pri_divine_word_chastise', 'spell_pri_divine_word_sanctify', 'spell_pri_divine_word_serenity', 'spell_pri_divine_word_sanctuary', 'spell_pri_divine_word_sanctuary_heal');
INSERT INTO `spell_script_names` (`spell_id`, `ScriptName`) VALUES
(88625, 'spell_pri_divine_word_chastise'),
(34861, 'spell_pri_divine_word_sanctify'),
(2050, 'spell_pri_divine_word_serenity'),
