...
DELETE FROM `spell_script_names` WHERE `spell_id` IN (255615, 255566, 255591, 255584, 258388, 255565, 258681, 255577, 255575, 259205, 259209, 255835, 255836);
...
(255577, 'spell_priestess_alun_za_tranfusion_cast'),
(255575, 'spell_priestess_alun_za_tranfusion'),
...
(255835, 'spell_priestess_alun_za_tranfusion_heal_and_damage'),
(255836, 'spell_priestess_alun_za_tranfusion_heal_and_damage');
