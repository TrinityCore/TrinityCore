...
DELETE FROM `areatrigger_template` WHERE `Id`=@ATFELENERGY AND `IsCustom`=1;
INSERT INTO `areatrigger_template` (`Id`, `IsCustom`, `Flags`, `VerifiedBuild`) VALUES
(@ATFELENERGY, 1, 1, 0);

DELETE FROM `areatrigger_create_properties` WHERE (`IsCustom`=0 AND `Id` IN (5315, 5298));
...
(5315, 0, 10037, 0, 4, 0, 0, 0, 0, -1, 0, 0, 197180, 6000, 0, 15, 15, 0, 0, 0, 0, 0, 0, 'at_fel_lord_caza_fel_infusion', 57212), -- Spell: 197180 (Fel Infusion)
(5298, 0, @ATFELENERGY, 1, 4, 0, 0, 0, 0, -1, 0, 0, 197180, 10000, 0, 5, 5, 0, 0, 0, 0, 0, 0, 'at_fel_lord_caza_fel_infusion', 57212); -- Spell: 196988 (Violent Fel Energy)
