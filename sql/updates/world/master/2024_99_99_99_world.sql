...
(-@CONDREFID,0,0,0,1,47,0,29547,8,0,'',0,0,0,'','Apply condition reference if quest 29547 is taken'),
(-@CONDREFID,0,0,0,2,47,0,49556,8,0,'',0,0,0,'','Apply condition reference if quest 49556 is taken'),
(-@CONDREFID,0,0,0,3,47,0,49866,8,0,'',0,0,0,'','Apply condition reference if quest 49866 is taken'),
(-@CONDREFID,0,0,0,4,47,0,60125,8,0,'',0,0,0,'','Apply condition reference if quest 60125 is taken');
