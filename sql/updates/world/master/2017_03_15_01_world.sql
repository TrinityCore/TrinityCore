-- Master Fixup for Thunder Buff Guard Gossip
...
(600,-976.6285,-285.0938,7,99,0, 'Thunder Bluff Monk Trainer',23420);
 
-- Thunder Buff Guard Gossip fixup for 434 up
-- Top Menu
...
(740,4,0,'Warlock',45407,1,1,0,0,0,0,'',0,0),
...
(740,8,0,'Monk',61793,1,1,13867,600,0,0,'',0,0);
-- Profession Menu
