...
DELETE FROM `gossip_menu_friendship_faction` WHERE `MenuID` IN (13332, 13338, 13470, 13475, 13486, 13574, 13593, 13594, 13595);
INSERT INTO `gossip_menu_friendship_faction` (`MenuID`, `FactionID`, `VerifiedBuild`) VALUES
