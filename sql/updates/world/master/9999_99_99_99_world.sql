...
-- Move MawOfSoulsDungeon teleport outside of instance (current location is inside but behind portal, which makes it unusable after areatrigger is added)
UPDATE `game_tele` SET `map` = 1220, `position_x` = 3419.01, `position_y` = 1988.64, `position_z` = 15.536, `orientation` = 6.15 WHERE `id` = 1702;
...
(@OGUID+16, 252245, 1571, 8079, 8079, '8,23,2,24', '0', 0, 1017.8524169921875, 3827.853271484375, 9.486422538757324218, 4.531371593475341796, 0, 0, -0.76812458038330078, 0.640300452709197998, 7200, 255, 1, 61122), -- Instance Portal (Area: Court of Stars - Difficulty: 0) CreateObject
(@OGUID+17, 252145, 1669, 8701, 8841, '0', '0', 0, 5412.83837890625, 10816.5673828125, 22.50126075744628906, 3.017399072647094726, 0, 0, 0.998072624206542968, 0.062056876718997955, 120, 255, 1, 61188), -- Instance Portal (Area: Triad's Conservatory - Difficulty: 0) CreateObject1
(@OGUID+18, 252145, 1753, 8910, 8907, '2,8,23', '0', 0, 5413.9912109375, 10818.3330078125, 20.21274566650390625, 2.885625600814819335, 0, 0, 0.9918212890625, 0.127634420990943908, 7200, 255, 1, 61188); -- Instance Portal (Area: Triad's Conservatory - Difficulty: 0) CreateObject1
