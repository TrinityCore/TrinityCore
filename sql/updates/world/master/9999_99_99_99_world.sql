...
DELETE FROM `conversation_actors` WHERE `ConversationId` IN (13611,13630,13631,13632,13633,13710,13892,14440,14441,14444,14447,14448,14449,14452,14453,14454,14455,14456,14457,14458,14459);
DELETE FROM `conversation_actors` WHERE `ConversationId` IN (14460,14461,14462,14463,14475,14486,14487,14488,14489,14490,14491,14492,14493,14494,14495);
...
DELETE FROM `conversation_line_template` WHERE `Id` IN (34011,34012,34013,34014,34015,34016,34017,34018,34019,36204,34173,36160,34690,34691,36206,36207,36163,36164,36170,36171,36175,36176,36177,36178,36179,36180,33931,33932,33933,36181,36182,36183,36161,36162);
DELETE FROM `conversation_line_template` WHERE `Id` IN (36188,36189,36190,36191,36192,36193,36194,36195,36196,36197,36198,36199,36200,36201,36202,36203,36208,36209,36210,36211,36212,36213,36214,36215,36244,36245,36246,36247,36248,36249,36250,36251,36252,36253);
DELETE FROM `conversation_line_template` WHERE `Id` IN (36275,36276,36277,36278,36279,36280,36281,36282,36283,36284,36285,36286,36287,36288,36289,36290,36291,36292,36293,36294);
...
DELETE FROM `conversation_template` WHERE `Id` IN (13630,13631,13632,13633,13710,13892,14441,14444,14447,14448,14449,13611,14440);
DELETE FROM `conversation_template` WHERE `Id` IN (14452,14453,14454,14455,14456,14457,14458,14459,14460,14461,14462,14463,14475);
