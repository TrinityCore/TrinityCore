...
UPDATE `creature_template_difficulty` SET `StaticFlags1`=536870912, `VerifiedBuild`=52649 WHERE (`Entry`=37859 AND `DifficultyID`=0); -- Ignis the Furnace Master Image
