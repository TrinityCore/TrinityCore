...
UPDATE `smart_scripts` SET `action_type`=54,`action_param1`=3000,`comment`='Corporal Keeshan - Action list - pause waypoint' WHERE `entryorguid`=34902 AND `source_type`=9 AND `id`=0;
