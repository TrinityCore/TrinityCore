...
-- PDATE `creature_template` SET `modelid2`=11160, `modelid3`=11159 WHERE `entry`=11346; -- Hakkari Oracle
-- PDATE `creature_template` SET `modelid2`=11169, `modelid3`=11168 WHERE `entry`=11355; -- Gurubashi Warrior
-- PDATE `creature_template` SET `modelid1`=6297, `modelid4`=901 WHERE `entry`=13321; -- Small Frog
-- PDATE `creature_template` SET `modelid1`=1986, `modelid2`=1206 WHERE `entry`=3300; -- Adder
-- PDATE `creature_template` SET `unit_flags2`=0 WHERE `entry`=16310; -- Mana Shifter
...
UPDATE `npc_text` SET `VerifiedBuild`=12340 WHERE `VerifiedBuild` BETWEEN 0 AND 12340 AND `ID`=12779; -- 12779
UPDATE `npc_text` SET `VerifiedBuild`=12340 WHERE `VerifiedBuild` BETWEEN 0 AND 12340 AND `ID`=1220; -- 1220
UPDATE `npc_text` SET `VerifiedBuild`=12340 WHERE `VerifiedBuild` BETWEEN 0 AND 12340 AND `ID`=14040; -- 14040
UPDATE `npc_text` SET `VerifiedBuild`=12340 WHERE `VerifiedBuild` BETWEEN 0 AND 12340 AND `ID`=13840; -- 13840
UPDATE `npc_text` SET `VerifiedBuild`=12340 WHERE `VerifiedBuild` BETWEEN 0 AND 12340 AND `ID`=14791; -- 14791
