...
ALTER TABLE `playercreateinfo`
    ADD COLUMN `npe_intro_scene_id` INT UNSIGNED DEFAULT NULL AFTER `npe_transport_guid`,
    ADD COLUMN `intro_movie_id` INT UNSIGNED DEFAULT NULL AFTER `npe_intro_scene_id`,
    ADD COLUMN `intro_scene_id` INT UNSIGNED DEFAULT NULL AFTER `intro_movie_id`;
