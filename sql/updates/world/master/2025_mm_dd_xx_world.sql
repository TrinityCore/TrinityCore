SET @CGUID := 112000000;
SET @OGUID := 112000000;
SET @WORLD_SAFE_LOC_ID := 220000;
SET @SPAWN_GROUP := 220000;
...
(@OGUID+4, 184664, 1911, 9992, 9992, '0', '0', 0, -1962.5364990234375, 1245.8975830078125, 34.43144989013671875, 3.316144466400146484, 0, 0, -0.99619388580322265, 0.087165042757987976, 7200, 255, 1, 63305), -- Shadow Sight (Area: Mugambala - Difficulty: 0) CreateObject2
(@OGUID+5, 184663, 1911, 9992, 9992, '0', '0', 0, -1960.6129150390625, 1354.592041015625, 34.4305572509765625, 2.460912704467773437, 0, 0, 0.942641258239746093, 0.333807557821273803, 7200, 255, 1, 63305); -- Shadow Sight (Area: Mugambala - Difficulty: 0) CreateObject2
