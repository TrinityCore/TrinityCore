SET @CGUID := 116000000;
SET @OGUID := 116000000;
SET @WORLD_SAFE_LOC_ID := 260000;
SET @SPAWN_GROUP := 260000;
...
(@OGUID+5, 184663, 2563, 14436, 14436, '0', '0', 0, -583.763916015625, 4170.548828125, 380.34564208984375, 0, 0, 0, 0, 1, 7200, 255, 1, 63305), -- Shadow Sight (Area: Nokhudon Proving Grounds - Difficulty: 0) CreateObject2
(@OGUID+6, 184664, 2563, 14436, 14436, '0', '0', 0, -487.916656494140625, 4191.6103515625, 380.926422119140625, 3.471065282821655273, 0, 0, -0.98646163940429687, 0.163992181420326232, 7200, 255, 1, 63305); -- Shadow Sight (Area: Nokhudon Proving Grounds - Difficulty: 0) CreateObject2
