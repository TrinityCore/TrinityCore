...
UPDATE `creature` SET `PhaseId` = 176, `spawndist` = 0, `MovementType` = 0 WHERE `guid` = 130400;
...
UPDATE `creature` SET `PhaseId` = 176 WHERE `guid` IN (130387,130419);
