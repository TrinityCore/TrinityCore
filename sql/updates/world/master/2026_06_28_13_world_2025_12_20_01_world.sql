...
UPDATE `creature_template` SET `unit_flags` = 0x02000000 WHERE `entry` = 18370;
UPDATE `creature_template` SET `unit_flags` = 0x02000000 WHERE `entry` = 20598;
...
UPDATE `creature_template_addon` SET `PathId` = 578530, `SheathState` = 1 WHERE `entry` IN (16807,20568);

DELETE FROM `waypoint_path` WHERE `PathId` = 578530;
INSERT INTO `waypoint_path` (`PathId`, `MoveType`, `Flags`, `Velocity`, `Comment`) VALUES
(578530, 0, 0, NULL, 'Migrated from refactor');

DELETE FROM `waypoint_path_node` WHERE `PathId` = 578530;
INSERT INTO `waypoint_path_node` (`PathId`, `NodeId`, `PositionX`, `PositionY`, `PositionZ`, `Orientation`, `Delay`) VALUES
(578530,1,178.51125,287.97794,-8.183065,NULL,0),
(578530,2,171.82281,289.97687,-8.185595,NULL,0),
(578530,3,178.51125,287.97794,-8.183065,NULL,0),
(578530,4,184.78966,290.36990,-8.181390,NULL,0);
