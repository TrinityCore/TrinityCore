...
UPDATE `serverside_spell` SET `ProcChance` = 101 WHERE `Id` = 45258;
DELETE FROM `serverside_spell_effect` WHERE `SpellID` = 45258;
INSERT INTO `serverside_spell_effect` (`SpellID`, `Effect`, `EffectBasePoints`, `EffectMiscValue1`, `EffectMiscValue2`, `ImplicitTarget1`) VALUES
(45258, 28, 3, 25214, 64, 18);
