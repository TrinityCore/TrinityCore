...
-- Credit - Cmangos
DELETE FROM `waypoint_path` WHERE `PathId` = 1381150;
INSERT INTO `waypoint_path` (`PathId`, `MoveType`, `Flags`, `Velocity`, `Comment`) VALUES
(1381150,0,0,NULL,'Migrated from refactor');

DELETE FROM `waypoint_path_node` WHERE `PathId` = 1381150;
INSERT INTO `waypoint_path_node` (`PathId`, `NodeId`, `PositionX`, `PositionY`, `PositionZ`, `Orientation`, `Delay`) VALUES
(1381150,1,455.6496,33.33417,9.544375,NULL,0),
(1381150,2,456.105,44.3159,9.62544,NULL,0),
(1381150,3,458.401,50.6364,9.62375,NULL,0),
(1381150,4,461.782,54.9224,9.6233,NULL,0),
(1381150,5,463.657,60.3144,9.61813,NULL,0),
(1381150,6,456.328,78.3051,9.61487,1.53589,0);
