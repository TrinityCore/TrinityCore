...
DELETE FROM `waypoint_path` WHERE `PathId` = 6;
INSERT INTO `waypoint_path` (`PathId`, `MoveType`, `Flags`, `Velocity`, `Comment`) VALUES
(6,0,0,NULL,'Migrated from refactor');

DELETE FROM `waypoint_path_node` WHERE `PathId` = 6;
INSERT INTO `waypoint_path_node` (`PathId`, `NodeId`, `PositionX`, `PositionY`, `PositionZ`, `Orientation`, `Delay`) VALUES
(6,1,-234.83836,304.74194,-47.59481,NULL,0),
(6,2,-234.52731,289.1205,-48.02008,NULL,0),
(6,3,-233.9544,270.41608,-50.40104,NULL,0),
(6,4,-233.42236,252.05559,-49.447884,NULL,0);
