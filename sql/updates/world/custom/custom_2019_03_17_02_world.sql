...
-- Pathing for  Entry: 38781 'TDB FORMAT' 
SET @NPC := 258134;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`= 0, `MovementType`= 2, `position_x`= -1649.024, `position_y`= 1873.108, `position_z`= 19.1203 WHERE `guid`= @NPC;
DELETE FROM `creature_addon` WHERE `guid`= @NPC;
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `auras`) VALUES (@NPC, @PATH, 0, 0, 1, 0, '');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`, `point`, `position_x`, `position_y`, `position_z`, `orientation`, `delay`, `move_type`, `action`, `action_chance`, `wpguid`) VALUES
(@PATH, 1, -1649.024, 1873.108, 19.1203, 0, 0, 0, 0, 100, 0),
(@PATH, 2, -1669.608, 1880.045, 22.73118, 0, 0, 0, 0, 100, 0),
(@PATH, 3, -1677.965, 1891.705, 25.61155, 0, 0, 0, 0, 100, 0),
(@PATH, 4, -1683.094, 1900.99, 27.75262, 0, 0, 0, 0, 100, 0),
(@PATH, 5, -1683.042, 1911.004, 28.70269, 0, 0, 0, 0, 100, 0),
(@PATH, 6, -1680.885, 1920.866, 29.42144, 0, 0, 0, 0, 100, 0),
(@PATH, 7, -1674.924, 1928.12, 29.60504, 0, 0, 0, 0, 100, 0),
(@PATH, 8, -1663.049, 1934.637, 29.74307, 0, 0, 0, 0, 100, 0),
(@PATH, 9, -1651.168, 1937.896, 28.55459, 0, 0, 0, 0, 100, 0),
(@PATH, 10, -1640.462, 1936.967, 27.37966, 0, 0, 0, 0, 100, 0),
(@PATH, 11, -1633.83, 1930.7, 27.0273, 0, 0, 0, 0, 100, 0),
(@PATH, 12, -1631.266, 1924.776, 27.37841, 0, 0, 0, 0, 100, 0),
(@PATH, 13, -1630.339, 1915.748, 28.42699, 0, 0, 0, 0, 100, 0),
(@PATH, 14, -1633.42, 1908.359, 30.0273, 0, 0, 0, 0, 100, 0),
(@PATH, 15, -1639.8, 1905.396, 30.0273, 0, 0, 0, 0, 100, 0),
(@PATH, 16, -1633.42, 1908.359, 30.0273, 0, 0, 0, 0, 100, 0),
(@PATH, 17, -1630.339, 1915.748, 28.42699, 0, 0, 0, 0, 100, 0),
(@PATH, 18, -1631.266, 1924.776, 27.37841, 0, 0, 0, 0, 100, 0),
(@PATH, 19, -1633.83, 1930.7, 27.0273, 0, 0, 0, 0, 100, 0),
(@PATH, 20, -1640.462, 1936.967, 27.37966, 0, 0, 0, 0, 100, 0),
(@PATH, 21, -1651.168, 1937.896, 28.55459, 0, 0, 0, 0, 100, 0),
(@PATH, 22, -1663.049, 1934.637, 29.74307, 0, 0, 0, 0, 100, 0),
(@PATH, 23, -1674.924, 1928.12, 29.60504, 0, 0, 0, 0, 100, 0),
(@PATH, 24, -1680.885, 1920.866, 29.42144, 0, 0, 0, 0, 100, 0),
(@PATH, 25, -1683.042, 1911.004, 28.70269, 0, 0, 0, 0, 100, 0),
(@PATH, 26, -1683.094, 1900.99, 27.75262, 0, 0, 0, 0, 100, 0),
(@PATH, 27, -1677.965, 1891.705, 25.61155, 0, 0, 0, 0, 100, 0),
(@PATH, 28, -1669.608, 1880.045, 22.73118, 0, 0, 0, 0, 100, 0),
(@PATH, 29, -1649.024, 1873.108, 19.1203, 0, 0, 0, 0, 100, 0),
(@PATH, 30, -1629.929, 1872.906, 17.2561, 0, 0, 0, 0, 100, 0),
(@PATH, 31, -1619.851, 1878.498, 16.67163, 0, 0, 0, 0, 100, 0),
(@PATH, 32, -1612.017, 1887.858, 17.06738, 0, 0, 0, 0, 100, 0),
(@PATH, 33, -1610.943, 1902.415, 17.62841, 0, 0, 0, 0, 100, 0),
(@PATH, 34, -1611.734, 1911.655, 17.62841, 0, 0, 0, 0, 100, 0),
(@PATH, 35, -1611.635, 1919.007, 17.50341, 0, 0, 0, 0, 100, 0),
(@PATH, 36, -1611.734, 1911.655, 17.62841, 0, 0, 0, 0, 100, 0),
(@PATH, 37, -1610.943, 1902.415, 17.62841, 0, 0, 0, 0, 100, 0),
(@PATH, 38, -1612.017, 1887.858, 17.06738, 0, 0, 0, 0, 100, 0),
(@PATH, 39, -1619.851, 1878.498, 16.67163, 0, 0, 0, 0, 100, 0),
(@PATH, 40, -1629.929, 1872.906, 17.2561, 0, 0, 0, 0, 100, 0);
-- 0x2016DC51C025DF40000A520003FBE97A .go xyz -1649.024 1873.108 19.1203


-- Pathing for  Entry: 38781 'TDB FORMAT' 
SET @NPC := 258251;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`= 0, `MovementType`= 2, `position_x`= -1581.465, `position_y`= 1914.379, `position_z`= 8.992912 WHERE `guid`= @NPC;
DELETE FROM `creature_addon` WHERE `guid`= @NPC;
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `auras`) VALUES (@NPC, @PATH, 0, 0, 1, 0, '');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`, `point`, `position_x`, `position_y`, `position_z`, `orientation`, `delay`, `move_type`, `action`, `action_chance`, `wpguid`) VALUES
(@PATH, 1, -1581.465, 1914.379, 8.992912, 0, 0, 0, 0, 100, 0),
(@PATH, 2, -1574.941, 1914.106, 6.857414, 0, 2194, 0, 0, 100, 0),
(@PATH, 3, -1581.465, 1914.379, 8.992912, 0, 0, 0, 0, 100, 0),
(@PATH, 4, -1590.125, 1915.576, 11.75512, 0, 0, 0, 0, 100, 0),
(@PATH, 5, -1593.026, 1910.849, 12.74291, 0, 0, 0, 0, 100, 0),
(@PATH, 6, -1594.325, 1905.576, 13.0725, 0, 0, 0, 0, 100, 0),
(@PATH, 7, -1594.356, 1900.148, 13.07641, 0, 260, 0, 0, 100, 0),
(@PATH, 8, -1594.356, 1900.148, 13.07641, 5.218534, 7700, 0, 0, 100, 0),
(@PATH, 9, -1593.545, 1908.655, 12.92968, 0, 0, 0, 0, 100, 0),
(@PATH, 10, -1591.601, 1912.281, 12.1599, 0, 0, 0, 0, 100, 0),
(@PATH, 11, -1593.803, 1918.926, 13.31615, 0, 0, 0, 0, 100, 0),
(@PATH, 12, -1600.043, 1925.274, 15.51366, 0, 0, 0, 0, 100, 0),
(@PATH, 13, -1609.965, 1938.255, 17.14267, 0, 0, 0, 0, 100, 0),
(@PATH, 14, -1618.234, 1951.901, 17.38437, 0, 0, 0, 0, 100, 0),
(@PATH, 15, -1623.514, 1962.212, 16.79636, 0, 0, 0, 0, 100, 0),
(@PATH, 16, -1624.063, 1968.535, 16.65928, 0, 0, 0, 0, 100, 0),
(@PATH, 17, -1623.014, 1973.892, 16.40781, 0, 9, 0, 0, 100, 0),
(@PATH, 18, -1622.483, 1960.806, 16.63437, 0, 0, 0, 0, 100, 0),
(@PATH, 19, -1618.387, 1951.734, 17.38437, 0, 0, 0, 0, 100, 0),
(@PATH, 20, -1610.865, 1940.819, 17.25083, 0, 0, 0, 0, 100, 0),
(@PATH, 21, -1602.97, 1928.142, 16.2163, 0, 0, 0, 0, 100, 0),
(@PATH, 22, -1596.207, 1921.931, 14.13842, 0, 0, 0, 0, 100, 0),
(@PATH, 23, -1588.667, 1917.278, 11.48168, 0, 0, 0, 0, 100, 0);
-- 0x2016DC51C025DF40000A5200047BE97A .go xyz -1581.465 1914.379 8.992912

-- Pathing for  Entry: 38781 'TDB FORMAT' 
SET @NPC := 258264;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`= 0, `MovementType`= 2, `position_x`= -1564.649, `position_y`= 1915.694, `position_z`= 4.934464 WHERE `guid`= @NPC;
DELETE FROM `creature_addon` WHERE `guid`= @NPC;
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `auras`) VALUES (@NPC, @PATH, 0, 0, 1, 0, '');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`, `point`, `position_x`, `position_y`, `position_z`, `orientation`, `delay`, `move_type`, `action`, `action_chance`, `wpguid`) VALUES
(@PATH, 1, -1564.649, 1915.694, 4.934464, 0, 0, 0, 0, 100, 0),
(@PATH, 2, -1569.519, 1887.024, 4.855809, 0, 0, 0, 0, 100, 0),
(@PATH, 3, -1688.986, 1857.273, 10.76249, 0, 0, 0, 0, 100, 0),
(@PATH, 4, -1708.094, 1884.66, 15.87239, 0, 0, 0, 0, 100, 0),
(@PATH, 5, -1711.604, 1918.266, 20.15472, 0, 0, 0, 0, 100, 0),
(@PATH, 6, -1696.24, 1954.156, 24.06622, 0, 0, 0, 0, 100, 0),
(@PATH, 7, -1682.677, 1970.589, 24.36957, 0, 0, 0, 0, 100, 0),
(@PATH, 8, -1654.806, 1982.245, 22.91579, 0, 0, 0, 0, 100, 0),
(@PATH, 9, -1624.497, 1984.214, 17.80649, 0, 0, 0, 0, 100, 0),
(@PATH, 10, -1567.773, 1935.132, 5.091717, 0, 0, 0, 0, 100, 0);
-- 0x2016DC51C025DF40000A5200057BE97A .go xyz -1564.649 1915.694 4.934464

-- Pathing for  Entry: 38781 'TDB FORMAT' 
SET @NPC := 258302;
SET @PATH := @NPC * 10;
UPDATE `creature` SET `spawndist`= 0, `MovementType`= 2, `position_x`= -1477.002, `position_y`= 2033.319, `position_z`= 9.797993 WHERE `guid`= @NPC;
DELETE FROM `creature_addon` WHERE `guid`= @NPC;
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `auras`) VALUES (@NPC, @PATH, 0, 0, 1, 0, '');
DELETE FROM `waypoint_data` WHERE `id`=@PATH;
INSERT INTO `waypoint_data` (`id`, `point`, `position_x`, `position_y`, `position_z`, `orientation`, `delay`, `move_type`, `action`, `action_chance`, `wpguid`) VALUES
(@PATH, 1, -1477.002, 2033.319, 9.797993, 0, 0, 0, 0, 100, 0),
(@PATH, 2, -1491.377, 2016.958, 8.145405, 0, 0, 0, 0, 100, 0),
(@PATH, 3, -1507.156, 2008.101, 8.427908, 0, 0, 0, 0, 100, 0),
(@PATH, 4, -1491.377, 2016.958, 8.145405, 0, 0, 0, 0, 100, 0);
-- 0x2016DC51C025DF40000A520004FBE97A .go xyz -1477.002 2033.319 9.797993
