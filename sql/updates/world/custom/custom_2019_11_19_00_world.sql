...
UPDATE `creature_template` SET `mingold`= 50000, `maxgold`= 50000 WHERE `entry` IN (39625, 40177, 40319, 40484, 44577, 43614, 43612, 44819, 39665, 39679, 39698, 39700, 39705, 39425, 39788, 39428, 39378, 39731, 39732, 39587, 43438, 43214, 42188, 42333, 40586, 40765, 40788, 43878, 43873, 43875, 52053);
UPDATE `creature_template` SET `mingold`= 150000, `maxgold`= 150000 WHERE `entry` IN (48337, 48702, 48784, 48822, 48932, 49045, 48951, 51088, 39666, 39680, 39699, 39701, 39706, 48936, 48940, 48941, 49541, 48943, 48944, 49262, 48902, 48714, 48815, 48715, 48776, 48710, 49708, 49709, 49711, 49710, 49711, 49642, 49538, 49654, 49624, 49080, 49064, 49082, 43879, 43874, 43876, 52155, 52151, 52148, 52059, 52053);

UPDATE `gameobject_template_addon` SET `mingold`= 50000, `maxgold`= 50000 WHERE `entry`= 205216;
UPDATE `gameobject_template_addon` SET `mingold`= 150000, `maxgold`= 150000 WHERE `entry`= 207973;
