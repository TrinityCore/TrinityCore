...
DELETE FROM `spell_linked_spell` WHERE `spell_trigger`=@SPELL_CANCEL_BLOOD;
INSERT INTO `spell_linked_spell` (`spell_trigger`,`spell_effect`,`type`,`comment`) VALUES
(@SPELL_CANCEL_BLOOD,-@SPELL_BLOOD,1,'Ravenous Jaws: Cancel Blood Cosmetic Aura');

DELETE FROM `spell_script_names` WHERE `spell_id`=@SPELL_GORE_BLADDER;
