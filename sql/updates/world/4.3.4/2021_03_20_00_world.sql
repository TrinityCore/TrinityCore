...
DELETE FROM `npc_vendor` WHERE `entry` IN (54662, 54659);
...
-- chest pieces
(54662, 51, @MAGE_DPS      + @OFFSET_CHEST_CLOTH, 0, 3162, 1, 0),
(54662, 52, @WARLOCK_DPS   + @OFFSET_CHEST_CLOTH, 0, 3162, 1, 0),
(54662, 53, @PRIEST_DPS    + @OFFSET_CHEST_CLOTH, 0, 3162, 1, 0),
(54662, 54, @PRIEST_HEAL   + @OFFSET_CHEST_CLOTH, 0, 3162, 1, 0),
-- waist
(54662, 55, 72315, 0, 3163, 1, 15595),
(54662, 56, 72314, 0, 3163, 1, 15595),
(54662, 57, 72313, 0, 3163, 1, 15595),
-- legs
(54662, 58, @MAGE_DPS      + @OFFSET_LEGS_CLOTH, 0, 3162, 1, 0),
(54662, 59, @WARLOCK_DPS   + @OFFSET_LEGS_CLOTH, 0, 3162, 1, 0),
(54662, 60, @PRIEST_DPS    + @OFFSET_LEGS_CLOTH, 0, 3162, 1, 0),
(54662, 61, @PRIEST_HEAL   + @OFFSET_LEGS_CLOTH, 0, 3162, 1, 0),
-- feet
(54662, 62, 72318, 0, 3163, 1, 15595),
(54662, 63, 72317, 0, 3163, 1, 15595),
(54662, 64, 72316, 0, 3163, 1, 15595),
-- wrist
(54662, 65, 72321, 0, 3164, 1, 15595),
(54662, 66, 72320, 0, 3164, 1, 15595),
(54662, 67, 72319, 0, 3164, 1, 15595),
-- hands
(54662, 68, @MAGE_DPS     + @OFFSET_HANDS_CLOTH, 0, 3163, 1, 0),
(54662, 69, @WARLOCK_DPS  + @OFFSET_HANDS_CLOTH, 0, 3163, 1, 0),
(54662, 70, @PRIEST_DPS   + @OFFSET_HANDS_CLOTH, 0, 3163, 1, 0),
(54662, 71, @PRIEST_HEAL  + @OFFSET_HANDS_CLOTH, 0, 3163, 1, 0),
...
-- chest pieces
(54659, 51, @MAGE_DPS      + @OFFSET_CHEST_CLOTH, 0, 3162, 1, 0),
(54659, 52, @WARLOCK_DPS   + @OFFSET_CHEST_CLOTH, 0, 3162, 1, 0),
(54659, 53, @PRIEST_DPS    + @OFFSET_CHEST_CLOTH, 0, 3162, 1, 0),
(54659, 54, @PRIEST_HEAL   + @OFFSET_CHEST_CLOTH, 0, 3162, 1, 0),
-- waist
(54659, 55, 72315, 0, 3163, 1, 15595),
(54659, 56, 72314, 0, 3163, 1, 15595),
(54659, 57, 72313, 0, 3163, 1, 15595),
-- legs
(54659, 58, @MAGE_DPS      + @OFFSET_LEGS_CLOTH, 0, 3162, 1, 0),
(54659, 59, @WARLOCK_DPS   + @OFFSET_LEGS_CLOTH, 0, 3162, 1, 0),
(54659, 60, @PRIEST_DPS    + @OFFSET_LEGS_CLOTH, 0, 3162, 1, 0),
(54659, 61, @PRIEST_HEAL   + @OFFSET_LEGS_CLOTH, 0, 3162, 1, 0),
-- feet
(54659, 62, 72318, 0, 3163, 1, 15595),
(54659, 63, 72317, 0, 3163, 1, 15595),
(54659, 64, 72316, 0, 3163, 1, 15595),
-- wrist
(54659, 65, 72321, 0, 3164, 1, 15595),
(54659, 66, 72320, 0, 3164, 1, 15595),
(54659, 67, 72319, 0, 3164, 1, 15595),
-- hands
(54659, 68, @MAGE_DPS     + @OFFSET_HANDS_CLOTH, 0, 3163, 1, 0),
(54659, 69, @WARLOCK_DPS  + @OFFSET_HANDS_CLOTH, 0, 3163, 1, 0),
(54659, 70, @PRIEST_DPS   + @OFFSET_HANDS_CLOTH, 0, 3163, 1, 0),
(54659, 71, @PRIEST_HEAL  + @OFFSET_HANDS_CLOTH, 0, 3163, 1, 0),
