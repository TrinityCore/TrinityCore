...
-- Difficulty
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x10000000, `VerifiedBuild`=69587 WHERE (`Entry`=50089 AND `DifficultyID`=0); -- 50089 (Julak-Doom) - CanSwim
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x20000100, `StaticFlags3`=0x2000000, `VerifiedBuild`=69587 WHERE (`Entry`=50091 AND `DifficultyID`=0); -- 50091 (Julak-Doom) - Sessile, Floating - CannotTurn
UPDATE `creature_template_difficulty` SET `StaticFlags1`=0x20000100, `VerifiedBuild`=69587 WHERE (`Entry`=51247 AND `DifficultyID`=0); -- 51247 (Julak-Doom) - Sessile, Floating
