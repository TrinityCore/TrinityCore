...
DELETE FROM `script_texts` WHERE `npc_entry` = 15956;
...
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15956, 5, 0, 'Corpse Scarabs appears from a Crypt Guard\'s corpse!', 41, 0, 0, 0, 0, 0, 'Anub\'Rekhan EMOTE_CORPSE_SCARAB');

-- Grand Widow Faerlina
DELETE FROM `creature_text` WHERE `entry` = 15953;
DELETE FROM `script_texts` WHERE `npc_entry` = 15953;
...
DELETE FROM `script_texts` WHERE `npc_entry` = 15954;
...
DELETE FROM `script_texts` WHERE `npc_entry` = 15936;
...
DELETE FROM `script_texts` WHERE `npc_entry` = 16060;
...
DELETE FROM `script_texts` WHERE `npc_entry` = 16063;
...
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (16065, 1, 0, 'Tou... ché!', 14, 0, 0, 0, 0, 8893, 'Blaumeux SAY_DEATH');
...
DELETE FROM `script_texts` WHERE `npc_entry` = 16028;
...
DELETE FROM `script_texts` WHERE `npc_entry` = 15928;
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15928, 0, 0, 'You are too late... I... must... OBEY!', 14, 0, 0, 0, 0, 0, 'Thaddius SAY_GREET');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15928, 1, 0, 'EAT YOUR BONES!', 14, 0, 0, 0, 0, 0, 'Thaddius SAY_AGGRO');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15928, 1, 1, 'BREAK YOU!', 14, 0, 0, 0, 0, 0, 'Thaddius SAY_AGGRO');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15928, 1, 2, 'KILL!', 14, 0, 0, 0, 0, 0, 'Thaddius SAY_AGGRO');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15928, 2, 0, 'Thank... you...', 14, 0, 0, 0, 0, 0, 'Thaddius SAY_DEATH');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15928, 3, 0, 'Now you feel pain!', 14, 0, 0, 0, 0, 0, 'Thaddius SAY_ELECT');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15928, 4, 0, 'You die now!', 14, 0, 0, 0, 0, 0, 'Thaddius SAY_KILL');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15928, 5, 0, 'The polarity has shifted!', 41, 0, 0, 0, 0, 0, 'Thaddis EMOTE_SHIFT');

/* Thaddius */

-- Sapphiron
DELETE FROM `creature_text` WHERE `entry` = 15989;
DELETE FROM `script_texts` WHERE `npc_entry` = 15989;
...
DELETE FROM `script_texts` WHERE `npc_entry` = 15990;
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 0, 0, 'Minions, servants, soldiers of the cold dark, obey the call of Kel\'Thuzad!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_SUMMON');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 1, 0, 'Pray for mercy!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_AGGRO');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 1, 1, 'Scream your dying breath!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_AGGRO');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 1, 2, 'The end is upon you!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_AGGRO');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 2, 0, 'The dark void awaits you!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_KILL');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 2, 1, '%s cackles maniacally!', 16, 0, 0, 0, 0, 0, 'Kelthuzad SAY_KILL');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 3, 0, 'AAAAGHHH!... Do not rejoice... your victory is a hollow one... for I shall return with powers beyond your imagining!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_DEATH');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 4, 0, 'There will be no escape!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_CHAIN');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 4, 1, 'Your soul, is bound to me now!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_CHAIN');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 5, 0, 'I will freeze the blood in your veins!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_FROST_BLAST');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 6, 0, 'Your petty magics are no challenge to the might of the Scourge! ', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_SPECIAL');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 6, 1, 'Fools, you have spread your powers too thin. Be free, my minions!', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_SPECIAL');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 6, 2, 'Enough! I grow tired of these distractions! ', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_SPECIAL');
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (15990, 7, 0, 'Master! I require aid! ', 14, 0, 0, 0, 0, 0, 'Kelthuzad SAY_AID');
...
INSERT INTO `creature_text` (`entry`, `groupid`, `id`, `text`, `type`, `language`, `probability`, `emote`, `duration`, `sound`, `comment`) VALUES (37181, 10, 0, 'Very well... warriors of the frozen wastes, rise up! I command you to fight, kill, and die for your master. Let none survive...', 14, 0, 0, 0, 0, 0, 'Lichking SAY_ANSWER');
