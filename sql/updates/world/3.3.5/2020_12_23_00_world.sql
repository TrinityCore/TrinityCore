...
INSERT INTO `conditions` VALUES(15, 6001, 0, 0, 0, 8, 0, 7761, 0, 0, 0, 0, 0, '', 'Gossip Requires Quest 7761 rewarded');
DELETE FROM `gossip_menu` WHERE `MenuID` = 6001;
INSERT INTO `gossip_menu` (`MenuID`, `TextID`, `VerifiedBuild`) VALUES (6001, 7155, 0);

DELETE FROM `gossip_menu_option` WHERE `MenuID` = 6001;
INSERT INTO `gossip_menu_option` (`MenuID`, `OptionID`, `OptionIcon`, `OptionText`, `OptionBroadcastTextID`, `OptionType`, `OptionNpcFlag`, `ActionMenuID`, `ActionPoiID`, `BoxCoded`, `BoxMoney`, `BoxText`, `BoxBroadcastTextID`, `VerifiedBuild`) VALUES 
(6001, 0, 0, '<Place my hand on the orb.>', 9859, 1, 0, 0, 0, 0, 0, '', 0, 0);
