...
UPDATE `creature_template` SET `speed_walk`=2.5, `speed_run`=2.5, `unit_flags` = 33554434, `flags_extra`=0,`AIName`='', `ScriptName`='npc_pet_dk_rune_weapon' WHERE `entry`=27893;
