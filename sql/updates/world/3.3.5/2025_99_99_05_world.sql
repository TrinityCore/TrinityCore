DELETE FROM `world_state` WHERE `ID` IN (2436,2453,2454,2540,2541,2784,2842,3104,3106,3479,3480,3486,3504,3524,3581,3582,3583,3584,3585,3810,3815,3816,3931,3932,4116,4131,4131,4389,4390,4882,4884,4903,4904,4940,4941,4942,5049,5050,5051);
...
(4131,60,'603','','Ulduar - Algalon timer'),
(4132,0,'603','','Ulduar - Algalon timer enabled'),
