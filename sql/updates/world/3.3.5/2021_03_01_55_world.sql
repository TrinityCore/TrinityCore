...
UPDATE `instance_spawn_groups` SET `bossStateId` = 1 WHERE `instanceMapId` = 550 AND `bossStateId` = 2 AND `spawnGroupId` = 46;
UPDATE `instance_spawn_groups` SET `bossStateId` = 2 WHERE `instanceMapId` = 550 AND `bossStateId` = 3 AND `spawnGroupId` = 45;
