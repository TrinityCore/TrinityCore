DELETE FROM `spell_proc` WHERE `SpellId` IN (70672, 72455, 72832, 72833, 71564, 71756, 72782, 72783, 72784, 59915, 59906, -53569, -53695, 54939, 11129, -31656);
...
(-31656,  4, 3, 0x00000000, 0x00000000, 0x00000000,      0, 0x0, 0x2,    0, 0, 0, 0,      0, 0); -- Empowered Fire

DELETE FROM `spell_script_names` WHERE `ScriptName` IN ('spell_item_deadly_precision','spell_item_deadly_precision_dummy','spell_item_discerning_eye_beast_dummy','spell_item_swift_hand_justice_dummy','spell_pal_infusion_of_light','spell_pal_judgements_of_the_just','spell_pal_glyph_of_divinity','spell_mage_combustion');
