DELETE FROM `spell_proc` WHERE `SpellId` IN (-18213, -12834, 26467, 38164, 52420, 28845, 37594, 40971, -63156, 72176, -15337, 71770, 45057, 71634, 71640, 75475, 75481, -49182, -49188, -51627, -13983, -20234, 37168, -14156, 16864, 30823, 29601, 53646, 54909);
...
'spell_dru_omen_of_clarity','spell_sha_shamanistic_rage','spell_item_pendant_of_the_violet_eye','spell_warl_demonic_pact');
