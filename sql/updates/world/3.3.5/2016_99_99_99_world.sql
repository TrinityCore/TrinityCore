DELETE FROM `spell_proc` WHERE `SpellId` IN (-18213, -12834, 26467, 38164, 52420, 28845, 37594, 40971, -63156, 72176, -15337);
...
(-15337,   0,  6, 0x00002000, 0x00000002, 0x00000040,     0, 0x1, 0x2,    2, 0, 0, 0,      0, 0); -- Improved Spirit Tap
