...
(38164,   0,  0, 0x00000000, 0x00000000, 0x00000000,     0, 0x0, 0x0,    2, 0, 0, 0,   5000, 0); -- Unyielding Knights
...
DELETE FROM `conditions` WHERE `SourceTypeOrReferenceId`=17 AND `SourceGroup`=0 AND `SourceEntry`=38164;
INSERT INTO `conditions` (`SourceTypeOrReferenceId`,`SourceGroup`,`SourceEntry`,`SourceId`,`ElseGroup`,`ConditionTypeOrReference`,`ConditionTarget`,`ConditionValue1`,`ConditionValue2`,`ConditionValue3`,`NegativeCondition`,`ErrorType`,`ErrorTextId`,`ScriptName`,`Comment`) VALUES
(17,0,38164,0,0,31,1,3,19457,0,0,0,0,"","Spell Unyielding Knights can only hit selected target on condition");
