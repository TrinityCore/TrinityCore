DELETE FROM `spell_proc` WHERE `SpellId` IN (-18213, -12834, 26467, 38164, 52420, 28845, 37594, 40971, -63156, 72176, -15337, 71770, 45057, 71634, 71640, 75475, 75481, -49182, -49188, -51627, -13983);
...
'spell_item_corpse_tongue_coin_heroic','spell_item_petrified_twilight_scale','spell_item_petrified_twilight_scale_heroic','spell_dk_blade_barrier','spell_dk_rime','spell_rog_turn_the_tables','spell_rog_turn_the_tables_proc','spell_rog_setup');
