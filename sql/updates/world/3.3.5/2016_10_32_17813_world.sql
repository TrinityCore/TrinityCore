...
DELETE FROM `gossip_menu_option` WHERE `menu_id`= @Menu AND `id`= 1;
...
(@Menu, 1, 0, "I require a chrono-beacon, Sa'at.", 17881, 1, 1, 0, 0, 0, 0, '', 0, 0);

DELETE FROM `gossip_menu` WHERE `entry`= @Menu AND `text_id` IN (10000,10001,10002);
