...
ALTER TABLE `gossip_menu` CHANGE `text_id` `OptionIndex` mediumint(8) unsigned NOT NULL DEFAULT '0';

-- gossip_menu_option
ALTER TABLE `gossip_menu_option` CHANGE `entry` `MenuID` smallint(5) unsigned NOT NULL DEFAULT '0';
ALTER TABLE `gossip_menu_option` CHANGE `id` `OptionIndex` mediumint(8) unsigned NOT NULL DEFAULT '0';
...
CREATE TABLE IF NOT EXISTS `gossip_menu_option_locale` (
  ...
  `OptionIndex` mediumint(8) unsigned NOT NULL DEFAULT '0',
