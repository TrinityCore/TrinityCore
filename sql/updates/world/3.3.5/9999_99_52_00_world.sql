...
-- Add missing spells in Ghost ( Vengeful Spirit )
...
(22871, 3, 1, 'You will show the proper respect!', 14, 0, 100, 0, 0, 11520, 21105, 0, 'Teron SAY_INCINERATE2'),
(22871, 4, 0, 'Death really isn\t so bad.', 14, 0, 100, 0, 0, 11516, 21101, 0, 'Teron SAY_DOOM_BLOSSOM1'),
(22871, 4, 1, 'I have something for you...', 14, 0, 100, 0, 0, 11519, 21104, 0, 'Teron SAY_DOOM_BLOSSOM2'),
(22871, 5, 0, 'Give in.', 14, 0, 100, 0, 0, 11518, 21103, 0, 'Teron CRUSHING_SHADOWS'),
(22871, 6, 0, 'The wheel... spins... again.', 14, 0, 100, 0, 0, 11521, 21106, 0, 'Teron DEATH');
