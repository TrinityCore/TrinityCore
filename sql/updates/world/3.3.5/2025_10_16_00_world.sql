--
UPDATE `spell_dbc` SET `ProcChance` = 101, `Effect1` = 140, `EffectImplicitTargetA1` = 25, `RangeIndex`= 12,`EffectTriggerSpell1` = 47681 WHERE `Id` = 47680;
...
DELETE FROM `smart_scripts` WHERE `entryorguid` = 26811 AND `source_type` = 0 AND `id` IN (9,12,13);
