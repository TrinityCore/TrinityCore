...
CHANGE COLUMN `em0_0` `EmoteDelay0_0` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `Probabililty0`,
...
CHANGE COLUMN `em1_0` `EmoteDelay1_0` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `Probabililty1`,
...
CHANGE COLUMN `em2_0` `EmoteDelay2_0` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `Probabililty2`,
...
CHANGE COLUMN `em3_0` `EmoteDelay3_0` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `Probabililty3`,
...
CHANGE COLUMN `em4_0` `EmoteDelay4_0` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `Probabililty4`,
...
CHANGE COLUMN `em5_0` `EmoteDelay5_0` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `Probabililty5`,
...
CHANGE COLUMN `em6_0` `EmoteDelay6_0` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `Probabililty6`,
...
CHANGE COLUMN `em7_0` `EmoteDelay7_0` SMALLINT(5) UNSIGNED NOT NULL DEFAULT '0' AFTER `Probabililty7`,
