...
DELETE FROM `gossip_menu_option` WHERE `MenuID` IN (3067,3068,3069,3070,3071,3072) AND `OptionID` IN (1,2);
INSERT INTO `gossip_menu_option`(`MenuID`, `OptionID`, `OptionIcon`, `OptionText`, `OptionBroadcastTextID`, `OptionType`, `OptionNpcFlag`, `ActionMenuID`, `ActionPoiID`, `BoxCoded`, `BoxMoney`, `BoxText`, `BoxBroadcastTextID`, `VerifiedBuild`) VALUES
(3067, 1, 0, 'I am absolutely certain that I want to learn dragonscale leatherworking.', 11889, 0, 0, 0, 0, 0, 200000, NULL, 0, 0),
(3067, 2, 0, 'I wish to unlearn dragonscale leatherworking!', 18977, 0, 0, 0, 0, 0, 1500000, 'Forgetting dragonscale leatherworking is not something to do lightly.  If you choose to abandon it you will forget all recipes that require dragonscale leatherworking as well!', 18976, 0),
(3068, 1, 0, 'I am absolutely certain that I want to learn dragonscale leatherworking.', 11889, 0, 0, 0, 0, 0, 200000, NULL, 0, 0),
(3068, 2, 0, 'I wish to unlearn dragonscale leatherworking!', 18977, 0, 0, 0, 0, 0, 1500000, 'Forgetting dragonscale leatherworking is not something to do lightly.  If you choose to abandon it you will forget all recipes that require dragonscale leatherworking as well!', 18976, 0),
(3070, 1, 0, 'I am absolutely certain that I want to learn elemental leatherworking.', 11890, 0, 0, 0, 0, 0, 200000, NULL, 0, 0),
(3070, 2, 0, 'I wish to unlearn elemental leatherworking!', 18917, 0, 0, 0, 0, 0, 1500000, 'Forgetting elemental leatherworking is not something to do lightly.  If you choose to abandon it you will forget all recipes that require elemental leatherworking as well!', 18923, 0),
(3069, 1, 0, 'I am absolutely certain that I want to learn elemental leatherworking.', 11890, 0, 0, 0, 0, 0, 200000, NULL, 0, 0),
(3069, 2, 0, 'I wish to unlearn elemental leatherworking!', 18917, 0, 0, 0, 0, 0, 1500000, 'Forgetting elemental leatherworking is not something to do lightly.  If you choose to abandon it you will forget all recipes that require elemental leatherworking as well!', 18923, 0),
(3072, 1, 0, 'I am absolutely certain that I want to learn tribal leatherworking.', 11891, 0, 0, 0, 0, 0, 200000, NULL, 0, 0),
(3072, 2, 0, 'I wish to unlearn tribal leatherworking!', 18975, 0, 0, 0, 0, 0, 1500000, 'Forgetting tribal leatherworking is not something to do lightly.  If you choose to abandon it you will forget all recipes that require tribal leatherworking as well!', 18974, 0),
(3071, 1, 0, 'I am absolutely certain that I want to learn tribal leatherworking.', 11891, 0, 0, 0, 0, 0, 200000, NULL, 0, 0),
(3071, 2, 0, 'I wish to unlearn tribal leatherworking!', 18975, 0, 0, 0, 0, 0, 1500000, 'Forgetting tribal leatherworking is not something to do lightly.  If you choose to abandon it you will forget all recipes that require tribal leatherworking as well!', 18974, 0);

-- npc professions blacksmithing
DELETE FROM `gossip_menu_option` WHERE `MenuID` IN (3182,3201,3187,3202,6090,6089,6091) AND `OptionID` IN (1,2);
DELETE FROM `gossip_menu_option` WHERE `MenuID` IN (597,3203) AND `OptionID` IN (1);
INSERT INTO `gossip_menu_option`(`MenuID`, `OptionID`, `OptionIcon`, `OptionText`, `OptionBroadcastTextID`, `OptionType`, `OptionNpcFlag`, `ActionMenuID`, `ActionPoiID`, `BoxCoded`, `BoxMoney`, `BoxText`, `BoxBroadcastTextID`, `VerifiedBuild`) VALUES
...
(3201, 1, 0, 'I wish to unlearn Weaponsmithing!', 19007, 0, 0, 0, 0, 0, 100000, 'Forgetting your Weaponsmithing skill is not something to do lightly.  If you choose to abandon it you will forget all recipes that require Weaponsmithing to create!', 19008, 0),
(3202, 1, 0, 'I wish to unlearn Weaponsmithing!', 19007, 0, 0, 0, 0, 0, 100000, 'Forgetting your Weaponsmithing skill is not something to do lightly.  If you choose to abandon it you will forget all recipes that require Weaponsmithing to create!', 19008, 0),
(597, 1, 0, 'I wish to unlearn Armorsmithing!', 19010, 0, 0, 0, 0, 0, 100000, 'Forgetting your Armorsmithing skill is not something to do lightly.  If you choose to abandon it you will forget all recipes that require Armorsmithing to create!', 19011, 0),
(3203, 1, 0, 'I wish to unlearn Armorsmithing!', 19010, 0, 0, 0, 0, 0, 100000, 'Forgetting your Armorsmithing skill is not something to do lightly.  If you choose to abandon it you will forget all recipes that require Armorsmithing to create!', 19011, 0),
(6090, 1, 0, 'Please teach me how to become a hammersmith, Lilith.', 9988, 0, 0, 0, 0, 0, 0, NULL, 0, 0),
(6090, 2, 0, 'I wish to unlearn Hammersmithing!', 18990, 0, 0, 0, 0, 0, 1000000, 'Forgetting your Hammersmithing skill is not something to do lightly.  If you choose to abandon it you will forget all recipes that require Hammersmithing to create!', 18991, 0),
(6089, 1, 0, 'Please teach me how to become an axesmith, Kilram.', 9985, 0, 0, 0, 0, 0, 0, NULL, 0, 0),
(6089, 2, 0, 'I wish to unlearn Axesmithing!', 18986, 0, 0, 0, 0, 0, 1000000, 'Forgetting your Axesmithing skill is not something to do lightly.  If you choose to abandon it you will forget all recipes that require Axesmithing to create!', 18987, 0),
