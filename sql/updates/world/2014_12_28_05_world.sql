...
UPDATE `quest_template` SET `MinLevel` = 0 WHERE `MinLevel` < 0;
...
ALTER TABLE `quest_template` CHANGE `RewardFactionValueId1` `RewardFactionValue1` INT(10) SIGNED NOT NULL DEFAULT '0' AFTER `RewardFactionID1`;
...
ALTER TABLE `quest_template` CHANGE `RewardFactionValueId2` `RewardFactionValue2` INT(10) SIGNED NOT NULL DEFAULT '0' AFTER `RewardFactionID2`;
...
ALTER TABLE `quest_template` CHANGE `RewardFactionValueId3` `RewardFactionValue3` INT(10) SIGNED NOT NULL DEFAULT '0' AFTER `RewardFactionID3`;
...
ALTER TABLE `quest_template` CHANGE `RewardFactionValueId4` `RewardFactionValue4` INT(10) SIGNED NOT NULL DEFAULT '0' AFTER `RewardFactionID4`;
...
ALTER TABLE `quest_template` CHANGE `RewardFactionValueId5` `RewardFactionValue5` INT(10) SIGNED NOT NULL DEFAULT '0' AFTER `RewardFactionID5`;
