...
('reset arenaseason', 901, 'Syntax: .reset arenaseason [delete]\nReset all rating and seasonGames/Wins, weekGames/Wins at the default values. With [delete] all teams will be deleted. This command works only without arena season inProgress (you can modify it by conf)');
