...
INSERT INTO `trinity_string` (`entry`, `content_default`, `content_loc8`) VALUES ('11005', '', 'Розыгрыш состоялся! Всего участвовало ставок: %u. Выигрышной оказалась комбинация %u %u %u %u %u. Джекпот, который на данный момент составляет %f ед. золота, разыгран не был.');
INSERT INTO `trinity_string` (`entry`, `content_default`, `content_loc8`) VALUES ('11006', '', 'Розыгрыш состоялся! Всего участвовало ставок: %u. Выигрышной оказалась комбинация %u %u %u %u %u. Джекпот в %f единиц золота выигран игроком %s.');
INSERT INTO `trinity_string` (`entry`, `content_default`, `content_loc8`) VALUES ('11007', '', 'Розыгрыш состоялся! Всего участвовало ставок: %u. Выигрышной оказалась комбинация %u %u %u %u %u. Джекпот в %f единиц золота разделило %u игроков.');
