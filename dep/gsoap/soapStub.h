...
public:
	int soap_type() const { return 9; } /* = unique id SOAP_TYPE_ns1__executeCommandResponse */
};
#endif
...
public:
	int soap_type() const { return 10; } /* = unique id SOAP_TYPE_ns1__executeCommand */
};
#endif
...
{
public:
	int soap_type() const { return 11; } /* = unique id SOAP_TYPE_SOAP_ENV__Header */
...
public:
	int soap_type() const { return 12; } /* = unique id SOAP_TYPE_SOAP_ENV__Code */
};
#endif
...
public:
	int soap_type() const { return 14; } /* = unique id SOAP_TYPE_SOAP_ENV__Detail */
};
#endif
...
public:
	int soap_type() const { return 17; } /* = unique id SOAP_TYPE_SOAP_ENV__Reason */
};
#endif
...
public:
	int soap_type() const { return 18; } /* = unique id SOAP_TYPE_SOAP_ENV__Fault */
};
#endif
