...
public:
    ...
    ChatCommandTable GetCommands() const override
    {
        ...
        {
            { "cinematic",          HandleDebugPlayCinematicCommand,   rbac::RBAC_PERM_COMMAND_DEBUG_PLAY_CINEMATIC, Console::No },
            { "movie",              HandleDebugPlayMovieCommand,       rbac::RBAC_PERM_COMMAND_DEBUG_PLAY_MOVIE,     Console::No },
            { "sound",              HandleDebugPlaySoundCommand,       rbac::RBAC_PERM_COMMAND_DEBUG_PLAY_SOUND,     Console::No },
            { "music",              HandleDebugPlayMusicCommand,       rbac::RBAC_PERM_COMMAND_DEBUG_PLAY_MUSIC,     Console::No },
        };
        static ChatCommandTable debugSendCommandTable =
        {
            { "buyerror",           HandleDebugSendBuyErrorCommand,        rbac::RBAC_PERM_COMMAND_DEBUG_SEND_BUYERROR,      Console::No },
            { "channelnotify",      HandleDebugSendChannelNotifyCommand,   rbac::RBAC_PERM_COMMAND_DEBUG_SEND_CHANNELNOTIFY, Console::No },
            { "chatmessage",        HandleDebugSendChatMsgCommand,         rbac::RBAC_PERM_COMMAND_DEBUG_SEND_CHATMESSAGE,   Console::No },
            { "equiperror",         HandleDebugSendEquipErrorCommand,      rbac::RBAC_PERM_COMMAND_DEBUG_SEND_EQUIPERROR,    Console::No },
            { "largepacket",        HandleDebugSendLargePacketCommand,     rbac::RBAC_PERM_COMMAND_DEBUG_SEND_LARGEPACKET,   Console::No },
            { "opcode",             HandleDebugSendOpcodeCommand,          rbac::RBAC_PERM_COMMAND_DEBUG_SEND_OPCODE,        Console::No },
            { "qpartymsg",          HandleDebugSendQuestPartyMsgCommand,   rbac::RBAC_PERM_COMMAND_DEBUG_SEND_QPARTYMSG,     Console::No },
            { "qinvalidmsg",        HandleDebugSendQuestInvalidMsgCommand, rbac::RBAC_PERM_COMMAND_DEBUG_SEND_QINVALIDMSG,   Console::No },
            { "sellerror",          HandleDebugSendSellErrorCommand,       rbac::RBAC_PERM_COMMAND_DEBUG_SEND_SELLERROR,     Console::No },
            { "setphaseshift",      HandleDebugSendSetPhaseShiftCommand,   rbac::RBAC_PERM_COMMAND_DEBUG_SEND_SETPHASESHIFT, Console::No },
            { "spellfail",          HandleDebugSendSpellFailCommand,       rbac::RBAC_PERM_COMMAND_DEBUG_SEND_SPELLFAIL,     Console::No },
        };
        static ChatCommandTable debugCommandTable =
        {
            { "setbit",             HandleDebugSet32BitCommand,            rbac::RBAC_PERM_COMMAND_DEBUG_SETBIT,        Console::No },
            { "threat",             HandleDebugThreatListCommand,          rbac::RBAC_PERM_COMMAND_DEBUG_THREAT,        Console::No },
            { "threatinfo",         HandleDebugThreatInfoCommand,          rbac::RBAC_PERM_COMMAND_DEBUG_THREATINFO,    Console::No },
            { "combat",             HandleDebugCombatListCommand,          rbac::RBAC_PERM_COMMAND_DEBUG_COMBAT,        Console::No },
            { "anim",               HandleDebugAnimCommand,                rbac::RBAC_PERM_COMMAND_DEBUG_ANIM,          Console::No },
            { "arena",              HandleDebugArenaCommand,               rbac::RBAC_PERM_COMMAND_DEBUG_ARENA,         Console::Yes },
            { "bg",                 HandleDebugBattlegroundCommand,        rbac::RBAC_PERM_COMMAND_DEBUG_BG,            Console::Yes },
            { "getitemstate",       HandleDebugGetItemStateCommand,        rbac::RBAC_PERM_COMMAND_DEBUG_GETITEMSTATE,  Console::No },
            { "lootrecipient",      HandleDebugGetLootRecipientCommand,    rbac::RBAC_PERM_COMMAND_DEBUG_LOOTRECIPIENT, Console::No },
            { "getvalue",           HandleDebugGetValueCommand,            rbac::RBAC_PERM_COMMAND_DEBUG_GETVALUE,      Console::No },
            { "getitemvalue",       HandleDebugGetItemValueCommand,        rbac::RBAC_PERM_COMMAND_DEBUG_GETITEMVALUE,  Console::No },
            { "Mod32Value",         HandleDebugMod32ValueCommand,          rbac::RBAC_PERM_COMMAND_DEBUG_MOD32VALUE,    Console::No },
            { "play",               debugPlayCommandTable },
            { "send",               debugSendCommandTable },
            { "setaurastate",       HandleDebugSetAuraStateCommand,        rbac::RBAC_PERM_COMMAND_DEBUG_SETAURASTATE,  Console::No },
            { "setitemvalue",       HandleDebugSetItemValueCommand,        rbac::RBAC_PERM_COMMAND_DEBUG_SETITEMVALUE,  Console::No },
            { "setvalue",           HandleDebugSetValueCommand,            rbac::RBAC_PERM_COMMAND_DEBUG_SETVALUE,      Console::No },
            { "spawnvehicle",       HandleDebugSpawnVehicleCommand,        rbac::RBAC_PERM_COMMAND_DEBUG_SPAWNVEHICLE,  Console::No },
            { "entervehicle",       HandleDebugEnterVehicleCommand,        rbac::RBAC_PERM_COMMAND_DEBUG_ENTERVEHICLE,  Console::No },
            { "worldstate",         HandleDebugUpdateWorldStateCommand,    rbac::RBAC_PERM_COMMAND_DEBUG_WORLDSTATE,    Console::No },
            { "update",             HandleDebugUpdateCommand,              rbac::RBAC_PERM_COMMAND_DEBUG_UPDATE,        Console::No },
            { "itemexpire",         HandleDebugItemExpireCommand,          rbac::RBAC_PERM_COMMAND_DEBUG_ITEMEXPIRE,    Console::No },
            { "areatriggers",       HandleDebugAreaTriggersCommand,        rbac::RBAC_PERM_COMMAND_DEBUG_AREATRIGGERS,  Console::No },
            { "los",                HandleDebugLoSCommand,                 rbac::RBAC_PERM_COMMAND_DEBUG_LOS,           Console::No },
            { "moveflags",          HandleDebugMoveflagsCommand,           rbac::RBAC_PERM_COMMAND_DEBUG_MOVEFLAGS,     Console::No },
            { "transport",          HandleDebugTransportCommand,           rbac::RBAC_PERM_COMMAND_DEBUG_TRANSPORT,     Console::No },
            { "loadcells",          HandleDebugLoadCellsCommand,           rbac::RBAC_PERM_COMMAND_DEBUG_LOADCELLS,     Console::No },
            { "boundary",           HandleDebugBoundaryCommand,            rbac::RBAC_PERM_COMMAND_DEBUG_BOUNDARY,      Console::No },
            { "raidreset",          HandleDebugRaidResetCommand,           rbac::RBAC_PERM_COMMAND_INSTANCE_UNBIND,     Console::No },
            { "neargraveyard",      HandleDebugNearGraveyard,              rbac::RBAC_PERM_COMMAND_NEARGRAVEYARD,       Console::No },
            { "instancespawn",      HandleDebugInstanceSpawns,             rbac::RBAC_PERM_COMMAND_DEBUG_INSTANCESPAWN, Console::No },
            { "dummy",              HandleDebugDummyCommand,               rbac::RBAC_PERM_COMMAND_DEBUG_DUMMY,         Console::No },
            { "asan memoryleak",    HandleDebugMemoryLeak,                 rbac::RBAC_PERM_COMMAND_DEBUG_ASAN,          Console::Yes },
            { "asan outofbounds",   HandleDebugOutOfBounds,                rbac::RBAC_PERM_COMMAND_DEBUG_ASAN,          Console::Yes },
            ...
            { "questreset",         HandleDebugQuestResetCommand,          rbac::RBAC_PERM_COMMAND_DEBUG_QUESTRESET,    Console::Yes },
            { "warden force",       HandleDebugWardenForce,                rbac::RBAC_PERM_COMMAND_DEBUG,               Console::Yes }
        };
        static ChatCommandTable commandTable =
        {
            { "debug",              debugCommandTable },
            { "wpgps",              HandleWPGPSCommand,                    rbac::RBAC_PERM_COMMAND_WPGPS,               Console::No },
        };
        return commandTable;
    }
