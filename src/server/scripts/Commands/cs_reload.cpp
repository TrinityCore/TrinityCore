...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "GreenPis_string",               SEC_ADMINISTRATOR, true,  &HandleReloadGreenPisStringCommand,              "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadGreenPisStringCommand(handler, "");
    ...
    static bool HandleReloadGreenPisStringCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading GreenPis_string Table!");
        sObjectMgr->LoadGreenPisStrings();
        handler->SendGlobalGMSysMessage("DB table `GreenPis_string` reloaded.");
        return true;
    }
