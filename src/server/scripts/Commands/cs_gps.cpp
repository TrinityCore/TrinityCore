...
public:
    ...
    static bool HandleGPSCommand(ChatHandler* handler, char const* args)
    {
        ...
        CellPair cellPair = Trinity::ComputeCellPair(object->GetPositionX(), object->GetPositionY());
        Cell cell(cellPair);
        ...
        GridPair gridPair = Trinity::ComputeGridPair(object->GetPositionX(), object->GetPositionY());

        // 63? WHY?
        int gridX = 63 - gridPair.x_coord;
        int gridY = 63 - gridPair.y_coord;
