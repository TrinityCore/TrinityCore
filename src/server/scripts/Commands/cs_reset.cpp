...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        ...
        {
            { "honorworld",   rbac::RBAC_PERM_COMMAND_RESET_HONORWORLD,  true, &HandleResetHonorWorldCommand,   "", NULL },
            { "arenaworld",   rbac::RBAC_PERM_COMMAND_RESET_ARENAWORLD,  true, &HandleResetArenaWorldCommand,   "", NULL },
    ...
    static bool HandleResetArenaWorldCommand(ChatHandler*, const char * args)
    {
    ...
    static bool HandleResetHonorWorldCommand(ChatHandler*, const char * args)
    {
        SQLTransaction trans = CharacterDatabase.BeginTransaction();
