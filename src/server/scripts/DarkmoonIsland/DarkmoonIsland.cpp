...
public:
    ...
    struct npc_rinlingAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            //Map::PlayerList const& PlayerList = me->GetMap()->GetPlayers();//DID N'T USE
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_SHOOTGALLERY_START_GAME:
                    ...
                    {
                    case 0:
                        if (TempSummon* summon = me->SummonCreature(54231, -4072.19f, 6356.46f, 13.35f, 4.21f, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(5000)))
                            summon->CastSpell(summon, 102341, false);
                        
                        me->SummonCreature(54225, -4070.09f, 6354.87f, 12.57f, 4.21f, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(5000));
                        me->SummonCreature(54225, -4068.41f, 6353.09f, 13.24f, 4.21f, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(5000));
                        break;
                    case 1:
                        me->SummonCreature(54225, -4072.19f, 6356.46f, 13.35f, 4.21f, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(5000));

                        if (Creature* summon = me->SummonCreature(54231, -4070.09f, 6354.87f, 12.57f, 4.21f, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(5000)))
                            summon->CastSpell(summon, 102341, false);

                        me->SummonCreature(54225, -4068.41f, 6353.09f, 12.24f, 4.21f, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(5000));
                        break;
                    case 2:
                        me->SummonCreature(54225, -4072.19f, 6356.46f, 13.35f, 4.21f, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(5000));
                        me->SummonCreature(54225, -4070.09f, 6354.87f, 12.57f, 4.21f, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(5000));

                        if (Creature* summon = me->SummonCreature(54231, -4068.41f, 6353.09f, 13.24f, 4.21f, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(5000)))
                            summon->CastSpell(summon, 102341, false);
...
public:
    ...
    class spell_gen_repair_damaged_tonk_SpellScript : public SpellScript
    {
        ...
        void HandleDummy(SpellEffIndex /*effIndex*/)
        {
            ...
            target->SummonCreature(55356, myPos, TEMPSUMMON_TIMED_DESPAWN, Milliseconds(30000));
    ...
    class spell_heal_injuried_carnie_SpellScript : public SpellScript
    {
        ...
        void HandleHealPct(SpellEffIndex /*effIndex*/)
        {
            ...
            case 0:
                ...
                target->HandleEmoteCommand(EMOTE_ONESHOT_NONE);// 0 before
                target->GetMotionMaster()->MoveRandom(30);
                target->DespawnOrUnsummon(Milliseconds(8000));
                break;
            case 1:
...
public:
    ...
    class spell_put_up_darkmoon_banner_SpellScript : public SpellScript
    {
        ...
        void HandleDummy(SpellEffIndex /*effIndex*/)
        {
            ...
            {
                loosestones->SummonGameObject(179965, Position(loosestones->GetPositionX(), loosestones->GetPositionY(), loosestones->GetPositionZ(), loosestones->GetOrientation()), QuaternionData(),Seconds(0));
                loosestones->DespawnOrUnsummon(Milliseconds(30000));
            }
        }
