    ...
    public:
        ...
        struct boss_nalorakkAI : public ScriptedAI
        {
                        ...
                        if (!inMove)
                        {
                            switch (MovePhase)
                            {
                                case 0:
                                    ...
                                    {
                                        me->MonsterYell(YELL_NALORAKK_WAVE1, me->getGender(), LANG_UNIVERSAL, NULL);
                                ...
                                case 2:
                                    ...
                                    {
                                        me->MonsterYell(YELL_NALORAKK_WAVE2, me->getGender(), LANG_UNIVERSAL, NULL);
                                ...
                                case 5:
                                    if (me->IsWithinDistInMap(who, 40))
                                    {
                                        me->MonsterYell(YELL_NALORAKK_WAVE3, me->getGender(), LANG_UNIVERSAL, NULL);
                                ...
                                case 7:
                                    if (me->IsWithinDistInMap(who, 50))
                                    {
                                        ...
                                        me->MonsterYell(YELL_NALORAKK_WAVE4, me->getGender(), LANG_UNIVERSAL, NULL);
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                ...
                me->MonsterYell(YELL_AGGRO, me->getGender(), LANG_UNIVERSAL, NULL);
            ...
            void JustDied(Unit* /*killer*/) override
            {
                ...
                me->MonsterYell(YELL_DEATH, me->getGender(), LANG_UNIVERSAL, NULL);
            ...
            void KilledUnit(Unit* /*victim*/) override
            {
                ...
                {
                    case 0:
                        me->MonsterYell(YELL_KILL_ONE, me->getGender(), LANG_UNIVERSAL, NULL);
                        DoPlaySoundToSet(me, SOUND_YELL_KILL_ONE);
                        break;
                    case 1:
                        me->MonsterYell(YELL_KILL_TWO, me->getGender(), LANG_UNIVERSAL, NULL);
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                if (Berserk_Timer <= diff)
                {
                    ...
                    me->MonsterYell(YELL_BERSERK, me->getGender(), LANG_UNIVERSAL, NULL);
                ...
                if (ShapeShift_Timer <= diff)
                {
                    if (inBearForm)
                    {
                        ...
                        me->MonsterYell(YELL_SHIFTEDTOTROLL, me->getGender(), LANG_UNIVERSAL, NULL);
                    ...
                    else
                    {
                        ...
                        me->MonsterYell(YELL_SHIFTEDTOBEAR, me->getGender(), LANG_UNIVERSAL, NULL);
                ...
                if (!inBearForm)
                {
                    ...
                    if (Surge_Timer <= diff)
                    {
                        me->MonsterYell(YELL_SURGE, me->getGender(), LANG_UNIVERSAL, NULL);
