...
static constexpr Position UpstairsPointR  = { -55.058910f, 1147.5952f, 18.705223f, 0.0f };
static constexpr Position UpstairsPointL  = { -55.047302f, 1153.5929f, 18.705204f, 0.0f };
static constexpr Position HatchEggsPointR = { -34.438860f, 1104.4828f, 18.711473f, 0.0f };
static constexpr Position HatchEggsPointL = { -34.767784f, 1192.8434f, 18.711363f, 0.0f };
...
struct boss_janalai : public BossAI
{
    ...
    {
        return GetClosestCreatureWithOptions(me, 200.0f, { .CreatureId = NPC_DRAGONHAWK_EGG, .IsAlive = FindCreatureAliveState::Alive }) == nullptr;
    }
...
{
    npc_amanishi_hatcher(Creature* creature) : ScriptedAI(creature), _otherHatcherId(0) { }
    ...
    {
        return GetClosestCreatureWithOptions(me, 200.0f, { .StringId = _eggsStringIdA, .IsAlive = FindCreatureAliveState::Alive }) == nullptr;
    }

    bool AreEggsHatchedB()
    {
        return GetClosestCreatureWithOptions(me, 200.0f, { .StringId = _eggsStringIdB, .IsAlive = FindCreatureAliveState::Alive }) == nullptr;
    }
