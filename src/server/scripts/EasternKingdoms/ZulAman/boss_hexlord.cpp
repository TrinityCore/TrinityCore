    ...
    public:
        ...
        struct boss_hex_lord_malacrassAI : public BossAI
        {
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                {
                    Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 70, true);
        ...
        struct boss_alyson_antilleAI : public boss_hexlord_addAI
        {
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                if (urand(0, 1))
                {
                    ...
                    me->CastSpell(SelectUnit(SelectAggroTarget::Random, 0), SPELL_DISPEL_MAGIC, false);
    ...
    public:
        ...
        struct boss_slitherAI : public boss_hexlord_addAI
        {
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                {
                    if (Unit* victim = SelectTarget(SelectAggroTarget::Random, 0, 100, true))
