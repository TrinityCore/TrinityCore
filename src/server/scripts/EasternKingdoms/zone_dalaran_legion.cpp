...
//    {
//        //tmp        player->SeamlessTeleportToMap(MAP_DALARAN_UNDERBELLY);
//    }
//
//    void OnPlayerExit(Player* player) 
//    {
//        //if (player->GetMapId() == MAP_DALARAN_UNDERBELLY)
//        //    player->SeamlessTeleportToMap(MAP_BROKEN_ISLANDS);//tmp
//    }
//};
//
//enum
...
//        {
//            // TODO : Remove this line when phasing is done properly
// //tmp           creature->DestroyForPlayer(player);
//        }
//    }
//};
//
...
//    }
///*
//    void OnCheckPhase(Player* player) A袮DIR FUNCIONES
//    { 
...
//            //    npc->AddNpcFlag(UNIT_NPC_FLAG_SPELLCLICK);//tmp
//        }
//        if (quest->GetQuestId() == 39987)
//        {
//            //player->SummonGameObject(244874, Position(-851.257f, 4631.811f, 749.6389f, 1.389102f), QuaternionData(0.0f, 0.0f, 0.6400404f, 0.7683412f), 60000);//tmp
//            Talk(2);
//        }
...
//    {
//        //if (Player* player = clicker->ToPlayer())//tmp
//        //{
...
//            //me->GetScheduler().Schedule(1s, [this](TaskContext /*context*/)//tmp
//            {
