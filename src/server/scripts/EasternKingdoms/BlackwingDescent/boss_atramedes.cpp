...
enum Spells
{
    ...
    SPELL_SONAR_BOMB_N         = 92553,
    SPELL_SONAR_BOMB_H         = 92556,
    ...
    SPELL_SONAR_PULSE_N        = 77674,
    SPELL_SONAR_PULSE_H        = 77674,
    ...
    SPELL_ROARING_FLAME_BREATH_DUMMY    = 78221,
    SPELL_ROARING_FLAME_BREATH_DAMAGE   = 78353,
    SPELL_ROARING_FLAME_PERIODIC        = 78018,
    SPELL_ROARING_FLAME_SUMMON          = 78555,

    // Gongs
    SPELL_RESONATING_DRAGON             = 77611,
    SPELL_VERTIGO                       = 77717,
    // Gong ring
    SPELL_RESONATING_PLAYER             = 78168,
    SPELL_RESONATING_PLAYER_POWER       = 77709,
    SPELL_NOISY                         = 78897,
...
public:
    ...
    struct boss_atramedesAI : public BossAI
    {
        ...
        {
            if(instance)
				instance->DoCastSpellOnPlayers(SPELL_SOUND_AURA);
        }
