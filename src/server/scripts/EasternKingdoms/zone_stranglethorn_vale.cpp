...
enum Yenniku
{
    ...
    //FACTION_TROLL_BLOODSCALP = 28     //Duplicate defination in SharedDefines.h
};
...
public:
    ...
    struct npc_yennikuAI : public ScriptedAI
    {
        ...
        //            me->GetThreatManager().ClearThreat(player);           // unsure of this    //DeleteThreatList-->org
            ...
            if (bReset)
            {
                ...
                if (me->IsInCombat() && me->GetVictim())
                {
                    if (Player* player = me->EnsureVictim()->ToPlayer())
                    {
                        ...
                        {
                            me->CombatStop();
                            me->GetThreatManager().ClearThreat(player);
                        }
                    }
                }
             }
