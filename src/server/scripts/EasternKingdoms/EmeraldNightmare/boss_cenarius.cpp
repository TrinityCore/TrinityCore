...
//            case EVENT_2:
//            {
//                    me->CastSpell(me, alies ? SPELL_SUM_ALLIES_WISPS : SPELL_SUM_NIGHTMARE_WISPS, true, 0, 0, ownerGuid);
//                break;
//            }
//            case EVENT_3:
...
//        if (!pTarget)
//            pTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 100.0f, true, false);
//
//        if (pTarget)
//        {
//            switchTarget = true;
//            ResetThreat(pTarget);
//            AddThreat(pTarget, 10000.0f);
//            AttackStart(pTarget);
