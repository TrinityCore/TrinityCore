...
//        me->SetVisible(false);
//        me->CastSpell(me, SPELL_DRUID_TRANSFORM, true);
//
...
//        {
//            fakeBoss->SetUnitFlags(UNIT_FLAG_NON_ATTACKABLE);
//            fakeBoss->SetUnitFlags(UNIT_FLAG_IMMUNE_TO_PC);
//            fakeBoss->SetUnitFlags(UNIT_FLAG_NOT_SELECTABLE);
...
//        me->GetAreaTriggerListWithSpellIDInRange(list, 11547, 222.0f); //NECROTIC_VENOM - 213123
//        for (auto at : list)
//            at->Remove();
//
...
//            me->GetMotionMaster()->MoveCharge(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ() + 32.0f);
//            break;
...
//            me->GetMotionMaster()->MoveCharge(target->GetPositionX(), target->GetPositionY(), me->GetPositionZ());
//            break;
...
//                me->CastSpell(victim, SPELL_RAKING_TALONS_2, false);
//        }
//    }
//
...
//                me->SetReactState(REACT_AGGRESSIVE);
//                if (IsMythicRaid())
//                    me->CastSpell(me, SPELL_TANGLED_WEBS_AT, true);
//                break;
//            }
//        }
...
//                me->RemoveDynObject(SPELL_DARK_STORM_AT);
...
//                me->CastSpell(me->GetVictim(), SPELL_RAKING_TALONS);
...
//                {
//                    if (Unit* plr = me->SelectNearestPlayer(5.0f))
...
//                if (Unit* target = SelectTarget(SELECT_TARGET_MAXTHREAT))
//                {
//                    me->CastSpell(target, 222996, false);
//                    me->CastSpell(target, 222996, false);
//                }
...
//            return;
//
//        GetCaster()->GetInstanceScript()->DoOnPlayers([this](Player* player)
//        {
...
//            return;
//
//        GetTarget()->CastSpell(GetTarget(), GetSpellInfo()->GetEffect(EFFECT_0)->BasePoints, true, nullptr, nullptr, GetCaster()->GetGUID());
//    }
//
//    void Register() override
//    {
