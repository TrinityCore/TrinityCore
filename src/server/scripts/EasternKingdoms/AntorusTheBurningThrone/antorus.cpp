...
struct npc_atbt_flamewear : public ScriptedAI
{
    ...
    void JustEngagedWith(Unit* who) override
    {
        ...
        //events.RescheduleEvent(EVENT_2, 10000);//tmp
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        if (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_1:
                DoCast(252614);
                //events.RescheduleEvent(EVENT_1, 3500);//tmp
                break;
            case EVENT_2:
                targs.clear();
                DoCast(252621);
                //events.RescheduleEvent(EVENT_2, urand(1000, 14000));//tmp
                break;
            }
        }
...
struct npc_atbt_battleship_controller : public ScriptedAI
{
    ...
    void MoveInLineOfSight(Unit* who) override
    {
        ...
        //events.RescheduleEvent(EVENT_1, 3000);//tmp
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        if (uint32 eventId = events.ExecuteEvent())
        {
            ...
            case EVENT_1:
                ...
                //events.RescheduleEvent(EVENT_1, urand(3000, 5000));//tmp
                break;
            }
        }
    }
...
//                    me->CastSpell(x, y, -115.73f, 249933, true);//tmp
                });
            }
        });
    }
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* me)  
    {
        ...
        if (isDone && me->GetEntry() != 128303)
            //tmp            AddGossipItemFor(player, 0, "Imonar", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);

        if (me->GetEntry() != 125720)
            //tmp            AddGossipItemFor(player, 0, "Start", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
        ...
        if (me->GetEntry() != 128304)
           // AddGossipItemFor(player, 0, "Varithmas", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);//tmp
...
class spell_atbt_soulburn : public AuraScript
{
    ...
    void OnRemove(AuraEffect const* aurEff, AuraEffectHandleModes mode)
    {
        ...
        //tmp        Trinity::Containers::RandomResize(players, 5);
