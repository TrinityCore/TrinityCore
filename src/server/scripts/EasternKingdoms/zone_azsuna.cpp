...
//                //tmp              _events.ScheduleEvent(EVENT_SAY_HURRY, 300);
//                break;
//            default:
//                break;
//            }
...
//                {
//                case 6:
//                    //tmp             _events.ScheduleEvent(EVENT_DESPAWN, 1000);
//                    break;
//                default:
//                    break;
//                }
...
//                    me->AI()->Talk(1);
//                    //tmp                 _events.ScheduleEvent(EVENT_TRANSFORM, 1000);
//                    break;
//                case EVENT_TRANSFORM:
//                    DoCast(me, SPELL_TRANSFORM_KHADGAR_RAVEN, true);
//                    //tmp               _events.ScheduleEvent(EVENT_MOVE_CAMP, 300);
//                    break;
...
//            return;*/
//
//            //tmp    std::list<Creature*> targets = me->FindAllCreaturesInRange(100.0f);
//
...
//            //tmp AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Please, show me where the Tidestone lies.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
//
...
//            //tmp           events.ScheduleEvent(EVENT_WAYPOINT_REACHED, 1000);
...
//
//                //tmp            events.ScheduleEvent(EVENT_FIREBALL, 5000);
//                break;
//            }
//
...
//                //tmp             events.ScheduleEvent(EVENT_METEOR_STORM, 2000);
//                break;
//            }
//
...
//            //tmp           creature->RemoveUnitFlag(UNIT_FLAG_UNK_15);
//
...
//                return true;
//
//            //tmp           AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_ACCEPT_DUEL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
...
//            CombatAI::Reset();
//
//            //tmp            me->AddUnitFlag(UNIT_FLAG_UNK_15);
//
...
//            if (Player* player = who->ToPlayer())
//            {
//                //if (player->GetQuestObjectiveData(42271, 4))//tmp
...
//        {
//            ResummonAdds = false;
//            //tmp            events.RescheduleEvent(1, 3000); // 234497
//        }
//
...
//                case 1:
//                    DoCast(234497);
//                    //tmp                   events.RescheduleEvent(1, 3000);
//                    break;
//                }
//            }
//            DoMeleeAttackIfReady();
...
//    //tmp    new go_sabotaged_portal_stabilizer();
...
//    //new go_fel_power_run244706();//tmp
