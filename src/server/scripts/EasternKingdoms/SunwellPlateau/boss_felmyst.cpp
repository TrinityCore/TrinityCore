    ...
    struct boss_felmystAI : public ScriptedAI
    {
        ...
        void HandleFlightSequence()
        {
            switch (uiFlightCount)
            {
                ...
                case 2:
                {
                    Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 150, true);
                    if (!target)
                ...
                case 8:
                    ...
                    break;
                case 9:
                    if (Unit* target = SelectTarget(SelectAggroTarget::MaxThreat))
                ...
                case 10:
                    ...
                    EnterPhase(PHASE_GROUND);
                    AttackStart(SelectTarget(SelectAggroTarget::MaxThreat));
                    break;
            }
            ++uiFlightCount;
        }
            ...
            if (phase == PHASE_GROUND)
            {
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_ENCAPSULATE:
                        if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 150, true))
