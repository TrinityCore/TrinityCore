    ...
    struct boss_moroesAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (!Enrage)
            {
                ...
                if (Blind_Timer <= diff)
                {
                    if (Unit* target = SelectTarget(SelectAggroTarget::MinDistance, 0, 0.0f, true, false))
...
public:
    ...
    struct boss_lady_catriona_von_indiAI : public boss_moroes_guestAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            {
                if (Unit* target = RAND(SelectGuestTarget(), SelectTarget(SelectAggroTarget::Random, 0, 100, true)))
