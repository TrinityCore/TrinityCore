...
struct boss_dorothee : public ScriptedAI
{
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        _scheduler
            ...
            .Schedule(35s, [this](TaskContext const& /*task*/)
            {
...
struct boss_strawman : public ScriptedAI
{
    ...
    void JustAppeared() override
    {
        _scheduler.Schedule(27s, [this](TaskContext const& /*task*/)
        {
            me->SetImmuneToPC(false);
            DoZoneInCombat();
        });
...
struct boss_tinhead : public ScriptedAI
{
    ...
    void JustAppeared() override
    {
        _scheduler.Schedule(35s, [this](TaskContext const& /*task*/)
        {
            me->SetImmuneToPC(false);
            DoZoneInCombat();
        });
...
struct boss_roar : public ScriptedAI
{
    ...
    void JustAppeared() override
    {
        _scheduler.Schedule(18s, [this](TaskContext const& /*task*/)
        {
            me->SetImmuneToPC(false);
            DoZoneInCombat();
        });
