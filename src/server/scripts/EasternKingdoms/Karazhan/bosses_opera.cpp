...
public:
    ...
    struct boss_dorotheeAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            {
                DoCast(SelectTarget(SelectAggroTarget::Random, 0), SPELL_WATERBOLT);
...
public:
    ...
    struct boss_strawmanAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            {
                if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 100, true))
...
void boss_julianne::boss_julianneAI::UpdateAI(uint32 diff)
{
    ...
    {
        DoCast(SelectTarget(SelectAggroTarget::Random, 0), SPELL_POWERFUL_ATTRACTION);
