        ...
        void Summon(uint8 uiCase)
        {
            switch (uiCase)
            {
                case 1:
                    ...
                    break;
                case 2:
                    if (GameObject* go = me->SummonGameObject(183410, -533.140f, -105.322f, -156.016f, 0.f, QuaternionData(), GO_SUMMON_TIMED_OR_CORPSE_DESPAWN, 1s))
                    {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    if (GameObject* go = me->SummonGameObject(183410, -542.199f, -96.854f, -155.790f, 0.f, QuaternionData(), GO_SUMMON_TIMED_OR_CORPSE_DESPAWN, 1s))
                    {
                        GoSummonList.push_back(go->GetGUID());
                ...
                case 5:
                    ...
                    break;
                case 6:
                    if (GameObject* go = me->SummonGameObject(183410, -507.820f, -103.333f, -151.353f, 0.f, QuaternionData(), GO_SUMMON_TIMED_OR_CORPSE_DESPAWN, 1s))))
                    {
                        GoSummonList.push_back(go->GetGUID());
                        go->SetFlag(GAMEOBJECT_FLAGS, GO_FLAG_NOT_SELECTABLE); //We can't use it!
                        Summon(5);
                    ...
                    break;
                case 7:
                    if (GameObject* go = me->SummonGameObject(183410, -511.829f, -86.249f, -151.431f, 0.f, QuaternionData(), GO_SUMMON_TIMED_OR_CORPSE_DESPAWN, 1s))))
                    {
                        GoSummonList.push_back(go->GetGUID());
                        go->SetFlag(GAMEOBJECT_FLAGS, GO_FLAG_NOT_SELECTABLE); //We can't use it!
                    }
                ...
                case 8:
                    ...
                    break;
                case 9:
                    me->SummonGameObject(GO_RED_ROCKET, SpawnPosition[17], QuaternionData(), GO_SUMMON_TIMED_OR_CORPSE_DESPAWN, 2h);
                    me->SummonGameObject(GO_RED_ROCKET, SpawnPosition[18], QuaternionData(), GO_SUMMON_TIMED_OR_CORPSE_DESPAWN, 2h);
                    me->SummonGameObject(GO_RED_ROCKET, SpawnPosition[19], QuaternionData(), GO_SUMMON_TIMED_OR_CORPSE_DESPAWN, 2h);
                    break;
            }
        }
