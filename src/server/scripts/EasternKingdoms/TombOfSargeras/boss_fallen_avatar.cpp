...
//            instance->SendEncounterUnit(ENCOUNTER_FRAME_ADD_COMBAT_RES_LIMIT, me);
//
...
//
//              /*  auto threatlist = me->GetThreatManager().GetUnsortedThreatList();  ( FIX THIS PLEASE )
//                threatlist.remove_if([](ThreatReference* ref)
//                {
...
//            Unit::DealDamage(me,me, me->GetMaxHealth() * 0.25);
//        }
//    }
//
//    void UpdateAI(uint32 diff) override
