...
//        _JustEngagedWith();
//
//        AddDelayedEvent(480000, [this]() -> void
//        {
...
//            instance->DoOnPlayers([this, lightOrFel](Player* player)
//            {
...
//            me->CastSpell(me->GetVictim(), spell->Id == SPELL_HAMMER_OF_OBLITERATION ? SPELL_HAMMER_OF_OBLITERATION_VICT : SPELL_HAMMER_OF_CREATION_VICT, true);
//            me->CastSpell(me->GetVictim(), spell->Id == SPELL_HAMMER_OF_OBLITERATION ? SPELL_HAMMER_OF_OBLITERATION_AOE : SPELL_HAMMER_OF_CREATION_AOE, true);
//            if (IsHeroicPlusRaid())
//            {
...
//                AddDelayedEvent(3000, [this, guid, isFelFragment, pos]() -> void
//                {
...
//            unit = me->SelectNearestPlayer(60.0f);
//
//        if (unit)
...
//                if (ROLE_TANK == player->GetSpecializationId() && !spellsForTank.empty()) // tanks have are different buffs
//                {
