...
enum eWorldstates
{
    ...
    WORLDSTATE_IN_PROCCESS                              = 260,
    WORLDSTATE_RL_DESTROYED                             = 261,
    WORLDSTATE_BATTLE_NEAR_WORKSHOPS                    = 262,
    WORLDSTATE_AIRFIELD_ATTACKED                        = 263,
    WORLDSTATE_AIRFIELD_CAPTURED                        = 264,
    WORLDSTATE_CANNONS_DESTROYED                        = 265,
    WORLDSTATE_AIRFIELD_AND_COMMAND_CENTER_CAPTURED     = 266,
    WORLDSTATE_BATTLE_NEAR_ENTRANCE                     = 267,
    WORLDSTATE_SURFACE_CAPTURED                         = 268,
    WORLDSTATE_BATLLE_IN_TUNNELS                        = 269,
    WORLDSTATE_TUNNELS_CAPTURED                         = 270,
    WORLDSTATE_COUNTDOWN                                = 271,
...
#define SOUND_IRRADIATOR_1      // 10830
