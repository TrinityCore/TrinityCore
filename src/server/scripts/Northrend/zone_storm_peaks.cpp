...
class spell_remove_collapsing_cave_aura : public SpellScript
{
    PrepareSpellScript(spell_remove_collapsing_cave_aura);
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(spell_remove_collapsing_cave_aura::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
void AddSC_storm_peaks()
{
    ...
    RegisterSpellScript(spell_remove_collapsing_cave_aura);
}
