                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_HEAL_BLOODLUST_HEROISM:
                            ...
                            return;
                        case EVENT_HEX:
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, NonTankTargetSelector(me)))
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_HAMMER_OF_JUSTICE:
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 15.0f, true))
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_HEAL_DISPEL:
                            if (Unit* target = urand(0, 1) ? SelectTarget(SelectAggroTarget::Random, 0, 30.0f, true) : DoSelectLowestHpFriendly(40.0f))
