...
enum TCRDataTypes
{
    ...
    DATA_FORDRING               = 11,
    DATA_FORDRING_ANUBARAK      = 12,
    DATA_VARIAN                 = 13,
    DATA_GARROSH                = 14,
    DATA_FIZZLEBANG             = 15,
    DATA_FACTION_CHAMPIONS      = 16,

    DATA_CRUSADERS_CHEST        = 17,
    DATA_COLISEUM_FLOOR         = 18,
    DATA_MAIN_GATE              = 19,
    DATA_EAST_PORTCULLIS        = 20,
    DATA_WEB_DOOR               = 21,
    DATA_TRIBUTE_CHEST          = 22,
    DATA_BEASTS_COMBAT_STALKER  = 23,
    DATA_FURIOUS_CHARGE         = 24,
    DATA_DESPAWN_SNOBOLDS       = 25,
    DATA_TEAM                   = 26,
    DATA_LICH_KING_VOICE        = 27,
