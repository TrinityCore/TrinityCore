                ...
                scheduler
                    ...
                    if (GetDifficulty() != RAID_DIFFICULTY_10MAN_NORMAL)
                        scheduler.Schedule(Seconds(27), [this](TaskContext dominate_mind)
                        {
                            ...
                            SelectTargetList(targets, _dominateMindCount, SelectAggroTarget::Random, 0, 0.0f, true, false, -SPELL_DOMINATE_MIND);
            ...
            void JustSummoned(Creature* summon) override
            {
                switch (summon->GetEntry())
                {
                    ...
                    case NPC_DARNAVAN_25:
                        ...
                        summon->AI()->AttackStart(SelectTarget(SelectAggroTarget::Random));
                        return;
