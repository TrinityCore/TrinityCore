...
struct boss_lady_deathwhisper : public BossAI
{
    ...
    void JustEngagedWith(Unit* who) override
    {
        ...
        scheduler
            .Schedule(10min, [this](TaskContext const& /*context*/)
            {
    ...
    void SpellHit(WorldObject* /*caster*/, SpellInfo const* spellInfo) override
    {
        switch (spellInfo->Id)
        {
            ...
            case SPELL_DARK_MARTYRDOM_FANATIC_25H:
                _scheduler
                    .Schedule(2s, [this](TaskContext const& /*context*/)
                    {
                    ...
                    .Schedule(6s, [this](TaskContext const& /*context*/)
                    {
...
struct npc_vengeful_shade : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        _scheduler
            ...
            .Schedule(7s, [this](TaskContext const& /*context*/)
            {
                me->KillSelf();
            });
    }
