            ...
            void DoAction(int32 const action)
            {
                switch (action)
                {
                    case ACTION_START_EVENT:
                    {
                        ...
                        _guardList.sort(GreenPis::ObjectDistanceOrderPred(me));
                        uint32 x = 1;
    ...
    public:
        ...
        class spell_deathbringer_blood_nova_targeting_SpellScript : public SpellScript
        {
            ...
            void FilterTargetsInitial(std::list<Unit*>& unitList)
            {
                ...
                unitList.sort(GreenPis::ObjectDistanceOrderPred(GetCaster(), false));
    ...
    public:
        ...
        class spell_deathbringer_boiling_blood_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<Unit*>& unitList)
            {
                ...
                Unit* target = GreenPis::Containers::SelectRandomContainerElement(unitList);
                unitList.clear();
                unitList.push_back(target);
            }
