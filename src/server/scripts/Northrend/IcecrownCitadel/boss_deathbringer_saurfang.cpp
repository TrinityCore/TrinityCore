...
class boss_deathbringer_saurfang : public CreatureScript
{
    public:
        ...
        struct boss_deathbringer_saurfangAI : public BossAI
        {
            ...
            {
                if (Unit* target = SelectTarget(SelectAggroTarget::Random, 1, 0.0f, true))
                {
            ...
            void DoAction(int32 action) override
            {
                switch (action)
                {
                    ...
                    {
                        if (Unit* target = SelectTarget(SelectAggroTarget::Random, 1, 0.0f, true, true, -SPELL_MARK_OF_THE_FALLEN_CHAMPION))
                        {
