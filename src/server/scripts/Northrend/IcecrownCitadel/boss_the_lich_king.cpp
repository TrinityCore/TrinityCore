    ...
    public:
        ...
        bool Execute(uint64 /*time*/, uint32 /*diff*/) override
        {
            ...
            if (Creature* _summoner = ObjectAccessor::GetCreature(*_owner, _summonerGuid))
                if (Unit* target = _summoner->AI()->SelectTarget(SelectAggroTarget::Random, 0, NonTankTargetSelector(_summoner)))
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_NECROTIC_PLAGUE:
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 1, NecroticPlagueTargetCheck(me, NECROTIC_PLAGUE_LK, NECROTIC_PLAGUE_PLR)))
                            {
                        ...
                        case EVENT_SHADOW_TRAP:
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, SpellTargetSelector(me, SPELL_SHADOW_TRAP)))
                        ...
                        case EVENT_SOUL_REAPER:
                            ...
                            break;
                        case EVENT_DEFILE:
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 0.0f, true, true, -SPELL_HARVEST_SOUL_VALKYR))
                            {
                        ...
                        case EVENT_HARVEST_SOUL:
                            ...
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, SpellTargetSelector(me, SPELL_HARVEST_SOUL)))
