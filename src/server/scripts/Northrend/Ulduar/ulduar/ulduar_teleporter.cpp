...
class ulduar_teleporter : public GameObjectScript
{
    public:
        ...
        bool OnGossipHello(Player* player, GameObject* gameObject)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Spark of Imagination", GOSSIP_SENDER_MAIN, SPARK_IMAGINATION);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Descent into Madness", GOSSIP_SENDER_MAIN, DESCENT_MADNESS);
