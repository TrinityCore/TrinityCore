    ...
    public:
        ...
        struct boss_freyaAI : public BossAI
        {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_STRENGTHENED_IRON_ROOTS:
                            ...
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 100.0f, true, true, -SPELL_ROOTS_FREYA))
            ...
            void JustSummoned(Creature* summoned) override
            {
                ...
                if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 250.0f, true))
                {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_IRON_ROOTS:
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 100.0f, true, true, -SPELL_ROOTS_IRONBRANCH))
    ...
    public:
        ...
        struct npc_ancient_conservatorAI : public ScriptedAI
        {
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                {
                    if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 100.0f, true, true, -SPELL_NATURE_FURY))
