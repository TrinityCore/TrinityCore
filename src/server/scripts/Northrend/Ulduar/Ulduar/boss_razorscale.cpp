...
struct npc_expedition_commander : public ScriptedAI
{
    ...
    void BuildBrokenHarpoons()
    {
        ...
        for (uint8 i = 0; i < harpoonNumber; ++i)
            me->SummonGameObject(GO_RAZOR_BROKEN_HARPOON, PosBrokenHarpoon[i], QuaternionData(0.0f, 0.0f, -0.8987932f, 0.4383728f), GO_SUMMON_CORPSE_DESPAWN);
    }
    ...
    void BuildHarpoon(uint8 harpoonNumber)
    {
        ...
        if (_is25Man)
        {
            ...
            {
                case HARPOON_1:
                    if (GameObject* harpoon = me->SummonGameObject(GO_RAZOR_HARPOON_3, PosHarpoon[2], QuaternionData(0.0f, 0.0f, -0.573576f, 0.8191524f), GO_SUMMON_CORPSE_DESPAWN))
                        _harpoons.emplace_back(harpoon->GetGUID());
                    break;
                case HARPOON_2:
                    if (GameObject* harpoon = me->SummonGameObject(GO_RAZOR_HARPOON_1, PosHarpoon[0], QuaternionData(0.0f, 0.0f, -0.6293201f, 0.7771462f), GO_SUMMON_CORPSE_DESPAWN))
                        _harpoons.emplace_back(harpoon->GetGUID());
                    break;
                case HARPOON_3:
                    if (GameObject* harpoon = me->SummonGameObject(GO_RAZOR_HARPOON_2, PosHarpoon[1], QuaternionData(0.0f, 0.0f, -0.6691303f, 0.743145f), GO_SUMMON_CORPSE_DESPAWN))
                        _harpoons.emplace_back(harpoon->GetGUID());
                    break;
                case HARPOON_4:
                    if (GameObject* harpoon = me->SummonGameObject(GO_RAZOR_HARPOON_4, PosHarpoon[3], QuaternionData(0.0f, 0.0f, -0.7660437f, 0.6427886f), GO_SUMMON_CORPSE_DESPAWN))
                        _harpoons.emplace_back(harpoon->GetGUID());
                    break;
                default:
                    break;
        ...
        else
        {
            ...
            {
                case HARPOON_1:
                    if (GameObject* harpoon = me->SummonGameObject(GO_RAZOR_HARPOON_1, PosHarpoon[harpoonNumber], QuaternionData(0.0f, 0.0f, -0.6293201f, 0.7771462f), GO_SUMMON_CORPSE_DESPAWN))
                        _harpoons.emplace_back(harpoon->GetGUID());
                    break;
                case HARPOON_2:
                    if (GameObject* harpoon = me->SummonGameObject(GO_RAZOR_HARPOON_2, PosHarpoon[harpoonNumber], QuaternionData(0.0f, 0.0f, -0.6691303f, 0.743145f), GO_SUMMON_CORPSE_DESPAWN))
                        _harpoons.emplace_back(harpoon->GetGUID());
                    break;
                default:
                    break;
