                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_INTRO_2:
                            if (Unit* mkii = me->GetVehicleBase())
                            {
                                ...
                                mkii->RemoveUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_UNINTERACTIBLE));
                            }
        ...
        struct boss_vx_001AI : public BossAI
        {
            ...
            void DamageTaken(Unit* who, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override
            {
                if (damage >= me->GetHealth())
                {
                    ...
                    {
                        me->CastStop();
                        me->AddUnitFlag(UNIT_FLAG_NON_ATTACKABLE); // | UNIT_FLAG_UNINTERACTIBLE);
    ...
    public:
        ...
        class spell_mimiron_bomb_bot_SpellScript : public SpellScript
        {
            ...
            void HandleDespawn(SpellEffIndex /*effIndex*/)
            {
                ...
                {
                    target->AddUnitFlag(UnitFlags(UNIT_FLAG_UNINTERACTIBLE | UNIT_FLAG_PACIFIED));
