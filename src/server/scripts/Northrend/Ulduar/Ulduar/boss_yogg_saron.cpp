...
class npc_ominous_cloud : public CreatureScript
{
    public:
        ...
        struct npc_ominous_cloudAI : public PassiveAI
        {
            ...
            void DoAction(int32 action) override
            {
                me->GetMotionMaster()->MoveCirclePath(YoggSaronSpawnPos, me->GetPositionZ(), me->GetDistance2d(YoggSaronSpawnPos.GetPositionX(), YoggSaronSpawnPos.GetPositionY()), true);
            }
        };
