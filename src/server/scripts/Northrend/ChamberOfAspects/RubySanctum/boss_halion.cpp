            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        {
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 0.0f, true, true, -SPELL_TWILIGHT_REALM))
                            {
                        ...
                        {
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 1, 0.0f, true, true, -SPELL_TWILIGHT_REALM))
