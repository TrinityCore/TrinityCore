...
enum Yells
{
    ...
    SAY_SYLVANASS_INTRO_1                = 0,
    SAY_SYLVANASS_INTRO_2                = 1,
    SAY_SYLVANASS_INTRO_3                = 2,
    SAY_SYLVANASS_INTRO_4                = 3,
    SAY_SYLVANASS_INTRO_5                = 4,
    SAY_SYLVANASS_INTRO_6                = 5,
    SAY_SYLVANASS_INTRO_7                = 6,
    SAY_SYLVANASS_INTRO_8                = 7,
    SAY_SYLVANASS_INTRO_END              = 8,
            ...
            // A2 Intro _didHappens
             ...
             // H2 Intro _didHappens
                ...
                case EVENT_INTRO_H2_15:
                    Talk(SAY_SYLVANASS_INTRO_8);
                    events.ScheduleEvent(EVENT_INTRO_LK_1,3000);
                    break;
            // Remaining Intro _didHappens common for both faction
