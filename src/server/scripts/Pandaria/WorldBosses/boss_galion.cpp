...
public:
    ...
    struct boss_galion_AI : public BossAI
    {
        ...
        void JustEnteredCombat(Unit* attacker) override
        {
            ...
            m_Events.ScheduleEvent(EVENT_WARN_STOMP, Milliseconds(47000));
            m_Events.ScheduleEvent(EVENT_STOMP, Milliseconds(50000));
            m_Events.ScheduleEvent(EVENT_CANON_BARRAGE, Milliseconds(24000));
        ...
        //    {
        //        for (auto hostileReference : me->GetThreatManager().GetThreatenedByMeList())//GetThreateList
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_STOMP:
                ...
                m_Events.ScheduleEvent(EVENT_WARN_STOMP, Milliseconds(57000));
                m_Events.ScheduleEvent(EVENT_STOMP, Milliseconds(60000));
                m_Events.ScheduleEvent(EVENT_WARMONGER, Milliseconds(10000));
                break;
            case EVENT_CANON_BARRAGE:
            {
                ...
                if (m_CanonReady < 8)
                    m_Events.ScheduleEvent(EVENT_CANON_BARRAGE, Milliseconds(1000));
                else
                {
                    m_CanonReady = 0;
                    m_Events.ScheduleEvent(EVENT_CANON_BARRAGE, Milliseconds(52000));
                }
    ...
    struct npc_salyin_warmongerAI : public ScriptedAI
    {
        ...
        void JustEnteredCombat(Unit* /*attacker*/) override
        {
            if (me->IsOnVehicle(me))
                m_Events.ScheduleEvent(EVENT_FIRE_SHOT, Milliseconds(urand(5000, 10000)));
            else
                m_Events.ScheduleEvent(EVENT_IMPALING_PULL, Milliseconds(20000));
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (!UpdateVictim() && !me->IsOnVehicle(me))
                return;

            if (me->HasUnitState(UNIT_STATE_CASTING) && !me->IsOnVehicle(me))
                return;
