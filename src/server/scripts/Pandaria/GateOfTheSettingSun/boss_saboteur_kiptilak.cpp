...
{
    boss_saboteur_kiptilak(Creature* creature) : BossAI(creature, DATA_KIPTILAK)
    {
    }
...
struct npc_instable_munition : public ScriptedAI
{
...
{
    RegisterGateOfTheSettingSunCreatureAI(boss_saboteur_kiptilak);
    RegisterGateOfTheSettingSunCreatureAI(npc_instable_munition);
    RegisterGateOfTheSettingSunCreatureAI( npc_munition_explosion_bunny);
