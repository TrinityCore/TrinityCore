    ...
    public:
        ...
        struct boss_raigonnAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                me->CombatStop();
                //SetCanSeeEvenInPassiveMode(true);//tmp
                ...
                events.ScheduleEvent(EVENT_RAIGONN_CHARGE, Milliseconds(1000), PHASE_WEAK_SPOT);
                ...
                {
                    //meVehicle->SetPassengersSpawnedByAI(true); //tmp
                    ...
                    if (Creature* weakSpot = me->SummonCreature(NPC_WEAK_SPOT, 0, 0, 0))
                    {
                        ...
                        //if (Vehicle* vehicleWeakSpot = weakSpot->GetVehicleKit()) //tmp
            ...
            void MoveInLineOfSight(Unit* who) override
            {
                ...
                events.ScheduleEvent(EVENT_SUMMON_PROTECTORAT, Milliseconds(urand(15000, 30000)));
                events.ScheduleEvent(EVENT_SUMMON_ENGULFER, Milliseconds(urand(15000, 30000)));
                events.ScheduleEvent(EVENT_SUMMON_SWARM_BRINGER, Milliseconds(urand(15000, 30000)));
                events.ScheduleEvent(EVENT_CHECK_WIPE, Milliseconds(1000));
            ...
            //void EnterCombat(Unit* /*who*/) override  //org
            //{
            ...
            void DoAction(int32 action) override
            {
                if (action == ACTION_WEAK_SPOT_DEAD)
                {
                    ...
                    events.ScheduleEvent(EVENT_STOMP, Milliseconds(16000), PHASE_VULNERABILITY);
            ...
            void DoEventCharge()
            {
                ...
                switch (eventChargeProgress)
                {
                    case 0:
                        ...
                        events.ScheduleEvent(EVENT_RAIGONN_CHARGE, Milliseconds(1750), PHASE_WEAK_SPOT);
                        ++eventChargeProgress;
                        break;
                    case 1:
                    ...
                    case 2:
                        ...
                        events.ScheduleEvent(EVENT_RAIGONN_CHARGE, Milliseconds(3000), PHASE_WEAK_SPOT);
                        ++eventChargeProgress;
                        break;
                    case 3:
                    default:
                        ...
                        //me->GetMotionMaster()->MoveBackward(POINT_MAIN_DOOR, chargePos[baseMovement + 1].GetPositionX(), chargePos[baseMovement + 1].GetPositionY(), chargePos[baseMovement + 1].GetPositionZ(), 1.0f);//tmp
                        break;
                }
            }
                ...
                switch(events.ExecuteEvent())
                {
                   /* case EVENT_CHECK_WIPE:
                    ...
                    case EVENT_SUMMON_PROTECTORAT:
                    {
                        ...
                        events.ScheduleEvent(EVENT_SUMMON_PROTECTORAT, Milliseconds(urand(30000, 45000)), PHASE_WEAK_SPOT);
                        break;
                    }
                    case EVENT_SUMMON_ENGULFER:
                    {
                        for (uint8 i = 0; i < 3; ++i)
                            me->SummonCreature(NPC_KRIKTHIK_ENGULFER, frand(941.0f, 974.0f), me->GetPositionY(), me->GetPositionZ() + 30.0f, 4.73f, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 5000,ObjectGuid::Empty);

                        events.ScheduleEvent(EVENT_SUMMON_ENGULFER, Milliseconds(urand(95000, 105000)), PHASE_WEAK_SPOT);
                        break;
                    }
                    case EVENT_SUMMON_SWARM_BRINGER:
                    {
                        if (Creature* summon = me->SummonCreature(NPC_KRIKTHIK_SWARM_BRINGER, frand(941.0f, 974.0f), 2374.85f, 296.67f, 4.73f, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 5000, ObjectGuid::Empty))
                            if (Unit* target = SelectTarget(SelectTargetMethod::Random))
                                if (summon->AI())
                                    summon->AI()->AttackStart(target);

                        events.ScheduleEvent(EVENT_SUMMON_ENGULFER, Milliseconds(urand(35000, 50000)), PHASE_WEAK_SPOT);
                        break;
                    }
                    case EVENT_FIXATE:
                    {
                        ...
                        events.ScheduleEvent(EVENT_FIXATE_STOP, Milliseconds(15000), PHASE_VULNERABILITY);
                        break;
                    }
                    ...
                    case EVENT_STOMP:
                    {
                        ...
                        events.ScheduleEvent(EVENT_STOMP, Milliseconds(30000), PHASE_VULNERABILITY);
                        break;
                    }
                    default:
                        break;
...
class npc_raigonn_weak_spot : public CreatureScript
{
    public:
        ...
        struct npc_raigonn_weak_spotAI : public ScriptedAI
        {
            ...
            //bool CanBeTargetedOutOfLOS() override //tmp
            //{
            //    return true;
            //}
        };
...
class vehicle_artillery : public VehicleScript
{
    public:
        ...
        //CreatureAI* GetAI(Creature* creature) const override  //tmp
        //{
