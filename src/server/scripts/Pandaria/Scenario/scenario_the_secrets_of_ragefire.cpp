...
struct scenario_the_secrets_of_ragefire : public InstanceScript
{
    ...
    void OnCompletedCriteriaTree(CriteriaTree const* tree) 
    {
        ...
        case CRITERIA_TREE_DEFEND_THE_GOB_SQUAD_WHILE_PATCH_ESTABLISHES_AN_ESCAPE_ROUTE:
            //instance->SummonGameObject(220066, Position(1437.774f, 1010.219f, 34.19741f, 4.680285f), QuaternionData(0.f, 0.f, -0.7183657f, 0.6956657f), Milliseconds(WEEK));
    ...
    */
    struct boss_ragefire_dark_shaman_xorenthAI : public BossAI
    {
        ...
        void JustEnteredCombat(Unit* /*attacker*/) override
        {
            ...
            events.Reset();
            events.ScheduleEvent(1, Milliseconds(urand(8000, 12000)));
            events.ScheduleEvent(2, Milliseconds(urand(14000, 27000)));
            events.ScheduleEvent(3, Milliseconds(urand(8000, 9000)));
            events.ScheduleEvent(4, Milliseconds(10));//not correct at all but it should be fine for now, more of a visual
        }
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 1://Twisted Elements
                    ...
                    events.ScheduleEvent(1, Milliseconds(urand(4000, 7000)));
                    break;
...
public:
    ...
    struct npc_ragefire_core_mantid_bombAI : public ScriptedAI
    {
        ...
        void UpdateAI(const uint32 /*diff*/) override
        {
            ...
            //        me->DespawnOrUnsummon(Milliseconds(500));
            //        instance->SetData(me->GetEntry(), DONE);
            //        break;
            //    }
            //}
...
public:
    ...
    struct boss_ragefire_overseer_elagloAI : public BossAI
    {
        ...
        void JustEnteredCombat(Unit* /*attacker*/) override
        {
            ...
            events.ScheduleEvent(1, Milliseconds(urand(3000, 20000)));
            events.ScheduleEvent(2, Milliseconds(urand(10000, 20000)));
        }
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 1:
                    ...
                    events.ScheduleEvent(1, Milliseconds(urand(10000, 20000)));
                    break;
                case 2:
...
public:
    ...
    struct npc_eredar_felcaller_98005AI : public ScriptedAI
    {
        ...
        //        events.ScheduleEvent(1, Milliseconds(2000));
        //}
