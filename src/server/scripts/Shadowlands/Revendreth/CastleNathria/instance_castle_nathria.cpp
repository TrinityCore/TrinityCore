...
#include "instance_castle_nathria.h"
...
{
public:
    instance_castle_nathria() : InstanceMapScript(ABTScriptName, 2284) { }

    struct instance_castle_nathria_InstanceScript : public InstanceScript
    {
