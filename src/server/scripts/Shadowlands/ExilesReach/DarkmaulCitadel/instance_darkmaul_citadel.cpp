...
#include "instance_darkmaul_citadel.h"

class instance_darkmaul_citadel : public InstanceMapScript
{
public:
    instance_darkmaul_citadel() : InstanceMapScript(ABTScriptName, 2236) { }
...
private:
    ...
    struct instance_darkmaul_citadel_InstanceScript : public InstanceScript
    {
        bool CombatAI;
