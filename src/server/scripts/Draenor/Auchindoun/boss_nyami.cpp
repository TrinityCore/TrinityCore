...
struct boss_nyami : public BossAI
{
    ...
    void ScheduleTasks() override
    {
        ...
        events.ScheduleEvent(eNyamiEvents::EventMindSpikeNyami, Milliseconds(urand(8 * TimeConstants::IN_MILLISECONDS, 15 * TimeConstants::IN_MILLISECONDS)));
        events.ScheduleEvent(eNyamiEvents::EventShadowWordPain, Milliseconds(urand(12 * TimeConstants::IN_MILLISECONDS, 18 * TimeConstants::IN_MILLISECONDS)));
        events.ScheduleEvent(eNyamiEvents::EventSoulVessel, Milliseconds(20 * TimeConstants::IN_MILLISECONDS));
        events.ScheduleEvent(eNyamiEvents::EventTornSpirit, Milliseconds(35 * TimeConstants::IN_MILLISECONDS));
    }
    ...
    void JustDied(Unit* /*p_Killer*/) override
    {
        ...
        events.ScheduleEvent(eNyamiEvents::EventOnDeath1, Milliseconds(5 * TimeConstants::IN_MILLISECONDS));
    }
    ...
    void ExecuteEvent(uint32 eventId) override
    {
        ...
        case eNyamiEvents::EventMindSpikeNyami:
            ...
            events.ScheduleEvent(eNyamiEvents::EventMindSpikeNyami, Milliseconds(urand(6 * TimeConstants::IN_MILLISECONDS, 8 * TimeConstants::IN_MILLISECONDS)));
            break;
        case eNyamiEvents::EventShadowWordPain:
            if (Unit* l_Target = SelectTarget(SelectTargetMethod::Random, 0, 200.0f, true))//org //SelectAggroTarget::SELECT_TARGET_RANDOM
        ...
        case eNyamiEvents::EventSoulVessel:
            if (instance)
            {
                ...
                if (TempSummon* l_Bubble = me->SummonCreature(eNyamiCreatures::CreatureSoulVesselHackBubbleEffect, g_PositionBubble, TempSummonType::TEMPSUMMON_MANUAL_DESPAWN))
                    if (l_Bubble->IsAIEnabled())
                        l_Bubble->AI()->DoAction(eNyamiActions::ActionReleaseAnimationPreSoulVessel);
            }
            events.ScheduleEvent(eNyamiEvents::EventSoulVessel, Milliseconds(25 * TimeConstants::IN_MILLISECONDS));
            break;
        case eNyamiEvents::EventTornSpirit:
        {
            ...
            events.ScheduleEvent(eNyamiEvents::EventTornSpiritsDummy, Milliseconds(3 * TimeConstants::IN_MILLISECONDS));
            events.ScheduleEvent(eNyamiEvents::EventTornSpirit, Milliseconds(35 * TimeConstants::IN_MILLISECONDS));
            break;
        }
        ...
        case EventOnDeath1:
        {
           /* if (Creature* l_Warden = me->GetSummonedCreatureByEntry(CreatureWardenAzzakael))  //tmp
            {
                ...
                events.ScheduleEvent(eNyamiEvents::EventOnDeath2, Milliseconds(6 * TimeConstants::IN_MILLISECONDS));
            }            
            break;*/
        }
        case EventOnDeath2:
        {/*
            if (Creature* l_Warden = me->GetSummonedCreatureByEntry(CreatureWardenAzzakael))//tmp
            {
                ...
                events.ScheduleEvent(eNyamiEvents::EventOnDeath3, Milliseconds(10 * TimeConstants::IN_MILLISECONDS));
            }
            break;*/
        }
        case EventOnDeath3:
        {
            if (instance)
            {
                ...
                //    //l_Warden->AddDynamicFlag(UNIT_DYNFLAG_DEAD);//tmp
                //    l_Warden->AddUnitFlag(UnitFlags(UnitFlags2::UNIT_FLAG2_DISABLE_PRED_STATS | UnitFlags2::UNIT_FLAG2_FEIGN_DEATH));//in th front former is UNIT_FLAG2_DISABLE_TURN
...
struct auchindoun_nyami_mob_malefic_defender : public ScriptedAI
{
    ...
    {
        events.ScheduleEvent(eMaleficDefenderEvents::EventCrusaderStirke, Milliseconds(5 * TimeConstants::IN_MILLISECONDS));
    }
    ...
    void UpdateAI(uint32 p_Diff) override
    {
        ...
        case eMaleficDefenderEvents::EventCrusaderStirke:
            ...
            events.ScheduleEvent(eMaleficDefenderEvents::EventCrusaderStirke, Milliseconds(urand(7 * TimeConstants::IN_MILLISECONDS, 12 * TimeConstants::IN_MILLISECONDS)));
            break;
        default:
            break;
        }
...
struct auchindoun_nyami_mob_spiteful_arbitrer : public ScriptedAI
{
    ...
    {
        events.ScheduleEvent(eNyamiEvents::EventRadiantFury, Milliseconds(8 * TimeConstants::IN_MILLISECONDS));
        events.ScheduleEvent(eNyamiEvents::EventArbitrerHammer, Milliseconds(14 * TimeConstants::IN_MILLISECONDS));
    }
    ...
    void UpdateAI(uint32 p_Diff) override
    {
        ...
        case eNyamiEvents::EventArbitrerHammer:
            if (Unit* l_Target = SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true))//SelectAggroTarget::SELECT_TARGET_RANDOM
        ...
        case eNyamiEvents::EventRadiantFury:
        {
            ...
            events.ScheduleEvent(eNyamiEvents::EventRadiantFuryStop, Milliseconds(6 * TimeConstants::IN_MILLISECONDS));
            break;
        }
        case eNyamiEvents::EventRadiantFuryStop:
        {
            ...
            events.ScheduleEvent(eNyamiEvents::EventRadiantFury, Milliseconds(urand(15 * TimeConstants::IN_MILLISECONDS, 20 * TimeConstants::IN_MILLISECONDS)));
            break;
        }
        default:
            break;
...
struct auchindoun_nyami_mob_twisted_magus : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*p_Attacker*/)
    {
        events.ScheduleEvent(eTwistedMagusEvents::EventArcaneBolt, Milliseconds(4 * TimeConstants::IN_MILLISECONDS));
        events.ScheduleEvent(eTwistedMagusEvents::EventArcaneBomb, Milliseconds(12 * TimeConstants::IN_MILLISECONDS));
    }
    ...
    void UpdateAI(uint32 p_Diff) override
    {
        ...
        case eTwistedMagusEvents::EventArcaneBolt:
            ...
            events.ScheduleEvent(eTwistedMagusEvents::EventArcaneBolt, Milliseconds(15 * TimeConstants::IN_MILLISECONDS));
            break;
        case eTwistedMagusEvents::EventArcaneBomb:
            me->CastSpell(me, eTwistedMagusSpells::SpellArcaneBombDummy);
            events.ScheduleEvent(eTwistedMagusEvents::EventArcaneBomb, Milliseconds(25 * TimeConstants::IN_MILLISECONDS));
            break;
        default:
            break;
        }
...
void AddSC_boss_nyami()
{
    ...
    RegisterSpellScript(auchindoun_nyami_spell_soul_vessel_dummy);
