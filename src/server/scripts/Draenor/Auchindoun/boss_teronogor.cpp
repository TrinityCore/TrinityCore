...
struct boss_teronogor : public BossAI
{
    ...
    {
        if(me->HealthBelowPctDamaged(75, p_Damage) && !m_SecondPhase)//HealthWillBeBelowPctDamaged
        {
            events.Reset();
            me->AttackStop();
            m_SecondPhase = true;
    ...
    void DoAction(int32 p_Action)
    {
        ...
        case eTeronogorActions::ActionChoosePower:
        {
            ...
            case eTeronogorTransformations::TransformationAffliction: // Mender Elum - Affliction
                ...
                events.ScheduleEvent(eTerongorEvents::EventShadowBolt, Milliseconds(urand(8 * TimeConstants::IN_MILLISECONDS, 10 * TimeConstants::IN_MILLISECONDS)));
                events.ScheduleEvent(eTerongorEvents::EventCurseOfExhaustion, Milliseconds(13 * TimeConstants::IN_MILLISECONDS));
                events.ScheduleEvent(eTerongorEvents::EventSeedOfMalevolence, Milliseconds(urand(22 * TimeConstants::IN_MILLISECONDS, 25 * TimeConstants::IN_MILLISECONDS)));
                events.ScheduleEvent(eTerongorEvents::EventAgony, Milliseconds(16 * TimeConstants::IN_MILLISECONDS));
                events.ScheduleEvent(eTerongorEvents::EventDrainLife, Milliseconds(urand(13 * TimeConstants::IN_MILLISECONDS, 16 * TimeConstants::IN_MILLISECONDS)));
                events.ScheduleEvent(eTerongorEvents::EventUnstableAffliction, Milliseconds(20 * TimeConstants::IN_MILLISECONDS));
                break;
            case eTeronogorTransformations::TransformationDestruction: // Arcanist Jorra's - destruction
                ...
                events.ScheduleEvent(eTerongorEvents::EventChaosBolt, Milliseconds(20 * TimeConstants::IN_MILLISECONDS));
                events.ScheduleEvent(eTerongorEvents::EventImmolate, Milliseconds(urand(10 * TimeConstants::IN_MILLISECONDS, 14 * TimeConstants::IN_MILLISECONDS)));
                events.ScheduleEvent(eTerongorEvents::EventConflagrate, Milliseconds(urand(8 * TimeConstants::IN_MILLISECONDS, 10 * TimeConstants::IN_MILLISECONDS)));
                events.ScheduleEvent(eTerongorEvents::EventRainOfFire, Milliseconds(24 * TimeConstants::IN_MILLISECONDS));
                events.ScheduleEvent(eTerongorEvents::EventIncinrate, Milliseconds(16 * TimeConstants::IN_MILLISECONDS));
                break;
            case eTeronogorTransformations::TransformationDemonology: // Vindication Iruun's - demonology
                ...
                events.ScheduleEvent(eTerongorEvents::EventDoom, Milliseconds(urand(8 * TimeConstants::IN_MILLISECONDS, 12 * TimeConstants::IN_MILLISECONDS)));
                events.ScheduleEvent(eTerongorEvents::EventDemonicLeap, Milliseconds(urand(10 * TimeConstants::IN_MILLISECONDS, 14 * TimeConstants::IN_MILLISECONDS)));
                events.ScheduleEvent(eTerongorEvents::EventCurseOfExhaustion, Milliseconds(18 * TimeConstants::IN_MILLISECONDS));
                events.ScheduleEvent(eTerongorEvents::EventCorruption, Milliseconds(urand(10 * TimeConstants::IN_MILLISECONDS, 14 * TimeConstants::IN_MILLISECONDS)));
                events.ScheduleEvent(eTerongorEvents::EventChaosBolt, Milliseconds(25 * TimeConstants::IN_MILLISECONDS));
                events.ScheduleEvent(eTerongorEvents::EventTouchOfChaos, Milliseconds(16 * TimeConstants::IN_MILLISECONDS));
                break;
            default:
                break;
            }
    ...
    void ScheduleTasks() override
    {
        ...
        events.ScheduleEvent(eTerongorEvents::EventShadowBolt, Milliseconds(urand(8 * TimeConstants::IN_MILLISECONDS, 16 * TimeConstants::IN_MILLISECONDS)));
        events.ScheduleEvent(eTerongorEvents::EventCorruption, Milliseconds(urand(10 * TimeConstants::IN_MILLISECONDS, 12 * TimeConstants::IN_MILLISECONDS)));
        events.ScheduleEvent(eTerongorEvents::EventRainOfFire, Milliseconds(21 * TimeConstants::IN_MILLISECONDS));
        events.ScheduleEvent(eTerongorEvents::EventDrainLife, Milliseconds(16 * TimeConstants::IN_MILLISECONDS));
    ...
    void MovementInform(uint32 /*p_Type*/, uint32 p_Id)
    {
        ...
        case eTeronogorMovements::MovementBossDeathSceneEnd:
            ...
            me->DespawnOrUnsummon(Milliseconds(10 * TimeConstants::IN_MILLISECONDS));
    ...
    void JustDied(Unit* /*p_Killer*/) override
    {
        ...
        me->SummonGameObject(eAuchindounObjects::GameobjectChestAucheni, 1891.84f, 2973.80f, 16.844f, 5.664811f, QuaternionData(0, 0, 0, 0), Seconds(0));
    ...
    void ExecuteEvent(uint32 eventId) override
    {
        ...
        case eTerongorEvents::EventShadowBolt:
        {
            ...
            events.ScheduleEvent(eTerongorEvents::EventShadowBolt, Milliseconds(6 * TimeConstants::IN_MILLISECONDS));
            break;
        }
        case eTerongorEvents::EventCorruption:
        {
            if (Unit* l_Random = SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true,true))// -eTerongorSpells::SpellCorruptionDmg
                me->CastSpell(l_Random, eTerongorSpells::SpellCorruptionDmg);

            events.ScheduleEvent(eTerongorEvents::EventCorruption, Milliseconds(9 * TimeConstants::IN_MILLISECONDS));
            break;
        }
        ...
        {
            if (Unit* l_Random = SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true, true))//-eTerongorSpells::SpellCurseOfExhaustionDebuff
        ...
        {
            if (Unit* l_Random = SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true,true))// -eTerongorSpells::SpellUnstableAffliction
        ...
        case eTerongorEvents::EventImmolate:
        {
            ...
            events.ScheduleEvent(eTerongorEvents::EventImmolate, Milliseconds(12 * TimeConstants::IN_MILLISECONDS));
            break;
        }
        case eTerongorEvents::EventConflagrate:
        {
            ...
            events.ScheduleEvent(eTerongorEvents::EventConflagrate, Milliseconds(urand(15 * TimeConstants::IN_MILLISECONDS, 20 * TimeConstants::IN_MILLISECONDS)));
            break;
        }
        case eTerongorEvents::EventIncinrate:
        {
            ...
            events.ScheduleEvent(eTerongorEvents::EventIncinrate, Milliseconds(6 * TimeConstants::IN_MILLISECONDS));
            break;
        }
        case eTerongorEvents::EventRainOfFire:
            ...
            events.ScheduleEvent(eTerongorEvents::EventRainOfFire, Milliseconds(10 * TimeConstants::IN_MILLISECONDS));
            break;
        ...
        case eTerongorEvents::EventDemonicLeap:
        {
            ...
            events.ScheduleEvent(eTerongorEvents::EventDemonicLeap, Milliseconds(urand(18 * TimeConstants::IN_MILLISECONDS, 30 * TimeConstants::IN_MILLISECONDS)));
            break;
        }
        case eTerongorEvents::EventChaosWave:
        {
            ...
            events.ScheduleEvent(eTerongorEvents::EventChaosWave, Milliseconds(urand(8 * TimeConstants::IN_MILLISECONDS, 10 * TimeConstants::IN_MILLISECONDS)));
            break;
        }
    ...
    void DoCastTransformation(uint32 spell)
    {
        ...
        if (me->IsAIEnabled())
        {
            if (Unit* l_Victim = me->GetAI()->SelectTarget(SelectTargetMethod::MaxThreat, 0, 100.0f, true))
...
public:
    ...
    struct auchindoun_teronogor_mob_duragAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*p_Attacker*/)
        {
            ...
            events.ScheduleEvent(eTeronogorDuragEvents::EventShadowBolt, Milliseconds(6 * TimeConstants::IN_MILLISECONDS));
            events.ScheduleEvent(eTeronogorDuragEvents::EventCorruption, Milliseconds(9 * TimeConstants::IN_MILLISECONDS));
            events.ScheduleEvent(eTeronogorDuragEvents::EventChaosWave, Milliseconds(12 * TimeConstants::IN_MILLISECONDS));
        }
        ...
        void UpdateAI(uint32 p_Diff) override
        {
            ...
            case eTeronogorDuragEvents::EventChaosWave:
                ...
                events.ScheduleEvent(eTeronogorDuragEvents::EventChaosWave, Milliseconds(20 * TimeConstants::IN_MILLISECONDS));
                break;
            default:
                break;
            }
...
public:
    ...
    struct auchindoun_teronogor_mob_gulkoshAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*p_Attacker*/)
        {
            me->CastStop();
            me->RemoveAllAuras();
            events.ScheduleEvent(eTeronogorGulkoshEvents::EventShadowBolt, Milliseconds(6 * TimeConstants::IN_MILLISECONDS));
            events.ScheduleEvent(eTeronogorGulkoshEvents::EventUnstableAffliction, Milliseconds(8 * TimeConstants::IN_MILLISECONDS));
            events.ScheduleEvent(eTeronogorGulkoshEvents::EventDrainLife, Milliseconds(10 * TimeConstants::IN_MILLISECONDS));
        }
        ...
        void MoveInLineOfSight(Unit* /*who*/) override
        {
           /* if (who && who->IsPlayer() && me->IsWithinDist(who, 18.0f, false) && !IsLock) //tmp
            {
                IsLock = true;
                who->RemoveUnitFlag(UnitFlags(UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL));
            }*/
...
public:
    ...
    struct auchindoun_teronogor_mob_shaadumAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*p_Attacker*/)
        {
            events.ScheduleEvent(eTerongorEvents::EventWrathcleave, Milliseconds(10 * TimeConstants::IN_MILLISECONDS));
            events.ScheduleEvent(eTerongorEvents::EventWrathstorm, Milliseconds(urand(14 * TimeConstants::IN_MILLISECONDS, 16 * TimeConstants::IN_MILLISECONDS)));
        }
        ...
        void UpdateAI(uint32 p_Diff) override
        {
            ...
            case eShaddumEvents::EventWrathstorm:
                ...
                events.ScheduleEvent(eShaddumEvents::EventWrathstorm, Milliseconds(urand(8 * TimeConstants::IN_MILLISECONDS, 10 * TimeConstants::IN_MILLISECONDS)));
                break;
            case eShaddumEvents::EventWrathcleave:
                if (Unit* l_Random = SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true))
                    me->CastSpell(l_Random, eShaddumSpells::SpellWrathCleave);
                events.ScheduleEvent(eShaddumEvents::EventWrathcleave, Milliseconds(urand(10 * TimeConstants::IN_MILLISECONDS, 14 * TimeConstants::IN_MILLISECONDS)));
                break;
            default:
                break;
            }
...
public:
    ...
    struct auchindoun_teronogor_mob_gromkashAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*p_Attacker*/)
        {
            me->CastStop();
            me->RemoveAllAuras();
            events.ScheduleEvent(eTerongorEvents::EventImmolate, Milliseconds(8 * TimeConstants::IN_MILLISECONDS));
            events.ScheduleEvent(eTerongorEvents::EventIncinrate, Milliseconds(urand(10 * TimeConstants::IN_MILLISECONDS, 12 * TimeConstants::IN_MILLISECONDS)));
            events.ScheduleEvent(eTerongorEvents::EventRainOfFire, Milliseconds(18 * TimeConstants::IN_MILLISECONDS));
        ...
        void UpdateAI(uint32 p_Diff) override
        {
            ...
            case eGromkashEvents::EventImmolate:
                ...
                events.ScheduleEvent(eGromkashEvents::EventImmolate, Milliseconds(10 * TimeConstants::IN_MILLISECONDS));
                break;
            case eGromkashEvents::EventIncinrate:
                if (Unit* l_Random = SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true))
                    me->CastSpell(l_Random, eGromkashSpells::SpellIncinrate);
                events.ScheduleEvent(eGromkashEvents::EventIncinrate, Milliseconds(6 * TimeConstants::IN_MILLISECONDS));
                break;
            case eGromkashEvents::EventRainOfFire:
                if (Unit* l_Random = SelectTarget(SelectTargetMethod::Random, 0, 50.0f, true))
                    me->CastSpell(l_Random, eGromkashSpells::SpellRainOfFire);
                events.ScheduleEvent(eGromkashEvents::EventRainOfFire, Milliseconds(15 * TimeConstants::IN_MILLISECONDS));
                break;
            default:
                break;
            }
        ...
        /*void MoveInLineOfSight(Unit* who) override    //tmp
        {
    ...
    struct auchindoun_teronogor_mob_abyssalAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 /*p_Diff*/) override
        {
            ...
            if (Player* l_Player = ObjectAccessor::GetPlayer(*me, m_Target))
            {
                ...
                if (!me->isMoving())
                    me->GetMotionMaster()->MoveFollow(l_Player, 0, 0, Milliseconds(MovementSlot::MOTION_SLOT_ACTIVE));
            }
            // }
        }
    };
...
public:
    ...
    bool OnGossipHello(Player* p_Player, GameObject* /*p_Gobject*/)
    {
        ...
        }).Schedule(Milliseconds(11000), [p_Player](TaskContext context)
        {
            ...
            p_Player->RemoveUnitFlag(UnitFlags(UNIT_FLAG_DISALLOWED));//UNIT_FLAG2_DISABLE_TURN
        });
        return true;
    }
};
...
public:
    ...
    bool OnGossipHello(Player* p_Player, GameObject* /*p_Gobject*/)
    {
        ...
        }).Schedule(Milliseconds(12000), [p_Player](TaskContext context)
        {
            ...
            p_Player->RemoveUnitMovementFlag(MovementFlags::MOVEMENTFLAG_ROOT);
            p_Player->RemoveUnitFlag(UnitFlags(UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL));
            p_Player->RemoveUnitFlag(UnitFlags(UnitFlags2::UNIT_FLAG2_DISABLE_PRED_STATS));
        });
        return true;
    }
};
...
public:
    ...
    bool OnGossipHello(Player* p_Player, GameObject* /*p_Gobject*/)
    {
        ...
        }).Schedule(Milliseconds(12000), [p_Player](TaskContext context)
        {
            ...
            p_Player->RemoveUnitMovementFlag(MovementFlags::MOVEMENTFLAG_ROOT);
            p_Player->RemoveUnitFlag(UnitFlags(UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL));
            p_Player->RemoveUnitFlag(UnitFlags(UnitFlags2::UNIT_FLAG2_DISABLE_PRED_STATS));//UNIT_FLAG2_DISABLE_TURN
        });
        return true;
    }
};
...
/*    new auchindoun_teronogor_gameobject_soul_transporter_01();      ///< 231736   //CANT SLOVE,TMP
