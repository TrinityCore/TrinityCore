...
class boss_Zaela : public CreatureScript
{
    public:
        boss_Zaela() : CreatureScript("boss_Zaela") { }

        struct boss_ZaelaAI : public ScriptedAI
        {
            boss_ZaelaAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_ZaelaAI(creature);
        }
};
