...
struct boss_tyrant_velhari : public BossAI
{
    boss_tyrant_velhari(Creature* creature) : BossAI(creature, DATA_TYRANT_VELHARI) { Initialize(); }
...
{
    RegisterCreatureAI(boss_tyrant_velhari);
}
