...
class dk_down_map1 : public GameObjectScript
{
    public:

        dk_down_map1(): GameObjectScript("dk_down_map1"){}
		...
		bool OnGossipSelect(Player* player, GameObject* go, uint32 sender, uint32 action) OVERRIDE
		{
			...
			case GOSSIP_ACTION_INFO_DEF+13:
				player->TeleportTo(0,2399.383057f,-5634.744141f,377.020997f,0.618091f);
			default:
