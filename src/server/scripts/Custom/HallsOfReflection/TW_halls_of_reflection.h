...
#define HoRScriptName "TW_instance_halls_of_reflection"
...
enum Creatures
{
    ...
    BOSS_LICH_KING                                = 36954,
    NPC_BARTLETT                                  = 30344, // High Captain Justin Bartlett
    NPC_KORM                                      = 30824, // Sky-Reaver Korm Blackscar
