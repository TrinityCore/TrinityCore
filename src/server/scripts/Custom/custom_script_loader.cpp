...
void AddSC_solocraft();             //����������³ǲ������ű�
void AddSC_SpellCraft();            //����������³ǲ������ű�
void AddSC_LeechCraft();            //����������³ǲ������ű�
void AddSC_CombatRatingCraft();     //����������³ǲ������ű�
void AddSC_Hastecraft();            //����������³ǲ������ű�
void AddLfgSoloScripts();           //����������³ǲ������ű�
void AddSC_custom_npcs();           //�Զ���NPC-�����Ǳ���ǵ����������¼�
void AddSC_custom_player_script();  //����������³ǲ������ű�
void AddSC_GuardianAngel();         //�ػ���
void AddSC_onlogin_announcer();      //��һ�ӭ��Ϣ
void AddSC_Boss_Announcer();        //boss��ɱ����
void AddSC_PvP_System();            //pvp��ɱ����


//void AddSC_debug_lfg();             //���˽����³ǳ���, OpenLCore,�Ѿ��Լ�ͨ������ʵ��,ͣ��
//void AddSC_double_xp();             //����������˫������, OpenLCore,������XpWeekend�ظ�,�ʶ�ͣ��
//void AddSC_start_equipment();       //OpenLCore,������װ��
//void AddSC_quest_conversation();     //����Ի�?           ////�������,��ʹ������������,ǧ�������,����!
