...
UPDATE `creature_template` SET `faction` = '16', `unit_flags2` = '0',`mechanic_immune_mask` = '2',`ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '33217';
UPDATE `creature_template` SET `faction` = '16', `unit_flags2` = '0',`mechanic_immune_mask` = '2',`ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '33316';
UPDATE `creature_template` SET `faction` = '16', `unit_flags2` = '0',`mechanic_immune_mask` = '2',`ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '33317';
UPDATE `creature_template` SET `faction` = '16', `unit_flags2` = '0',`mechanic_immune_mask` = '2',`ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '33318';
UPDATE `creature_template` SET `faction` = '16', `unit_flags2` = '0',`mechanic_immune_mask` = '2',`ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '33319';
UPDATE `creature_template` SET `faction` = '16', `unit_flags2` = '0',`mechanic_immune_mask` = '2',`ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '33320';
UPDATE `creature_template` SET `faction` = '16', `unit_flags2` = '0',`mechanic_immune_mask` = '2',`ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '33321';
UPDATE `creature_template` SET `faction` = '16', `unit_flags2` = '0',`mechanic_immune_mask` = '2',`ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '33322';
...
UPDATE `creature_template` SET `ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '35633';
UPDATE `creature_template` SET `ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '35635';
UPDATE `creature_template` SET `ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '35636';
UPDATE `creature_template` SET `ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '35637';
UPDATE `creature_template` SET `ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '35638';
UPDATE `creature_template` SET `ScriptName` = 'TW_generic_vehicleAI_toc5' WHERE `entry` = '35640';
