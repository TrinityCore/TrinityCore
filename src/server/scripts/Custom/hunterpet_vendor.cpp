...
//Preise
#define PRICE_PET_TYP_1 150000
#define PRICE_PET_TYP_2 2500000
#define MSG_NOT_MONEY "У вас недостаточно золота!"
#define MSG_PET_SUMMON "питомец будет призван..."
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        {
            player->ADD_GOSSIP_ITEM(0, "Нормальные питомцы(стоимость 15 золота)", GOSSIP_SENDER_MAIN, pets);
            player->ADD_GOSSIP_ITEM(0, "Экзотические питомцы(стоимость 250 золота)", GOSSIP_SENDER_MAIN, exotic);
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        {
        case pets:
            //player->ADD_GOSSIP_ITEM(2, "Ядоплюй Колючего Клыка", GOSSIP_SENDER_MAIN, felshetzer);
            player->ADD_GOSSIP_ITEM(2, "Злобный нетопырь", GOSSIP_SENDER_MAIN, fledermaus);
            player->ADD_GOSSIP_ITEM(2, "Болотный терзатель", GOSSIP_SENDER_MAIN, netherrochen);
            player->ADD_GOSSIP_ITEM(2, "Калири Скеттиса", GOSSIP_SENDER_MAIN, raubvogelrot);
            player->ADD_GOSSIP_ITEM(2, "Испачканный нефтью птенец", GOSSIP_SENDER_MAIN, raubvogelschwarz);
            player->ADD_GOSSIP_ITEM(2, "Императорский орел", GOSSIP_SENDER_MAIN, raubvogelweiss);
            //player->ADD_GOSSIP_ITEM(2, "Мрачный ползун", GOSSIP_SENDER_MAIN, schlange);
            player->ADD_GOSSIP_ITEM(2, "Паук высокогорья", GOSSIP_SENDER_MAIN, spinne);
            player->ADD_GOSSIP_ITEM(2, "Небогривая горилла", GOSSIP_SENDER_MAIN, gorillaschwarz);
            player->ADD_GOSSIP_ITEM(2, "Ун'горский рокотун", GOSSIP_SENDER_MAIN, gorillaweiss);
            player->ADD_GOSSIP_ITEM(2, "Гигантский прибрежный краб", GOSSIP_SENDER_MAIN, krebs);
            //player->ADD_GOSSIP_ITEM(2, "Шипастый кроколиск", GOSSIP_SENDER_MAIN, krokolisk);
            //player->ADD_GOSSIP_ITEM(2, "Канюк-костегрыз", GOSSIP_SENDER_MAIN, aasvogel);
            player->ADD_GOSSIP_ITEM(2, "Тундровый мусорщик", GOSSIP_SENDER_MAIN, hyaene);
            player->ADD_GOSSIP_ITEM(2, "Дозорный прайда ледопардов", GOSSIP_SENDER_MAIN, katzetiger);
            player->ADD_GOSSIP_ITEM(2, "Острокол", GOSSIP_SENDER_MAIN, katzeloewe);
            //player->ADD_GOSSIP_ITEM(2, "Аманийская рысь", GOSSIP_SENDER_MAIN, katzeluchs);
            player->ADD_GOSSIP_ITEM(2, "Скверноподданный из каньона Кинжальной Пасти", GOSSIP_SENDER_MAIN, raptorgruen);
            player->ADD_GOSSIP_ITEM(2, "Крикун Кровавой Топи", GOSSIP_SENDER_MAIN, raptorrot);
            player->ADD_GOSSIP_ITEM(2, "Проворный равнинный долгоног", GOSSIP_SENDER_MAIN, weitschreiter);
            player->ADD_GOSSIP_ITEM(2, "Черная браконида", GOSSIP_SENDER_MAIN, wesperot);
            player->ADD_GOSSIP_ITEM(2, "Оса Сапфирного улья", GOSSIP_SENDER_MAIN, wespeblau);
            player->ADD_GOSSIP_ITEM(2, "Бойцовый пес из клана Изувеченной Длани", GOSSIP_SENDER_MAIN, wolfruestung);
            //player->ADD_GOSSIP_ITEM(2, "Дикий ворг", GOSSIP_SENDER_MAIN, wolfgrau);
            //player->ADD_GOSSIP_ITEM(2, "Кровожадный тундровый волк", GOSSIP_SENDER_MAIN, wolfwei?);
            //player->ADD_GOSSIP_ITEM(0, "Я бы предпочел экзотических...", GOSSIP_SENDER_MAIN, exotic);

            player->SEND_GOSSIP_MENU(40011, creature->GetGUID());
            break;

        case exotic:
            player->ADD_GOSSIP_ITEM(2, "Нурамок", GOSSIP_SENDER_MAIN, schimaere);
            player->ADD_GOSSIP_ITEM(2, "Векнисский воин", GOSSIP_SENDER_MAIN, silithidgelb);
            player->ADD_GOSSIP_ITEM(2, "Разоритель-сентипаар", GOSSIP_SENDER_MAIN, silithidrot);
            player->ADD_GOSSIP_ITEM(2, "Теленок шерстистого люторога", GOSSIP_SENDER_MAIN, rhinozeros);
            //player->ADD_GOSSIP_ITEM(2, "Глубинный йормунгар", GOSSIP_SENDER_MAIN, wurmgelb);
            player->ADD_GOSSIP_ITEM(2, "Слизнечерв", GOSSIP_SENDER_MAIN, kernhundweiss);
            player->ADD_GOSSIP_ITEM(2, "Куркен", GOSSIP_SENDER_MAIN, kernhundrot);
            player->ADD_GOSSIP_ITEM(2, "Гончая Недр", GOSSIP_SENDER_MAIN, teufelssaurierweiss);
            player->ADD_GOSSIP_ITEM(2, "Дьявозавр", GOSSIP_SENDER_MAIN, teufelssaurierschwarz);
            player->ADD_GOSSIP_ITEM(2, "Сколл", GOSSIP_SENDER_MAIN, skoll);
            player->ADD_GOSSIP_ITEM(2, "Локе'нахак <Жена Хар'коа>", GOSSIP_SENDER_MAIN, loque);
            player->ADD_GOSSIP_ITEM(2, "Гондрия", GOSSIP_SENDER_MAIN, gondria);
            player->ADD_GOSSIP_ITEM(2, "Арктур", GOSSIP_SENDER_MAIN, arcturis);
            //player->ADD_GOSSIP_ITEM(0, "Я бы предпочел нормальных...", GOSSIP_SENDER_MAIN, pets);
