...
public:
    ...
    void OnLevelChanged(Player* player, uint8 /*oldlevel*/) override            // Any hook here
    {
        ...
        AddGossipItemFor(player, GossipOptionIcon::None, "Morph", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        AddGossipItemFor(player, GossipOptionIcon::None, "Demorph", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
