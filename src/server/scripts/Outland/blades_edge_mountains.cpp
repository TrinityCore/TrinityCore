        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
                ...
                GreenPis::AllWorldObjectsInRange objects(me, searchDistance);
                GreenPis::WorldObjectListSearcher<GreenPis::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
