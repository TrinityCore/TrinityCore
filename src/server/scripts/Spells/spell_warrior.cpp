...
class spell_warr_concussion_blow : public SpellScriptLoader
{
    public:
        ...
        class spell_warr_concussion_blow_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_warr_concussion_blow_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
...
class spell_warr_bloodthirst : public SpellScriptLoader
{
    public:
        ...
        class spell_warr_bloodthirst_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_warr_bloodthirst_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
