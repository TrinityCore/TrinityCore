...
class spell_quest_make_player_destroy_totems : public SpellScript
{
    ...
    void HandleScript(SpellEffIndex /*effIndex*/)
    {
        ...
        GetHitUnit()->CastSpell(GetHitUnit(), SPELL_TOTEM_OF_THE_EARTHEN_RING, TRIGGERED_IGNORE_REAGENT_COST);
    }
...
class spell_q28813_get_our_boys_back_dummy : public SpellScript
{
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
    ...
    void Register() override
    {
        OnCast += SpellCastFn(spell_q28813_get_our_boys_back_dummy::HandleDummyEffect);
    }
};

// 53034 - Set Health Random
class spell_q28813_set_health_random : public SpellScript
{
    void HandleDummyEffect()
    {
        Unit* caster = GetCaster();
    ...
    void Register() override
    {
        OnCast += SpellCastFn(spell_q28813_set_health_random::HandleDummyEffect);
    }
};
...
void AddSC_quest_spell_scripts()
{
    ...
    RegisterSpellScript(spell_q28813_get_our_boys_back_dummy);
    RegisterSpellScript(spell_q28813_set_health_random);
}
