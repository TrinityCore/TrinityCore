...
class spell_gen_bp_damage_pct_from_max_hp : public SpellScriptLoader
{
    public:
        spell_gen_bp_damage_pct_from_max_hp() : SpellScriptLoader("spell_gen_bp_damage_pct_from_max_hp") { }

        class spell_gen_bp_damage_pct_from_max_hp_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_gen_bp_damage_pct_from_max_hp_SpellScript);
            ...
            void Register()
            {
                OnHit += SpellHitFn(spell_gen_bp_damage_pct_from_max_hp_SpellScript::RecalculateDamage);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_gen_bp_damage_pct_from_max_hp_SpellScript();
        }
};

class spell_gen_cataclysmic_bolt : public SpellScriptLoader
{
    public:
        spell_gen_cataclysmic_bolt() : SpellScriptLoader("spell_gen_cataclysmic_bolt") { }

        class spell_gen_cataclysmic_bolt_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_gen_cataclysmic_bolt_SpellScript);
            ...
            void Register()
            {
                OnHit += SpellHitFn(spell_gen_cataclysmic_bolt_SpellScript::RecalculateDamage);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_gen_cataclysmic_bolt_SpellScript();
        }
};
...
void AddSC_generic_spell_scripts()
{
    ...
    new spell_gen_cataclysmic_bolt();
}
