    ...
    public:
        ...
        class spell_gen_blood_reserve_AuraScript : public AuraScript
        {
            ...
            void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
            {
                ...
                caster->CastCustomSpell(caster, SPELL_GEN_BLOOD_RESERVE_HEAL, &triggerAmount, nullptr, nullptr, true);
            ...
            void Register() override
            {
                ...
                OnEffectProc += AuraEffectProcFn(spell_gen_blood_reserve_AuraScript::HandleProc, EFFECT_0, SPELL_AURA_DUMMY);
            }
        };
