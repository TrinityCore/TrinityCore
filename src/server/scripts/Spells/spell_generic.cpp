...
class spell_gen_cannibalize : public SpellScript
{
    ...
    SpellCastResult CheckIfCorpseNear()
    {
        ...
        Kitron::AnyDeadUnitSpellTargetInRangeCheck check(caster, max_range, GetSpellInfo(), TARGET_CHECK_ENEMY);
        Kitron::WorldObjectSearcher<Kitron::AnyDeadUnitSpellTargetInRangeCheck> searcher(caster, result, check);
...
class spell_gen_spectator_cheer_trigger : public SpellScript
{
    ...
    {
        if (roll_chance_i(40))
            GetCaster()->HandleEmoteCommand(Kitron::Containers::SelectRandomContainerElement(EmoteArray));
    }
...
class spell_corrupting_plague_aura : public AuraScript
{
    ...
    void OnPeriodic(AuraEffect const* /*aurEff*/)
    {
        ...
        Kitron::CreatureListSearcher<CorruptingPlagueSearcher> creature_searcher(owner, targets, creature_check);
...
class spell_stasis_field_aura : public AuraScript
{
    ...
    void OnPeriodic(AuraEffect const* /*aurEff*/)
    {
        ...
        Kitron::CreatureListSearcher<StasisFieldSearcher> creature_searcher(owner, targets, creature_check);
        Cell::VisitGridObjects(owner, creature_searcher, 15.0f);
