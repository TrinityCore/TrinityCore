...
public:
    ...
    struct npc_ebon_gargoyleAI : CasterAI
    {
        ...
        void InitializeAI()
        {
            ...
            GreenPis::AnyUnfriendlyUnitInObjectRangeCheck u_check(me, me, 30);
            GreenPis::UnitListSearcher<GreenPis::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, targets, u_check);
