...
#define GOSSIP_HELLO_ROGUE1 "Quiero olvidar mis talentos."
#define GOSSIP_HELLO_ROGUE2 "<Llevar la carta>"
#define GOSSIP_HELLO_ROGUE3 "Comprar una segunda especializaci""\xc3\xb3""n de talentos."
