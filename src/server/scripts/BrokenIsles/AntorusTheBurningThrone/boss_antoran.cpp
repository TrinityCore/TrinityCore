...
//            //tmp        events.RescheduleEvent(EVENT_EXPLOIT_WEAKNESS, 8000);
//            break;
//        case EVENT_SHOCK_GRENADE:
//            DoCast(SPELL_SHOCK_GRENADE_FILTER);
//            //tmp            events.RescheduleEvent(EVENT_SHOCK_GRENADE, 14000);
//           break;
//        case EVENT_CHECK_VICTIM:
//            if (me->GetVictim() && me->GetVictim()->HasAura(SPELL_PSYCHIC_ASSAULT))
//                //DoModifyThreatPercent(me->GetVictim(), -100);
////tmp            events.RescheduleEvent(EVENT_CHECK_VICTIM, 1500);
//            break;
//        }
//    }
//};
...
//        //else
//        //    events.RescheduleEvent(EVENT_2, 4500);//tmp
//
//        checkTimer = 500;
//    }
//
...
//        });
//
//        //tmp       Trinity::Containers::RandomResize(targets, 1);
//    }
//
//    void HandleDummy(SpellEffIndex /*effectIndex*/)
//    {
