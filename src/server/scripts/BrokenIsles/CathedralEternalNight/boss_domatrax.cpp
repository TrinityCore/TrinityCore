    ...
    struct boss_domatraxAI : public BossAI
    {
        ...
        void Reset() override
        {
            ...
            if (Creature* egida = instance->instance->GetCreature(instance->GetGuidData(NPC_EGIDA_START)))
            {
                ...
                //instance->SendEncounterUnit(ENCOUNTER_FRAME_INSTANCE_END, egida);//tmp
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.RescheduleEvent(EVENT_FELSOUL_CLEAVE, Milliseconds(8000));
            events.RescheduleEvent(EVENT_CHAOTIC_ENERGY, Milliseconds(1000));

            if (Creature* egida = instance->instance->GetCreature(instance->GetGuidData(NPC_EGIDA_START)))
            {
                instance->SendEncounterUnit(ENCOUNTER_FRAME_ENGAGE, egida);
                instance->SendEncounterUnit(ENCOUNTER_FRAME_ADD_COMBAT_RES_LIMIT, egida);
        ...
        void SummonedCreatureDies(Creature* summon, Unit* /*killer*/) override
        {
            if (summon->GetEntry() == NPC_PORTAL_OWNER)
            {
                ...
                //instance->SendEncounterUnit(ENCOUNTER_FRAME_INSTANCE_END, summon);//tmp
            }
        }

        void OnSpellFinished(SpellInfo const* spell) 
        {
            switch (spell->Id)
            {
            case SPELL_WAVE_TWO:
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            if (Creature* egida = instance->instance->GetCreature(instance->GetGuidData(NPC_EGIDA_START)))
            {
                ...
                egida->DespawnOrUnsummon(Milliseconds(3000));
        ...
        void DamageTaken(Unit* /*attacker*/, uint32& /*damage*/)
        {
            if (phase < 3 && me->HealthBelowPct(phases_hp_required[phase]))
            {
                ...
                {
                case 0:
                    events.RescheduleEvent(EVENT_WAVE_ONE, Milliseconds(100));
                    break;
                case 1:
                    events.RescheduleEvent(EVENT_WAVE_TWO, Milliseconds(100));
                    break;
                case 2:
                    events.RescheduleEvent(EVENT_ENRAGE, Milliseconds(100));
                    break;
                default:
                    break;
                }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_FELSOUL_CLEAVE:
                    ...
                    events.RescheduleEvent(EVENT_FELSOUL_CLEAVE, Milliseconds(18000));
                    break;
                case EVENT_CHAOTIC_ENERGY:
                    ...
                    else
                    {
                        ...
                        events.RescheduleEvent(EVENT_CHAOTIC_ENERGY, Milliseconds(5000));
                    }
                    break;
                case EVENT_WAVE_ONE:
