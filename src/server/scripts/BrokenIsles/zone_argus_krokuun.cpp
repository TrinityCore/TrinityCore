...
//{
//public:
////    zone_argus_krokuun() : ZoneScript("zone_argus_krokuun") { }//tmp
//
...
//    {
//        //player->GetScheduler().CancelGroup(ZONE_KROKUUN);//tmp
//    }
//};
//
//// 251924
...
//        if (!player)
//            return;
////        if (!HasPlayer(player->GetGUID()) && (player->HasQuest(QUEST_H_THE_HAND_OF_FATE)) && !player->GetQuestObjectiveData(QUEST_H_THE_HAND_OF_FATE, 0))//tmp
//        {
...
////            AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_VEREESA_READY, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);//tmp
...
//            //    });
//            //}
//            //tmp          events.ScheduleEvent(EVENT_UPDATE_PHASES, 13000);
//        }
//
//        void UpdateAI(uint32 diff) override
//        {
...
//                {
////                    if ((*itr)->ToPlayer()->GetQuestStatus(QUEST_THE_VINDICAAR) == QUEST_STATUS_INCOMPLETE && (*itr)->ToPlayer()->GetQuestObjectiveData(QUEST_THE_VINDICAAR, 2))//tmp
//                    {
