...
//
// //tmp       player->SetPower(POWER_ALTERNATE_POWER, player->GetPower(POWER_ALTERNATE_POWER) + spellInfo->GetEffect(EFFECT_0)->BasePoints);
//
//  //tmp      for (int32 i = 0; i < spellInfo->GetEffect(EFFECT_0)->BasePoints; ++i)
...
//            {
//                //tmp               caster->EnergizeBySpell(caster, GetSpellInfo(), GetSpellInfo()->GetEffect(EFFECT_0)->BasePoints, POWER_ALTERNATE_POWER);
...
//    }
//
//    void QuestReward(Player* player, Quest const* quest, LootItemType /*type*/, uint32 /*item*/) 
//    {
//        if (quest->GetQuestId() == 38358)
...
//                {
//                    //tmp               if (caster->GetPower(POWER_ALTERNATE_POWER) > caster->ToPlayer()->GetQuestObjectiveData(38058, 1))
//                    //tmp    for (int32 i = 0; i < (std::min(caster->GetPower(POWER_ALTERNATE_POWER), 100) - caster->ToPlayer()->GetQuestObjectiveData(38058, 1)); ++i)
...
//                   // IsLock = true;
//                    Talk(0);
//                    //tmp                me->GetScheduler().Schedule(Milliseconds(5000), [this, player](TaskContext context)
//                    {
//                        Talk(1);
//                    });
//                   // SetUnlock(120000);
