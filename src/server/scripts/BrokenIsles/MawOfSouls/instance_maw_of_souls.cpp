    ...
    public:
        ...
        struct instance_maw_of_souls_InstanceScript : public InstanceScript
        {
            ...
            void OnCreatureCreate(Creature* creature) override
            {
                ...
                {
                    case NPC_YMIRON_MAW:    YmironMawGUID = creature->GetGUID();    break;
                    case NPC_HARBARON_MAW:  HarbaronMawGUID = creature->GetGUID();  break;
                    case NPC_HELYA_MAW:     HelyaMawGUID = creature->GetGUID();     break;
                    default: break;
                }
            }
