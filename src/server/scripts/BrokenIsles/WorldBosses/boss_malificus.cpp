    ...
    struct boss_malificusAI : public WorldBossAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                {
                    //DoCastRandom(SPELL_INCITE_PANIC, false);//org
                    /*DoCastRandom(SPELL_INCITE_PANIC, false);
                    DoCastRandom(SPELL_INCITE_PANIC, false);*/

                    Unit* target = SelectTarget(SelectTargetMethod::Random);
                    me->CastSpell(target, Spells::SPELL_INCITE_PANIC, true);
                    me->CastSpell(target, Spells::SPELL_INCITE_PANIC, true);
                    me->CastSpell(target, Spells::SPELL_INCITE_PANIC, true);
                ...
                case EVENT_PESTILENCE:
                {
                    ...
                    Unit* target = SelectTarget(SelectTargetMethod::Random);
                    me->CastSpell(target, Spells::SPELL_PESTILENCE, false);
                    events.Repeat(14s);
                    break;
                }
                case EVENT_SHADOW_BARRAGE:
                {
                    ...
                    Unit* target = SelectTarget(SelectTargetMethod::Random);
                    me->CastSpell(target, Spells::SPELL_SHADOW_BARRAGE, false);
