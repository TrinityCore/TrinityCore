...
public:
    ...
    struct boss_sharthosAI : public WorldBossAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.ScheduleEvent(EventTailLash, Milliseconds(8) * IN_MILLISECONDS);
            events.ScheduleEvent(EventDreadFlame, Milliseconds(11) * IN_MILLISECONDS);
            events.ScheduleEvent(EventNightmareBreath, Milliseconds(16) * IN_MILLISECONDS);
            events.ScheduleEvent(EventBurningEarth, Milliseconds(28) * IN_MILLISECONDS);
            events.ScheduleEvent(EventCryOfTheTormented, Milliseconds(63) * IN_MILLISECONDS);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case Events::EventTailLash:
                    ...
                    events.ScheduleEvent(Events::EventTailLash, Milliseconds(8000));
                    break;
                case Events::EventDreadFlame:
                    me->CastSpell(me->GetVictim(), Spells::DreadFlame);
                    events.ScheduleEvent(EventDreadFlame, Milliseconds(urand(19, 25)) * IN_MILLISECONDS);
                    break;
                case Events::EventNightmareBreath:
                    DoCastAOE(Spells::NightmareBreath);
                    events.ScheduleEvent(Events::EventNightmareBreath, Milliseconds(18000));
                    break;
                ...
                case Events::EventCryOfTheTormented:
                    ...
                    events.ScheduleEvent(EventCryOfTheTormented, Milliseconds(63000));
                    break;
                }
            }
