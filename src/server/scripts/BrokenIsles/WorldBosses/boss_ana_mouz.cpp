        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 1:
                    ...
                    events.RescheduleEvent(1, Milliseconds(22000));
                    events.RescheduleEvent(2, Milliseconds(3000));
                    break;
                case 2:
                ...
                case 3:
                    ...
                    events.RescheduleEvent(3, Milliseconds(31000));
                    break;
                case 4:
                    DoCast(SPELL_MOTHERS_EMBRACE);
                    events.RescheduleEvent(4, Milliseconds(65000));
                    break;
                }
            }
