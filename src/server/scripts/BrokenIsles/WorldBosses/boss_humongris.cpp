...
struct boss_humongris : public ScriptedAI
{
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        events.ScheduleEvent(EVENT_ICE_FIST, Milliseconds(29000));
        events.ScheduleEvent(EVENT_MAKE_SNOW, Milliseconds(35000));
        events.ScheduleEvent(EVENT_YOU_GO_BANG, Milliseconds(24400));
    }
    ...
    void ExecuteEvent(uint32 eventId) //override
    {
        ...
        case EVENT_EARTHSHAKE_STOMP:
            ...
            events.Repeat(Milliseconds(28800));
            break;
        ...
        case EVENT_ICE_FIST:
            ...
            events.Repeat(Milliseconds(29000));
            break;
        ...
        case EVENT_YOU_GO_BANG:
            ...
            events.Repeat(Milliseconds(24400));
            break;
        }
    }
    EventMap events;
