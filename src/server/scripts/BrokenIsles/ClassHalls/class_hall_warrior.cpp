...
//                TELE_TO_SPELL | TELE_TO_NOT_LEAVE_COMBAT | TELE_TO_SEAMLESS, 247832); // 247832 = SkyJump, visual of the landing + stun removal
//        }
//    }
//
//    void Register() override
...
//        {
//            player->SummonCreature(100519, me->GetNearPosition(5.0f, me->GetFollowAngle()), TEMPSUMMON_MANUAL_DESPAWN, 0, 0, player->GetGUID());
