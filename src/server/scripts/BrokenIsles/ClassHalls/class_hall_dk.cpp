...
//                    player->SummonCreature(102459, me->GetPosition(), TEMPSUMMON_MANUAL_DESPAWN, 0, 0, player->GetGUID());
//                }
//                else
//                {
//                    if (Creature* mob = player->SummonCreature(102459, me->GetPosition(), TEMPSUMMON_MANUAL_DESPAWN, 0, 0, player->GetGUID()))
//                        mob->Say(104853);
//                }
//
