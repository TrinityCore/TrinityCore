...
//            if (me->IsWithinDist(player, 15.0f, false))
//            {
//                //if (/*!IsLock && */player->HasQuest(QUEST_KEEPERS_OF_THE_HAMMER))//tmp
//                //{
//                //    //IsLock = true;
//                //    me->Say(99596);
...
//        //    Creature* Warbrave02 = player->SummonCreature(98788, Position(3555.33f, 4380.189f, 663.773f, 3.5473f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
//        //    Igrul->Say(100465);
...
//        //    Creature* Warbrave02 = player->SummonCreature(98788, Position(3519.07f, 4295.7f, 680.42f, 2.621f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
//        //    Igrul->Say(100831);
//        //    player->GetScheduler().Schedule(Milliseconds(10000), [Huln](TaskContext context)
//        //    {
//        //        Huln->Say(100832);
...
//    bool OnGossipHello(Player* player, GameObject* go) 
//    {
//        //if (go->GetEntry() == 250994)//tmp
//        //{
//        //    player->RemoveAurasDueToSpell(191564);
//        //    Creature* Ebonhorn = player->SummonCreature(99190, Position(3419.129f, 4297.44f, 704.041f, 4.68f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
//        //    Creature* Igrul = player->SummonCreature(96387, Position(3427.0f, 4254.979f, 704.059f, 1.551f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
//        //    Creature* Huln = player->SummonCreature(96318, Position(3425.44f, 4296.27f, 704.379f, 4.53f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
//        //    Creature* Mayla = player->SummonCreature(96523, Position(3430.49f, 4295.62f, 703.898f, 4.34947f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
//
//        //    Creature* Deathwing = player->SummonCreature(97056, Position(3427.34f, 4272.229f, 704.005f, 1.57f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
//        //    Deathwing->Say(98359);
...
//        //    });
//
//        //    Creature* Drogbar01 = player->SummonCreature(99138, Position(3410.1f, 4272.1098f, 704.4719f, 0.0069f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
//        //    Creature* Drogbar02 = player->SummonCreature(99138, Position(3412.22f, 4263.99f, 705.056f, 0.49896f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
...
//        //    //tmp            me->GetScheduler().Schedule(15s, [this](TaskContext /*context*/)
//        //    {
...
////tmp                player->ForceCompleteQuest(QUEST_JUSTICE_RAINS_FROM_ABOVE);
//            }
//        }
//    }
//
...
//        //tmp       player->SummonCreature(98825, Position(4057.2099f, 4320.37f, 675.603f, 1.2158f), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
//    }
//};
//
...
//    //new go_quest_40219_highmountain_brazier();//tmp
