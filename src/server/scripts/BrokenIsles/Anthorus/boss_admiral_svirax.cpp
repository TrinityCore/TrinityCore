...
enum Creatures
{
    ...
    NPC_CHIEF_ENGINEER_ISHKAR = 0,
    NPC_GENERAL_ERODUS =0,
    NPC_CHIEF_ENGINEER_ISHKAR = 0,
    NPC_GENERAL_ERODUS = 0,
    NPC_CHIEF_ENGINEER_ISHKAR = 0,
...
enum Phases
{
    Phase_One_Active_Boss_Admiral_Svirax,
    Phase_Two_Active_Boss_Chief_Engineer_Ishkar,
    Phase_Three_Active_Boss_General_Erodus,
};
