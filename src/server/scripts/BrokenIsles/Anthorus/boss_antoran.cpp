...
struct boss_admiral_svirax : public BossAI
{
    ...
    //    //    me->SummonCreature(NPC_CHIEF_ENGINEER_ISHKAR, phase2pos, TEMPSUMMON_MANUAL_DESPAWN, Milliseconds(WEEK));
    //    //    break;
    //    //}
    ...
    //    //    events.ScheduleEvent(SPELL_ENTROPIC_MINE, 5s);
    //    //    me->SummonCreature(NPC_GENERAL_ERODUS, phase2pos, TEMPSUMMON_MANUAL_DESPAWN, Milliseconds(WEEK));
    //    //    break;
    //    //}
