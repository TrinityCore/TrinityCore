                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_MIND_BLAST:
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 1, 100.0f, true, -int32(sSpellMgr->GetSpellIdForDifficulty(SPELL_SLEEP, me))))
                        ...
                        case EVENT_VAMPIRIC_TOUCH:
                            ...
                            break;
                        case EVENT_SLEEP:
                            if (Unit* target = SelectTarget(SelectAggroTarget::Random, 1, 100.0f))
