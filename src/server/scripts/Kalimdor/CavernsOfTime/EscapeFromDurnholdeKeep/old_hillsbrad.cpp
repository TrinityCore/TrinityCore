...
enum ThrallOldHillsbrad
{
    ...
    GOSSIP_ITEM_WALKING_OID     = 0,                           //We are ready to get you out of here, Thrall. Let's go!
    GOSSIP_ITEM_TARREN_MID      = 7840,
    GOSSIP_ITEM_TARREN_OID      = 0,                           //We're ready, Thrall.
    GOSSIP_ITEM_SKARLOC1_MID    = 7830,
    GOSSIP_ITEM_SKARLOC1_OID    = 0,                           //Taretha cannot see you, Thrall.
    GOSSIP_ITEM_SKARLOC2_MID    = 7829,
    GOSSIP_ITEM_SKARLOC2_OID    = 0                            //The situation is rather complicated, Thrall. It would be best for you to head into the mountains now, before more of Blackmoore's men show up. We'll make sure Taretha is safe.
};
...
public:
    ...
    struct npc_thrall_old_hillsbradAI : public EscortAI
    {
        ...
        bool OnGossipSelect(Player* player, uint32 /*menuId*/, uint32 gossipListId) override
        {
            ...
            switch (action)
            {
                ...
                case GOSSIP_ACTION_INFO_DEF + 2:
                    AddGossipItemFor(player, GOSSIP_ITEM_SKARLOC2_MID, GOSSIP_ITEM_SKARLOC2_OID, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 20);
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            {
                AddGossipItemFor(player, GOSSIP_ITEM_WALKING_MID, GOSSIP_ITEM_WALKING_OID, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
            ...
            {
                AddGossipItemFor(player, GOSSIP_ITEM_SKARLOC1_MID, GOSSIP_ITEM_SKARLOC1_OID, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
            ...
            {
                AddGossipItemFor(player, GOSSIP_ITEM_TARREN_MID, GOSSIP_ITEM_TARREN_OID, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
