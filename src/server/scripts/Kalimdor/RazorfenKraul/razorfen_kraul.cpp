...
public:
    ...
    struct npc_snufflenose_gopherAI : public PetAI
    {
        ...
        void MovementInform(uint32 type, uint32 id)
        {
            ...
            {
                if (GameObject* pGo = me->GetMap()->GetGameObject(TargetTubberGUID))
                {
        ...
        void DoFindNewTubber()
        {
            ...
            TargetTubberGUID = pNearestTubber->GetGUID();

            // XFurry was wrong...
            me->GetMotionMaster()->MovePoint(POINT_TUBBER, pNearestTubber->GetPositionX(),
                                                           pNearestTubber->GetPositionY(),
                                                           pNearestTubber->GetPositionZ());
