...
public:
    ...
    struct boss_veknilashAI : public boss_twinemperorsAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            {
                Unit* randomMelee = SelectTarget(SelectAggroTarget::Random, 0, NOMINAL_MELEE_RANGE, true);
                if (randomMelee)
...
public:
    ...
    struct boss_veklorAI : public boss_twinemperorsAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            {
                if (Unit* target = SelectTarget(SelectAggroTarget::Random, 0, 45, true))
            ...
            {
                if (Unit* mvic = SelectTarget(SelectAggroTarget::MinDistance, 0, NOMINAL_MELEE_RANGE, true))
                {
