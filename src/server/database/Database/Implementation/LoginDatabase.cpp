...
void LoginDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(LOGIN_UPD_SV, "UPDATE account SET v = ?, s = ? WHERE id = ?", CONNECTION_ASYNC);
    ...
    PrepareStatement(LOGIN_SEL_LOGONCHALLENGE, "SELECT a.id, a.username, a.locked, a.lock_country, a.last_ip, a.failed_logins, ab.unbandate > UNIX_TIMESTAMP() OR ab.unbandate = ab.bandate, "
        "ab.unbandate = ab.bandate, aa.SecurityLevel, a.totp_secret, IF(length(a.s)=0 OR length(a.v)=0, a.sha_pass_hash, NULL), a.s, a.v "
