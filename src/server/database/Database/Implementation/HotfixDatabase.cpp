...
void HotfixDatabaseConnection::DoPrepareStatements()
{
    ...
    // QuestPOIBlob.db2
    PrepareStatement(HOTFIX_SEL_QUEST_POI_BLOB, "SELECT ID, MapID, UiMapID, NumPoints, QuestID, ObjectiveIndex, ObjectiveID, PlayerConditionID, Unknown901 FROM quest_poi_blob"
        " WHERE (`VerifiedBuild` > 0) = ?", CONNECTION_SYNCH);
