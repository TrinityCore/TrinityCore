...
void WorldDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(WORLD_SEL_ACTION_SET, "SELECT Id, `Index`, `Type`, Unit, Point, Path, TimeA, MoveSpeed, StringId, TimeB, LinearPath, CircularPath, FlightPath, TargetType, TargetParam1, TargetParam2, TargetParam3, TargetParam4, Extra0, Extra1, Extra2, Extra3, Extra4 FROM action_set ORDER BY Id, `Index`", CONNECTION_SYNCH);
