...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_SEL_BNET_WARBAND_GROUPS,
    LOGIN_SEL_BNET_WARBAND_GROUP_MEMBERS,
    LOGIN_DEL_BNET_WARBAND_GROUPS,
    LOGIN_DEL_BNET_WARBAND_GROUP_MEMBERS,
    LOGIN_INS_BNET_WARBAND_GROUP,
    LOGIN_INS_BNET_WARBAND_GROUP_MEMBER,
