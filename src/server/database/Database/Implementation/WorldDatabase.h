...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_SEL_CONVERSATION_TEMPLATE,
    WORLD_SEL_CONVERSATION_ACTOR_TEMPLATE,
    WORLD_SEL_CONVERSATION_LINE_TEMPLATE,
    WORLD_SEL_CONVERSATION_ACTORS,
    WORLD_SEL_CONVERSATION_LINES,
