...
enum WorldDatabaseStatements : uint32
{
    ...
    */
    ...
    WORLD_SEL_CREATURE_GUIDS_BY_ZONE,
    WORLD_SEL_AI_WORLD_FACTION_ENTRY_DEFAULTS,
    WORLD_SEL_AI_AGENT_TYPE_ENTRY_DEFAULTS,
    WORLD_SEL_AI_SPAWN_PARTICIPATION_DEFAULTS,
    WORLD_SEL_AI_WORLD_FACTION_RELATIONS,
    WORLD_SEL_AI_WORLD_FACTION_REPUTATION_DEFAULTS,
