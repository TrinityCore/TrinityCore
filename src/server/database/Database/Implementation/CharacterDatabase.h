...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_DEL_ITEM_ENCHANTMENTS,
    CHAR_INS_ITEM_ENCHANTMENTS,
    CHAR_DEL_ITEM_CHARGES,
    CHAR_INS_ITEM_CHARGES,
    CHAR_DEL_ITEM_CREATOR,
    CHAR_INS_ITEM_CREATOR,
    CHAR_DEL_ITEM_TEXT,
    CHAR_INS_ITEM_TEXT,
    CHAR_DEL_ITEM_DURATION,
    CHAR_INS_ITEM_DURATION,
    CHAR_DEL_ITEM_RANDOMPROPERTYID,
    CHAR_INS_ITEM_RANDOMPROPERTYID,
    CHAR_DEL_ITEM_PLAYEDTIME,
    CHAR_INS_ITEM_PLAYEDTIME,
    CHAR_UPD_ITEM_INSTANCE,
    CHAR_UPD_ITEM_INSTANCE_FLAGS_DURABILITY,
    ...
    CHAR_INS_CHARACTER,
    CHAR_UPD_CHARACTER,
    CHAR_DEL_CHAR_TRANSPORT,
    CHAR_INS_CHAR_TRANSPORT,
    CHAR_DEL_CHAR_DRUNK,
    CHAR_INS_CHAR_DRUNK,
    CHAR_DEL_CHAR_GRANTABLELEVELS,
    CHAR_INS_CHAR_GRANTABLELEVELS,
    CHAR_DEL_CHAR_STABLE_SLOTS,
    CHAR_INS_CHAR_STABLE_SLOTS,
    CHAR_DEL_CHAR_TAXI_PATH,
    CHAR_INS_CHAR_TAXI_PATH,
    CHAR_DEL_CHAR_RESETTALENTS,
    CHAR_INS_CHAR_RESETTALENTS,
    CHAR_DEL_CHAR_TITLE,
    CHAR_INS_CHAR_TITLE,
    CHAR_DEL_CHAR_PVP_STATS,
    CHAR_INS_CHAR_PVP_STATS,

    CHAR_SEL_AT_LOGIN_FLAG,
    CHAR_DEL_AT_LOGIN_FLAG,
    CHAR_INS_AT_LOGIN_FLAG,
    CHAR_INS_BUG_REPORT,
    ...
    CHAR_DEL_DELETE_INFO,
    CHAR_INS_DELETE_INFO,
    CHAR_UPD_CHAR_DELETED,
