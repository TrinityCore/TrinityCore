...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_AI_AGENTS,
    CHAR_SEL_AI_AGENT_BY_BINDING,
    CHAR_INS_AI_AGENT,
    CHAR_UPD_AI_AGENT_CONTROL_MODE,
    CHAR_SEL_AI_AGENT_CONTROL_MODE,
    CHAR_SEL_AI_AGENT_BINDINGS,
    CHAR_SEL_AI_AGENT_CONTROL_MODES,
    CHAR_SEL_AI_AGENT_WORLD_FACTIONS,
    CHAR_SEL_AI_AGENT_TYPES,
    CHAR_UPD_AI_AGENT_ECONOMY,
    CHAR_SEL_AI_AGENT_GROUP_ID_SEQUENCE,
    CHAR_UPD_AI_AGENT_GROUP_ID_SEQUENCE,
    CHAR_SEL_AI_AGENT_GROUP_MAX_ID,
    CHAR_SEL_AI_AGENT_GROUPS,
    CHAR_INS_AI_AGENT_GROUP,
    CHAR_UPD_AI_AGENT_GROUP,
    CHAR_UPD_AI_AGENT_GROUP_PROFILE_ID,
    CHAR_DEL_AI_AGENT_GROUP,
    CHAR_SEL_AI_AGENT_GROUP_MEMBERS,
    CHAR_INS_AI_AGENT_GROUP_MEMBER,
    CHAR_DEL_AI_AGENT_GROUP_MEMBER,
    CHAR_DEL_AI_AGENT_GROUP_MEMBERS_BY_GROUP,

    CHAR_SEL_AI_LONG_TERM_MEMORIES,
    CHAR_INS_AI_LONG_TERM_MEMORY,

    CHAR_SEL_AI_PLAYER_WORLD_FACTION,
    CHAR_REP_AI_PLAYER_WORLD_FACTION,
    CHAR_DEL_AI_PLAYER_WORLD_FACTION,
