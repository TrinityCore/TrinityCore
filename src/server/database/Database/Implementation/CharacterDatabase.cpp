...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_SEL_CHARACTER_QUESTSTATUS_DAILY, "SELECT quest, time FROM character_queststatus_daily cq join characters.characters c on c.guid = cq.guid join characters.characters allC on allC.account = c.account WHERE allC.guid = ?", CONNECTION_ASYNC);
