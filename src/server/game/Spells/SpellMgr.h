...
enum ProcFlags
{
    ...
    PROC_FLAG_END_OF_SPELL_CAST               = 0x20000000,    // 29 On end of spell cast
    PROC_FLAG_ON_LOOT                         = 0x40000000,    // 30 Looted something

    PROC_FLAG_TAKEN_HELPFUL_PERIODIC          = 0x80000000,    // 31 Taken helpful periodic
