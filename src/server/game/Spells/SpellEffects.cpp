...
void Spell::EffectTriggerSpell(SpellEffIndex effIndex)
{
    ...
    if (!spellInfo)
    {
        TC_LOG_ERROR("spells.nospell", "Spell::EffectTriggerSpell spell %u tried to trigger unknown spell %u", m_spellInfo->Id, triggered_spell_id);
        return;
    }
...
void Spell::EffectTriggerMissileSpell(SpellEffIndex effIndex)
{
    ...
    if (!spellInfo)
    {
        TC_LOG_ERROR("spells.nospell", "Spell::EffectTriggerMissileSpell spell %u tried to trigger unknown spell %u.", m_spellInfo->Id, triggered_spell_id);
        return;
    }
...
void Spell::EffectForceCast(SpellEffIndex effIndex)
{
    ...
    if (!spellInfo)
    {
        TC_LOG_ERROR("spells.nospell", "Spell::EffectForceCast of spell %u: triggering unknown spell id %i.", m_spellInfo->Id, triggered_spell_id);
        return;
    }
...
void Spell::EffectTriggerRitualOfSummoning(SpellEffIndex effIndex)
{
    ...
    if (!spellInfo)
    {
        TC_LOG_ERROR("spells.nospell", "EffectTriggerRitualOfSummoning of spell %u: triggering unknown spell id %i.", m_spellInfo->Id, triggered_spell_id);
        return;
    }
