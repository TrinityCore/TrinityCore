...
void Spell::EffectSummonObjectWild(SpellEffIndex effIndex)
{
    ...
    if (!pGameObj->Create(map->GenerateLowGuid<HighGuid::GameObject>(), gameobject_id, map,
        m_caster->GetPhaseMask(), x, y, z, target->GetOrientation(), QuatData::Empty, 100, GO_STATE_READY))
    {
        delete pGameObj;
        return;
    }
...
void Spell::EffectDuel(SpellEffIndex effIndex)
{
    ...
    if (!pGameObj->Create(map->GenerateLowGuid<HighGuid::GameObject>(), gameobject_id,
        ...
        m_caster->GetOrientation(), QuatData::Empty, 0, GO_STATE_READY))
    {
        delete pGameObj;
        return;
    }
...
void Spell::EffectSummonObject(SpellEffIndex effIndex)
{
    ...
    if (!go->Create(map->GenerateLowGuid<HighGuid::GameObject>(), go_id, map,
        m_caster->GetPhaseMask(), x, y, z, m_caster->GetOrientation(), QuatData::Empty, 0, GO_STATE_READY))
    {
        delete go;
        return;
    }
...
void Spell::EffectTransmitted(SpellEffIndex effIndex)
{
    ...
    if (!pGameObj->Create(cMap->GenerateLowGuid<HighGuid::GameObject>(), name_id, cMap,
        m_caster->GetPhaseMask(), fx, fy, fz, m_caster->GetOrientation(), QuatData::Empty, 100, GO_STATE_READY))
    {
        delete pGameObj;
        return;
    }
