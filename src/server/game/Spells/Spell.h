...
class TC_GAME_API Spell
{
    ...
    public:
        ...
        template<class SEARCHER> void SearchTargets(SEARCHER& searcher, uint32 containerMask, WorldObject* referer, Position const* pos, float radius, bool extraRadius = false);
