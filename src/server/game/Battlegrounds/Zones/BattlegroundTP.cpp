...
bool BattlegroundTP::SetupBattleground()
{
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundTP: Failed to spawn some objects Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundTP: Failed to spawn Alliance spirit guides! Battleground not created!");
        return false;
    }
    ...
    if (!sg || !AddSpiritGuide(TP_SPIRIT_ALLIANCE, sg->x, sg->y, sg->z, 3.641396f, ALLIANCE))
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundTP: Failed to spawn Alliance start spirit guides! Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundTP: Failed to spawn Horde spirit guides! Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundTP: Failed to spawn Horde start spirit guide! Battleground not created!");
        return false;
    }
