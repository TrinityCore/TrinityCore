...
bool BattlegroundSA::ResetObjs()
{
    ...
    GetBGObject(BG_SA_BOAT_ONE)->SetTransportPathRotation(G3D::Quat(0.f, 0.f, 1.0f, 0.0002f));
    GetBGObject(BG_SA_BOAT_TWO)->SetTransportPathRotation(G3D::Quat(0.f, 0.f, 1.0f, 0.00001f));
