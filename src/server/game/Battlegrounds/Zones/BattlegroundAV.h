...
enum BG_AV_PVP_Stats
{
    BG_AV_PVP_STAT_TOWERS_ASSAULTED     = 61,
    BG_AV_PVP_STAT_GRAVEYARDS_ASSAULTED = 63,
    BG_AV_PVP_STAT_TOWERS_DEFENDED      = 64,
    BG_AV_PVP_STAT_GRAVEYARDS_DEFENDED  = 65,
    BG_AV_PVP_STAT_SECONDARY_OBJECTIVES = 82
};
