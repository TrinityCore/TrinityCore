...
enum BG_AV_Player_Scores_Index
{
    SCORE_INDEX_ASSAULT_GRAVEYARD   = 0,
    SCORE_INDEX_DEFEND_GRAVEYARD    = 1,
    SCORE_INDEX_ASSAULT_TOWER       = 2,
    SCORE_INDEX_DEFEND_TOWER        = 3,
    SCORE_INDEX_SECONDARY_OBJECTIVE = 4
};
