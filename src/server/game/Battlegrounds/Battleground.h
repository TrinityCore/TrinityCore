...
{
    BG_REWARD_WINNER_HONOR_FIRST    = 120,
    BG_REWARD_WINNER_CONQUEST_FIRST = 120,
    BG_REWARD_WINNER_HONOR_LAST     = 60,
    BG_REWARD_WINNER_CONQUEST_LAST  = 60,
    BG_REWARD_LOSER_HONOR_FIRST     = 20,
    BG_REWARD_LOSER_HONOR_LAST      = 20
};
