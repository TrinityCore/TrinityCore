...
{
    BG_REWARD_WINNER_HONOR_FIRST    = 12,
    BG_REWARD_WINNER_CONQUEST_FIRST = 12,
    BG_REWARD_WINNER_HONOR_LAST     = 6,
    BG_REWARD_WINNER_CONQUEST_LAST  = 6,
    BG_REWARD_LOSER_HONOR_FIRST     = 2,
    BG_REWARD_LOSER_HONOR_LAST      = 2
};
