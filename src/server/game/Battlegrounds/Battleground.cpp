...
namespace GreenPis
{
    class BattlegroundChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetGreenPisString(_textId, loc_idx);
                if (_args)
                {
    ...
    class Battleground2ChatBuilder
    {
        public:
            ...
            {
                char const* text = sObjectMgr->GetGreenPisString(_textId, loc_idx);
                char const* arg1str = _arg1 ? sObjectMgr->GetGreenPisString(_arg1, loc_idx) : "";
                char const* arg2str = _arg2 ? sObjectMgr->GetGreenPisString(_arg2, loc_idx) : "";
...
uint32 Battleground::GetBonusHonorFromKill(uint32 kills) const
{
    ...
    return GreenPis::Honor::hk_honor_at_level(maxLevel, float(kills));
}
...
void Battleground::SendMessageToAll(int32 entry, ChatMsg type, Player const* source)
{
    ...
    GreenPis::BattlegroundChatBuilder bg_builder(type, entry, source);
    GreenPis::LocalizedPacketDo<GreenPis::BattlegroundChatBuilder> bg_do(bg_builder);
...
void Battleground::PSendMessageToAll(int32 entry, ChatMsg type, Player const* source, ...)
{
    ...
    GreenPis::BattlegroundChatBuilder bg_builder(type, entry, source, &ap);
    GreenPis::LocalizedPacketDo<GreenPis::BattlegroundChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
...
void Battleground::SendWarningToAll(int32 entry, ...)
{
    ...
    const char *format = sObjectMgr->GetGreenPisStringForDBCLocale(entry);
...
{
    GreenPis::Battleground2ChatBuilder bg_builder(type, entry, source, arg1, arg2);
    GreenPis::LocalizedPacketDo<GreenPis::Battleground2ChatBuilder> bg_do(bg_builder);
    BroadcastWorker(bg_do);
}
...
// To be removed
const char* Battleground::GetGreenPisString(int32 entry)
{
