...
enum WorldFloatConfigs
{
    ...
    CONFIG_JAIL_TELE_ALLY_X,
    CONFIG_JAIL_TELE_ALLY_Y,
    CONFIG_JAIL_TELE_ALLY_Z,
    CONFIG_JAIL_TELE_ALLY_O,
    CONFIG_JAIL_TELE_HORDE_X,
    CONFIG_JAIL_TELE_HORDE_Y,
    CONFIG_JAIL_TELE_HORDE_Z,
    CONFIG_JAIL_TELE_HORDE_O,
...
enum WorldIntConfigs
{
    ...
    CONFIG_JAIL_MAX_JAILS,
    CONFIG_JAIL_MAX_DURATION,
    CONFIG_JAIL_MIN_REASON,
    CONFIG_JAIL_WARN_PLAYER,
    CONFIG_JAIL_AMNESTIE,
    CONFIG_JAIL_TELE_ALLY_MAP,
    CONFIG_JAIL_TELE_HORDE_MAP,
    CONFIG_JAIL_RADIUS,
