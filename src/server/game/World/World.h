...
class TC_GAME_API World
{
    public:
        ...
        void SendGlobalMessage(WorldPacket const* packet, WorldSession* self = nullptr, Team team = TEAM_OTHER);
        void SendGlobalGMMessage(WorldPacket const* packet, WorldSession* self = nullptr, Team team = TEAM_OTHER);
        bool SendZoneMessage(uint32 zone, WorldPacket const* packet, WorldSession* self = nullptr, Team team = TEAM_OTHER);
        void SendZoneText(uint32 zone, const char *text, WorldSession* self = nullptr, Team team = TEAM_OTHER);
