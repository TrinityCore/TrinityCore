...
enum WorldIntConfigs
{
    ...
    CONFIG_CORPSE_DECAY_RARE_ELITE,
    CONFIG_CORPSE_DECAY_OBSOLETE,
    CONFIG_CORPSE_DECAY_RARE,
    CONFIG_CORPSE_DECAY_TRIVIAL,
    CONFIG_CORPSE_DECAY_MINUS_MOB,
...
enum Rates
{
    ...
    RATE_CREATURE_ELITE_HP,
    RATE_CREATURE_RARE_ELITE_HP,
    RATE_CREATURE_OBSOLETE_HP,
    RATE_CREATURE_RARE_HP,
    RATE_CREATURE_TRIVIAL_HP,
    RATE_CREATURE_MINUS_MOB_HP,
    RATE_CREATURE_NORMAL_DAMAGE,
    RATE_CREATURE_ELITE_DAMAGE,
    RATE_CREATURE_RARE_ELITE_DAMAGE,
    RATE_CREATURE_OBSOLETE_DAMAGE,
    RATE_CREATURE_RARE_DAMAGE,
    RATE_CREATURE_TRIVIAL_DAMAGE,
    RATE_CREATURE_MINUS_MOB_DAMAGE,
    RATE_CREATURE_NORMAL_SPELLDAMAGE,
    RATE_CREATURE_ELITE_SPELLDAMAGE,
    RATE_CREATURE_RARE_ELITE_SPELLDAMAGE,
    RATE_CREATURE_OBSOLETE_SPELLDAMAGE,
    RATE_CREATURE_RARE_SPELLDAMAGE,
    RATE_CREATURE_TRIVIAL_SPELLDAMAGE,
    RATE_CREATURE_MINUS_MOB_SPELLDAMAGE,
    RATE_CREATURE_AGGRO,
    RATE_REST_INGAME,
