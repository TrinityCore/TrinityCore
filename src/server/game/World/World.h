...
enum WorldBoolConfigs
{
    ...
    CONFIG_POOL_INIT_STATE,
    CONFIG_POOL_LOOT_RESET_CORPSE_DECAY,
    CONFIG_POOL_STOP_ON_INVALID_CONFIG,
    CONFIG_POOL_REUSE_GUIDS,
...
enum WorldIntConfigs
{
    ...
    CONFIG_POOL_DEFAULT_CREATURE_RESPAWN,
    CONFIG_POOL_DEFAULT_CORPSE_DECAY_LOOT,
    CONFIG_POOL_DEFAULT_CORPSE_DECAY_NOLOOT,
    CONFIG_POOL_DEFAULT_GAMEOBJECT_RESPAWN,
    CONFIG_POOL_FAST_RESPAWN_WAIT,
    CONFIG_POOL_UPDATE_RATE,
