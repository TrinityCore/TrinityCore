...
PersistentWorldVariable const World::NextArenaPointDistributionTime{ "NextArenaPointDistributionTime" };
...
void World::SetInitialWorldSettings()
{
    ...
    sWorldStateMgr->LoadFromDB();                               // must be loaded before battleground, outdoor PvP, conditions and PoolMgr as PoolMgr is creating the maps
