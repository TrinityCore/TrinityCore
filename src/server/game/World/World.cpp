...
void World::LoadConfigSettings(bool reload)
{
    ...
    rate_values[RATE_CREATURE_ELITE_HP]                 = sConfigMgr->GetFloatDefault("Rate.Creature.Elite.HP", 1.0f);
    rate_values[RATE_CREATURE_RARE_ELITE_HP]            = sConfigMgr->GetFloatDefault("Rate.Creature.Rare.Elite.HP", 1.0f);
    rate_values[RATE_CREATURE_OBSOLETE_HP]              = sConfigMgr->GetFloatDefault("Rate.Creature.Obsolete.HP", 1.0f);
    rate_values[RATE_CREATURE_RARE_HP]                  = sConfigMgr->GetFloatDefault("Rate.Creature.Rare.HP", 1.0f);
    rate_values[RATE_CREATURE_TRIVIAL_HP]               = sConfigMgr->GetFloatDefault("Rate.Creature.Trivial.HP", 1.0f);
    rate_values[RATE_CREATURE_MINUS_MOB_HP]             = sConfigMgr->GetFloatDefault("Rate.Creature.Minus.Mob.HP", 1.0f);
    rate_values[RATE_CREATURE_NORMAL_DAMAGE]            = sConfigMgr->GetFloatDefault("Rate.Creature.Normal.Damage", 1.0f);
    rate_values[RATE_CREATURE_ELITE_DAMAGE]             = sConfigMgr->GetFloatDefault("Rate.Creature.Elite.Damage", 1.0f);
    rate_values[RATE_CREATURE_RARE_ELITE_DAMAGE]        = sConfigMgr->GetFloatDefault("Rate.Creature.Rare.Elite.Damage", 1.0f);
    rate_values[RATE_CREATURE_OBSOLETE_DAMAGE]          = sConfigMgr->GetFloatDefault("Rate.Creature.Obsolete.Damage", 1.0f);
    rate_values[RATE_CREATURE_RARE_DAMAGE]              = sConfigMgr->GetFloatDefault("Rate.Creature.Rare.Damage", 1.0f);
    rate_values[RATE_CREATURE_TRIVIAL_DAMAGE]           = sConfigMgr->GetFloatDefault("Rate.Creature.Trivial.Damage", 1.0f);
    rate_values[RATE_CREATURE_MINUS_MOB_DAMAGE]         = sConfigMgr->GetFloatDefault("Rate.Creature.Minus.Mob.Damage", 1.0f);
    rate_values[RATE_CREATURE_NORMAL_SPELLDAMAGE]       = sConfigMgr->GetFloatDefault("Rate.Creature.Normal.SpellDamage", 1.0f);
    rate_values[RATE_CREATURE_ELITE_SPELLDAMAGE]        = sConfigMgr->GetFloatDefault("Rate.Creature.Elite.SpellDamage", 1.0f);
    rate_values[RATE_CREATURE_RARE_ELITE_SPELLDAMAGE]   = sConfigMgr->GetFloatDefault("Rate.Creature.Rare.Elite.SpellDamage", 1.0f);
    rate_values[RATE_CREATURE_OBSOLETE_SPELLDAMAGE]     = sConfigMgr->GetFloatDefault("Rate.Creature.Obsolete.SpellDamage", 1.0f);
    rate_values[RATE_CREATURE_RARE_SPELLDAMAGE]         = sConfigMgr->GetFloatDefault("Rate.Creature.Rare.SpellDamage", 1.0f);
    rate_values[RATE_CREATURE_TRIVIAL_SPELLDAMAGE]      = sConfigMgr->GetFloatDefault("Rate.Creature.Trivial.SpellDamage", 1.0f);
    rate_values[RATE_CREATURE_MINUS_MOB_SPELLDAMAGE]    = sConfigMgr->GetFloatDefault("Rate.Creature.Minus.Mob.SpellDamage", 1.0f);
