...
void World::LoadConfigSettings(bool reload)
{
    ...
    // Allow IP History Logging only if  CONFIG_ALLOW_LOGGING_IP_ADDRESSES_IN_DATABASE is enabled.
    if (m_bool_configs[CONFIG_ALLOW_LOGGING_IP_ADDRESSES_IN_DATABASE])
    {
