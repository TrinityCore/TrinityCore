...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_START_DEATH_KNIGHT_LEVEL] = sConfigMgr->GetIntDefault("StartDeathKnightLevel", 55);
    if (m_int_configs[CONFIG_START_DEATH_KNIGHT_LEVEL] < 1)
    {
        TC_LOG_ERROR("server.loading", "StartDeathKnightLevel (%i) must be in range 1..MaxPlayerLevel(%u). Set to 55.",
            m_int_configs[CONFIG_START_DEATH_KNIGHT_LEVEL], m_int_configs[CONFIG_MAX_PLAYER_LEVEL]);
        m_int_configs[CONFIG_START_DEATH_KNIGHT_LEVEL] = 55;
    }
    else if (m_int_configs[CONFIG_START_DEATH_KNIGHT_LEVEL] > m_int_configs[CONFIG_MAX_PLAYER_LEVEL])
    {
        TC_LOG_ERROR("server.loading", "StartDeathKnightLevel (%i) must be in range 1..MaxPlayerLevel(%u). Set to %u.",
            m_int_configs[CONFIG_START_DEATH_KNIGHT_LEVEL], m_int_configs[CONFIG_MAX_PLAYER_LEVEL], m_int_configs[CONFIG_MAX_PLAYER_LEVEL]);
        m_int_configs[CONFIG_START_DEATH_KNIGHT_LEVEL] = m_int_configs[CONFIG_MAX_PLAYER_LEVEL];
    }
