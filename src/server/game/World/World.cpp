...
void World::SendGlobalMessage(WorldPacket const* packet, WorldSession* self, Team team)
{
    SessionMap::const_iterator itr;
    for (itr = m_sessions.begin(); itr != m_sessions.end(); ++itr)
    {
...
void World::SendGlobalGMMessage(WorldPacket const* packet, WorldSession* self, Team team)
{
...
bool World::SendZoneMessage(uint32 zone, WorldPacket const* packet, WorldSession* self, Team team)
{
...
void World::SendZoneText(uint32 zone, char const* text, WorldSession* self, Team team)
{
    WorldPackets::Chat::Chat packet;
