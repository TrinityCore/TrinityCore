...
void World::LoadConfigSettings(bool reload)
{
    ...
    std::string ignoreVMapIds = sConfig->GetStringDefault("vmap.ignoreMapIds", "");
    ...
    VMAP::VMapFactory::createOrGetVMapManager()->preventMapsFromBeingUsed(ignoreVMapIds.c_str());
    VMAP::VMapFactory::preventSpellsFromBeingTestedForLoS(ignoreSpellIds.c_str());
    sLog->outString("WORLD: VMap support included. LineOfSight: %i, getHeight: %i, indoorCheck: %i, ignoreMapIds: %s, ignoreSpellIds: %s, PetLOS: %i", enableLOS, enableHeight, enableIndoor, ignoreVMapIds.c_str(), ignoreSpellIds.c_str(), enablePetLOS);
