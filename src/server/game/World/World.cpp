...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_ARENA_SEASON_ID]                            = sConfig->GetIntDefault ("Arena.ArenaSeason.ID", 8);
    ...
    m_int_configs[CONFIG_ARENA_SEASON_PREVIOUS_ID]                   = sConfig->GetIntDefault("Arena.ArenaSeasonPrevious.ID", 7);
