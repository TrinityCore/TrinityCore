...
{
    GreenPis_READ_GUARD(HashMapHolder<Player>::LockType, *HashMapHolder<Player>::GetLock());
...
{
    GreenPis_READ_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
...
void ObjectAccessor::RemoveCorpse(Corpse* corpse)
{
    ...
    // Critical section
    {
        GreenPis_WRITE_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
        ...
        CellCoord cellCoord = GreenPis::ComputeCellCoord(corpse->GetPositionX(), corpse->GetPositionY());
