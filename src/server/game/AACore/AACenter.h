...
struct AA_Item_Instance
{
    ...
    uint32 randomBonusListId = 0;
    uint16 durability = 0;
    uint32 playedTime = 0;
    std::string text = "";
    uint32 transmogrification = 0;//` int(10) unsigned NOT NULL DEFAULT '0',
    uint32 enchantIllusion = 0;//` int(10) unsigned NOT NULL DEFAULT '0',
    uint32 battlePetSpeciesId = 0;//` int(10) unsigned NOT NULL DEFAULT '0',
    uint32 battlePetBreedData = 0;//` int(10) unsigned NOT NULL DEFAULT '0',
    uint16 battlePetLevel = 0;//` smallint(5) unsigned NOT NULL DEFAULT '0',
    uint32 battlePetDisplayId = 0;//` int(10) unsigned NOT NULL DEFAULT '0',
    uint8 context = 0;//` tinyint(3) unsigned NOT NULL DEFAULT '0',
