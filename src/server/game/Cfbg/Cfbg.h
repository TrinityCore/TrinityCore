/*
+ * Copyright (C) 2013-2016 DeathCore <http://www.deathcore.org/>
+ *
...
enum FakeMorphs
{
    ...
    FAKE_M_BLOOD_ELF_MALE = 20578,
    FAKE_M_BLOOD_ELF_FEMALE = 20579,
    FAKE_M_HUMAN_MALE = 19723,
    FAKE_M_HUMAN_FEMALE = 19724
};
#endif
