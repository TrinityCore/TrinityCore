...
void LoadNpcTele(void)
{
    ...
    if (result)
    {
        sLog->outError(LOG_FILTER_GENERAL, "TSCR: Loading %s, %s and %s...", Table[0], Table[1], Table[2]);
        ...
        sLog->outError(LOG_FILTER_GENERAL, "TSCR: >> Loaded %u npc_teleport.", nbDest);
    } else sLog->outError(LOG_FILTER_GENERAL, "TSCR: WARNING >> Loaded 0 npc_teleport.");
}
