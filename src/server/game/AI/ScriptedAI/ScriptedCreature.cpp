/* Copyright (C) 2008-2012 GreenPis <http://www.GreenPis.org/>
 *
...
std::list<Creature*> ScriptedAI::DoFindFriendlyCC(float range)
{
    ...
    GreenPis::CreatureListSearcher<GreenPis::FriendlyCCedInRange> searcher(me, list, u_check);
    me->VisitNearbyObject(range, searcher);
    return list;
}
...
{
    std::list<Creature*> list;
    GreenPis::FriendlyMissingBuffInRange u_check(me, range, uiSpellid);
...
Player* ScriptedAI::GetPlayerAtMinimumRange(float minimumRange)
{
    ...
    GreenPis::PlayerAtMinimumRangeAway check(me, minimumRange);
    GreenPis::PlayerSearcher<GreenPis::PlayerAtMinimumRangeAway> searcher(me, player, check);
    TypeContainerVisitor<GreenPis::PlayerSearcher<GreenPis::PlayerAtMinimumRangeAway>, GridTypeMapContainer> visitor(searcher);
