...
protected:
    ...
    //uint32 WarriorIDLE_AOEAddLife = 45517;			 
    //uint32 WarriorIDLE_AOEAddPower = 27578;			
    ...
    //uint32 WarriorCommon_PowerAtt = 25712;			 
    //uint32 WarriorCommon_PowerThrow = 57755;			 
    //uint32 WarriorCommon_PowerRelife = 184364;		 
    //uint32 WarriorCommon_ClearCtrl = 18499;			 
    //uint32 WarriorCommon_AOEFear = 65930;			
    //uint32 WarriorCommon_SweepAtt = 231833;			
    //uint32 WarriorCommon_AddPower = 173401;			
    //uint32 WarriorCommon_AOEDecPower = 27579;		
    ...
    uint32 WarriorDefance_ShieldBlock = 38031;		
    uint32 WarriorDefance_ShieldAtt = 23922;			
    uint32 WarriorDefance_Pojia = 25051;				
    uint32 WarriorDefance_MaxLife = 12975;			
    uint32 WarriorDefance_ShiledWall = 871;			
    uint32 WarriorDefance_Disarm = 11879;				
    uint32 WarriorDefance_Support = 41198;			
    ...
    */
    ...
    /*
    uint32 WarriorWeapon_SwordStorm = 9632;			
    uint32 WarriorWeaponDefance_AOEAtt = 165749;		
    uint32 WarriorWeaponDefance_Bleed = 43931;		
    uint32 WarriorWeaponDefance_SpellReflect = 57643;	
    uint32 WarriorWeaponDefance_ShieldHit = 149383;		

    uint32 WarriorWeapon_HighThrow = 65940;			
    uint32 WarriorWeapon_Charge = 100;			
    uint32 WarriorWeapon_Suppress = 7384;			
    uint32 WarriorWeapon_Backstorm = 22857;			
    uint32 WarriorWeapon_DeadAtt = 27580;			

    uint32 WarriorWeaponRage_FullKill = 5308;		
    ...
    uint32 WarriorRage_Whirlwind = 12950;			
    uint32 WarriorRage_Impertinency = 13847;			
    uint32 WarriorRage_Needdead = 199261;			
    uint32 WarriorRage_Bloodthirsty = 39071;			
    uint32 WarriorRage_ReIntercept = 184364;			
    */
};
