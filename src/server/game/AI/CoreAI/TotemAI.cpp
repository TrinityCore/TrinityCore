...
void TotemAI::UpdateAI(uint32 const /*diff*/)
{
    ...
    {
        victim = NULL;
        GreenPis::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
        GreenPis::UnitLastSearcher<GreenPis::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
