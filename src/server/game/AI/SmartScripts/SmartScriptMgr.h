...
enum SMART_EVENT
{
    ...
    SMART_EVENT_POWER_PCT                = 3,       // PowerMin%, PowerMax%, RepeatMin, RepeatMax
    ...
    SMART_EVENT_TARGET_POWER_PCT         = 18,      // PowerMin%, PowerMax%, RepeatMin, RepeatMax
...
const uint32 SmartAIEventMask[SMART_EVENT_END][2] =
{
    ...
    {SMART_EVENT_TARGET_POWER_PCT,          SMART_SCRIPT_TYPE_MASK_CREATURE },
