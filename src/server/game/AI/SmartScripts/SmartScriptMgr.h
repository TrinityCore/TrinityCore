...
enum SMART_EVENT
{
    ...
    SMART_EVENT_ON_PLAYER_CHOICE_RESPONSE= 86,      // ResponseId
...
enum SmartScriptType
{
    ...
    SMART_SCRIPT_TYPE_PLAYER_CHOICE = 13, // done
...
enum SmartAITypeMaskId
{
    ...
    SMART_SCRIPT_TYPE_MASK_PLAYERCHOICE = 4096,
};
...
const uint32 SmartAITypeMask[SMART_SCRIPT_TYPE_MAX][2] =
{
    ...
    {SMART_SCRIPT_TYPE_PLAYER_CHOICE,                 SMART_SCRIPT_TYPE_MASK_PLAYERCHOICE },
};
...
const uint32 SmartAIEventMask[SMART_EVENT_END][2] =
{
    ...
    {SMART_EVENT_ON_PLAYER_CHOICE_RESPONSE, SMART_SCRIPT_TYPE_MASK_PLAYERCHOICE },
};
