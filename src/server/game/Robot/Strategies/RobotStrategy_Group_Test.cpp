...
std::string RobotStrategy_Group_Test::GetGroupRoleName()
{
    ...
    case GroupRole_Test::GroupRole_Test_Tank3:
    {
        return "tank3";
    }
    case GroupRole_Test::GroupRole_Test_Tank4:
    {
        return "tank4";
    }
    case GroupRole_Test::GroupRole_Test_Tank5:
    {
        return "tank5";
    }
    case GroupRole_Test::GroupRole_Test_Healer1:
    {
        return "healer1";
    }
    case GroupRole_Test::GroupRole_Test_Healer2:
    {
        return "healer2";
    }
    case GroupRole_Test::GroupRole_Test_Healer3:
    {
        return "healer3";
    }
    case GroupRole_Test::GroupRole_Test_Healer4:
    {
        return "healer4";
    }
    case GroupRole_Test::GroupRole_Test_Healer5:
    {
        return "healer5";
    }
    case GroupRole_Test::GroupRole_Test_Healer6:
    {
        return "healer6";
    }
    case GroupRole_Test::GroupRole_Test_Healer7:
    {
        return "healer7";
    }
    case GroupRole_Test::GroupRole_Test_Healer8:
    {
        return "healer8";
    }
...
void RobotStrategy_Group_Test::SetGroupRole(std::string pmRoleName)
{
    ...
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Tank3;
    }
    else if (pmRoleName == "tank4")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Tank4;
    }
    else if (pmRoleName == "tank5")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Tank5;
    }
    else if (pmRoleName == "healer1")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Healer1;
    }
    else if (pmRoleName == "healer2")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Healer2;
    }
    else if (pmRoleName == "healer3")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Healer3;
    }
    else if (pmRoleName == "healer4")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Healer4;
    }
    else if (pmRoleName == "healer5")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Healer5;
    }
    else if (pmRoleName == "healer6")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Healer6;
    }
    else if (pmRoleName == "healer7")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Healer7;
    }
    else if (pmRoleName == "healer8")
    {
        me->groupRole = GroupRole_Test::GroupRole_Test_Healer8;
    }
...
bool RobotStrategy_Group_Test::Stay(std::string pmTargetGroupRole)
{
    ...
    {
        if (me->groupRole != GroupRole_Test::GroupRole_Test_Healer1 && me->groupRole != GroupRole_Test::GroupRole_Test_Healer2 && me->groupRole != GroupRole_Test::GroupRole_Test_Healer3 && me->groupRole != GroupRole_Test::GroupRole_Test_Healer4 && me->groupRole != GroupRole_Test::GroupRole_Test_Healer5 && me->groupRole != GroupRole_Test::GroupRole_Test_Healer6 && me->groupRole != GroupRole_Test::GroupRole_Test_Healer7 && me->groupRole != GroupRole_Test::GroupRole_Test_Healer8)
        {
            todo = false;
        }
    }
    ...
    {
        if (me->groupRole != GroupRole_Test::GroupRole_Test_Tank1 && me->groupRole != GroupRole_Test::GroupRole_Test_Tank2 && me->groupRole != GroupRole_Test::GroupRole_Test_Tank3 && me->groupRole != GroupRole_Test::GroupRole_Test_Tank4 && me->groupRole != GroupRole_Test::GroupRole_Test_Tank5)
        {
            todo = false;
        }
    }
    ...
    if (Group* myGroup = me->GetGroup())
    {
        if (Unit* boss = GetAttacker(CreatureEntry_RobotStrategy::CreatureEntry_RobotStrategy_Group_Lethon))
        {
            ...
            if (bossPositionValid)
            {
                ...
                if (me->groupRole == GroupRole_Test::GroupRole_Test_DPS_Range)
                {
                    ...
                    if (tank1->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(1))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                if (Player* healer2 = GetPlayerByGroupRole(GroupRole_Test::GroupRole_Test_Healer2))
                                {
                                    if (healer2->IsAlive())
                                    {
                                ...
                                {
                                    if (Player* healer3 = GetPlayerByGroupRole(GroupRole_Test::GroupRole_Test_Healer3))
                                    {
                                        if (healer3->IsAlive())
                                        {
                    ...
                    if (tank1->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(1))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                if (!activeHealerSwitched)
                                {
                                    if (Player* healer1 = GetPlayerByGroupRole(GroupRole_Test::GroupRole_Test_Healer1))
                                    {
                                        if (healer1->IsAlive())
                                        {
                    ...
                    if (tank2->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(2))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                bool activeHealerSwitched = false;
                                if (Player* healer5 = GetPlayerByGroupRole(GroupRole_Test::GroupRole_Test_Healer5))
                                {
                                    if (healer5->IsAlive())
                                    {
                                ...
                                if (!activeHealerSwitched)
                                {
                                    if (Player* healer6 = GetPlayerByGroupRole(GroupRole_Test::GroupRole_Test_Healer6))
                                    {
                                        if (healer6->IsAlive())
                                        {
                    ...
                    if (tank2->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(2))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                if (!activeHealerSwitched)
                                {
                                    if (Player* healer4 = GetPlayerByGroupRole(GroupRole_Test::GroupRole_Test_Healer4))
                                    {
                                        if (healer4->IsAlive())
                                        {
            ...
            case GroupRole_Test::GroupRole_Test_Healer7:
            {
                ...
                if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(3))
                {
                    if (activeHealerOG == me->GetGUID())
                    {
                                    ...
                                    if (me->GetPower(Powers::POWER_MANA) > 500)
                                    {
                                        for (GroupReference* groupRef = myGroup->GetFirstMember(); groupRef != nullptr; groupRef = groupRef->next())
                                        {
                                            if (Player* member = groupRef->GetSource())
                                            {
                                                if (member->IsAlive())
                                                {
                                                    if (member->groupRole == GroupRole_Test::GroupRole_Test_Tank1 || member->groupRole == GroupRole_Test::GroupRole_Test_Tank2)
                                                    {
                                                        continue;
                                                    }
                        ...
                        if (Player* healer8 = GetPlayerByGroupRole(GroupRole_Test::GroupRole_Test_Healer8))
                        {
                            if (healer8->IsAlive())
                            {
            ...
            case GroupRole_Test::GroupRole_Test_Healer8:
            {
                ...
                if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(3))
                {
                    if (activeHealerOG == me->GetGUID())
                    {
                        ...
                        if (Player* healer7 = GetPlayerByGroupRole(GroupRole_Test::GroupRole_Test_Healer7))
                        {
                            if (healer7->IsAlive())
                            {
