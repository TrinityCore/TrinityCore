...
void RobotStrategy_Group_Lucifron::InitialStrategy()
{
    engageAngle = 0.0f;
    engageDistance = 0.0f;
...
std::string RobotStrategy_Group_Lucifron::GetGroupRoleName()
{
    if (!me)
    {
        return "";
    ...
    switch (me->groupRole)
    {
    case GroupRole_Lucifron::GroupRole_Lucifron_Tank1:
    {
        return "tank1";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Tank2:
    {
        return "tank2";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Tank3:
    {
        return "tank3";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Tank4:
    {
        return "tank4";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Tank5:
    {
        return "tank5";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Healer1:
    {
        return "healer1";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Healer2:
    {
        return "healer2";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Healer3:
    {
        return "healer3";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Healer4:
    {
        return "healer4";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Healer5:
    {
        return "healer5";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Healer6:
    {
        return "healer6";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Healer7:
    {
        return "healer7";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_Healer8:
    {
        return "healer8";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_DPS_Range:
    {
        return "dpsr";
    }
    case GroupRole_Lucifron::GroupRole_Lucifron_DPS_Melee:
    {
        return "dpsm";
    }
    default:
...
void RobotStrategy_Group_Lucifron::SetGroupRole(std::string pmRoleName)
{
    if (!me)
    {
        return;
    ...
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Tank1;
    }
    else if (pmRoleName == "tank2")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Tank2;
    }
    else if (pmRoleName == "tank3")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Tank3;
    }
    else if (pmRoleName == "tank4")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Tank4;
    }
    else if (pmRoleName == "tank5")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Tank5;
    }
    else if (pmRoleName == "healer1")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Healer1;
    }
    else if (pmRoleName == "healer2")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Healer2;
    }
    else if (pmRoleName == "healer3")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Healer3;
    }
    else if (pmRoleName == "healer4")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Healer4;
    }
    else if (pmRoleName == "healer5")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Healer5;
    }
    else if (pmRoleName == "healer6")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Healer6;
    }
    else if (pmRoleName == "healer7")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Healer7;
    }
    else if (pmRoleName == "healer8")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_Healer8;
    }
    else if (pmRoleName == "dpsm")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_DPS_Melee;
    }
    else if (pmRoleName == "dpsr")
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_DPS_Range;
    }
    else
    {
        me->groupRole = GroupRole_Lucifron::GroupRole_Lucifron_DPS_Range;
...
bool RobotStrategy_Group_Lucifron::Stay(std::string pmTargetGroupRole)
{
    if (!me)
    {
        return false;
    ...
    {
        if (me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_DPS_Melee && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_DPS_Range)
        {
            todo = false;
        }
    }
    ...
    {
        if (me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Healer1 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Healer2 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Healer3 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Healer4 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Healer5 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Healer6 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Healer7 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Healer8)
        {
            todo = false;
        }
    }
    ...
    {
        if (me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Tank1 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Tank2 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Tank3 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Tank4 && me->groupRole != GroupRole_Lucifron::GroupRole_Lucifron_Tank5)
        {
            todo = false;
        }
    }
...
bool RobotStrategy_Group_Lucifron::Hold(std::string pmTargetGroupRole)
{
    if (!me)
    {
        return false;
...
bool RobotStrategy_Group_Lucifron::Engage(Unit* pmTarget)
{
    if (!me)
    {
        return false;
...
bool RobotStrategy_Group_Lucifron::Follow()
{
    if (!me)
    {
        return false;
...
void RobotStrategy_Group_Lucifron::Update(uint32 pmDiff)
{
    if (!Update0(pmDiff))
    {
        return;
    ...
    if (Group* myGroup = me->GetGroup())
    {
        if (actionDelay > 0)
        {
            ...
            switch (actionType)
            {
            case ActionType_Lucifron::ActionType_Lucifron_MarkMove:
            {
...
bool RobotStrategy_Group_Lucifron::DPS()
{
    if (!me->IsAlive())
    {
        return true;
    ...
    if (Group* myGroup = me->GetGroup())
    {
        if (Unit* boss = GetAttacker(CreatureEntry_RobotStrategy::CreatureEntry_RobotStrategy_Azuregos))
        {
            ...
            if (bossPositionValid)
            {
                ...
                if (me->groupRole == GroupRole_Lucifron::GroupRole_Lucifron_DPS_Range)
                {
                ...
                if (!myPositionValid)
                {
                    ...
                    actionDelay = 3000;
                    actionType = ActionType_Lucifron::ActionType_Lucifron_MarkMove;
...
bool RobotStrategy_Group_Lucifron::Tank()
{
    if (Group* myGroup = me->GetGroup())
    {
        if (Unit* boss = GetAttacker(CreatureEntry_RobotStrategy::CreatureEntry_RobotStrategy_Azuregos))
            ...
            case GroupRole_Lucifron::GroupRole_Lucifron_Tank1:
            {
                if (ObjectGuid activeTankOG = myGroup->GetOGByTargetIcon(0))
                {
                    if (activeTankOG == me->GetGUID())
                    {
                        ...
                        if (Player* tank2 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Tank2))
                        {
                            if (tank2->IsAlive())
                            {
            ...
            case GroupRole_Lucifron::GroupRole_Lucifron_Tank2:
            {
                if (ObjectGuid activeTankOG = myGroup->GetOGByTargetIcon(0))
                {
                    if (activeTankOG == me->GetGUID())
                    {
                        ...
                        if (Player* tank1 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Tank1))
                        {
                            if (tank1->IsAlive())
                            {
...
bool RobotStrategy_Group_Lucifron::Tank(Unit* pmTarget)
{
    if (!me)
    {
        return false;
...
bool RobotStrategy_Group_Lucifron::Heal()
{
    if (Group* myGroup = me->GetGroup())
    {
        if (Unit* boss = GetAttacker(CreatureEntry_RobotStrategy::CreatureEntry_RobotStrategy_Azuregos))
                    ...
                    if (tank1->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(1))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                if (Player* healer2 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Healer2))
                                {
                                    if (healer2->IsAlive())
                                    {
                                ...
                                {
                                    if (Player* healer3 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Healer3))
                                    {
                                        if (healer3->IsAlive())
                                        {
                    ...
                    if (tank1->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(1))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                if (!activeHealerSwitched)
                                {
                                    if (Player* healer1 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Healer1))
                                    {
                                        if (healer1->IsAlive())
                                        {
                    ...
                    if (tank2->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(2))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                bool activeHealerSwitched = false;
                                if (Player* healer5 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Healer5))
                                {
                                    if (healer5->IsAlive())
                                    {
                                ...
                                if (!activeHealerSwitched)
                                {
                                    if (Player* healer6 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Healer6))
                                    {
                                        if (healer6->IsAlive())
                                        {
                    ...
                    if (tank2->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(2))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                if (!activeHealerSwitched)
                                {
                                    if (Player* healer4 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Healer4))
                                    {
                                        if (healer4->IsAlive())
                                        {
            ...
            case GroupRole_Lucifron::GroupRole_Lucifron_Healer7:
            {
                ...
                if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(3))
                {
                    if (activeHealerOG == me->GetGUID())
                    {
                                    ...
                                    if (me->GetPower(Powers::POWER_MANA) > 500)
                                    {
                                        for (GroupReference* groupRef = myGroup->GetFirstMember(); groupRef != nullptr; groupRef = groupRef->next())
                                        {
                                            if (Player* member = groupRef->GetSource())
                                            {
                                                if (member->IsAlive())
                                                {
                                                    if (member->groupRole == GroupRole_Lucifron::GroupRole_Lucifron_Tank1 || member->groupRole == GroupRole_Lucifron::GroupRole_Lucifron_Tank2)
                                                    {
                                                        continue;
                                                    }
                        ...
                        if (Player* healer8 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Healer8))
                        {
                            if (healer8->IsAlive())
                            {
            ...
            case GroupRole_Lucifron::GroupRole_Lucifron_Healer8:
            {
                ...
                if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(3))
                {
                    if (activeHealerOG == me->GetGUID())
                    {
                        ...
                        if (Player* healer7 = GetPlayerByGroupRole(GroupRole_Lucifron::GroupRole_Lucifron_Healer7))
                        {
                            if (healer7->IsAlive())
                            {
