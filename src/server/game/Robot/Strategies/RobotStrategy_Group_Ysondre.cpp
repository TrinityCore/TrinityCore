                    ...
                    if (tank1->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(1))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                if (Player* healer2 = GetPlayerByGroupRole(GroupRole_Ysondre::GroupRole_Ysondre_Healer2))
                                {
                                    if (healer2->IsAlive())
                                    {
                                ...
                                {
                                    if (Player* healer3 = GetPlayerByGroupRole(GroupRole_Ysondre::GroupRole_Ysondre_Healer3))
                                    {
                                        if (healer3->IsAlive())
                                        {
                    ...
                    if (tank1->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(1))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                if (!activeHealerSwitched)
                                {
                                    if (Player* healer1 = GetPlayerByGroupRole(GroupRole_Ysondre::GroupRole_Ysondre_Healer1))
                                    {
                                        if (healer1->IsAlive())
                                        {
                    ...
                    if (tank2->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(2))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                bool activeHealerSwitched = false;
                                if (Player* healer5 = GetPlayerByGroupRole(GroupRole_Ysondre::GroupRole_Ysondre_Healer5))
                                {
                                    if (healer5->IsAlive())
                                    {
                                ...
                                if (!activeHealerSwitched)
                                {
                                    if (Player* healer6 = GetPlayerByGroupRole(GroupRole_Ysondre::GroupRole_Ysondre_Healer6))
                                    {
                                        if (healer6->IsAlive())
                                        {
                    ...
                    if (tank2->IsAlive())
                    {
                        ...
                        if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(2))
                        {
                            if (activeHealerOG == me->GetGUID())
                            {
                                ...
                                if (!activeHealerSwitched)
                                {
                                    if (Player* healer4 = GetPlayerByGroupRole(GroupRole_Ysondre::GroupRole_Ysondre_Healer4))
                                    {
                                        if (healer4->IsAlive())
                                        {
            ...
            case GroupRole_Ysondre::GroupRole_Ysondre_Healer7:
            {
                ...
                if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(3))
                {
                    if (activeHealerOG == me->GetGUID())
                    {
                        ...
                        if (Player* healer8 = GetPlayerByGroupRole(GroupRole_Ysondre::GroupRole_Ysondre_Healer8))
                        {
                            if (healer8->IsAlive())
                            {
            ...
            case GroupRole_Ysondre::GroupRole_Ysondre_Healer8:
            {
                ...
                if (ObjectGuid activeHealerOG = myGroup->GetOGByTargetIcon(3))
                {
                    if (activeHealerOG == me->GetGUID())
                    {
                        ...
                        if (Player* healer7 = GetPlayerByGroupRole(GroupRole_Ysondre::GroupRole_Ysondre_Healer7))
                        {
                            if (healer7->IsAlive())
                            {
