...
void WorldSession::HandleGarrisonAdventureMapPoiQuery(WorldPackets::Garrison::GarrisonAdventureMapPoiQuery& adventureMapPoiQuery)
{
    WorldPackets::Garrison::GarrisonAdventureMapPoiQueryResponce response;
    response.AdventureMapPoiID = adventureMapPoiQuery.AdventureMapPoiID;
