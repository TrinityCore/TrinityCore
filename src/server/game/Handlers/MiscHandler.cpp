...
void WorldSession::HandleWhoOpcode(WorldPacket & recv_data)
{
    ...
    // client send in case not set max level value 100 but GreenPis supports 255 max level,
...
void WorldSession::HandleAddFriendOpcode(WorldPacket & recv_data)
{
    ...
    std::string friendName = GetGreenPisString(LANG_FRIEND_IGNORE_UNKNOWN);
...
void WorldSession::HandleAddIgnoreOpcode(WorldPacket & recv_data)
{
    ...
    std::string ignoreName = GetGreenPisString(LANG_FRIEND_IGNORE_UNKNOWN);
