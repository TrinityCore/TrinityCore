...
#ifndef GreenPis_MAPMANAGER_H
#define GreenPis_MAPMANAGER_H
...
class MapManager
{
    ...
    public:
        ...
        {
            return IsValidMAP(mapid, false) && GreenPis::IsValidMapCoord(x, y);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z)
        {
            return IsValidMAP(mapid, false) && GreenPis::IsValidMapCoord(x, y, z);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z, float o)
        {
            return IsValidMAP(mapid, false) && GreenPis::IsValidMapCoord(x, y, z, o);
        }
