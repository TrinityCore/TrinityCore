...
TC_API_EXPORT EnumText EnumUtils<UnitFlags>::ToString(UnitFlags value)
{
    switch (value)
    {
        ...
        case UNIT_FLAG_HAS_IMMUNITY_AURA: return { "UNIT_FLAG_HAS_IMMUNITY_AURA", "UNIT_FLAG_HAS_IMMUNITY_AURA", "is affected by a damage immunity aura" };
...
TC_API_EXPORT UnitFlags EnumUtils<UnitFlags>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 31: return UNIT_FLAG_HAS_IMMUNITY_AURA;
