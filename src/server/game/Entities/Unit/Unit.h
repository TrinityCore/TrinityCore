...
enum UnitState
{
    ...
    UNIT_STATE_MOVING            = UNIT_STATE_ROAMING_MOVE | UNIT_STATE_CONFUSED_MOVE | UNIT_STATE_FLEEING_MOVE | UNIT_STATE_CHASE_MOVE | UNIT_STATE_FOLLOW_MOVE, // for real move using movegen check and stop (except unstoppable flight)
    ...
    UNIT_STATE_NOT_MOVE          = UNIT_STATE_ROOT | UNIT_STATE_STUNNED | UNIT_STATE_DIED | UNIT_STATE_DISTRACTED | UNIT_STATE_CASTING, // stay by different reasons
