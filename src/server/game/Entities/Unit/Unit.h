...
enum UnitState : uint32
{
    ...
    UNIT_STATE_CONTROLLED          = UNIT_STATE_CONFUSED | UNIT_STATE_STUNNED | UNIT_STATE_FLEEING | UNIT_STATE_TAUNTED,
...
class TC_GAME_API Unit : public WorldObject
{
    ...
    public:
        ...
        SpellMissInfo MeleeSpellHitResult(Unit* victim, SpellInfo const* spellInfo, uint32* heartbeatResistChance) const override;
