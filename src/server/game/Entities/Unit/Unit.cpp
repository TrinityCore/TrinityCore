...
bool Unit::HandleStatModifier(UnitMods unitMod, UnitModifierType modifierType, float amount, bool apply)
{
    ...
    switch (unitMod)
    {
        ...
        case UNIT_MOD_FURY:
        case UNIT_MOD_PAIN:                UpdateMaxPower(GetPowerTypeByAuraGroup(unitMod));           break;
...
{
    ASSERT(unitMod >= UNIT_MOD_POWER_START && unitMod < UNIT_MOD_POWER_END);
    return Powers(unitMod - UNIT_MOD_POWER_START);
}
