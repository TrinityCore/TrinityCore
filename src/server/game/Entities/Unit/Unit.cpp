...
void Unit::CalcAbsorbResist(Unit* victim, SpellSchoolMask schoolMask, DamageEffectType damagetype, uint32 const damage, uint32 *absorb, uint32 *resist, SpellInfo const* spellInfo)
{
    ...
    vSchoolAbsorbCopy.sort(GreenPis::AbsorbAuraOrderPred());
...
Unit* Unit::SelectNearbyTarget(Unit* exclude, float dist) const
{
    ...
    GreenPis::AnyUnfriendlyUnitInObjectRangeCheck u_check(this, this, dist);
    GreenPis::UnitListSearcher<GreenPis::AnyUnfriendlyUnitInObjectRangeCheck> searcher(this, targets, u_check);
    ...
    // select random
    return GreenPis::Containers::SelectRandomContainerElement(targets);
}
...
void Unit::UpdateObjectVisibility(bool forced)
{
    ...
    else
    {
        ...
        GreenPis::AIRelocationNotifier notifier(*this);
...
bool Unit::UpdatePosition(float x, float y, float z, float orientation, bool teleport)
{
    ...
    if (!GreenPis::IsValidMapCoord(x, y, z, orientation))
    {
