...
float Player::GetDRMissPercent(WeaponAttackType attType)
{   //TODO: find correct values except warrior, paladin, dk.
    ...
    if(attType == RANGED_ATTACK)
        diminishing += GetRatingBonusValue(CR_HIT_TAKEN_RANGED);
    else
        diminishing += GetRatingBonusValue(CR_HIT_TAKEN_MELEE);
