...
enum CreatureFlagsExtra : uint32
{
    ...
    CREATURE_FLAG_EXTRA_IGNORE_LOS_WHEN_CASTING_ON_ME = 0x00400000, // Other objects can ignore line of sight requirements when casting spells on me
    ...
    // Masks
    CREATURE_FLAG_EXTRA_UNUSED               = (CREATURE_FLAG_EXTRA_UNUSED_23 | CREATURE_FLAG_EXTRA_UNUSED_24 | CREATURE_FLAG_EXTRA_UNUSED_25 |
