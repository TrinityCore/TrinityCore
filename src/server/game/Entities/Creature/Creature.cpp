...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        CellCoord p(GreenPis::ComputeCellCoord(GetPositionX(), GetPositionY()));
        Cell cell(p);
        cell.SetNoCreate();
        GreenPis::NearestAssistCreatureInCreatureRangeCheck u_check(this, getVictim(), radius);
        GreenPis::CreatureLastSearcher<GreenPis::NearestAssistCreatureInCreatureRangeCheck> searcher(this, creature, u_check);

        TypeContainerVisitor<GreenPis::CreatureLastSearcher<GreenPis::NearestAssistCreatureInCreatureRangeCheck>, GridTypeMapContainer > grid_creature_searcher(searcher);
...
Unit* Creature::SelectNearestTarget(float dist) const
{
...

    {
        ...
        GreenPis::NearestHostileUnitCheck u_check(this, dist);
        GreenPis::UnitLastSearcher<GreenPis::NearestHostileUnitCheck> searcher(this, target, u_check);

        TypeContainerVisitor<GreenPis::UnitLastSearcher<GreenPis::NearestHostileUnitCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<GreenPis::UnitLastSearcher<GreenPis::NearestHostileUnitCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Unit* Creature::SelectNearestTargetInAttackDistance(float dist) const
{
    ...
    {
        GreenPis::NearestHostileUnitInAttackDistanceCheck u_check(this, dist);
        GreenPis::UnitLastSearcher<GreenPis::NearestHostileUnitInAttackDistanceCheck> searcher(this, target, u_check);

        TypeContainerVisitor<GreenPis::UnitLastSearcher<GreenPis::NearestHostileUnitInAttackDistanceCheck>, WorldTypeMapContainer > world_unit_searcher(searcher);
        TypeContainerVisitor<GreenPis::UnitLastSearcher<GreenPis::NearestHostileUnitInAttackDistanceCheck>, GridTypeMapContainer >  grid_unit_searcher(searcher);
...
Player* Creature::SelectNearestPlayer(float distance) const
{
    ...
    GreenPis::NearestPlayerInObjectRangeCheck checker(this, distance);
    GreenPis::PlayerLastSearcher<GreenPis::NearestPlayerInObjectRangeCheck> searcher(this, target, checker);
    ...
    if (!m_AlreadyCallAssistance && getVictim() && !isPet() && !isCharmed())
    {
        ...
        if (radius > 0)
        {
...

            {
                ...
                GreenPis::AnyAssistCreatureInRangeCheck u_check(this, getVictim(), radius);
                GreenPis::CreatureListSearcher<GreenPis::AnyAssistCreatureInRangeCheck> searcher(this, assistList, u_check);

                TypeContainerVisitor<GreenPis::CreatureListSearcher<GreenPis::AnyAssistCreatureInRangeCheck>, GridTypeMapContainer >  grid_creature_searcher(searcher);
...
void Creature::CallForHelp(float radius)
{
    ...
    GreenPis::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), radius);
    GreenPis::CreatureWorker<GreenPis::CallOfHelpCreatureInRangeDo> worker(this, u_do);

    TypeContainerVisitor<GreenPis::CreatureWorker<GreenPis::CallOfHelpCreatureInRangeDo>, GridTypeMapContainer >  grid_creature_searcher(worker);
...
void Creature::SetPosition(float x, float y, float z, float o)
{
    ...
    if (!GreenPis::IsValidMapCoord(x, y, z, o))
    {
