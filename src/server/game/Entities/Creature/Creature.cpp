...
Creature::Creature(bool isWorldObject): Unit(isWorldObject), MapObject(), m_groupLootTimer(0), m_PlayerDamageReq(0), _pickpocketLootRestore(0),
    ...
    _regenerateHealth(true), _regenerateHealthLock(false), _noNPCDamageBelowHealthPct(0)
{
...
bool Creature::LoadCreaturesAddon()
{
    ...
    if (CreatureDifficultyEntry const* creatureDifficulty = sDB2Manager.GetCreatureDifficulty(GetCreatureTemplate()->Entry))
    {
