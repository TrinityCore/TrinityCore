...
class TC_GAME_API Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        bool CanBeMultiTapped() const { return _staticFlags.HasFlag(CREATURE_STATIC_FLAG_3_DO_NOT_TAP); }
        void SetCanBeMultiTapped(bool apply) { return _staticFlags.ApplyFlag(CREATURE_STATIC_FLAG_3_DO_NOT_TAP, apply); }
