...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_ROOT                 = 0x00000200,       // Applies UNIT_FLAG_ROOT
...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_NO_TAUNT | CREATURE_FLAG_EXTRA_ROOT | CREATURE_FLAG_EXTRA_WORLDEVENT | CREATURE_FLAG_EXTRA_NO_CRIT | \
