...
class TC_GAME_API Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        void DoNotReacquireTarget() { m_shouldReacquireTarget = false; m_suppressedTarget = ObjectGuid::Empty; SetGuidValue(UNIT_FIELD_TARGET, m_suppressedTarget); m_suppressedOrientation = 0.0f; }
