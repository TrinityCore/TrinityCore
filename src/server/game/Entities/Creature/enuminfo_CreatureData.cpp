...
TC_API_EXPORT EnumText EnumUtils<CreatureFlagsExtra>::ToString(CreatureFlagsExtra value)
{
    switch (value)
    {
        ...
        case CREATURE_FLAG_EXTRA_IGNORE_LOS_WHEN_CASTING_ON_ME: return { "CREATURE_FLAG_EXTRA_IGNORE_LOS_WHEN_CASTING_ON_ME", "Other objects can ignore line of sight requirements when casting spells on me", "" };
...
TC_API_EXPORT CreatureFlagsExtra EnumUtils<CreatureFlagsExtra>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 22: return CREATURE_FLAG_EXTRA_IGNORE_LOS_WHEN_CASTING_ON_ME;
...
TC_API_EXPORT size_t EnumUtils<CreatureFlagsExtra>::ToIndex(CreatureFlagsExtra value)
{
    switch (value)
    {
        ...
        case CREATURE_FLAG_EXTRA_IGNORE_LOS_WHEN_CASTING_ON_ME: return 22;
