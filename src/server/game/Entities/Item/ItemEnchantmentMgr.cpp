...
void TC_GAME_API LoadRandomEnchantmentsTable()
{
...
uint32 TC_GAME_API GetItemEnchantMod(int32 entry)
{
    if (!entry)
        return 0;
...
uint32 TC_GAME_API GenerateEnchSuffixFactor(uint32 item_id)
{
