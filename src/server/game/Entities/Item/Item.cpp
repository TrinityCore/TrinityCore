...
{
    return Item::GetItemLevel(GetTemplate(), _bonusData, owner ? owner->getLevel(): 0, GetModifier(ITEM_MODIFIER_SCALING_STAT_DISTRIBUTION_FIXED_LEVEL), GetModifier(ITEM_MODIFIER_UPGRADE_ID));
}
