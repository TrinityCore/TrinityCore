...
enum ItemClass
{
    ...
    ITEM_CLASS_QUEST                            = 12,
    ITEM_CLASS_KEY                              = 13,
    ITEM_CLASS_PERMANENT                        = 14, // Unused (4.2.2)
    ITEM_CLASS_MISC                             = 15,
    ITEM_CLASS_GLYPH                            = 16
};
...
enum ItemSubclassMoney
{
    ...
    ITEM_SUBCLASS_MONEY_UNK7                    = 7  // used in Item.db2, but not found in ItemSubClass.dbc
};
...
enum ItemSubclassQuest
{
    ...
    ITEM_SUBCLASS_QUEST_UNK3                    = 3, // used in Item.db2, but not found in ItemSubClass.dbc
    ITEM_SUBCLASS_QUEST_UNK8                    = 8  // used in Item.db2, but not found in ItemSubClass.dbc
};
...
enum ItemSubclassJunk
{
    ...
    ITEM_SUBCLASS_JUNK_UNK12                    = 12 // used in Item.db2, but not found in ItemSubClass.dbc
};
