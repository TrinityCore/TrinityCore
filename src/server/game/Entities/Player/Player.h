...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        */
        ...
        void KillCreditCriteriaTreeObjective(QuestObjective const* objective);
        ...
        void ResetQuestObjectiveCriteria();
    ...
    private:
        ...
        QuestObjectiveCriteriaMgr* m_questObjectiveCriteriaMgr;
