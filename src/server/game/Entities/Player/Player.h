...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        PlayerRestState GetRestState() const { return PlayerRestState(GetByteValue(PLAYER_BYTES_2, PLAYER_BYTES_2_OFFSET_REST_STATE)); }
        void SetRestState(PlayerRestState restState) { SetByteValue(PLAYER_BYTES_2, PLAYER_BYTES_2_OFFSET_REST_STATE, restState); }
        ...
        static bool IsValidGender(Gender Gender) { return Gender <= GENDER_FEMALE; }
        static bool ValidateAppearance(Races race, Classes class_, Gender gender, uint8 hairID, uint8 hairColor, uint8 faceID, uint8 facialHair, uint8 skinColor, bool create = false);
        ...
        static uint32 TeamForRace(Races race);
        uint32 GetTeam() const { return m_team; }
        TeamId GetTeamId() const { return m_team == ALLIANCE ? TEAM_ALLIANCE : TEAM_HORDE; }
        void SetFactionForRace(Races race);
