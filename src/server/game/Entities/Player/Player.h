...
inline constexpr uint8 INVENTORY_ACCOUNT_SECURED_SIZE = INVENTORY_DEFAULT_SIZE + 4; // 4 slots are provided for having a secured account
...
class TC_GAME_API Player final : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void CastItemUseSpell(Item* item, uint32 spellId, SpellCastTargets const& targets, ObjectGuid castCount, std::array<int32, 2> const& misc);
