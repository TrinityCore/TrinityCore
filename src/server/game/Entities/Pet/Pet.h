...
class TC_GAME_API Pet final : public Guardian
{
    public:
        ...
        void SendNewlyTamed(bool playPingFx = true) const;
        ...
        */
        ...
        float GetFollowAngle() const override { return m_animalCompanion ? static_cast<float>(-M_PI / 2) : static_cast<float>(M_PI / 2); }
