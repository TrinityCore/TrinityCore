...
Creature* WorldObject::FindNearestCreatureWithAura(uint32 entry, float range, bool alive, uint32 spellId) const
{
    Creature* creature = nullptr;
    Trinity::NearestCreatureEntryWithLiveStateAndAuraInObjectRangeCheck checker(*this, entry, alive, range, spellId);
