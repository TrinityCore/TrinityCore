...
{
    AZERITEEMPOWEREDITEM_FIELD_SELECTIONS = ITEM_END + 0x000, // Size: 4, Flags: PUBLIC
    AZERITEEMPOWEREDITEM_END              = ITEM_END + 0x004,
};

enum AzeriteEmpoweredItemDynamicField
{
    AZERITEEMPOWEREDITEM_DYNAMIC_END = ITEM_DYNAMIC_END + 0x000,
};

enum AzeriteItemField
{
    AZERITEITEM_FIELD_XP                   = ITEM_END + 0x000, // Size: 2, Flags: PUBLIC
    AZERITEITEM_FIELD_LEVEL                = ITEM_END + 0x002, // Size: 1, Flags: PUBLIC
    AZERITEITEM_FIELD_AURA_LEVEL           = ITEM_END + 0x003, // Size: 1, Flags: PUBLIC
    AZERITEITEM_FIELD_KNOWLEDGE_LEVEL      = ITEM_END + 0x004, // Size: 1, Flags: OWNER
    AZERITEITEM_FIELD_DEBUG_KNOWLEDGE_WEEK = ITEM_END + 0x005, // Size: 1, Flags: OWNER
    AZERITEITEM_END                        = ITEM_END + 0x006,
};

enum AzeriteItemDynamicField
{
    AZERITEITEM_DYNAMIC_END = ITEM_DYNAMIC_END + 0x000,
};
...
enum PlayerDynamicFieldNotSelf
{
    PLAYER_NOT_SELF_DYNAMIC_FIELD_ARENA_COOLDOWNS = UNIT_DYNAMIC_END + 0x000, // Flags: PUBLIC
    PLAYER_NOT_SELF_DYNAMIC_END                   = UNIT_DYNAMIC_END + 0x001,
};

enum PlayerDynamicFields
{
    PLAYER_DYNAMIC_FIELD_RESEARCH                         = PLAYER_NOT_SELF_DYNAMIC_END + 0x000, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_RESERACH_SITE                    = PLAYER_NOT_SELF_DYNAMIC_END + 0x001, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_RESEARCH_SITE_PROGRESS           = PLAYER_NOT_SELF_DYNAMIC_END + 0x002, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_DAILY_QUESTS                     = PLAYER_NOT_SELF_DYNAMIC_END + 0x003, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_AVAILABLE_QUEST_LINE_X_QUEST_ID  = PLAYER_NOT_SELF_DYNAMIC_END + 0x004, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_HEIRLOOMS                        = PLAYER_NOT_SELF_DYNAMIC_END + 0x005, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_HEIRLOOM_FLAGS                   = PLAYER_NOT_SELF_DYNAMIC_END + 0x006, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_TOYS                             = PLAYER_NOT_SELF_DYNAMIC_END + 0x007, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_TRANSMOG                         = PLAYER_NOT_SELF_DYNAMIC_END + 0x008, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_CONDITIONAL_TRANSMOG             = PLAYER_NOT_SELF_DYNAMIC_END + 0x009, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_SELF_RES_SPELLS                  = PLAYER_NOT_SELF_DYNAMIC_END + 0x00A, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_CHARACTER_RESTRICTIONS           = PLAYER_NOT_SELF_DYNAMIC_END + 0x00B, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_SPELL_PCT_MOD_BY_LABEL           = PLAYER_NOT_SELF_DYNAMIC_END + 0x00C, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_SPELL_FLAT_MOD_BY_LABEL          = PLAYER_NOT_SELF_DYNAMIC_END + 0x00D, // Flags: PUBLIC
    PLAYER_DYNAMIC_END                                    = PLAYER_NOT_SELF_DYNAMIC_END + 0x00E,
};
