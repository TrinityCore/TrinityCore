...
{
    PLAYER_DYNAMIC_FIELD_RESERACH_SITE                     = PLAYER_NOT_SELF_DYNAMIC_END + 0x000, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_RESEARCH_SITE_PROGRESS            = PLAYER_NOT_SELF_DYNAMIC_END + 0x001, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_DAILY_QUESTS                      = PLAYER_NOT_SELF_DYNAMIC_END + 0x002, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_AVAILABLE_QUEST_LINE_X_QUEST_ID   = PLAYER_NOT_SELF_DYNAMIC_END + 0x003, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_HEIRLOOMS                         = PLAYER_NOT_SELF_DYNAMIC_END + 0x004, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_HEIRLOOM_FLAGS                    = PLAYER_NOT_SELF_DYNAMIC_END + 0x005, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_TOYS                              = PLAYER_NOT_SELF_DYNAMIC_END + 0x006, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_TRANSMOG                          = PLAYER_NOT_SELF_DYNAMIC_END + 0x007, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_CONDITIONAL_TRANSMOG              = PLAYER_NOT_SELF_DYNAMIC_END + 0x008, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_SELF_RES_SPELLS                   = PLAYER_NOT_SELF_DYNAMIC_END + 0x009, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_CHARACTER_RESTRICTIONS            = PLAYER_NOT_SELF_DYNAMIC_END + 0x00A, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_SPELL_PCT_MOD_BY_LABEL            = PLAYER_NOT_SELF_DYNAMIC_END + 0x00B, // Flags: PRIVATE
    PLAYER_DYNAMIC_FIELD_SPELL_FLAT_MOD_BY_LABEL           = PLAYER_NOT_SELF_DYNAMIC_END + 0x00C, // Flags: PRIVATE
