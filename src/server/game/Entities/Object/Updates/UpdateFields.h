...
struct ActivePlayerData : public IsUpdateFieldStructureTag, public HasChangesMask<1490>
{
    ...
    UpdateField<uint8, 98, 108> Unk340;
    UpdateFieldArray<ObjectGuid, 129, 109, 110> InvSlots;
    UpdateFieldArray<uint32, 2, 239, 240> TrackResourceMask;
    UpdateFieldArray<float, 7, 242, 243> SpellCritPercentage;
    UpdateFieldArray<int32, 7, 242, 250> ModDamageDonePos;
    UpdateFieldArray<int32, 7, 242, 257> ModDamageDoneNeg;
    UpdateFieldArray<float, 7, 242, 264> ModDamageDonePercent;
    UpdateFieldArray<uint64, 240, 271, 272> ExploredZones;
    UpdateFieldArray<UF::RestInfo, 2, 512, 513> RestInfo;
    UpdateFieldArray<float, 3, 515, 516> WeaponDmgMultipliers;
    UpdateFieldArray<float, 3, 515, 519> WeaponAtkSpeedMultipliers;
    UpdateFieldArray<uint32, 12, 522, 523> BuybackPrice;
    UpdateFieldArray<int64, 12, 522, 535> BuybackTimestamp;
    UpdateFieldArray<int32, 32, 547, 548> CombatRatings;
    UpdateFieldArray<UF::PVPInfo, 6, 580, 581> PvpInfo;
    UpdateFieldArray<uint32, 4, 587, 588> NoReagentCostMask;
    UpdateFieldArray<int32, 2, 592, 593> ProfessionSkillLine;
    UpdateFieldArray<uint32, 4, 595, 596> BagSlotFlags;
    UpdateFieldArray<uint32, 7, 600, 601> BankBagSlotFlags;
    UpdateFieldArray<uint64, 875, 608, 609> QuestCompleted;
    UpdateFieldArray<UF::GlyphInfo, 6, 1484, 1485> GlyphInfos;
