...
class TC_GAME_API AreaTrigger : public WorldObject, public GridObject<AreaTrigger>, public MapObject
{
    ...
    public:
        ...
        bool IsNeverVisibleFor(WorldObject const* seer, bool implicitDetect = false) const override { return WorldObject::IsNeverVisibleFor(seer) || (IsServerSide() && !implicitDetect); }
