...
class TC_GAME_API SplineChainMovementGenerator : public MovementGenerator
{
    public:
        ...
        void Initialize(WorldObject* me) override;
        void Finalize(WorldObject* me) override;
        void Reset(WorldObject* /*me*/) override { };
        bool Update(WorldObject* me, uint32 diff) override;
