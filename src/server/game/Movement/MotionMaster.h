...
class TC_GAME_API MotionMaster
{
    public:
        ...
        void MovePoint(uint32 id, Position const& pos, bool generatePath = true, Optional<float> finalOrient = nullptr)
        {
            MovePoint(id, pos.m_positionX, pos.m_positionY, pos.m_positionZ, generatePath, finalOrient);
        }
        void MovePoint(uint32 id, float x, float y, float z, bool generatePath = true, Optional<float> finalOrient = nullptr);
