...
class TC_GAME_API MotionMaster
{
    public:
        ...
        void MoveJump(Position const& pos, float speedXY, float speedZ, uint32 id = EVENT_JUMP, bool hasOrientation = false, Optional<JumpArrivalActionArgs> arrivalActions = {}, Movement::SpellEffectExtraData const* spellEffectExtraData = nullptr);
        void MoveJump(float x, float y, float z, float o, float speedXY, float speedZ, uint32 id = EVENT_JUMP, bool hasOrientation = false, Optional<JumpArrivalActionArgs> arrivalActions = {}, Movement::SpellEffectExtraData const* spellEffectExtraData = nullptr);
        bool MoveJumpWithGravity(Position const& pos, float speedXY, float gravity, uint32 id = EVENT_JUMP, bool hasOrientation = false, Optional<JumpArrivalActionArgs> arrivalActions = {}, Movement::SpellEffectExtraData const* spellEffectExtraData = nullptr);
