...
std::string const WorldPackets::Auth::ConnectTo::Haiku("World torn asunder\nDarkness descends on the land\nDeathwing has returned\n\0\0", 73);

uint8 const WorldPackets::Auth::ConnectTo::PiDigits[142] =
{
...
WorldPacket const* WorldPackets::Auth::ConnectTo::Write()
{
    ...
    payload << uint8(PiDigits[125]);
    payload << uint8(Haiku[24]);
    payload << uint8(Haiku[6]);
    payload << uint8(PiDigits[140]);
    payload << uint8(Haiku[8]);
    payload << uint8(PiDigits[112]);
    payload << uint8(PiDigits[133]);
    payload << uint8(PiDigits[74]);
    payload << uint8(PiDigits[135]);
    ...
    payload << uint8(PiDigits[110]);
    payload << uint8(PiDigits[109]);
    ...
    payload << uint8(PiDigits[139]);
    payload << uint8(Haiku[51]);
    payload << uint8(Haiku[64]);
    payload << uint8(PiDigits[111]);
    payload << uint8(PiDigits[131]);
