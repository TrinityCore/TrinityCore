...
bool ContentTuningParams::GenerateDataForUnits<Creature, Player>(Creature* attacker, Player* target)
{
    ...
    CreatureScaling const* creatureScaling = creatureTemplate->GetScaling(attacker->GetMap()->GetDifficultyID());
    ...
    Expansion = creatureScaling->HealthScalingExpansion;
...
bool ContentTuningParams::GenerateDataForUnits<Player, Creature>(Player* attacker, Creature* target)
{
    ...
    CreatureScaling const* creatureScaling = creatureTemplate->GetScaling(target->GetMap()->GetDifficultyID());
...
bool ContentTuningParams::GenerateDataForUnits<Creature, Creature>(Creature* attacker, Creature* target)
{
    ...
    CreatureScaling const* creatureScaling = creatureTemplate->GetScaling(accessor->GetMap()->GetDifficultyID());
