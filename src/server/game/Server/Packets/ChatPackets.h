...
namespace WorldPackets
{
    namespace Chat
    {
        ...
        public:
            ...
            void Initialize(ChatMsg chatType, uint32 language, WorldObject const* sender, WorldObject const* receiver, std::string message, uint32 achievementId = 0, std::string channelName = "", LocaleConstant locale = DEFAULT_LOCALE, std::string addonPrefix = "");
