...
enum OpcodeClient : uint16
{
    ...
    // Deleted opcodes in 3.4.0, here only to allow compile
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x2865,
    SMSG_ACCOUNT_DATA_TIMES                           = 0x2704,
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0x25AD,
    SMSG_ACCOUNT_NOTIFICATIONS_RESPONSE               = 0x2881,
    ...
    SMSG_ADJUST_SPLINE_DURATION                       = 0x25CD,
    SMSG_ADVENTURE_JOURNAL_DATA_RESPONSE              = 0x2876,
    SMSG_ADVENTURE_MAP_OPEN_NPC                       = 0x27F2,
    SMSG_AE_LOOT_TARGETS                              = 0x2614,
    SMSG_AE_LOOT_TARGET_ACK                           = 0x2615,
    SMSG_AI_REACTION                                  = 0x26B1,
    SMSG_ALLIED_RACE_DETAILS                          = 0x27F8,
    ...
    SMSG_AREA_TRIGGER_MESSAGE                         = 0x287E,
    ...
    SMSG_ARENA_TEAM_COMMAND_RESULT                    = 0x275D,
    SMSG_ARENA_TEAM_EVENT                             = 0x275C,
    SMSG_ARENA_TEAM_INVITE                            = 0x275B,
    SMSG_ARENA_TEAM_ROSTER                            = 0x275A,
    SMSG_ARENA_TEAM_STATS                             = 0x275E,
    SMSG_ARTIFACT_XP_GAIN                             = 0x27EB,
    ...
    SMSG_AUCTIONABLE_TOKEN_AUCTION_SOLD               = 0x27D4,
    SMSG_AUCTIONABLE_TOKEN_SELL_AT_MARKET_PRICE_RESPONSE = 0x27D3,
    SMSG_AUCTIONABLE_TOKEN_SELL_CONFIRM_REQUIRED      = 0x27D2,
    SMSG_AUCTION_CLOSED_NOTIFICATION                  = 0x26ED,
    SMSG_AUCTION_COMMAND_RESULT                       = 0x26EA,
    SMSG_AUCTION_FAVORITE_LIST                        = 0x286C,
    SMSG_AUCTION_HELLO_RESPONSE                       = 0x26E8,
    SMSG_AUCTION_LIST_BIDDED_ITEMS_RESULT             = 0x287B,
    SMSG_AUCTION_LIST_ITEMS_RESULT                    = 0x2860,
    SMSG_AUCTION_LIST_OWNED_ITEMS_RESULT              = 0x287A,
    ...
    SMSG_AZERITE_RESPEC_NPC                           = 0x27F5,
    SMSG_BAG_CLEANUP_FINISHED                         = 0x2DA7,
    SMSG_BARBER_SHOP_RESULT                           = 0x26B9,
    SMSG_BATCH_PRESENCE_SUBSCRIPTION                  = 0x2857,
    ...
    SMSG_BATTLENET_NOTIFICATION                       = 0x2803,
    SMSG_BATTLENET_RESPONSE                           = 0x2802,
    SMSG_BATTLE_NET_CONNECTION_STATUS                 = 0x2804,
    ...
    SMSG_BATTLE_PET_LICENSE_CHANGED                   = 0x25EF,
    ...
    SMSG_BROADCAST_SUMMON_CAST                        = 0x2859,
    SMSG_BROADCAST_SUMMON_RESPONSE                    = 0x285A,
    ...
    SMSG_CHROMIE_TIME_OPEN_NPC                        = 0x27FA,
    SMSG_CHROMIE_TIME_SELECT_EXPANSION_SUCCESS        = 0x2870,
    ...
    SMSG_COMMERCE_TOKEN_GET_COUNT_RESPONSE            = 0x27CF,
    SMSG_COMMERCE_TOKEN_GET_LOG_RESPONSE              = 0x27DB,
    SMSG_COMMERCE_TOKEN_GET_MARKET_PRICE_RESPONSE     = 0x27D1,
    SMSG_COMMERCE_TOKEN_UPDATE                        = 0x27D0,
    SMSG_COMPLAINT_RESULT                             = 0x26A7,
    SMSG_COMPLETE_SHIPMENT_RESPONSE                   = 0x2799,
    SMSG_CONFIRM_PARTY_INVITE                         = 0x2811,
    SMSG_CONNECT_TO                                   = 0x304D,
    SMSG_CONQUEST_FORMULA_CONSTANTS                   = 0x2783,
    SMSG_CONSOLE_WRITE                                = 0x2631,
    SMSG_CONSUMABLE_TOKEN_BUY_AT_MARKET_PRICE_RESPONSE = 0x27D7,
    SMSG_CONSUMABLE_TOKEN_BUY_CHOICE_REQUIRED         = 0x27D6,
    SMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY_RESPONSE    = 0x27D5,
    SMSG_CONSUMABLE_TOKEN_REDEEM_CONFIRM_REQUIRED     = 0x27D9,
    SMSG_CONSUMABLE_TOKEN_REDEEM_RESPONSE             = 0x27DA,
    SMSG_CONTACT_LIST                                 = 0x2786,
    SMSG_CONTRIBUTION_LAST_UPDATE_RESPONSE            = 0x2818,
    SMSG_CONTROL_UPDATE                               = 0x2643,
    SMSG_CONVERT_ITEMS_TO_CURRENCY_VALUE              = 0x2879,
    ...
    SMSG_COVENANT_PREVIEW_OPEN_NPC                    = 0x27FB,
    SMSG_COVENANT_RENOWN_OPEN_NPC                     = 0x2878,
    SMSG_CREATE_CHAR                                  = 0x26FB,
    SMSG_CREATE_SHIPMENT_RESPONSE                     = 0x2798,
    SMSG_CRITERIA_DELETED                             = 0x26E2,
    SMSG_CRITERIA_UPDATE                              = 0x26DC,
    SMSG_CROSSED_INEBRIATION_THRESHOLD                = 0x26BD,
    SMSG_CUSTOM_LOAD_SCREEN                           = 0x25C8,
    SMSG_DAILY_QUESTS_RESET                           = 0x2A80,
    SMSG_DAMAGE_CALC_LOG                              = 0x27C4,
    ...
    SMSG_DISPLAY_WORLD_TEXT                           = 0x27EC,
    ...
    SMSG_ENUM_VAS_PURCHASE_STATES_RESPONSE            = 0x27F1,
    ...
    SMSG_EXTERNAL_TRANSACTION_ID_GENERATED            = 0x2877,
    SMSG_FACTION_BONUS_INFO                           = 0x271F,
    SMSG_FAILED_PLAYER_CONDITION                      = 0x2FFA,
    SMSG_FAILED_QUEST_TURN_IN                         = 0x280E,
    ...
    SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT                = 0x25C0,
    SMSG_GAME_OBJECT_BASE                             = 0x2826,
    SMSG_GAME_OBJECT_CUSTOM_ANIM                      = 0x25C1,
    SMSG_GAME_OBJECT_DESPAWN                          = 0x25C2,
    ...
    SMSG_GAME_OBJECT_SET_STATE_LOCAL                  = 0x2801,
    SMSG_GAME_OBJECT_UI_LINK                          = 0x2714,
    ...
    SMSG_GENERATE_SSO_TOKEN_RESPONSE                  = 0x2819,
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT            = 0x275F,
    SMSG_GET_LANDING_PAGE_SHIPMENTS_RESPONSE          = 0x279B,
    SMSG_GET_REMAINING_GAME_TIME_RESPONSE             = 0x27D8,
    SMSG_GET_SELECTED_TROPHY_ID_RESPONSE              = 0x27C2,
    SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE               = 0x279A,
    SMSG_GET_SHIPMENT_INFO_RESPONSE                   = 0x2796,
    SMSG_GET_TROPHY_LIST_RESPONSE                     = 0x27C1,
    SMSG_GET_VAS_ACCOUNT_CHARACTER_LIST_RESULT        = 0x27ED,
    SMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST_RESULT    = 0x27EE,
    ...
    SMSG_GOSSIP_POI                                   = 0x2793,
    SMSG_GOSSIP_QUEST_UPDATE                          = 0x2A99,
    SMSG_GOSSIP_REFRESH_OPTION                        = 0x2AA6,
    SMSG_GROUP_ACTION_THROTTLED                       = 0x2591,
    SMSG_GROUP_AUTO_KICK                              = 0x2791,
    SMSG_GROUP_DECLINE                                = 0x278E,
    SMSG_GROUP_DESTROYED                              = 0x2790,
    SMSG_GROUP_NEW_LEADER                             = 0x2629,
    SMSG_GROUP_UNINVITE                               = 0x278F,
    ...
    SMSG_INVENTORY_FIXUP_COMPLETE                     = 0x2810,
    SMSG_INVENTORY_FULL_OVERFLOW                      = 0x2821,
    SMSG_ISLANDS_MISSION_NPC                          = 0x27F7,
    ...
    SMSG_ITEM_INTERACTION_COMPLETE                    = 0x286F,
    SMSG_ITEM_PURCHASE_REFUND_RESULT                  = 0x259D,
    SMSG_ITEM_PUSH_RESULT                             = 0x261F,
    SMSG_ITEM_TIME_UPDATE                             = 0x274E,
    SMSG_KICK_REASON                                  = 0x2685,
    SMSG_LATENCY_REPORT_PING                          = 0x2882,
    SMSG_LEARNED_SPELLS                               = 0x2C4D,
    SMSG_LEARN_PVP_TALENT_FAILED                      = 0x25CF,
    SMSG_LEARN_TALENT_FAILED                          = 0x25CE,
    SMSG_LEGACY_LOOT_RULES                            = 0x2827,
    ...
    SMSG_LOOT_REMOVED                                 = 0x2611,
    SMSG_LOOT_RESPONSE                                = 0x2610,
    ...
    SMSG_MISSILE_CANCEL                               = 0x25C4,
    SMSG_MODIFY_COOLDOWN                              = 0x2762,
    SMSG_MOTD                                         = 0x2BAF,
    SMSG_MOUNT_RESULT                                 = 0x257B,
    SMSG_MOVEMENT_ENFORCEMENT_ALERT                   = 0x2858,
    ...
    SMSG_OPEN_ANIMA_DIVERSION_UI                      = 0x2715,
    SMSG_OPEN_CONTAINER                               = 0x2DA6,
    SMSG_OPEN_HEART_FORGE                             = 0x2824,
    SMSG_OPEN_LFG_DUNGEON_FINDER                      = 0x2A31,
    SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP                = 0x2795,
    SMSG_OPEN_SHIPMENT_NPC_RESULT                     = 0x2797,
    SMSG_OVERRIDE_LIGHT                               = 0x26B7,
    SMSG_PAGE_TEXT                                    = 0x2713,
    SMSG_PARTY_COMMAND_RESULT                         = 0x2792,
    ...
    SMSG_PARTY_NOTIFY_LFG_LEADER_CHANGE               = 0x2875,
    SMSG_PARTY_UPDATE                                 = 0x25F0,
    SMSG_PAST_TIME_EVENTS                             = 0x25BF,
    ...
    SMSG_PET_BATTLE_CHAT_RESTRICTED                   = 0x25FE,
    SMSG_PET_BATTLE_DEBUG_QUEUE_DUMP_RESPONSE         = 0x2671,
    SMSG_PET_BATTLE_FINALIZE_LOCATION                 = 0x25F7,
    SMSG_PET_BATTLE_FINAL_ROUND                       = 0x25FC,
    SMSG_PET_BATTLE_FINISHED                          = 0x25FD,
    SMSG_PET_BATTLE_FIRST_ROUND                       = 0x25F9,
    SMSG_PET_BATTLE_INITIAL_UPDATE                    = 0x25F8,
    SMSG_PET_BATTLE_MAX_GAME_LENGTH_WARNING           = 0x25FF,
    SMSG_PET_BATTLE_PVP_CHALLENGE                     = 0x25F6,
    SMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH               = 0x2635,
    SMSG_PET_BATTLE_QUEUE_STATUS                      = 0x2636,
    SMSG_PET_BATTLE_REPLACEMENTS_MADE                 = 0x25FB,
    SMSG_PET_BATTLE_REQUEST_FAILED                    = 0x25F5,
    SMSG_PET_BATTLE_ROUND_RESULT                      = 0x25FA,
    ...
    SMSG_PREPOPULATE_NAME_CACHE                       = 0x285B,
    SMSG_PRE_RESSURECT                                = 0x2765,
    SMSG_PRINT_NOTIFICATION                           = 0x25C7,
    ...
    SMSG_QUEST_SESSION_INFO_RESPONSE                  = 0x286A,
    ...
    SMSG_QUEUE_SUMMARY_UPDATE                         = 0x280F,
    SMSG_RAF_ACTIVITY_STATE_CHANGED                   = 0x2866,
    ...
    SMSG_READY_CHECK_COMPLETED                        = 0x25F4,
    SMSG_READY_CHECK_RESPONSE                         = 0x25F3,
    SMSG_READY_CHECK_STARTED                          = 0x25F2,
    SMSG_READ_ITEM_RESULT_FAILED                      = 0x27A4,
    SMSG_READ_ITEM_RESULT_OK                          = 0x279C,
    SMSG_REALM_LOOKUP_INFO                            = 0x27C8,
    ...
    SMSG_RESPEC_WIPE_CONFIRM                          = 0x260E,
    ...
    SMSG_RUNEFORGE_LEGENDARY_CRAFTING_OPEN_NPC        = 0x27FC,
    SMSG_RUNE_REGEN_DEBUG                             = 0x25B3,
    SMSG_SCENARIO_COMPLETED                           = 0x27EA,
    SMSG_SCENARIO_POIS                                = 0x262F,
    SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x2628,
    SMSG_SCENARIO_SHOW_CRITERIA                       = 0x27FF,
    SMSG_SCENARIO_STATE                               = 0x2627,
    SMSG_SCENARIO_UI_UPDATE                           = 0x27FE,
    ...
    SMSG_SET_ALL_TASK_PROGRESS                        = 0x278C,
    ...
    SMSG_SET_LOOT_METHOD_FAILED                       = 0x27CE,
    ...
    SMSG_SET_TASK_COMPLETE                            = 0x278D,
    SMSG_SET_TIME_ZONE_INFORMATION                    = 0x2673,
    SMSG_SET_VEHICLE_REC_ID                           = 0x26F1,
    SMSG_SHOW_BANK                                    = 0x267B,
    SMSG_SHOW_MAILBOX                                 = 0x27A6,
    ...
    SMSG_SPELL_VISUAL_LOAD_SCREEN                     = 0x25C9,
    SMSG_SPIRIT_HEALER_CONFIRM                        = 0x270F,
    SMSG_SPLASH_SCREEN_SHOW_LATEST                    = 0x2871,
    SMSG_STAND_STATE_UPDATE                           = 0x2716,
    SMSG_START_ELAPSED_TIMER                          = 0x2600,
    SMSG_START_ELAPSED_TIMERS                         = 0x2602,
    SMSG_START_LIGHTNING_STORM                        = 0x26A3,
    SMSG_START_LOOT_ROLL                              = 0x2619,
    SMSG_START_MIRROR_TIMER                           = 0x2709,
    SMSG_START_TIMER                                  = 0x25A5,
    SMSG_STOP_ELAPSED_TIMER                           = 0x2601,
    ...
    SMSG_SYNC_WOW_ENTITLEMENTS                        = 0x2868,
    ...
    SMSG_TRANSFER_PENDING                             = 0x25CA,
    SMSG_TRANSMOGRIFY_NPC                             = 0x27F4,
    SMSG_TREASURE_PICKER_RESPONSE                     = 0x291F,
    SMSG_TRIGGER_CINEMATIC                            = 0x27C6,
    ...
    SMSG_UI_ITEM_INTERACTION_NPC                      = 0x27F6,
    SMSG_UI_MAP_QUEST_LINES_RESPONSE                  = 0x2AA2,
    SMSG_UNDELETE_CHARACTER_RESPONSE                  = 0x27C9,
    SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE            = 0x27CA,
    SMSG_UNLEARNED_SPELLS                             = 0x2C4E,
    SMSG_UNLOAD_CHILD_MAP                             = 0x257A,
    SMSG_UPDATE_AADC_STATUS_RESPONSE                  = 0x2884,
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x2703,
    SMSG_UPDATE_ACTION_BUTTONS                        = 0x25DB,
    SMSG_UPDATE_BNET_SESSION_KEY                      = 0x2820,
    SMSG_UPDATE_CAPTURE_POINT                         = 0x2929,
    SMSG_UPDATE_CELESTIAL_BODY                        = 0x281C,
    ...
    SMSG_UPDATE_GAME_TIME_STATE                       = 0x2823,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x26A5,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x2684,
    SMSG_UPDATE_OBJECT                                = 0x27C7,
    SMSG_UPDATE_PRIMARY_SPEC                          = 0x25D3,
    SMSG_UPDATE_TALENT_DATA                           = 0x25D1,
    SMSG_UPDATE_TASK_PROGRESS                         = 0x278B,
    ...
    SMSG_VAS_CHECK_TRANSFER_OK_RESPONSE               = 0x2817,
    SMSG_VAS_GET_QUEUE_MINUTES_RESPONSE               = 0x2815,
    SMSG_VAS_GET_SERVICE_STATUS_RESPONSE              = 0x2814,
    SMSG_VAS_PURCHASE_COMPLETE                        = 0x27F0,
    SMSG_VAS_PURCHASE_STATE_UPDATE                    = 0x27EF,
    SMSG_VENDOR_INVENTORY                             = 0x25B5,
    SMSG_VIGNETTE_UPDATE                              = 0x3008,
    SMSG_VOICE_CHANNEL_INFO_RESPONSE                  = 0x281B,
    SMSG_VOICE_CHANNEL_STT_TOKEN_RESPONSE             = 0x2880,
    SMSG_VOICE_LOGIN_RESPONSE                         = 0x281A,
    ...
    SMSG_WARDEN3_DISABLED                             = 0x281E,
    SMSG_WARDEN3_ENABLED                              = 0x281D,
    SMSG_WARFRONT_COMPLETE                            = 0x2758,
    SMSG_WARGAME_REQUEST_SUCCESSFULLY_SENT_TO_OPPONENT = 0x2935,
    SMSG_WEATHER                                      = 0x26A2,
    SMSG_WEEKLY_REWARDS_PROGRESS_RESULT               = 0x2874,
    SMSG_WEEKLY_REWARDS_RESULT                        = 0x2872,
    SMSG_WEEKLY_REWARD_CLAIM_RESULT                   = 0x2873,
    SMSG_WEEKLY_SPELL_USAGE                           = 0x2C18,
    SMSG_WHO                                          = 0x2BAE,
    SMSG_WHO_IS                                       = 0x26A1,
    SMSG_WILL_BE_KICKED_FOR_ADDED_SUBSCRIPTION_TIME   = 0x2822,
    SMSG_WORLD_MAP_OPEN_NPC                           = 0x27F3,
    SMSG_WORLD_QUEST_UPDATE_RESPONSE                  = 0x300F,
    SMSG_WORLD_SERVER_INFO                            = 0x25AC,
    SMSG_WOW_ENTITLEMENT_NOTIFICATION                 = 0x2869,
    SMSG_XP_GAIN_ABORTED                              = 0x25C6,
    SMSG_XP_GAIN_ENABLED                              = 0x27A9,
    SMSG_ZONE_UNDER_ATTACK                            = 0x2BB5,

    // Opcodes that are not generated automatically
    SMSG_ACCOUNT_HEIRLOOM_UPDATE                      = 0x25AF, // no client handler
