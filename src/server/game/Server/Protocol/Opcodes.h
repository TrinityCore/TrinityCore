...
enum OpcodeClient : uint16
{
    ...
    CMSG_ACCEPT_SOCIAL_CONTRACT                       = 0x374D,
    CMSG_ACCEPT_TRADE                                 = 0x315A,
    CMSG_ACCEPT_WARGAME_INVITE                        = 0x35E1,
    CMSG_ACCOUNT_NOTIFICATION_ACKNOWLEDGED            = 0x373D,
    ...
    CMSG_ADD_TOY                                      = 0x3299,
    CMSG_ADVENTURE_MAP_START_QUEST                    = 0x32D9,
    ...
    CMSG_ASSIGN_EQUIPMENT_SET_SPEC                    = 0x3207,
    CMSG_ATTACK_STOP                                  = 0x3256,
    CMSG_ATTACK_SWING                                 = 0x3255,
    CMSG_AUCTIONABLE_TOKEN_SELL                       = 0x36EE,
    CMSG_AUCTIONABLE_TOKEN_SELL_AT_MARKET_PRICE       = 0x36EF,
    ...
    CMSG_AZERITE_EMPOWERED_ITEM_SELECT_POWER          = 0x32F2,
    CMSG_AZERITE_EMPOWERED_ITEM_VIEWED                = 0x32E0,
    CMSG_AZERITE_ESSENCE_ACTIVATE_ESSENCE             = 0x32F4,
    CMSG_AZERITE_ESSENCE_UNLOCK_MILESTONE             = 0x32F3,
    ...
    CMSG_BATTLENET_CHALLENGE_RESPONSE                 = 0x36DB,
    CMSG_BATTLENET_REQUEST                            = 0x36FD,
    CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE               = 0x36D5,
    CMSG_BATTLE_PAY_CANCEL_OPEN_CHECKOUT              = 0x371B,
    CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE         = 0x36D4,
    CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_TO_TARGET     = 0x36CB,
    CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS           = 0x3742,
    ...
    CMSG_BATTLE_PAY_START_PURCHASE                    = 0x36D3,
    CMSG_BATTLE_PAY_START_VAS_PURCHASE                = 0x36FA,
    ...
    CMSG_CAN_REDEEM_TOKEN_FOR_BALANCE                 = 0x370F,
    CMSG_CAST_SPELL                                   = 0x329C,
    CMSG_CHANGE_BAG_SLOT_FLAG                         = 0x32C8,
    CMSG_CHANGE_BANK_BAG_SLOT_FLAG                    = 0x32C9,
    CMSG_CHANGE_REALM_TICKET                          = 0x3701,
    CMSG_CHANGE_SUB_GROUP                             = 0x364F,
    CMSG_CHARACTER_CHECK_UPGRADE                      = 0x36CE,
    CMSG_CHARACTER_RENAME_REQUEST                     = 0x36C9,
    CMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_REQUEST    = 0x36CC,
    CMSG_CHARACTER_UPGRADE_START                      = 0x36CD,
    CMSG_CHAR_CUSTOMIZE                               = 0x368C,
    CMSG_CHAR_DELETE                                  = 0x369D,
    CMSG_CHAR_RACE_OR_FACTION_CHANGE                  = 0x3692,
    CMSG_CHAT_ADDON_MESSAGE                           = 0x37EE,
    CMSG_CHAT_ADDON_MESSAGE_WHISPER                   = 0x37EF,
    ...
    CMSG_CHECK_IS_ADVENTURE_MAP_POI_VALID             = 0x3247,
    CMSG_CLEAR_TRADE_ITEM                             = 0x315E,
    CMSG_CLOSE_INTERACTION                            = 0x3493,
    CMSG_CLOSE_QUEST_CHOICE                           = 0x32A2,
    CMSG_CLOSE_TRAIT_SYSTEM_INTERACTION               = 0x330E,
    CMSG_CLUB_PRESENCE_SUBSCRIBE                      = 0x36FF,
    ...
    CMSG_COMMERCE_TOKEN_GET_COUNT                     = 0x36EC,
    CMSG_COMMERCE_TOKEN_GET_LOG                       = 0x36F6,
    CMSG_COMMERCE_TOKEN_GET_MARKET_PRICE              = 0x36ED,
    CMSG_COMPLAINT                                    = 0x366E,
    CMSG_COMPLETE_CINEMATIC                           = 0x3545,
    CMSG_COMPLETE_MOVIE                               = 0x34DD,
    CMSG_CONFIRM_BARBERS_CHOICE                       = 0x320E,
    CMSG_CONFIRM_RESPEC_WIPE                          = 0x320D,
    CMSG_CONNECT_TO_FAILED                            = 0x35D4,
    CMSG_CONSUMABLE_TOKEN_BUY                         = 0x36F1,
    CMSG_CONSUMABLE_TOKEN_BUY_AT_MARKET_PRICE         = 0x36F2,
    CMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY             = 0x36F0,
    CMSG_CONSUMABLE_TOKEN_REDEEM                      = 0x36F4,
    CMSG_CONSUMABLE_TOKEN_REDEEM_CONFIRMATION         = 0x36F5,
    CMSG_CONTRIBUTION_LAST_UPDATE_REQUEST             = 0x355B,
    ...
    CMSG_ENGINE_SURVEY                                = 0x36EB,
    CMSG_ENTER_ENCRYPTED_MODE_ACK                     = 0x3767,
    CMSG_ENUM_CHARACTERS                              = 0x35E9,
    CMSG_ENUM_CHARACTERS_DELETED_BY_CLIENT            = 0x36E5,
    ...
    CMSG_GET_MIRROR_IMAGE_DATA                        = 0x3297,
    CMSG_GET_REMAINING_GAME_TIME                      = 0x36F3,
    CMSG_GET_UNDELETE_CHARACTER_COOLDOWN_STATUS       = 0x36E7,
    CMSG_GET_VAS_ACCOUNT_CHARACTER_LIST               = 0x36F8,
    ...
    CMSG_GUILD_ADD_BATTLENET_FRIEND                   = 0x308C,
    ...
    CMSG_KEYBOUND_OVERRIDE                            = 0x3223,
    CMSG_LATENCY_REPORT                               = 0x3771,
    CMSG_LEARN_PREVIEW_TALENTS                        = 0x3553,
    CMSG_LEARN_PREVIEW_TALENTS_PET                    = 0x3555,
    ...
    CMSG_LFG_LIST_JOIN                                = 0x32F0,
    CMSG_LFG_LIST_LEAVE                               = 0x360C,
    CMSG_LFG_LIST_SEARCH                              = 0x360E,
    CMSG_LFG_LIST_SET_ROLES                           = 0x3302,
    CMSG_LFG_LIST_UPDATE_REQUEST                      = 0x32F1,
    CMSG_LIST_INVENTORY                               = 0x34A1,
    CMSG_LIVE_REGION_ACCOUNT_RESTORE                  = 0x36C2,
    CMSG_LIVE_REGION_CHARACTER_COPY                   = 0x36C1,
    CMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST       = 0x36C0,
    ...
    CMSG_MISSILE_TRAJECTORY_COLLISION                 = 0x318D,
    ...
    CMSG_OBJECT_UPDATE_RESCUED                        = 0x3184,
    ...
    CMSG_QUERY_QUEST_ITEM_USABILITY                   = 0x3178,
    CMSG_QUERY_REALM_NAME                             = 0x368A,
    CMSG_QUERY_TIME                                   = 0x34D5,
    CMSG_QUERY_TREASURE_PICKER                        = 0x32DC,
    ...
    CMSG_QUEST_GIVER_STATUS_TRACKED_QUERY             = 0x356B,
    ...
    CMSG_QUICK_JOIN_AUTO_ACCEPT_REQUESTS              = 0x370D,
    CMSG_QUICK_JOIN_REQUEST_INVITE                    = 0x370C,
    ...
    CMSG_SET_ADVANCED_COMBAT_LOGGING                  = 0x32B5,
    ...
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT               = 0x32CA,
    ...
    CMSG_CHAT_ADDON_MESSAGE_TARGETED                  = 0xBADD,
...
{
    SMSG_ABORT_NEW_WORLD                              = 0x2598,
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x2868,
    SMSG_ACCOUNT_DATA_TIMES                           = 0x270A,
    SMSG_ACCOUNT_EXPORT_RESPONSE                      = 0x28A7,
    SMSG_ACCOUNT_MOUNT_REMOVED                        = 0x25AF,
    ...
    SMSG_ADDON_LIST_REQUEST                           = 0x2642,
    SMSG_ADD_BATTLENET_FRIEND_RESPONSE                = 0x263D,
    SMSG_ADD_ITEM_PASSIVE                             = 0x25AA,
    SMSG_ADD_LOSS_OF_CONTROL                          = 0x2671,
    SMSG_ADD_RUNE_POWER                               = 0x26B8,
    SMSG_ADJUST_SPLINE_DURATION                       = 0x25D0,
    SMSG_AE_LOOT_TARGETS                              = 0x2618,
    SMSG_AE_LOOT_TARGET_ACK                           = 0x2619,
    ...
    SMSG_AREA_TRIGGER_NO_CORPSE                       = 0x2716,
    SMSG_AREA_TRIGGER_RE_PATH                         = 0x28FD,
    SMSG_AREA_TRIGGER_RE_SHAPE                        = 0x2902,
    SMSG_AREA_TRIGGER_UNATTACH                        = 0x2901,
    SMSG_ARENA_CROWD_CONTROL_SPELL_RESULT             = 0x2632,
    SMSG_ARENA_PREP_OPPONENT_SPECIALIZATIONS          = 0x2648,
    ...
    SMSG_AUCTION_LIST_OWNER_ITEMS_RESULT              = 0x287C,
    SMSG_AUCTION_LIST_PENDING_SALES_RESULT            = 0x26F5,
    SMSG_AUCTION_OUTBID_NOTIFICATION                  = 0x26F2,
    SMSG_AUCTION_OWNER_BID_NOTIFICATION               = 0x26F4,
    SMSG_AUCTION_REPLICATE_RESPONSE                   = 0x26EF,
    ...
    SMSG_BATCH_PRESENCE_SUBSCRIPTION                  = 0x2846,
    ...
    SMSG_BATTLENET_CHALLENGE_ABORT                    = 0x2790,
    SMSG_BATTLENET_CHALLENGE_START                    = 0x278F,
    SMSG_BATTLENET_NOTIFICATION                       = 0x2808,
    SMSG_BATTLENET_RESPONSE                           = 0x2807,
    SMSG_BATTLE_NET_CONNECTION_STATUS                 = 0x2809,
    SMSG_BATTLE_PAY_ACK_FAILED                        = 0x2788,
    SMSG_BATTLE_PAY_BATTLE_PET_DELIVERED              = 0x277D,
    SMSG_BATTLE_PAY_COLLECTION_ITEM_DELIVERED         = 0x277E,
    SMSG_BATTLE_PAY_CONFIRM_PURCHASE                  = 0x2787,
    SMSG_BATTLE_PAY_DELIVERY_ENDED                    = 0x277B,
    SMSG_BATTLE_PAY_DELIVERY_STARTED                  = 0x277A,
    SMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS_RESPONSE  = 0x2888,
    SMSG_BATTLE_PAY_DISTRIBUTION_UNREVOKED            = 0x2778,
    SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE               = 0x2779,
    SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE    = 0x2777,
    SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE         = 0x2775,
    SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE        = 0x2776,
    SMSG_BATTLE_PAY_MOUNT_DELIVERED                   = 0x277C,
    SMSG_BATTLE_PAY_PURCHASE_UPDATE                   = 0x2786,
    SMSG_BATTLE_PAY_START_CHECKOUT                    = 0x2824,
    SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE = 0x2784,
    SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE           = 0x2783,
    SMSG_BATTLE_PAY_VALIDATE_PURCHASE_RESPONSE        = 0x2818,
    SMSG_BATTLE_PETS_HEALED                           = 0x25F3,
    SMSG_BATTLE_PET_CAGE_DATE_ERROR                   = 0x2678,
    SMSG_BATTLE_PET_DELETED                           = 0x25F0,
    SMSG_BATTLE_PET_ERROR                             = 0x2638,
    ...
    SMSG_BLACK_MARKET_BID_ON_ITEM_RESULT              = 0x2628,
    SMSG_BLACK_MARKET_OUTBID                          = 0x2629,
    SMSG_BLACK_MARKET_REQUEST_ITEMS_RESULT            = 0x2627,
    SMSG_BLACK_MARKET_WON                             = 0x262A,
    SMSG_BONUS_ROLL_EMPTY                             = 0x2645,
    ...
    SMSG_CALENDAR_CLEAR_PENDING_ACTION                = 0x269D,
    SMSG_CALENDAR_COMMAND_RESULT                      = 0x269E,
    SMSG_CALENDAR_COMMUNITY_INVITE                    = 0x268D,
    SMSG_CALENDAR_EVENT_REMOVED_ALERT                 = 0x2695,
    SMSG_CALENDAR_EVENT_UPDATED_ALERT                 = 0x2696,
    SMSG_CALENDAR_INVITE_ADDED                        = 0x268E,
    SMSG_CALENDAR_INVITE_ALERT                        = 0x2692,
    SMSG_CALENDAR_INVITE_NOTES                        = 0x2697,
    SMSG_CALENDAR_INVITE_NOTES_ALERT                  = 0x2698,
    SMSG_CALENDAR_INVITE_REMOVED                      = 0x268F,
    SMSG_CALENDAR_INVITE_REMOVED_ALERT                = 0x2694,
    SMSG_CALENDAR_INVITE_STATUS                       = 0x2690,
    SMSG_CALENDAR_INVITE_STATUS_ALERT                 = 0x2693,
    SMSG_CALENDAR_MODERATOR_STATUS                    = 0x2691,
    SMSG_CALENDAR_RAID_LOCKOUT_ADDED                  = 0x2699,
    SMSG_CALENDAR_RAID_LOCKOUT_REMOVED                = 0x269A,
    SMSG_CALENDAR_RAID_LOCKOUT_UPDATED                = 0x269B,
    SMSG_CALENDAR_SEND_CALENDAR                       = 0x268B,
    SMSG_CALENDAR_SEND_EVENT                          = 0x268C,
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x269C,
    SMSG_CAMERA_EFFECT                                = 0x2726,
    SMSG_CANCEL_AUTO_REPEAT                           = 0x26DE,
    SMSG_CANCEL_COMBAT                                = 0x294B,
    SMSG_CANCEL_ORPHAN_SPELL_VISUAL                   = 0x2C43,
    SMSG_CANCEL_PRELOAD_WORLD                         = 0x2596,
    SMSG_CANCEL_SCENE                                 = 0x2637,
    SMSG_CANCEL_SPELL_VISUAL                          = 0x2C41,
    SMSG_CANCEL_SPELL_VISUAL_KIT                      = 0x2C45,
    SMSG_CAN_DUEL_RESULT                              = 0x2947,
    SMSG_CAN_REDEEM_TOKEN_FOR_BALANCE_RESPONSE        = 0x2817,
    ...
    SMSG_CHARACTER_CHECK_UPGRADE_RESULT               = 0x27C2,
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x2705,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x278E,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x2767,
    SMSG_CHARACTER_UPGRADE_ABORTED                    = 0x27C1,
    SMSG_CHARACTER_UPGRADE_COMPLETE                   = 0x27C0,
    SMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_RESULT     = 0x27C3,
    SMSG_CHARACTER_UPGRADE_STARTED                    = 0x27BF,
    SMSG_CHAR_CUSTOMIZE_FAILURE                       = 0x26E2,
    SMSG_CHAR_CUSTOMIZE_SUCCESS                       = 0x26E3,
    SMSG_CHAR_FACTION_CHANGE_RESULT                   = 0x27AC,
    SMSG_CHAT                                         = 0x2BAD,
    ...
    SMSG_CHECK_WARGAME_ENTRY                          = 0x2590,
    ...
    SMSG_COMMENTATOR_MAP_INFO                         = 0x2707,
    SMSG_COMMENTATOR_PLAYER_INFO                      = 0x2708,
    SMSG_COMMENTATOR_STATE_CHANGED                    = 0x2706,
    ...
    SMSG_CONFIRM_BARBERS_CHOICE                       = 0x26BD,
    SMSG_CONFIRM_PARTY_INVITE                         = 0x2816,
    SMSG_CONNECT_TO                                   = 0x304D,
    SMSG_CONQUEST_FORMULA_CONSTANTS                   = 0x2789,
    SMSG_CONSOLE_WRITE                                = 0x2635,
    ...
    SMSG_CONTRIBUTION_LAST_UPDATE_RESPONSE            = 0x281D,
    SMSG_CONTROL_UPDATE                               = 0x2647,
    SMSG_CONVERT_RUNE                                 = 0x2C5D,
    ...
    SMSG_DAMAGE_CALC_LOG                              = 0x2C5F,
    SMSG_DB_REPLY                                     = 0x290E,
    SMSG_DEATH_RELEASE_LOC                            = 0x26D3,
    SMSG_DEBUG_MENU_MANAGER_FULL_UPDATE               = 0x2655,
    ...
    SMSG_DISPLAY_GAME_ERROR                           = 0x259D,
    SMSG_DISPLAY_PLAYER_CHOICE                        = 0x2FFC,
    SMSG_DISPLAY_PROMOTION                            = 0x264C,
    ...
    SMSG_ENCOUNTER_END                                = 0x2782,
    SMSG_ENCOUNTER_START                              = 0x2781,
    SMSG_END_LIGHTNING_STORM                          = 0x26A8,
    ...
    SMSG_FAILED_QUEST_TURN_IN                         = 0x2813,
    ...
    SMSG_FORCE_OBJECT_RELINK                          = 0x264B,
    SMSG_FRIEND_STATUS                                = 0x278D,
    SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT                = 0x25C3,
    SMSG_GAME_OBJECT_BASE                             = 0x282A,
    SMSG_GAME_OBJECT_CLOSE_INTERACTION                = 0x288C,
    SMSG_GAME_OBJECT_CUSTOM_ANIM                      = 0x25C4,
    SMSG_GAME_OBJECT_DESPAWN                          = 0x25C5,
    SMSG_GAME_OBJECT_INTERACTION                      = 0x288B,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL                = 0x2C48,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL_KIT            = 0x2C47,
    SMSG_GAME_OBJECT_RESET_STATE                      = 0x271E,
    SMSG_GAME_OBJECT_SET_STATE_LOCAL                  = 0x2806,
    SMSG_GAME_OBJECT_UI_LINK                          = 0x271A,
    SMSG_GAME_SPEED_SET                               = 0x2681,
    SMSG_GAME_TIME_SET                                = 0x270C,
    SMSG_GAME_TIME_UPDATE                             = 0x270B,
    SMSG_GENERATE_RANDOM_CHARACTER_NAME_RESULT        = 0x2585,
    SMSG_GENERATE_SSO_TOKEN_RESPONSE                  = 0x281E,
    ...
    SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY           = 0x27B2,
    SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT            = 0x27B1,
    SMSG_INSTANCE_ENCOUNTER_END                       = 0x27BA,
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT               = 0x27B0,
    SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE = 0x27BC,
    SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION    = 0x27BB,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE        = 0x27B5,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START           = 0x27B4,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE          = 0x27B9,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED       = 0x27BD,
    SMSG_INSTANCE_ENCOUNTER_START                     = 0x27B6,
    SMSG_INSTANCE_ENCOUNTER_TIMER_START               = 0x27B3,
    SMSG_INSTANCE_ENCOUNTER_UPDATE_ALLOW_RELEASE_IN_PROGRESS = 0x27B8,
    SMSG_INSTANCE_ENCOUNTER_UPDATE_SUPPRESS_RELEASE   = 0x27B7,
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                  = 0x26FA,
    SMSG_INSTANCE_INFO                                = 0x2634,
    SMSG_INSTANCE_RESET                               = 0x2686,
    SMSG_INSTANCE_RESET_FAILED                        = 0x2687,
    SMSG_INSTANCE_SAVE_CREATED                        = 0x2780,
    SMSG_INTERRUPT_POWER_REGEN                        = 0x2C56,
    ...
    SMSG_INVENTORY_FIXUP_COMPLETE                     = 0x2815,
    SMSG_INVENTORY_FULL_OVERFLOW                      = 0x2826,
    SMSG_ISLAND_AZERITE_GAIN                          = 0x275C,
    SMSG_ISLAND_COMPLETE                              = 0x275D,
    SMSG_IS_QUEST_COMPLETE_RESPONSE                   = 0x2A84,
    SMSG_ITEM_CHANGED                                 = 0x26EB,
    SMSG_ITEM_COOLDOWN                                = 0x27C8,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                     = 0x2755,
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x259C,
    SMSG_ITEM_PURCHASE_REFUND_RESULT                  = 0x259A,
    SMSG_ITEM_PUSH_RESULT                             = 0x2623,
    SMSG_ITEM_TIME_UPDATE                             = 0x2754,
    SMSG_KICK_REASON                                  = 0x2689,
    SMSG_LATENCY_REPORT_PING                          = 0x2884,
    ...
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT           = 0x2772,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT            = 0x2771,
    SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT = 0x2766,
    ...
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                  = 0x2670,
    ...
    SMSG_MASTER_LOOT_CANDIDATE_LIST                   = 0x261F,
    ...
    SMSG_MODIFY_COOLDOWN                              = 0x2768,
    SMSG_MOTD                                         = 0x2BAF,
    SMSG_MOUNT_RESULT                                 = 0x257B,
    SMSG_MOVEMENT_ENFORCEMENT_ALERT                   = 0x2847,
    ...
    SMSG_NEW_DATA_BUILD                               = 0x28AB,
    SMSG_NEW_TAXI_PATH                                = 0x267E,
    SMSG_NEW_WORLD                                    = 0x2594,
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST                   = 0x2C40,
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION          = 0x26AA,
    SMSG_NOTIFY_MONEY                                 = 0x2599,
    SMSG_NOTIFY_RECEIVED_MAIL                         = 0x263C,
    SMSG_NPC_INTERACTION_OPEN_RESULT                  = 0x288A,
    ...
    SMSG_PLAY_ORPHAN_SPELL_VISUAL                     = 0x2C44,
    SMSG_PLAY_SCENE                                   = 0x2636,
    SMSG_PLAY_SOUND                                   = 0x276C,
    SMSG_PLAY_SPEAKERBOT_SOUND                        = 0x276F,
    SMSG_PLAY_SPELL_VISUAL                            = 0x2C42,
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x2C46,
    SMSG_PONG                                         = 0x304E,
    SMSG_POWER_UPDATE                                 = 0x26D2,
    SMSG_PRELOAD_CHILD_MAP                            = 0x2579,
    SMSG_PRELOAD_WORLD                                = 0x2595,
    SMSG_PREPOPULATE_NAME_CACHE                       = 0x284A,
    SMSG_PRE_RESSURECT                                = 0x276B,
    SMSG_PRINT_NOTIFICATION                           = 0x25CA,
    SMSG_PROC_RESIST                                  = 0x275B,
    SMSG_PROPOSE_LEVEL_GRANT                          = 0x26DD,
    SMSG_PUSH_SPELL_TO_ACTION_BAR                     = 0x2C4E,
    ...
    SMSG_RECRUIT_A_FRIEND_FAILURE                     = 0x26C1,
    SMSG_REFER_A_FRIEND_EXPIRED                       = 0x2723,
    SMSG_REFRESH_COMPONENT                            = 0x2651,
    ...
    SMSG_SCENARIO_POIS                                = 0x2633,
    SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x262C,
    SMSG_SCENARIO_SHOW_CRITERIA                       = 0x2804,
    SMSG_SCENARIO_STATE                               = 0x262B,
    SMSG_SCENARIO_UI_UPDATE                           = 0x2803,
    SMSG_SCENARIO_VACATE                              = 0x27AA,
    ...
    SMSG_SERVER_FIRST_ACHIEVEMENTS                    = 0x264E,
    SMSG_SERVER_TIME                                  = 0x2682,
    ...
    SMSG_SET_FACTION_AT_WAR                           = 0x2700,
    ...
    SMSG_SET_ITEM_PURCHASE_DATA                       = 0x259B,
    SMSG_SET_LOOT_METHOD_FAILED                       = 0x27D2,
    SMSG_SET_MAX_WEEKLY_QUANTITY                      = 0x259E,
    ...
    SMSG_SOR_START_EXPERIENCE_INCOMPLETE              = 0x25DD,
    SMSG_SPECIAL_MOUNT_ANIM                           = 0x269F,
    SMSG_SPEC_INVOLUNTARILY_CHANGED                   = 0x2718,
    ...
    SMSG_SPELL_EXECUTE_LOG                            = 0x2C3D,
    SMSG_SPELL_FAILED_OTHER                           = 0x2C52,
    SMSG_SPELL_FAILURE                                = 0x2C50,
    SMSG_SPELL_FAILURE_MESSAGE                        = 0x2C57,
    ...
    SMSG_SYNC_WOW_ENTITLEMENTS                        = 0x286B,
    SMSG_TALENTS_INVOLUNTARILY_RESET                  = 0x2717,
    SMSG_TALENT_GROUP_ROLE_CHANGED                    = 0x258C,
    ...
    SMSG_UPDATE_AADC_STATUS_RESPONSE                  = 0x2886,
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x2709,
    SMSG_UPDATE_ACTION_BUTTONS                        = 0x25E0,
    SMSG_UPDATE_BNET_SESSION_KEY                      = 0x2825,
    SMSG_UPDATE_CELESTIAL_BODY                        = 0x2821,
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x27C4,
    SMSG_UPDATE_CHARGE_CATEGORY_COOLDOWN              = 0x276A,
    SMSG_UPDATE_COOLDOWN                              = 0x2769,
    SMSG_UPDATE_EXPANSION_LEVEL                       = 0x2646,
    SMSG_UPDATE_GAME_TIME_STATE                       = 0x2828,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x26A9,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x2688,
    SMSG_UPDATE_OBJECT                                = 0x27CB,
    SMSG_UPDATE_PET_TALENT_DATA                       = 0x25D7,
    SMSG_UPDATE_PRIMARY_SPEC                          = 0x25D8,
    SMSG_UPDATE_REALM_HIDDEN_INFO                     = 0x28AC,
    ...
    SMSG_VAS_CHECK_TRANSFER_OK_RESPONSE               = 0x281C,
    SMSG_VAS_GET_QUEUE_MINUTES_RESPONSE               = 0x281A,
    SMSG_VAS_GET_SERVICE_STATUS_RESPONSE              = 0x2819,
    ...
    SMSG_VOICE_CHANNEL_INFO_RESPONSE                  = 0x2820,
    SMSG_VOICE_CHANNEL_STT_TOKEN_RESPONSE             = 0x2882,
    SMSG_VOICE_LOGIN_RESPONSE                         = 0x281F,
    ...
    SMSG_WARDEN3_DISABLED                             = 0x2823,
    SMSG_WARDEN3_ENABLED                              = 0x2822,
    ...
    SMSG_WHO                                          = 0x2BAE,
    SMSG_WHO_IS                                       = 0x26A5,
    SMSG_WILL_BE_KICKED_FOR_ADDED_SUBSCRIPTION_TIME   = 0x2827,
    SMSG_WORLD_QUEST_UPDATE_RESPONSE                  = 0x300F,
    SMSG_WORLD_SERVER_INFO                            = 0x25AD,
    SMSG_WOW_ENTITLEMENT_NOTIFICATION                 = 0x286C,
    SMSG_XP_GAIN_ABORTED                              = 0x25C9,
    SMSG_XP_GAIN_ENABLED                              = 0x27AE,
