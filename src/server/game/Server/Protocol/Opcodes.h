...
enum OpcodeClient : uint16
{
    ...
    CMSG_ADD_TOY                                      = 0x32A9,
    CMSG_ADD_TRANSMOG_COSMETIC_COLLECTION_SOURCE      = 0x32AA,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_NOTIFICATIONS                        = 0x2883,
    SMSG_ACCOUNT_TOY_UPDATE                           = 0x25AD,
    SMSG_ACCOUNT_TRANSMOG_COSMETIC_COLLECTION_SOURCE_ADDED = 0x2884,
    ...
    SMSG_UPDATE_AADC_STATUS                           = 0x2887,
