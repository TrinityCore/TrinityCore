...
enum OpcodeClient : uint16
{
    ...
    CMSG_BUY_STABLE_SLOT                               = UNKNOWN_OPCODE,
    ...
    CMSG_MOVE_SEAMLESS_TRANSFER_COMPLETE               = UNKNOWN_OPCODE,
    ...
    CMSG_REPORT_FROZEN_WHILE_LOADING_MAP               = UNKNOWN_OPCODE,
    ...
    CMSG_REQUEST_FORCED_REACTIONS                      = UNKNOWN_OPCODE,
    ...
    CMSG_STABLE_SWAP_PET                               = UNKNOWN_OPCODE,
    ...
    CMSG_UNSTABLE_PET                                  = UNKNOWN_OPCODE
};
...
enum OpcodeServer : uint16
{
    ...
    SMSG_AUCTION_LIST_ITEMS_RESULT                     = 0x2851,
    ...
    //SMSG_UPDATE_TALENT_DATA                           = 0x25DA,
