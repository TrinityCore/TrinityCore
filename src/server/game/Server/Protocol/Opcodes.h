...
enum OpcodeClient : uint16
{
    ...
    CMSG_ATTACK_STOP                                  = 0x3252,
    CMSG_ATTACK_SWING                                 = 0x3251,
    ...
    CMSG_BATTLEMASTER_HELLO                           = 0x32AA,
    ...
    CMSG_CANCEL_CAST                                  = 0x3298,
    CMSG_CANCEL_CHANNELLING                           = 0x3266,
    CMSG_CANCEL_GROWTH_AURA                           = 0x326B,
    CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS            = 0x31AF,
    CMSG_CANCEL_MOUNT_AURA                            = 0x327B,
    ...
    CMSG_CAST_SPELL                                   = 0x3295,
    CMSG_CHANGE_BAG_SLOT_FLAG                         = 0x32C1,
    CMSG_CHANGE_BANK_BAG_SLOT_FLAG                    = 0x32C2,
    ...
    CMSG_CHECK_IS_ADVENTURE_MAP_POI_VALID             = 0x3243,
    CMSG_CHOICE_RESPONSE                              = 0x329A,
    ...
    CMSG_CLOSE_QUEST_CHOICE                           = 0x329B,
    ...
    CMSG_GET_MIRROR_IMAGE_DATA                        = 0x3290,
    ...
    CMSG_LOOT_ITEM                                    = 0x320F,
    CMSG_LOOT_MONEY                                   = 0x320E,
    CMSG_LOOT_RELEASE                                 = 0x3211,
    CMSG_LOOT_ROLL                                    = 0x3212,
    CMSG_LOOT_UNIT                                    = 0x320D,
    CMSG_LOW_LEVEL_RAID1                              = 0x369F,
    CMSG_LOW_LEVEL_RAID2                              = 0x3512,
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x353B,
    CMSG_MAIL_DELETE                                  = 0x3223,
    ...
    CMSG_MOUNT_SPECIAL_ANIM                           = 0x327C,
    ...
    CMSG_OFFER_PETITION                               = 0x32F7,
    CMSG_OPENING_CINEMATIC                            = 0x3543,
    CMSG_OPEN_ITEM                                    = 0x32BF,
    ...
    CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT        = 0x3222,
    ...
    CMSG_QUERY_BATTLE_PET_NAME                        = 0x3272,
    CMSG_QUERY_CORPSE_LOCATION_FROM_CLIENT            = 0x3661,
    CMSG_QUERY_CORPSE_TRANSPORT                       = 0x3662,
    CMSG_QUERY_COUNTDOWN_TIMER                        = 0x31AB,
    CMSG_QUERY_CREATURE                               = 0x326C,
    CMSG_QUERY_GAME_OBJECT                            = 0x326D,
    CMSG_QUERY_GARRISON_PET_NAME                      = 0x3273,
    CMSG_QUERY_GUILD_INFO                             = 0x368A,
    CMSG_QUERY_INSPECT_ACHIEVEMENTS                   = 0x3500,
    CMSG_QUERY_NEXT_MAIL_TIME                         = 0x3539,
    CMSG_QUERY_NPC_TEXT                               = 0x326E,
    CMSG_QUERY_PAGE_TEXT                              = 0x3270,
    CMSG_QUERY_PETITION                               = 0x3274,
    CMSG_QUERY_PET_NAME                               = 0x3271,
    ...
    CMSG_READ_ITEM                                    = 0x32C0,
    CMSG_RECLAIM_CORPSE                               = 0x34DB,
    CMSG_REMOVE_NEW_ITEM                              = 0x32D8,
    ...
    CMSG_REQUEST_LFG_LIST_BLACKLIST                   = 0x329D,
    ...
    CMSG_REQUEST_PLAYED_TIME                          = 0x3276,
    CMSG_REQUEST_RAID_INFO                            = 0x36CF,
    CMSG_REQUEST_RATED_PVP_INFO                       = 0x35E4,
    CMSG_REQUEST_STABLED_PETS                         = 0x3491,
    CMSG_REQUEST_VEHICLE_EXIT                         = 0x3233,
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                    = 0x3235,
    CMSG_REQUEST_VEHICLE_PREV_SEAT                    = 0x3234,
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                  = 0x3236,
    CMSG_REQUEST_WORLD_QUEST_UPDATE                   = 0x32D6,
    ...
    CMSG_RIDE_VEHICLE_INTERACT                        = 0x3237,
    CMSG_SAVE_CUF_PROFILES                            = 0x318F,
    CMSG_SAVE_EQUIPMENT_SET                           = 0x3509,
    CMSG_SAVE_GUILD_EMBLEM                            = 0x32A1,
    CMSG_SCENE_PLAYBACK_CANCELED                      = 0x321E,
    CMSG_SCENE_PLAYBACK_COMPLETE                      = 0x321D,
    CMSG_SCENE_TRIGGER_EVENT                          = 0x321F,
    ...
    CMSG_SET_CHAT_DISABLED                            = 0x373F,
    CMSG_SET_CONTACT_NOTES                            = 0x36D7,
    CMSG_SET_DIFFICULTY_ID                            = 0x3220,
    ...
    CMSG_TABARD_VENDOR_ACTIVATE                       = 0x32A2,
    ...
    CMSG_ACCEPT_SOCIAL_CONTRACT                                      = 0xBADD,
    CMSG_ACTIVATE_SOULBIND                                           = 0xBADD,
    CMSG_ADD_ACCOUNT_COSMETIC                                        = 0xBADD,
    CMSG_ADD_TOY                                                     = 0xBADD,
    CMSG_ADVENTURE_JOURNAL_UPDATE_SUGGESTIONS                        = 0xBADD,
    CMSG_ADVENTURE_MAP_START_QUEST                                   = 0xBADD,
    CMSG_AUTOBANK_REAGENT                                            = 0xBADD,
    CMSG_AUTOSTORE_BANK_REAGENT                                      = 0xBADD,
    CMSG_AZERITE_EMPOWERED_ITEM_SELECT_POWER                         = 0xBADD,
    CMSG_AZERITE_EMPOWERED_ITEM_VIEWED                               = 0xBADD,
    CMSG_AZERITE_ESSENCE_ACTIVATE_ESSENCE                            = 0xBADD,
    CMSG_AZERITE_ESSENCE_UNLOCK_MILESTONE                            = 0xBADD,
    ...
    CMSG_CONTRIBUTION_LAST_UPDATE_REQUEST                            = 0xBADD,
    ...
    CMSG_QUICK_JOIN_REQUEST_INVITE                                   = 0xBADD,
    ...
    CMSG_REQUEST_SCHEDULED_PVP_INFO                                  = 0xBADD,
    ...
    CMSG_SET_GAME_EVENT_DEBUG_VIEW_STATE                             = 0xBADD,
    ...
    CMSG_SOCIAL_CONTRACT_REQUEST                                     = 0xBADD,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x2869,
    SMSG_ACCOUNT_DATA_TIMES                           = 0x2706,
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0x25AE,
    SMSG_ACCOUNT_NOTIFICATIONS_RESPONSE               = 0x2885,
    SMSG_ACCOUNT_TOY_UPDATE                           = 0x25AF,
    SMSG_ACCOUNT_TRANSMOG_SET_FAVORITES_UPDATE        = 0x25B2,
    SMSG_ACCOUNT_TRANSMOG_UPDATE                      = 0x25B1,
    ...
    SMSG_AREA_TRIGGER_NO_CORPSE                       = 0x2712,
    ...
    SMSG_ARENA_TEAM_COMMAND_RESULT                    = 0x275F,
    SMSG_ARENA_TEAM_EVENT                             = 0x275E,
    SMSG_ARENA_TEAM_INVITE                            = 0x275D,
    SMSG_ARENA_TEAM_ROSTER                            = 0x275C,
    SMSG_ARENA_TEAM_STATS                             = 0x2760,
    SMSG_ARTIFACT_XP_GAIN                             = 0x27EF,
    SMSG_ATTACKER_STATE_UPDATE                        = 0x2951,
    SMSG_ATTACK_START                                 = 0x293C,
    SMSG_ATTACK_STOP                                  = 0x293D,
    SMSG_ATTACK_SWING_ERROR                           = 0x294B,
    SMSG_ATTACK_SWING_LANDED_LOG                      = 0x294C,
    ...
    SMSG_AUCTION_CLOSED_NOTIFICATION                  = 0x26EF,
    SMSG_AUCTION_COMMAND_RESULT                       = 0x26EC,
    SMSG_AUCTION_FAVORITE_LIST                        = 0x2870,
    SMSG_AUCTION_HELLO_RESPONSE                       = 0x26EA,
    SMSG_AUCTION_LIST_BIDDED_ITEMS_RESULT             = 0x287F,
    SMSG_AUCTION_LIST_ITEMS_RESULT                    = 0x2864,
    SMSG_AUCTION_LIST_OWNED_ITEMS_RESULT              = 0x287E,
    SMSG_AUCTION_OUTBID_NOTIFICATION                  = 0x26EE,
    SMSG_AUCTION_OWNER_BID_NOTIFICATION               = 0x26F0,
    SMSG_AUCTION_REPLICATE_RESPONSE                   = 0x26EB,
    SMSG_AUCTION_WON_NOTIFICATION                     = 0x26ED,
    ...
    SMSG_AZERITE_RESPEC_NPC                           = 0x27F9,
    ...
    SMSG_BATTLEGROUND_INIT                            = 0x294E,
    SMSG_BATTLEGROUND_PLAYER_JOINED                   = 0x292B,
    SMSG_BATTLEGROUND_PLAYER_LEFT                     = 0x292C,
    SMSG_BATTLEGROUND_PLAYER_POSITIONS                = 0x2928,
    SMSG_BATTLEGROUND_POINTS                          = 0x294D,
    SMSG_BATTLENET_CHALLENGE_ABORT                    = 0x278C,
    SMSG_BATTLENET_CHALLENGE_START                    = 0x278B,
    SMSG_BATTLENET_NOTIFICATION                       = 0x2807,
    SMSG_BATTLENET_RESPONSE                           = 0x2806,
    SMSG_BATTLE_NET_CONNECTION_STATUS                 = 0x2808,
    ...
    SMSG_BATTLE_PAY_START_CHECKOUT                    = 0x2823,
    SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE = 0x2780,
    SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE           = 0x277F,
    SMSG_BATTLE_PAY_VALIDATE_PURCHASE_RESPONSE        = 0x2817,
    SMSG_BATTLE_PETS_HEALED                           = 0x25EF,
    SMSG_BATTLE_PET_CAGE_DATE_ERROR                   = 0x2675,
    SMSG_BATTLE_PET_DELETED                           = 0x25EC,
    SMSG_BATTLE_PET_ERROR                             = 0x2635,
    SMSG_BATTLE_PET_JOURNAL                           = 0x25EB,
    SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED             = 0x25E9,
    SMSG_BATTLE_PET_JOURNAL_LOCK_DENIED               = 0x25EA,
    SMSG_BATTLE_PET_LICENSE_CHANGED                   = 0x25F0,
    SMSG_BATTLE_PET_RESTORED                          = 0x25EE,
    SMSG_BATTLE_PET_REVOKED                           = 0x25ED,
    SMSG_BATTLE_PET_TRAP_LEVEL                        = 0x25E7,
    SMSG_BATTLE_PET_UPDATES                           = 0x25E6,
    SMSG_BINDER_CONFIRM                               = 0x26F9,
    ...
    SMSG_BOSS_KILL                                    = 0x2950,
    SMSG_BREAK_TARGET                                 = 0x293B,
    ...
    SMSG_CAN_DUEL_RESULT                              = 0x2946,
    SMSG_CAN_REDEEM_TOKEN_FOR_BALANCE_RESPONSE        = 0x2816,
    SMSG_CAPTURE_POINT_REMOVED                        = 0x292A,
    SMSG_CAST_FAILED                                  = 0x2C57,
    SMSG_CATEGORY_COOLDOWN                            = 0x2C16,
    SMSG_CHAIN_MISSILE_BOUNCE                         = 0x25C6,
    SMSG_CHANGE_PLAYER_DIFFICULTY_RESULT              = 0x3004,
    SMSG_CHANGE_REALM_TICKET_RESPONSE                 = 0x2809,
    SMSG_CHANNEL_LIST                                 = 0x2BC3,
    SMSG_CHANNEL_NOTIFY                               = 0x2BC0,
    SMSG_CHANNEL_NOTIFY_JOINED                        = 0x2BC1,
    SMSG_CHANNEL_NOTIFY_LEFT                          = 0x2BC2,
    SMSG_CHARACTER_CHECK_UPGRADE_RESULT               = 0x27C1,
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x2701,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x278A,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x2763,
    SMSG_CHARACTER_UPGRADE_ABORTED                    = 0x27C0,
    SMSG_CHARACTER_UPGRADE_COMPLETE                   = 0x27BF,
    SMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_RESULT     = 0x27C2,
    SMSG_CHARACTER_UPGRADE_STARTED                    = 0x27BE,
    SMSG_CHAR_CUSTOMIZE_FAILURE                       = 0x26DF,
    SMSG_CHAR_CUSTOMIZE_SUCCESS                       = 0x26E0,
    SMSG_CHAR_FACTION_CHANGE_RESULT                   = 0x27AB,
    SMSG_CHAT                                         = 0x2BAD,
    ...
    SMSG_COMPLETE_SHIPMENT_RESPONSE                   = 0x279D,
    SMSG_CONFIRM_PARTY_INVITE                         = 0x2815,
    SMSG_CONNECT_TO                                   = 0x304D,
    SMSG_CONQUEST_FORMULA_CONSTANTS                   = 0x2785,
    ...
    SMSG_CONTACT_LIST                                 = 0x2788,
    SMSG_CONTRIBUTION_LAST_UPDATE_RESPONSE            = 0x281C,
    ...
    SMSG_CORPSE_TRANSPORT_QUERY                       = 0x270E,
    SMSG_COVENANT_CALLINGS_AVAILABILITY_RESPONSE      = 0x2AA3,
    SMSG_COVENANT_PREVIEW_OPEN_NPC                    = 0x27FF,
    SMSG_COVENANT_RENOWN_OPEN_NPC                     = 0x287C,
    SMSG_CREATE_CHAR                                  = 0x26FD,
    SMSG_CREATE_SHIPMENT_RESPONSE                     = 0x279C,
    ...
    SMSG_DEATH_RELEASE_LOC                            = 0x26D0,
    SMSG_DEBUG_MENU_MANAGER_FULL_UPDATE               = 0x2652,
    SMSG_DEFENSE_MESSAGE                              = 0x2BB6,
    SMSG_DELETE_CHAR                                  = 0x26FE,
    SMSG_DESTROY_ARENA_UNIT                           = 0x273E,
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0x26F5,
    SMSG_DIFFERENT_INSTANCE_FROM_PARTY                = 0x258D,
    SMSG_DISENCHANT_CREDIT                            = 0x25A7,
    SMSG_DISMOUNT                                     = 0x26AE,
    ...
    SMSG_DUEL_ARRANGED                                = 0x2940,
    SMSG_DUEL_COMPLETE                                = 0x2944,
    SMSG_DUEL_COUNTDOWN                               = 0x2943,
    SMSG_DUEL_IN_BOUNDS                               = 0x2942,
    SMSG_DUEL_OUT_OF_BOUNDS                           = 0x2941,
    SMSG_DUEL_REQUESTED                               = 0x293F,
    SMSG_DUEL_WINNER                                  = 0x2945,
    SMSG_DURABILITY_DAMAGE_DEATH                      = 0x2742,
    SMSG_EMOTE                                        = 0x27C9,
    SMSG_ENABLE_BARBER_SHOP                           = 0x26B9,
    SMSG_ENCHANTMENT_LOG                              = 0x270F,
    ...
    SMSG_ENUM_VAS_PURCHASE_STATES_RESPONSE            = 0x27F5,
    ...
    SMSG_FAILED_QUEST_TURN_IN                         = 0x2812,
    SMSG_FEATURE_SYSTEM_STATUS                        = 0x25BD,
    SMSG_FEATURE_SYSTEM_STATUS_GLUE_SCREEN            = 0x25BE,
    SMSG_FEIGN_DEATH_RESISTED                         = 0x2741,
    SMSG_FISH_ESCAPED                                 = 0x26CD,
    SMSG_FISH_NOT_HOOKED                              = 0x26CC,
    SMSG_FLIGHT_SPLINE_SYNC                           = 0x2E2B,
    SMSG_FORCED_DEATH_UPDATE                          = 0x26D1,
    SMSG_FORCE_ANIM                                   = 0x274D,
    SMSG_FORCE_ANIMATIONS                             = 0x274E,
    SMSG_FORCE_OBJECT_RELINK                          = 0x2648,
    SMSG_FRIEND_STATUS                                = 0x2789,
    SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT                = 0x25C1,
    SMSG_GAME_OBJECT_BASE                             = 0x282A,
    SMSG_GAME_OBJECT_CUSTOM_ANIM                      = 0x25C2,
    SMSG_GAME_OBJECT_DESPAWN                          = 0x25C3,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL                = 0x2C4B,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL_KIT            = 0x2C4A,
    SMSG_GAME_OBJECT_RESET_STATE                      = 0x271A,
    SMSG_GAME_OBJECT_SET_STATE_LOCAL                  = 0x2805,
    SMSG_GAME_OBJECT_UI_LINK                          = 0x2716,
    SMSG_GAME_SPEED_SET                               = 0x267E,
    SMSG_GAME_TIME_SET                                = 0x2708,
    SMSG_GAME_TIME_UPDATE                             = 0x2707,
    SMSG_GENERATE_RANDOM_CHARACTER_NAME_RESULT        = 0x2585,
    SMSG_GENERATE_SSO_TOKEN_RESPONSE                  = 0x281D,
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT            = 0x2761,
    SMSG_GET_LANDING_PAGE_SHIPMENTS_RESPONSE          = 0x279F,
    SMSG_GET_REMAINING_GAME_TIME_RESPONSE             = 0x27DC,
    SMSG_GET_SELECTED_TROPHY_ID_RESPONSE              = 0x27C6,
    SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE               = 0x279E,
    SMSG_GET_SHIPMENT_INFO_RESPONSE                   = 0x279A,
    SMSG_GET_TROPHY_LIST_RESPONSE                     = 0x27C5,
    SMSG_GET_VAS_ACCOUNT_CHARACTER_LIST_RESULT        = 0x27F1,
    SMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST_RESULT    = 0x27F2,
    ...
    SMSG_GOD_MODE                                     = 0x26F8,
    SMSG_GOSSIP_COMPLETE                              = 0x2A97,
    SMSG_GOSSIP_MESSAGE                               = 0x2A98,
    SMSG_GOSSIP_POI                                   = 0x2797,
    SMSG_GOSSIP_QUEST_UPDATE                          = 0x2A99,
    SMSG_GOSSIP_REFRESH_OPTION                        = 0x2AA6,
    SMSG_GROUP_ACTION_THROTTLED                       = 0x2592,
    SMSG_GROUP_AUTO_KICK                              = 0x2794,
    SMSG_GROUP_DECLINE                                = 0x2790,
    ...
    SMSG_GUILD_EVENT_BANK_CONTENTS_CHANGED            = 0x29F7,
    SMSG_GUILD_EVENT_BANK_MONEY_CHANGED               = 0x29F6,
    ...
    SMSG_GUILD_EVENT_RANKS_UPDATED                    = 0x29F0,
    SMSG_GUILD_EVENT_RANK_CHANGED                     = 0x29F1,
    SMSG_GUILD_EVENT_TAB_ADDED                        = 0x29F2,
    SMSG_GUILD_EVENT_TAB_DELETED                      = 0x29F3,
    SMSG_GUILD_EVENT_TAB_MODIFIED                     = 0x29F4,
    SMSG_GUILD_EVENT_TAB_TEXT_CHANGED                 = 0x29F5,
    ...
    SMSG_HEALTH_UPDATE                                = 0x26CE,
    SMSG_HIGHEST_THREAT_UPDATE                        = 0x26D6,
    SMSG_HOTFIX_CONNECT                               = 0x2911,
    SMSG_HOTFIX_MESSAGE                               = 0x2910,
    SMSG_INITIALIZE_FACTIONS                          = 0x2720,
    SMSG_INITIAL_SETUP                                = 0x2580,
    SMSG_INIT_WORLD_STATES                            = 0x2743,
    SMSG_INSPECT_HONOR_STATS                          = 0x2933,
    SMSG_INSPECT_PVP                                  = 0x271E,
    SMSG_INSPECT_RESULT                               = 0x262E,
    SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY           = 0x27B1,
    SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT            = 0x27B0,
    SMSG_INSTANCE_ENCOUNTER_END                       = 0x27B9,
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT               = 0x27AF,
    SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE = 0x27BB,
    SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION    = 0x27BA,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE        = 0x27B4,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START           = 0x27B3,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE          = 0x27B8,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED       = 0x27BC,
    SMSG_INSTANCE_ENCOUNTER_START                     = 0x27B5,
    SMSG_INSTANCE_ENCOUNTER_TIMER_START               = 0x27B2,
    SMSG_INSTANCE_ENCOUNTER_UPDATE_ALLOW_RELEASE_IN_PROGRESS = 0x27B7,
    SMSG_INSTANCE_ENCOUNTER_UPDATE_SUPPRESS_RELEASE   = 0x27B6,
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                  = 0x26F6,
    ...
    SMSG_INVENTORY_FIXUP_COMPLETE                     = 0x2814,
    SMSG_INVENTORY_FULL_OVERFLOW                      = 0x2825,
    SMSG_ISLANDS_MISSION_NPC                          = 0x27FB,
    SMSG_ISLAND_AZERITE_GAIN                          = 0x2758,
    SMSG_ISLAND_COMPLETE                              = 0x2759,
    SMSG_IS_QUEST_COMPLETE_RESPONSE                   = 0x2A84,
    SMSG_ITEM_CHANGED                                 = 0x26E7,
    ...
    SMSG_LOAD_CUF_PROFILES                            = 0x25BA,
    SMSG_LOAD_EQUIPMENT_SET                           = 0x270A,
    SMSG_LOGIN_SET_TIME_SPEED                         = 0x2709,
    ...
    SMSG_MAP_OBJECTIVES_INIT                          = 0x294F,
    SMSG_MAP_OBJ_EVENTS                               = 0x25C4,
    ...
    SMSG_OPEN_ANIMA_DIVERSION_UI                      = 0x2717,
    SMSG_OPEN_CONTAINER                               = 0x2DA6,
    SMSG_OPEN_HEART_FORGE                             = 0x2828,
    SMSG_OPEN_LFG_DUNGEON_FINDER                      = 0x2A31,
    SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP                = 0x2799,
    SMSG_OPEN_SHIPMENT_NPC_RESULT                     = 0x279B,
    SMSG_OVERRIDE_LIGHT                               = 0x26B8,
    SMSG_PAGE_TEXT                                    = 0x2715,
    SMSG_PARTY_COMMAND_RESULT                         = 0x2795,
    SMSG_PARTY_INVITE                                 = 0x25BB,
    ...
    SMSG_PARTY_UPDATE                                 = 0x25F1,
    SMSG_PAST_TIME_EVENTS                             = 0x25C0,
    SMSG_PAUSE_MIRROR_TIMER                           = 0x270C,
    SMSG_PENDING_RAID_LOCK                            = 0x26F4,
    SMSG_PETITION_ALREADY_SIGNED                      = 0x25A3,
    SMSG_PETITION_RENAME_GUILD_RESPONSE               = 0x29F9,
    ...
    SMSG_PLAYER_SAVE_GUILD_EMBLEM                     = 0x29F8,
    ...
    SMSG_PLAY_TIME_WARNING                            = 0x26FA,
    SMSG_PONG                                         = 0x304E,
    SMSG_POWER_UPDATE                                 = 0x26CF,
    SMSG_PRELOAD_CHILD_MAP                            = 0x2579,
    SMSG_PREPOPULATE_NAME_CACHE                       = 0x285F,
    SMSG_PRE_RESSURECT                                = 0x2767,
    SMSG_PRINT_NOTIFICATION                           = 0x25C8,
    SMSG_PROC_RESIST                                  = 0x2757,
    SMSG_PUSH_SPELL_TO_ACTION_BAR                     = 0x2C51,
    SMSG_PVP_CREDIT                                   = 0x2949,
    SMSG_PVP_MATCH_COMPLETE                           = 0x2953,
    SMSG_PVP_MATCH_INITIALIZE                         = 0x2954,
    SMSG_PVP_MATCH_START                              = 0x2952,
    SMSG_PVP_MATCH_STATISTICS                         = 0x2934,
    SMSG_PVP_OPTIONS_ENABLED                          = 0x2937,
    ...
    SMSG_QUEST_SESSION_INFO_RESPONSE                  = 0x286E,
    ...
    SMSG_QUEUE_SUMMARY_UPDATE                         = 0x2813,
    SMSG_RAF_ACTIVITY_STATE_CHANGED                   = 0x286A,
    SMSG_RAID_DIFFICULTY_SET                          = 0x27AC,
    SMSG_RAID_GROUP_ONLY                              = 0x27AE,
    ...
    SMSG_READ_ITEM_RESULT_FAILED                      = 0x27A8,
    SMSG_READ_ITEM_RESULT_OK                          = 0x27A0,
    ...
    SMSG_REMOVE_ITEM_PASSIVE                          = 0x25AB,
    SMSG_REMOVE_SPELL_FROM_ACTION_BAR                 = 0x2C52,
    SMSG_REPLACE_TROPHY_RESPONSE                      = 0x27C4,
    SMSG_REPORT_PVP_PLAYER_AFK_RESULT                 = 0x3001,
    SMSG_REQUEST_CEMETERY_LIST_RESPONSE               = 0x2593,
    SMSG_REQUEST_PVP_REWARDS_RESPONSE                 = 0x2938,
    SMSG_REQUEST_SCHEDULED_PVP_INFO_RESPONSE          = 0x2939,
    ...
    SMSG_RESET_RANGED_COMBAT_TIMER                    = 0x2948,
    ...
    SMSG_RESTRICTED_ACCOUNT_WARNING                   = 0x25B7,
    ...
    SMSG_RUNEFORGE_LEGENDARY_CRAFTING_OPEN_NPC        = 0x2800,
    SMSG_RUNE_REGEN_DEBUG                             = 0x25B4,
    SMSG_SCENARIO_COMPLETED                           = 0x27EE,
    SMSG_SCENARIO_POIS                                = 0x2630,
    SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x2629,
    SMSG_SCENARIO_SHOW_CRITERIA                       = 0x2803,
    SMSG_SCENARIO_STATE                               = 0x2628,
    SMSG_SCENARIO_UI_UPDATE                           = 0x2802,
    SMSG_SCENARIO_VACATE                              = 0x27A9,
    ...
    SMSG_SEASON_INFO                                  = 0x25BF,
    SMSG_SELL_RESPONSE                                = 0x26C2,
    SMSG_SEND_ITEM_PASSIVES                           = 0x25AC,
    ...
    SMSG_SET_FACTION_AT_WAR                           = 0x26FC,
    ...
    SMSG_SET_FORCED_REACTIONS                         = 0x2719,
    ...
    SMSG_SET_PLAY_HOVER_ANIM                          = 0x25B8,
    SMSG_SET_PROFICIENCY                              = 0x2731,
    SMSG_SET_SPELL_CHARGES                            = 0x2C29,
    SMSG_SET_TASK_COMPLETE                            = 0x278F,
    SMSG_SET_TIME_ZONE_INFORMATION                    = 0x2674,
    SMSG_SET_VEHICLE_REC_ID                           = 0x26F3,
    SMSG_SHOW_BANK                                    = 0x267C,
    SMSG_SHOW_MAILBOX                                 = 0x27AA,
    ...
    SMSG_SPEC_INVOLUNTARILY_CHANGED                   = 0x2714,
    ...
    SMSG_SPIRIT_HEALER_CONFIRM                        = 0x2711,
    SMSG_SPLASH_SCREEN_SHOW_LATEST                    = 0x2875,
    SMSG_STAND_STATE_UPDATE                           = 0x2718,
    ...
    SMSG_TRANSFER_ABORTED                             = 0x26FF,
    SMSG_TRANSFER_PENDING                             = 0x25CB,
    SMSG_TRANSMOGRIFY_NPC                             = 0x27F8,
    ...
    SMSG_TUTORIAL_FLAGS                               = 0x27BD,
    SMSG_TWITTER_STATUS                               = 0x3043,
    SMSG_UI_HEALING_RANGE_MODIFIED                    = 0x2740,
    SMSG_UI_ITEM_INTERACTION_NPC                      = 0x27FA,
    ...
    SMSG_VAS_CHECK_TRANSFER_OK_RESPONSE               = 0x281B,
    SMSG_VAS_GET_QUEUE_MINUTES_RESPONSE               = 0x2819,
    SMSG_VAS_GET_SERVICE_STATUS_RESPONSE              = 0x2818,
    SMSG_VAS_PURCHASE_COMPLETE                        = 0x27F4,
    SMSG_VAS_PURCHASE_STATE_UPDATE                    = 0x27F3,
    SMSG_VENDOR_INVENTORY                             = 0x25B6,
    SMSG_VIGNETTE_UPDATE                              = 0x3008,
    SMSG_VOICE_CHANNEL_INFO_RESPONSE                  = 0x281F,
    SMSG_VOICE_CHANNEL_STT_TOKEN_RESPONSE             = 0x2884,
    SMSG_VOICE_LOGIN_RESPONSE                         = 0x281E,
    ...
    SMSG_WARDEN3_DISABLED                             = 0x2822,
    SMSG_WARDEN3_ENABLED                              = 0x2821,
    ...
    SMSG_WHO                                          = 0x2BAE,
    SMSG_WHO_IS                                       = 0x26A2,
    SMSG_WILL_BE_KICKED_FOR_ADDED_SUBSCRIPTION_TIME   = 0x2826,
    SMSG_WORLD_MAP_OPEN_NPC                           = 0x27F7,
    SMSG_WORLD_QUEST_UPDATE_RESPONSE                  = 0x300F,
    SMSG_WORLD_SERVER_INFO                            = 0x25AD,
    SMSG_WOW_ENTITLEMENT_NOTIFICATION                 = 0x286D,
    SMSG_XP_GAIN_ABORTED                              = 0x25C7,
    SMSG_XP_GAIN_ENABLED                              = 0x27AD,
    ...
    SMSG_AUCTION_DISABLE_POSTING_BEFORE_MAINTENANCE             = 0xBADD,
    SMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS_RESPONSE            = 0xBADD,
    ...
    SMSG_GARRISON_OPEN_TALENT_NPC                               = 0xBADD,
    ...
    SMSG_SOCIAL_CONTRACT_REQUEST_RESPONSE                       = 0xBADD,
