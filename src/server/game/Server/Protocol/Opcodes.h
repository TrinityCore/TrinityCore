...
enum OpcodeClient : uint32
{
    ...
    CMSG_BATTLE_PAY_GET_PRODUCT_LIST_QUERY            = 0x1616,
    ...
    CMSG_EQUIPMENT_SET_SAVE                           = 0xBADD,
    ...
    CMSG_MOVE_START_TURN_LEFT                         = 0x0157,
...
enum OpcodeServer : uint32
{
    ...
    SMSG_ATTACKERSTATEUPDATE                          = 0xBADD,
    ...
    SMSG_CHANNEL_START                                = 0x103E,
    SMSG_CHANNEL_UPDATE                               = 0x10D9,
    ...
    SMSG_CLIENTCACHE_VERSION                          = 0x0E09,
    SMSG_CLIENT_CONTROL_UPDATE                        = 0x0D32,
    ...
    SMSG_CREATURE_QUERY_RESPONSE                      = 0x1A15,
    ...
    SMSG_EQUIPMENT_SET_LIST                           = 0x079E,
    ...
    SMSG_GUILD_QUERY_RESPONSE                         = 0xBADD,
    ...
    SMSG_LOGIN_SETTIMESPEED                           = 0x0D65,
    ...
    SMSG_MOVE_DISABLE_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY = 0x1EAC,
    SMSG_MOVE_DISABLE_COLLISION                       = 0xBADD,
    SMSG_MOVE_DISABLE_GRAVITY                         = 0xBADD,
    SMSG_MOVE_ENABLE_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY = 0x0BCF,
    ...
    SMSG_MOVE_SPLINE_SET_WALK_BACK_SPEED              = 0x1205,
    ...
    SMSG_NAME_QUERY_RESPONSE                          = 0x0C71,
    ...
    SMSG_QUEST_QUERY_RESPONSE                         = 0xBADD,
    ...
    SMSG_SET_PHASE_SHIFT_CHANGE                       = 0xBADD,
    ...
    SMSG_SPELL_CATEGORY_COOLDOWN                      = 0x15FA,
    ...
    SMSG_TALENTS_INFO                                 = 0x1862,
    SMSG_TALENTS_INVOLUNTARILY_RESET                  = 0xBADD,
    SMSG_TAXINODE_STATUS                              = 0x0EBF,
