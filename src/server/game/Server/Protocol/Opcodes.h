...
enum OpcodeClient : uint32
{
    ...
    CMSG_ALTER_APPEARANCE                             = 0x34E9,
    CMSG_AREA_SPIRIT_HEALER_QUERY                     = 0x34AF,
    CMSG_AREA_SPIRIT_HEALER_QUEUE                     = 0x34B0,
    ...
    CMSG_AUCTION_HELLO_REQUEST                        = 0x34BF,
    CMSG_AUCTION_LIST_BIDDER_ITEMS                    = 0x34C5,
    CMSG_AUCTION_LIST_ITEMS                           = 0x34C2,
    CMSG_AUCTION_LIST_OWNER_ITEMS                     = 0x34C4,
    CMSG_AUCTION_LIST_PENDING_SALES                   = 0x34C7,
    CMSG_AUCTION_PLACE_BID                            = 0x34C6,
    CMSG_AUCTION_REMOVE_ITEM                          = 0x34C1,
    CMSG_AUCTION_REPLICATE_ITEMS                      = 0x34C3,
    CMSG_AUCTION_SELL_ITEM                            = 0x34C0,
    ...
    CMSG_BANKER_ACTIVATE                              = 0x34B2,
    CMSG_BATTLEFIELD_LEAVE                            = 0x3171,
    CMSG_BATTLEFIELD_LIST                             = 0x317C,
    CMSG_BATTLEFIELD_PORT                             = 0x3517,
    CMSG_BATTLEMASTER_HELLO                           = 0x3288,
    CMSG_BATTLEMASTER_JOIN                            = 0x3514,
    CMSG_BATTLEMASTER_JOIN_ARENA                      = 0x3515,
    CMSG_BATTLEMASTER_JOIN_SKIRMISH                   = 0x3516,
    ...
    CMSG_BINDER_ACTIVATE                              = 0x34B1,
    CMSG_BLACK_MARKET_BID_ON_ITEM                     = 0x351E,
    CMSG_BLACK_MARKET_OPEN                            = 0x351C,
    CMSG_BLACK_MARKET_REQUEST_ITEMS                   = 0x351D,
    CMSG_BUG_REPORT                                   = 0x368C,
    CMSG_BUSY_TRADE                                   = 0x3158,
    CMSG_BUY_BACK_ITEM                                = 0x34A3,
    CMSG_BUY_BANK_SLOT                                = 0x34B3,
    CMSG_BUY_ITEM                                     = 0x34A2,
    CMSG_BUY_REAGENT_BANK                             = 0x34B4,
    ...
    CMSG_CANCEL_AUTO_REPEAT_SPELL                     = 0x34DB,
    CMSG_CANCEL_CAST                                  = 0x3278,
    CMSG_CANCEL_CHANNELLING                           = 0x3246,
    CMSG_CANCEL_GROWTH_AURA                           = 0x324B,
    CMSG_CANCEL_MASTER_LOOT_ROLL                      = 0x31F7,
    CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS            = 0x31A6,
    CMSG_CANCEL_MOUNT_AURA                            = 0x325C,
    CMSG_CANCEL_QUEUED_SPELL                          = 0x317D,
    CMSG_CANCEL_TEMP_ENCHANTMENT                      = 0x34E6,
    CMSG_CANCEL_TRADE                                 = 0x315C,
    CMSG_CAN_DUEL                                     = 0x3667,
    CMSG_CAST_SPELL                                   = 0x3276,
    ...
    CMSG_CHOICE_RESPONSE                              = 0x327A,
    CMSG_CLEAR_RAID_MARKER                            = 0x319F,
    CMSG_CLEAR_TRADE_ITEM                             = 0x315E,
    CMSG_CLIENT_PORT_GRAVEYARD                        = 0x3519,
    CMSG_CLOSE_INTERACTION                            = 0x348E,
    ...
    CMSG_COMPLETE_CINEMATIC                           = 0x3536,
    CMSG_COMPLETE_MOVIE                               = 0x34D1,
    ...
    CMSG_DECLINE_GUILD_INVITES                        = 0x3512,
    CMSG_DECLINE_PETITION                             = 0x3525,
    CMSG_DELETE_EQUIPMENT_SET                         = 0x3500,
    CMSG_DEL_FRIEND                                   = 0x36D6,
    CMSG_DEL_IGNORE                                   = 0x36DA,
    CMSG_DEPOSIT_REAGENT_BANK                         = 0x3306,
    CMSG_DESTROY_ITEM                                 = 0x326D,
    ...
    CMSG_DISMISS_CRITTER                              = 0x34EF,
    CMSG_DO_MASTER_LOOT_ROLL                          = 0x31F6,
    CMSG_DO_READY_CHECK                               = 0x3634,
    CMSG_DUEL_RESPONSE                                = 0x34D6,
    CMSG_EJECT_PASSENGER                              = 0x321F,
    CMSG_EMOTE                                        = 0x3532,
    CMSG_ENABLE_ENCRYPTION_ACK                        = 0x3767,
    CMSG_ENABLE_NAGLE                                 = 0x376B,
    CMSG_ENABLE_TAXI_NODE                             = 0x34A8,
    CMSG_ENGINE_SURVEY                                = 0x36E9,
    CMSG_ENUM_CHARACTERS                              = 0x35E7,
    CMSG_ENUM_CHARACTERS_DELETED_BY_CLIENT            = 0x36E3,
    CMSG_FAR_SIGHT                                    = 0x34DC,
    CMSG_GAME_OBJ_REPORT_USE                          = 0x34E3,
    CMSG_GAME_OBJ_USE                                 = 0x34E2,
    CMSG_GARRISON_ASSIGN_FOLLOWER_TO_BUILDING         = 0x32B4,
    CMSG_GARRISON_CANCEL_CONSTRUCTION                 = 0x32A5,
    CMSG_GARRISON_CHECK_UPGRADEABLE                   = 0x32F9,
    CMSG_GARRISON_COMPLETE_MISSION                    = 0x32EA,
    CMSG_GARRISON_GENERATE_RECRUITS                   = 0x32B7,
    CMSG_GARRISON_GET_BUILDING_LANDMARKS              = 0x32C5,
    CMSG_GARRISON_MISSION_BONUS_ROLL                  = 0x32EC,
    CMSG_GARRISON_PURCHASE_BUILDING                   = 0x32A1,
    CMSG_GARRISON_RECRUIT_FOLLOWER                    = 0x32B9,
    CMSG_GARRISON_REMOVE_FOLLOWER                     = 0x32E1,
    CMSG_GARRISON_REMOVE_FOLLOWER_FROM_BUILDING       = 0x32B5,
    CMSG_GARRISON_RENAME_FOLLOWER                     = 0x32B6,
    CMSG_GARRISON_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA = 0x32A0,
    ...
    CMSG_GARRISON_RESEARCH_TALENT                     = 0x32BA,
    CMSG_GARRISON_SET_BUILDING_ACTIVE                 = 0x32A2,
    CMSG_GARRISON_SET_FOLLOWER_FAVORITE               = 0x32B2,
    CMSG_GARRISON_SET_FOLLOWER_INACTIVE               = 0x32AE,
    CMSG_GARRISON_SET_RECRUITMENT_PREFERENCES         = 0x32B8,
    CMSG_GARRISON_START_MISSION                       = 0x32E9,
    CMSG_GARRISON_SWAP_BUILDINGS                      = 0x32A6,
    CMSG_GENERATE_RANDOM_CHARACTER_NAME               = 0x35E6,
    CMSG_GET_CHALLENGE_MODE_REWARDS                   = 0x3688,
    CMSG_GET_GARRISON_INFO                            = 0x329B,
    CMSG_GET_ITEM_PURCHASE_DATA                       = 0x3520,
    CMSG_GET_MIRROR_IMAGE_DATA                        = 0x3271,
    ...
    CMSG_GOSSIP_SELECT_OPTION                         = 0x348F,
    CMSG_GRANT_LEVEL                                  = 0x34EB,
    ...
    CMSG_GUILD_BANK_BUY_TAB                           = 0x34B8,
    CMSG_GUILD_BANK_DEPOSIT_MONEY                     = 0x34BA,
    CMSG_GUILD_BANK_LOG_QUERY                         = 0x3082,
    CMSG_GUILD_BANK_QUERY_TAB                         = 0x34B7,
    CMSG_GUILD_BANK_REMAINING_WITHDRAW_MONEY_QUERY    = 0x3083,
    CMSG_GUILD_BANK_SET_TAB_TEXT                      = 0x3086,
    CMSG_GUILD_BANK_SWAP_ITEMS                        = 0x34B6,
    CMSG_GUILD_BANK_TEXT_QUERY                        = 0x3087,
    CMSG_GUILD_BANK_UPDATE_TAB                        = 0x34B9,
    CMSG_GUILD_BANK_WITHDRAW_MONEY                    = 0x34BB,
    ...
    CMSG_LEARN_PVP_TALENTS                            = 0x3544,
    CMSG_LEARN_TALENTS                                = 0x3543,
    ...
    CMSG_LOGOUT_CANCEL                                = 0x34CC,
    CMSG_LOGOUT_INSTANT                               = 0x34CD,
    CMSG_LOGOUT_REQUEST                               = 0x34CB,
    ...
    CMSG_LOW_LEVEL_RAID2                              = 0x3507,
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x352C,
    CMSG_MAIL_DELETE                                  = 0x320A,
    CMSG_MAIL_GET_LIST                                = 0x3527,
    CMSG_MAIL_MARK_AS_READ                            = 0x352B,
    CMSG_MAIL_RETURN_TO_SENDER                        = 0x3659,
    CMSG_MAIL_TAKE_ITEM                               = 0x3529,
    CMSG_MAIL_TAKE_MONEY                              = 0x3528,
    ...
    CMSG_MOUNT_SPECIAL_ANIM                           = 0x325D,
    ...
    CMSG_PET_CANCEL_AURA                              = 0x3489,
    CMSG_PET_CAST_SPELL                               = 0x3275,
    CMSG_PET_RENAME                                   = 0x368B,
    CMSG_PET_SET_ACTION                               = 0x3485,
    CMSG_PET_SPELL_AUTOCAST                           = 0x348A,
    CMSG_PET_STOP_ATTACK                              = 0x3487,
    CMSG_PING                                         = 0x3768,
    CMSG_PLAYER_LOGIN                                 = 0x35E9,
    CMSG_PROTOCOL_MISMATCH                            = 0x376E,
    CMSG_PUSH_QUEST_TO_PARTY                          = 0x349E,
    CMSG_PVP_LOG_DATA                                 = 0x3179,
    CMSG_PVP_PRESTIGE_RANK_UP                         = 0x331F,
    CMSG_QUERY_BATTLE_PET_NAME                        = 0x3252,
    CMSG_QUERY_CORPSE_LOCATION_FROM_CLIENT            = 0x3665,
    CMSG_QUERY_CORPSE_TRANSPORT                       = 0x3666,
    CMSG_QUERY_COUNTDOWN_TIMER                        = 0x31A2,
    CMSG_QUERY_CREATURE                               = 0x324C,
    CMSG_QUERY_GAME_OBJECT                            = 0x324D,
    CMSG_QUERY_GARRISON_CREATURE_NAME                 = 0x3253,
    CMSG_QUERY_GUILD_INFO                             = 0x3693,
    CMSG_QUERY_INSPECT_ACHIEVEMENTS                   = 0x34F6,
    CMSG_QUERY_NEXT_MAIL_TIME                         = 0x352A,
    CMSG_QUERY_NPC_TEXT                               = 0x324E,
    CMSG_QUERY_PAGE_TEXT                              = 0x3250,
    CMSG_QUERY_PETITION                               = 0x3254,
    CMSG_QUERY_PET_NAME                               = 0x3251,
    CMSG_QUERY_PLAYER_NAME                            = 0x3691,
    CMSG_QUERY_QUEST_COMPLETION_NPCS                  = 0x3172,
    CMSG_QUERY_QUEST_INFO                             = 0x324F,
    CMSG_QUERY_QUEST_REWARDS                          = 0x3322,
    CMSG_QUERY_REALM_NAME                             = 0x3692,
    CMSG_QUERY_SCENARIO_POI                           = 0x365A,
    CMSG_QUERY_TIME                                   = 0x34CA,
    CMSG_QUERY_VOID_STORAGE                           = 0x319B,
    CMSG_QUEST_CONFIRM_ACCEPT                         = 0x349D,
    CMSG_QUEST_GIVER_ACCEPT_QUEST                     = 0x3494,
    CMSG_QUEST_GIVER_CHOOSE_REWARD                    = 0x3499,
    CMSG_QUEST_GIVER_COMPLETE_QUEST                   = 0x3497,
    CMSG_QUEST_GIVER_HELLO                            = 0x3491,
    CMSG_QUEST_GIVER_IGNORE_QUEST                     = 0x3495,
    CMSG_QUEST_GIVER_QUERY_QUEST                      = 0x3492,
    CMSG_QUEST_GIVER_REQUEST_REWARD                   = 0x349A,
    CMSG_QUEST_GIVER_STATUS_MULTIPLE_QUERY            = 0x349C,
    CMSG_QUEST_GIVER_STATUS_QUERY                     = 0x349B,
    CMSG_QUEST_GIVER_UNIGNORE_QUEST                   = 0x3496,
    CMSG_QUEST_LOG_REMOVE_QUEST                       = 0x351F,
    CMSG_QUEST_POI_QUERY                              = 0x36B6,
    CMSG_QUEST_PUSH_RESULT                            = 0x349F,
    ...
    CMSG_REPAIR_ITEM                                  = 0x34E0,
    CMSG_REPLACE_TROPHY                               = 0x32DC,
    CMSG_REPOP_REQUEST                                = 0x3518,
    CMSG_REPORT_PVP_PLAYER_AFK                        = 0x34E8,
    ...
    CMSG_REQUEST_CONQUEST_FORMULA_CONSTANTS           = 0x328B,
    ...
    CMSG_REQUEST_LFG_LIST_BLACKLIST                   = 0x327C,
    CMSG_REQUEST_PARTY_JOIN_UPDATES                   = 0x35F5,
    CMSG_REQUEST_PARTY_MEMBER_STATS                   = 0x3654,
    CMSG_REQUEST_PET_INFO                             = 0x348B,
    CMSG_REQUEST_PLAYED_TIME                          = 0x3257,
    ...
    CMSG_REQUEST_STABLED_PETS                         = 0x348C,
    ...
    CMSG_SAVE_CLIENT_VARIABLES                        = 0x3705,
    CMSG_SAVE_CUF_PROFILES                            = 0x3189,
    CMSG_SAVE_ENABLED_ADDONS                          = 0x3704,
    CMSG_SAVE_EQUIPMENT_SET                           = 0x34FF,
    ...
    CMSG_SELF_RES                                     = 0x3522,
    CMSG_SELL_ITEM                                    = 0x34A1,
    ...
    CMSG_SET_FACTION_AT_WAR                           = 0x34D2,
    CMSG_SET_FACTION_INACTIVE                         = 0x34D4,
    CMSG_SET_FACTION_NOT_AT_WAR                       = 0x34D3,
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT               = 0x3302,
    CMSG_SET_LFG_BONUS_FACTION_ID                     = 0x327B,
    CMSG_SET_LOOT_METHOD                              = 0x3649,
    CMSG_SET_LOOT_SPECIALIZATION                      = 0x3530,
    ...
    CMSG_TABARD_VENDOR_ACTIVATE                       = 0x3281,
    CMSG_TALK_TO_GOSSIP                               = 0x348D,
    CMSG_TAXI_NODE_STATUS_QUERY                       = 0x34A7,
    CMSG_TAXI_QUERY_AVAILABLE_NODES                   = 0x34A9,
    CMSG_TAXI_REQUEST_EARLY_LANDING                   = 0x34AB,
...
enum OpcodeServer : uint32
{
    ...
    SMSG_AREA_SPIRIT_HEALER_TIME                      = 0x2780,
    ...
    SMSG_CAMERA_EFFECT                                = 0x2764,
    SMSG_CAMERA_SHAKE                                 = 0x2765,
    ...
    SMSG_CHALLENGE_MODE_REWARDS                       = 0x261D,
    ...
    SMSG_DESTROY_ARENA_UNIT                           = 0x2782,
    ...
    SMSG_INITIALIZE_FACTIONS                          = 0x2762,
    SMSG_INITIAL_SETUP                                = 0x257F,
    SMSG_INIT_WORLD_STATES                            = 0x2789,
    ...
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT           = 0x27B0,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT            = 0x27AE,
    ...
    SMSG_MAIL_LIST_RESULT                             = 0x2796,
    SMSG_MAIL_QUERY_NEXT_TIME_RESULT                  = 0x2797,
    SMSG_MAP_OBJECTIVES_INIT                          = 0x279F,
    ...
    SMSG_MODIFY_CHARGE_RECOVERY_SPEED                 = 0x27A7,
    SMSG_MODIFY_COOLDOWN                              = 0x27A5,
    SMSG_MODIFY_COOLDOWN_RECOVERY_SPEED               = 0x27A6,
    SMSG_MODIFY_PARTY_RANGE                           = 0x2784,
    SMSG_MOTD                                         = 0x2BAF,
    ...
    SMSG_PARTY_MEMBER_STATE_UPDATE                    = 0x2798,
    ...
    SMSG_PETITION_SIGN_RESULTS                        = 0x278D,
    SMSG_PET_ACTION_FEEDBACK                          = 0x278B,
    ...
    SMSG_PLAYER_SKINNED                               = 0x2786,
    SMSG_PLAYER_TABARD_VENDOR_ACTIVATE                = 0x279A,
    SMSG_PLAY_MUSIC                                   = 0x27AA,
    SMSG_PLAY_OBJECT_SOUND                            = 0x27AB,
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                       = 0x2770,
    SMSG_PLAY_ORPHAN_SPELL_VISUAL                     = 0x2C46,
    SMSG_PLAY_SCENE                                   = 0x264F,
    SMSG_PLAY_SOUND                                   = 0x27A9,
    SMSG_PLAY_SPEAKERBOT_SOUND                        = 0x27AC,
    SMSG_PLAY_SPELL_VISUAL                            = 0x2C44,
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x2C48,
    SMSG_PLAY_TIME_WARNING                            = 0x2737,
    SMSG_PONG                                         = 0x304E,
    SMSG_POWER_UPDATE                                 = 0x26FA,
    SMSG_PRESTIGE_AND_HONOR_INVOLUNTARILY_CHANGED     = 0x2755,
    SMSG_PRE_RESSURECT                                = 0x27A8,
    SMSG_PRINT_NOTIFICATION                           = 0x25DD,
    SMSG_PROC_RESIST                                  = 0x279C,
    ...
    SMSG_SET_FACTION_NOT_VISIBLE                      = 0x276A,
    SMSG_SET_FACTION_STANDING                         = 0x276B,
    SMSG_SET_FACTION_VISIBLE                          = 0x2769,
    ...
    SMSG_SOCKET_GEMS                                  = 0x2766,
    SMSG_SOCKET_GEMS_FAILURE                          = 0x2767,
    ...
    SMSG_USE_EQUIPMENT_SET_RESULT                     = 0x2790,
    SMSG_VENDOR_INVENTORY                             = 0x25C7,
    SMSG_VIGNETTE_UPDATE                              = 0x27AF,
