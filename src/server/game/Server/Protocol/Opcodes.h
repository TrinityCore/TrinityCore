...
enum OpcodeClient : uint32
{
    ...
    CMSG_BATTLENET_REQUEST_REALM_LIST_TICKET          = 0x36F8,
    ...
    CMSG_CALENDAR_GUILD_FILTER                        = 0x3672,
    ...
    CMSG_COMMENTATOR_ENTER_INSTANCE                   = 0x35F3,
    CMSG_COMMENTATOR_EXIT_INSTANCE                    = 0x35F4,
    ...
    CMSG_CONVERT_CONSUMPTION_TIME                     = 0x36FA,
    ...
    CMSG_LOADING_SCREEN_NOTIFY                        = 0x35F7,
    ...
    CMSG_PARTY_INVITE                                 = 0x3601,
    CMSG_PARTY_INVITE_RESPONSE                        = 0x3602,
    ...
    CMSG_REQUEST_CONSUMPTION_CONVERSION_INFO          = 0x36F9,
    ...
    CMSG_REQUEST_PARTY_JOIN_UPDATES                   = 0x35F6,
    ...
    CMSG_SAVE_CLIENT_VARIABLES                        = 0x3700,
    CMSG_SAVE_CUF_PROFILES                            = 0x318A,
    CMSG_SAVE_ENABLED_ADDONS                          = 0x36FF,
    ...
    CMSG_WHO                                          = 0x3682,
    CMSG_WHO_IS                                       = 0x3681,
    CMSG_WORLD_PORT_RESPONSE                          = 0x35F8,
    CMSG_WORLD_TELEPORT                               = 0x3332,
...
enum OpcodeServer : uint32
{
    ...
    SMSG_AE_LOOT_TARGETS                              = 0x262B,
    SMSG_AE_LOOT_TARGET_ACK                           = 0x262C,
    ...
    SMSG_BATTLENET_NOTIFICATION                       = 0x283C,
    SMSG_BATTLENET_REALM_LIST_TICKET                  = 0x283E,
    SMSG_BATTLENET_RESPONSE                           = 0x283B,
    SMSG_BATTLENET_SET_SESSION_STATE                  = 0x283D,
    ...
    SMSG_BATTLE_PAY_VAS_BNET_TRANSFER_VALIDATION_RESULT = 0x2853,
    SMSG_BATTLE_PAY_VAS_BOOST_CONSUMED                = 0x27B7,
    SMSG_BATTLE_PAY_VAS_CHARACTER_LIST                = 0x282B,
    SMSG_BATTLE_PAY_VAS_CHARACTER_QUEUE_STATUS        = 0x2852,
    SMSG_BATTLE_PAY_VAS_PURCHASE_COMPLETE             = 0x282E,
    SMSG_BATTLE_PAY_VAS_PURCHASE_LIST                 = 0x282F,
    SMSG_BATTLE_PAY_VAS_PURCHASE_STARTED              = 0x282D,
    SMSG_BATTLE_PAY_VAS_REALM_LIST                    = 0x282C,
    SMSG_BATTLE_PAY_VAS_TRANSFER_QUEUE_STATUS         = 0x2851,
    ...
    SMSG_CHALLENGE_MODE_ALL_MAP_STATS                 = 0x2621,
    SMSG_CHALLENGE_MODE_COMPLETE                      = 0x261F,
    SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE              = 0x2622,
    SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD             = 0x2624,
    SMSG_CHALLENGE_MODE_REQUEST_LEADERS_RESULT        = 0x2623,
    SMSG_CHALLENGE_MODE_RESET                         = 0x261E,
    SMSG_CHALLENGE_MODE_REWARDS                       = 0x2620,
    ...
    SMSG_CHARACTER_CLASS_TRIAL_CREATE                 = 0x2800,
    SMSG_CHARACTER_ITEM_FIXUP                         = 0x284D,
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x2744,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x27CD,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x27A6,
    SMSG_CHARACTER_UPGRADE_COMPLETE                   = 0x27FF,
    SMSG_CHARACTER_UPGRADE_QUEUED                     = 0x27FE,
    SMSG_CHARACTER_UPGRADE_SPELL_TIER_SET             = 0x25F4,
    SMSG_CHARACTER_UPGRADE_STARTED                    = 0x27FD,
    SMSG_CHARACTER_UPGRADE_UNREVOKE_RESULT            = 0x2801,
    SMSG_CHAR_CUSTOMIZE                               = 0x2719,
    SMSG_CHAR_CUSTOMIZE_FAILED                        = 0x2718,
    SMSG_CHAR_FACTION_CHANGE_RESULT                   = 0x27EB,
    SMSG_CHAT                                         = 0x2BAD,
    ...
    SMSG_CONSUMPTION_CONVERSION_INFO_RESPONSE         = 0x2842,
    SMSG_CONSUMPTION_CONVERSION_RESULT                = 0x2843,
    ...
    SMSG_DAMAGE_CALC_LOG                              = 0x2808,
    SMSG_DANCE_STUDIO_CREATE_RESULT                   = 0x27A3,
    ...
    SMSG_GAME_OBJECT_SET_STATE                        = 0x283A,
    ...
    SMSG_GET_TROPHY_LIST_RESPONSE                     = 0x2804,
    ...
    SMSG_GROUP_INVITE_CONFIRMATION                    = 0x284E,
    ...
    SMSG_HOTFIXES                                     = 0x25A2,
    SMSG_HOTFIX_LIST                                  = 0x25A1,
    SMSG_HOTFIX_QUERY_RESPONSE                        = 0x25A3,
    ...
    SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY           = 0x27F1,
    SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT            = 0x27F0,
    SMSG_INSTANCE_ENCOUNTER_END                       = 0x27F8,
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT               = 0x27EF,
    SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE = 0x27FA,
    SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION    = 0x27F9,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE        = 0x27F4,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START           = 0x27F3,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE          = 0x27F7,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED       = 0x27FB,
    SMSG_INSTANCE_ENCOUNTER_SET_SUPPRESSING_RELEASE   = 0x27F6,
    SMSG_INSTANCE_ENCOUNTER_START                     = 0x27F5,
    SMSG_INSTANCE_ENCOUNTER_TIMER_START               = 0x27F2,
    ...
    SMSG_LOAD_SELECTED_TROPHY_RESULT                  = 0x2805,
    ...
    SMSG_LOOT_ITEM_LIST                               = 0x2633,
    SMSG_LOOT_LIST                                    = 0x2783,
    SMSG_LOOT_MONEY_NOTIFY                            = 0x262F,
    SMSG_LOOT_RELEASE                                 = 0x262E,
    SMSG_LOOT_RELEASE_ALL                             = 0x262D,
    SMSG_LOOT_REMOVED                                 = 0x2628,
    SMSG_LOOT_RESPONSE                                = 0x2627,
    SMSG_LOOT_ROLL                                    = 0x2631,
    ...
    SMSG_MASTER_LOOT_CANDIDATE_LIST                   = 0x2632,
    ...
    SMSG_QUERY_ITEM_TEXT_RESPONSE                     = 0x2806,
    ...
    SMSG_QUERY_QUEST_REWARD_RESPONSE                  = 0x283F,
    ...
    SMSG_QUEST_GIVER_QUEST_TURN_IN_FAILURE            = 0x284B,
    ...
    SMSG_RAID_DIFFICULTY_SET                          = 0x27EC,
    SMSG_RAID_GROUP_ONLY                              = 0x27EE,
    ...
    SMSG_READ_ITEM_RESULT_FAILED                      = 0x27E8,
    ...
    SMSG_REPLACE_TROPHY_RESPONSE                      = 0x2803,
    ...
    SMSG_RESPEC_WIPE_CONFIRM                          = 0x2625,
    ...
    SMSG_SCENARIO_BOOT                                = 0x27E9,
    SMSG_SCENARIO_COMPLETED                           = 0x2827,
    SMSG_SCENARIO_POIS                                = 0x264F,
    SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x2648,
    SMSG_SCENARIO_SET_SHOULD_SHOW_CRITERIA            = 0x2833,
    SMSG_SCENARIO_SPELL_UPDATE                        = 0x2832,
    ...
    SMSG_SET_LOOT_METHOD_FAILED                       = 0x2812,
    ...
    SMSG_SHOW_ADVENTURE_MAP                           = 0x2830,
    SMSG_SHOW_BANK                                    = 0x26A8,
    SMSG_SHOW_MAILBOX                                 = 0x27EA,
    ...
    SMSG_TRIGGER_CINEMATIC                            = 0x280A,
    SMSG_TRIGGER_MOVIE                                = 0x26F4,
    SMSG_TURN_IN_PETITION_RESULT                      = 0x2791,
    SMSG_TUTORIAL_FLAGS                               = 0x27FC,
    SMSG_TUTORIAL_HIGHLIGHT_SPELL                     = 0x2839,
    SMSG_TUTORIAL_UNHIGHLIGHT_SPELL                   = 0x2838,
    SMSG_TWITTER_STATUS                               = 0x2FFD,
    SMSG_UI_TIME                                      = 0x2753,
    SMSG_UNDELETE_CHARACTER_RESPONSE                  = 0x280D,
    SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE            = 0x280E,
    SMSG_UNLEARNED_SPELLS                             = 0x2C4D,
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x2748,
    SMSG_UPDATE_ACTION_BUTTONS                        = 0x25F5,
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x2802,
    ...
    SMSG_WHO                                          = 0x2BAE,
    SMSG_WHO_IS                                       = 0x26CE,
    SMSG_WORLD_QUEST_UPDATE                           = 0x2840,
    SMSG_WORLD_SERVER_INFO                            = 0x25C2,
    SMSG_WORLD_TEXT                                   = 0x2829,
    SMSG_WOW_TOKEN_AUCTION_SOLD                       = 0x2818,
    SMSG_WOW_TOKEN_BUY_REQUEST_CONFIRMATION           = 0x281A,
    SMSG_WOW_TOKEN_BUY_RESULT_CONFIRMATION            = 0x281B,
    SMSG_WOW_TOKEN_CAN_REDEEM_FOR_BALANCE_RESULT      = 0x284F,
    SMSG_WOW_TOKEN_CAN_VETERAN_BUY_RESULT             = 0x2819,
    SMSG_WOW_TOKEN_DISTRIBUTION_GLUE_UPDATE           = 0x2813,
    SMSG_WOW_TOKEN_DISTRIBUTION_UPDATE                = 0x2814,
    SMSG_WOW_TOKEN_MARKET_PRICE_RESPONSE              = 0x2815,
    SMSG_WOW_TOKEN_REDEEM_GAME_TIME_UPDATED           = 0x281C,
    SMSG_WOW_TOKEN_REDEEM_REQUEST_CONFIRMATION        = 0x281D,
    SMSG_WOW_TOKEN_REDEEM_RESULT                      = 0x281E,
    SMSG_WOW_TOKEN_SELL_REQUEST_CONFIRMATION          = 0x2816,
    SMSG_WOW_TOKEN_SELL_RESULT_CONFIRMATION           = 0x2817,
    SMSG_WOW_TOKEN_UPDATE_AUCTIONABLE_LIST_RESPONSE   = 0x281F,
    SMSG_XP_GAIN_ABORTED                              = 0x25E0,
    SMSG_XP_GAIN_ENABLED                              = 0x27ED,
