...
enum Opcodes
{
    ...
    CMSG_AUTO_DECLINE_GUILD_INVITES                   = 0x1234,
    ...
    CMSG_GUILD_BANK_REM_MONEY_WITHDRAW_QUERY          = 0x1225,
    ...
    CMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY_= 0x3014,
    ...
    SMSG_GUILD_BANK_REM_MONEY_WITHDRAW_QUERY          = 0x5DB4,
    ...
    SMSG_MOVE_UNSET_CAN_TRANSITION_BETWEEN_SWIM_AND_FL= 0x7DB2,
    ...
    SMSG_SPLINE_SET_WALK_BACK_SPEED                   = 0x34A5,
