...
enum OpcodeClient : uint32
{
    ...
    CMSG_ATTACK_STOP                                  = 0x3238,
    CMSG_ATTACK_SWING                                 = 0x3237,
    ...
    CMSG_BATTLEMASTER_HELLO                           = 0x3287,
    ...
    CMSG_CANCEL_CHANNELLING                           = 0x3245,
    CMSG_CANCEL_GROWTH_AURA                           = 0x324A,
    CMSG_CANCEL_MASTER_LOOT_ROLL                      = 0x31F6,
    CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS            = 0x31A6,
    CMSG_CANCEL_MOUNT_AURA                            = 0x325B,
    ...
    CMSG_GARRISON_ASSIGN_FOLLOWER_TO_BUILDING         = 0x32B3,
    CMSG_GARRISON_CANCEL_CONSTRUCTION                 = 0x32A4,
    CMSG_GARRISON_CHECK_UPGRADEABLE                   = 0x32F8,
    CMSG_GARRISON_COMPLETE_MISSION                    = 0x32E9,
    CMSG_GARRISON_GENERATE_RECRUITS                   = 0x32B6,
    CMSG_GARRISON_GET_BUILDING_LANDMARKS              = 0x32C4,
    CMSG_GARRISON_MISSION_BONUS_ROLL                  = 0x32EB,
    CMSG_GARRISON_PURCHASE_BUILDING                   = 0x32A0,
    CMSG_GARRISON_RECRUIT_FOLLOWER                    = 0x32B8,
    CMSG_GARRISON_REMOVE_FOLLOWER                     = 0x32E0,
    CMSG_GARRISON_REMOVE_FOLLOWER_FROM_BUILDING       = 0x32B4,
    CMSG_GARRISON_RENAME_FOLLOWER                     = 0x32B5,
    CMSG_GARRISON_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA = 0x329F,
    CMSG_GARRISON_REQUEST_CLASS_SPEC_CATEGORY_INFO    = 0x32BD,
    CMSG_GARRISON_REQUEST_LANDING_PAGE_SHIPMENT_INFO  = 0x32C7,
    CMSG_GARRISON_REQUEST_SHIPMENT_INFO               = 0x32C6,
    CMSG_GARRISON_RESEARCH_TALENT                     = 0x32B9,
    CMSG_GARRISON_SET_BUILDING_ACTIVE                 = 0x32A1,
    CMSG_GARRISON_SET_FOLLOWER_FAVORITE               = 0x32B1,
    CMSG_GARRISON_SET_FOLLOWER_INACTIVE               = 0x32AD,
    CMSG_GARRISON_SET_RECRUITMENT_PREFERENCES         = 0x32B7,
    ...
    CMSG_MOUNT_SPECIAL_ANIM                           = 0x325C,
    ...
    CMSG_OPEN_SHIPMENT_NPC                            = 0x32C5,
    CMSG_OPEN_TRADESKILL_NPC                          = 0x32D0,
    ...
    CMSG_REQUEST_CONQUEST_FORMULA_CONSTANTS           = 0x328A,
    CMSG_REQUEST_FORCED_REACTIONS                     = 0x31ED,
    CMSG_REQUEST_GUILD_PARTY_STATE                    = 0x31A1,
    CMSG_REQUEST_GUILD_REWARDS_LIST                   = 0x31A0,
    CMSG_REQUEST_HONOR_STATS                          = 0x3178,
    CMSG_REQUEST_LFG_LIST_BLACKLIST                   = 0x327B,
    ...
    CMSG_REQUEST_VEHICLE_EXIT                         = 0x3219,
    ...
    CMSG_SET_ADVANCED_COMBAT_LOGGING                  = 0x328B,
    ...
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT               = 0x3301,
    CMSG_SET_LFG_BONUS_FACTION_ID                     = 0x327A,
    ...
    CMSG_SORT_BAGS                                    = 0x3302,
    CMSG_SORT_BANK_BAGS                               = 0x3303,
    CMSG_SORT_REAGENT_BANK_BAGS                       = 0x3304,
    ...
    CMSG_TABARD_VENDOR_ACTIVATE                       = 0x3280,
    ...
    CMSG_TOGGLE_PVP                                   = 0x3282,
    CMSG_TOTEM_DESTROYED                              = 0x34ED,
    CMSG_TOY_SET_FAVORITE                             = 0x3631,
    CMSG_TRADE_SKILL_SET_FAVORITE                     = 0x3320,
...
enum OpcodeServer : uint32
{
    ...
    SMSG_CHARACTER_ITEM_FIXUP                         = 0x2840,
