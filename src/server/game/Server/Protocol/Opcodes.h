...
enum OpcodeClient : uint16
{
    ...
    CMSG_CHANGE_BAG_SLOT_FLAG                             = 0x32CA,
    ...
    CMSG_PING                                             = 0x377C,
    CMSG_PLAYER_CLEAR_TRADE_ITEM                          = 0x315E,
    CMSG_PLAYER_LOGIN                                     = 0x35EB,
    CMSG_PLAYER_SAVE_GUILD_EMBLEM                         = 0x32A8,
    CMSG_PLAYER_TABARD_VENDOR_ACTIVATE                    = 0x32A9,
    CMSG_PLAYER_VIOLENCE_LEVEL                            = 0x3187,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_VOICE_CHANNEL_INFO_RESPONSE                  = 0x2823,
    SMSG_VOICE_CHANNEL_STT_TOKEN_RESPONSE             = 0x2885,
    SMSG_VOICE_LOGIN_RESPONSE                         = 0x2822,
