...
enum OpcodeClient : uint16
{
    ...
    CMSG_GUILD_BANK_SWAP_ITEMS_PLAYER_BANK            = 0x34BB,
    CMSG_GUILD_BANK_SWAP_ITEMS_BANK_PLAYER            = 0x34BC,
    CMSG_GUILD_BANK_SWAP_ITEMS_BANK_BANK              = 0x34BF,
    CMSG_GUILD_BANK_SWAP_ITEMS_PLAYER_BANK_COUNT      = 0x34C1,
    CMSG_GUILD_BANK_SWAP_ITEMS_BANK_PLAYER_COUNT      = 0x34C3,
    CMSG_GUILD_BANK_SWAP_ITEMS_BANK_PLAYER_AUTO       = 0x34C4,
    CMSG_GUILD_BANK_SWAP_ITEMS_BANK_BANK_COUNT        = 0x34C6,
