...
enum Opcodes
{
    ...
    SMSG_MOVE_DISABLE_TRANSITION_BETWEEN_SWIM_AND_FLY = 0x0000,
    SMSG_MOVE_ENABLE_COLLISION                        = 0x0000,
    SMSG_MOVE_ENABLE_GRAVITY                          = 0x0000,
    SMSG_MOVE_ENABLE_TRANSITION_BETWEEN_SWIM_AND_FLY  = 0x0000,
    ...
    SMSG_MOVE_SET_FEATHER_FALL                        = 0x0000,
    SMSG_MOVE_SET_FLIGHT_BACK_SPEED                   = 0x0000,
    SMSG_MOVE_SET_FLIGHT_SPEED                        = 0x0000,
    SMSG_MOVE_SET_HOVERING                            = 0x0000,
    SMSG_MOVE_SET_LAND_WALK                           = 0x0000,
    SMSG_MOVE_SET_NORMAL_FALL                         = 0x0000,
    ...
    SMSG_MOVE_SET_WATER_WALK                          = 0x0000,
    SMSG_MOVE_SKIP_TIME                               = 0x0000,
    SMSG_MOVE_SPLINE_DISABLE_COLLISION                = 0x0000,
    SMSG_MOVE_SPLINE_DISABLE_GRAVITY                  = 0x0000,
    SMSG_MOVE_SPLINE_ENABLE_COLLISION                 = 0x0000,
    SMSG_MOVE_SPLINE_ENABLE_GRAVITY                   = 0x0000,
    SMSG_MOVE_SPLINE_ROOT                             = 0x0000,
    SMSG_MOVE_SPLINE_SET_FEATHER_FALL                 = 0x0000,
    SMSG_MOVE_SPLINE_SET_FLIGHT_BACK_SPEED            = 0x0000,
    SMSG_MOVE_SPLINE_SET_FLIGHT_SPEED                 = 0x0000,
    SMSG_MOVE_SPLINE_SET_FLYING                       = 0x0000,
    SMSG_MOVE_SPLINE_SET_HOVER                        = 0x0000,
    SMSG_MOVE_SPLINE_SET_LAND_WALK                    = 0x0000,
    SMSG_MOVE_SPLINE_SET_NORMAL_FALL                  = 0x0000,
    SMSG_MOVE_SPLINE_SET_PITCH_RATE                   = 0x0000,
    SMSG_MOVE_SPLINE_SET_RUN_BACK_SPEED               = 0x0000,
    SMSG_MOVE_SPLINE_SET_RUN_MODE                     = 0x0000,
    SMSG_MOVE_SPLINE_SET_RUN_SPEED                    = 0x0000,
    SMSG_MOVE_SPLINE_SET_SWIM_BACK_SPEED              = 0x0000,
    SMSG_MOVE_SPLINE_SET_SWIM_SPEED                   = 0x0000,
    SMSG_MOVE_SPLINE_SET_TURN_RATE                    = 0x0000,
    SMSG_MOVE_SPLINE_SET_WALK_MODE                    = 0x0000,
    SMSG_MOVE_SPLINE_SET_WALK_SPEED                   = 0x0000,
    SMSG_MOVE_SPLINE_SET_WATER_WALK                   = 0x0000,
    SMSG_MOVE_SPLINE_START_SWIM                       = 0x0000,
    SMSG_MOVE_SPLINE_STOP_SWIM                        = 0x0000,
    SMSG_MOVE_SPLINE_UNROOT                           = 0x0000,
    SMSG_MOVE_SPLINE_UNSET_FLYING                     = 0x0000,
    SMSG_MOVE_SPLINE_UNSET_HOVER                      = 0x0000,
    SMSG_MOVE_TELEPORT                                = 0x0000,
    SMSG_MOVE_UNROOT                                  = 0x0000,
    SMSG_MOVE_UNSET_CAN_FLY                           = 0x0000,
    SMSG_MOVE_UNSET_HOVERING                          = 0x0000,
    ...
    SMSG_SET_FLAT_SPELL_MODIFIER                      = 0x0224,
