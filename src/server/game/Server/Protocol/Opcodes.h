...
enum Opcodes
{
    ...
    SMSG_SPLINE_MOVE_DISABLE_COLLISION               = 0xE04E,
    SMSG_SPLINE_MOVE_ENABLE_COLLISION                = 0x227C,
    SMSG_SPLINE_MOVE_GRAVITY_DISABLE                 = 0xF04C,
    SMSG_SPLINE_MOVE_GRAVITY_ENABLE                  = 0xA4DE,
    SMSG_SPLINE_MOVE_ROOT                            = 0x265C,
    SMSG_SPLINE_MOVE_SET_FEATHER_FALL                = 0xB6CC,
    SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED           = 0x70EC,
    SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED                = 0x644C,
    SMSG_SPLINE_MOVE_SET_FLYING                      = 0x70DC,
    SMSG_SPLINE_MOVE_SET_HOVER                       = 0x667E,
    SMSG_SPLINE_MOVE_SET_LAND_WALK                   = 0xA65E,
    SMSG_SPLINE_MOVE_SET_NORMAL_FALL                 = 0xE2FC,
    SMSG_SPLINE_MOVE_SET_PITCH_RATE                  = 0x60CE,
    SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED              = 0x624E,
    SMSG_SPLINE_MOVE_SET_RUN_MODE                    = 0x26CC,
    SMSG_SPLINE_MOVE_SET_RUN_SPEED                   = 0xB2CE, // for others
    SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED             = 0x326C,
    SMSG_SPLINE_MOVE_SET_SWIM_SPEED                  = 0x327E,
    SMSG_SPLINE_MOVE_SET_TURN_RATE                   = 0x745C,
    SMSG_SPLINE_MOVE_SET_WALK_MODE                   = 0xF65C,
    SMSG_SPLINE_MOVE_SET_WALK_SPEED                  = 0x0000, // exists, but not yet known
    SMSG_SPLINE_MOVE_SET_WATER_WALK                  = 0xA24E,
    SMSG_SPLINE_MOVE_START_SWIM                      = 0xF0FC,
    SMSG_SPLINE_MOVE_STOP_SWIM                       = 0x66EE,
    SMSG_SPLINE_MOVE_UNROOT                          = 0x64EE,
    SMSG_SPLINE_MOVE_UNSET_FLYING                    = 0xB06E,
    SMSG_SPLINE_MOVE_UNSET_HOVER                     = 0xA07E,
