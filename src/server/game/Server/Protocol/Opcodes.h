...
enum OpcodeClient : uint32
{
    ...
    CMSG_MESSAGECHAT_AFK                              = 0xBADD,
    CMSG_MESSAGECHAT_CHANNEL                          = 0xBADD,
    CMSG_MESSAGECHAT_DND                              = 0xBADD,
    CMSG_MESSAGECHAT_EMOTE                            = 0xBADD,
    CMSG_MESSAGECHAT_GUILD                            = 0xBADD,
    ...
    CMSG_MESSAGECHAT_SAY                              = 0xBADD,
    CMSG_MESSAGECHAT_WHISPER                          = 0xBADD,
    CMSG_MESSAGECHAT_YELL                             = 0xBADD,
    ...
    CMSG_PLAYER_TIME_ADJUSTMENT_RESPONSE              = 0xBADD,
