...
{
    CMSG_ACCEPT_GUILD_INVITE                          = 0x35F9,
    CMSG_ACCEPT_LEVEL_GRANT                           = 0x34F1,
    ...
    CMSG_ADD_TOY                                      = 0x3275,
    CMSG_ADVENTURE_JOURNAL_OPEN_QUEST                 = 0x31E9,
    CMSG_ADVENTURE_JOURNAL_START_QUEST                = 0x331D,
    CMSG_ALTER_APPEARANCE                             = 0x34ED,
    CMSG_AREA_SPIRIT_HEALER_QUERY                     = 0x34B3,
    CMSG_AREA_SPIRIT_HEALER_QUEUE                     = 0x34B4,
    CMSG_AREA_TRIGGER                                 = 0x31BF,
    CMSG_ARTIFACT_ADD_POWER                           = 0x31A3,
    CMSG_ARTIFACT_SET_APPEARANCE                      = 0x31A5,
    CMSG_ATTACK_STOP                                  = 0x3239,
    CMSG_ATTACK_SWING                                 = 0x3238,
    CMSG_AUCTION_HELLO_REQUEST                        = 0x34C3,
    CMSG_AUCTION_LIST_BIDDER_ITEMS                    = 0x34C9,
    CMSG_AUCTION_LIST_ITEMS                           = 0x34C6,
    CMSG_AUCTION_LIST_OWNER_ITEMS                     = 0x34C8,
    CMSG_AUCTION_LIST_PENDING_SALES                   = 0x34CB,
    CMSG_AUCTION_PLACE_BID                            = 0x34CA,
    CMSG_AUCTION_REMOVE_ITEM                          = 0x34C5,
    CMSG_AUCTION_REPLICATE_ITEMS                      = 0x34C7,
    CMSG_AUCTION_SELL_ITEM                            = 0x34C4,
    ...
    CMSG_BATTLEFIELD_PORT                             = 0x351A,
    CMSG_BATTLEMASTER_HELLO                           = 0x328A,
    CMSG_BATTLEMASTER_JOIN                            = 0x3517,
    CMSG_BATTLEMASTER_JOIN_ARENA                      = 0x3518,
    CMSG_BATTLEMASTER_JOIN_SKIRMISH                   = 0x3519,
    ...
    CMSG_BATTLE_PAY_GET_PRODUCT_LIST                  = 0x36BF,
    CMSG_BATTLE_PAY_GET_PURCHASE_LIST                 = 0x36C0,
    ...
    CMSG_BATTLE_PET_UPDATE_NOTIFY                     = 0x31C8,
    CMSG_BEGIN_TRADE                                  = 0x3157,
    CMSG_BINDER_ACTIVATE                              = 0x34B5,
    CMSG_BLACK_MARKET_BID_ON_ITEM                     = 0x3521,
    CMSG_BLACK_MARKET_OPEN                            = 0x351F,
    CMSG_BLACK_MARKET_REQUEST_ITEMS                   = 0x3520,
    CMSG_BUG_REPORT                                   = 0x368A,
    ...
    CMSG_CANCEL_AUTO_REPEAT_SPELL                     = 0x34DF,
    CMSG_CANCEL_CAST                                  = 0x327A,
    CMSG_CANCEL_CHANNELLING                           = 0x3248,
    CMSG_CANCEL_GROWTH_AURA                           = 0x324D,
    CMSG_CANCEL_MASTER_LOOT_ROLL                      = 0x31F7,
    CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS            = 0x31A6,
    CMSG_CANCEL_MOUNT_AURA                            = 0x325E,
    ...
    CMSG_CHANGE_BAG_SLOT_FLAG                         = 0x32FF,
    CMSG_CHANGE_MONUMENT_APPEARANCE                   = 0x32DF,
    ...
    CMSG_CHOICE_RESPONSE                              = 0x327C,
    CMSG_CLEAR_RAID_MARKER                            = 0x319F,
    CMSG_CLEAR_TRADE_ITEM                             = 0x315E,
    CMSG_CLIENT_PORT_GRAVEYARD                        = 0x351C,
    CMSG_CLOSE_INTERACTION                            = 0x3492,
    CMSG_COMMENTATOR_ENABLE                           = 0x35EE,
    CMSG_COMMENTATOR_ENTER_INSTANCE                   = 0x35F1,
    CMSG_COMMENTATOR_EXIT_INSTANCE                    = 0x35F2,
    ...
    CMSG_FAR_SIGHT                                    = 0x34E0,
    CMSG_GAME_OBJ_REPORT_USE                          = 0x34E7,
    CMSG_GAME_OBJ_USE                                 = 0x34E6,
    CMSG_GARRISON_ASSIGN_FOLLOWER_TO_BUILDING         = 0x32B6,
    CMSG_GARRISON_CANCEL_CONSTRUCTION                 = 0x32A7,
    CMSG_GARRISON_CHECK_UPGRADEABLE                   = 0x32FB,
    CMSG_GARRISON_COMPLETE_MISSION                    = 0x32EC,
    CMSG_GARRISON_GENERATE_RECRUITS                   = 0x32B9,
    CMSG_GARRISON_GET_BUILDING_LANDMARKS              = 0x32C7,
    CMSG_GARRISON_GET_MISSION_REWARD                  = 0x3323,
    CMSG_GARRISON_MISSION_BONUS_ROLL                  = 0x32EE,
    CMSG_GARRISON_PURCHASE_BUILDING                   = 0x32A3,
    CMSG_GARRISON_RECRUIT_FOLLOWER                    = 0x32BB,
    CMSG_GARRISON_REMOVE_FOLLOWER                     = 0x32E3,
    CMSG_GARRISON_REMOVE_FOLLOWER_FROM_BUILDING       = 0x32B7,
    CMSG_GARRISON_RENAME_FOLLOWER                     = 0x32B8,
    CMSG_GARRISON_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA = 0x32A2,
    CMSG_GARRISON_REQUEST_CLASS_SPEC_CATEGORY_INFO    = 0x32C0,
    CMSG_GARRISON_REQUEST_LANDING_PAGE_SHIPMENT_INFO  = 0x32CA,
    CMSG_GARRISON_REQUEST_SHIPMENT_INFO               = 0x32C9,
    CMSG_GARRISON_RESEARCH_TALENT                     = 0x32BC,
    CMSG_GARRISON_SET_BUILDING_ACTIVE                 = 0x32A4,
    CMSG_GARRISON_SET_FOLLOWER_FAVORITE               = 0x32B4,
    CMSG_GARRISON_SET_FOLLOWER_INACTIVE               = 0x32B0,
    CMSG_GARRISON_SET_RECRUITMENT_PREFERENCES         = 0x32BA,
    CMSG_GARRISON_START_MISSION                       = 0x32EB,
    CMSG_GARRISON_SWAP_BUILDINGS                      = 0x32A8,
    CMSG_GENERATE_RANDOM_CHARACTER_NAME               = 0x35E5,
    CMSG_GET_CHALLENGE_MODE_REWARDS                   = 0x3686,
    CMSG_GET_GARRISON_INFO                            = 0x329D,
    CMSG_GET_ITEM_PURCHASE_DATA                       = 0x3523,
    CMSG_GET_MIRROR_IMAGE_DATA                        = 0x3273,
    CMSG_GET_PVP_OPTIONS_ENABLED                      = 0x35EC,
    CMSG_GET_REMAINING_GAME_TIME                      = 0x36EF,
    CMSG_GET_TROPHY_LIST                              = 0x32DC,
    ...
    CMSG_GUILD_BANK_BUY_TAB                           = 0x34BC,
    CMSG_GUILD_BANK_DEPOSIT_MONEY                     = 0x34BE,
    CMSG_GUILD_BANK_LOG_QUERY                         = 0x3082,
    CMSG_GUILD_BANK_QUERY_TAB                         = 0x34BB,
    ...
    CMSG_GUILD_BANK_UPDATE_TAB                        = 0x34BD,
    CMSG_GUILD_BANK_WITHDRAW_MONEY                    = 0x34BF,
    ...
    CMSG_GUILD_INVITE_BY_NAME                         = 0x3603,
    ...
    CMSG_HEARTH_AND_RESURRECT                         = 0x3500,
    CMSG_IGNORE_TRADE                                 = 0x3159,
    CMSG_INITIATE_ROLE_POLL                           = 0x35DA,
    CMSG_INITIATE_TRADE                               = 0x3156,
    CMSG_INSPECT                                      = 0x351E,
    CMSG_INSPECT_PVP                                  = 0x36A5,
    CMSG_INSTANCE_LOCK_RESPONSE                       = 0x3505,
    CMSG_ITEM_PURCHASE_REFUND                         = 0x3524,
    CMSG_ITEM_TEXT_QUERY                              = 0x32FC,
    CMSG_JOIN_PET_BATTLE_QUEUE                        = 0x31C6,
    CMSG_JOIN_RATED_BATTLEGROUND                      = 0x3175,
    CMSG_KEEP_ALIVE                                   = 0x3682,
    CMSG_KEYBOUND_OVERRIDE                            = 0x3208,
    CMSG_LEARN_PVP_TALENTS                            = 0x3547,
    CMSG_LEARN_TALENTS                                = 0x3546,
    CMSG_LEAVE_GROUP                                  = 0x3649,
    CMSG_LEAVE_PET_BATTLE_QUEUE                       = 0x31C7,
    ...
    CMSG_LFG_LIST_JOIN                                = 0x3606,
    CMSG_LFG_LIST_LEAVE                               = 0x3608,
    CMSG_LFG_LIST_SEARCH                              = 0x360A,
    CMSG_LFG_LIST_UPDATE_REQUEST                      = 0x3607,
    ...
    CMSG_LOAD_SELECTED_TROPHY                         = 0x32DD,
    CMSG_LOGOUT_CANCEL                                = 0x34D0,
    CMSG_LOGOUT_INSTANT                               = 0x34D1,
    CMSG_LOGOUT_REQUEST                               = 0x34CF,
    CMSG_LOG_DISCONNECT                               = 0x3769,
    CMSG_LOG_STREAMING_ERROR                          = 0x376D,
    CMSG_LOOT_ITEM                                    = 0x31F4,
    CMSG_LOOT_MONEY                                   = 0x31F3,
    CMSG_LOOT_RELEASE                                 = 0x31F8,
    CMSG_LOOT_ROLL                                    = 0x31F9,
    CMSG_LOOT_UNIT                                    = 0x31F2,
    CMSG_LOW_LEVEL_RAID1                              = 0x36A3,
    CMSG_LOW_LEVEL_RAID2                              = 0x350B,
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x352F,
    CMSG_MAIL_DELETE                                  = 0x320A,
    CMSG_MAIL_GET_LIST                                = 0x352A,
    CMSG_MAIL_MARK_AS_READ                            = 0x352E,
    CMSG_MAIL_RETURN_TO_SENDER                        = 0x3658,
    CMSG_MAIL_TAKE_ITEM                               = 0x352C,
    CMSG_MAIL_TAKE_MONEY                              = 0x352B,
    CMSG_MASTER_LOOT_ITEM                             = 0x31F5,
    ...
    CMSG_MOUNT_SPECIAL_ANIM                           = 0x325F,
    ...
    CMSG_NEUTRAL_PLAYER_SELECT_FACTION                = 0x31BC,
    CMSG_NEXT_CINEMATIC_CAMERA                        = 0x3538,
    CMSG_OBJECT_UPDATE_FAILED                         = 0x317E,
    CMSG_OBJECT_UPDATE_RESCUED                        = 0x317F,
    CMSG_OFFER_PETITION                               = 0x36B3,
    CMSG_OPENING_CINEMATIC                            = 0x3537,
    CMSG_OPEN_ITEM                                    = 0x32FD,
    CMSG_OPEN_MISSION_NPC                             = 0x32C2,
    CMSG_OPEN_SHIPMENT_NPC                            = 0x32C8,
    CMSG_OPEN_TRADESKILL_NPC                          = 0x32D3,
    CMSG_OPT_OUT_OF_LOOT                              = 0x34EE,
    CMSG_PARTY_INVITE                                 = 0x35FF,
    CMSG_PARTY_INVITE_RESPONSE                        = 0x3600,
    CMSG_PARTY_UNINVITE                               = 0x3647,
    CMSG_PETITION_BUY                                 = 0x34C1,
    CMSG_PETITION_RENAME_GUILD                        = 0x36C9,
    CMSG_PETITION_SHOW_LIST                           = 0x34C0,
    CMSG_PETITION_SHOW_SIGNATURES                     = 0x34C2,
    CMSG_PET_ABANDON                                  = 0x348C,
    CMSG_PET_ACTION                                   = 0x348A,
    CMSG_PET_BATTLE_FINAL_NOTIFY                      = 0x31CA,
    CMSG_PET_BATTLE_INPUT                             = 0x3640,
    CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT        = 0x3209,
    CMSG_PET_BATTLE_QUIT_NOTIFY                       = 0x31C9,
    CMSG_PET_BATTLE_REPLACE_FRONT_PET                 = 0x3641,
    CMSG_PET_BATTLE_REQUEST_PVP                       = 0x31C4,
    CMSG_PET_BATTLE_REQUEST_UPDATE                    = 0x31C5,
    CMSG_PET_BATTLE_REQUEST_WILD                      = 0x31C2,
    CMSG_PET_BATTLE_SCRIPT_ERROR_NOTIFY               = 0x31CB,
    CMSG_PET_BATTLE_WILD_LOCATION_FAIL                = 0x31C3,
    CMSG_PET_CANCEL_AURA                              = 0x348D,
    CMSG_PET_CAST_SPELL                               = 0x3277,
    CMSG_PET_RENAME                                   = 0x3689,
    ...
    CMSG_PVP_PRESTIGE_RANK_UP                         = 0x3321,
    CMSG_QUERY_BATTLE_PET_NAME                        = 0x3254,
    CMSG_QUERY_CORPSE_LOCATION_FROM_CLIENT            = 0x3663,
    CMSG_QUERY_CORPSE_TRANSPORT                       = 0x3664,
    CMSG_QUERY_COUNTDOWN_TIMER                        = 0x31A2,
    CMSG_QUERY_CREATURE                               = 0x324E,
    CMSG_QUERY_GAME_OBJECT                            = 0x324F,
    CMSG_QUERY_GARRISON_CREATURE_NAME                 = 0x3255,
    CMSG_QUERY_GUILD_INFO                             = 0x3691,
    CMSG_QUERY_INSPECT_ACHIEVEMENTS                   = 0x34FA,
    CMSG_QUERY_NEXT_MAIL_TIME                         = 0x352D,
    CMSG_QUERY_NPC_TEXT                               = 0x3250,
    CMSG_QUERY_PAGE_TEXT                              = 0x3252,
    CMSG_QUERY_PETITION                               = 0x3256,
    CMSG_QUERY_PET_NAME                               = 0x3253,
    CMSG_QUERY_PLAYER_NAME                            = 0x368F,
    CMSG_QUERY_QUEST_COMPLETION_NPCS                  = 0x3172,
    CMSG_QUERY_QUEST_INFO                             = 0x3251,
    CMSG_QUERY_QUEST_REWARDS                          = 0x3325,
    CMSG_QUERY_REALM_NAME                             = 0x3690,
    CMSG_QUERY_SCENARIO_POI                           = 0x3659,
    CMSG_QUERY_TIME                                   = 0x34CE,
    ...
    CMSG_QUEST_GIVER_COMPLETE_QUEST                   = 0x349B,
    CMSG_QUEST_GIVER_HELLO                            = 0x3495,
    CMSG_QUEST_GIVER_IGNORE_QUEST                     = 0x3499,
    ...
    CMSG_QUEST_GIVER_UNIGNORE_QUEST                   = 0x349A,
    CMSG_QUEST_LOG_REMOVE_QUEST                       = 0x3522,
    ...
    CMSG_READ_ITEM                                    = 0x32FE,
    CMSG_RECLAIM_CORPSE                               = 0x34D3,
    ...
    CMSG_REPAIR_ITEM                                  = 0x34E4,
    CMSG_REPLACE_TROPHY                               = 0x32DE,
    CMSG_REPOP_REQUEST                                = 0x351B,
    CMSG_REPORT_PVP_PLAYER_AFK                        = 0x34EC,
    ...
    CMSG_REQUEST_CONQUEST_FORMULA_CONSTANTS           = 0x328D,
    ...
    CMSG_REQUEST_LFG_LIST_BLACKLIST                   = 0x327E,
    CMSG_REQUEST_PARTY_JOIN_UPDATES                   = 0x35F4,
    CMSG_REQUEST_PARTY_MEMBER_STATS                   = 0x3653,
    CMSG_REQUEST_PET_INFO                             = 0x348F,
    CMSG_REQUEST_PLAYED_TIME                          = 0x3259,
    ...
    CMSG_SAVE_EQUIPMENT_SET                           = 0x3503,
    CMSG_SAVE_GUILD_EMBLEM                            = 0x3282,
    CMSG_SCENE_PLAYBACK_CANCELED                      = 0x3205,
    CMSG_SCENE_PLAYBACK_COMPLETE                      = 0x3204,
    CMSG_SCENE_TRIGGER_EVENT                          = 0x3206,
    CMSG_SELF_RES                                     = 0x3525,
    ...
    CMSG_SET_ACHIEVEMENTS_HIDDEN                      = 0x320B,
    CMSG_SET_ACTION_BAR_TOGGLES                       = 0x3526,
    CMSG_SET_ACTION_BUTTON                            = 0x3635,
    CMSG_SET_ACTIVE_MOVER                             = 0x3A37,
    CMSG_SET_ACTIVE_VOICE_CHANNEL                     = 0x3655,
    CMSG_SET_ADVANCED_COMBAT_LOGGING                  = 0x328E,
    CMSG_SET_ASSISTANT_LEADER                         = 0x364F,
    CMSG_SET_BACKPACK_AUTOSORT_DISABLED               = 0x3301,
    CMSG_SET_BANK_AUTOSORT_DISABLED                   = 0x3302,
    CMSG_SET_BANK_BAG_SLOT_FLAG                       = 0x3300,
    CMSG_SET_CONTACT_NOTES                            = 0x36D4,
    CMSG_SET_CURRENCY_FLAGS                           = 0x3169,
    CMSG_SET_DIFFICULTY_ID                            = 0x3207,
    CMSG_SET_DUNGEON_DIFFICULTY                       = 0x3685,
    CMSG_SET_EVERYONE_IS_ASSISTANT                    = 0x3616,
    CMSG_SET_FACTION_AT_WAR                           = 0x34D6,
    CMSG_SET_FACTION_INACTIVE                         = 0x34D8,
    CMSG_SET_FACTION_NOT_AT_WAR                       = 0x34D7,
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT               = 0x3304,
    CMSG_SET_LFG_BONUS_FACTION_ID                     = 0x327D,
    CMSG_SET_LOOT_METHOD                              = 0x3648,
    CMSG_SET_LOOT_SPECIALIZATION                      = 0x3533,
    CMSG_SET_PARTY_ASSIGNMENT                         = 0x3651,
    CMSG_SET_PARTY_LEADER                             = 0x364A,
    CMSG_SET_PET_SLOT                                 = 0x3168,
    CMSG_SET_PLAYER_DECLINED_NAMES                    = 0x368E,
    CMSG_SET_PREFERRED_CEMETERY                       = 0x3174,
    CMSG_SET_PVP                                      = 0x3286,
    CMSG_SET_RAID_DIFFICULTY                          = 0x36DE,
    CMSG_SET_ROLE                                     = 0x35D9,
    CMSG_SET_SAVED_INSTANCE_EXTEND                    = 0x368C,
    CMSG_SET_SELECTION                                = 0x351D,
    CMSG_SET_SHEATHED                                 = 0x3487,
    CMSG_SET_SORT_BAGS_RIGHT_TO_LEFT                  = 0x3303,
    CMSG_SET_TAXI_BENCHMARK_MODE                      = 0x34EB,
    CMSG_SET_TITLE                                    = 0x325D,
    CMSG_SET_TRADE_CURRENCY                           = 0x3160,
    CMSG_SET_TRADE_GOLD                               = 0x315F,
    CMSG_SET_TRADE_ITEM                               = 0x315D,
    CMSG_SET_USING_PARTY_GARRISON                     = 0x32C4,
    CMSG_SET_WATCHED_FACTION                          = 0x34D9,
    CMSG_SHOW_TRADE_SKILL                             = 0x36C3,
    CMSG_SIGN_PETITION                                = 0x3527,
    CMSG_SILENCE_PARTY_TALKER                         = 0x3652,
    CMSG_SOCKET_GEMS                                  = 0x34E3,
    CMSG_SORT_BAGS                                    = 0x3305,
    CMSG_SORT_BANK_BAGS                               = 0x3306,
    CMSG_SORT_REAGENT_BANK_BAGS                       = 0x3307,
    CMSG_SPELL_CLICK                                  = 0x3494,
    CMSG_SPIRIT_HEALER_ACTIVATE                       = 0x34B2,
    CMSG_SPLIT_ITEM                                   = 0x399E,
    CMSG_STAND_STATE_CHANGE                           = 0x3187,
    CMSG_START_CHALLENGE_MODE                         = 0x353E,
    ...
    CMSG_TABARD_VENDOR_ACTIVATE                       = 0x3283,
    ...
    CMSG_TOGGLE_PVP                                   = 0x3285,
    CMSG_TOTEM_DESTROYED                              = 0x34F2,
    CMSG_TOY_SET_FAVORITE                             = 0x3631,
    CMSG_TRADE_SKILL_SET_FAVORITE                     = 0x3324,
...
enum OpcodeServer : uint32
{
    ...
    SMSG_ACHIEVEMENT_DELETED                          = 0x2719,
    ...
    SMSG_ADD_RUNE_POWER                               = 0x26DD,
    SMSG_ADJUST_SPLINE_DURATION                       = 0x25E4,
    SMSG_AE_LOOT_TARGETS                              = 0x2627,
    SMSG_AE_LOOT_TARGET_ACK                           = 0x2628,
    SMSG_AI_REACTION                                  = 0x26DA,
    ...
    SMSG_ARTIFACT_RESPEC_CONFIRM                      = 0x27E1,
    SMSG_ARTIFACT_XP_GAIN                             = 0x2821,
    SMSG_ATTACKER_STATE_UPDATE                        = 0x27CB,
    SMSG_ATTACK_START                                 = 0x2668,
    SMSG_ATTACK_STOP                                  = 0x2669,
    SMSG_ATTACK_SWING_ERROR                           = 0x272E,
    SMSG_ATTACK_SWING_LANDED_LOG                      = 0x272F,
    SMSG_AUCTION_CLOSED_NOTIFICATION                  = 0x2723,
    SMSG_AUCTION_COMMAND_RESULT                       = 0x2720,
    SMSG_AUCTION_HELLO_RESPONSE                       = 0x271E,
    SMSG_AUCTION_LIST_BIDDER_ITEMS_RESULT             = 0x2727,
    SMSG_AUCTION_LIST_ITEMS_RESULT                    = 0x2725,
    SMSG_AUCTION_LIST_OWNER_ITEMS_RESULT              = 0x2726,
    SMSG_AUCTION_LIST_PENDING_SALES_RESULT            = 0x2728,
    SMSG_AUCTION_OUTBID_NOTIFICATION                  = 0x2722,
    SMSG_AUCTION_OWNER_BID_NOTIFICATION               = 0x2724,
    SMSG_AUCTION_REPLICATE_RESPONSE                   = 0x271F,
    SMSG_AUCTION_WON_NOTIFICATION                     = 0x2721,
    ...
    SMSG_BARBER_SHOP_RESULT                           = 0x26E3,
    ...
    SMSG_BATTLEGROUND_INIT                            = 0x279B,
    SMSG_BATTLEGROUND_PLAYER_JOINED                   = 0x2598,
    SMSG_BATTLEGROUND_PLAYER_LEFT                     = 0x2599,
    SMSG_BATTLEGROUND_PLAYER_POSITIONS                = 0x2595,
    SMSG_BATTLEGROUND_POINTS                          = 0x279A,
    SMSG_BATTLENET_CHALLENGE_ABORT                    = 0x27CA,
    SMSG_BATTLENET_CHALLENGE_START                    = 0x27C9,
    SMSG_BATTLENET_NOTIFICATION                       = 0x2836,
    SMSG_BATTLENET_REALM_LIST_TICKET                  = 0x2838,
    SMSG_BATTLENET_RESPONSE                           = 0x2835,
    SMSG_BATTLENET_SET_SESSION_STATE                  = 0x2837,
    SMSG_BATTLE_PAY_ACK_FAILED                        = 0x27C2,
    SMSG_BATTLE_PAY_CONFIRM_PURCHASE                  = 0x27C1,
    SMSG_BATTLE_PAY_DELIVERY_ENDED                    = 0x27B5,
    SMSG_BATTLE_PAY_DELIVERY_STARTED                  = 0x27B4,
    SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE               = 0x27B3,
    SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE    = 0x27B1,
    SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE         = 0x27AF,
    SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE        = 0x27B0,
    ...
    SMSG_BATTLE_PAY_VAS_BOOST_CONSUMED                = 0x27B2,
    SMSG_BATTLE_PAY_VAS_CHARACTER_LIST                = 0x2825,
    SMSG_BATTLE_PAY_VAS_PURCHASE_COMPLETE             = 0x2828,
    SMSG_BATTLE_PAY_VAS_PURCHASE_LIST                 = 0x2829,
    SMSG_BATTLE_PAY_VAS_PURCHASE_STARTED              = 0x2827,
    SMSG_BATTLE_PETS_HEALED                           = 0x2605,
    SMSG_BATTLE_PET_CAGE_DATE_ERROR                   = 0x269B,
    SMSG_BATTLE_PET_DELETED                           = 0x2602,
    SMSG_BATTLE_PET_ERROR                             = 0x2650,
    SMSG_BATTLE_PET_JOURNAL                           = 0x2601,
    SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED             = 0x25FF,
    SMSG_BATTLE_PET_JOURNAL_LOCK_DENIED               = 0x2600,
    SMSG_BATTLE_PET_LICENSE_CHANGED                   = 0x2606,
    SMSG_BATTLE_PET_MAX_COUNT_CHANGED                 = 0x25FD,
    SMSG_BATTLE_PET_RESTORED                          = 0x2604,
    SMSG_BATTLE_PET_REVOKED                           = 0x2603,
    SMSG_BATTLE_PET_TRAP_LEVEL                        = 0x25FC,
    SMSG_BATTLE_PET_UPDATES                           = 0x25FB,
    SMSG_BINDER_CONFIRM                               = 0x2734,
    ...
    SMSG_BUY_FAILED                                   = 0x26EC,
    SMSG_BUY_SUCCEEDED                                = 0x26EB,
    SMSG_CACHE_INFO                                   = 0x273E,
    SMSG_CACHE_VERSION                                = 0x273D,
    ...
    SMSG_CANCEL_AUTO_REPEAT                           = 0x270D,
    SMSG_CANCEL_COMBAT                                = 0x272C,
    ...
    SMSG_CHALLENGE_MODE_ALL_MAP_STATS                 = 0x261D,
    SMSG_CHALLENGE_MODE_COMPLETE                      = 0x261B,
    SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE              = 0x261E,
    SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD             = 0x2620,
    SMSG_CHALLENGE_MODE_REQUEST_LEADERS_RESULT        = 0x261F,
    SMSG_CHALLENGE_MODE_RESET                         = 0x261A,
    SMSG_CHALLENGE_MODE_REWARDS                       = 0x261C,
    SMSG_CHALLENGE_MODE_START                         = 0x2619,
    SMSG_CHANGE_PLAYER_DIFFICULTY_RESULT              = 0x2730,
    SMSG_CHANNEL_LIST                                 = 0x2BC8,
    SMSG_CHANNEL_NOTIFY                               = 0x2BC5,
    SMSG_CHANNEL_NOTIFY_JOINED                        = 0x2BC6,
    SMSG_CHANNEL_NOTIFY_LEFT                          = 0x2BC7,
    SMSG_CHARACTER_CLASS_TRIAL_CREATE                 = 0x27FA,
    SMSG_CHARACTER_ITEM_FIXUP                         = 0x2846,
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x273F,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x27C8,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x27A1,
    SMSG_CHARACTER_UPGRADE_COMPLETE                   = 0x27F9,
    SMSG_CHARACTER_UPGRADE_QUEUED                     = 0x27F8,
    SMSG_CHARACTER_UPGRADE_SPELL_TIER_SET             = 0x25F0,
    SMSG_CHARACTER_UPGRADE_STARTED                    = 0x27F7,
    SMSG_CHAR_CUSTOMIZE                               = 0x2714,
    SMSG_CHAR_CUSTOMIZE_FAILED                        = 0x2713,
    ...
    SMSG_CONSUMPTION_CONVERSION_INFO_RESPONSE         = 0x283B,
    SMSG_CONSUMPTION_CONVERSION_RESULT                = 0x283C,
    SMSG_CONTACT_LIST                                 = 0x27C6,
    SMSG_CONTROL_UPDATE                               = 0x265F,
    SMSG_COOLDOWN_CHEAT                               = 0x2776,
    SMSG_COOLDOWN_EVENT                               = 0x26DE,
    SMSG_CORPSE_LOCATION                              = 0x2666,
    SMSG_CORPSE_RECLAIM_DELAY                         = 0x2789,
    SMSG_CORPSE_TRANSPORT_QUERY                       = 0x274C,
    SMSG_CREATE_CHAR                                  = 0x2739,
    SMSG_CREATE_SHIPMENT_RESPONSE                     = 0x27D9,
    SMSG_CRITERIA_DELETED                             = 0x2718,
    SMSG_CRITERIA_UPDATE                              = 0x2712,
    SMSG_CROSSED_INEBRIATION_THRESHOLD                = 0x26E7,
    SMSG_CUSTOM_LOAD_SCREEN                           = 0x25DF,
    SMSG_DAILY_QUESTS_RESET                           = 0x2A80,
    SMSG_DAMAGE_CALC_LOG                              = 0x2801,
    SMSG_DANCE_STUDIO_CREATE_RESULT                   = 0x279E,
    SMSG_DB_REPLY                                     = 0x25A0,
    SMSG_DEATH_RELEASE_LOC                            = 0x2700,
    SMSG_DEFENSE_MESSAGE                              = 0x2BBB,
    SMSG_DELETE_CHAR                                  = 0x273A,
    SMSG_DESTROY_ARENA_UNIT                           = 0x277F,
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0x272D,
    SMSG_DIFFERENT_INSTANCE_FROM_PARTY                = 0x258A,
    SMSG_DISENCHANT_CREDIT                            = 0x25BA,
    SMSG_DISMOUNT                                     = 0x26D5,
    ...
    SMSG_DISPLAY_TOAST                                = 0x2634,
    SMSG_DONT_AUTO_PUSH_SPELLS_TO_ACTION_BAR          = 0x25F2,
    ...
    SMSG_DURABILITY_DAMAGE_DEATH                      = 0x2785,
    SMSG_EMOTE                                        = 0x2802,
    SMSG_ENABLE_BARBER_SHOP                           = 0x26E2,
    ...
    SMSG_EQUIPMENT_SET_ID                             = 0x26D7,
    SMSG_EXPECTED_SPAM_RECORDS                        = 0x2BB1,
    SMSG_EXPLORATION_EXPERIENCE                       = 0x279D,
    ...
    SMSG_FEIGN_DEATH_RESISTED                         = 0x2782,
    SMSG_FISH_ESCAPED                                 = 0x26F4,
    SMSG_FISH_NOT_HOOKED                              = 0x26F3,
    SMSG_FLIGHT_SPLINE_SYNC                           = 0x2DF7,
    SMSG_FORCED_DEATH_UPDATE                          = 0x2701,
    SMSG_FORCE_ANIM                                   = 0x278F,
    ...
    SMSG_GAME_OBJECT_SET_STATE                        = 0x2834,
    ...
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT            = 0x279F,
    ...
    SMSG_GET_TROPHY_LIST_RESPONSE                     = 0x27FD,
    SMSG_GM_PLAYER_INFO                               = 0x2775,
    SMSG_GM_REQUEST_PLAYER_INFO                       = 0x25E9,
    SMSG_GM_TICKET_CASE_STATUS                        = 0x26C7,
    SMSG_GM_TICKET_SYSTEM_STATUS                      = 0x26C6,
    SMSG_GOD_MODE                                     = 0x2733,
    ...
    SMSG_GROUP_INVITE_CONFIRMATION                    = 0x2847,
    ...
    SMSG_INSTANCE_ENCOUNTER_END                       = 0x27F2,
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT               = 0x27E9,
    SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE = 0x27F4,
    SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION    = 0x27F3,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE        = 0x27EE,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START           = 0x27ED,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE          = 0x27F1,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED       = 0x27F5,
    SMSG_INSTANCE_ENCOUNTER_SET_SUPPRESSING_RELEASE   = 0x27F0,
    SMSG_INSTANCE_ENCOUNTER_START                     = 0x27EF,
    SMSG_INSTANCE_ENCOUNTER_TIMER_START               = 0x27EC,
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                  = 0x2731,
    SMSG_INSTANCE_INFO                                = 0x264B,
    SMSG_INSTANCE_RESET                               = 0x26AA,
    SMSG_INSTANCE_RESET_FAILED                        = 0x26AB,
    SMSG_INSTANCE_SAVE_CREATED                        = 0x27B9,
    SMSG_INVALIDATE_PAGE_TEXT                         = 0x26FC,
    SMSG_INVALIDATE_PLAYER                            = 0x26CD,
    SMSG_INVALID_PROMOTION_CODE                       = 0x2790,
    SMSG_INVENTORY_CHANGE_FAILURE                     = 0x275E,
    SMSG_IS_QUEST_COMPLETE_RESPONSE                   = 0x2A83,
    SMSG_ITEM_CHANGED                                 = 0x271B,
    SMSG_ITEM_COOLDOWN                                = 0x2800,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                     = 0x2792,
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x25AF,
    SMSG_ITEM_PURCHASE_REFUND_RESULT                  = 0x25AD,
    SMSG_ITEM_PUSH_RESULT                             = 0x2633,
    SMSG_ITEM_TIME_UPDATE                             = 0x2791,
    SMSG_KICK_REASON                                  = 0x2824,
    SMSG_LEARNED_SPELLS                               = 0x2C4D,
    SMSG_LEARN_PVP_TALENTS_FAILED                     = 0x25E6,
    SMSG_LEARN_TALENTS_FAILED                         = 0x25E5,
    SMSG_LEVEL_UPDATE                                 = 0x2587,
    SMSG_LEVEL_UP_INFO                                = 0x271A,
    ...
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT           = 0x27AD,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT            = 0x27AB,
    SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT = 0x27A0,
    SMSG_LOAD_CUF_PROFILES                            = 0x25CB,
    SMSG_LOAD_EQUIPMENT_SET                           = 0x2748,
    SMSG_LOAD_SELECTED_TROPHY_RESULT                  = 0x27FE,
    ...
    SMSG_LOG_XP_GAIN                                  = 0x2716,
    SMSG_LOOT_ALL_PASSED                              = 0x2631,
    SMSG_LOOT_ITEM_LIST                               = 0x262F,
    SMSG_LOOT_LIST                                    = 0x277E,
    SMSG_LOOT_MONEY_NOTIFY                            = 0x262B,
    SMSG_LOOT_RELEASE                                 = 0x262A,
    SMSG_LOOT_RELEASE_ALL                             = 0x2629,
    SMSG_LOOT_REMOVED                                 = 0x2624,
    SMSG_LOOT_RESPONSE                                = 0x2623,
    SMSG_LOOT_ROLL                                    = 0x262D,
    SMSG_LOOT_ROLLS_COMPLETE                          = 0x2630,
    SMSG_LOOT_ROLL_WON                                = 0x2632,
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                  = 0x2690,
    SMSG_MAIL_COMMAND_RESULT                          = 0x2653,
    SMSG_MAIL_LIST_RESULT                             = 0x2793,
    SMSG_MAIL_QUERY_NEXT_TIME_RESULT                  = 0x2794,
    SMSG_MAP_OBJECTIVES_INIT                          = 0x279C,
    SMSG_MAP_OBJ_EVENTS                               = 0x25D5,
    SMSG_MASTER_LOOT_CANDIDATE_LIST                   = 0x262E,
    SMSG_MESSAGE_BOX                                  = 0x2575,
    SMSG_MINIMAP_PING                                 = 0x26F2,
    SMSG_MIRROR_IMAGE_COMPONENTED_DATA                = 0x2C14,
    SMSG_MIRROR_IMAGE_CREATURE_DATA                   = 0x2C13,
    SMSG_MISSILE_CANCEL                               = 0x25D6,
    SMSG_MODIFY_CHARGE_RECOVERY_SPEED                 = 0x27A4,
    SMSG_MODIFY_COOLDOWN                              = 0x27A2,
    SMSG_MODIFY_COOLDOWN_RECOVERY_SPEED               = 0x27A3,
    SMSG_MODIFY_PARTY_RANGE                           = 0x2781,
    SMSG_MOTD                                         = 0x2BAF,
    ...
    SMSG_NEUTRAL_PLAYER_FACTION_SELECT_RESULT         = 0x25ED,
    SMSG_NEW_TAXI_PATH                                = 0x26A2,
    SMSG_NEW_WORLD                                    = 0x25A9,
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST                   = 0x2C43,
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION          = 0x26CC,
    SMSG_NOTIFY_MONEY                                 = 0x25AC,
    SMSG_NOTIFY_RECEIVED_MAIL                         = 0x2654,
    SMSG_OFFER_PETITION_ERROR                         = 0x26DB,
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA         = 0x2717,
    ...
    SMSG_OVERRIDE_LIGHT                               = 0x26E1,
    SMSG_PAGE_TEXT                                    = 0x2754,
    SMSG_PARTY_COMMAND_RESULT                         = 0x27D3,
    SMSG_PARTY_INVITE                                 = 0x25CC,
    SMSG_PARTY_KILL_LOG                               = 0x2798,
    SMSG_PARTY_MEMBER_STATE                           = 0x2796,
    SMSG_PARTY_MEMBER_STATE_UPDATE                    = 0x2795,
    SMSG_PARTY_UPDATE                                 = 0x2607,
    SMSG_PAUSE_MIRROR_TIMER                           = 0x274A,
    SMSG_PENDING_RAID_LOCK                            = 0x272B,
    SMSG_PETITION_ALREADY_SIGNED                      = 0x25B6,
    SMSG_PETITION_RENAME_GUILD_RESPONSE               = 0x29F7,
    SMSG_PETITION_SHOW_LIST                           = 0x26E4,
    SMSG_PETITION_SHOW_SIGNATURES                     = 0x26E5,
    SMSG_PETITION_SIGN_RESULTS                        = 0x278A,
    SMSG_PET_ACTION_FEEDBACK                          = 0x2788,
    SMSG_PET_ACTION_SOUND                             = 0x26C4,
    SMSG_PET_ADDED                                    = 0x25A6,
    SMSG_PET_BATTLE_CHAT_RESTRICTED                   = 0x2614,
    SMSG_PET_BATTLE_DEBUG_QUEUE_DUMP_RESPONSE         = 0x2697,
    SMSG_PET_BATTLE_FINALIZE_LOCATION                 = 0x260D,
    SMSG_PET_BATTLE_FINAL_ROUND                       = 0x2612,
    SMSG_PET_BATTLE_FINISHED                          = 0x2613,
    SMSG_PET_BATTLE_FIRST_ROUND                       = 0x260F,
    SMSG_PET_BATTLE_INITIAL_UPDATE                    = 0x260E,
    SMSG_PET_BATTLE_MAX_GAME_LENGTH_WARNING           = 0x2615,
    SMSG_PET_BATTLE_PVP_CHALLENGE                     = 0x260C,
    SMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH               = 0x2651,
    SMSG_PET_BATTLE_QUEUE_STATUS                      = 0x2652,
    SMSG_PET_BATTLE_REPLACEMENTS_MADE                 = 0x2611,
    SMSG_PET_BATTLE_REQUEST_FAILED                    = 0x260B,
    SMSG_PET_BATTLE_ROUND_RESULT                      = 0x2610,
    SMSG_PET_BATTLE_SLOT_UPDATES                      = 0x25FE,
    SMSG_PET_CAST_FAILED                              = 0x2C57,
    SMSG_PET_CLEAR_SPELLS                             = 0x2C24,
    SMSG_PET_DISMISS_SOUND                            = 0x26C5,
    SMSG_PET_GOD_MODE                                 = 0x269F,
    SMSG_PET_GUIDS                                    = 0x273C,
    SMSG_PET_LEARNED_SPELLS                           = 0x2C4F,
    SMSG_PET_MODE                                     = 0x2589,
    SMSG_PET_NAME_INVALID                             = 0x26E9,
    SMSG_PET_SLOT_UPDATED                             = 0x2588,
    SMSG_PET_SPELLS_MESSAGE                           = 0x2C25,
    SMSG_PET_STABLE_LIST                              = 0x25A7,
    SMSG_PET_STABLE_RESULT                            = 0x25A8,
    SMSG_PET_TAME_FAILURE                             = 0x26D8,
    SMSG_PET_UNLEARNED_SPELLS                         = 0x2C50,
    SMSG_PHASE_SHIFT_CHANGE                           = 0x2577,
    SMSG_PLAYED_TIME                                  = 0x2703,
    SMSG_PLAYER_BOUND                                 = 0x257D,
    SMSG_PLAYER_SAVE_GUILD_EMBLEM                     = 0x29F6,
    SMSG_PLAYER_SKINNED                               = 0x2783,
    SMSG_PLAYER_TABARD_VENDOR_ACTIVATE                = 0x2797,
    SMSG_PLAY_MUSIC                                   = 0x27A7,
    SMSG_PLAY_OBJECT_SOUND                            = 0x27A8,
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                       = 0x276D,
    SMSG_PLAY_ORPHAN_SPELL_VISUAL                     = 0x2C47,
    SMSG_PLAY_SCENE                                   = 0x264E,
    SMSG_PLAY_SOUND                                   = 0x27A6,
    SMSG_PLAY_SPEAKERBOT_SOUND                        = 0x27A9,
    SMSG_PLAY_SPELL_VISUAL                            = 0x2C45,
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x2C49,
    SMSG_PLAY_TIME_WARNING                            = 0x2735,
    SMSG_PONG                                         = 0x304E,
    SMSG_POWER_UPDATE                                 = 0x26F8,
    SMSG_PRESTIGE_AND_HONOR_INVOLUNTARILY_CHANGED     = 0x2753,
    SMSG_PRE_RESSURECT                                = 0x27A5,
    SMSG_PRINT_NOTIFICATION                           = 0x25DD,
    SMSG_PROC_RESIST                                  = 0x2799,
    SMSG_PROPOSE_LEVEL_GRANT                          = 0x270B,
    SMSG_PUSH_SPELL_TO_ACTION_BAR                     = 0x2C51,
    SMSG_PVP_CREDIT                                   = 0x2711,
    SMSG_PVP_LOG_DATA                                 = 0x25B1,
    SMSG_PVP_OPTIONS_ENABLED                          = 0x25B4,
    SMSG_PVP_SEASON                                   = 0x25D0,
    SMSG_QUERY_BATTLE_PET_NAME_RESPONSE               = 0x26FE,
    SMSG_QUERY_CREATURE_RESPONSE                      = 0x26F5,
    SMSG_QUERY_GAME_OBJECT_RESPONSE                   = 0x26F6,
    SMSG_QUERY_GARRISON_CREATURE_NAME_RESPONSE        = 0x292B,
    SMSG_QUERY_GUILD_INFO_RESPONSE                    = 0x29E5,
    SMSG_QUERY_ITEM_TEXT_RESPONSE                     = 0x27FF,
    SMSG_QUERY_NPC_TEXT_RESPONSE                      = 0x26F9,
    SMSG_QUERY_PAGE_TEXT_RESPONSE                     = 0x26FB,
    SMSG_QUERY_PETITION_RESPONSE                      = 0x26FF,
    SMSG_QUERY_PET_NAME_RESPONSE                      = 0x26FD,
    SMSG_QUERY_PLAYER_NAME_RESPONSE                   = 0x26FA,
    SMSG_QUERY_QUEST_INFO_RESPONSE                    = 0x2A95,
    SMSG_QUERY_QUEST_REWARD_RESPONSE                  = 0x2839,
    SMSG_QUERY_TIME_RESPONSE                          = 0x2715,
    ...
    SMSG_QUEST_GIVER_QUEST_LIST_MESSAGE               = 0x2A98,
    SMSG_QUEST_GIVER_REQUEST_ITEMS                    = 0x2A92,
    SMSG_QUEST_GIVER_STATUS                           = 0x2A99,
    SMSG_QUEST_GIVER_STATUS_MULTIPLE                  = 0x2A90,
    SMSG_QUEST_IGNORED                                = 0x2A9F,
    ...
    SMSG_READY_CHECK_COMPLETED                        = 0x260A,
    SMSG_READY_CHECK_RESPONSE                         = 0x2609,
    SMSG_READY_CHECK_STARTED                          = 0x2608,
    SMSG_READ_ITEM_RESULT_FAILED                      = 0x27E2,
    SMSG_READ_ITEM_RESULT_OK                          = 0x27DD,
    SMSG_REALM_QUERY_RESPONSE                         = 0x26E0,
    SMSG_RECRUIT_A_FRIEND_RESPONSE                    = 0x27C5,
    SMSG_REFER_A_FRIEND_EXPIRED                       = 0x275D,
    SMSG_REFER_A_FRIEND_FAILURE                       = 0x26E6,
    ...
    SMSG_REPLACE_TROPHY_RESPONSE                      = 0x27FC,
    SMSG_REPORT_PVP_PLAYER_AFK_RESULT                 = 0x26D4,
    ...
    SMSG_RESET_FAILED_NOTIFY                          = 0x26DC,
    SMSG_RESET_RANGED_COMBAT_TIMER                    = 0x270E,
    SMSG_RESET_WEEKLY_CURRENCY                        = 0x2574,
    SMSG_RESPEC_WIPE_CONFIRM                          = 0x2621,
    ...
    SMSG_SCENARIO_COMPLETED                           = 0x2820,
    SMSG_SCENARIO_POIS                                = 0x264A,
    SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x2644,
    SMSG_SCENARIO_SPELL_UPDATE                        = 0x282C,
    SMSG_SCENARIO_STATE                               = 0x2643,
    SMSG_SCENE_OBJECT_EVENT                           = 0x25F3,
    SMSG_SCENE_OBJECT_PET_BATTLE_FINAL_ROUND          = 0x25F8,
    SMSG_SCENE_OBJECT_PET_BATTLE_FINISHED             = 0x25F9,
    SMSG_SCENE_OBJECT_PET_BATTLE_FIRST_ROUND          = 0x25F5,
    SMSG_SCENE_OBJECT_PET_BATTLE_INITIAL_UPDATE       = 0x25F4,
    SMSG_SCENE_OBJECT_PET_BATTLE_REPLACEMENTS_MADE    = 0x25F7,
    SMSG_SCENE_OBJECT_PET_BATTLE_ROUND_RESULT         = 0x25F6,
    ...
    SMSG_SET_AI_ANIM_KIT                              = 0x276C,
    SMSG_SET_ALL_TASK_PROGRESS                        = 0x27CD,
    SMSG_SET_ANIM_TIER                                = 0x2770,
    SMSG_SET_CURRENCY                                 = 0x2573,
    SMSG_SET_DF_FAST_LAUNCH_RESULT                    = 0x2A2E,
    SMSG_SET_DUNGEON_DIFFICULTY                       = 0x26C8,
    SMSG_SET_FACTION_AT_WAR                           = 0x2737,
    SMSG_SET_FACTION_NOT_VISIBLE                      = 0x2767,
    SMSG_SET_FACTION_STANDING                         = 0x2768,
    SMSG_SET_FACTION_VISIBLE                          = 0x2766,
    SMSG_SET_FLAT_SPELL_MODIFIER                      = 0x2C37,
    SMSG_SET_FORCED_REACTIONS                         = 0x2757,
    SMSG_SET_ITEM_PURCHASE_DATA                       = 0x25AE,
    SMSG_SET_LOOT_METHOD_FAILED                       = 0x280B,
    SMSG_SET_MAX_WEEKLY_QUANTITY                      = 0x25B5,
    SMSG_SET_MELEE_ANIM_KIT                           = 0x276F,
    SMSG_SET_MOVEMENT_ANIM_KIT                        = 0x276E,
    SMSG_SET_PCT_SPELL_MODIFIER                       = 0x2C38,
    SMSG_SET_PET_SPECIALIZATION                       = 0x263D,
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT             = 0x2702,
    SMSG_SET_PLAY_HOVER_ANIM                          = 0x25C9,
    SMSG_SET_PROFICIENCY                              = 0x2771,
    SMSG_SET_SPELL_CHARGES                            = 0x2C29,
    SMSG_SET_TASK_COMPLETE                            = 0x27CE,
    SMSG_SET_TIME_ZONE_INFORMATION                    = 0x269A,
    SMSG_SET_VEHICLE_REC_ID                           = 0x272A,
    SMSG_SHOW_ADVENTURE_MAP                           = 0x282A,
    SMSG_SHOW_BANK                                    = 0x26A3,
    SMSG_SHOW_MAILBOX                                 = 0x27E4,
    SMSG_SHOW_NEUTRAL_PLAYER_FACTION_SELECT_UI        = 0x25EC,
    SMSG_SHOW_TAXI_NODES                              = 0x26F1,
    SMSG_SHOW_TRADE_SKILL_RESPONSE                    = 0x27AE,
    SMSG_SOCKET_GEMS                                  = 0x2763,
    SMSG_SOCKET_GEMS_FAILURE                          = 0x2764,
    SMSG_SOR_START_EXPERIENCE_INCOMPLETE              = 0x25EE,
    ...
    SMSG_SPELL_CHANNEL_START                          = 0x2C35,
    SMSG_SPELL_CHANNEL_UPDATE                         = 0x2C36,
    ...
    SMSG_SPELL_PREPARE                                = 0x2C39,
    SMSG_SPELL_START                                  = 0x2C3B,
    SMSG_SPELL_UPDATE_CHAIN_TARGETS                   = 0x2C34,
    SMSG_SPIRIT_HEALER_CONFIRM                        = 0x274F,
    SMSG_STAND_STATE_UPDATE                           = 0x2756,
    SMSG_START_ELAPSED_TIMER                          = 0x2616,
    SMSG_START_ELAPSED_TIMERS                         = 0x2618,
    SMSG_START_LOOT_ROLL                              = 0x262C,
    SMSG_START_MIRROR_TIMER                           = 0x2749,
    SMSG_START_TIMER                                  = 0x25B9,
    SMSG_STOP_ELAPSED_TIMER                           = 0x2617,
    SMSG_STOP_MIRROR_TIMER                            = 0x274B,
    SMSG_STOP_SPEAKERBOT_SOUND                        = 0x27AA,
    SMSG_STREAMING_MOVIES                             = 0x25B8,
    SMSG_SUMMON_CANCEL                                = 0x26D3,
    ...
    SMSG_THREAT_CLEAR                                 = 0x270A,
    SMSG_THREAT_REMOVE                                = 0x2709,
    SMSG_THREAT_UPDATE                                = 0x2708,
    SMSG_TIME_ADJUSTMENT                              = 0x2DA1,
    SMSG_TIME_SYNC_REQUEST                            = 0x2DA0,
    SMSG_TITLE_EARNED                                 = 0x2705,
    SMSG_TITLE_LOST                                   = 0x2706,
    SMSG_TOTEM_CREATED                                = 0x26ED,
    SMSG_TOTEM_MOVED                                  = 0x26EE,
    SMSG_TRADE_STATUS                                 = 0x2581,
    SMSG_TRADE_UPDATED                                = 0x2580,
    SMSG_TRAINER_BUY_FAILED                           = 0x2710,
    SMSG_TRAINER_LIST                                 = 0x270F,
    SMSG_TRANSFER_ABORTED                             = 0x273B,
    SMSG_TRANSFER_PENDING                             = 0x25E1,
    SMSG_TRANSMOG_COLLECTION_UPDATE                   = 0x25C4,
    SMSG_TRIGGER_CINEMATIC                            = 0x2803,
    SMSG_TRIGGER_MOVIE                                = 0x26EF,
    SMSG_TURN_IN_PETITION_RESULT                      = 0x278C,
    SMSG_TUTORIAL_FLAGS                               = 0x27F6,
    SMSG_TUTORIAL_HIGHLIGHT_SPELL                     = 0x2833,
    SMSG_TUTORIAL_UNHIGHLIGHT_SPELL                   = 0x2832,
    SMSG_TWITTER_STATUS                               = 0x2FFD,
    SMSG_UI_TIME                                      = 0x274E,
    SMSG_UNDELETE_CHARACTER_RESPONSE                  = 0x2806,
    SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE            = 0x2807,
    SMSG_UNLEARNED_SPELLS                             = 0x2C4E,
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x2743,
    SMSG_UPDATE_ACTION_BUTTONS                        = 0x25F1,
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x27FB,
    SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT            = 0x2A31,
    SMSG_UPDATE_EXPANSION_LEVEL                       = 0x265E,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x26CB,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x26AC,
    SMSG_UPDATE_OBJECT                                = 0x2804,
    SMSG_UPDATE_TALENT_DATA                           = 0x25E7,
    SMSG_UPDATE_TASK_PROGRESS                         = 0x27CC,
    SMSG_UPDATE_WEEKLY_SPELL_USAGE                    = 0x2C19,
    SMSG_UPDATE_WORLD_STATE                           = 0x2787,
    SMSG_USERLIST_ADD                                 = 0x2BBE,
    SMSG_USERLIST_REMOVE                              = 0x2BBF,
    SMSG_USERLIST_UPDATE                              = 0x2BC0,
    SMSG_USE_EQUIPMENT_SET_RESULT                     = 0x278D,
    SMSG_VENDOR_INVENTORY                             = 0x25C7,
    SMSG_VIGNETTE_UPDATE                              = 0x27AC,
    ...
    SMSG_WHO                                          = 0x2BAE,
    SMSG_WHO_IS                                       = 0x26C9,
    SMSG_WORLD_QUEST_UPDATE                           = 0x283A,
    SMSG_WORLD_SERVER_INFO                            = 0x25C0,
    SMSG_WORLD_TEXT                                   = 0x2822,
    ...
    SMSG_WOW_TOKEN_MARKET_PRICE_RESPONSE              = 0x280E,
    SMSG_WOW_TOKEN_REDEEM_GAME_TIME_UPDATED           = 0x2815,
    SMSG_WOW_TOKEN_REDEEM_REQUEST_CONFIRMATION        = 0x2816,
    SMSG_WOW_TOKEN_REDEEM_RESULT                      = 0x2817,
    SMSG_WOW_TOKEN_SELL_REQUEST_CONFIRMATION          = 0x280F,
    SMSG_WOW_TOKEN_SELL_RESULT_CONFIRMATION           = 0x2810,
    SMSG_WOW_TOKEN_UPDATE_AUCTIONABLE_LIST_RESPONSE   = 0x2818,
