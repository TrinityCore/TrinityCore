...
enum OpcodeClient : uint32
{
    ...
    CMSG_HEARTH_AND_RESURRECT                         = 0x0655,
    ...
    CMSG_JOIN_RATED_BATTLEGROUND                      = 0x01ED,
    ...
    CMSG_SORT_BAGS                                    = 0x05AA,
    CMSG_SORT_BANK_BAGS                               = 0x09F2,
    CMSG_SORT_REAGENT_BANK_BAGS                       = 0x053A,
