...
enum Opcodes
{
    ...
    CMSG_GROUP_ACCEPT_DECLINE                        = 0x8A88,
    ...
    MSG_MOVE_KNOCK_BACK                              = 0x00, // Possibly 0x60FE
    MSG_MOVE_ROOT                                    = 0x00,
    ...
    SMSG_DURABILITY_DAMAGE_DEATH                     = 0xACF,
    ...
    SMSG_LFG_OPEN_FROM_GOSSIP                        = 0xC5E,
