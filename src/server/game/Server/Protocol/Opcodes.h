...
enum OpcodeClient : uint32
{
    ...
    CMSG_ACCEPT_LEVEL_GRANT                           = 0x34E9,
    ...
    CMSG_CLIENT_PORT_GRAVEYARD                        = 0x3515,
    ...
    CMSG_HEARTH_AND_RESURRECT                         = 0x34F8,
    ...
    CMSG_MAIL_GET_LIST                                = 0x3523,
    CMSG_MAIL_MARK_AS_READ                            = 0x3527,
    CMSG_MAIL_RETURN_TO_SENDER                        = 0x3658,
    CMSG_MAIL_TAKE_ITEM                               = 0x3525,
    CMSG_MAIL_TAKE_MONEY                              = 0x3524,
    ...
    CMSG_SAVE_EQUIPMENT_SET                           = 0x34FB,
    ...
    CMSG_SET_ACTION_BAR_TOGGLES                       = 0x351F,
    ...
    CMSG_SET_LOOT_SPECIALIZATION                      = 0x352C,
    ...
    CMSG_SET_TAXI_BENCHMARK_MODE                      = 0x34E3,
