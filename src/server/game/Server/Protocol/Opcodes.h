...
enum OpcodeClient : uint16
{
    ...
    CMSG_CHAR_CREATE_FINALIZE_REINCARNATION               = 0x375F,
    ...
    CMSG_CONTRIBUTION_LAST_UPDATE_REQUEST                 = 0x355C,
    ...
    CMSG_QUEST_GIVER_STATUS_TRACKED_QUERY                 = 0x356C,
    ...
    CMSG_REPORT_ENABLED_ADD_ONS                           = 0x3706,
    ...
    CMSG_SET_PRIMARY_TALENT_TREE                          = 0x3557,
    CMSG_SET_PVP                                          = 0x32AD,
    ...
    CMSG_SHOWING_CLOAK                                    = 0x356A,
    CMSG_SHOWING_HELM                                     = 0x3569,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0x25BA,
    SMSG_ACCOUNT_NOTIFICATIONS_RESPONSE               = 0x278A,
    SMSG_ACCOUNT_TOY_UPDATE                           = 0x25B2,
    SMSG_ACHIEVEMENT_DELETED                          = 0x26EC,
    SMSG_ACHIEVEMENT_EARNED                           = 0x2645,
    SMSG_ACTIVATE_TAXI_REPLY                          = 0x2827,
    ...
    SMSG_ADD_LOSS_OF_CONTROL                          = 0x279C,
    ...
    SMSG_ALLIED_RACE_DETAILS                          = 0x2682,
    SMSG_ALL_ACCOUNT_CRITERIA                         = 0x2571,
    SMSG_ALL_ACHIEVEMENT_DATA                         = 0x2570,
    SMSG_ALL_GUILD_ACHIEVEMENTS                       = 0x29B8,
    SMSG_ARCHAEOLOGY_SURVERY_CAST                     = 0x27BC,
    SMSG_AREA_POI_UPDATE_RESPONSE                     = 0x300F,
    ...
    SMSG_AUCTIONABLE_TOKEN_SELL_AT_MARKET_PRICE_RESPONSE = 0x281A,
    SMSG_AUCTIONABLE_TOKEN_SELL_CONFIRM_REQUIRED      = 0x27E2,
    ...
    SMSG_BARBER_SHOP_RESULT                           = 0x2787,
    ...
    SMSG_BATTLENET_CHALLENGE_START                    = 0x25D6,
    SMSG_BATTLENET_NOTIFICATION                       = 0x280B,
    SMSG_BATTLENET_RESPONSE                           = 0x280A,
    SMSG_BATTLE_NET_CONNECTION_STATUS                 = 0x280C,
    SMSG_BATTLE_PAY_ACK_FAILED                        = 0x270A,
    SMSG_BATTLE_PAY_BATTLE_PET_DELIVERED              = 0x2575,
    SMSG_BATTLE_PAY_COLLECTION_ITEM_DELIVERED         = 0x2595,
    SMSG_BATTLE_PAY_CONFIRM_PURCHASE                  = 0x270B,
    SMSG_BATTLE_PAY_DELIVERY_ENDED                    = 0x2574,
    SMSG_BATTLE_PAY_DELIVERY_STARTED                  = 0x2573,
    SMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS_RESPONSE  = 0x288B,
    SMSG_BATTLE_PAY_DISTRIBUTION_UNREVOKED            = 0x272F,
    SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE               = 0x277D,
    SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE    = 0x277B,
    SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE         = 0x2721,
    SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE        = 0x2587,
    SMSG_BATTLE_PAY_MOUNT_DELIVERED                   = 0x25A0,
    SMSG_BATTLE_PAY_PURCHASE_UPDATE                   = 0x270C,
    SMSG_BATTLE_PAY_START_CHECKOUT                    = 0x277A,
    SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE = 0x2886,
    SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE           = 0x26C0,
    SMSG_BATTLE_PAY_VALIDATE_PURCHASE_RESPONSE        = 0x26C2,
    ...
    SMSG_CAN_REDEEM_TOKEN_FOR_BALANCE_RESPONSE        = 0x27D9,
    ...
    SMSG_COMMENTATOR_MAP_INFO                         = 0x278C,
    SMSG_COMMENTATOR_PLAYER_INFO                      = 0x278B,
    SMSG_COMMENTATOR_STATE_CHANGED                    = 0x277E,
    SMSG_COMMERCE_TOKEN_GET_COUNT_RESPONSE            = 0x2794,
    SMSG_COMMERCE_TOKEN_GET_LOG_RESPONSE              = 0x27DF,
    SMSG_COMMERCE_TOKEN_GET_MARKET_PRICE_RESPONSE     = 0x27DC,
    ...
    SMSG_CONSUMABLE_TOKEN_BUY_CHOICE_REQUIRED         = 0x27E1,
    SMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY_RESPONSE    = 0x27D7,
    SMSG_CONSUMABLE_TOKEN_REDEEM_CONFIRM_REQUIRED     = 0x27DE,
    ...
    SMSG_DAILY_QUESTS_RESET                           = 0x27FF,
    ...
    SMSG_DISPLAY_QUEST_POPUP                          = 0x288D,
    ...
    SMSG_EMOTE                                        = 0x27CD,
    SMSG_ENABLE_BARBER_SHOP                           = 0x2788,
    ...
    SMSG_ENUM_VAS_PURCHASE_STATES_RESPONSE            = 0x272E,
    SMSG_ENVIRONMENTAL_DAMAGE_LOG                     = 0x2C1E,
    SMSG_EQUIPMENT_SET_ID                             = 0x2753,
    SMSG_EXPECTED_SPAM_RECORDS                        = 0x2BB1,
    SMSG_EXPLORATION_EXPERIENCE                       = 0x2763,
    SMSG_FACTION_BONUS_INFO                           = 0x26E8,
    ...
    SMSG_GAME_OBJECT_CLOSE_INTERACTION                = 0x2823,
    SMSG_GAME_OBJECT_CUSTOM_ANIM                      = 0x25C6,
    SMSG_GAME_OBJECT_DESPAWN                          = 0x25C7,
    SMSG_GAME_OBJECT_INTERACTION                      = 0x2885,
    ...
    SMSG_GET_VAS_ACCOUNT_CHARACTER_LIST_RESULT        = 0x27F8,
    SMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST_RESULT    = 0x277C,
    ...
    SMSG_GOSSIP_COMPLETE                              = 0x2726,
    SMSG_GOSSIP_MESSAGE                               = 0x2A97,
    SMSG_GOSSIP_OPTION_NPC_INTERACTION                = 0x2680,
    SMSG_GOSSIP_POI                                   = 0x2A99,
    ...
    SMSG_INITIALIZE_FACTIONS                          = 0x2A81,
    SMSG_INITIAL_SETUP                                = 0x2580,
    SMSG_INIT_WORLD_STATES                            = 0x3010,
    SMSG_INSPECT_HONOR_STATS                          = 0x287A,
    SMSG_INSPECT_PVP                                  = 0x2933,
    ...
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT               = 0x27DB,
    ...
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE          = 0x27BA,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED       = 0x27BF,
    ...
    SMSG_INSTANCE_ENCOUNTER_UPDATE_SUPPRESS_RELEASE   = 0x27C0,
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                  = 0x26FE,
    SMSG_INSTANCE_INFO                                = 0x25D3,
    SMSG_INSTANCE_RESET                               = 0x268A,
    SMSG_INSTANCE_RESET_FAILED                        = 0x268B,
    SMSG_INSTANCE_SAVE_CREATED                        = 0x2895,
    ...
    SMSG_LEARN_TALENT_FAILED                          = 0x25DA,
    SMSG_LEGACY_LOOT_RULES                            = 0x282E,
    SMSG_LEVEL_UP_INFO                                = 0x26ED,
    SMSG_LFG_BOOT_PLAYER                              = 0x2A34,
    SMSG_LFG_DISABLED                                 = 0x2A30,
    SMSG_LFG_EXPAND_SEARCH_PROMPT                     = 0x2A3A,
    SMSG_LFG_INSTANCE_SHUTDOWN_COUNTDOWN              = 0x2A21,
    SMSG_LFG_JOIN_RESULT                              = 0x2A32,
    SMSG_LFG_LIST_APPLICANT_LIST_UPDATE               = 0x2A29,
    SMSG_LFG_LIST_APPLICATION_STATUS_UPDATE           = 0x2A1F,
    SMSG_LFG_LIST_APPLY_TO_GROUP_RESULT               = 0x2A28,
    SMSG_LFG_LIST_JOIN_RESULT                         = 0x2A3B,
    SMSG_LFG_LIST_SEARCH_RESULTS                      = 0x2A2A,
    SMSG_LFG_LIST_SEARCH_RESULTS_UPDATE               = 0x2A2B,
    SMSG_LFG_LIST_SEARCH_STATUS                       = 0x2A1E,
    SMSG_LFG_LIST_UPDATE_BLACKLIST                    = 0x2A26,
    SMSG_LFG_LIST_UPDATE_EXPIRATION                   = 0x2A2C,
    SMSG_LFG_LIST_UPDATE_STATUS                       = 0x2A1D,
    SMSG_LFG_OFFER_CONTINUE                           = 0x2A25,
    SMSG_LFG_PARTY_INFO                               = 0x2A35,
    SMSG_LFG_PLAYER_INFO                              = 0x2A36,
    SMSG_LFG_PLAYER_REWARD                            = 0x2A31,
    SMSG_LFG_PROPOSAL_UPDATE                          = 0x2A24,
    SMSG_LFG_QUEUE_STATUS                             = 0x2A2D,
    SMSG_LFG_READY_CHECK_RESULT                       = 0x2A22,
    SMSG_LFG_READY_CHECK_UPDATE                       = 0x2A37,
    SMSG_LFG_ROLE_CHECK_UPDATE                        = 0x2A20,
    SMSG_LFG_SLOT_INVALID                             = 0x2A2E,
    SMSG_LFG_TELEPORT_DENIED                          = 0x2A38,
    SMSG_LFG_UPDATE_STATUS                            = 0x2A1C,
    ...
    SMSG_LOAD_CUF_PROFILES                            = 0x286F,
    SMSG_LOAD_EQUIPMENT_SET                           = 0x25B1,
    ...
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                  = 0x2675,
    SMSG_MAIL_COMMAND_RESULT                          = 0x2674,
    SMSG_MAIL_LIST_RESULT                             = 0x263D,
    SMSG_MAIL_QUERY_NEXT_TIME_RESULT                  = 0x275A,
    ...
    SMSG_NOTIFY_RECEIVED_MAIL                         = 0x275B,
    SMSG_NPC_INTERACTION_OPEN_RESULT                  = 0x2822,
    ...
    SMSG_OPEN_LFG_DUNGEON_FINDER                      = 0x2A39,
    ...
    SMSG_PARTY_NOTIFY_LFG_LEADER_CHANGE               = 0x2A27,
    ...
    SMSG_QUEST_COMPLETION_NPC_RESPONSE                = 0x2AA7,
    ...
    SMSG_RESET_QUEST_POI                              = 0x288E,
    SMSG_RESET_RANGED_COMBAT_TIMER                    = 0x2949,
    SMSG_RESET_WEEKLY_CURRENCY                        = 0x2782,
    ...
    SMSG_SOCIAL_CONTRACT_REQUEST_RESPONSE             = 0x2728,
    ...
    SMSG_TRAINER_LIST                                 = 0x2681,
    SMSG_TRAIT_CONFIG_COMMIT_FAILED                   = 0x27F7,
    ...
    SMSG_UPDATE_TALENT_DATA                           = 0x2627,
    SMSG_UPDATE_WORLD_STATE                           = 0x274A,
    SMSG_USERLIST_ADD                                 = 0x2BB9,
    SMSG_USERLIST_REMOVE                              = 0x2BBA,
    SMSG_USERLIST_UPDATE                              = 0x2BBB,
    SMSG_USE_EQUIPMENT_SET_RESULT                     = 0x2712,
    SMSG_VAS_CHECK_TRANSFER_OK_RESPONSE               = 0x2779,
    SMSG_VAS_GET_QUEUE_MINUTES_RESPONSE               = 0x2704,
    SMSG_VAS_GET_SERVICE_STATUS_RESPONSE              = 0x2730,
    SMSG_VAS_PURCHASE_COMPLETE                        = 0x281D,
    SMSG_VAS_PURCHASE_STATE_UPDATE                    = 0x281C,
    SMSG_VENDOR_INVENTORY                             = 0x263E,
    SMSG_VIGNETTE_UPDATE                              = 0x274C,
    SMSG_VOICE_CHANNEL_INFO_RESPONSE                  = 0x27F6,
    SMSG_VOICE_CHANNEL_STT_TOKEN_RESPONSE             = 0x27F5,
    SMSG_VOICE_LOGIN_RESPONSE                         = 0x27F4,
    ...
    SMSG_WORLD_QUEST_UPDATE_RESPONSE                  = 0x25A7,
