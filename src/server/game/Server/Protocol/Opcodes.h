...
enum Opcodes
{
    ...
    SMSG_TRAINER_BUY_SUCCEEDED                       = 0xAF7, // 
    ...
    SMSG_WEATHER                                     = 0x00, // 
    SMSG_WARDEN_DATA                                 = 0x4ECE, // 
    SMSG_WHO                                         = 0x4C7F, // 
    SMSG_WHOIS                                       = 0x00, // 
    SMSG_WORLD_STATE_UI_TIMER_UPDATE                 = 0x00, // 
    SMSG_ZONE_UNDER_ATTACK                           = 0x00, // 

    SMSG_VERIFY_CONNECTIVITY                         = 20311, // 
    CMSG_VERIFY_CONNECTIVITY_RESPONSE                = 19538, //1280462679, //  special opcode, client sends as uint32

    SMSG_BATTLEFIELD_STATUS                          = 0x00, // 
    SMSG_QUESTUPDATE_ADD_ITEM                        = 0x00, // 
    SMSG_OVERRIDE_LIGHT                              = 0x00, // 
    CMSG_RANDOMIZE_CHAR_NAME                         = 35481, //  byte unk, byte race
    SMSG_RANDOMIZE_CHAR_NAME                         = 61660, //  byte unk(0x80), string name
