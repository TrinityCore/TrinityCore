...
enum OpcodeClient : uint16
{
    ...
    CMSG_ACTIVATE_TAXI                                = 0x34AC,
    CMSG_ADDON_LIST                                   = 0x35D8,
    CMSG_ADD_BATTLENET_FRIEND                         = 0x365D,
    CMSG_ADD_FRIEND                                   = 0x36D2,
    CMSG_ADD_IGNORE                                   = 0x36D6,
    CMSG_ADD_TOY                                      = 0x327D,
    CMSG_ADVENTURE_JOURNAL_OPEN_QUEST                 = 0x31EF,
    CMSG_ADVENTURE_JOURNAL_START_QUEST                = 0x3325,
    CMSG_ALTER_APPEARANCE                             = 0x34EB,
    CMSG_AREA_SPIRIT_HEALER_QUERY                     = 0x34B1,
    CMSG_AREA_SPIRIT_HEALER_QUEUE                     = 0x34B2,
    CMSG_AREA_TRIGGER                                 = 0x31C5,
    CMSG_ARTIFACT_ADD_POWER                           = 0x31A5,
    CMSG_ARTIFACT_SET_APPEARANCE                      = 0x31A7,
    CMSG_ASSIGN_EQUIPMENT_SET_SPEC                    = 0x31F6,
    CMSG_ATTACK_STOP                                  = 0x3240,
    CMSG_ATTACK_SWING                                 = 0x323F,
    CMSG_AUCTION_HELLO_REQUEST                        = 0x34C1,
    CMSG_AUCTION_LIST_BIDDER_ITEMS                    = 0x34C7,
    CMSG_AUCTION_LIST_ITEMS                           = 0x34C4,
    CMSG_AUCTION_LIST_OWNER_ITEMS                     = 0x34C6,
    CMSG_AUCTION_LIST_PENDING_SALES                   = 0x34C9,
    CMSG_AUCTION_PLACE_BID                            = 0x34C8,
    CMSG_AUCTION_REMOVE_ITEM                          = 0x34C3,
    CMSG_AUCTION_REPLICATE_ITEMS                      = 0x34C5,
    CMSG_AUCTION_SELL_ITEM                            = 0x34C2,
    ...
    CMSG_BANKER_ACTIVATE                              = 0x34B4,
    CMSG_BATTLEFIELD_LEAVE                            = 0x3171,
    CMSG_BATTLEFIELD_LIST                             = 0x317D,
    CMSG_BATTLEFIELD_PORT                             = 0x351B,
    CMSG_BATTLEMASTER_HELLO                           = 0x3293,
    CMSG_BATTLEMASTER_JOIN                            = 0x3516,
    CMSG_BATTLEMASTER_JOIN_ARENA                      = 0x3517,
    CMSG_BATTLEMASTER_JOIN_BRAWL                      = 0x3519,
    CMSG_BATTLEMASTER_JOIN_SKIRMISH                   = 0x3518,
    ...
    CMSG_BATTLE_PAY_QUERY_CLASS_TRIAL_BOOST_RESULT    = 0x36C6,
    CMSG_BATTLE_PAY_REQUEST_CHARACTER_BOOST_UNREVOKE  = 0x36C4,
    ...
    CMSG_BATTLE_PAY_TRIAL_BOOST_CHARACTER             = 0x36C5,
    CMSG_BATTLE_PAY_VALIDATE_BNET_VAS_TRANSFER        = 0x370C,
    CMSG_BATTLE_PET_CLEAR_FANFARE                     = 0x312C,
    CMSG_BATTLE_PET_DELETE_PET                        = 0x3627,
    CMSG_BATTLE_PET_DELETE_PET_CHEAT                  = 0x3628,
    CMSG_BATTLE_PET_MODIFY_NAME                       = 0x362A,
    CMSG_BATTLE_PET_REQUEST_JOURNAL                   = 0x3626,
    CMSG_BATTLE_PET_REQUEST_JOURNAL_LOCK              = 0x3625,
    CMSG_BATTLE_PET_SET_BATTLE_SLOT                   = 0x362E,
    CMSG_BATTLE_PET_SET_FLAGS                         = 0x3632,
    CMSG_BATTLE_PET_SUMMON                            = 0x362B,
    CMSG_BATTLE_PET_UPDATE_NOTIFY                     = 0x31CE,
    CMSG_BEGIN_TRADE                                  = 0x3157,
    CMSG_BINDER_ACTIVATE                              = 0x34B3,
    CMSG_BLACK_MARKET_BID_ON_ITEM                     = 0x3523,
    CMSG_BLACK_MARKET_OPEN                            = 0x3521,
    CMSG_BLACK_MARKET_REQUEST_ITEMS                   = 0x3522,
    CMSG_BUG_REPORT                                   = 0x3689,
    CMSG_BUSY_TRADE                                   = 0x3158,
    CMSG_BUY_BACK_ITEM                                = 0x34A5,
    CMSG_BUY_BANK_SLOT                                = 0x34B5,
    CMSG_BUY_ITEM                                     = 0x34A4,
    CMSG_BUY_REAGENT_BANK                             = 0x34B6,
    CMSG_BUY_WOW_TOKEN_CONFIRM                        = 0x36EE,
    CMSG_BUY_WOW_TOKEN_START                          = 0x36ED,
    CMSG_CAGE_BATTLE_PET                              = 0x31DF,
    CMSG_CALENDAR_ADD_EVENT                           = 0x3680,
    CMSG_CALENDAR_COMPLAIN                            = 0x367C,
    CMSG_CALENDAR_COPY_EVENT                          = 0x367B,
    CMSG_CALENDAR_EVENT_INVITE                        = 0x3675,
    CMSG_CALENDAR_EVENT_MODERATOR_STATUS              = 0x3679,
    CMSG_CALENDAR_EVENT_RSVP                          = 0x3677,
    CMSG_CALENDAR_EVENT_SIGN_UP                       = 0x367E,
    CMSG_CALENDAR_EVENT_STATUS                        = 0x3678,
    CMSG_CALENDAR_GET                                 = 0x3672,
    CMSG_CALENDAR_GET_EVENT                           = 0x3673,
    CMSG_CALENDAR_GET_NUM_PENDING                     = 0x367D,
    CMSG_CALENDAR_GUILD_FILTER                        = 0x3674,
    CMSG_CALENDAR_REMOVE_EVENT                        = 0x367A,
    CMSG_CALENDAR_REMOVE_INVITE                       = 0x3676,
    CMSG_CALENDAR_UPDATE_EVENT                        = 0x3681,
    CMSG_CANCEL_AURA                                  = 0x31A9,
    CMSG_CANCEL_AUTO_REPEAT_SPELL                     = 0x34DD,
    CMSG_CANCEL_CAST                                  = 0x3283,
    CMSG_CANCEL_CHANNELLING                           = 0x324F,
    CMSG_CANCEL_GROWTH_AURA                           = 0x3254,
    CMSG_CANCEL_MASTER_LOOT_ROLL                      = 0x31FE,
    CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS            = 0x31A8,
    CMSG_CANCEL_MOUNT_AURA                            = 0x3265,
    CMSG_CANCEL_QUEUED_SPELL                          = 0x317E,
    CMSG_CANCEL_TEMP_ENCHANTMENT                      = 0x34E8,
    CMSG_CANCEL_TRADE                                 = 0x315C,
    CMSG_CAN_DUEL                                     = 0x3665,
    CMSG_CAN_REDEEM_WOW_TOKEN_FOR_BALANCE             = 0x3708,
    CMSG_CAST_SPELL                                   = 0x3280,
    CMSG_CHALLENGE_MODE_REQUEST_LEADERS               = 0x308F,
    CMSG_CHALLENGE_MODE_REQUEST_MAP_STATS             = 0x308E,
    CMSG_CHANGE_BAG_SLOT_FLAG                         = 0x3308,
    CMSG_CHANGE_MONUMENT_APPEARANCE                   = 0x32E8,
    CMSG_CHANGE_SUB_GROUP                             = 0x364F,
    CMSG_CHARACTER_RENAME_REQUEST                     = 0x36C1,
    CMSG_CHAR_CUSTOMIZE                               = 0x3691,
    CMSG_CHAR_DELETE                                  = 0x369E,
    CMSG_CHAR_RACE_OR_FACTION_CHANGE                  = 0x3697,
    ...
    CMSG_CHECK_RAF_EMAIL_ENABLED                      = 0x36CE,
    CMSG_CHECK_WOW_TOKEN_VETERAN_ELIGIBILITY          = 0x36EC,
    CMSG_CHOICE_RESPONSE                              = 0x3285,
    CMSG_CLEAR_RAID_MARKER                            = 0x31A1,
    CMSG_CLEAR_TRADE_ITEM                             = 0x315E,
    CMSG_CLIENT_PORT_GRAVEYARD                        = 0x351D,
    CMSG_CLOSE_INTERACTION                            = 0x3492,
    CMSG_COLLECTION_ITEM_SET_FAVORITE                 = 0x3635,
    ...
    CMSG_COMPLAINT                                    = 0x366F,
    CMSG_COMPLETE_CINEMATIC                           = 0x353B,
    CMSG_COMPLETE_MOVIE                               = 0x34D3,
    CMSG_CONFIRM_ARTIFACT_RESPEC                      = 0x31A6,
    CMSG_CONFIRM_RESPEC_WIPE                          = 0x31F8,
    CMSG_CONNECT_TO_FAILED                            = 0x35D4,
    CMSG_CONTRIBUTION_CONTRIBUTE                      = 0x354A,
    CMSG_CONTRIBUTION_GET_STATE                       = 0x354B,
    CMSG_CONVERT_CONSUMPTION_TIME                     = 0x36FC,
    CMSG_CONVERT_RAID                                 = 0x3651,
    CMSG_CREATE_CHARACTER                             = 0x3646,
    CMSG_CREATE_SHIPMENT                              = 0x32D4,
    CMSG_DB_QUERY_BULK                                = 0x35E4,
    CMSG_DECLINE_GUILD_INVITES                        = 0x3514,
    CMSG_DECLINE_PETITION                             = 0x352A,
    CMSG_DELETE_EQUIPMENT_SET                         = 0x3502,
    CMSG_DEL_FRIEND                                   = 0x36D3,
    CMSG_DEL_IGNORE                                   = 0x36D7,
    CMSG_DEPOSIT_REAGENT_BANK                         = 0x3311,
    CMSG_DESTROY_ITEM                                 = 0x3277,
    ...
    CMSG_DISMISS_CRITTER                              = 0x34F1,
    CMSG_DO_MASTER_LOOT_ROLL                          = 0x31FD,
    CMSG_DO_READY_CHECK                               = 0x3636,
    CMSG_DUEL_RESPONSE                                = 0x34D8,
    CMSG_EJECT_PASSENGER                              = 0x3226,
    CMSG_EMOTE                                        = 0x3537,
    CMSG_ENABLE_ENCRYPTION_ACK                        = 0x3767,
    CMSG_ENABLE_NAGLE                                 = 0x376B,
    CMSG_ENABLE_TAXI_NODE                             = 0x34AA,
    CMSG_ENGINE_SURVEY                                = 0x36E6,
    CMSG_ENUM_CHARACTERS                              = 0x35E8,
    CMSG_ENUM_CHARACTERS_DELETED_BY_CLIENT            = 0x36E0,
    CMSG_FAR_SIGHT                                    = 0x34DE,
    CMSG_GAME_OBJ_REPORT_USE                          = 0x34E5,
    CMSG_GAME_OBJ_USE                                 = 0x34E4,
    CMSG_GARRISON_ASSIGN_FOLLOWER_TO_BUILDING         = 0x32BF,
    CMSG_GARRISON_CANCEL_CONSTRUCTION                 = 0x32B0,
    CMSG_GARRISON_CHECK_UPGRADEABLE                   = 0x3304,
    CMSG_GARRISON_COMPLETE_MISSION                    = 0x32F5,
    CMSG_GARRISON_GENERATE_RECRUITS                   = 0x32C2,
    CMSG_GARRISON_GET_BUILDING_LANDMARKS              = 0x32D0,
    CMSG_GARRISON_GET_MISSION_REWARD                  = 0x332B,
    CMSG_GARRISON_MISSION_BONUS_ROLL                  = 0x32F7,
    CMSG_GARRISON_PURCHASE_BUILDING                   = 0x32AC,
    CMSG_GARRISON_RECRUIT_FOLLOWER                    = 0x32C4,
    CMSG_GARRISON_REMOVE_FOLLOWER                     = 0x32EC,
    CMSG_GARRISON_REMOVE_FOLLOWER_FROM_BUILDING       = 0x32C0,
    CMSG_GARRISON_RENAME_FOLLOWER                     = 0x32C1,
    CMSG_GARRISON_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA = 0x32AB,
    CMSG_GARRISON_REQUEST_CLASS_SPEC_CATEGORY_INFO    = 0x32C9,
    CMSG_GARRISON_REQUEST_LANDING_PAGE_SHIPMENT_INFO  = 0x32D3,
    CMSG_GARRISON_REQUEST_SHIPMENT_INFO               = 0x32D2,
    CMSG_GARRISON_REQUEST_SCOUTING_MAP                = 0x3231,
    CMSG_GARRISON_RESEARCH_TALENT                     = 0x32C5,
    CMSG_GARRISON_SET_BUILDING_ACTIVE                 = 0x32AD,
    CMSG_GARRISON_SET_FOLLOWER_FAVORITE               = 0x32BD,
    CMSG_GARRISON_SET_FOLLOWER_INACTIVE               = 0x32B9,
    CMSG_GARRISON_SET_RECRUITMENT_PREFERENCES         = 0x32C3,
    CMSG_GARRISON_START_MISSION                       = 0x32F4,
    CMSG_GARRISON_SWAP_BUILDINGS                      = 0x32B1,
    CMSG_GENERATE_RANDOM_CHARACTER_NAME               = 0x35E7,
    CMSG_GET_CHALLENGE_MODE_REWARDS                   = 0x3686,
    CMSG_GET_GARRISON_INFO                            = 0x32A6,
    CMSG_GET_ITEM_PURCHASE_DATA                       = 0x3525,
    CMSG_GET_MIRROR_IMAGE_DATA                        = 0x327B,
    CMSG_GET_PVP_OPTIONS_ENABLED                      = 0x35EF,
    CMSG_GET_REMAINING_GAME_TIME                      = 0x36EF,
    CMSG_GET_TROPHY_LIST                              = 0x32E5,
    CMSG_GET_UNDELETE_CHARACTER_COOLDOWN_STATUS       = 0x36E2,
    CMSG_GM_TICKET_ACKNOWLEDGE_SURVEY                 = 0x3695,
    CMSG_GM_TICKET_GET_CASE_STATUS                    = 0x3694,
    CMSG_GM_TICKET_GET_SYSTEM_STATUS                  = 0x3693,
    CMSG_GOSSIP_SELECT_OPTION                         = 0x3493,
    CMSG_GRANT_LEVEL                                  = 0x34ED,
    ...
    CMSG_GUILD_BANK_ACTIVATE                          = 0x34B7,
    CMSG_GUILD_BANK_BUY_TAB                           = 0x34BA,
    CMSG_GUILD_BANK_DEPOSIT_MONEY                     = 0x34BC,
    CMSG_GUILD_BANK_LOG_QUERY                         = 0x3082,
    CMSG_GUILD_BANK_QUERY_TAB                         = 0x34B9,
    CMSG_GUILD_BANK_REMAINING_WITHDRAW_MONEY_QUERY    = 0x3083,
    CMSG_GUILD_BANK_SET_TAB_TEXT                      = 0x3086,
    CMSG_GUILD_BANK_SWAP_ITEMS                        = 0x34B8,
    CMSG_GUILD_BANK_TEXT_QUERY                        = 0x3087,
    CMSG_GUILD_BANK_UPDATE_TAB                        = 0x34BB,
    CMSG_GUILD_BANK_WITHDRAW_MONEY                    = 0x34BD,
    ...
    CMSG_HEARTH_AND_RESURRECT                         = 0x34FE,
    CMSG_HOTFIX_QUERY                                 = 0x35E5,
    CMSG_IGNORE_TRADE                                 = 0x3159,
    CMSG_INITIATE_ROLE_POLL                           = 0x35DA,
    CMSG_INITIATE_TRADE                               = 0x3156,
    CMSG_INSPECT                                      = 0x351F,
    CMSG_INSPECT_PVP                                  = 0x36A4,
    CMSG_INSTANCE_LOCK_RESPONSE                       = 0x3503,
    CMSG_ITEM_PURCHASE_REFUND                         = 0x3526,
    CMSG_ITEM_TEXT_QUERY                              = 0x3305,
    CMSG_JOIN_PET_BATTLE_QUEUE                        = 0x31CC,
    CMSG_JOIN_RATED_BATTLEGROUND                      = 0x3176,
    CMSG_KEEP_ALIVE                                   = 0x3682,
    CMSG_KEYBOUND_OVERRIDE                            = 0x320F,
    CMSG_LEARN_PVP_TALENTS                            = 0x3549,
    CMSG_LEARN_TALENTS                                = 0x3548,
    CMSG_LEAVE_GROUP                                  = 0x364C,
    CMSG_LEAVE_PET_BATTLE_QUEUE                       = 0x31CD,
    ...
    CMSG_LFG_LIST_JOIN                                = 0x360A,
    CMSG_LFG_LIST_LEAVE                               = 0x360C,
    CMSG_LFG_LIST_SEARCH                              = 0x360E,
    CMSG_LFG_LIST_UPDATE_REQUEST                      = 0x360B,
    CMSG_LF_GUILD_ADD_RECRUIT                         = 0x361E,
    CMSG_LF_GUILD_BROWSE                              = 0x3620,
    ...
    CMSG_LF_GUILD_SET_GUILD_POST                      = 0x361F,
    CMSG_LIST_INVENTORY                               = 0x34A2,
    ...
    CMSG_LOAD_SELECTED_TROPHY                         = 0x32E6,
    CMSG_LOGOUT_CANCEL                                = 0x34CE,
    CMSG_LOGOUT_INSTANT                               = 0x34CF,
    CMSG_LOGOUT_REQUEST                               = 0x34CD,
    CMSG_LOG_DISCONNECT                               = 0x3769,
    CMSG_LOG_STREAMING_ERROR                          = 0x376D,
    CMSG_LOOT_ITEM                                    = 0x31FB,
    CMSG_LOOT_MONEY                                   = 0x31FA,
    CMSG_LOOT_RELEASE                                 = 0x31FF,
    CMSG_LOOT_ROLL                                    = 0x3200,
    CMSG_LOOT_UNIT                                    = 0x31F9,
    CMSG_LOW_LEVEL_RAID1                              = 0x36A2,
    CMSG_LOW_LEVEL_RAID2                              = 0x350A,
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x3531,
    CMSG_MAIL_DELETE                                  = 0x3211,
    CMSG_MAIL_GET_LIST                                = 0x352C,
    CMSG_MAIL_MARK_AS_READ                            = 0x3530,
    CMSG_MAIL_RETURN_TO_SENDER                        = 0x3658,
    CMSG_MAIL_TAKE_ITEM                               = 0x352E,
    CMSG_MAIL_TAKE_MONEY                              = 0x352D,
    CMSG_MASTER_LOOT_ITEM                             = 0x31FC,
    CMSG_MINIMAP_PING                                 = 0x364E,
    CMSG_MISSILE_TRAJECTORY_COLLISION                 = 0x3189,
    CMSG_MOUNT_CLEAR_FANFARE                          = 0x312D,
    CMSG_MOUNT_SET_FAVORITE                           = 0x3634,
    CMSG_MOUNT_SPECIAL_ANIM                           = 0x3266,
    ...
    CMSG_NEUTRAL_PLAYER_SELECT_FACTION                = 0x31C2,
    CMSG_NEXT_CINEMATIC_CAMERA                        = 0x353A,
    CMSG_OBJECT_UPDATE_FAILED                         = 0x317F,
    CMSG_OBJECT_UPDATE_RESCUED                        = 0x3180,
    CMSG_OFFER_PETITION                               = 0x36B2,
    CMSG_OPENING_CINEMATIC                            = 0x3539,
    CMSG_OPEN_ITEM                                    = 0x3306,
    CMSG_OPEN_MISSION_NPC                             = 0x32CB,
    CMSG_OPEN_SHIPMENT_NPC                            = 0x32D1,
    CMSG_OPEN_TRADESKILL_NPC                          = 0x32DC,
    CMSG_OPT_OUT_OF_LOOT                              = 0x34EC,
    CMSG_PARTY_INVITE                                 = 0x3603,
    CMSG_PARTY_INVITE_RESPONSE                        = 0x3604,
    CMSG_PARTY_UNINVITE                               = 0x364A,
    CMSG_PETITION_BUY                                 = 0x34BF,
    CMSG_PETITION_RENAME_GUILD                        = 0x36C9,
    CMSG_PETITION_SHOW_LIST                           = 0x34BE,
    CMSG_PETITION_SHOW_SIGNATURES                     = 0x34C0,
    CMSG_PET_ABANDON                                  = 0x348C,
    CMSG_PET_ACTION                                   = 0x348A,
    CMSG_PET_BATTLE_FINAL_NOTIFY                      = 0x31D0,
    CMSG_PET_BATTLE_INPUT                             = 0x3643,
    CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT        = 0x3210,
    CMSG_PET_BATTLE_QUIT_NOTIFY                       = 0x31CF,
    CMSG_PET_BATTLE_REPLACE_FRONT_PET                 = 0x3644,
    CMSG_PET_BATTLE_REQUEST_PVP                       = 0x31CA,
    CMSG_PET_BATTLE_REQUEST_UPDATE                    = 0x31CB,
    CMSG_PET_BATTLE_REQUEST_WILD                      = 0x31C8,
    CMSG_PET_BATTLE_SCRIPT_ERROR_NOTIFY               = 0x31D1,
    CMSG_PET_BATTLE_WILD_LOCATION_FAIL                = 0x31C9,
    CMSG_PET_CANCEL_AURA                              = 0x348D,
    CMSG_PET_CAST_SPELL                               = 0x327F,
    CMSG_PET_RENAME                                   = 0x3688,
    CMSG_PET_SET_ACTION                               = 0x3489,
    CMSG_PET_SPELL_AUTOCAST                           = 0x348E,
    CMSG_PET_STOP_ATTACK                              = 0x348B,
    CMSG_PING                                         = 0x3768,
    CMSG_PLAYER_LOGIN                                 = 0x35EA,
    CMSG_PROTOCOL_MISMATCH                            = 0x376E,
    CMSG_PUSH_QUEST_TO_PARTY                          = 0x34A0,
    CMSG_PVP_LOG_DATA                                 = 0x317A,
    CMSG_PVP_PRESTIGE_RANK_UP                         = 0x3329,
    CMSG_QUERY_BATTLE_PET_NAME                        = 0x325B,
    CMSG_QUERY_CORPSE_LOCATION_FROM_CLIENT            = 0x3663,
    CMSG_QUERY_CORPSE_TRANSPORT                       = 0x3664,
    CMSG_QUERY_COUNTDOWN_TIMER                        = 0x31A4,
    CMSG_QUERY_CREATURE                               = 0x3255,
    CMSG_QUERY_GAME_OBJECT                            = 0x3256,
    CMSG_QUERY_GARRISON_CREATURE_NAME                 = 0x325C,
    CMSG_QUERY_GUILD_INFO                             = 0x3690,
    CMSG_QUERY_INSPECT_ACHIEVEMENTS                   = 0x34F8,
    CMSG_QUERY_NEXT_MAIL_TIME                         = 0x352F,
    CMSG_QUERY_NPC_TEXT                               = 0x3257,
    CMSG_QUERY_PAGE_TEXT                              = 0x3259,
    CMSG_QUERY_PETITION                               = 0x325D,
    CMSG_QUERY_PET_NAME                               = 0x325A,
    CMSG_QUERY_PLAYER_NAME                            = 0x368E,
    CMSG_QUERY_QUEST_COMPLETION_NPCS                  = 0x3173,
    CMSG_QUERY_QUEST_INFO                             = 0x3258,
    CMSG_QUERY_QUEST_REWARDS                          = 0x332D,
    CMSG_QUERY_REALM_NAME                             = 0x368F,
    CMSG_QUERY_SCENARIO_POI                           = 0x3659,
    CMSG_QUERY_TIME                                   = 0x34CC,
    CMSG_QUERY_VOID_STORAGE                           = 0x319D,
    CMSG_QUEST_CONFIRM_ACCEPT                         = 0x349F,
    CMSG_QUEST_GIVER_ACCEPT_QUEST                     = 0x3498,
    CMSG_QUEST_GIVER_CHOOSE_REWARD                    = 0x349B,
    CMSG_QUEST_GIVER_COMPLETE_QUEST                   = 0x3499,
    CMSG_QUEST_GIVER_HELLO                            = 0x3495,
    CMSG_QUEST_GIVER_QUERY_QUEST                      = 0x3496,
    CMSG_QUEST_GIVER_REQUEST_REWARD                   = 0x349C,
    CMSG_QUEST_GIVER_STATUS_MULTIPLE_QUERY            = 0x349E,
    CMSG_QUEST_GIVER_STATUS_QUERY                     = 0x349D,
    CMSG_QUEST_LOG_REMOVE_QUEST                       = 0x3524,
    CMSG_QUEST_POI_QUERY                              = 0x36B3,
    CMSG_QUEST_PUSH_RESULT                            = 0x34A1,
    ...
    CMSG_READY_CHECK_RESPONSE                         = 0x3637,
    CMSG_READ_ITEM                                    = 0x3307,
    CMSG_RECLAIM_CORPSE                               = 0x34D1,
    CMSG_RECRUIT_A_FRIEND                             = 0x36CF,
    CMSG_REDEEM_WOW_TOKEN_CONFIRM                     = 0x36F1,
    CMSG_REDEEM_WOW_TOKEN_START                       = 0x36F0,
    CMSG_REMOVE_NEW_ITEM                              = 0x3330,
    CMSG_REORDER_CHARACTERS                           = 0x35E9,
    CMSG_REPAIR_ITEM                                  = 0x34E2,
    CMSG_REPLACE_TROPHY                               = 0x32E7,
    CMSG_REPOP_REQUEST                                = 0x351C,
    CMSG_REPORT_PVP_PLAYER_AFK                        = 0x34EA,
    CMSG_REQUEST_ACCOUNT_DATA                         = 0x3698,
    CMSG_REQUEST_AREA_POI_UPDATE                      = 0x332F,
    CMSG_REQUEST_BATTLEFIELD_STATUS                   = 0x35DC,
    CMSG_REQUEST_CATEGORY_COOLDOWNS                   = 0x317C,
    CMSG_REQUEST_CEMETERY_LIST                        = 0x3174,
    CMSG_REQUEST_CONQUEST_FORMULA_CONSTANTS           = 0x3296,
    CMSG_REQUEST_CONSUMPTION_CONVERSION_INFO          = 0x36FB,
    CMSG_REQUEST_CROWD_CONTROL_SPELL                  = 0x3520,
    CMSG_REQUEST_FORCED_REACTIONS                     = 0x31F4,
    CMSG_REQUEST_GUILD_PARTY_STATE                    = 0x31A3,
    CMSG_REQUEST_GUILD_REWARDS_LIST                   = 0x31A2,
    CMSG_REQUEST_HONOR_STATS                          = 0x3179,
    CMSG_REQUEST_LFG_LIST_BLACKLIST                   = 0x3287,
    CMSG_REQUEST_PARTY_JOIN_UPDATES                   = 0x35F8,
    CMSG_REQUEST_PARTY_MEMBER_STATS                   = 0x3656,
    CMSG_REQUEST_PET_INFO                             = 0x348F,
    CMSG_REQUEST_PLAYED_TIME                          = 0x3260,
    ...
    CMSG_REQUEST_STABLED_PETS                         = 0x3490,
    CMSG_REQUEST_VEHICLE_EXIT                         = 0x3221,
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                    = 0x3223,
    CMSG_REQUEST_VEHICLE_PREV_SEAT                    = 0x3222,
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                  = 0x3224,
    CMSG_REQUEST_WORLD_QUEST_UPDATE                   = 0x332E,
    CMSG_REQUEST_WOW_TOKEN_MARKET_PRICE               = 0x36E9,
    CMSG_RESET_CHALLENGE_MODE                         = 0x31F1,
    CMSG_RESET_CHALLENGE_MODE_CHEAT                   = 0x31F2,
    CMSG_RESET_INSTANCES                              = 0x366B,
    CMSG_RESURRECT_RESPONSE                           = 0x3687,
    CMSG_REVERT_MONUMENT_APPEARANCE                   = 0x32E9,
    CMSG_RIDE_VEHICLE_INTERACT                        = 0x3225,
    CMSG_SAVE_CLIENT_VARIABLES                        = 0x3702,
    CMSG_SAVE_CUF_PROFILES                            = 0x318A,
    CMSG_SAVE_ENABLED_ADDONS                          = 0x3701,
    CMSG_SAVE_EQUIPMENT_SET                           = 0x3501,
    CMSG_SAVE_GUILD_EMBLEM                            = 0x328B,
    CMSG_SCENE_PLAYBACK_CANCELED                      = 0x320C,
    CMSG_SCENE_PLAYBACK_COMPLETE                      = 0x320B,
    CMSG_SCENE_TRIGGER_EVENT                          = 0x320D,
    CMSG_SELF_RES                                     = 0x3527,
    CMSG_SELL_ITEM                                    = 0x34A3,
    CMSG_SELL_WOW_TOKEN_CONFIRM                       = 0x36EB,
    CMSG_SELL_WOW_TOKEN_START                         = 0x36EA,
    CMSG_SEND_CONTACT_LIST                            = 0x36D1,
    CMSG_SEND_MAIL                                    = 0x35FB,
    CMSG_SEND_SOR_REQUEST_VIA_ADDRESS                 = 0x3623,
    CMSG_SEND_TEXT_EMOTE                              = 0x3486,
    CMSG_SET_ACHIEVEMENTS_HIDDEN                      = 0x3212,
    CMSG_SET_ACTION_BAR_TOGGLES                       = 0x3528,
    CMSG_SET_ACTION_BUTTON                            = 0x3638,
    CMSG_SET_ACTIVE_MOVER                             = 0x3A37,
    CMSG_SET_ADVANCED_COMBAT_LOGGING                  = 0x3297,
    CMSG_SET_ASSISTANT_LEADER                         = 0x3652,
    CMSG_SET_BACKPACK_AUTOSORT_DISABLED               = 0x330A,
    CMSG_SET_BANK_AUTOSORT_DISABLED                   = 0x330B,
    CMSG_SET_BANK_BAG_SLOT_FLAG                       = 0x3309,
    CMSG_SET_CONTACT_NOTES                            = 0x36D4,
    CMSG_SET_CURRENCY_FLAGS                           = 0x3169,
    CMSG_SET_DIFFICULTY_ID                            = 0x320E,
    CMSG_SET_DUNGEON_DIFFICULTY                       = 0x3685,
    CMSG_SET_EVERYONE_IS_ASSISTANT                    = 0x361A,
    CMSG_SET_FACTION_AT_WAR                           = 0x34D4,
    CMSG_SET_FACTION_INACTIVE                         = 0x34D6,
    CMSG_SET_FACTION_NOT_AT_WAR                       = 0x34D5,
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT               = 0x330D,
    CMSG_SET_LFG_BONUS_FACTION_ID                     = 0x3286,
    CMSG_SET_LOOT_METHOD                              = 0x364B,
    CMSG_SET_LOOT_SPECIALIZATION                      = 0x3535,
    CMSG_SET_PARTY_ASSIGNMENT                         = 0x3654,
    CMSG_SET_PARTY_LEADER                             = 0x364D,
    CMSG_SET_PET_SLOT                                 = 0x3168,
    CMSG_SET_PLAYER_DECLINED_NAMES                    = 0x368D,
    CMSG_SET_PREFERRED_CEMETERY                       = 0x3175,
    CMSG_SET_PVP                                      = 0x328F,
    CMSG_SET_RAID_DIFFICULTY                          = 0x36DE,
    CMSG_SET_ROLE                                     = 0x35D9,
    CMSG_SET_SAVED_INSTANCE_EXTEND                    = 0x368B,
    CMSG_SET_SELECTION                                = 0x351E,
    CMSG_SET_SHEATHED                                 = 0x3487,
    CMSG_SET_SORT_BAGS_RIGHT_TO_LEFT                  = 0x330C,
    CMSG_SET_TAXI_BENCHMARK_MODE                      = 0x34E9,
    CMSG_SET_TITLE                                    = 0x3264,
    CMSG_SET_TRADE_CURRENCY                           = 0x3160,
    CMSG_SET_TRADE_GOLD                               = 0x315F,
    CMSG_SET_TRADE_ITEM                               = 0x315D,
    CMSG_SET_USING_PARTY_GARRISON                     = 0x32CD,
    CMSG_SET_WATCHED_FACTION                          = 0x34D7,
    CMSG_SHOW_TRADE_SKILL                             = 0x36C2,
    CMSG_SIGN_PETITION                                = 0x3529,
    CMSG_SILENCE_PARTY_TALKER                         = 0x3655,
    CMSG_SOCKET_GEMS                                  = 0x34E1,
    CMSG_SORT_BAGS                                    = 0x330E,
    CMSG_SORT_BANK_BAGS                               = 0x330F,
    CMSG_SORT_REAGENT_BANK_BAGS                       = 0x3310,
    CMSG_SPELL_CLICK                                  = 0x3494,
    CMSG_SPIRIT_HEALER_ACTIVATE                       = 0x34B0,
    CMSG_SPLIT_ITEM                                   = 0x399E,
    CMSG_STAND_STATE_CHANGE                           = 0x3188,
    CMSG_START_CHALLENGE_MODE                         = 0x3540,
    CMSG_START_SPECTATOR_WAR_GAME                     = 0x35DF,
    CMSG_START_WAR_GAME                               = 0x35DE,
    CMSG_SUMMON_RESPONSE                              = 0x366D,
    ...
    CMSG_TABARD_VENDOR_ACTIVATE                       = 0x328C,
    CMSG_TALK_TO_GOSSIP                               = 0x3491,
    CMSG_TAXI_NODE_STATUS_QUERY                       = 0x34A9,
    CMSG_TAXI_QUERY_AVAILABLE_NODES                   = 0x34AB,
    CMSG_TAXI_REQUEST_EARLY_LANDING                   = 0x34AD,
    ...
    CMSG_TOGGLE_PVP                                   = 0x328E,
    CMSG_TOTEM_DESTROYED                              = 0x34F0,
    CMSG_TRADE_SKILL_SET_FAVORITE                     = 0x332C,
    CMSG_TRAINER_BUY_SPELL                            = 0x34AF,
    CMSG_TRAINER_LIST                                 = 0x34AE,
    CMSG_TRANSMOGRIFY_ITEMS                           = 0x3192,
    CMSG_TURN_IN_PETITION                             = 0x352B,
    CMSG_TUTORIAL                                     = 0x36DF,
    CMSG_TWITTER_CHECK_STATUS                         = 0x312A,
    CMSG_TWITTER_CONNECT                              = 0x3127,
    CMSG_TWITTER_DISCONNECT                           = 0x312B,
    CMSG_TWITTER_POST                                 = 0x3312,
    CMSG_UI_TIME_REQUEST                              = 0x369D,
    CMSG_UNACCEPT_TRADE                               = 0x315B,
    CMSG_UNDELETE_CHARACTER                           = 0x36E1,
    CMSG_UNLEARN_SKILL                                = 0x34DB,
    CMSG_UNLEARN_SPECIALIZATION                       = 0x31A0,
    CMSG_UNLOCK_VOID_STORAGE                          = 0x319C,
    CMSG_UPDATE_ACCOUNT_DATA                          = 0x3699,
    CMSG_UPDATE_AREA_TRIGGER_VISUAL                   = 0x3282,
    CMSG_UPDATE_CLIENT_SETTINGS                       = 0x3667,
    ...
    CMSG_UPGRADE_GARRISON                             = 0x329F,
    CMSG_UPGRADE_ITEM                                 = 0x3213,
    CMSG_USED_FOLLOW                                  = 0x3185,
    CMSG_USE_CRITTER_ITEM                             = 0x322C,
    CMSG_USE_EQUIPMENT_SET                            = 0x3995,
    CMSG_USE_ITEM                                     = 0x327C,
    CMSG_USE_TOY                                      = 0x327E,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_DATA_TIMES                           = 0x274B,
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0x25C4,
    SMSG_ACCOUNT_TOYS_UPDATE                          = 0x25C5,
    SMSG_ACHIEVEMENT_DELETED                          = 0x2720,
    SMSG_ACHIEVEMENT_EARNED                           = 0x2662,
    SMSG_ACTIVATE_TAXI_REPLY                          = 0x26A8,
    SMSG_ACTIVE_GLYPHS                                = 0x2C52,
    SMSG_ADD_BATTLENET_FRIEND_RESPONSE                = 0x265C,
    SMSG_ADD_ITEM_PASSIVE                             = 0x25C0,
    SMSG_ADD_LOSS_OF_CONTROL                          = 0x2698,
    SMSG_ADD_RUNE_POWER                               = 0x26E4,
    SMSG_ADJUST_SPLINE_DURATION                       = 0x25E9,
    SMSG_AE_LOOT_TARGETS                              = 0x262D,
    SMSG_AE_LOOT_TARGET_ACK                           = 0x262E,
    SMSG_AI_REACTION                                  = 0x26E1,
    ...
    SMSG_AREA_POI_UPDATE                              = 0x2844,
    SMSG_AREA_SPIRIT_HEALER_TIME                      = 0x2784,
    SMSG_AREA_TRIGGER_DENIED                          = 0x269F,
    SMSG_AREA_TRIGGER_NO_CORPSE                       = 0x2757,
    SMSG_AREA_TRIGGER_RE_PATH                         = 0x2641,
    SMSG_AREA_TRIGGER_RE_SHAPE                        = 0x263E,
    SMSG_ARENA_CROWD_CONTROL_SPELLS                   = 0x2650,
    SMSG_ARENA_ERROR                                  = 0x2713,
    SMSG_ARENA_PREP_OPPONENT_SPECIALIZATIONS          = 0x2667,
    SMSG_ARTIFACT_FORGE_OPENED                        = 0x27E5,
    SMSG_ARTIFACT_RESPEC_CONFIRM                      = 0x27E8,
    SMSG_ARTIFACT_TRAITS_REFUNDED                     = 0x27E9,
    SMSG_ARTIFACT_XP_GAIN                             = 0x282A,
    SMSG_ATTACKER_STATE_UPDATE                        = 0x27D2,
    SMSG_ATTACK_START                                 = 0x266F,
    SMSG_ATTACK_STOP                                  = 0x2670,
    SMSG_ATTACK_SWING_ERROR                           = 0x2735,
    SMSG_ATTACK_SWING_LANDED_LOG                      = 0x2736,
    SMSG_AUCTION_CLOSED_NOTIFICATION                  = 0x272A,
    SMSG_AUCTION_COMMAND_RESULT                       = 0x2727,
    SMSG_AUCTION_HELLO_RESPONSE                       = 0x2725,
    SMSG_AUCTION_LIST_BIDDER_ITEMS_RESULT             = 0x272E,
    SMSG_AUCTION_LIST_ITEMS_RESULT                    = 0x272C,
    SMSG_AUCTION_LIST_OWNER_ITEMS_RESULT              = 0x272D,
    SMSG_AUCTION_LIST_PENDING_SALES_RESULT            = 0x272F,
    SMSG_AUCTION_OUTBID_NOTIFICATION                  = 0x2729,
    SMSG_AUCTION_OWNER_BID_NOTIFICATION               = 0x272B,
    SMSG_AUCTION_REPLICATE_RESPONSE                   = 0x2726,
    SMSG_AUCTION_WON_NOTIFICATION                     = 0x2728,
    SMSG_AURA_POINTS_DEPLETED                         = 0x2C23,
    SMSG_AURA_UPDATE                                  = 0x2C22,
    SMSG_AUTH_CHALLENGE                               = 0x3048,
    SMSG_AUTH_RESPONSE                                = 0x256C,
    SMSG_BAN_REASON                                   = 0x26B4,
    SMSG_BARBER_SHOP_RESULT                           = 0x26EA,
    ...
    SMSG_BATTLEGROUND_INIT                            = 0x27A2,
    SMSG_BATTLEGROUND_PLAYER_JOINED                   = 0x2599,
    SMSG_BATTLEGROUND_PLAYER_LEFT                     = 0x259A,
    SMSG_BATTLEGROUND_PLAYER_POSITIONS                = 0x2596,
    SMSG_BATTLEGROUND_POINTS                          = 0x27A1,
    SMSG_BATTLENET_CHALLENGE_ABORT                    = 0x27D1,
    SMSG_BATTLENET_CHALLENGE_START                    = 0x27D0,
    SMSG_BATTLENET_NOTIFICATION                       = 0x283F,
    SMSG_BATTLENET_REALM_LIST_TICKET                  = 0x2841,
    SMSG_BATTLENET_RESPONSE                           = 0x283E,
    SMSG_BATTLENET_SET_SESSION_STATE                  = 0x2840,
    SMSG_BATTLE_PAY_ACK_FAILED                        = 0x27C9,
    SMSG_BATTLE_PAY_BATTLE_PET_DELIVERED              = 0x27BE,
    SMSG_BATTLE_PAY_CONFIRM_PURCHASE                  = 0x27C8,
    SMSG_BATTLE_PAY_DELIVERY_ENDED                    = 0x27BC,
    SMSG_BATTLE_PAY_DELIVERY_STARTED                  = 0x27BB,
    SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE               = 0x27BA,
    SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE    = 0x27B8,
    SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE         = 0x27B6,
    SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE        = 0x27B7,
    SMSG_BATTLE_PAY_MOUNT_DELIVERED                   = 0x27BD,
    SMSG_BATTLE_PAY_PURCHASE_UPDATE                   = 0x27C7,
    SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE = 0x27C5,
    SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE           = 0x27C4,
    SMSG_BATTLE_PAY_VAS_BNET_TRANSFER_VALIDATION_RESULT = 0x2856,
    SMSG_BATTLE_PAY_VAS_BOOST_CONSUMED                = 0x27B9,
    SMSG_BATTLE_PAY_VAS_CHARACTER_LIST                = 0x282D,
    SMSG_BATTLE_PAY_VAS_CHARACTER_QUEUE_STATUS        = 0x2855,
    SMSG_BATTLE_PAY_VAS_PURCHASE_COMPLETE             = 0x2830,
    SMSG_BATTLE_PAY_VAS_PURCHASE_LIST                 = 0x2831,
    SMSG_BATTLE_PAY_VAS_PURCHASE_STARTED              = 0x282F,
    SMSG_BATTLE_PAY_VAS_REALM_LIST                    = 0x282E,
    SMSG_BATTLE_PAY_VAS_TRANSFER_QUEUE_STATUS         = 0x2854,
    SMSG_BATTLE_PETS_HEALED                           = 0x260A,
    SMSG_BATTLE_PET_CAGE_DATE_ERROR                   = 0x26A2,
    ...
    SMSG_BOSS_KILL_CREDIT                             = 0x27C3,
    SMSG_BREAK_TARGET                                 = 0x266E,
    SMSG_BUY_FAILED                                   = 0x26F3,
    SMSG_BUY_SUCCEEDED                                = 0x26F2,
    SMSG_CACHE_INFO                                   = 0x2745,
    SMSG_CACHE_VERSION                                = 0x2744,
    SMSG_CALENDAR_CLEAR_PENDING_ACTION                = 0x26C8,
    SMSG_CALENDAR_COMMAND_RESULT                      = 0x26C9,
    SMSG_CALENDAR_EVENT_INITIAL_INVITES               = 0x26B8,
    SMSG_CALENDAR_EVENT_INVITE                        = 0x26B9,
    SMSG_CALENDAR_EVENT_INVITE_ALERT                  = 0x26BA,
    SMSG_CALENDAR_EVENT_INVITE_MODERATOR_STATUS       = 0x26BD,
    SMSG_CALENDAR_EVENT_INVITE_NOTES                  = 0x26C2,
    SMSG_CALENDAR_EVENT_INVITE_NOTES_ALERT            = 0x26C3,
    SMSG_CALENDAR_EVENT_INVITE_REMOVED                = 0x26BE,
    SMSG_CALENDAR_EVENT_INVITE_REMOVED_ALERT          = 0x26BF,
    SMSG_CALENDAR_EVENT_INVITE_STATUS                 = 0x26BB,
    SMSG_CALENDAR_EVENT_INVITE_STATUS_ALERT           = 0x26BC,
    SMSG_CALENDAR_EVENT_REMOVED_ALERT                 = 0x26C0,
    SMSG_CALENDAR_EVENT_UPDATED_ALERT                 = 0x26C1,
    SMSG_CALENDAR_RAID_LOCKOUT_ADDED                  = 0x26C4,
    SMSG_CALENDAR_RAID_LOCKOUT_REMOVED                = 0x26C5,
    SMSG_CALENDAR_RAID_LOCKOUT_UPDATED                = 0x26C6,
    SMSG_CALENDAR_SEND_CALENDAR                       = 0x26B6,
    SMSG_CALENDAR_SEND_EVENT                          = 0x26B7,
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x26C7,
    SMSG_CAMERA_EFFECT                                = 0x2769,
    SMSG_CANCEL_AUTO_REPEAT                           = 0x2714,
    SMSG_CANCEL_COMBAT                                = 0x2733,
    ...
    SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE              = 0x2624,
    ...
    SMSG_CHANGE_PLAYER_DIFFICULTY_RESULT              = 0x2737,
    SMSG_CHANNEL_LIST                                 = 0x2BC3,
    SMSG_CHANNEL_NOTIFY                               = 0x2BC0,
    SMSG_CHANNEL_NOTIFY_JOINED                        = 0x2BC1,
    SMSG_CHANNEL_NOTIFY_LEFT                          = 0x2BC2,
    SMSG_CHARACTER_CLASS_TRIAL_CREATE                 = 0x2802,
    SMSG_CHARACTER_ITEM_FIXUP                         = 0x2850,
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x2746,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x27CF,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x27A8,
    SMSG_CHARACTER_UPGRADE_COMPLETE                   = 0x2801,
    SMSG_CHARACTER_UPGRADE_QUEUED                     = 0x2800,
    SMSG_CHARACTER_UPGRADE_SPELL_TIER_SET             = 0x25F5,
    SMSG_CHARACTER_UPGRADE_STARTED                    = 0x27FF,
    SMSG_CHARACTER_UPGRADE_UNREVOKE_RESULT            = 0x2803,
    SMSG_CHAR_CUSTOMIZE                               = 0x271B,
    SMSG_CHAR_CUSTOMIZE_FAILED                        = 0x271A,
    SMSG_CHAR_FACTION_CHANGE_RESULT                   = 0x27ED,
    SMSG_CHAT                                         = 0x2BAD,
    ...
    SMSG_CLEAR_COOLDOWN                               = 0x26E6,
    SMSG_CLEAR_COOLDOWNS                              = 0x2C26,
    SMSG_CLEAR_LOSS_OF_CONTROL                        = 0x269A,
    SMSG_CLEAR_SPELL_CHARGES                          = 0x2C28,
    SMSG_CLEAR_TARGET                                 = 0x26DD,
    SMSG_COIN_REMOVED                                 = 0x262C,
    SMSG_COMBAT_EVENT_FAILED                          = 0x2671,
    SMSG_COMMENTATOR_MAP_INFO                         = 0x2748,
    SMSG_COMMENTATOR_PLAYER_INFO                      = 0x2749,
    SMSG_COMMENTATOR_STATE_CHANGED                    = 0x2747,
    SMSG_COMPLAINT_RESULT                             = 0x26D5,
    SMSG_COMPLETE_SHIPMENT_RESPONSE                   = 0x27E1,
    SMSG_CONNECT_TO                                   = 0x304D,
    SMSG_CONQUEST_FORMULA_CONSTANTS                   = 0x27CA,
    SMSG_CONSOLE_WRITE                                = 0x2653,
    SMSG_CONSUMPTION_CONVERSION_INFO_RESPONSE         = 0x2845,
    SMSG_CONSUMPTION_CONVERSION_RESULT                = 0x2846,
    SMSG_CONTACT_LIST                                 = 0x27CD,
    SMSG_CONTROL_UPDATE                               = 0x2666,
    SMSG_COOLDOWN_CHEAT                               = 0x277D,
    SMSG_COOLDOWN_EVENT                               = 0x26E5,
    SMSG_CORPSE_LOCATION                              = 0x266D,
    SMSG_CORPSE_RECLAIM_DELAY                         = 0x2790,
    SMSG_CORPSE_TRANSPORT_QUERY                       = 0x2753,
    SMSG_CREATE_CHAR                                  = 0x2740,
    SMSG_CREATE_SHIPMENT_RESPONSE                     = 0x27E0,
    SMSG_CRITERIA_DELETED                             = 0x271F,
    SMSG_CRITERIA_UPDATE                              = 0x2719,
    SMSG_CROSSED_INEBRIATION_THRESHOLD                = 0x26EE,
    SMSG_CUSTOM_LOAD_SCREEN                           = 0x25E4,
    SMSG_DAILY_QUESTS_RESET                           = 0x2A80,
    SMSG_DAMAGE_CALC_LOG                              = 0x280A,
    SMSG_DANCE_STUDIO_CREATE_RESULT                   = 0x27A5,
    SMSG_DB_REPLY                                     = 0x25A1,
    SMSG_DEATH_RELEASE_LOC                            = 0x2707,
    SMSG_DEFENSE_MESSAGE                              = 0x2BB6,
    SMSG_DELETE_CHAR                                  = 0x2741,
    SMSG_DESTROY_ARENA_UNIT                           = 0x2786,
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0x2734,
    SMSG_DIFFERENT_INSTANCE_FROM_PARTY                = 0x258B,
    SMSG_DISENCHANT_CREDIT                            = 0x25BD,
    SMSG_DISMOUNT                                     = 0x26DC,
    SMSG_DISMOUNT_RESULT                              = 0x257C,
    SMSG_DISPEL_FAILED                                = 0x2C30,
    SMSG_DISPLAY_GAME_ERROR                           = 0x25B6,
    SMSG_DISPLAY_PLAYER_CHOICE                        = 0x26A3,
    ...
    SMSG_DUEL_COMPLETE                                = 0x2676,
    SMSG_DUEL_COUNTDOWN                               = 0x2675,
    SMSG_DUEL_IN_BOUNDS                               = 0x2674,
    SMSG_DUEL_OUT_OF_BOUNDS                           = 0x2673,
    SMSG_DUEL_REQUESTED                               = 0x2672,
    SMSG_DUEL_WINNER                                  = 0x2677,
    SMSG_DURABILITY_DAMAGE_DEATH                      = 0x278C,
    SMSG_EMOTE                                        = 0x280B,
    SMSG_ENABLE_BARBER_SHOP                           = 0x26E9,
    SMSG_ENABLE_ENCRYPTION                            = 0x3049,
    SMSG_ENCHANTMENT_LOG                              = 0x2754,
    SMSG_ENCOUNTER_END                                = 0x27C2,
    SMSG_ENCOUNTER_START                              = 0x27C1,
    SMSG_ENUM_CHARACTERS_RESULT                       = 0x2583,
    SMSG_ENVIRONMENTAL_DAMAGE_LOG                     = 0x2C21,
    SMSG_EQUIPMENT_SET_ID                             = 0x26DE,
    SMSG_EXPECTED_SPAM_RECORDS                        = 0x2BB1,
    SMSG_EXPLORATION_EXPERIENCE                       = 0x27A4,
    SMSG_FACTION_BONUS_INFO                           = 0x2768,
    SMSG_FAILED_PLAYER_CONDITION                      = 0x25E3,
    SMSG_FEATURE_SYSTEM_STATUS                        = 0x25D2,
    SMSG_FEATURE_SYSTEM_STATUS_GLUE_SCREEN            = 0x25D3,
    SMSG_FEIGN_DEATH_RESISTED                         = 0x2789,
    SMSG_FISH_ESCAPED                                 = 0x26FB,
    SMSG_FISH_NOT_HOOKED                              = 0x26FA,
    SMSG_FLIGHT_SPLINE_SYNC                           = 0x2DF7,
    SMSG_FORCED_DEATH_UPDATE                          = 0x2708,
    SMSG_FORCE_ANIM                                   = 0x2796,
    SMSG_FORCE_OBJECT_RELINK                          = 0x2669,
    SMSG_FRIEND_STATUS                                = 0x27CE,
    ...
    SMSG_GAME_OBJECT_RESET_STATE                      = 0x275F,
    SMSG_GAME_OBJECT_SET_STATE                        = 0x283D,
    SMSG_GAME_OBJECT_UI_ACTION                        = 0x275C,
    SMSG_GAME_SPEED_SET                               = 0x26AC,
    SMSG_GAME_TIME_SET                                = 0x274D,
    SMSG_GAME_TIME_UPDATE                             = 0x274C,
    ...
    SMSG_GARRISON_LANDING_PAGE_SHIPMENT_INFO          = 0x27E3,
    ...
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT            = 0x27A6,
    SMSG_GARRISON_SCOUTING_MAP_RESULT                 = 0x2837,
    SMSG_GET_DISPLAYED_TROPHY_LIST_RESPONSE           = 0x2928,
    SMSG_GET_GARRISON_INFO_RESULT                     = 0x28F0,
    SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE               = 0x27E2,
    SMSG_GET_SHIPMENT_INFO_RESPONSE                   = 0x27DE,
    SMSG_GET_TROPHY_LIST_RESPONSE                     = 0x2806,
    SMSG_GM_PLAYER_INFO                               = 0x277C,
    SMSG_GM_REQUEST_PLAYER_INFO                       = 0x25EE,
    SMSG_GM_TICKET_CASE_STATUS                        = 0x26CE,
    SMSG_GM_TICKET_SYSTEM_STATUS                      = 0x26CD,
    SMSG_GOD_MODE                                     = 0x273A,
    SMSG_GOSSIP_COMPLETE                              = 0x2A96,
    SMSG_GOSSIP_MESSAGE                               = 0x2A97,
    SMSG_GOSSIP_POI                                   = 0x27DB,
    SMSG_GROUP_ACTION_THROTTLED                       = 0x259D,
    SMSG_GROUP_DECLINE                                = 0x27D6,
    SMSG_GROUP_DESTROYED                              = 0x27D8,
    SMSG_GROUP_INVITE_CONFIRMATION                    = 0x2851,
    SMSG_GROUP_NEW_LEADER                             = 0x264B,
    SMSG_GROUP_UNINVITE                               = 0x27D7,
    ...
    SMSG_HEALTH_UPDATE                                = 0x26FE,
    SMSG_HIGHEST_THREAT_UPDATE                        = 0x270E,
    SMSG_HOTFIXES                                     = 0x25A3,
    SMSG_HOTFIX_LIST                                  = 0x25A2,
    SMSG_HOTFIX_QUERY_RESPONSE                        = 0x25A4,
    SMSG_INITIALIZE_FACTIONS                          = 0x2767,
    SMSG_INITIAL_SETUP                                = 0x2580,
    SMSG_INIT_WORLD_STATES                            = 0x278D,
    SMSG_INSPECT_HONOR_STATS                          = 0x25B3,
    SMSG_INSPECT_PVP                                  = 0x2763,
    SMSG_INSPECT_RESULT                               = 0x264F,
    SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY           = 0x27F3,
    SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT            = 0x27F2,
    SMSG_INSTANCE_ENCOUNTER_END                       = 0x27FA,
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT               = 0x27F1,
    SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE = 0x27FC,
    SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION    = 0x27FB,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE        = 0x27F6,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START           = 0x27F5,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE          = 0x27F9,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED       = 0x27FD,
    SMSG_INSTANCE_ENCOUNTER_SET_SUPPRESSING_RELEASE   = 0x27F8,
    SMSG_INSTANCE_ENCOUNTER_START                     = 0x27F7,
    SMSG_INSTANCE_ENCOUNTER_TIMER_START               = 0x27F4,
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                  = 0x2738,
    SMSG_INSTANCE_INFO                                = 0x2652,
    SMSG_INSTANCE_RESET                               = 0x26B1,
    SMSG_INSTANCE_RESET_FAILED                        = 0x26B2,
    SMSG_INSTANCE_SAVE_CREATED                        = 0x27C0,
    SMSG_INVALIDATE_PAGE_TEXT                         = 0x2703,
    SMSG_INVALIDATE_PLAYER                            = 0x26D4,
    SMSG_INVALID_PROMOTION_CODE                       = 0x2797,
    SMSG_INVENTORY_CHANGE_FAILURE                     = 0x2765,
    SMSG_IS_QUEST_COMPLETE_RESPONSE                   = 0x2A83,
    SMSG_ITEM_CHANGED                                 = 0x2722,
    SMSG_ITEM_COOLDOWN                                = 0x2809,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                     = 0x2799,
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x25B2,
    SMSG_ITEM_PURCHASE_REFUND_RESULT                  = 0x25B0,
    SMSG_ITEM_PUSH_RESULT                             = 0x2639,
    SMSG_ITEM_TIME_UPDATE                             = 0x2798,
    SMSG_KICK_REASON                                  = 0x282C,
    SMSG_LEARNED_SPELLS                               = 0x2C4C,
    SMSG_LEARN_PVP_TALENTS_FAILED                     = 0x25EB,
    SMSG_LEARN_TALENTS_FAILED                         = 0x25EA,
    SMSG_LEVEL_UPDATE                                 = 0x2588,
    SMSG_LEVEL_UP_INFO                                = 0x2721,
    ...
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT           = 0x27B4,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT            = 0x27B2,
    SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT = 0x27A7,
    SMSG_LOAD_CUF_PROFILES                            = 0x25CF,
    SMSG_LOAD_EQUIPMENT_SET                           = 0x274F,
    SMSG_LOAD_SELECTED_TROPHY_RESULT                  = 0x2807,
    SMSG_LOGIN_SET_TIME_SPEED                         = 0x274E,
    SMSG_LOGIN_VERIFY_WORLD                           = 0x25AD,
    SMSG_LOGOUT_CANCEL_ACK                            = 0x26B0,
    SMSG_LOGOUT_COMPLETE                              = 0x26AF,
    SMSG_LOGOUT_RESPONSE                              = 0x26AE,
    SMSG_LOG_XP_GAIN                                  = 0x271D,
    SMSG_LOOT_ALL_PASSED                              = 0x2637,
    SMSG_LOOT_ITEM_LIST                               = 0x2635,
    SMSG_LOOT_LIST                                    = 0x2785,
    SMSG_LOOT_MONEY_NOTIFY                            = 0x2631,
    SMSG_LOOT_RELEASE                                 = 0x2630,
    SMSG_LOOT_RELEASE_ALL                             = 0x262F,
    SMSG_LOOT_REMOVED                                 = 0x262A,
    SMSG_LOOT_RESPONSE                                = 0x2629,
    SMSG_LOOT_ROLL                                    = 0x2633,
    SMSG_LOOT_ROLLS_COMPLETE                          = 0x2636,
    SMSG_LOOT_ROLL_WON                                = 0x2638,
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                  = 0x2697,
    SMSG_MAIL_COMMAND_RESULT                          = 0x265A,
    SMSG_MAIL_LIST_RESULT                             = 0x279A,
    SMSG_MAIL_QUERY_NEXT_TIME_RESULT                  = 0x279B,
    SMSG_MAP_OBJECTIVES_INIT                          = 0x27A3,
    SMSG_MAP_OBJ_EVENTS                               = 0x25DA,
    SMSG_MASTER_LOOT_CANDIDATE_LIST                   = 0x2634,
    SMSG_MESSAGE_BOX                                  = 0x2575,
    SMSG_MINIMAP_PING                                 = 0x26F9,
    SMSG_MIRROR_IMAGE_COMPONENTED_DATA                = 0x2C14,
    SMSG_MIRROR_IMAGE_CREATURE_DATA                   = 0x2C13,
    SMSG_MISSILE_CANCEL                               = 0x25DB,
    SMSG_MODIFY_CHARGE_RECOVERY_SPEED                 = 0x27AB,
    SMSG_MODIFY_COOLDOWN                              = 0x27A9,
    SMSG_MODIFY_COOLDOWN_RECOVERY_SPEED               = 0x27AA,
    SMSG_MODIFY_PARTY_RANGE                           = 0x2788,
    SMSG_MOTD                                         = 0x2BAF,
    ...
    SMSG_NEW_TAXI_PATH                                = 0x26A9,
    SMSG_NEW_WORLD                                    = 0x25AC,
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST                   = 0x2C42,
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION          = 0x26D3,
    SMSG_NOTIFY_MONEY                                 = 0x25AF,
    SMSG_NOTIFY_RECEIVED_MAIL                         = 0x265B,
    SMSG_OFFER_PETITION_ERROR                         = 0x26E2,
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA         = 0x271E,
    SMSG_ON_MONSTER_MOVE                              = 0x2DA2,
    SMSG_OPEN_CONTAINER                               = 0x2766,
    SMSG_OPEN_LFG_DUNGEON_FINDER                      = 0x2A32,
    SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP                = 0x27DD,
    SMSG_OPEN_SHIPMENT_NPC_RESULT                     = 0x27DF,
    SMSG_OPEN_TRANSMOGRIFIER                          = 0x2833,
    SMSG_OVERRIDE_LIGHT                               = 0x26E8,
    SMSG_PAGE_TEXT                                    = 0x275B,
    SMSG_PARTY_COMMAND_RESULT                         = 0x27DA,
    SMSG_PARTY_INVITE                                 = 0x25D0,
    SMSG_PARTY_KILL_LOG                               = 0x279F,
    SMSG_PARTY_MEMBER_STATE                           = 0x279D,
    SMSG_PARTY_MEMBER_STATE_UPDATE                    = 0x279C,
    SMSG_PARTY_UPDATE                                 = 0x260C,
    SMSG_PAUSE_MIRROR_TIMER                           = 0x2751,
    SMSG_PENDING_RAID_LOCK                            = 0x2732,
    SMSG_PETITION_ALREADY_SIGNED                      = 0x25B9,
    SMSG_PETITION_RENAME_GUILD_RESPONSE               = 0x29F7,
    SMSG_PETITION_SHOW_LIST                           = 0x26EB,
    SMSG_PETITION_SHOW_SIGNATURES                     = 0x26EC,
    SMSG_PETITION_SIGN_RESULTS                        = 0x2791,
    SMSG_PET_ACTION_FEEDBACK                          = 0x278F,
    SMSG_PET_ACTION_SOUND                             = 0x26CB,
    SMSG_PET_ADDED                                    = 0x25A9,
    SMSG_PET_BATTLE_CHAT_RESTRICTED                   = 0x2619,
    SMSG_PET_BATTLE_DEBUG_QUEUE_DUMP_RESPONSE         = 0x269E,
    ...
    SMSG_PET_DISMISS_SOUND                            = 0x26CC,
    SMSG_PET_GOD_MODE                                 = 0x26A6,
    SMSG_PET_GUIDS                                    = 0x2743,
    SMSG_PET_LEARNED_SPELLS                           = 0x2C4E,
    SMSG_PET_MODE                                     = 0x258A,
    SMSG_PET_NAME_INVALID                             = 0x26F0,
    SMSG_PET_SLOT_UPDATED                             = 0x2589,
    SMSG_PET_SPELLS_MESSAGE                           = 0x2C25,
    SMSG_PET_STABLE_LIST                              = 0x25AA,
    SMSG_PET_STABLE_RESULT                            = 0x25AB,
    SMSG_PET_TAME_FAILURE                             = 0x26DF,
    SMSG_PET_UNLEARNED_SPELLS                         = 0x2C4F,
    SMSG_PHASE_SHIFT_CHANGE                           = 0x2578,
    SMSG_PLAYED_TIME                                  = 0x270A,
    SMSG_PLAYER_BOUND                                 = 0x257E,
    SMSG_PLAYER_SAVE_GUILD_EMBLEM                     = 0x29F6,
    SMSG_PLAYER_SKINNED                               = 0x278A,
    SMSG_PLAYER_TABARD_VENDOR_ACTIVATE                = 0x279E,
    SMSG_PLAY_MUSIC                                   = 0x27AE,
    SMSG_PLAY_OBJECT_SOUND                            = 0x27AF,
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                       = 0x2774,
    SMSG_PLAY_ORPHAN_SPELL_VISUAL                     = 0x2C46,
    SMSG_PLAY_SCENE                                   = 0x2655,
    SMSG_PLAY_SOUND                                   = 0x27AD,
    SMSG_PLAY_SPEAKERBOT_SOUND                        = 0x27B0,
    SMSG_PLAY_SPELL_VISUAL                            = 0x2C44,
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x2C48,
    SMSG_PLAY_TIME_WARNING                            = 0x273C,
    SMSG_PONG                                         = 0x304E,
    SMSG_POWER_UPDATE                                 = 0x26FF,
    SMSG_PRESTIGE_AND_HONOR_INVOLUNTARILY_CHANGED     = 0x275A,
    SMSG_PRE_RESSURECT                                = 0x27AC,
    SMSG_PRINT_NOTIFICATION                           = 0x25E2,
    SMSG_PROC_RESIST                                  = 0x27A0,
    SMSG_PROPOSE_LEVEL_GRANT                          = 0x2712,
    SMSG_PUSH_SPELL_TO_ACTION_BAR                     = 0x2C50,
    SMSG_PVP_CREDIT                                   = 0x2718,
    SMSG_PVP_LOG_DATA                                 = 0x25B4,
    SMSG_PVP_OPTIONS_ENABLED                          = 0x25B7,
    SMSG_PVP_SEASON                                   = 0x25D4,
    SMSG_QUERY_BATTLE_PET_NAME_RESPONSE               = 0x2705,
    SMSG_QUERY_CREATURE_RESPONSE                      = 0x26FC,
    SMSG_QUERY_GAME_OBJECT_RESPONSE                   = 0x26FD,
    SMSG_QUERY_GARRISON_CREATURE_NAME_RESPONSE        = 0x292B,
    SMSG_QUERY_GUILD_INFO_RESPONSE                    = 0x29E5,
    SMSG_QUERY_ITEM_TEXT_RESPONSE                     = 0x2808,
    SMSG_QUERY_NPC_TEXT_RESPONSE                      = 0x2700,
    SMSG_QUERY_PAGE_TEXT_RESPONSE                     = 0x2702,
    SMSG_QUERY_PETITION_RESPONSE                      = 0x2706,
    SMSG_QUERY_PET_NAME_RESPONSE                      = 0x2704,
    SMSG_QUERY_PLAYER_NAME_RESPONSE                   = 0x2701,
    SMSG_QUERY_QUEST_INFO_RESPONSE                    = 0x2A95,
    SMSG_QUERY_QUEST_REWARD_RESPONSE                  = 0x2842,
    SMSG_QUERY_TIME_RESPONSE                          = 0x271C,
    ...
    SMSG_QUEST_GIVER_QUEST_TURN_IN_FAILURE            = 0x284E,
    ...
    SMSG_RAF_EMAIL_ENABLED_RESPONSE                   = 0x27CB,
    SMSG_RAID_DIFFICULTY_SET                          = 0x27EE,
    SMSG_RAID_GROUP_ONLY                              = 0x27F0,
    ...
    SMSG_READ_ITEM_RESULT_FAILED                      = 0x27EA,
    SMSG_READ_ITEM_RESULT_OK                          = 0x27E4,
    SMSG_REALM_QUERY_RESPONSE                         = 0x26E7,
    SMSG_RECRUIT_A_FRIEND_RESPONSE                    = 0x27CC,
    SMSG_REFER_A_FRIEND_EXPIRED                       = 0x2764,
    SMSG_REFER_A_FRIEND_FAILURE                       = 0x26ED,
    SMSG_REFRESH_COMPONENT                            = 0x267A,
    SMSG_REFRESH_SPELL_HISTORY                        = 0x2C2C,
    SMSG_REMOVE_ITEM_PASSIVE                          = 0x25C1,
    SMSG_REMOVE_LOSS_OF_CONTROL                       = 0x2699,
    SMSG_REPLACE_TROPHY_RESPONSE                      = 0x2805,
    SMSG_REPORT_PVP_PLAYER_AFK_RESULT                 = 0x26DB,
    ...
    SMSG_RESET_FAILED_NOTIFY                          = 0x26E3,
    SMSG_RESET_RANGED_COMBAT_TIMER                    = 0x2715,
    SMSG_RESET_WEEKLY_CURRENCY                        = 0x2574,
    SMSG_RESPEC_WIPE_CONFIRM                          = 0x2627,
    ...
    SMSG_SERVER_TIME                                  = 0x26AD,
    SMSG_SETUP_CURRENCY                               = 0x2572,
    SMSG_SETUP_RESEARCH_HISTORY                       = 0x2585,
    SMSG_SET_AI_ANIM_KIT                              = 0x2773,
    SMSG_SET_ALL_TASK_PROGRESS                        = 0x27D4,
    SMSG_SET_ANIM_TIER                                = 0x2777,
    SMSG_SET_CURRENCY                                 = 0x2573,
    SMSG_SET_DF_FAST_LAUNCH_RESULT                    = 0x2A2E,
    SMSG_SET_DUNGEON_DIFFICULTY                       = 0x26CF,
    SMSG_SET_FACTION_AT_WAR                           = 0x273E,
    SMSG_SET_FACTION_NOT_VISIBLE                      = 0x276E,
    SMSG_SET_FACTION_STANDING                         = 0x276F,
    SMSG_SET_FACTION_VISIBLE                          = 0x276D,
    SMSG_SET_FLAT_SPELL_MODIFIER                      = 0x2C36,
    SMSG_SET_FORCED_REACTIONS                         = 0x275E,
    SMSG_SET_ITEM_PURCHASE_DATA                       = 0x25B1,
    SMSG_SET_LOOT_METHOD_FAILED                       = 0x2814,
    SMSG_SET_MAX_WEEKLY_QUANTITY                      = 0x25B8,
    SMSG_SET_MELEE_ANIM_KIT                           = 0x2776,
    SMSG_SET_MOVEMENT_ANIM_KIT                        = 0x2775,
    SMSG_SET_PCT_SPELL_MODIFIER                       = 0x2C37,
    SMSG_SET_PET_SPECIALIZATION                       = 0x2643,
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT             = 0x2709,
    SMSG_SET_PLAY_HOVER_ANIM                          = 0x25CD,
    SMSG_SET_PROFICIENCY                              = 0x2778,
    SMSG_SET_SPELL_CHARGES                            = 0x2C29,
    SMSG_SET_TASK_COMPLETE                            = 0x27D5,
    SMSG_SET_TIME_ZONE_INFORMATION                    = 0x26A1,
    SMSG_SET_VEHICLE_REC_ID                           = 0x2731,
    SMSG_SHOW_ADVENTURE_MAP                           = 0x2832,
    SMSG_SHOW_BANK                                    = 0x26AA,
    SMSG_SHOW_MAILBOX                                 = 0x27EC,
    SMSG_SHOW_NEUTRAL_PLAYER_FACTION_SELECT_UI        = 0x25F1,
    SMSG_SHOW_TAXI_NODES                              = 0x26F8,
    SMSG_SHOW_TRADE_SKILL_RESPONSE                    = 0x27B5,
    SMSG_SOCKET_GEMS                                  = 0x276A,
    SMSG_SOCKET_GEMS_FAILURE                          = 0x276B,
    SMSG_SORT_BAGS_RESULT                             = 0x2822,
    SMSG_SOR_START_EXPERIENCE_INCOMPLETE              = 0x25F3,
    SMSG_SPECIALIZATION_CHANGED                       = 0x25ED,
    SMSG_SPECIAL_MOUNT_ANIM                           = 0x26CA,
    SMSG_SPEC_INVOLUNTARILY_CHANGED                   = 0x2759,
    ...
    SMSG_SPIRIT_HEALER_CONFIRM                        = 0x2756,
    SMSG_STAND_STATE_UPDATE                           = 0x275D,
    SMSG_START_ELAPSED_TIMER                          = 0x261B,
    SMSG_START_ELAPSED_TIMERS                         = 0x261D,
    SMSG_START_LOOT_ROLL                              = 0x2632,
    SMSG_START_MIRROR_TIMER                           = 0x2750,
    SMSG_START_TIMER                                  = 0x25BC,
    SMSG_STOP_ELAPSED_TIMER                           = 0x261C,
    SMSG_STOP_MIRROR_TIMER                            = 0x2752,
    SMSG_STOP_SPEAKERBOT_SOUND                        = 0x27B1,
    SMSG_STREAMING_MOVIES                             = 0x25BB,
    SMSG_SUMMON_CANCEL                                = 0x26DA,
    SMSG_SUMMON_RAID_MEMBER_VALIDATE_FAILED           = 0x258F,
    SMSG_SUMMON_REQUEST                               = 0x2762,
    SMSG_SUPERCEDED_SPELLS                            = 0x2C4B,
    SMSG_SUSPEND_COMMS                                = 0x304A,
    SMSG_SUSPEND_TOKEN                                = 0x25BE,
    SMSG_TALENTS_INVOLUNTARILY_RESET                  = 0x2758,
    SMSG_TAXI_NODE_STATUS                             = 0x26A7,
    SMSG_TEXT_EMOTE                                   = 0x26A5,
    SMSG_THREAT_CLEAR                                 = 0x2711,
    SMSG_THREAT_REMOVE                                = 0x2710,
    SMSG_THREAT_UPDATE                                = 0x270F,
    SMSG_TIME_ADJUSTMENT                              = 0x2DA1,
    SMSG_TIME_SYNC_REQUEST                            = 0x2DA0,
    SMSG_TITLE_EARNED                                 = 0x270C,
    SMSG_TITLE_LOST                                   = 0x270D,
    SMSG_TOTEM_CREATED                                = 0x26F4,
    SMSG_TOTEM_MOVED                                  = 0x26F5,
    SMSG_TRADE_STATUS                                 = 0x2582,
    SMSG_TRADE_UPDATED                                = 0x2581,
    SMSG_TRAINER_BUY_FAILED                           = 0x2717,
    SMSG_TRAINER_LIST                                 = 0x2716,
    SMSG_TRANSFER_ABORTED                             = 0x2742,
    SMSG_TRANSFER_PENDING                             = 0x25E6,
    SMSG_TRANSMOG_COLLECTION_UPDATE                   = 0x25C7,
    SMSG_TRANSMOG_SET_COLLECTION_UPDATE               = 0x25C8,
    SMSG_TRIGGER_CINEMATIC                            = 0x280C,
    SMSG_TRIGGER_MOVIE                                = 0x26F6,
    SMSG_TURN_IN_PETITION_RESULT                      = 0x2793,
    SMSG_TUTORIAL_FLAGS                               = 0x27FE,
    SMSG_TUTORIAL_HIGHLIGHT_SPELL                     = 0x283C,
    SMSG_TUTORIAL_UNHIGHLIGHT_SPELL                   = 0x283B,
    SMSG_TWITTER_STATUS                               = 0x2FFD,
    SMSG_UI_TIME                                      = 0x2755,
    SMSG_UNDELETE_CHARACTER_RESPONSE                  = 0x280F,
    SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE            = 0x2810,
    SMSG_UNLEARNED_SPELLS                             = 0x2C4D,
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x274A,
    SMSG_UPDATE_ACTION_BUTTONS                        = 0x25F6,
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x2804,
    SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT            = 0x2A31,
    SMSG_UPDATE_EXPANSION_LEVEL                       = 0x2665,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x26D2,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x26B3,
    SMSG_UPDATE_OBJECT                                = 0x280D,
    SMSG_UPDATE_TALENT_DATA                           = 0x25EC,
    SMSG_UPDATE_TASK_PROGRESS                         = 0x27D3,
    SMSG_UPDATE_WEEKLY_SPELL_USAGE                    = 0x2C19,
    SMSG_UPDATE_WORLD_STATE                           = 0x278E,
    SMSG_USERLIST_ADD                                 = 0x2BB9,
    SMSG_USERLIST_REMOVE                              = 0x2BBA,
    SMSG_USERLIST_UPDATE                              = 0x2BBB,
    SMSG_USE_EQUIPMENT_SET_RESULT                     = 0x2794,
    SMSG_VENDOR_INVENTORY                             = 0x25CB,
    SMSG_VIGNETTE_UPDATE                              = 0x27B3,
    ...
    SMSG_WHO                                          = 0x2BAE,
    SMSG_WHO_IS                                       = 0x26D0,
    SMSG_WORLD_QUEST_UPDATE                           = 0x2843,
    SMSG_WORLD_SERVER_INFO                            = 0x25C3,
    SMSG_WORLD_TEXT                                   = 0x282B,
    SMSG_WOW_TOKEN_AUCTION_SOLD                       = 0x281A,
    SMSG_WOW_TOKEN_BUY_REQUEST_CONFIRMATION           = 0x281C,
    SMSG_WOW_TOKEN_BUY_RESULT_CONFIRMATION            = 0x281D,
    SMSG_WOW_TOKEN_CAN_REDEEM_FOR_BALANCE_RESULT      = 0x2852,
    SMSG_WOW_TOKEN_CAN_VETERAN_BUY_RESULT             = 0x281B,
    SMSG_WOW_TOKEN_DISTRIBUTION_GLUE_UPDATE           = 0x2815,
    SMSG_WOW_TOKEN_DISTRIBUTION_UPDATE                = 0x2816,
    SMSG_WOW_TOKEN_MARKET_PRICE_RESPONSE              = 0x2817,
    SMSG_WOW_TOKEN_REDEEM_GAME_TIME_UPDATED           = 0x281E,
    SMSG_WOW_TOKEN_REDEEM_REQUEST_CONFIRMATION        = 0x281F,
    SMSG_WOW_TOKEN_REDEEM_RESULT                      = 0x2820,
    SMSG_WOW_TOKEN_SELL_REQUEST_CONFIRMATION          = 0x2818,
    SMSG_WOW_TOKEN_SELL_RESULT_CONFIRMATION           = 0x2819,
    SMSG_WOW_TOKEN_UPDATE_AUCTIONABLE_LIST_RESPONSE   = 0x2821,
    SMSG_XP_GAIN_ABORTED                              = 0x25E1,
    SMSG_XP_GAIN_ENABLED                              = 0x27EF,
