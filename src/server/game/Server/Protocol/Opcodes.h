...
enum Opcodes
{
    ...
    MSG_BATTLEGROUND_PLAYER_POSITIONS                 = 0x3902,
    ...
    MSG_GUILD_EVENT_LOG_QUERY                         = 0x10B2,
    ...
    SMSG_CALENDAR_ARENA_TEAM                          = 0x0615,//may be reversed with SMSG_CALENDAR_FILTER_GUILD
