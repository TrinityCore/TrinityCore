...
enum OpcodeClient : uint16
{
    ...
    CMSG_GUILD_BANK_TRANSFER_ITEM_TO_BANK             = 0x34BD,
    CMSG_GUILD_BANK_TRANSFER_ITEM_TO_PLAYER           = 0x34BE,
    CMSG_GUILD_BANK_MOVE_ITEM_IN_BANK                 = 0x34C1,
    CMSG_GUILD_BANK_COMBINE_ITEM_STACK_WITH_BANK      = 0x34C2,
    CMSG_GUILD_BANK_TRANSFER_ITEM_STACK_TO_BANK       = 0x34C3,
    CMSG_GUILD_BANK_COMBINE_ITEM_STACK_WITH_PLAYER    = 0x34C4,
    CMSG_GUILD_BANK_TRANSFER_ITEM_STACK_TO_PLAYER     = 0x34C5,
    CMSG_GUILD_BANK_TRANSFER_ITEM_TO_PLAYER_AUTOSTORE = 0x34C6,
    CMSG_GUILD_BANK_COMBINE_ITEM_STACK_IN_BANK        = 0x34C7,
