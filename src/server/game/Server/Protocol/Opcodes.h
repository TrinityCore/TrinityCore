...
enum Opcodes
{
    ...
    MSG_MOVE_ENABLE_TRANSITION_BETWEEN_SWIM_AND_FLY   = 0x3014,
    MSG_MOVE_FALL_LAND                                = 0x380A,
    MSG_MOVE_FEATHER_FALL                             = 0x0000,
    MSG_MOVE_FEATHER_FALL_ACK                         = 0x3110,
    MSG_MOVE_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK       = 0x310E,
    MSG_MOVE_FORCE_FLIGHT_SPEED_CHANGE_ACK            = 0x7314,
    MSG_MOVE_FORCE_PITCH_RATE_CHANGE_ACK              = 0x3100,
    MSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK          = 0x3216,
    MSG_MOVE_FORCE_RUN_SPEED_CHANGE_ACK               = 0x7818,
    MSG_MOVE_FORCE_SWIM_BACK_SPEED_CHANGE_ACK         = 0x7A16,
    MSG_MOVE_FORCE_SWIM_SPEED_CHANGE_ACK              = 0x7A10,
    MSG_MOVE_FORCE_TURN_RATE_CHANGE_ACK               = 0x7316,
    MSG_MOVE_FORCE_WALK_SPEED_CHANGE_ACK              = 0x7210,
    MSG_MOVE_GRAVITY_CHNG                             = 0x0000,
    MSG_MOVE_HEARTBEAT                                = 0x3914,
    MSG_MOVE_HOVER                                    = 0x0000,
    MSG_MOVE_HOVER_ACK                                = 0x3318,
    MSG_MOVE_JUMP                                     = 0x7A06,
    MSG_MOVE_KNOCK_BACK_ACK                           = 0x5CB4,
    MSG_MOVE_ROOT                                     = 0x7DA0,
    MSG_MOVE_SET_ACTIVE_MOVER                         = 0x11B3,
    MSG_MOVE_SET_ALL_SPEED_CHEAT                      = 0x0000,
    MSG_MOVE_SET_CAN_FLY                              = 0x720E,
    MSG_MOVE_SET_CAN_FLY_ACK                          = 0x790C,
    MSG_MOVE_SET_COLLISION_HEIGHT                     = 0x59A3,
    MSG_MOVE_SET_COLLISION_HEIGHT_ACK                 = 0x7114,
    MSG_MOVE_SET_COMPOUND_STATE                       = 0x75A0,
    MSG_MOVE_SET_FACING                               = 0x7914,
    MSG_MOVE_SET_FEATHER_FALL                         = 0x79B0,
    ...
    MSG_MOVE_SET_HOVERING                             = 0x5CB3,
    MSG_MOVE_SET_LAND_WALK                            = 0x34B7,
    MSG_MOVE_SET_NORMAL_FALL                          = 0x51B6,
    ...
    MSG_MOVE_SET_WATER_WALK                           = 0x75B1,
    MSG_MOVE_SKIP_TIME                                = 0x19B3,
    MSG_MOVE_SPLINE_DONE                              = 0x790E,
    MSG_MOVE_SPLINE_SET_FEATHER_FALL                  = 0x3DA5,
    MSG_MOVE_SPLINE_SET_FLYING                        = 0x31B5,
    MSG_MOVE_SPLINE_SET_LAND_WALK                     = 0x3DA7,
    MSG_MOVE_SPLINE_SET_NORMAL_FALL                   = 0x38B2,
    MSG_MOVE_SPLINE_SET_RUN_SPEED                     = 0x51B7,
    MSG_MOVE_SPLINE_UNSET_FLYING                      = 0x58A6,
    MSG_MOVE_SPLINE_UNSET_HOVER                       = 0x7DA5,
    ...
    SMSG_QUEST_FORCE_REMOVED                          = 0x6605,
