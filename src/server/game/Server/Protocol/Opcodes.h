...
enum OpcodeClient : uint32
{
    ...
    CMSG_AUTOEQUIP_ITEM                               = 0x0423,
    CMSG_AUTOEQUIP_ITEM_SLOT                          = 0x0838,
    CMSG_AUTOSTORE_BAG_ITEM                           = 0x0424,
    ...
    CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE        = 0x0F36,
    CMSG_BATTLEFIELD_MGR_EXIT_REQUEST                 = 0x0F96,
    CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE        = 0x17BE,
    CMSG_BATTLEFIELD_MGR_QUEUE_REQUEST                = 0x1748,
    ...
    CMSG_CHANGE_BANK_BAG_SLOT_FLAG                    = 0x0B72,
    CMSG_CHANGE_SUB_GROUP                             = 0x0AB7,
    CMSG_CHANGE_TROPHY                                = 0x1A48,
    ...
    CMSG_CHECK_VETERAN_TOKEN_ELIGIBILITY              = 0x0337,
    ...
    CMSG_GARRISON_OPEN_TRADESKILL_NPC                 = 0x06DB,
    ...
    CMSG_GET_SELECTED_TROPHY                          = 0x0F47,
    ...
    CMSG_LFG_LIST_SEARCH_UPDATED_RESULT               = 0x061F,
    ...
    CMSG_LOW_LEVEL_RAID1                              = 0x0F0B,
    CMSG_LOW_LEVEL_RAID2                              = 0x02C0,
    ...
    CMSG_OPEN_SHIPMENT_GAME_OBJ                       = 0x0F06,
    CMSG_OPEN_SHIPMENT_NPC                            = 0x074F,
    CMSG_OPT_OUT_OF_LOOT                              = 0x1F89,
    CMSG_PAGE_TEXT_QUERY                              = 0x1AA2,
    ...
    CMSG_REQUEST_RATED_BG_INFO                        = 0x0A40,
    ...
    CMSG_SET_PREFERED_CEMETERY                        = 0x07DA,
    CMSG_SET_PVP                                      = 0x1BC7,
    ...
    CMSG_TOKEN_BUY_TOKEN                              = 0x1A35,
    CMSG_TOKEN_CONFIRM_BUY_TOKEN                      = 0x17B8,
    CMSG_TOKEN_CONFIRM_REDEEM_TOKEN                   = 0x06BD,
    CMSG_TOKEN_CONFIRM_SELL_TOKEN                     = 0x031E,
    CMSG_TOKEN_REDEEM_TOKEN                           = 0x03B5,
    CMSG_TOKEN_SELL_TOKEN                             = 0x0FB8,
    CMSG_TOKEN_UPDATE_MARKET_PRICE                    = 0x0718,
    CMSG_TOKEN_UPDATE_TOKEN_COUNT                     = 0x0A16,
    ...
    CMSG_TWITTER_GET_STATUS                           = 0x0CDE,
    CMSG_TWITTER_POST_SCREENSHOT                      = 0x0FA2,
    CMSG_TWITTER_UNK1                                 = 0x0C5E,
    ...
    CMSG_UPDATE_LISTED_AUCTIONABLE_TOKENS             = 0x1795,
