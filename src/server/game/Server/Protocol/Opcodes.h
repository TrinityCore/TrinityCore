...
{
    CMSG_ABANDON_NPE_RESPONSE                         = 0x300292,
    CMSG_ACCEPT_GUILD_INVITE                          = 0x350029,
    CMSG_ACCEPT_RETURNING_PLAYER_PROMPT               = 0x300253,
    CMSG_ACCEPT_SOCIAL_CONTRACT                       = 0x35016E,
    CMSG_ACCEPT_TRADE                                 = 0x300004,
    CMSG_ACCEPT_WARGAME_INVITE                        = 0x35000C,
    CMSG_ACCOUNT_BANK_DEPOSIT_MONEY                   = 0x3002D4,
    CMSG_ACCOUNT_BANK_WITHDRAW_MONEY                  = 0x3002D5,
    CMSG_ACCOUNT_NOTIFICATION_ACKNOWLEDGED            = 0x35015E,
    CMSG_ACTIVATE_SOULBIND                            = 0x300281,
    CMSG_ACTIVATE_TAXI                                = 0x31003D,
    CMSG_ADDON_LIST                                   = 0x350004,
    CMSG_ADD_ACCOUNT_COSMETIC                         = 0x30016B,
    CMSG_ADD_BATTLENET_FRIEND                         = 0x350084,
    CMSG_ADD_FRIEND                                   = 0x3500F9,
    CMSG_ADD_IGNORE                                   = 0x3500FD,
    CMSG_ADD_TOY                                      = 0x30016A,
    CMSG_ADVENTURE_JOURNAL_OPEN_QUEST                 = 0x3000B0,
    CMSG_ADVENTURE_JOURNAL_UPDATE_SUGGESTIONS         = 0x300284,
    CMSG_ADVENTURE_MAP_START_QUEST                    = 0x300226,
    CMSG_ALTER_APPEARANCE                             = 0x31008E,
    CMSG_AREA_SPIRIT_HEALER_QUERY                     = 0x310042,
    CMSG_AREA_SPIRIT_HEALER_QUEUE                     = 0x310043,
    CMSG_AREA_TRIGGER                                 = 0x300083,
    CMSG_ARTIFACT_ADD_POWER                           = 0x300054,
    CMSG_ARTIFACT_SET_APPEARANCE                      = 0x300056,
    CMSG_ASSIGN_EQUIPMENT_SET_SPEC                    = 0x3000BB,
    CMSG_ATTACK_STOP                                  = 0x300119,
    CMSG_ATTACK_SWING                                 = 0x300118,
    CMSG_AUCTIONABLE_TOKEN_SELL                       = 0x35010F,
    CMSG_AUCTIONABLE_TOKEN_SELL_AT_MARKET_PRICE       = 0x350110,
    ...
    CMSG_AUCTION_SET_FAVORITE_ITEM                    = 0x35015F,
    ...
    CMSG_AUTO_DEPOSIT_ACCOUNT_BANK                    = 0x3002DF,
    ...
    CMSG_AZERITE_EMPOWERED_ITEM_SELECT_POWER          = 0x30024F,
    CMSG_AZERITE_EMPOWERED_ITEM_VIEWED                = 0x300231,
    CMSG_AZERITE_ESSENCE_ACTIVATE_ESSENCE             = 0x300251,
    CMSG_AZERITE_ESSENCE_UNLOCK_MILESTONE             = 0x300250,
    CMSG_BANKER_ACTIVATE                              = 0x310045,
    CMSG_BATTLEFIELD_LEAVE                            = 0x30001D,
    CMSG_BATTLEFIELD_LIST                             = 0x300028,
    CMSG_BATTLEFIELD_PORT                             = 0x3100C4,
    CMSG_BATTLEMASTER_HELLO                           = 0x300188,
    ...
    CMSG_BATTLENET_CHALLENGE_RESPONSE                 = 0x3500FC,
    CMSG_BATTLENET_REQUEST                            = 0x35011D,
    CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE               = 0x3500F6,
    CMSG_BATTLE_PAY_CANCEL_OPEN_CHECKOUT              = 0x35013C,
    CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE         = 0x3500F5,
    CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_TO_TARGET     = 0x3500EC,
    CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS           = 0x350162,
    CMSG_BATTLE_PAY_GET_PRODUCT_LIST                  = 0x3500E4,
    CMSG_BATTLE_PAY_GET_PURCHASE_LIST                 = 0x3500E5,
    CMSG_BATTLE_PAY_OPEN_CHECKOUT                     = 0x350135,
    CMSG_BATTLE_PAY_REQUEST_PRICE_INFO                = 0x350131,
    CMSG_BATTLE_PAY_START_PURCHASE                    = 0x3500F4,
    CMSG_BATTLE_PAY_START_VAS_PURCHASE                = 0x35011B,
    ...
    CMSG_BATTLE_PET_UPDATE_DISPLAY_NOTIFY             = 0x30008D,
    CMSG_BATTLE_PET_UPDATE_NOTIFY                     = 0x30008C,
    ...
    CMSG_CANCEL_CAST                                  = 0x300171,
    CMSG_CANCEL_CHANNELLING                           = 0x300132,
    CMSG_CANCEL_GROWTH_AURA                           = 0x30013A,
    CMSG_CANCEL_MASTER_LOOT_ROLL                      = 0x3000C7,
    CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS            = 0x300057,
    CMSG_CANCEL_MOUNT_AURA                            = 0x30014D,
    CMSG_CANCEL_QUEUED_SPELL                          = 0x300029,
    CMSG_CANCEL_TEMP_ENCHANTMENT                      = 0x31008B,
    CMSG_CANCEL_TRADE                                 = 0x300006,
    CMSG_CAN_DUEL                                     = 0x35008C,
    CMSG_CAN_REDEEM_TOKEN_FOR_BALANCE                 = 0x350130,
    CMSG_CAST_SPELL                                   = 0x30016E,
    CMSG_CHALLENGE_MODE_REQUEST_LEADERS               = 0x2D0002,
    CMSG_CHANGE_BAG_SLOT_FLAG                         = 0x30020A,
    CMSG_CHANGE_BANK_BAG_SLOT_FLAG                    = 0x30020B,
    CMSG_CHANGE_MONUMENT_APPEARANCE                   = 0x3001EB,
    CMSG_CHANGE_REALM_TICKET                          = 0x350122,
    CMSG_CHANGE_SUB_GROUP                             = 0x350076,
    CMSG_CHARACTER_CHECK_UPGRADE                      = 0x3500EF,
    CMSG_CHARACTER_RENAME_REQUEST                     = 0x3500EA,
    CMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_REQUEST    = 0x3500ED,
    CMSG_CHARACTER_UPGRADE_START                      = 0x3500EE,
    CMSG_CHAR_CUSTOMIZE                               = 0x3500B6,
    CMSG_CHAR_DELETE                                  = 0x3500C7,
    ...
    CMSG_CHECK_IS_ADVENTURE_MAP_POI_VALID             = 0x30010A,
    CMSG_CHOICE_RESPONSE                              = 0x300176,
    CMSG_CHROMIE_TIME_SELECT_EXPANSION                = 0x300280,
    CMSG_CLAIM_WEEKLY_REWARD                          = 0x30025D,
    CMSG_CLASS_TALENTS_DELETE_CONFIG                  = 0x3002B9,
    CMSG_CLASS_TALENTS_NOTIFY_EMPTY_CONFIG            = 0x3000BF,
    CMSG_CLASS_TALENTS_NOTIFY_VALIDATION_FAILED       = 0x3002BB,
    CMSG_CLASS_TALENTS_RENAME_CONFIG                  = 0x3002B8,
    CMSG_CLASS_TALENTS_REQUEST_NEW_CONFIG             = 0x3002B7,
    CMSG_CLASS_TALENTS_SET_STARTER_BUILD_ACTIVE       = 0x3002BC,
    CMSG_CLASS_TALENTS_SET_USES_SHARED_ACTION_BARS    = 0x3000BE,
    ...
    CMSG_CLOSE_QUEST_CHOICE                           = 0x300177,
    CMSG_CLOSE_RUNEFORGE_INTERACTION                  = 0x300288,
    CMSG_CLOSE_TRAIT_SYSTEM_INTERACTION               = 0x3002BD,
    CMSG_CLUB_FINDER_APPLICATION_RESPONSE             = 0x350147,
    CMSG_CLUB_FINDER_GET_APPLICANTS_LIST              = 0x350145,
    CMSG_CLUB_FINDER_POST                             = 0x350142,
    CMSG_CLUB_FINDER_REQUEST_CLUBS_DATA               = 0x350149,
    CMSG_CLUB_FINDER_REQUEST_CLUBS_LIST               = 0x350143,
    CMSG_CLUB_FINDER_REQUEST_MEMBERSHIP_TO_CLUB       = 0x350144,
    CMSG_CLUB_FINDER_REQUEST_PENDING_CLUBS_LIST       = 0x350148,
    CMSG_CLUB_FINDER_REQUEST_SUBSCRIBED_CLUB_POSTING_IDS = 0x35014A,
    CMSG_CLUB_FINDER_RESPOND_TO_APPLICANT             = 0x350146,
    CMSG_CLUB_FINDER_WHISPER_APPLICANT_REQUEST        = 0x350165,
    CMSG_CLUB_PRESENCE_SUBSCRIBE                      = 0x35011F,
    ...
    CMSG_COMMENTATOR_SPECTATE                         = 0x350163,
    CMSG_COMMENTATOR_START_WARGAME                    = 0x35001B,
    CMSG_COMMERCE_TOKEN_GET_COUNT                     = 0x35010D,
    CMSG_COMMERCE_TOKEN_GET_LOG                       = 0x350117,
    CMSG_COMMERCE_TOKEN_GET_MARKET_PRICE              = 0x35010E,
    CMSG_COMPLAINT                                    = 0x350096,
    CMSG_COMPLETE_CINEMATIC                           = 0x3100E4,
    CMSG_COMPLETE_MOVIE                               = 0x310076,
    CMSG_CONFIRM_ARTIFACT_RESPEC                      = 0x300055,
    CMSG_CONFIRM_RESPEC_WIPE                          = 0x3000C1,
    CMSG_CONNECT_TO_FAILED                            = 0x350000,
    CMSG_CONSUMABLE_TOKEN_BUY                         = 0x350112,
    CMSG_CONSUMABLE_TOKEN_BUY_AT_MARKET_PRICE         = 0x350113,
    CMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY             = 0x350111,
    CMSG_CONSUMABLE_TOKEN_REDEEM                      = 0x350115,
    CMSG_CONSUMABLE_TOKEN_REDEEM_CONFIRMATION         = 0x350116,
    CMSG_CONTENT_TRACKING_START_TRACKING              = 0x3002CD,
    CMSG_CONTENT_TRACKING_STOP_TRACKING               = 0x3002CE,
    ...
    CMSG_CONVERT_ITEM_TO_BIND_TO_ACCOUNT              = 0x3002DE,
    ...
    CMSG_DEL_FRIEND                                   = 0x3500FA,
    CMSG_DEL_IGNORE                                   = 0x3500FE,
    CMSG_DEPOSIT_REAGENT_BANK                         = 0x300214,
    CMSG_DESTROY_ITEM                                 = 0x300164,
    ...
    CMSG_GARRISON_ADD_FOLLOWER_HEALTH                 = 0x3001CF,
    CMSG_GARRISON_ASSIGN_FOLLOWER_TO_BUILDING         = 0x3001B5,
    CMSG_GARRISON_CANCEL_CONSTRUCTION                 = 0x3001A2,
    CMSG_GARRISON_CHECK_UPGRADEABLE                   = 0x300206,
    CMSG_GARRISON_COMPLETE_MISSION                    = 0x3001F8,
    CMSG_GARRISON_FULLY_HEAL_ALL_FOLLOWERS            = 0x3001D0,
    CMSG_GARRISON_GENERATE_RECRUITS                   = 0x3001B8,
    CMSG_GARRISON_GET_CLASS_SPEC_CATEGORY_INFO        = 0x3001C7,
    CMSG_GARRISON_GET_MAP_DATA                        = 0x3001CE,
    CMSG_GARRISON_GET_MISSION_REWARD                  = 0x30022A,
    CMSG_GARRISON_LEARN_TALENT                        = 0x3001C3,
    CMSG_GARRISON_MISSION_BONUS_ROLL                  = 0x3001FA,
    CMSG_GARRISON_PURCHASE_BUILDING                   = 0x30019E,
    CMSG_GARRISON_RECRUIT_FOLLOWER                    = 0x3001BA,
    CMSG_GARRISON_REMOVE_FOLLOWER                     = 0x3001EF,
    CMSG_GARRISON_REMOVE_FOLLOWER_FROM_BUILDING       = 0x3001B6,
    CMSG_GARRISON_RENAME_FOLLOWER                     = 0x3001B7,
    CMSG_GARRISON_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA = 0x30019D,
    CMSG_GARRISON_REQUEST_SHIPMENT_INFO               = 0x3001D2,
    CMSG_GARRISON_RESEARCH_TALENT                     = 0x3001BB,
    CMSG_GARRISON_SET_BUILDING_ACTIVE                 = 0x30019F,
    CMSG_GARRISON_SET_FOLLOWER_FAVORITE               = 0x3001B3,
    CMSG_GARRISON_SET_FOLLOWER_INACTIVE               = 0x3001AB,
    CMSG_GARRISON_SET_RECRUITMENT_PREFERENCES         = 0x3001B9,
    CMSG_GARRISON_SOCKET_TALENT                       = 0x300295,
    CMSG_GARRISON_START_MISSION                       = 0x3001F7,
    CMSG_GARRISON_SWAP_BUILDINGS                      = 0x3001A3,
    CMSG_GENERATE_RANDOM_CHARACTER_NAME               = 0x350013,
    CMSG_GET_ACCOUNT_CHARACTER_LIST                   = 0x3500DF,
    CMSG_GET_ACCOUNT_NOTIFICATIONS                    = 0x35015D,
    CMSG_GET_GARRISON_INFO                            = 0x300198,
    CMSG_GET_ITEM_PURCHASE_DATA                       = 0x3100CE,
    CMSG_GET_LANDING_PAGE_SHIPMENTS                   = 0x3001D3,
    CMSG_GET_MIRROR_IMAGE_DATA                        = 0x300168,
    CMSG_GET_PVP_OPTIONS_ENABLED                      = 0x35001A,
    CMSG_GET_RAF_ACCOUNT_INFO                         = 0x35014B,
    CMSG_GET_REGIONWIDE_CHARACTER_RESTRICTION_AND_MAIL_DATA = 0x350188,
    CMSG_GET_REMAINING_GAME_TIME                      = 0x350114,
    CMSG_GET_TROPHY_LIST                              = 0x3001E8,
    CMSG_GET_UNDELETE_CHARACTER_COOLDOWN_STATUS       = 0x350108,
    CMSG_GET_VAS_ACCOUNT_CHARACTER_LIST               = 0x350119,
    CMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST           = 0x35011A,
    ...
    CMSG_GUILD_SET_GUILD_MASTER                       = 0x3500F1,
    ...
    CMSG_HIDE_QUEST_CHOICE                            = 0x300178,
    ...
    CMSG_LFG_LIST_JOIN                                = 0x30024D,
    CMSG_LFG_LIST_LEAVE                               = 0x350038,
    CMSG_LFG_LIST_SEARCH                              = 0x35003A,
    CMSG_LFG_LIST_UPDATE_REQUEST                      = 0x30024E,
    CMSG_LIST_INVENTORY                               = 0x310032,
    CMSG_LIVE_REGION_ACCOUNT_RESTORE                  = 0x3500E2,
    CMSG_LIVE_REGION_CHARACTER_COPY                   = 0x3500E1,
    CMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST       = 0x3500E0,
    CMSG_LIVE_REGION_KEY_BINDINGS_COPY                = 0x3500E3,
    CMSG_LOADING_SCREEN_NOTIFY                        = 0x350024,
    CMSG_LOAD_SELECTED_TROPHY                         = 0x3001E9,
    CMSG_LOBBY_MATCHMAKER_ACCEPT_PARTY_INVITE         = 0x350167,
    CMSG_LOBBY_MATCHMAKER_CREATE_CHARACTER            = 0x350175,
    CMSG_LOBBY_MATCHMAKER_LEAVE_PARTY                 = 0x35016A,
    CMSG_LOBBY_MATCHMAKER_PARTY_INVITE                = 0x350166,
    CMSG_LOBBY_MATCHMAKER_PARTY_UNINVITE              = 0x350169,
    CMSG_LOBBY_MATCHMAKER_REJECT_PARTY_INVITE         = 0x350168,
    CMSG_LOBBY_MATCHMAKER_SET_PARTY_PLAYLIST_ENTRY    = 0x35016B,
    CMSG_LOBBY_MATCHMAKER_SET_PLAYER_READY            = 0x35016C,
    ...
    CMSG_LOOT_ITEM                                    = 0x3000C4,
    CMSG_LOOT_MONEY                                   = 0x3000C3,
    CMSG_LOOT_RELEASE                                 = 0x3000C8,
    CMSG_LOOT_ROLL                                    = 0x3000C9,
    CMSG_LOOT_UNIT                                    = 0x3000C2,
    CMSG_LOW_LEVEL_RAID1                              = 0x3500CB,
    CMSG_LOW_LEVEL_RAID2                              = 0x3100AC,
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x3100DA,
    CMSG_MAIL_DELETE                                  = 0x3000DE,
    ...
    CMSG_MAKE_CONTITIONAL_APPEARANCE_PERMANENT        = 0x3000E0,
    CMSG_MASTER_LOOT_ITEM                             = 0x3000C5,
    ...
    CMSG_MOUNT_SPECIAL_ANIM                           = 0x30014E,
    ...
    CMSG_NEUTRAL_PLAYER_SELECT_FACTION                = 0x300080,
    CMSG_NEXT_CINEMATIC_CAMERA                        = 0x3100E3,
    CMSG_OBJECT_UPDATE_FAILED                         = 0x30002A,
    CMSG_OBJECT_UPDATE_RESCUED                        = 0x30002B,
    CMSG_OFFER_PETITION                               = 0x30027F,
    CMSG_OPENING_CINEMATIC                            = 0x3100E2,
    CMSG_OPEN_ITEM                                    = 0x300208,
    CMSG_OPEN_MISSION_NPC                             = 0x3001C9,
    CMSG_OPEN_SHIPMENT_NPC                            = 0x3001D1,
    CMSG_OPEN_TRADESKILL_NPC                          = 0x3001DC,
    ...
    CMSG_PERFORM_ITEM_INTERACTION                     = 0x3000E8,
    CMSG_PERKS_PROGRAM_ITEMS_REFRESHED                = 0x3002A7,
    CMSG_PERKS_PROGRAM_REQUEST_PENDING_REWARDS        = 0x2A0011,
    CMSG_PERKS_PROGRAM_REQUEST_PURCHASE               = 0x3002A9,
    CMSG_PERKS_PROGRAM_REQUEST_REFUND                 = 0x3002AA,
    CMSG_PERKS_PROGRAM_SET_FROZEN_VENDOR_ITEM         = 0x3002AB,
    CMSG_PERKS_PROGRAM_STATUS_REQUEST                 = 0x3002A8,
    CMSG_PETITION_BUY                                 = 0x31005B,
    CMSG_PETITION_RENAME_GUILD                        = 0x3500F2,
    ...
    CMSG_PET_BATTLE_FINAL_NOTIFY                      = 0x30008F,
    CMSG_PET_BATTLE_INPUT                             = 0x35006B,
    CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT        = 0x3000DD,
    CMSG_PET_BATTLE_QUIT_NOTIFY                       = 0x30008E,
    CMSG_PET_BATTLE_REPLACE_FRONT_PET                 = 0x35006C,
    CMSG_PET_BATTLE_REQUEST_PVP                       = 0x300088,
    CMSG_PET_BATTLE_REQUEST_UPDATE                    = 0x300089,
    CMSG_PET_BATTLE_REQUEST_WILD                      = 0x300086,
    CMSG_PET_BATTLE_SCRIPT_ERROR_NOTIFY               = 0x300090,
    CMSG_PET_BATTLE_WILD_LOCATION_FAIL                = 0x300087,
    CMSG_PET_CANCEL_AURA                              = 0x31001F,
    CMSG_PET_CAST_SPELL                               = 0x30016D,
    ...
    CMSG_QUERY_BATTLE_PET_NAME                        = 0x300141,
    CMSG_QUERY_CORPSE_LOCATION_FROM_CLIENT            = 0x35008A,
    CMSG_QUERY_CORPSE_TRANSPORT                       = 0x35008B,
    CMSG_QUERY_COUNTDOWN_TIMER                        = 0x300053,
    CMSG_QUERY_CREATURE                               = 0x30013B,
    CMSG_QUERY_GAME_OBJECT                            = 0x30013C,
    CMSG_QUERY_GARRISON_PET_NAME                      = 0x300142,
    CMSG_QUERY_GUILD_INFO                             = 0x3500B4,
    CMSG_QUERY_INSPECT_ACHIEVEMENTS                   = 0x310099,
    CMSG_QUERY_NEXT_MAIL_TIME                         = 0x3100D8,
    CMSG_QUERY_NPC_TEXT                               = 0x30013D,
    CMSG_QUERY_PAGE_TEXT                              = 0x30013F,
    CMSG_QUERY_PETITION                               = 0x300143,
    CMSG_QUERY_PET_NAME                               = 0x300140,
    ...
    CMSG_QUERY_QUEST_INFO                             = 0x30013E,
    ...
    CMSG_QUERY_TREASURE_PICKER                        = 0x30022D,
    ...
    CMSG_QUEST_POI_QUERY                              = 0x3500D9,
    CMSG_QUEST_PUSH_RESULT                            = 0x310031,
    CMSG_QUEST_SESSION_BEGIN_RESPONSE                 = 0x300271,
    CMSG_QUEST_SESSION_REQUEST_START                  = 0x300270,
    CMSG_QUEST_SESSION_REQUEST_STOP                   = 0x350156,
    CMSG_QUEUED_MESSAGES_END                          = 0x360008,
    CMSG_QUICK_JOIN_AUTO_ACCEPT_REQUESTS              = 0x35012E,
    CMSG_QUICK_JOIN_REQUEST_INVITE                    = 0x35012D,
    CMSG_QUICK_JOIN_REQUEST_INVITE_WITH_CONFIRMATION  = 0x35015B,
    CMSG_QUICK_JOIN_RESPOND_TO_INVITE                 = 0x35012C,
    CMSG_QUICK_JOIN_SIGNAL_TOAST_DISPLAYED            = 0x35012B,
    CMSG_RAF_CLAIM_ACTIVITY_REWARD                    = 0x31009D,
    CMSG_RAF_CLAIM_NEXT_REWARD                        = 0x35014C,
    CMSG_RAF_GENERATE_RECRUITMENT_LINK                = 0x35014E,
    CMSG_RAF_UPDATE_RECRUITMENT_INFO                  = 0x35014D,
    CMSG_RANDOM_ROLL                                  = 0x35007E,
    CMSG_READY_CHECK_RESPONSE                         = 0x35005F,
    CMSG_READ_ITEM                                    = 0x300209,
    CMSG_RECLAIM_CORPSE                               = 0x310074,
    CMSG_REMOVE_NEW_ITEM                              = 0x300230,
    CMSG_REMOVE_RAF_RECRUIT                           = 0x35014F,
    CMSG_REORDER_CHARACTERS                           = 0x350015,
    CMSG_REPAIR_ITEM                                  = 0x310085,
    CMSG_REPLACE_TROPHY                               = 0x3001EA,
    CMSG_REPOP_REQUEST                                = 0x3100C5,
    CMSG_REPORT_CLIENT_VARIABLES                      = 0x350128,
    CMSG_REPORT_ENABLED_ADDONS                        = 0x350127,
    CMSG_REPORT_KEYBINDING_EXECUTION_COUNTS           = 0x350129,
    CMSG_REPORT_PVP_PLAYER_AFK                        = 0x31008D,
    CMSG_REPORT_SERVER_LAG                            = 0x300269,
    CMSG_REPORT_STUCK_IN_COMBAT                       = 0x30026A,
    CMSG_REQUEST_ACCOUNT_DATA                         = 0x3500BF,
    CMSG_REQUEST_AREA_POI_UPDATE                      = 0x30022F,
    ...
    CMSG_REQUEST_COVENANT_CALLINGS                    = 0x30025B,
    CMSG_REQUEST_CROWD_CONTROL_SPELL                  = 0x3100C9,
    CMSG_REQUEST_CURRENCY_DATA_FOR_ACCOUNT_CHARACTERS = 0x2A0018,
    CMSG_REQUEST_GARRISON_TALENT_WORLD_QUEST_UNLOCKS  = 0x300294,
    CMSG_REQUEST_GUILD_PARTY_STATE                    = 0x300052,
    CMSG_REQUEST_GUILD_REWARDS_LIST                   = 0x300051,
    CMSG_REQUEST_LATEST_SPLASH_SCREEN                 = 0x30026B,
    CMSG_REQUEST_LFG_LIST_BLACKLIST                   = 0x300179,
    CMSG_REQUEST_MYTHIC_PLUS_AFFIXES                  = 0x3000B4,
    CMSG_REQUEST_MYTHIC_PLUS_SEASON_DATA              = 0x3000B5,
    CMSG_REQUEST_PARTY_ELIGIBILITY_FOR_DELVE_TIERS    = 0x3002E2,
    CMSG_REQUEST_PARTY_JOIN_UPDATES                   = 0x350023,
    CMSG_REQUEST_PARTY_MEMBER_STATS                   = 0x35007D,
    CMSG_REQUEST_PET_INFO                             = 0x310021,
    CMSG_REQUEST_PLAYED_TIME                          = 0x300146,
    CMSG_REQUEST_PVP_REWARDS                          = 0x30003F,
    CMSG_REQUEST_RAID_INFO                            = 0x3500F3,
    CMSG_REQUEST_RATED_PVP_INFO                       = 0x35000F,
    CMSG_REQUEST_REALM_GUILD_MASTER_INFO              = 0x35018B,
    CMSG_REQUEST_SCHEDULED_PVP_INFO                   = 0x300040,
    CMSG_REQUEST_STABLED_PETS                         = 0x310022,
    CMSG_REQUEST_VEHICLE_EXIT                         = 0x3000FA,
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                    = 0x3000FC,
    CMSG_REQUEST_VEHICLE_PREV_SEAT                    = 0x3000FB,
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                  = 0x3000FD,
    CMSG_REQUEST_WEEKLY_REWARDS                       = 0x30025E,
    CMSG_REQUEST_WORLD_QUEST_UPDATE                   = 0x30022E,
    CMSG_RESET_CHALLENGE_MODE                         = 0x3000B2,
    CMSG_RESET_CHALLENGE_MODE_CHEAT                   = 0x3000B3,
    CMSG_RESET_INSTANCES                              = 0x350092,
    CMSG_RESURRECT_RESPONSE                           = 0x3500AD,
    CMSG_REVERT_MONUMENT_APPEARANCE                   = 0x3001EC,
    CMSG_RIDE_VEHICLE_INTERACT                        = 0x3000FE,
    CMSG_RPE_RESET_CHARACTER                          = 0x350178,
    CMSG_SAVE_ACCOUNT_DATA_EXPORT                     = 0x350172,
    CMSG_SAVE_CUF_PROFILES                            = 0x300035,
    CMSG_SAVE_EQUIPMENT_SET                           = 0x3100A3,
    CMSG_SAVE_GUILD_EMBLEM                            = 0x30017D,
    CMSG_SAVE_PERSONAL_EMBLEM                         = 0x30017E,
    CMSG_SCENE_PLAYBACK_CANCELED                      = 0x3000D9,
    CMSG_SCENE_PLAYBACK_COMPLETE                      = 0x3000D8,
    CMSG_SCENE_TRIGGER_EVENT                          = 0x3000DA,
    CMSG_SEAMLESS_TRANSFER_COMPLETE                   = 0x3002D0,
    CMSG_SELF_RES                                     = 0x3100D0,
    CMSG_SELL_ALL_JUNK_ITEMS                          = 0x310034,
    CMSG_SELL_ITEM                                    = 0x310033,
    CMSG_SEND_CHARACTER_CLUB_INVITATION               = 0x350121,
    CMSG_SEND_CONTACT_LIST                            = 0x3500F8,
    CMSG_SEND_MAIL                                    = 0x350026,
    CMSG_SEND_PING_UNIT                               = 0x3002D2,
    CMSG_SEND_PING_WORLD_POINT                        = 0x3002D3,
    CMSG_SEND_TEXT_EMOTE                              = 0x310018,
    CMSG_SERVER_TIME_OFFSET_REQUEST                   = 0x3500C6,
    CMSG_SETUP_WARBAND_GROUPS                         = 0x350186,
    CMSG_SET_ACHIEVEMENTS_HIDDEN                      = 0x3000DF,
    CMSG_SET_ACTION_BAR_TOGGLES                       = 0x3100D1,
    CMSG_SET_ACTION_BUTTON                            = 0x350060,
    CMSG_SET_ACTIVE_MOVER                             = 0x330059,
    CMSG_SET_ADVANCED_COMBAT_LOGGING                  = 0x30018B,
    CMSG_SET_ASSISTANT_LEADER                         = 0x350079,
    CMSG_SET_BACKPACK_AUTOSORT_DISABLED               = 0x30020C,
    CMSG_SET_BACKPACK_SELL_JUNK_DISABLED              = 0x30020D,
    CMSG_SET_BANK_AUTOSORT_DISABLED                   = 0x30020E,
    CMSG_SET_CONTACT_NOTES                            = 0x3500FB,
    CMSG_SET_CURRENCY_FLAGS                           = 0x300013,
    CMSG_SET_DIFFICULTY_ID                            = 0x3000DB,
    CMSG_SET_DUNGEON_DIFFICULTY                       = 0x3500AC,
    CMSG_SET_EMPOWER_MIN_HOLD_STAGE_PERCENT           = 0x300135,
    CMSG_SET_EVERYONE_IS_ASSISTANT                    = 0x350046,
    CMSG_SET_EXCLUDED_CHAT_CENSOR_SOURCES             = 0x35012F,
    ...
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT               = 0x300210,
    ...
    CMSG_SET_PVP                                      = 0x300182,
    CMSG_SET_RAID_DIFFICULTY                          = 0x350104,
    ...
    CMSG_SET_SORT_BAGS_RIGHT_TO_LEFT                  = 0x30020F,
    CMSG_SET_TAXI_BENCHMARK_MODE                      = 0x31008C,
    CMSG_SET_TITLE                                    = 0x30014C,
    CMSG_SET_TRADE_CURRENCY                           = 0x30000A,
    CMSG_SET_TRADE_GOLD                               = 0x300009,
    CMSG_SET_TRADE_ITEM                               = 0x300007,
    CMSG_SET_USING_PARTY_GARRISON                     = 0x3001CB,
    CMSG_SET_WAR_MODE                                 = 0x300183,
    CMSG_SET_WATCHED_FACTION                          = 0x31007A,
    CMSG_SHOW_TRADE_SKILL                             = 0x3500EB,
    CMSG_SIGN_PETITION                                = 0x3100D2,
    CMSG_SILENCE_PARTY_TALKER                         = 0x35007C,
    CMSG_SOCIAL_CONTRACT_REQUEST                      = 0x35016D,
    CMSG_SOCKET_GEMS                                  = 0x310084,
    CMSG_SORT_ACCOUNT_BANK_BAGS                       = 0x3002D6,
    CMSG_SORT_BAGS                                    = 0x300211,
    CMSG_SORT_BANK_BAGS                               = 0x300212,
    CMSG_SORT_REAGENT_BANK_BAGS                       = 0x300213,
    CMSG_SPAWN_TRACKING_UPDATE                        = 0x300161,
    CMSG_SPECTATE_CHANGE                              = 0x3002C9,
    CMSG_SPELL_CLICK                                  = 0x310026,
    CMSG_SPELL_EMPOWER_RELEASE                        = 0x300133,
    CMSG_SPELL_EMPOWER_RESTART                        = 0x300134,
    ...
    CMSG_SUBMIT_USER_FEEDBACK                         = 0x3500BE,
    CMSG_SUBSCRIPTION_INTERSTITIAL_RESPONSE           = 0x300289,
    ...
    CMSG_TABARD_VENDOR_ACTIVATE                       = 0x30017F,
    ...
    CMSG_TOGGLE_PVP                                   = 0x300181,
    CMSG_TOTEM_DESTROYED                              = 0x310091,
    CMSG_TOY_CLEAR_FANFARE                            = 0x2A0004,
    CMSG_TRADE_SKILL_SET_FAVORITE                     = 0x30022C,
    CMSG_TRAINER_BUY_SPELL                            = 0x310040,
    CMSG_TRAINER_LIST                                 = 0x31003F,
    CMSG_TRAITS_COMMIT_CONFIG                         = 0x3002B1,
    CMSG_TRAITS_TALENT_TEST_UNLEARN_SPELLS            = 0x3002AF,
    CMSG_TRANSFER_CURRENCY_FROM_ACCOUNT_CHARACTER     = 0x3002E0,
    CMSG_TRANSMOGRIFY_ITEMS                           = 0x300041,
    CMSG_TURN_IN_PETITION                             = 0x3100D4,
    CMSG_TUTORIAL                                     = 0x350105,
    CMSG_UI_MAP_QUEST_LINES_REQUEST                   = 0x30025A,
    CMSG_UNACCEPT_TRADE                               = 0x300005,
    CMSG_UNDELETE_CHARACTER                           = 0x350107,
    CMSG_UNLEARN_SKILL                                = 0x31007E,
    CMSG_UNLEARN_SPECIALIZATION                       = 0x30004F,
    CMSG_UNLOCK_VOID_STORAGE                          = 0x30004B,
    CMSG_UPDATE_AADC_STATUS                           = 0x350161,
    CMSG_UPDATE_ACCOUNT_BANK_TAB_SETTINGS             = 0x310127,
    CMSG_UPDATE_ACCOUNT_DATA                          = 0x3500C0,
    CMSG_UPDATE_AREA_TRIGGER_VISUAL                   = 0x300170,
    CMSG_UPDATE_CLIENT_SETTINGS                       = 0x35008E,
    CMSG_UPDATE_CRAFTING_NPC_RECIPES                  = 0x3001DD,
    CMSG_UPDATE_MISSILE_TRAJECTORY                    = 0x330060,
    CMSG_UPDATE_RAID_TARGET                           = 0x35007A,
    CMSG_UPDATE_SPELL_VISUAL                          = 0x30016F,
    CMSG_UPDATE_VAS_PURCHASE_STATES                   = 0x35011C,
    CMSG_UPGRADE_GARRISON                             = 0x300193,
    CMSG_UPGRADE_RUNEFORGE_LEGENDARY                  = 0x300287,
    CMSG_USED_FOLLOW                                  = 0x300030,
    CMSG_USE_CRITTER_ITEM                             = 0x300104,
    CMSG_USE_EQUIPMENT_SET                            = 0x320001,
    CMSG_USE_ITEM                                     = 0x300169,
    CMSG_USE_TOY                                      = 0x30016C,
    CMSG_VAS_CHECK_TRANSFER_OK                        = 0x350134,
    CMSG_VAS_GET_QUEUE_MINUTES                        = 0x350133,
    CMSG_VAS_GET_SERVICE_STATUS                       = 0x350132,
    CMSG_VIOLENCE_LEVEL                               = 0x30002E,
    CMSG_VOICE_CHANNEL_STT_TOKEN_REQUEST              = 0x350138,
    CMSG_VOICE_CHAT_JOIN_CHANNEL                      = 0x350139,
    CMSG_VOICE_CHAT_LOGIN                             = 0x350137,
    CMSG_VOID_STORAGE_TRANSFER                        = 0x30004D,
    CMSG_WARDEN3_DATA                                 = 0x350018,
    CMSG_WHO                                          = 0x3500AB,
    CMSG_WHO_IS                                       = 0x3500AA,
    CMSG_WORLD_LOOT_OBJECT_CLICK                      = 0x3002CC,
...
{
    SMSG_ABORT_NEW_WORLD                              = 0x37002F,
    SMSG_ACCOUNT_CHARACTER_CURRENCY_LISTS             = 0x370334,
    SMSG_ACCOUNT_CONVERSION_STATE_UPDATE              = 0x370339,
    SMSG_ACCOUNT_COSMETIC_ADDED                       = 0x3702F7,
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x3702DE,
    SMSG_ACCOUNT_DATA_TIMES                           = 0x3701A0,
    SMSG_ACCOUNT_EXPORT_RESPONSE                      = 0x370325,
    SMSG_ACCOUNT_MOUNT_REMOVED                        = 0x370046,
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0x370045,
    SMSG_ACCOUNT_NOTIFICATIONS_RESPONSE               = 0x3702F6,
    SMSG_ACCOUNT_TOY_UPDATE                           = 0x370047,
    SMSG_ACCOUNT_TRANSMOG_SET_FAVORITES_UPDATE        = 0x37004B,
    SMSG_ACCOUNT_TRANSMOG_UPDATE                      = 0x37004A,
    SMSG_ACHIEVEMENT_DELETED                          = 0x37017E,
    SMSG_ACHIEVEMENT_EARNED                           = 0x3700D8,
    SMSG_ACTIVATE_ESSENCE_FAILED                      = 0x4A001F,
    SMSG_ACTIVATE_SOULBIND_FAILED                     = 0x4A0021,
    SMSG_ACTIVATE_TAXI_REPLY                          = 0x370115,
    SMSG_ACTIVE_GLYPHS                                = 0x4D0045,
    SMSG_ACTIVE_SCHEDULED_WORLD_STATE_INFO            = 0x3701DB,
    SMSG_ADDON_LIST_REQUEST                           = 0x3700D7,
    SMSG_ADD_BATTLENET_FRIEND_RESPONSE                = 0x3700D2,
    SMSG_ADD_ITEM_PASSIVE                             = 0x370041,
    SMSG_ADD_LOSS_OF_CONTROL                          = 0x370108,
    SMSG_ADD_RUNE_POWER                               = 0x37014F,
    SMSG_ADJUST_SPLINE_DURATION                       = 0x370067,
    SMSG_ADVANCED_COMBAT_LOG                          = 0x3702F3,
    SMSG_ADVENTURE_JOURNAL_DATA_RESPONSE              = 0x3702EE,
    SMSG_AE_LOOT_TARGETS                              = 0x3700AD,
    SMSG_AE_LOOT_TARGET_ACK                           = 0x3700AE,
    SMSG_AI_REACTION                                  = 0x37014C,
    SMSG_ALLIED_RACE_DETAILS                          = 0x370288,
    SMSG_ALL_ACCOUNT_CRITERIA                         = 0x370005,
    SMSG_ALL_ACHIEVEMENT_DATA                         = 0x370004,
    SMSG_ALL_GUILD_ACHIEVEMENTS                       = 0x430000,
    SMSG_APPLY_MOUNT_EQUIPMENT_RESULT                 = 0x3702CB,
    SMSG_ARCHAEOLOGY_SURVERY_CAST                     = 0x37001D,
    SMSG_AREA_POI_UPDATE_RESPONSE                     = 0x4A0018,
    SMSG_AREA_SPIRIT_HEALER_TIME                      = 0x3701D4,
    SMSG_AREA_TRIGGER_DENIED                          = 0x380009,
    SMSG_AREA_TRIGGER_FORCE_SET_POSITION_AND_FACING   = 0x380006,
    SMSG_AREA_TRIGGER_NO_CORPSE                       = 0x3701AC,
    ...
    SMSG_ARENA_CLEAR_OPPONENTS                        = 0x3700DE,
    SMSG_ARENA_CROWD_CONTROL_SPELL_RESULT             = 0x3700C7,
    SMSG_ARENA_PREP_OPPONENT_SPECIALIZATIONS          = 0x3700DD,
    SMSG_ARTIFACT_ENDGAME_POWERS_REFUNDED             = 0x370235,
    SMSG_ARTIFACT_FORGE_ERROR                         = 0x370233,
    SMSG_ARTIFACT_RESPEC_PROMPT                       = 0x370234,
    SMSG_ARTIFACT_XP_GAIN                             = 0x37027B,
    ...
    SMSG_AUCTIONABLE_TOKEN_AUCTION_SOLD               = 0x370264,
    SMSG_AUCTIONABLE_TOKEN_SELL_AT_MARKET_PRICE_RESPONSE = 0x370263,
    SMSG_AUCTIONABLE_TOKEN_SELL_CONFIRM_REQUIRED      = 0x370262,
    SMSG_AUCTION_CLOSED_NOTIFICATION                  = 0x370189,
    SMSG_AUCTION_COMMAND_RESULT                       = 0x370186,
    SMSG_AUCTION_DISABLE_NEW_POSTINGS                 = 0x370312,
    SMSG_AUCTION_FAVORITE_LIST                        = 0x3702E5,
    SMSG_AUCTION_GET_COMMODITY_QUOTE_RESULT           = 0x3702DD,
    SMSG_AUCTION_HELLO_RESPONSE                       = 0x370184,
    SMSG_AUCTION_LIST_BIDDED_ITEMS_RESULT             = 0x3702DC,
    SMSG_AUCTION_LIST_BUCKETS_RESULT                  = 0x3702D8,
    SMSG_AUCTION_LIST_ITEMS_RESULT                    = 0x3702D9,
    SMSG_AUCTION_LIST_OWNED_ITEMS_RESULT              = 0x3702DB,
    SMSG_AUCTION_OUTBID_NOTIFICATION                  = 0x370188,
    SMSG_AUCTION_OWNER_BID_NOTIFICATION               = 0x37018A,
    SMSG_AUCTION_REPLICATE_RESPONSE                   = 0x370185,
    SMSG_AUCTION_WON_NOTIFICATION                     = 0x370187,
    ...
    SMSG_BACKPACK_DEFAULT_SIZE_CHANGED                = 0x370313,
    SMSG_BAG_CLEANUP_FINISHED                         = 0x4E0007,
    SMSG_BARBER_SHOP_RESULT                           = 0x370154,
    SMSG_BATCH_PRESENCE_SUBSCRIPTION                  = 0x3702BC,
    ...
    SMSG_BATTLENET_CHALLENGE_ABORT                    = 0x37021D,
    SMSG_BATTLENET_CHALLENGE_START                    = 0x37021C,
    SMSG_BATTLENET_NOTIFICATION                       = 0x370294,
    SMSG_BATTLENET_RESPONSE                           = 0x370293,
    SMSG_BATTLE_NET_CONNECTION_STATUS                 = 0x370295,
    SMSG_BATTLE_PAY_ACK_FAILED                        = 0x370218,
    SMSG_BATTLE_PAY_BATTLE_PET_DELIVERED              = 0x37020D,
    SMSG_BATTLE_PAY_COLLECTION_ITEM_DELIVERED         = 0x37020E,
    SMSG_BATTLE_PAY_CONFIRM_PURCHASE                  = 0x370217,
    SMSG_BATTLE_PAY_DELIVERY_ENDED                    = 0x37020B,
    SMSG_BATTLE_PAY_DELIVERY_STARTED                  = 0x37020A,
    SMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS_RESPONSE  = 0x3702FC,
    SMSG_BATTLE_PAY_DISTRIBUTION_UNREVOKED            = 0x370208,
    SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE               = 0x370209,
    SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE    = 0x370207,
    SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE         = 0x370205,
    SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE        = 0x370206,
    SMSG_BATTLE_PAY_MOUNT_DELIVERED                   = 0x37020C,
    SMSG_BATTLE_PAY_PURCHASE_UPDATE                   = 0x370216,
    SMSG_BATTLE_PAY_START_CHECKOUT                    = 0x3702B0,
    SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE = 0x370214,
    SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE           = 0x370213,
    SMSG_BATTLE_PAY_VALIDATE_PURCHASE_RESPONSE        = 0x3702A4,
    SMSG_BATTLE_PETS_HEALED                           = 0x370089,
    SMSG_BATTLE_PET_CAGE_DATE_ERROR                   = 0x370110,
    SMSG_BATTLE_PET_DELETED                           = 0x370086,
    SMSG_BATTLE_PET_ERROR                             = 0x3700CD,
    SMSG_BATTLE_PET_JOURNAL                           = 0x370085,
    SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED             = 0x370083,
    SMSG_BATTLE_PET_JOURNAL_LOCK_DENIED               = 0x370084,
    SMSG_BATTLE_PET_RESTORED                          = 0x370088,
    SMSG_BATTLE_PET_REVOKED                           = 0x370087,
    SMSG_BATTLE_PET_TRAP_LEVEL                        = 0x370081,
    SMSG_BATTLE_PET_UPDATES                           = 0x370080,
    SMSG_BIND_POINT_UPDATE                            = 0x370011,
    SMSG_BLACK_MARKET_BID_ON_ITEM_RESULT              = 0x3700BD,
    SMSG_BLACK_MARKET_OUTBID                          = 0x3700BE,
    SMSG_BLACK_MARKET_REQUEST_ITEMS_RESULT            = 0x3700BC,
    SMSG_BLACK_MARKET_WON                             = 0x3700BF,
    SMSG_BONUS_ROLL_EMPTY                             = 0x3700DA,
    SMSG_BOSS_KILL                                    = 0x3D002B,
    SMSG_BREAK_TARGET                                 = 0x3D0016,
    SMSG_BROADCAST_ACHIEVEMENT                        = 0x3C0010,
    SMSG_BROADCAST_SUMMON_CAST                        = 0x3702BE,
    SMSG_BROADCAST_SUMMON_RESPONSE                    = 0x3702BF,
    SMSG_BUY_FAILED                                   = 0x37015D,
    SMSG_BUY_SUCCEEDED                                = 0x37015C,
    SMSG_CACHE_INFO                                   = 0x3B000F,
    SMSG_CACHE_VERSION                                = 0x3B000E,
    SMSG_CALENDAR_CLEAR_PENDING_ACTION                = 0x370135,
    SMSG_CALENDAR_COMMAND_RESULT                      = 0x370136,
    SMSG_CALENDAR_COMMUNITY_INVITE                    = 0x370125,
    SMSG_CALENDAR_EVENT_REMOVED_ALERT                 = 0x37012D,
    SMSG_CALENDAR_EVENT_UPDATED_ALERT                 = 0x37012E,
    SMSG_CALENDAR_INVITE_ADDED                        = 0x370126,
    SMSG_CALENDAR_INVITE_ALERT                        = 0x37012A,
    SMSG_CALENDAR_INVITE_NOTES                        = 0x37012F,
    SMSG_CALENDAR_INVITE_NOTES_ALERT                  = 0x370130,
    SMSG_CALENDAR_INVITE_REMOVED                      = 0x370127,
    SMSG_CALENDAR_INVITE_REMOVED_ALERT                = 0x37012C,
    SMSG_CALENDAR_INVITE_STATUS                       = 0x370128,
    SMSG_CALENDAR_INVITE_STATUS_ALERT                 = 0x37012B,
    SMSG_CALENDAR_MODERATOR_STATUS                    = 0x370129,
    SMSG_CALENDAR_RAID_LOCKOUT_ADDED                  = 0x370131,
    SMSG_CALENDAR_RAID_LOCKOUT_REMOVED                = 0x370132,
    SMSG_CALENDAR_RAID_LOCKOUT_UPDATED                = 0x370133,
    SMSG_CALENDAR_SEND_CALENDAR                       = 0x370123,
    SMSG_CALENDAR_SEND_EVENT                          = 0x370124,
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x370134,
    SMSG_CAMERA_EFFECT                                = 0x3701BA,
    SMSG_CANCEL_AUTO_REPEAT                           = 0x370174,
    SMSG_CANCEL_COMBAT                                = 0x3D0025,
    SMSG_CANCEL_ORPHAN_SPELL_VISUAL                   = 0x4D0037,
    SMSG_CANCEL_PING_PIN                              = 0x37003A,
    SMSG_CANCEL_PRELOAD_WORLD                         = 0x37002D,
    SMSG_CANCEL_SCENE                                 = 0x3700CC,
    SMSG_CANCEL_SPELL_VISUAL                          = 0x4D0035,
    SMSG_CANCEL_SPELL_VISUAL_KIT                      = 0x4D0039,
    SMSG_CAN_DUEL_RESULT                              = 0x3D0021,
    SMSG_CAN_REDEEM_TOKEN_FOR_BALANCE_RESPONSE        = 0x3702A3,
    SMSG_CAPTURE_POINT_REMOVED                        = 0x3D0008,
    SMSG_CAST_FAILED                                  = 0x4D0048,
    SMSG_CAS_REFRESH_REMOTE_DATA                      = 0x37010E,
    SMSG_CHAIN_MISSILE_BOUNCE                         = 0x37005F,
    SMSG_CHALLENGE_MODE_COMPLETE                      = 0x3700A0,
    SMSG_CHALLENGE_MODE_REQUEST_LEADERS_RESULT        = 0x3700A5,
    SMSG_CHALLENGE_MODE_RESET                         = 0x37009F,
    SMSG_CHALLENGE_MODE_START                         = 0x37009D,
    SMSG_CHALLENGE_MODE_UPDATE_DEATH_COUNT            = 0x37009E,
    SMSG_CHANGE_PLAYER_DIFFICULTY_RESULT              = 0x4A000C,
    SMSG_CHANGE_REALM_TICKET_RESPONSE                 = 0x370296,
    SMSG_CHANNEL_LIST                                 = 0x3C0018,
    SMSG_CHANNEL_NOTIFY                               = 0x3C0015,
    SMSG_CHANNEL_NOTIFY_JOINED                        = 0x3C0016,
    SMSG_CHANNEL_NOTIFY_LEFT                          = 0x3C0017,
    SMSG_CHARACTER_CHECK_UPGRADE_RESULT               = 0x370250,
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x37019B,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x37021B,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x3701F7,
    SMSG_CHARACTER_UPGRADE_ABORTED                    = 0x37024F,
    SMSG_CHARACTER_UPGRADE_COMPLETE                   = 0x37024E,
    SMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_RESULT     = 0x370251,
    SMSG_CHARACTER_UPGRADE_STARTED                    = 0x37024D,
    SMSG_CHAR_CUSTOMIZE_FAILURE                       = 0x370178,
    SMSG_CHAR_CUSTOMIZE_SUCCESS                       = 0x370179,
    SMSG_CHAR_FACTION_CHANGE_RESULT                   = 0x37023A,
    SMSG_CHAT                                         = 0x3C0001,
    SMSG_CHAT_AUTO_RESPONDED                          = 0x3C000C,
    SMSG_CHAT_CAN_LOCAL_WHISPER_TARGET_RESPONSE       = 0x3C001F,
    SMSG_CHAT_DOWN                                    = 0x3C0012,
    SMSG_CHAT_IGNORED_ACCOUNT_MUTED                   = 0x3C0000,
    SMSG_CHAT_IS_DOWN                                 = 0x3C0013,
    SMSG_CHAT_NOT_IN_GUILD                            = 0x3C0020,
    ...
    SMSG_CHAT_REGIONAL_SERVICE_STATUS                 = 0x3C001A,
    SMSG_CHAT_RESTRICTED                              = 0x3C0007,
    SMSG_CHAT_SERVER_MESSAGE                          = 0x3C0019,
    ...
    SMSG_CHROMIE_TIME_SELECT_EXPANSION_SUCCESS        = 0x3702E8,
    SMSG_CLAIM_RAF_REWARD_RESPONSE                    = 0x3702CF,
    SMSG_CLEAR_ALL_SPELL_CHARGES                      = 0x4D0016,
    SMSG_CLEAR_BOSS_EMOTES                            = 0x370052,
    SMSG_CLEAR_COOLDOWN                               = 0x370151,
    ...
    SMSG_CLOSE_ARTIFACT_FORGE                         = 0x370232,
    SMSG_CLUB_FINDER_ERROR_MESSAGE                    = 0x3702C7,
    SMSG_CLUB_FINDER_GET_CLUB_POSTING_IDS_RESPONSE    = 0x3702CA,
    SMSG_CLUB_FINDER_LOOKUP_CLUB_POSTINGS_LIST        = 0x3702C8,
    SMSG_CLUB_FINDER_RESPONSE_CHARACTER_APPLICATION_LIST = 0x3702C5,
    SMSG_CLUB_FINDER_RESPONSE_POST_RECRUITMENT_MESSAGE = 0x3702C9,
    SMSG_CLUB_FINDER_UPDATE_APPLICATIONS              = 0x3702C6,
    SMSG_CLUB_FINDER_WHISPER_APPLICANT_RESPONSE       = 0x370308,
    SMSG_COIN_REMOVED                                 = 0x3700AC,
    SMSG_COMBAT_EVENT_FAILED                          = 0x3D0019,
    SMSG_COMMENTATOR_MAP_INFO                         = 0x37019D,
    SMSG_COMMENTATOR_PLAYER_INFO                      = 0x37019E,
    SMSG_COMMENTATOR_STATE_CHANGED                    = 0x37019C,
    SMSG_COMMERCE_TOKEN_GET_COUNT_RESPONSE            = 0x37025F,
    SMSG_COMMERCE_TOKEN_GET_LOG_RESPONSE              = 0x37026B,
    SMSG_COMMERCE_TOKEN_GET_MARKET_PRICE_RESPONSE     = 0x370261,
    SMSG_COMMERCE_TOKEN_UPDATE                        = 0x370260,
    SMSG_COMPLAINT_RESULT                             = 0x370143,
    SMSG_COMPLETE_SHIPMENT_RESPONSE                   = 0x37022B,
    SMSG_CONFIRM_PARTY_INVITE                         = 0x3702A2,
    SMSG_CONNECT_TO                                   = 0x3E0005,
    SMSG_CONSOLE_WRITE                                = 0x3700CA,
    SMSG_CONSUMABLE_TOKEN_BUY_AT_MARKET_PRICE_RESPONSE = 0x370267,
    SMSG_CONSUMABLE_TOKEN_BUY_CHOICE_REQUIRED         = 0x370266,
    SMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY_RESPONSE    = 0x370265,
    SMSG_CONSUMABLE_TOKEN_REDEEM_CONFIRM_REQUIRED     = 0x370269,
    SMSG_CONSUMABLE_TOKEN_REDEEM_RESPONSE             = 0x37026A,
    SMSG_CONTACT_LIST                                 = 0x370219,
    SMSG_CONTRIBUTION_LAST_UPDATE_RESPONSE            = 0x3702A9,
    SMSG_CONTROL_UPDATE                               = 0x3700DC,
    SMSG_CONVERT_ITEMS_TO_CURRENCY_VALUE              = 0x3702F1,
    SMSG_COOLDOWN_CHEAT                               = 0x3701CD,
    SMSG_COOLDOWN_EVENT                               = 0x370150,
    SMSG_CORPSE_LOCATION                              = 0x3700E4,
    SMSG_CORPSE_RECLAIM_DELAY                         = 0x3701DE,
    SMSG_CORPSE_TRANSPORT_QUERY                       = 0x3701A8,
    SMSG_COVENANT_CALLINGS_AVAILABILITY_RESPONSE      = 0x4B0024,
    SMSG_COVENANT_PREVIEW_OPEN_NPC                    = 0x37028B,
    SMSG_COVENANT_RENOWN_SEND_CATCHUP_STATE           = 0x3702F2,
    SMSG_CRAFTING_HOUSE_HELLO_RESPONSE                = 0x37031F,
    SMSG_CRAFTING_ORDER_CANCEL_RESULT                 = 0x37031B,
    SMSG_CRAFTING_ORDER_CLAIM_RESULT                  = 0x370317,
    SMSG_CRAFTING_ORDER_CRAFT_RESULT                  = 0x370319,
    SMSG_CRAFTING_ORDER_CREATE_RESULT                 = 0x370315,
    SMSG_CRAFTING_ORDER_FULFILL_RESULT                = 0x37031A,
    SMSG_CRAFTING_ORDER_LIST_ORDERS_RESPONSE          = 0x370316,
    SMSG_CRAFTING_ORDER_NPC_REWARD_INFO               = 0x370321,
    SMSG_CRAFTING_ORDER_REJECT_RESULT                 = 0x37031D,
    SMSG_CRAFTING_ORDER_RELEASE_RESULT                = 0x370318,
    SMSG_CRAFTING_ORDER_UPDATE_STATE                  = 0x370320,
    SMSG_CRAFT_ENCHANT_RESULT                         = 0x37031E,
    SMSG_CREATE_CHAR                                  = 0x370197,
    SMSG_CREATE_SHIPMENT_RESPONSE                     = 0x37022A,
    SMSG_CREATOR_VISUALS_OVERRIDE                     = 0x370324,
    SMSG_CRITERIA_DELETED                             = 0x37017D,
    SMSG_CRITERIA_UPDATE                              = 0x370177,
    SMSG_CROSSED_INEBRIATION_THRESHOLD                = 0x370158,
    SMSG_CURRENCY_TRANSFER_LOG                        = 0x370336,
    SMSG_CURRENCY_TRANSFER_RESULT                     = 0x370335,
    SMSG_CUSTOM_LOAD_SCREEN                           = 0x370062,
    SMSG_DAILY_QUESTS_RESET                           = 0x4B0000,
    SMSG_DAMAGE_CALC_LOG                              = 0x4D0054,
    SMSG_DB_REPLY                                     = 0x3B0000,
    SMSG_DEATH_RELEASE_LOC                            = 0x37016A,
    SMSG_DEBUG_MENU_MANAGER_FULL_UPDATE               = 0x3700EC,
    SMSG_DEFENSE_MESSAGE                              = 0x3C000A,
    SMSG_DELETE_CHAR                                  = 0x370198,
    SMSG_DELETE_EXPIRED_MISSIONS_RESULT               = 0x410022,
    SMSG_DELVES_ACCOUNT_DATA_ELEMENT_CHANGED          = 0x37033B,
    SMSG_DESTROY_ARENA_UNIT                           = 0x3701D6,
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0x37018F,
    SMSG_DIFFERENT_INSTANCE_FROM_PARTY                = 0x370020,
    SMSG_DISENCHANT_CREDIT                            = 0x37003E,
    SMSG_DISMOUNT_RESULT                              = 0x370010,
    SMSG_DISPEL_FAILED                                = 0x4D001E,
    SMSG_DISPLAY_GAME_ERROR                           = 0x370034,
    SMSG_DISPLAY_PLAYER_CHOICE                        = 0x4A0004,
    SMSG_DISPLAY_PROMOTION                            = 0x3700E1,
    SMSG_DISPLAY_QUEST_POPUP                          = 0x4B001E,
    SMSG_DISPLAY_SOULBIND_UPDATE_MESSAGE              = 0x3702F5,
    SMSG_DISPLAY_TOAST                                = 0x3700B9,
    SMSG_DISPLAY_WORLD_TEXT                           = 0x37027C,
    SMSG_DISPLAY_WORLD_TEXT_ON_TARGET                 = 0x4D0053,
    SMSG_DONT_AUTO_PUSH_SPELLS_TO_ACTION_BAR          = 0x370077,
    ...
    SMSG_DURABILITY_DAMAGE_DEATH                      = 0x3701D9,
    SMSG_EMOTE                                        = 0x370257,
    SMSG_ENABLE_BARBER_SHOP                           = 0x370153,
    SMSG_ENCHANTMENT_LOG                              = 0x3701A9,
    SMSG_ENCOUNTER_END                                = 0x370212,
    SMSG_ENCOUNTER_START                              = 0x370211,
    SMSG_END_LIGHTNING_STORM                          = 0x370140,
    SMSG_ENTER_ENCRYPTED_MODE                         = 0x3E0001,
    SMSG_ENUM_CHARACTERS_RESULT                       = 0x370018,
    SMSG_ENUM_VAS_PURCHASE_STATES_RESPONSE            = 0x370281,
    SMSG_ENVIRONMENTAL_DAMAGE_LOG                     = 0x4D000E,
    SMSG_EQUIPMENT_SET_ID                             = 0x370149,
    SMSG_EXPECTED_SPAM_RECORDS                        = 0x3C0005,
    SMSG_EXPLORATION_EXPERIENCE                       = 0x3701F3,
    SMSG_EXTERNAL_TRANSACTION_ID_GENERATED            = 0x3702EF,
    SMSG_FACTION_BONUS_INFO                           = 0x3701B9,
    SMSG_FAILED_PLAYER_CONDITION                      = 0x4A0002,
    SMSG_FAILED_QUEST_TURN_IN                         = 0x37029F,
    SMSG_FEATURE_SYSTEM_STATUS                        = 0x370056,
    SMSG_FEATURE_SYSTEM_STATUS2                       = 0x370333,
    SMSG_FEATURE_SYSTEM_STATUS_GLUE_SCREEN            = 0x370057,
    SMSG_FEIGN_DEATH_RESISTED                         = 0x3701D8,
    SMSG_FISH_ESCAPED                                 = 0x370167,
    SMSG_FISH_NOT_HOOKED                              = 0x370166,
    SMSG_FLIGHT_SPLINE_SYNC                           = 0x48005B,
    SMSG_FLUSH_COMBAT_LOG_FILE                        = 0x4D0010,
    SMSG_FORCED_DEATH_UPDATE                          = 0x37016B,
    SMSG_FORCE_ANIM                                   = 0x3701E5,
    SMSG_FORCE_ANIMATIONS                             = 0x3701E6,
    SMSG_FORCE_OBJECT_RELINK                          = 0x3700E0,
    SMSG_FORCE_RANDOM_TRANSMOG_TOAST                  = 0x370049,
    SMSG_FORCE_SPAWN_TRACKING_UPDATE                  = 0x4B0021,
    SMSG_FRIEND_STATUS                                = 0x37021A,
    SMSG_GAIN_MAW_POWER                               = 0x370270,
    SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT                = 0x37005A,
    SMSG_GAME_OBJECT_BASE                             = 0x3702B6,
    SMSG_GAME_OBJECT_CLOSE_INTERACTION                = 0x370307,
    SMSG_GAME_OBJECT_CUSTOM_ANIM                      = 0x37005B,
    SMSG_GAME_OBJECT_DESPAWN                          = 0x37005C,
    SMSG_GAME_OBJECT_INTERACTION                      = 0x370306,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL                = 0x4D003C,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL_KIT            = 0x4D003B,
    SMSG_GAME_OBJECT_RESET_STATE                      = 0x3701B3,
    SMSG_GAME_OBJECT_SET_STATE_LOCAL                  = 0x370292,
    SMSG_GAME_SPEED_SET                               = 0x370119,
    SMSG_GAME_TIME_SET                                = 0x3701A2,
    SMSG_GAME_TIME_UPDATE                             = 0x3701A1,
    ...
    SMSG_GENERATE_SSO_TOKEN_RESPONSE                  = 0x3702AA,
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT            = 0x3701F5,
    SMSG_GET_GARRISON_INFO_RESULT                     = 0x410000,
    SMSG_GET_LANDING_PAGE_SHIPMENTS_RESPONSE          = 0x37022D,
    SMSG_GET_REALM_HIDDEN_RESULT                      = 0x37032A,
    SMSG_GET_REMAINING_GAME_TIME_RESPONSE             = 0x370268,
    SMSG_GET_SELECTED_TROPHY_ID_RESPONSE              = 0x370255,
    SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE               = 0x37022C,
    SMSG_GET_SHIPMENT_INFO_RESPONSE                   = 0x370228,
    SMSG_GET_TROPHY_LIST_RESPONSE                     = 0x370254,
    SMSG_GET_VAS_ACCOUNT_CHARACTER_LIST_RESULT        = 0x37027D,
    SMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST_RESULT    = 0x37027E,
    SMSG_GM_PLAYER_INFO                               = 0x4A000D,
    SMSG_GM_REQUEST_PLAYER_INFO                       = 0x4A0003,
    SMSG_GM_TICKET_CASE_STATUS                        = 0x37013B,
    SMSG_GM_TICKET_SYSTEM_STATUS                      = 0x37013A,
    SMSG_GOD_MODE                                     = 0x370192,
    SMSG_GOSSIP_COMPLETE                              = 0x4B0017,
    SMSG_GOSSIP_MESSAGE                               = 0x4B0018,
    SMSG_GOSSIP_OPTION_NPC_INTERACTION                = 0x4B0028,
    SMSG_GOSSIP_POI                                   = 0x370225,
    SMSG_GOSSIP_QUEST_UPDATE                          = 0x4B0019,
    SMSG_GOSSIP_REFRESH_OPTIONS                       = 0x4B0027,
    SMSG_GROUP_ACTION_THROTTLED                       = 0x370024,
    SMSG_GROUP_AUTO_KICK                              = 0x370222,
    SMSG_GROUP_DECLINE                                = 0x37021E,
    SMSG_GROUP_DESTROYED                              = 0x370221,
    SMSG_GROUP_NEW_LEADER                             = 0x3700C2,
    SMSG_GROUP_REQUEST_DECLINE                        = 0x37021F,
    SMSG_GROUP_UNINVITE                               = 0x370220,
    ...
    SMSG_HARDCORE_DEATH_ALERT                         = 0x370332,
    SMSG_HEALTH_UPDATE                                = 0x370168,
    SMSG_HIGHEST_THREAT_UPDATE                        = 0x370170,
    SMSG_HOTFIX_CONNECT                               = 0x3B0003,
    SMSG_HOTFIX_MESSAGE                               = 0x3B0002,
    SMSG_INITIALIZE_FACTIONS                          = 0x3701B8,
    SMSG_INITIAL_SETUP                                = 0x370014,
    SMSG_INIT_WORLD_STATES                            = 0x3701DA,
    SMSG_INSPECT_RESULT                               = 0x3700C6,
    SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY           = 0x370240,
    SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT            = 0x37023F,
    SMSG_INSTANCE_ENCOUNTER_END                       = 0x370248,
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT               = 0x37023E,
    SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE = 0x37024A,
    SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION    = 0x370249,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE        = 0x370243,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START           = 0x370242,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE          = 0x370247,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED       = 0x37024B,
    SMSG_INSTANCE_ENCOUNTER_START                     = 0x370244,
    SMSG_INSTANCE_ENCOUNTER_TIMER_START               = 0x370241,
    SMSG_INSTANCE_ENCOUNTER_UPDATE_ALLOW_RELEASE_IN_PROGRESS = 0x370246,
    SMSG_INSTANCE_ENCOUNTER_UPDATE_SUPPRESS_RELEASE   = 0x370245,
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                  = 0x370190,
    SMSG_INSTANCE_INFO                                = 0x3700C9,
    SMSG_INSTANCE_RESET                               = 0x37011E,
    SMSG_INSTANCE_RESET_FAILED                        = 0x37011F,
    SMSG_INSTANCE_SAVE_CREATED                        = 0x370210,
    SMSG_INTERRUPT_POWER_REGEN                        = 0x4D004A,
    SMSG_INVALIDATE_PAGE_TEXT                         = 0x3B000A,
    SMSG_INVALIDATE_PLAYER                            = 0x4A0007,
    SMSG_INVALID_PROMOTION_CODE                       = 0x3701E7,
    SMSG_INVENTORY_CHANGE_FAILURE                     = 0x4E0005,
    SMSG_INVENTORY_FIXUP_COMPLETE                     = 0x3702A1,
    SMSG_INVENTORY_FULL_OVERFLOW                      = 0x3702B2,
    SMSG_ISLAND_AZERITE_GAIN                          = 0x3701F0,
    SMSG_ISLAND_COMPLETE                              = 0x3701F1,
    SMSG_IS_QUEST_COMPLETE_RESPONSE                   = 0x4B0004,
    SMSG_ITEM_CHANGED                                 = 0x370181,
    SMSG_ITEM_COOLDOWN                                = 0x370256,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                     = 0x3701E9,
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x370033,
    SMSG_ITEM_INTERACTION_COMPLETE                    = 0x3702E7,
    SMSG_ITEM_PURCHASE_REFUND_RESULT                  = 0x370031,
    SMSG_ITEM_PUSH_RESULT                             = 0x3700B8,
    SMSG_ITEM_TIME_UPDATE                             = 0x3701E8,
    SMSG_KICK_REASON                                  = 0x370121,
    SMSG_LATENCY_REPORT_PING                          = 0x3702F8,
    SMSG_LEARNED_SPELLS                               = 0x4D003E,
    SMSG_LEARN_PVP_TALENT_FAILED                      = 0x37006B,
    SMSG_LEARN_TALENT_FAILED                          = 0x37006A,
    SMSG_LEGACY_LOOT_RULES                            = 0x3702B7,
    SMSG_LEVEL_LINKING_RESULT                         = 0x3702CD,
    SMSG_LEVEL_UP_INFO                                = 0x37017F,
    ...
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT           = 0x370202,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT            = 0x370201,
    SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT = 0x3701F6,
    SMSG_LIVE_REGION_KEY_BINDINGS_COPY_RESULT         = 0x370203,
    SMSG_LOAD_CUF_PROFILES                            = 0x370053,
    SMSG_LOAD_EQUIPMENT_SET                           = 0x3701A4,
    SMSG_LOBBY_MATCHMAKER_LOBBY_ACQUIRED_SERVER       = 0x370309,
    SMSG_LOBBY_MATCHMAKER_PARTY_INFO                  = 0x37030A,
    SMSG_LOBBY_MATCHMAKER_PARTY_INVITE_REJECTED       = 0x37030B,
    SMSG_LOBBY_MATCHMAKER_RECEIVE_INVITE              = 0x37030C,
    SMSG_LOGIN_SET_TIME_SPEED                         = 0x3701A3,
    SMSG_LOGIN_VERIFY_WORLD                           = 0x37002E,
    SMSG_LOGOUT_CANCEL_ACK                            = 0x37011D,
    SMSG_LOGOUT_COMPLETE                              = 0x37011C,
    SMSG_LOGOUT_RESPONSE                              = 0x37011B,
    SMSG_LOG_XP_GAIN                                  = 0x37017B,
    SMSG_LOOT_ALL_PASSED                              = 0x3700B6,
    SMSG_LOOT_LIST                                    = 0x3701D5,
    SMSG_LOOT_MONEY_NOTIFY                            = 0x3700B1,
    SMSG_LOOT_RELEASE                                 = 0x3700B0,
    SMSG_LOOT_RELEASE_ALL                             = 0x3700AF,
    SMSG_LOOT_REMOVED                                 = 0x3700AB,
    SMSG_LOOT_RESPONSE                                = 0x3700AA,
    SMSG_LOOT_ROLL                                    = 0x3700B3,
    SMSG_LOOT_ROLLS_COMPLETE                          = 0x3700B5,
    SMSG_LOOT_ROLL_WON                                = 0x3700B7,
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                  = 0x370107,
    SMSG_MAIL_COMMAND_RESULT                          = 0x3700D0,
    SMSG_MAIL_LIST_RESULT                             = 0x3701EA,
    SMSG_MAIL_QUERY_NEXT_TIME_RESULT                  = 0x3701EB,
    SMSG_MAP_OBJECTIVES_INIT                          = 0x3D002A,
    SMSG_MAP_OBJ_EVENTS                               = 0x37005D,
    SMSG_MASTER_LOOT_CANDIDATE_LIST                   = 0x3700B4,
    SMSG_MEETING_STONE_FAILED                         = 0x37030D,
    SMSG_MESSAGE_BOX                                  = 0x37000A,
    SMSG_MINIMAP_PING                                 = 0x370165,
    SMSG_MIRROR_IMAGE_COMPONENTED_DATA                = 0x4D0004,
    SMSG_MIRROR_IMAGE_CREATURE_DATA                   = 0x4D0003,
    SMSG_MISSILE_CANCEL                               = 0x37005E,
    SMSG_MODIFY_COOLDOWN                              = 0x3701F8,
    SMSG_MOUNT_RESULT                                 = 0x37000F,
    SMSG_MOVEMENT_ENFORCEMENT_ALERT                   = 0x3702BD,
    ...
    SMSG_MULTI_FLOOR_LEAVE_FLOOR                      = 0x37026D,
    SMSG_MULTI_FLOOR_NEW_FLOOR                        = 0x37026C,
    SMSG_MYTHIC_PLUS_ALL_MAP_STATS                    = 0x3700A1,
    SMSG_MYTHIC_PLUS_CURRENT_AFFIXES                  = 0x3700A3,
    SMSG_MYTHIC_PLUS_NEW_WEEK_RECORD                  = 0x3700A7,
    SMSG_MYTHIC_PLUS_SEASON_DATA                      = 0x3700A2,
    SMSG_NEUTRAL_PLAYER_FACTION_SELECT_RESULT         = 0x370072,
    SMSG_NEW_DATA_BUILD                               = 0x370329,
    SMSG_NEW_TAXI_PATH                                = 0x370116,
    SMSG_NEW_WORLD                                    = 0x37002B,
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST                   = 0x4D0034,
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION          = 0x370142,
    SMSG_NOTIFY_MONEY                                 = 0x370030,
    SMSG_NOTIFY_RECEIVED_MAIL                         = 0x3700D1,
    SMSG_NPC_INTERACTION_OPEN_RESULT                  = 0x370305,
    SMSG_OFFER_PETITION_ERROR                         = 0x37014D,
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA         = 0x37017C,
    SMSG_ON_MONSTER_MOVE                              = 0x480002,
    SMSG_OPEN_ARTIFACT_FORGE                          = 0x370231,
    SMSG_OPEN_CONTAINER                               = 0x4E0006,
    SMSG_OPEN_LFG_DUNGEON_FINDER                      = 0x450015,
    SMSG_OPEN_SHIPMENT_NPC_RESULT                     = 0x370229,
    SMSG_OVERRIDE_LIGHT                               = 0x370152,
    SMSG_PAGE_TEXT                                    = 0x3701AF,
    SMSG_PARTY_COMMAND_RESULT                         = 0x370223,
    SMSG_PARTY_ELIGIBILITY_FOR_DELVE_TIERS_RESPONSE   = 0x37033E,
    SMSG_PARTY_INVITE                                 = 0x370054,
    SMSG_PARTY_KILL_LOG                               = 0x3701EE,
    SMSG_PARTY_MEMBER_FULL_STATE                      = 0x3701ED,
    SMSG_PARTY_MEMBER_PARTIAL_STATE                   = 0x3701EC,
    SMSG_PARTY_NOTIFY_LFG_LEADER_CHANGE               = 0x3702ED,
    SMSG_PARTY_UPDATE                                 = 0x37008A,
    SMSG_PAST_TIME_EVENTS                             = 0x370059,
    SMSG_PAUSE_MIRROR_TIMER                           = 0x3701A6,
    SMSG_PENDING_RAID_LOCK                            = 0x37018E,
    SMSG_PERKS_PROGRAM_ACTIVITY_COMPLETE              = 0x370302,
    SMSG_PERKS_PROGRAM_ACTIVITY_UPDATE                = 0x3702FE,
    SMSG_PERKS_PROGRAM_DISABLED                       = 0x370303,
    SMSG_PERKS_PROGRAM_RESULT                         = 0x3702FF,
    SMSG_PERKS_PROGRAM_VENDOR_UPDATE                  = 0x3702FD,
    SMSG_PETITION_ALREADY_SIGNED                      = 0x370036,
    SMSG_PETITION_RENAME_GUILD_RESPONSE               = 0x430042,
    SMSG_PETITION_SHOW_LIST                           = 0x370155,
    SMSG_PETITION_SHOW_SIGNATURES                     = 0x370156,
    SMSG_PETITION_SIGN_RESULTS                        = 0x3701E0,
    SMSG_PET_ACTION_FEEDBACK                          = 0x3701DD,
    SMSG_PET_ACTION_SOUND                             = 0x370138,
    SMSG_PET_BATTLE_CHAT_RESTRICTED                   = 0x370098,
    SMSG_PET_BATTLE_DEBUG_QUEUE_DUMP_RESPONSE         = 0x37010C,
    SMSG_PET_BATTLE_FINALIZE_LOCATION                 = 0x370091,
    SMSG_PET_BATTLE_FINAL_ROUND                       = 0x370096,
    SMSG_PET_BATTLE_FINISHED                          = 0x370097,
    SMSG_PET_BATTLE_FIRST_ROUND                       = 0x370093,
    SMSG_PET_BATTLE_INITIAL_UPDATE                    = 0x370092,
    SMSG_PET_BATTLE_MAX_GAME_LENGTH_WARNING           = 0x370099,
    SMSG_PET_BATTLE_PVP_CHALLENGE                     = 0x370090,
    SMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH               = 0x3700CE,
    SMSG_PET_BATTLE_QUEUE_STATUS                      = 0x3700CF,
    SMSG_PET_BATTLE_REPLACEMENTS_MADE                 = 0x370095,
    SMSG_PET_BATTLE_REQUEST_FAILED                    = 0x37008F,
    SMSG_PET_BATTLE_ROUND_RESULT                      = 0x370094,
    SMSG_PET_BATTLE_SLOT_UPDATES                      = 0x370082,
    SMSG_PET_CAST_FAILED                              = 0x4D0049,
    SMSG_PET_CLEAR_SPELLS                             = 0x4D0013,
    SMSG_PET_DISMISS_SOUND                            = 0x370139,
    SMSG_PET_GOD_MODE                                 = 0x370113,
    SMSG_PET_GUIDS                                    = 0x37019A,
    SMSG_PET_LEARNED_SPELLS                           = 0x4D0040,
    SMSG_PET_MODE                                     = 0x37001F,
    SMSG_PET_NAME_INVALID                             = 0x37015A,
    SMSG_PET_NEWLY_TAMED                              = 0x37001E,
    SMSG_PET_SPELLS_MESSAGE                           = 0x4D0014,
    SMSG_PET_STABLE_RESULT                            = 0x37002A,
    SMSG_PET_TAME_FAILURE                             = 0x37014A,
    SMSG_PET_UNLEARNED_SPELLS                         = 0x4D0041,
    SMSG_PHASE_SHIFT_CHANGE                           = 0x37000C,
    SMSG_PLAYED_TIME                                  = 0x37016C,
    ...
    SMSG_PLAY_MUSIC                                   = 0x3701FD,
    SMSG_PLAY_OBJECT_SOUND                            = 0x3701FE,
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                       = 0x3701C5,
    SMSG_PLAY_ORPHAN_SPELL_VISUAL                     = 0x4D0038,
    SMSG_PLAY_SCENE                                   = 0x3700CB,
    SMSG_PLAY_SOUND                                   = 0x3701FC,
    SMSG_PLAY_SPEAKERBOT_SOUND                        = 0x3701FF,
    SMSG_PLAY_SPELL_VISUAL                            = 0x4D0036,
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x4D003A,
    SMSG_PLAY_TIME_WARNING                            = 0x370194,
    SMSG_PONG                                         = 0x3E0006,
    SMSG_POWER_UPDATE                                 = 0x370169,
    SMSG_PRELOAD_CHILD_MAP                            = 0x37000D,
    SMSG_PRELOAD_WORLD                                = 0x37002C,
    SMSG_PREPOPULATE_NAME_CACHE                       = 0x3702C0,
    SMSG_PRE_RESSURECT                                = 0x3701FB,
    SMSG_PRINT_NOTIFICATION                           = 0x370061,
    SMSG_PROC_RESIST                                  = 0x3701EF,
    SMSG_PROFESSION_GOSSIP                            = 0x37028D,
    ...
    SMSG_QUERY_TIME_RESPONSE                          = 0x37017A,
    ...
    SMSG_QUEST_SESSION_INFO_RESPONSE                  = 0x3702E3,
    SMSG_QUEST_SESSION_READY_CHECK                    = 0x3702D1,
    SMSG_QUEST_SESSION_READY_CHECK_RESPONSE           = 0x3702D2,
    SMSG_QUEST_SESSION_RESULT                         = 0x3702D0,
    ...
    SMSG_QUEUE_SUMMARY_UPDATE                         = 0x3702A0,
    SMSG_RAF_ACCOUNT_INFO                             = 0x3702CE,
    SMSG_RAF_ACTIVITY_STATE_CHANGED                   = 0x3702DF,
    SMSG_RAF_DEBUG_FRIEND_MONTHS                      = 0x370326,
    SMSG_RAID_DIFFICULTY_SET                          = 0x37023B,
    SMSG_RAID_GROUP_ONLY                              = 0x37023D,
    SMSG_RAID_INSTANCE_MESSAGE                        = 0x3C0008,
    SMSG_RAID_MARKERS_CHANGED                         = 0x370037,
    SMSG_RANDOM_ROLL                                  = 0x3700C5,
    SMSG_RATED_PVP_INFO                               = 0x3D000F,
    SMSG_READY_CHECK_COMPLETED                        = 0x37008E,
    SMSG_READY_CHECK_RESPONSE                         = 0x37008D,
    SMSG_READY_CHECK_STARTED                          = 0x37008C,
    SMSG_READ_ITEM_RESULT_FAILED                      = 0x370237,
    SMSG_READ_ITEM_RESULT_OK                          = 0x37022E,
    SMSG_REALM_QUERY_RESPONSE                         = 0x3B0005,
    SMSG_REATTACH_RESURRECT                           = 0x3701DF,
    SMSG_RECEIVE_PING_UNIT                            = 0x370038,
    SMSG_RECEIVE_PING_WORLD_POINT                     = 0x370039,
    SMSG_RECRAFT_ITEM_RESULT                          = 0x37031C,
    SMSG_RECRUIT_A_FRIEND_FAILURE                     = 0x370157,
    SMSG_REFRESH_COMPONENT                            = 0x3700E6,
    SMSG_REGIONWIDE_CHARACTER_MAIL_DATA               = 0x37001A,
    SMSG_REGIONWIDE_CHARACTER_RESTRICTIONS_DATA       = 0x370019,
    SMSG_REMOVE_ITEM_PASSIVE                          = 0x370042,
    SMSG_REMOVE_SPELL_FROM_ACTION_BAR                 = 0x4D0043,
    SMSG_REPLACE_TROPHY_RESPONSE                      = 0x370253,
    ...
    SMSG_RESET_FAILED_NOTIFY                          = 0x37014E,
    SMSG_RESET_LAST_LOADED_CONFIG_CVARS               = 0x370323,
    SMSG_RESET_QUEST_POI                              = 0x4B0020,
    SMSG_RESET_RANGED_COMBAT_TIMER                    = 0x3D0023,
    SMSG_RESET_WEEKLY_CURRENCY                        = 0x370009,
    SMSG_RESPEC_WIPE_CONFIRM                          = 0x3700A8,
    SMSG_RESPOND_INSPECT_ACHIEVEMENTS                 = 0x370006,
    SMSG_RESPONSE_PERK_PENDING_REWARDS                = 0x370300,
    SMSG_RESPONSE_PERK_RECENT_PURCHASES               = 0x370301,
    SMSG_RESTART_GLOBAL_COOLDOWN                      = 0x4D0052,
    SMSG_RESTRICTED_ACCOUNT_WARNING                   = 0x370050,
    SMSG_RESUME_CAST                                  = 0x4D002C,
    SMSG_RESUME_CAST_BAR                              = 0x4D002F,
    SMSG_RESUME_COMMS                                 = 0x3E0003,
    SMSG_RESUME_TOKEN                                 = 0x370040,
    SMSG_RESURRECT_REQUEST                            = 0x370012,
    SMSG_RESYNC_RUNES                                 = 0x4D0050,
    SMSG_RETURNING_PLAYER_PROMPT                      = 0x370236,
    SMSG_RETURN_APPLICANT_LIST                        = 0x3702C4,
    SMSG_RETURN_RECRUITING_CLUBS                      = 0x3702C3,
    SMSG_ROLE_CHANGED_INFORM                          = 0x370021,
    SMSG_ROLE_CHOSEN                                  = 0x45001D,
    SMSG_ROLE_POLL_INFORM                             = 0x370022,
    SMSG_RUNEFORGE_LEGENDARY_CRAFTING_OPEN_NPC        = 0x37028C,
    SMSG_RUNE_REGEN_DEBUG                             = 0x37004D,
    SMSG_SCENARIO_COMPLETED                           = 0x37027A,
    SMSG_SCENARIO_POIS                                = 0x3700C8,
    SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x3700C1,
    SMSG_SCENARIO_SHOW_CRITERIA                       = 0x370290,
    SMSG_SCENARIO_STATE                               = 0x3700C0,
    SMSG_SCENARIO_UI_UPDATE                           = 0x37028F,
    SMSG_SCENARIO_VACATE                              = 0x370238,
    SMSG_SCENE_OBJECT_EVENT                           = 0x370078,
    SMSG_SCENE_OBJECT_PET_BATTLE_FINAL_ROUND          = 0x37007D,
    SMSG_SCENE_OBJECT_PET_BATTLE_FINISHED             = 0x37007E,
    SMSG_SCENE_OBJECT_PET_BATTLE_FIRST_ROUND          = 0x37007A,
    SMSG_SCENE_OBJECT_PET_BATTLE_INITIAL_UPDATE       = 0x370079,
    SMSG_SCENE_OBJECT_PET_BATTLE_REPLACEMENTS_MADE    = 0x37007C,
    SMSG_SCENE_OBJECT_PET_BATTLE_ROUND_RESULT         = 0x37007B,
    SMSG_SCRIPT_CAST                                  = 0x4D0047,
    SMSG_SEASON_INFO                                  = 0x370058,
    SMSG_SELL_RESPONSE                                = 0x37015B,
    SMSG_SEND_ITEM_PASSIVES                           = 0x370043,
    SMSG_SEND_KNOWN_SPELLS                            = 0x4D0019,
    SMSG_SEND_RAID_TARGET_UPDATE_ALL                  = 0x3700C3,
    SMSG_SEND_RAID_TARGET_UPDATE_SINGLE               = 0x3700C4,
    SMSG_SEND_SPELL_CHARGES                           = 0x4D001B,
    SMSG_SEND_SPELL_HISTORY                           = 0x4D001A,
    SMSG_SEND_UNLEARN_SPELLS                          = 0x4D001C,
    SMSG_SERVER_FIRST_ACHIEVEMENTS                    = 0x3700E3,
    SMSG_SERVER_TIME                                  = 0x37011A,
    SMSG_SERVER_TIME_OFFSET                           = 0x3701AA,
    SMSG_SETUP_COMBAT_LOG_FILE_FLUSH                  = 0x4D000F,
    SMSG_SETUP_CURRENCY                               = 0x370007,
    SMSG_SET_AI_ANIM_KIT                              = 0x3701C4,
    SMSG_SET_ANIM_TIER                                = 0x3701C8,
    SMSG_SET_CHR_UPGRADE_TIER                         = 0x370075,
    SMSG_SET_CURRENCY                                 = 0x370008,
    SMSG_SET_DF_FAST_LAUNCH_RESULT                    = 0x450012,
    SMSG_SET_DUNGEON_DIFFICULTY                       = 0x37013C,
    SMSG_SET_FACTION_AT_WAR                           = 0x370196,
    SMSG_SET_FACTION_NOT_VISIBLE                      = 0x3701BF,
    SMSG_SET_FACTION_STANDING                         = 0x3701C0,
    SMSG_SET_FACTION_VISIBLE                          = 0x3701BE,
    SMSG_SET_FLAT_SPELL_MODIFIER                      = 0x4D0027,
    SMSG_SET_ITEM_PURCHASE_DATA                       = 0x370032,
    SMSG_SET_LOOT_METHOD_FAILED                       = 0x37025E,
    SMSG_SET_MAX_WEEKLY_QUANTITY                      = 0x370035,
    SMSG_SET_MELEE_ANIM_KIT                           = 0x3701C7,
    SMSG_SET_MOVEMENT_ANIM_KIT                        = 0x3701C6,
    SMSG_SET_PCT_SPELL_MODIFIER                       = 0x4D0028,
    SMSG_SET_PET_SPECIALIZATION                       = 0x3700BA,
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT             = 0x4A000B,
    SMSG_SET_PLAY_HOVER_ANIM                          = 0x370051,
    SMSG_SET_PROFICIENCY                              = 0x3701C9,
    SMSG_SET_QUEST_REPLAY_COOLDOWN_OVERRIDE           = 0x3702D7,
    SMSG_SET_SHIPMENT_READY_RESPONSE                  = 0x41003A,
    SMSG_SET_SPELL_CHARGES                            = 0x4D0018,
    SMSG_SET_TIME_ZONE_INFORMATION                    = 0x37010F,
    SMSG_SET_VEHICLE_REC_ID                           = 0x37018D,
    SMSG_SHADOWLANDS_CAPACITANCE_UPDATE               = 0x370304,
    SMSG_SHIPMENT_FACTION_UPDATE_RESULT               = 0x41003B,
    SMSG_SHOW_DELVES_COMPANION_CONFIGURATION_UI       = 0x37033C,
    SMSG_SHOW_DELVES_DISPLAY_UI                       = 0x37033A,
    SMSG_SHOW_NEUTRAL_PLAYER_FACTION_SELECT_UI        = 0x370071,
    SMSG_SHOW_QUEST_COMPLETION_TEXT                   = 0x4B0015,
    SMSG_SHOW_TAXI_NODES                              = 0x370164,
    SMSG_SHOW_TRADE_SKILL_RESPONSE                    = 0x370204,
    SMSG_SOCIAL_CONTRACT_REQUEST_RESPONSE             = 0x37030E,
    SMSG_SOCKET_GEMS_FAILURE                          = 0x3701BC,
    SMSG_SOCKET_GEMS_SUCCESS                          = 0x3701BB,
    SMSG_SPECIAL_MOUNT_ANIM                           = 0x370137,
    SMSG_SPECTATE_END                                 = 0x370328,
    SMSG_SPECTATE_PLAYER                              = 0x370327,
    SMSG_SPEC_INVOLUNTARILY_CHANGED                   = 0x3701AE,
    ...
    SMSG_SPELL_VISUAL_LOAD_SCREEN                     = 0x370063,
    SMSG_SPLASH_SCREEN_SHOW_LATEST                    = 0x3702E9,
    SMSG_STAND_STATE_UPDATE                           = 0x3701B2,
    SMSG_STARTER_BUILD_ACTIVATE_FAILED                = 0x370069,
    SMSG_START_ELAPSED_TIMER                          = 0x37009A,
    SMSG_START_ELAPSED_TIMERS                         = 0x37009C,
    SMSG_START_LIGHTNING_STORM                        = 0x37013F,
    SMSG_START_LOOT_ROLL                              = 0x3700B2,
    SMSG_START_MIRROR_TIMER                           = 0x3701A5,
    SMSG_START_TIMER                                  = 0x37003C,
    SMSG_STOP_ELAPSED_TIMER                           = 0x37009B,
    SMSG_STOP_MIRROR_TIMER                            = 0x3701A7,
    SMSG_STOP_SPEAKERBOT_SOUND                        = 0x370200,
    SMSG_STOP_TIMER                                   = 0x37003D,
    SMSG_STREAMING_MOVIES                             = 0x37003B,
    SMSG_SUGGEST_INVITE_INFORM                        = 0x370224,
    SMSG_SUMMON_CANCEL                                = 0x370148,
    SMSG_SUMMON_RAID_MEMBER_VALIDATE_FAILED           = 0x370023,
    SMSG_SUMMON_REQUEST                               = 0x3701B6,
    SMSG_SUPERCEDED_SPELLS                            = 0x4D003D,
    SMSG_SUSPEND_COMMS                                = 0x3E0002,
    SMSG_SUSPEND_TOKEN                                = 0x37003F,
    SMSG_SYNC_WOW_ENTITLEMENTS                        = 0x3702E1,
    SMSG_TALENTS_INVOLUNTARILY_RESET                  = 0x3701AD,
    SMSG_TAXI_NODE_STATUS                             = 0x370114,
    SMSG_TEXT_EMOTE                                   = 0x370112,
    SMSG_THREAT_CLEAR                                 = 0x370173,
    SMSG_THREAT_REMOVE                                = 0x370172,
    SMSG_THREAT_UPDATE                                = 0x370171,
    SMSG_TIMERUNNING_SEASON_ENDED                     = 0x37033D,
    SMSG_TIME_ADJUSTMENT                              = 0x480001,
    SMSG_TIME_SYNC_REQUEST                            = 0x480000,
    SMSG_TITLE_EARNED                                 = 0x37016E,
    SMSG_TITLE_LOST                                   = 0x37016F,
    SMSG_TOTEM_CREATED                                = 0x37015E,
    SMSG_TOTEM_DURATION_CHANGED                       = 0x370160,
    SMSG_TOTEM_MOVED                                  = 0x370161,
    SMSG_TOTEM_REMOVED                                = 0x37015F,
    SMSG_TRADE_STATUS                                 = 0x370017,
    SMSG_TRADE_UPDATED                                = 0x370016,
    SMSG_TRAINER_BUY_FAILED                           = 0x370176,
    SMSG_TRAINER_LIST                                 = 0x370175,
    SMSG_TRAIT_CONFIG_COMMIT_FAILED                   = 0x370068,
    SMSG_TRANSFER_ABORTED                             = 0x370199,
    SMSG_TRANSFER_PENDING                             = 0x370064,
    SMSG_TREASURE_PICKER_RESPONSE                     = 0x3B0011,
    SMSG_TRIGGER_CINEMATIC                            = 0x370258,
    SMSG_TRIGGER_MOVIE                                = 0x370162,
    SMSG_TURN_IN_PETITION_RESULT                      = 0x3701E2,
    SMSG_TUTORIAL_FLAGS                               = 0x37024C,
    SMSG_UI_MAP_QUEST_LINES_RESPONSE                  = 0x4B0023,
    SMSG_UNDELETE_CHARACTER_RESPONSE                  = 0x370259,
    SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE            = 0x37025A,
    SMSG_UNLEARNED_SPELLS                             = 0x4D003F,
    SMSG_UNLOAD_CHILD_MAP                             = 0x37000E,
    SMSG_UPDATE_AADC_STATUS_RESPONSE                  = 0x3702FA,
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x37019F,
    SMSG_UPDATE_ACTION_BUTTONS                        = 0x370076,
    SMSG_UPDATE_BNET_SESSION_KEY                      = 0x3702B1,
    SMSG_UPDATE_CAPTURE_POINT                         = 0x3D0007,
    SMSG_UPDATE_CELESTIAL_BODY                        = 0x3702AD,
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x370252,
    SMSG_UPDATE_CHARGE_CATEGORY_COOLDOWN              = 0x3701FA,
    SMSG_UPDATE_COOLDOWN                              = 0x3701F9,
    SMSG_UPDATE_CRAFTING_NPC_RECIPES                  = 0x410038,
    SMSG_UPDATE_DAILY_MISSION_COUNTER                 = 0x410021,
    SMSG_UPDATE_EXPANSION_LEVEL                       = 0x3700DB,
    SMSG_UPDATE_GAME_TIME_STATE                       = 0x3702B4,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x370141,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x370120,
    SMSG_UPDATE_OBJECT                                = 0x470000,
    SMSG_UPDATE_PRIMARY_SPEC                          = 0x37006E,
    SMSG_UPDATE_RECENT_PLAYER_GUIDS                   = 0x37008B,
    SMSG_UPDATE_TALENT_DATA                           = 0x37006D,
    SMSG_UPDATE_WORLD_STATE                           = 0x3701DC,
    SMSG_USERLIST_ADD                                 = 0x3C000D,
    SMSG_USERLIST_REMOVE                              = 0x3C000E,
    SMSG_USERLIST_UPDATE                              = 0x3C000F,
    SMSG_USE_EQUIPMENT_SET_RESULT                     = 0x3701E3,
    SMSG_VAS_CHECK_TRANSFER_OK_RESPONSE               = 0x3702A8,
    SMSG_VAS_GET_QUEUE_MINUTES_RESPONSE               = 0x3702A6,
    SMSG_VAS_GET_SERVICE_STATUS_RESPONSE              = 0x3702A5,
    SMSG_VAS_PURCHASE_COMPLETE                        = 0x370280,
    SMSG_VAS_PURCHASE_STATE_UPDATE                    = 0x37027F,
    SMSG_VENDOR_INVENTORY                             = 0x37004F,
    SMSG_VIGNETTE_UPDATE                              = 0x4A0010,
    SMSG_VOICE_CHANNEL_INFO_RESPONSE                  = 0x3702AC,
    SMSG_VOICE_CHANNEL_STT_TOKEN_RESPONSE             = 0x3702F4,
    SMSG_VOICE_LOGIN_RESPONSE                         = 0x3702AB,
    ...
    SMSG_WARDEN3_DISABLED                             = 0x3702AF,
    SMSG_WARDEN3_ENABLED                              = 0x3702AE,
    SMSG_WARFRONT_COMPLETE                            = 0x3701F2,
    SMSG_WARGAME_REQUEST_OPPONENT_RESPONSE            = 0x3D0012,
    SMSG_WARGAME_REQUEST_SUCCESSFULLY_SENT_TO_OPPONENT = 0x3D0011,
    SMSG_WEATHER                                      = 0x37013E,
    SMSG_WEEKLY_REWARDS_PROGRESS_RESULT               = 0x3702EC,
    SMSG_WEEKLY_REWARDS_RESULT                        = 0x3702EA,
    SMSG_WEEKLY_REWARD_CLAIM_RESULT                   = 0x3702EB,
    SMSG_WHO                                          = 0x3C0002,
    SMSG_WHO_IS                                       = 0x37013D,
    SMSG_WILL_BE_KICKED_FOR_ADDED_SUBSCRIPTION_TIME   = 0x3702B3,
    SMSG_WORLD_QUEST_UPDATE_RESPONSE                  = 0x4A0017,
    SMSG_WORLD_SERVER_INFO                            = 0x370044,
    SMSG_WOW_ENTITLEMENT_NOTIFICATION                 = 0x3702E2,
    SMSG_WOW_LABS_NOTIFY_PLAYERS_MATCH_END            = 0x37030F,
    SMSG_WOW_LABS_NOTIFY_PLAYERS_MATCH_STATE_CHANGED  = 0x370310,
    SMSG_WOW_LABS_PARTY_ERROR                         = 0x370314,
    SMSG_WOW_LABS_SET_PREDICTION_CIRCLE               = 0x370311,
    SMSG_XP_AWARDED_FROM_CURRENCY                     = 0x370322,
    SMSG_XP_GAIN_ABORTED                              = 0x370060,
    SMSG_XP_GAIN_ENABLED                              = 0x37023C,
