...
enum OpcodeClient : uint16
{
    ...
    CMSG_ATTACK_STOP                                  = 0x326F,
    CMSG_ATTACK_SWING                                 = 0x326E,
    ...
    CMSG_AUTO_DEPOSIT_ACCOUNT_BANK                    = 0x3435,
    ...
    CMSG_AZERITE_EMPOWERED_ITEM_SELECT_POWER          = 0x33A5,
    CMSG_AZERITE_EMPOWERED_ITEM_VIEWED                = 0x3387,
    CMSG_AZERITE_ESSENCE_ACTIVATE_ESSENCE             = 0x33A7,
    CMSG_AZERITE_ESSENCE_UNLOCK_MILESTONE             = 0x33A6,
    CMSG_BANKER_ACTIVATE                              = 0x34BB,
    CMSG_BATTLEFIELD_LEAVE                            = 0x3173,
    CMSG_BATTLEFIELD_LIST                             = 0x317E,
    CMSG_BATTLEFIELD_PORT                             = 0x353A,
    CMSG_BATTLEMASTER_HELLO                           = 0x32DE,
    ...
    CMSG_CANCEL_CAST                                  = 0x32C7,
    CMSG_CANCEL_CHANNELLING                           = 0x3288,
    CMSG_CANCEL_GROWTH_AURA                           = 0x3290,
    CMSG_CANCEL_MASTER_LOOT_ROLL                      = 0x321D,
    CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS            = 0x31AD,
    CMSG_CANCEL_MOUNT_AURA                            = 0x32A3,
    ...
    CMSG_CAST_SPELL                                   = 0x32C4,
    CMSG_CHALLENGE_MODE_REQUEST_LEADERS               = 0x305E,
    CMSG_CHANGE_BAG_SLOT_FLAG                         = 0x3360,
    CMSG_CHANGE_BANK_BAG_SLOT_FLAG                    = 0x3361,
    CMSG_CHANGE_MONUMENT_APPEARANCE                   = 0x3341,
    ...
    CMSG_CHECK_IS_ADVENTURE_MAP_POI_VALID             = 0x3260,
    CMSG_CHOICE_RESPONSE                              = 0x32CC,
    CMSG_CHROMIE_TIME_SELECT_EXPANSION                = 0x33D6,
    CMSG_CLAIM_WEEKLY_REWARD                          = 0x33B3,
    CMSG_CLASS_TALENTS_DELETE_CONFIG                  = 0x340F,
    CMSG_CLASS_TALENTS_NOTIFY_EMPTY_CONFIG            = 0x3215,
    ...
    CMSG_CLASS_TALENTS_SET_USES_SHARED_ACTION_BARS    = 0x3214,
    ...
    CMSG_CLOSE_QUEST_CHOICE                           = 0x32CD,
    CMSG_CLOSE_RUNEFORGE_INTERACTION                  = 0x33DE,
    ...
    CMSG_CONFIRM_RESPEC_WIPE                          = 0x3217,
    ...
    CMSG_CONTENT_TRACKING_START_TRACKING              = 0x3423,
    CMSG_CONTENT_TRACKING_STOP_TRACKING               = 0x3424,
    ...
    CMSG_CONVERT_ITEM_TO_BIND_TO_ACCOUNT              = 0x3434,
    ...
    CMSG_CRAFTING_ORDER_GET_NPC_REWARD_INFO           = 0x358B,
    ...
    CMSG_DEPOSIT_REAGENT_BANK                         = 0x336A,
    CMSG_DESTROY_ITEM                                 = 0x32BA,
    ...
    CMSG_DO_MASTER_LOOT_ROLL                          = 0x321C,
    CMSG_DO_READY_CHECK                               = 0x3632,
    CMSG_DUEL_RESPONSE                                = 0x34F1,
    CMSG_EJECT_PASSENGER                              = 0x3255,
    CMSG_EMOTE                                        = 0x3556,
    ...
    CMSG_GARRISON_ADD_FOLLOWER_HEALTH                 = 0x3325,
    CMSG_GARRISON_ASSIGN_FOLLOWER_TO_BUILDING         = 0x330B,
    CMSG_GARRISON_CANCEL_CONSTRUCTION                 = 0x32F8,
    CMSG_GARRISON_CHECK_UPGRADEABLE                   = 0x335C,
    CMSG_GARRISON_COMPLETE_MISSION                    = 0x334E,
    CMSG_GARRISON_FULLY_HEAL_ALL_FOLLOWERS            = 0x3326,
    CMSG_GARRISON_GENERATE_RECRUITS                   = 0x330E,
    CMSG_GARRISON_GET_CLASS_SPEC_CATEGORY_INFO        = 0x331D,
    CMSG_GARRISON_GET_MAP_DATA                        = 0x3324,
    CMSG_GARRISON_GET_MISSION_REWARD                  = 0x3380,
    CMSG_GARRISON_LEARN_TALENT                        = 0x3319,
    CMSG_GARRISON_MISSION_BONUS_ROLL                  = 0x3350,
    CMSG_GARRISON_PURCHASE_BUILDING                   = 0x32F4,
    CMSG_GARRISON_RECRUIT_FOLLOWER                    = 0x3310,
    CMSG_GARRISON_REMOVE_FOLLOWER                     = 0x3345,
    CMSG_GARRISON_REMOVE_FOLLOWER_FROM_BUILDING       = 0x330C,
    CMSG_GARRISON_RENAME_FOLLOWER                     = 0x330D,
    CMSG_GARRISON_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA = 0x32F3,
    CMSG_GARRISON_REQUEST_SHIPMENT_INFO               = 0x3328,
    CMSG_GARRISON_RESEARCH_TALENT                     = 0x3311,
    CMSG_GARRISON_SET_BUILDING_ACTIVE                 = 0x32F5,
    CMSG_GARRISON_SET_FOLLOWER_FAVORITE               = 0x3309,
    CMSG_GARRISON_SET_FOLLOWER_INACTIVE               = 0x3301,
    CMSG_GARRISON_SET_RECRUITMENT_PREFERENCES         = 0x330F,
    CMSG_GARRISON_SOCKET_TALENT                       = 0x33EB,
    CMSG_GARRISON_START_MISSION                       = 0x334D,
    CMSG_GARRISON_SWAP_BUILDINGS                      = 0x32F9,
    CMSG_GENERATE_RANDOM_CHARACTER_NAME               = 0x35E7,
    CMSG_GET_ACCOUNT_CHARACTER_LIST                   = 0x36B3,
    CMSG_GET_ACCOUNT_NOTIFICATIONS                    = 0x3732,
    CMSG_GET_GARRISON_INFO                            = 0x32EE,
    CMSG_GET_ITEM_PURCHASE_DATA                       = 0x3544,
    CMSG_GET_LANDING_PAGE_SHIPMENTS                   = 0x3329,
    CMSG_GET_MIRROR_IMAGE_DATA                        = 0x32BE,
    ...
    CMSG_LFG_LIST_JOIN                                = 0x33A3,
    CMSG_LFG_LIST_LEAVE                               = 0x360C,
    CMSG_LFG_LIST_SEARCH                              = 0x360E,
    CMSG_LFG_LIST_UPDATE_REQUEST                      = 0x33A4,
    ...
    CMSG_LOAD_SELECTED_TROPHY                         = 0x333F,
    ...
    CMSG_LOOT_ITEM                                    = 0x321A,
    CMSG_LOOT_MONEY                                   = 0x3219,
    CMSG_LOOT_RELEASE                                 = 0x321E,
    CMSG_LOOT_ROLL                                    = 0x321F,
    CMSG_LOOT_UNIT                                    = 0x3218,
    CMSG_LOW_LEVEL_RAID1                              = 0x369F,
    CMSG_LOW_LEVEL_RAID2                              = 0x3522,
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x3550,
    CMSG_MAIL_DELETE                                  = 0x3234,
    ...
    CMSG_MAKE_CONTITIONAL_APPEARANCE_PERMANENT        = 0x3236,
    CMSG_MASTER_LOOT_ITEM                             = 0x321B,
    ...
    CMSG_MOUNT_SPECIAL_ANIM                           = 0x32A4,
    ...
    CMSG_OFFER_PETITION                               = 0x33D5,
    CMSG_OPENING_CINEMATIC                            = 0x3558,
    CMSG_OPEN_ITEM                                    = 0x335E,
    CMSG_OPEN_MISSION_NPC                             = 0x331F,
    CMSG_OPEN_SHIPMENT_NPC                            = 0x3327,
    CMSG_OPEN_TRADESKILL_NPC                          = 0x3332,
    ...
    CMSG_PERFORM_ITEM_INTERACTION                     = 0x323E,
    CMSG_PERKS_PROGRAM_ITEMS_REFRESHED                = 0x33FD,
    ...
    CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT        = 0x3233,
    ...
    CMSG_QUERY_BATTLE_PET_NAME                        = 0x3297,
    CMSG_QUERY_CORPSE_LOCATION_FROM_CLIENT            = 0x365E,
    CMSG_QUERY_CORPSE_TRANSPORT                       = 0x365F,
    CMSG_QUERY_COUNTDOWN_TIMER                        = 0x31A9,
    CMSG_QUERY_CREATURE                               = 0x3291,
    CMSG_QUERY_GAME_OBJECT                            = 0x3292,
    CMSG_QUERY_GARRISON_PET_NAME                      = 0x3298,
    CMSG_QUERY_GUILD_INFO                             = 0x3688,
    CMSG_QUERY_INSPECT_ACHIEVEMENTS                   = 0x350F,
    CMSG_QUERY_NEXT_MAIL_TIME                         = 0x354E,
    CMSG_QUERY_NPC_TEXT                               = 0x3293,
    CMSG_QUERY_PAGE_TEXT                              = 0x3295,
    CMSG_QUERY_PETITION                               = 0x3299,
    CMSG_QUERY_PET_NAME                               = 0x3296,
    ...
    CMSG_QUEST_SESSION_BEGIN_RESPONSE                 = 0x33C7,
    CMSG_QUEST_SESSION_REQUEST_START                  = 0x33C6,
    ...
    CMSG_REQUEST_VEHICLE_EXIT                         = 0x3250,
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                    = 0x3252,
    CMSG_REQUEST_VEHICLE_PREV_SEAT                    = 0x3251,
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                  = 0x3253,
    CMSG_REQUEST_WEEKLY_REWARDS                       = 0x33B4,
    CMSG_REQUEST_WORLD_QUEST_UPDATE                   = 0x3384,
    ...
    CMSG_REVERT_MONUMENT_APPEARANCE                   = 0x3342,
    CMSG_RIDE_VEHICLE_INTERACT                        = 0x3254,
    ...
    CMSG_SAVE_GUILD_EMBLEM                            = 0x32D3,
    CMSG_SAVE_PERSONAL_EMBLEM                         = 0x32D4,
    CMSG_SCENE_PLAYBACK_CANCELED                      = 0x322F,
    CMSG_SCENE_PLAYBACK_COMPLETE                      = 0x322E,
    CMSG_SCENE_TRIGGER_EVENT                          = 0x3230,
    CMSG_SEAMLESS_TRANSFER_COMPLETE                   = 0x3426,
    ...
    CMSG_SEND_PING_UNIT                               = 0x3428,
    CMSG_SEND_PING_WORLD_POINT                        = 0x3429,
    CMSG_SEND_TEXT_EMOTE                              = 0x348E,
    CMSG_SERVER_TIME_OFFSET_REQUEST                   = 0x369A,
    CMSG_SETUP_WARBAND_GROUPS                         = 0x375C,
    CMSG_SET_ACHIEVEMENTS_HIDDEN                      = 0x3235,
    CMSG_SET_ACTION_BAR_TOGGLES                       = 0x3547,
    CMSG_SET_ACTION_BUTTON                            = 0x3634,
    CMSG_SET_ACTIVE_MOVER                             = 0x3A3D,
    CMSG_SET_ADVANCED_COMBAT_LOGGING                  = 0x32E1,
    CMSG_SET_ASSISTANT_LEADER                         = 0x364D,
    CMSG_SET_BACKPACK_AUTOSORT_DISABLED               = 0x3362,
    CMSG_SET_BACKPACK_SELL_JUNK_DISABLED              = 0x3363,
    CMSG_SET_BANK_AUTOSORT_DISABLED                   = 0x3364,
    CMSG_SET_CONTACT_NOTES                            = 0x36CF,
    CMSG_SET_CURRENCY_FLAGS                           = 0x3169,
    CMSG_SET_DIFFICULTY_ID                            = 0x3231,
    CMSG_SET_DUNGEON_DIFFICULTY                       = 0x3680,
    CMSG_SET_EMPOWER_MIN_HOLD_STAGE_PERCENT           = 0x328B,
    ...
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT               = 0x3366,
    ...
    CMSG_SET_SORT_BAGS_RIGHT_TO_LEFT                  = 0x3365,
    CMSG_SET_TAXI_BENCHMARK_MODE                      = 0x3502,
    CMSG_SET_TITLE                                    = 0x32A2,
    CMSG_SET_TRADE_CURRENCY                           = 0x3160,
    CMSG_SET_TRADE_GOLD                               = 0x315F,
    CMSG_SET_TRADE_ITEM                               = 0x315D,
    CMSG_SET_USING_PARTY_GARRISON                     = 0x3321,
    CMSG_SET_WAR_MODE                                 = 0x32D9,
    ...
    CMSG_SORT_ACCOUNT_BANK_BAGS                       = 0x342C,
    CMSG_SORT_BAGS                                    = 0x3367,
    CMSG_SORT_BANK_BAGS                               = 0x3368,
    CMSG_SORT_REAGENT_BANK_BAGS                       = 0x3369,
    CMSG_SPAWN_TRACKING_UPDATE                        = 0x32B7,
    CMSG_SPECTATE_CHANGE                              = 0x341F,
    CMSG_SPELL_CLICK                                  = 0x349C,
    CMSG_SPELL_EMPOWER_RELEASE                        = 0x3289,
    CMSG_SPELL_EMPOWER_RESTART                        = 0x328A,
    ...
    CMSG_SUBSCRIPTION_INTERSTITIAL_RESPONSE           = 0x33DF,
    ...
    CMSG_TABARD_VENDOR_ACTIVATE                       = 0x32D5,
    ...
    CMSG_TOGGLE_PVP                                   = 0x32D7,
    CMSG_TOTEM_DESTROYED                              = 0x3507,
    CMSG_TOY_CLEAR_FANFARE                            = 0x3128,
    CMSG_TRADE_SKILL_SET_FAVORITE                     = 0x3382,
    ...
    CMSG_TRANSFER_CURRENCY_FROM_ACCOUNT_CHARACTER     = 0x3436,
    CMSG_TRANSMOGRIFY_ITEMS                           = 0x3197,
    CMSG_TURN_IN_PETITION                             = 0x354A,
    CMSG_TUTORIAL                                     = 0x36D9,
    CMSG_UI_MAP_QUEST_LINES_REQUEST                   = 0x33B0,
    ...
    CMSG_UPDATE_AREA_TRIGGER_VISUAL                   = 0x32C6,
    CMSG_UPDATE_CLIENT_SETTINGS                       = 0x3662,
    CMSG_UPDATE_CRAFTING_NPC_RECIPES                  = 0x3333,
    CMSG_UPDATE_MISSILE_TRAJECTORY                    = 0x3A44,
    CMSG_UPDATE_RAID_TARGET                           = 0x364E,
    CMSG_UPDATE_SPELL_VISUAL                          = 0x32C5,
    CMSG_UPDATE_VAS_PURCHASE_STATES                   = 0x36F0,
    CMSG_UPGRADE_GARRISON                             = 0x32E9,
    CMSG_UPGRADE_RUNEFORGE_LEGENDARY                  = 0x33DD,
    CMSG_USED_FOLLOW                                  = 0x3186,
    CMSG_USE_CRITTER_ITEM                             = 0x325A,
    CMSG_USE_EQUIPMENT_SET                            = 0x3995,
    CMSG_USE_ITEM                                     = 0x32BF,
    CMSG_USE_TOY                                      = 0x32C2,
    ...
    CMSG_WHO                                          = 0x367F,
    CMSG_WHO_IS                                       = 0x367E,
    CMSG_WORLD_LOOT_OBJECT_CLICK                      = 0x3422,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_CHARACTER_CURRENCY_LISTS             = 0x28A0,
    SMSG_ACCOUNT_CONVERSION_STATE_UPDATE              = 0x28A5,
    SMSG_ACCOUNT_COSMETIC_ADDED                       = 0x2863,
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x284A,
    SMSG_ACCOUNT_DATA_TIMES                           = 0x270C,
    SMSG_ACCOUNT_EXPORT_RESPONSE                      = 0x2891,
    SMSG_ACCOUNT_MOUNT_REMOVED                        = 0x25B2,
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0x25B1,
    SMSG_ACCOUNT_NOTIFICATIONS_RESPONSE               = 0x2862,
    ...
    SMSG_ACTIVE_SCHEDULED_WORLD_STATE_INFO            = 0x2747,
    ...
    SMSG_ADVANCED_COMBAT_LOG                          = 0x285F,
    SMSG_ADVENTURE_JOURNAL_DATA_RESPONSE              = 0x285A,
    ...
    SMSG_APPLY_MOUNT_EQUIPMENT_RESULT                 = 0x2838,
    ...
    SMSG_ARTIFACT_ENDGAME_POWERS_REFUNDED             = 0x27A1,
    SMSG_ARTIFACT_FORGE_ERROR                         = 0x279F,
    SMSG_ARTIFACT_RESPEC_PROMPT                       = 0x27A0,
    ...
    SMSG_AUCTION_DISABLE_NEW_POSTINGS                 = 0x287E,
    SMSG_AUCTION_FAVORITE_LIST                        = 0x2851,
    SMSG_AUCTION_GET_COMMODITY_QUOTE_RESULT           = 0x2849,
    SMSG_AUCTION_HELLO_RESPONSE                       = 0x26F0,
    SMSG_AUCTION_LIST_BIDDED_ITEMS_RESULT             = 0x2848,
    SMSG_AUCTION_LIST_BUCKETS_RESULT                  = 0x2845,
    SMSG_AUCTION_LIST_ITEMS_RESULT                    = 0x2846,
    SMSG_AUCTION_LIST_OWNED_ITEMS_RESULT              = 0x2847,
    ...
    SMSG_BACKPACK_DEFAULT_SIZE_CHANGED                = 0x287F,
    SMSG_BAG_CLEANUP_FINISHED                         = 0x2DA7,
    SMSG_BARBER_SHOP_RESULT                           = 0x26C0,
    SMSG_BATCH_PRESENCE_SUBSCRIPTION                  = 0x2829,
    ...
    SMSG_BATTLENET_CHALLENGE_ABORT                    = 0x2789,
    SMSG_BATTLENET_CHALLENGE_START                    = 0x2788,
    SMSG_BATTLENET_NOTIFICATION                       = 0x2801,
    SMSG_BATTLENET_RESPONSE                           = 0x2800,
    SMSG_BATTLE_NET_CONNECTION_STATUS                 = 0x2802,
    SMSG_BATTLE_PAY_ACK_FAILED                        = 0x2784,
    SMSG_BATTLE_PAY_BATTLE_PET_DELIVERED              = 0x2779,
    SMSG_BATTLE_PAY_COLLECTION_ITEM_DELIVERED         = 0x277A,
    SMSG_BATTLE_PAY_CONFIRM_PURCHASE                  = 0x2783,
    SMSG_BATTLE_PAY_DELIVERY_ENDED                    = 0x2777,
    SMSG_BATTLE_PAY_DELIVERY_STARTED                  = 0x2776,
    SMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS_RESPONSE  = 0x2868,
    SMSG_BATTLE_PAY_DISTRIBUTION_UNREVOKED            = 0x2774,
    SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE               = 0x2775,
    SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE    = 0x2773,
    SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE         = 0x2771,
    SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE        = 0x2772,
    SMSG_BATTLE_PAY_MOUNT_DELIVERED                   = 0x2778,
    SMSG_BATTLE_PAY_PURCHASE_UPDATE                   = 0x2782,
    SMSG_BATTLE_PAY_START_CHECKOUT                    = 0x281D,
    SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE = 0x2780,
    SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE           = 0x277F,
    ...
    SMSG_BROADCAST_SUMMON_CAST                        = 0x282B,
    SMSG_BROADCAST_SUMMON_RESPONSE                    = 0x282C,
    ...
    SMSG_CHARACTER_CHECK_UPGRADE_RESULT               = 0x27BC,
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x2707,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x2787,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x2763,
    SMSG_CHARACTER_UPGRADE_ABORTED                    = 0x27BB,
    SMSG_CHARACTER_UPGRADE_COMPLETE                   = 0x27BA,
    SMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_RESULT     = 0x27BD,
    SMSG_CHARACTER_UPGRADE_STARTED                    = 0x27B9,
    SMSG_CHAR_CUSTOMIZE_FAILURE                       = 0x26E4,
    SMSG_CHAR_CUSTOMIZE_SUCCESS                       = 0x26E5,
    SMSG_CHAR_FACTION_CHANGE_RESULT                   = 0x27A6,
    SMSG_CHAT                                         = 0x2BAD,
    ...
    SMSG_CHROMIE_TIME_SELECT_EXPANSION_SUCCESS        = 0x2854,
    SMSG_CLAIM_RAF_REWARD_RESPONSE                    = 0x283C,
    ...
    SMSG_CLOSE_ARTIFACT_FORGE                         = 0x279E,
    SMSG_CLUB_FINDER_ERROR_MESSAGE                    = 0x2834,
    SMSG_CLUB_FINDER_GET_CLUB_POSTING_IDS_RESPONSE    = 0x2837,
    SMSG_CLUB_FINDER_LOOKUP_CLUB_POSTINGS_LIST        = 0x2835,
    SMSG_CLUB_FINDER_RESPONSE_CHARACTER_APPLICATION_LIST = 0x2832,
    SMSG_CLUB_FINDER_RESPONSE_POST_RECRUITMENT_MESSAGE = 0x2836,
    SMSG_CLUB_FINDER_UPDATE_APPLICATIONS              = 0x2833,
    SMSG_CLUB_FINDER_WHISPER_APPLICANT_RESPONSE       = 0x2874,
    ...
    SMSG_COMPLETE_SHIPMENT_RESPONSE                   = 0x2797,
    ...
    SMSG_COVENANT_RENOWN_SEND_CATCHUP_STATE           = 0x285E,
    SMSG_CRAFTING_HOUSE_HELLO_RESPONSE                = 0x288B,
    SMSG_CRAFTING_ORDER_CANCEL_RESULT                 = 0x2887,
    SMSG_CRAFTING_ORDER_CLAIM_RESULT                  = 0x2883,
    SMSG_CRAFTING_ORDER_CRAFT_RESULT                  = 0x2885,
    SMSG_CRAFTING_ORDER_CREATE_RESULT                 = 0x2881,
    SMSG_CRAFTING_ORDER_FULFILL_RESULT                = 0x2886,
    SMSG_CRAFTING_ORDER_LIST_ORDERS_RESPONSE          = 0x2882,
    SMSG_CRAFTING_ORDER_NPC_REWARD_INFO               = 0x288D,
    SMSG_CRAFTING_ORDER_REJECT_RESULT                 = 0x2889,
    SMSG_CRAFTING_ORDER_RELEASE_RESULT                = 0x2884,
    SMSG_CRAFTING_ORDER_UPDATE_STATE                  = 0x288C,
    SMSG_CRAFT_ENCHANT_RESULT                         = 0x288A,
    SMSG_CREATE_CHAR                                  = 0x2703,
    SMSG_CREATE_SHIPMENT_RESPONSE                     = 0x2796,
    SMSG_CREATOR_VISUALS_OVERRIDE                     = 0x2890,
    SMSG_CRITERIA_DELETED                             = 0x26E9,
    SMSG_CRITERIA_UPDATE                              = 0x26E3,
    SMSG_CROSSED_INEBRIATION_THRESHOLD                = 0x26C4,
    SMSG_CURRENCY_TRANSFER_LOG                        = 0x28A2,
    SMSG_CURRENCY_TRANSFER_RESULT                     = 0x28A1,
    ...
    SMSG_DESTROY_ARENA_UNIT                           = 0x2742,
    ...
    SMSG_DISPLAY_SOULBIND_UPDATE_MESSAGE              = 0x2861,
    ...
    SMSG_ENCOUNTER_END                                = 0x277E,
    SMSG_ENCOUNTER_START                              = 0x277D,
    ...
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT            = 0x2761,
    SMSG_GET_GARRISON_INFO_RESULT                     = 0x295E,
    SMSG_GET_LANDING_PAGE_SHIPMENTS_RESPONSE          = 0x2799,
    SMSG_GET_REALM_HIDDEN_RESULT                      = 0x2896,
    SMSG_GET_REMAINING_GAME_TIME_RESPONSE             = 0x27D5,
    SMSG_GET_SELECTED_TROPHY_ID_RESPONSE              = 0x27C1,
    SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE               = 0x2798,
    SMSG_GET_SHIPMENT_INFO_RESPONSE                   = 0x2794,
    SMSG_GET_TROPHY_LIST_RESPONSE                     = 0x27C0,
    ...
    SMSG_GROUP_DECLINE                                = 0x278A,
    SMSG_GROUP_DESTROYED                              = 0x278D,
    SMSG_GROUP_NEW_LEADER                             = 0x262E,
    SMSG_GROUP_REQUEST_DECLINE                        = 0x278B,
    ...
    SMSG_HARDCORE_DEATH_ALERT                         = 0x289E,
    ...
    SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY           = 0x27AC,
    SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT            = 0x27AB,
    SMSG_INSTANCE_ENCOUNTER_END                       = 0x27B4,
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT               = 0x27AA,
    SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE = 0x27B6,
    SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION    = 0x27B5,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE        = 0x27AF,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START           = 0x27AE,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE          = 0x27B3,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED       = 0x27B7,
    SMSG_INSTANCE_ENCOUNTER_START                     = 0x27B0,
    SMSG_INSTANCE_ENCOUNTER_TIMER_START               = 0x27AD,
    SMSG_INSTANCE_ENCOUNTER_UPDATE_ALLOW_RELEASE_IN_PROGRESS = 0x27B2,
    SMSG_INSTANCE_ENCOUNTER_UPDATE_SUPPRESS_RELEASE   = 0x27B1,
    ...
    SMSG_LEVEL_LINKING_RESULT                         = 0x283A,
    ...
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT           = 0x276E,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT            = 0x276D,
    SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT = 0x2762,
    SMSG_LIVE_REGION_KEY_BINDINGS_COPY_RESULT         = 0x276F,
    SMSG_LOAD_CUF_PROFILES                            = 0x25BF,
    SMSG_LOAD_EQUIPMENT_SET                           = 0x2710,
    SMSG_LOBBY_MATCHMAKER_LOBBY_ACQUIRED_SERVER       = 0x2875,
    SMSG_LOBBY_MATCHMAKER_PARTY_INFO                  = 0x2876,
    SMSG_LOBBY_MATCHMAKER_PARTY_INVITE_REJECTED       = 0x2877,
    SMSG_LOBBY_MATCHMAKER_RECEIVE_INVITE              = 0x2878,
    ...
    SMSG_MEETING_STONE_FAILED                         = 0x2879,
    ...
    SMSG_MODIFY_COOLDOWN                              = 0x2764,
    SMSG_MOUNT_RESULT                                 = 0x257B,
    SMSG_MOVEMENT_ENFORCEMENT_ALERT                   = 0x282A,
    ...
    SMSG_PARTY_NOTIFY_LFG_LEADER_CHANGE               = 0x2859,
    SMSG_PARTY_UPDATE                                 = 0x25F6,
    SMSG_PAST_TIME_EVENTS                             = 0x25C5,
    SMSG_PAUSE_MIRROR_TIMER                           = 0x2712,
    SMSG_PENDING_RAID_LOCK                            = 0x26FA,
    SMSG_PERKS_PROGRAM_ACTIVITY_COMPLETE              = 0x286E,
    SMSG_PERKS_PROGRAM_ACTIVITY_UPDATE                = 0x286A,
    SMSG_PERKS_PROGRAM_DISABLED                       = 0x286F,
    SMSG_PERKS_PROGRAM_RESULT                         = 0x286B,
    SMSG_PERKS_PROGRAM_VENDOR_UPDATE                  = 0x2869,
    ...
    SMSG_PLAY_MUSIC                                   = 0x2769,
    SMSG_PLAY_OBJECT_SOUND                            = 0x276A,
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                       = 0x2731,
    SMSG_PLAY_ORPHAN_SPELL_VISUAL                     = 0x2C49,
    SMSG_PLAY_SCENE                                   = 0x2637,
    SMSG_PLAY_SOUND                                   = 0x2768,
    SMSG_PLAY_SPEAKERBOT_SOUND                        = 0x276B,
    ...
    SMSG_PREPOPULATE_NAME_CACHE                       = 0x282D,
    SMSG_PRE_RESSURECT                                = 0x2767,
    SMSG_PRINT_NOTIFICATION                           = 0x25CD,
    SMSG_PROC_RESIST                                  = 0x275B,
    ...
    SMSG_QUEST_SESSION_INFO_RESPONSE                  = 0x284F,
    SMSG_QUEST_SESSION_READY_CHECK                    = 0x283E,
    SMSG_QUEST_SESSION_READY_CHECK_RESPONSE           = 0x283F,
    SMSG_QUEST_SESSION_RESULT                         = 0x283D,
    ...
    SMSG_RAF_ACCOUNT_INFO                             = 0x283B,
    SMSG_RAF_ACTIVITY_STATE_CHANGED                   = 0x284B,
    SMSG_RAF_DEBUG_FRIEND_MONTHS                      = 0x2892,
    SMSG_RAID_DIFFICULTY_SET                          = 0x27A7,
    SMSG_RAID_GROUP_ONLY                              = 0x27A9,
    ...
    SMSG_READ_ITEM_RESULT_FAILED                      = 0x27A3,
    SMSG_READ_ITEM_RESULT_OK                          = 0x279A,
    SMSG_REALM_QUERY_RESPONSE                         = 0x2913,
    SMSG_REATTACH_RESURRECT                           = 0x274B,
    SMSG_RECEIVE_PING_UNIT                            = 0x25A4,
    SMSG_RECEIVE_PING_WORLD_POINT                     = 0x25A5,
    SMSG_RECRAFT_ITEM_RESULT                          = 0x2888,
    ...
    SMSG_REPLACE_TROPHY_RESPONSE                      = 0x27BF,
    ...
    SMSG_RESET_LAST_LOADED_CONFIG_CVARS               = 0x288F,
    ...
    SMSG_RESPONSE_PERK_PENDING_REWARDS                = 0x286C,
    SMSG_RESPONSE_PERK_RECENT_PURCHASES               = 0x286D,
    ...
    SMSG_RETURNING_PLAYER_PROMPT                      = 0x27A2,
    SMSG_RETURN_APPLICANT_LIST                        = 0x2831,
    SMSG_RETURN_RECRUITING_CLUBS                      = 0x2830,
    ...
    SMSG_SET_AI_ANIM_KIT                              = 0x2730,
    SMSG_SET_ANIM_TIER                                = 0x2734,
    ...
    SMSG_SET_FACTION_NOT_VISIBLE                      = 0x272B,
    ...
    SMSG_SET_MELEE_ANIM_KIT                           = 0x2733,
    SMSG_SET_MOVEMENT_ANIM_KIT                        = 0x2732,
    ...
    SMSG_SET_QUEST_REPLAY_COOLDOWN_OVERRIDE           = 0x2844,
    ...
    SMSG_SHADOWLANDS_CAPACITANCE_UPDATE               = 0x2870,
    SMSG_SHIPMENT_FACTION_UPDATE_RESULT               = 0x2999,
    SMSG_SHOW_DELVES_COMPANION_CONFIGURATION_UI       = 0x28A8,
    SMSG_SHOW_DELVES_DISPLAY_UI                       = 0x28A6,
    SMSG_SHOW_NEUTRAL_PLAYER_FACTION_SELECT_UI        = 0x25DD,
    SMSG_SHOW_QUEST_COMPLETION_TEXT                   = 0x2A95,
    SMSG_SHOW_TAXI_NODES                              = 0x26D0,
    SMSG_SHOW_TRADE_SKILL_RESPONSE                    = 0x2770,
    SMSG_SOCIAL_CONTRACT_REQUEST_RESPONSE             = 0x287A,
    SMSG_SOCKET_GEMS_FAILURE                          = 0x2728,
    SMSG_SOCKET_GEMS_SUCCESS                          = 0x2727,
    SMSG_SPECIAL_MOUNT_ANIM                           = 0x26A3,
    SMSG_SPECTATE_END                                 = 0x2894,
    SMSG_SPECTATE_PLAYER                              = 0x2893,
    ...
    SMSG_SPLASH_SCREEN_SHOW_LATEST                    = 0x2855,
    ...
    SMSG_TIMERUNNING_SEASON_ENDED                     = 0x28A9,
    ...
    SMSG_UPDATE_AADC_STATUS_RESPONSE                  = 0x2866,
    ...
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x27BE,
    SMSG_UPDATE_CHARGE_CATEGORY_COOLDOWN              = 0x2766,
    SMSG_UPDATE_COOLDOWN                              = 0x2765,
    ...
    SMSG_VOICE_CHANNEL_STT_TOKEN_RESPONSE             = 0x2860,
    ...
    SMSG_WARFRONT_COMPLETE                            = 0x275E,
    SMSG_WARGAME_REQUEST_OPPONENT_RESPONSE            = 0x2934,
    SMSG_WARGAME_REQUEST_SUCCESSFULLY_SENT_TO_OPPONENT = 0x2933,
    SMSG_WEATHER                                      = 0x26AA,
    SMSG_WEEKLY_REWARDS_PROGRESS_RESULT               = 0x2858,
    SMSG_WEEKLY_REWARDS_RESULT                        = 0x2856,
    SMSG_WEEKLY_REWARD_CLAIM_RESULT                   = 0x2857,
    SMSG_WHO                                          = 0x2BAE,
    SMSG_WHO_IS                                       = 0x26A9,
    ...
    SMSG_WOW_ENTITLEMENT_NOTIFICATION                 = 0x284E,
    SMSG_WOW_LABS_NOTIFY_PLAYERS_MATCH_END            = 0x287B,
    SMSG_WOW_LABS_NOTIFY_PLAYERS_MATCH_STATE_CHANGED  = 0x287C,
    SMSG_WOW_LABS_PARTY_ERROR                         = 0x2880,
    SMSG_WOW_LABS_SET_PREDICTION_CIRCLE               = 0x287D,
    SMSG_XP_AWARDED_FROM_CURRENCY                     = 0x288E,
    SMSG_XP_GAIN_ABORTED                              = 0x25CC,
    SMSG_XP_GAIN_ENABLED                              = 0x27A8,
