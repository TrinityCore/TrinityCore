...
enum OpcodeClient : uint32
{
    ...
    CMSG_ALTER_APPEARANCE                             = 0x34E8,
    CMSG_AREA_SPIRIT_HEALER_QUERY                     = 0x34AE,
    CMSG_AREA_SPIRIT_HEALER_QUEUE                     = 0x34AF,
    ...
    CMSG_AUCTION_HELLO_REQUEST                        = 0x34BE,
    CMSG_AUCTION_LIST_BIDDER_ITEMS                    = 0x34C4,
    CMSG_AUCTION_LIST_ITEMS                           = 0x34C1,
    CMSG_AUCTION_LIST_OWNER_ITEMS                     = 0x34C3,
    CMSG_AUCTION_LIST_PENDING_SALES                   = 0x34C6,
    CMSG_AUCTION_PLACE_BID                            = 0x34C5,
    CMSG_AUCTION_REMOVE_ITEM                          = 0x34C0,
    CMSG_AUCTION_REPLICATE_ITEMS                      = 0x34C2,
    CMSG_AUCTION_SELL_ITEM                            = 0x34BF,
    ...
    CMSG_BANKER_ACTIVATE                              = 0x34B1,
    CMSG_BATTLEFIELD_LEAVE                            = 0x3171,
    CMSG_BATTLEFIELD_LIST                             = 0x317C,
    CMSG_BATTLEFIELD_PORT                             = 0x3516,
    CMSG_BATTLEMASTER_HELLO                           = 0x3288,
    CMSG_BATTLEMASTER_JOIN                            = 0x3513,
    CMSG_BATTLEMASTER_JOIN_ARENA                      = 0x3514,
    CMSG_BATTLEMASTER_JOIN_SKIRMISH                   = 0x3515,
    ...
    CMSG_BINDER_ACTIVATE                              = 0x34B0,
    CMSG_BLACK_MARKET_BID_ON_ITEM                     = 0x351D,
    CMSG_BLACK_MARKET_OPEN                            = 0x351B,
    CMSG_BLACK_MARKET_REQUEST_ITEMS                   = 0x351C,
    CMSG_BUG_REPORT                                   = 0x368B,
    CMSG_BUSY_TRADE                                   = 0x3158,
    CMSG_BUY_BACK_ITEM                                = 0x34A2,
    CMSG_BUY_BANK_SLOT                                = 0x34B2,
    CMSG_BUY_ITEM                                     = 0x34A1,
    CMSG_BUY_REAGENT_BANK                             = 0x34B3,
    ...
    CMSG_CANCEL_AUTO_REPEAT_SPELL                     = 0x34DA,
    ...
    CMSG_CANCEL_TEMP_ENCHANTMENT                      = 0x34E5,
    ...
    CMSG_CLIENT_PORT_GRAVEYARD                        = 0x3518,
    CMSG_CLOSE_INTERACTION                            = 0x348D,
    ...
    CMSG_COMPLETE_CINEMATIC                           = 0x3535,
    CMSG_COMPLETE_MOVIE                               = 0x34D0,
    ...
    CMSG_DECLINE_GUILD_INVITES                        = 0x3511,
    CMSG_DECLINE_PETITION                             = 0x3524,
    CMSG_DELETE_EQUIPMENT_SET                         = 0x34FF,
    ...
    CMSG_GET_ITEM_PURCHASE_DATA                       = 0x351F,
    ...
    CMSG_GOSSIP_SELECT_OPTION                         = 0x348E,
    CMSG_GRANT_LEVEL                                  = 0x34EA,
    ...
    CMSG_GUILD_BANK_ACTIVATE                          = 0x34B4,
    CMSG_GUILD_BANK_BUY_TAB                           = 0x34B7,
    CMSG_GUILD_BANK_DEPOSIT_MONEY                     = 0x34B9,
    CMSG_GUILD_BANK_LOG_QUERY                         = 0x3082,
    CMSG_GUILD_BANK_QUERY_TAB                         = 0x34B6,
    CMSG_GUILD_BANK_REMAINING_WITHDRAW_MONEY_QUERY    = 0x3083,
    CMSG_GUILD_BANK_SET_TAB_TEXT                      = 0x3086,
    CMSG_GUILD_BANK_SWAP_ITEMS                        = 0x34B5,
    CMSG_GUILD_BANK_TEXT_QUERY                        = 0x3087,
    CMSG_GUILD_BANK_UPDATE_TAB                        = 0x34B8,
    CMSG_GUILD_BANK_WITHDRAW_MONEY                    = 0x34BA,
    ...
    CMSG_LEARN_PVP_TALENTS                            = 0x3543,
    CMSG_LEARN_TALENTS                                = 0x3542,
    ...
    CMSG_LOGOUT_CANCEL                                = 0x34CB,
    CMSG_LOGOUT_INSTANT                               = 0x34CC,
    CMSG_LOGOUT_REQUEST                               = 0x34CA,
    ...
    CMSG_LOW_LEVEL_RAID2                              = 0x3506,
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x352B,
    CMSG_MAIL_DELETE                                  = 0x320A,
    CMSG_MAIL_GET_LIST                                = 0x3526,
    CMSG_MAIL_MARK_AS_READ                            = 0x352A,
    CMSG_MAIL_RETURN_TO_SENDER                        = 0x3658,
    CMSG_MAIL_TAKE_ITEM                               = 0x3528,
    CMSG_MAIL_TAKE_MONEY                              = 0x3527,
    ...
    CMSG_PET_CANCEL_AURA                              = 0x3488,
    CMSG_PET_CAST_SPELL                               = 0x3275,
    CMSG_PET_RENAME                                   = 0x368A,
    CMSG_PET_SET_ACTION                               = 0x3484,
    CMSG_PET_SPELL_AUTOCAST                           = 0x3489,
    CMSG_PET_STOP_ATTACK                              = 0x3486,
    CMSG_PING                                         = 0x3768,
    CMSG_PLAYER_LOGIN                                 = 0x35E8,
    CMSG_PROTOCOL_MISMATCH                            = 0x376E,
    CMSG_PUSH_QUEST_TO_PARTY                          = 0x349D,
    ...
    CMSG_QUERY_INSPECT_ACHIEVEMENTS                   = 0x34F5,
    CMSG_QUERY_NEXT_MAIL_TIME                         = 0x3529,
    ...
    CMSG_QUERY_TIME                                   = 0x34C9,
    CMSG_QUERY_VOID_STORAGE                           = 0x319B,
    CMSG_QUEST_CONFIRM_ACCEPT                         = 0x349C,
    CMSG_QUEST_GIVER_ACCEPT_QUEST                     = 0x3493,
    CMSG_QUEST_GIVER_CHOOSE_REWARD                    = 0x3498,
    CMSG_QUEST_GIVER_COMPLETE_QUEST                   = 0x3496,
    CMSG_QUEST_GIVER_HELLO                            = 0x3490,
    CMSG_QUEST_GIVER_IGNORE_QUEST                     = 0x3494,
    CMSG_QUEST_GIVER_QUERY_QUEST                      = 0x3491,
    CMSG_QUEST_GIVER_REQUEST_REWARD                   = 0x3499,
    CMSG_QUEST_GIVER_STATUS_MULTIPLE_QUERY            = 0x349B,
    CMSG_QUEST_GIVER_STATUS_QUERY                     = 0x349A,
    CMSG_QUEST_GIVER_UNIGNORE_QUEST                   = 0x3495,
    CMSG_QUEST_LOG_REMOVE_QUEST                       = 0x351E,
    CMSG_QUEST_POI_QUERY                              = 0x36B5,
    CMSG_QUEST_PUSH_RESULT                            = 0x349E,
    ...
    CMSG_REPAIR_ITEM                                  = 0x34DF,
    CMSG_REPLACE_TROPHY                               = 0x32DC,
    CMSG_REPOP_REQUEST                                = 0x3517,
    CMSG_REPORT_PVP_PLAYER_AFK                        = 0x34E7,
    ...
    CMSG_REQUEST_STABLED_PETS                         = 0x348B,
    ...
    CMSG_SELF_RES                                     = 0x3521,
    CMSG_SELL_ITEM                                    = 0x34A0,
    ...
    CMSG_SEND_TEXT_EMOTE                              = 0x3481,
    CMSG_SET_ACHIEVEMENTS_HIDDEN                      = 0x320B,
    CMSG_SET_ACTION_BAR_TOGGLES                       = 0x3522,
    ...
    CMSG_SET_FACTION_AT_WAR                           = 0x34D1,
    CMSG_SET_FACTION_INACTIVE                         = 0x34D3,
    CMSG_SET_FACTION_NOT_AT_WAR                       = 0x34D2,
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT               = 0x3302,
    CMSG_SET_LFG_BONUS_FACTION_ID                     = 0x327B,
    CMSG_SET_LOOT_METHOD                              = 0x3648,
    CMSG_SET_LOOT_SPECIALIZATION                      = 0x352F,
    ...
    CMSG_SET_SELECTION                                = 0x3519,
    CMSG_SET_SHEATHED                                 = 0x3482,
    CMSG_SET_SORT_BAGS_RIGHT_TO_LEFT                  = 0x3301,
    CMSG_SET_TAXI_BENCHMARK_MODE                      = 0x34E6,
    ...
    CMSG_TALK_TO_GOSSIP                               = 0x348C,
    CMSG_TAXI_NODE_STATUS_QUERY                       = 0x34A6,
    CMSG_TAXI_QUERY_AVAILABLE_NODES                   = 0x34A8,
    CMSG_TAXI_REQUEST_EARLY_LANDING                   = 0x34AA,
