...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AURA_UPDATE_ALL,                                  STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EJECTED,                          STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EJECT_PENDING,                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_ENTERED,                          STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GAMEOBJECT_CUSTOM_ANIM,                           STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GROUP_INVITE,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_NEWS_UPDATE,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INSPECT_RATED_BG_STATS,                           STATUS_UNHANDLED,   CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INSPECT_RESULTS_UPDATE,                           STATUS_UNHANDLED,   CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INSPECT_TALENT,                                   STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_EXPIRE_PURCHASE_REFUND,                      STATUS_UNHANDLED,   CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_PUSH_RESULT,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_REFUND_INFO_RESPONSE,                        STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LEARNED_SPELL,                                    STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_CLEAR_MONEY,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_CONTENTS,                                    STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_ITEM_NOTIFY,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_RELEASE_RESPONSE,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_KNOCK_BACK,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_NORMAL_FALL,                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_HOVER,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_WEEKLY_SPELL_USAGE_UPDATE,                        STATUS_UNHANDLED,   CONNECTION_TYPE_INSTANCE    );
