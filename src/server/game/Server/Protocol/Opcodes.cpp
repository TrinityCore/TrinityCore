...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_QUERY_QUEST_ITEM_USABILITY,                         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQueryQuestItemUsability);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUEST_ITEM_USABILITY_RESPONSE,                                STATUS_NEVER,       CONNECTION_TYPE_REALM);
