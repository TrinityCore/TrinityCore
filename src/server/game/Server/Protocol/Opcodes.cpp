...
#define DEFINE_HANDLER(opcode, status, processing, packetclass, handler) \
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_AUCTION_HELLO_REQUEST,                   STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_BATTLE_PET_REQUEST_WILD,                 STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_DELETE_EQUIPMENT_SET,                    STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_ENABLE_TAXI_NODE,                        STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_GUILD_SET_FOCUSED_ACHIEVEMENT,           STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_MOVE_FORCE_ROOT_ACK,                     STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_MOVE_FORCE_UNROOT_ACK,                   STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_PLAYER_DIFFICULTY_CHANGE,                STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_REQUEST_BATTLEFIELD_STATUS,              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_REQUEST_GUILD_REWARDS_LIST,              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER_OLD(CMSG_REQUEST_HONOR_STATS,                     STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_SEARCH_LFG_JOIN,                         STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER_OLD(CMSG_SEARCH_LFG_LEAVE,                        STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_SET_FACTION_AT_WAR,                      STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_SET_LEARN_TALENTS,                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_SHOW_TRADE_SKIL,                         STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_TAXI_NODE_STATUS_QUERY,                  STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER_OLD(CMSG_TAXI_QUERY_AVAILABLE_NODES,              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_TIME_SYNC_RESPONSE,                      STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(CMSG_UPDATE_RAID_TARGET,                      STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER_OLD(MSG_MOVE_UPDATE_MOUSE,                        STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLE_PET_FINALIZE_LOCATION,            STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLE_PET_FINAL_ROUND,                  STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLE_PET_FIRST_ROUND,                  STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLE_PET_INITIAL_UPDATE,               STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLE_PET_PVP_CHALLENGE,                STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLE_PET_REPLACEMENTS_MADE,            STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLE_PET_REQUEST_FAILED,               STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BLACK_MARKET_ITEM_RESULT,                STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CRITERIA_UPDATE_ACCOUNT,                 STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CRITERIA_UPDATE_PLAYER,                  STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_FORCE_RUN_SPEED_CHANGE,                  STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_FORCE_SET_VEHICLE_REC_ID,                STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_FORCE_SWIM_SPEED_CHANGE,                 STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GARRISON_FOLLOWER_XP_CHANGED_RESULT,     STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_MOTD,                              STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LEARNED_SPELL,                           STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PETITION_RENAME_GUILD_RESULT,            STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_ITEM,                    STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_VEHILCE_REC_ID,                      STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
