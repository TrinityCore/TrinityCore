...
#define DEFINE_OPCODE_HANDLER(opcode, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AREATRIGGER,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAreaTriggerOpcode         );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AUTOBANK_ITEM,                                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoBankItemOpcode        );
    DEFINE_OPCODE_HANDLER(CMSG_AUTOEQUIP_ITEM,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoEquipItemOpcode       );
    DEFINE_OPCODE_HANDLER(CMSG_AUTOEQUIP_ITEM_SLOT,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoEquipItemSlotOpcode   );
    DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_BAG_ITEM,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoStoreBagItemOpcode    );
    DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_BANK_ITEM,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoStoreBankItemOpcode   );
    DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_LOOT_ITEM,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutostoreLootItemOpcode   );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BANKER_ACTIVATE,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBankerActivateOpcode      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEMASTER_JOIN_RATED,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlemasterJoinOpcode    );
    DEFINE_OPCODE_HANDLER(CMSG_BEGIN_TRADE,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBeginTradeOpcode          );
    DEFINE_OPCODE_HANDLER(CMSG_BINDER_ACTIVATE,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBinderActivateOpcode      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BUYBACK_ITEM,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBuybackItem               );
    DEFINE_OPCODE_HANDLER(CMSG_BUY_BANK_SLOT,                                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBuyBankSlotOpcode         );
    DEFINE_OPCODE_HANDLER(CMSG_BUY_ITEM,                                         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBuyItemOpcode             );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHANNEL_MODERATE,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelModerator          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CLEAR_CHANNEL_WATCH,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUnsetChannelWatch         );
    DEFINE_OPCODE_HANDLER(CMSG_CLEAR_RAID_MARKER,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupClearMarker          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_DISMISS_CONTROLLED_VEHICLE,                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleDismissControlledVehicle  );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_EJECT_PASSENGER,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleEjectPassenger            );
    DEFINE_OPCODE_HANDLER(CMSG_EMOTE,                                            STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleEmoteOpcode               );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_EQUIPMENT_SET_USE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleEquipmentSetUse           );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GAMEOBJ_REPORT_USE,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGameobjectReportUse       );
    DEFINE_OPCODE_HANDLER(CMSG_GAMEOBJ_USE,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGameObjectUseOpcode       );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GOSSIP_HELLO,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGossipHelloOpcode         );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_REQUEST_JOIN_UPDATES,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupRequestJoinUpdates   );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_ACHIEVEMENT_MEMBERS,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAchievementMembers   );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_CHANGE_NAME_REQUEST,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRenameRequest        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_QUERY_NEWS,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildQueryNewsOpcode      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SWITCH_RANK,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildSwitchRank           );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_INSPECT,                                          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleInspectOpcode             );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ITEM_REFUND,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleItemRefund                );
    DEFINE_OPCODE_HANDLER(CMSG_ITEM_REFUND_INFO,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleItemRefundInfoRequest     );
    DEFINE_OPCODE_HANDLER(CMSG_ITEM_TEXT_QUERY,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleItemTextQuery             );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LEARN_PREVIEW_TALENTS,                            STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleLearnPreviewTalents       );
    DEFINE_OPCODE_HANDLER(CMSG_LEARN_PREVIEW_TALENTS_PET,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleLearnPreviewTalentsPet    );
    DEFINE_OPCODE_HANDLER(CMSG_LEARN_TALENT,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleLearnTalentOpcode         );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LFG_LFR_JOIN,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfrJoinOpcode             );
    DEFINE_OPCODE_HANDLER(CMSG_LFG_LFR_LEAVE,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfrLeaveOpcode            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LFG_SET_COMMENT,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleLfgSetCommentOpcode       );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LIST_INVENTORY,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleListInventoryOpcode       );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NAME_QUERY,                                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleNameQueryOpcode           );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NPC_TEXT_QUERY,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleNpcTextQueryOpcode        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_OPEN_ITEM,                                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleOpenItemOpcode            );
    DEFINE_OPCODE_HANDLER(CMSG_OPT_OUT_OF_LOOT,                                  STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleOptOutOfLootOpcode        );
    DEFINE_OPCODE_HANDLER(CMSG_PAGE_TEXT_QUERY,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePageTextQueryOpcode       );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_CANCEL_AURA,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePetCancelAuraOpcode       );
    DEFINE_OPCODE_HANDLER(CMSG_PET_CAST_SPELL,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePetCastSpellOpcode        );
    DEFINE_OPCODE_HANDLER(CMSG_PET_LEARN_TALENT,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePetLearnTalent            );
    DEFINE_OPCODE_HANDLER(CMSG_PET_NAME_QUERY,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePetNameQuery              );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_SPELL_AUTOCAST,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePetSpellAutocastOpcode    );
    DEFINE_OPCODE_HANDLER(CMSG_PET_STOP_ATTACK,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePetStopAttack             );
    DEFINE_OPCODE_HANDLER(CMSG_PING,                                             STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess            );
    DEFINE_OPCODE_HANDLER(CMSG_PLAYED_TIME,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePlayedTime                );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_BATTLEFIELD_STATE,                          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBattlegroundStateQuery    );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_INSPECT_ACHIEVEMENTS,                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQueryInspectAchievements  );
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_QUESTS_COMPLETED,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQueryQuestsCompleted      );
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_TIME,                                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQueryTimeOpcode           );
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_ACCEPT_QUEST,                          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverAcceptQuestOpcode);
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_CHOOSE_REWARD,                         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverChooseRewardOpcode);
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_COMPLETE_QUEST,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverCompleteQuest   );
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_HELLO,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverHelloOpcode     );
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_QUERY_QUEST,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverQueryQuestOpcode);
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_REQUEST_REWARD,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverRequestRewardOpcode);
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUESTLOG_REMOVE_QUEST,                            STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestLogRemoveQuest       );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUEST_POI_QUERY,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestPOIQuery             );
    DEFINE_OPCODE_HANDLER(CMSG_QUEST_QUERY,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestQueryOpcode          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_READ_ITEM,                                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleReadItem                  );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REPAIR_ITEM,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRepairItemOpcode          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_RESEARCH_HISTORY,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestResearchHistory    );
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_VEHICLE_EXIT,                             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestVehicleExit        );
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_VEHICLE_NEXT_SEAT,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleChangeSeatsOnControlledVehicle);
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_VEHICLE_PREV_SEAT,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleChangeSeatsOnControlledVehicle);
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_VEHICLE_SWITCH_SEAT,                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleChangeSeatsOnControlledVehicle);
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SELL_ITEM,                                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSellItemOpcode            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_CURRENCY_FLAGS,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetCurrencyFlags          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_PET_SLOT,                                     STATUS_LOGGEDIN , PROCESS_THREADUNSAFE, &WorldSession::HandleSetPetSlot                );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_TITLE,                                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetTitleOpcode            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SHOWING_CLOAK,                                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleShowingCloakOpcode        );
    DEFINE_OPCODE_HANDLER(CMSG_SHOWING_HELM,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleShowingHelmOpcode         );
    DEFINE_OPCODE_HANDLER(CMSG_SOCKET_GEMS,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSocketOpcode              );
    DEFINE_OPCODE_HANDLER(CMSG_SPELLCLICK,                                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSpellClick                );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SPLIT_ITEM,                                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSplitItemOpcode           );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SWAP_INV_ITEM,                                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSwapInvItemOpcode         );
    DEFINE_OPCODE_HANDLER(CMSG_SWAP_ITEM,                                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSwapItem                  );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TRAINER_BUY_SPELL,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTrainerBuySpellOpcode     );
    DEFINE_OPCODE_HANDLER(CMSG_TRAINER_LIST,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTrainerListOpcode         );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_UNLEARN_SKILL,                                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleUnlearnSkillOpcode        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_USE_ITEM,                                         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleUseItemOpcode             );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_WARDEN_DATA,                                      STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleWardenDataOpcode          ); // STATUS_AUTHED
    ...
    DEFINE_OPCODE_HANDLER(CMSG_WHO,                                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleWhoOpcode                 );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ZONEUPDATE,                                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleZoneUpdateOpcode          );
    ...
    DEFINE_OPCODE_HANDLER(MSG_INSPECT_ARENA_TEAMS,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleInspectArenaTeamsOpcode   );
    ...
    DEFINE_OPCODE_HANDLER(MSG_TABARDVENDOR_ACTIVATE,                             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTabardVendorActivateOpcode);
    DEFINE_OPCODE_HANDLER(MSG_TALENT_WIPE_CONFIRM,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTalentWipeConfirmOpcode   );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BINDZONEREPLY,                                    STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_KICK_REASON,                                      STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_FLIGHT_SPEED,                         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RAID_MARKERS_CHANGED,                             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
