...
#define DEFINE_OPCODE_HANDLER(opcode, status, processing, handler)                                                  \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_QUERY_NEWS,                        STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleGuildQueryRanks           );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_REQUEST_MAX_DAILY_XP,              STATUS_LOGGEDIN,    PROCESS_INPLACE,      &WorldSession::HandleGuildRequestMaxXP         );
