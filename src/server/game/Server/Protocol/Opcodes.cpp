...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_ACTIVATETAXI,                                     STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleActivateTaxiOpcode        );
    DEFINE_HANDLER(CMSG_ACTIVATETAXIEXPRESS,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleActivateTaxiExpressOpcode );
    DEFINE_HANDLER(CMSG_ADDON_REGISTERED_PREFIXES,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonRegisteredPrefixesOpcode);
    ...
    DEFINE_HANDLER(CMSG_ADD_VOICE_IGNORE,                                 STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_ALTER_APPEARANCE,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAlterAppearance           );
    DEFINE_HANDLER(CMSG_AREATRIGGER,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAreaTriggerOpcode         );
    ...
    DEFINE_HANDLER(CMSG_ARENA_TEAM_ACCEPT,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamAcceptOpcode     );
    DEFINE_HANDLER(CMSG_ARENA_TEAM_CREATE,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamCreateOpcode     );
    DEFINE_HANDLER(CMSG_ARENA_TEAM_DECLINE,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamDeclineOpcode    );
    DEFINE_HANDLER(CMSG_ARENA_TEAM_DISBAND,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamDisbandOpcode    );
    DEFINE_HANDLER(CMSG_ARENA_TEAM_INVITE,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamInviteOpcode     );
    DEFINE_HANDLER(CMSG_ARENA_TEAM_LEADER,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamLeaderOpcode     );
    DEFINE_HANDLER(CMSG_ARENA_TEAM_LEAVE,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamLeaveOpcode      );
    ...
    DEFINE_HANDLER(CMSG_AUTH_SESSION,                                     STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess            );
    DEFINE_HANDLER(CMSG_AUTOBANK_ITEM,                                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoBankItemOpcode        );
    DEFINE_HANDLER(CMSG_AUTOEQUIP_ITEM,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoEquipItemOpcode       );
    DEFINE_HANDLER(CMSG_AUTOEQUIP_ITEM_SLOT,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoEquipItemSlotOpcode   );
    DEFINE_HANDLER(CMSG_AUTOSTORE_BAG_ITEM,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoStoreBagItemOpcode    );
    DEFINE_HANDLER(CMSG_AUTOSTORE_BANK_ITEM,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutoStoreBankItemOpcode   );
    DEFINE_HANDLER(CMSG_AUTOSTORE_LOOT_ITEM,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAutostoreLootItemOpcode   );
    DEFINE_HANDLER(CMSG_AUTO_DECLINE_GUILD_INVITES,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoDeclineGuildInvites   );
    DEFINE_HANDLER(CMSG_BANKER_ACTIVATE,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBankerActivateOpcode      );
    DEFINE_HANDLER(CMSG_BATTLEFIELD_LEAVE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBattlefieldLeaveOpcode    );
    DEFINE_HANDLER(CMSG_BATTLEFIELD_LIST,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlefieldListOpcode     );
    DEFINE_HANDLER(CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE,            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBfEntryInviteResponse     );
    DEFINE_HANDLER(CMSG_BATTLEFIELD_MGR_EXIT_REQUEST,                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBfExitRequest             );
    DEFINE_HANDLER(CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE,            STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBfQueueInviteResponse     );
    DEFINE_HANDLER(CMSG_BATTLEFIELD_MGR_QUEUE_REQUEST,                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBfQueueRequest            );
    DEFINE_HANDLER(CMSG_BATTLEFIELD_PORT,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattleFieldPortOpcode     );
    DEFINE_HANDLER(CMSG_BATTLEFIELD_STATUS,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlefieldStatusOpcode   );
    DEFINE_HANDLER(CMSG_BATTLEGROUND_PLAYER_POSITIONS,                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBattlegroundPlayerPositionsOpcode);
    ...
    DEFINE_HANDLER(CMSG_BATTLEMASTER_JOIN_RATED,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlemasterJoinOpcode    );
    ...
    DEFINE_HANDLER(CMSG_BUG,                                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBugOpcode                 );
    DEFINE_HANDLER(CMSG_BUSY_TRADE,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBusyTradeOpcode           );
    DEFINE_HANDLER(CMSG_BUYBACK_ITEM,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBuybackItem               );
    ...
    DEFINE_HANDLER(CMSG_CALENDAR_ARENA_TEAM,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCalendarArenaTeam         );
    ...
    DEFINE_HANDLER(CMSG_CALENDAR_EVENT_REMOVE_INVITE,                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCalendarEventRemoveInvite );
    DEFINE_HANDLER(CMSG_CALENDAR_EVENT_RSVP,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCalendarEventRsvp         );
    DEFINE_HANDLER(CMSG_CALENDAR_EVENT_SIGNUP,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCalendarEventSignup       );
    DEFINE_HANDLER(CMSG_CALENDAR_EVENT_STATUS,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCalendarEventStatus       );
    DEFINE_HANDLER(CMSG_CALENDAR_GET_CALENDAR,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCalendarGetCalendar       );
    ...
    DEFINE_HANDLER(CMSG_CHANNEL_ANNOUNCEMENTS,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelAnnouncements      );
    DEFINE_HANDLER(CMSG_CHANNEL_BAN,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelBan                );
    DEFINE_HANDLER(CMSG_CHANNEL_DISPLAY_LIST,                             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelDisplayListQuery   );
    DEFINE_HANDLER(CMSG_CHANNEL_INVITE,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelInvite             );
    DEFINE_HANDLER(CMSG_CHANNEL_KICK,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelKick               );
    DEFINE_HANDLER(CMSG_CHANNEL_LIST,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelList               );
    DEFINE_HANDLER(CMSG_CHANNEL_MODERATE,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelModerator          );
    DEFINE_HANDLER(CMSG_CHANNEL_MODERATOR,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelModerator          );
    DEFINE_HANDLER(CMSG_CHANNEL_MUTE,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelMute               );
    DEFINE_HANDLER(CMSG_CHANNEL_OWNER,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelOwner              );
    DEFINE_HANDLER(CMSG_CHANNEL_PASSWORD,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelPassword           );
    DEFINE_HANDLER(CMSG_CHANNEL_ROSTER_INFO,                              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHANNEL_SET_OWNER,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelSetOwner           );
    DEFINE_HANDLER(CMSG_CHANNEL_SILENCE_ALL,                              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHANNEL_SILENCE_VOICE,                            STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHANNEL_UNBAN,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnban              );
    DEFINE_HANDLER(CMSG_CHANNEL_UNMODERATOR,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnmoderator        );
    DEFINE_HANDLER(CMSG_CHANNEL_UNMUTE,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnmute             );
    DEFINE_HANDLER(CMSG_CHANNEL_UNSILENCE_ALL,                            STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHANNEL_UNSILENCE_VOICE,                          STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHANNEL_VOICE_OFF,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelVoiceOnOpcode      );
    DEFINE_HANDLER(CMSG_CHANNEL_VOICE_ON,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelVoiceOnOpcode      );
    ...
    DEFINE_HANDLER(CMSG_COMMENTATOR_GET_PARTY_INFO,                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(CMSG_COMPLAIN,                                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleComplainOpcode            );
    ...
    DEFINE_HANDLER(CMSG_CONTACT_LIST,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleContactListOpcode         );
    DEFINE_HANDLER(CMSG_CORPSE_MAP_POSITION_QUERY,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCorpseMapPositionQuery    );
    DEFINE_HANDLER(CMSG_CREATURE_QUERY,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleCreatureQueryOpcode       );
    DEFINE_HANDLER(CMSG_DANCE_QUERY,                                      STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(CMSG_DEL_VOICE_IGNORE,                                 STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_DESTROY_ITEM,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDestroyItemOpcode         );
    DEFINE_HANDLER(CMSG_DISMISS_CONTROLLED_VEHICLE,                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleDismissControlledVehicle  );
    DEFINE_HANDLER(CMSG_DISMISS_CRITTER,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDismissCritter            );
    DEFINE_HANDLER(CMSG_DUEL_ACCEPTED,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDuelAcceptedOpcode        );
    DEFINE_HANDLER(CMSG_DUEL_CANCELLED,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDuelCancelledOpcode       );
    ...
    DEFINE_HANDLER(CMSG_FORCE_MOVE_ROOT_ACK,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveRootAck               );
    DEFINE_HANDLER(CMSG_FORCE_MOVE_UNROOT_ACK,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveUnRootAck             );
    DEFINE_HANDLER(CMSG_GAMEOBJECT_QUERY,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGameObjectQueryOpcode     );
    DEFINE_HANDLER(CMSG_GAMEOBJ_REPORT_USE,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGameobjectReportUse       );
    DEFINE_HANDLER(CMSG_GAMEOBJ_USE,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGameObjectUseOpcode       );
    DEFINE_HANDLER(CMSG_GET_MAIL_LIST,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetMailList               );
    DEFINE_HANDLER(CMSG_GET_MIRRORIMAGE_DATA,                             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMirrorImageDataRequest    );
    DEFINE_HANDLER(CMSG_GMRESPONSE_RESOLVE,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMResponseResolve         );
    DEFINE_HANDLER(CMSG_GMSURVEY_SUBMIT,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMSurveySubmit            );
    DEFINE_HANDLER(CMSG_GMTICKET_CREATE,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketCreateOpcode      );
    DEFINE_HANDLER(CMSG_GMTICKET_DELETETICKET,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketDeleteOpcode      );
    DEFINE_HANDLER(CMSG_GMTICKET_GETTICKET,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketGetTicketOpcode   );
    DEFINE_HANDLER(CMSG_GMTICKET_SYSTEMSTATUS,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketSystemStatusOpcode);
    DEFINE_HANDLER(CMSG_GMTICKET_UPDATETEXT,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketUpdateOpcode      );
    DEFINE_HANDLER(CMSG_GM_REPORT_LAG,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReportLag                 );
    DEFINE_HANDLER(CMSG_GOSSIP_HELLO,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGossipHelloOpcode         );
    ...
    DEFINE_HANDLER(CMSG_GROUP_SET_ROLES,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGroupSetRolesOpcode       );
    DEFINE_HANDLER(CMSG_GROUP_SWAP_SUB_GROUP,                             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupSwapSubGroupOpcode   );
    DEFINE_HANDLER(CMSG_GROUP_UNINVITE_GUID,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupUninviteGuidOpcode   );
    DEFINE_HANDLER(CMSG_GUILD_ACCEPT,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAcceptOpcode         );
    DEFINE_HANDLER(CMSG_GUILD_ACHIEVEMENT_MEMBERS,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAchievementMembers   );
    ...
    DEFINE_HANDLER(CMSG_GUILD_CHANGE_NAME_REQUEST,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRenameRequest        );
    DEFINE_HANDLER(CMSG_GUILD_DECLINE,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDeclineOpcode        );
    DEFINE_HANDLER(CMSG_GUILD_DEL_RANK,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDelRankOpcode        );
    DEFINE_HANDLER(CMSG_GUILD_DEMOTE,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDemoteOpcode         );
    DEFINE_HANDLER(CMSG_GUILD_DISBAND,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDisbandOpcode        );
    DEFINE_HANDLER(CMSG_GUILD_EVENT_LOG_QUERY,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildEventLogQueryOpcode  );
    DEFINE_HANDLER(CMSG_GUILD_INFO_TEXT,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildChangeInfoTextOpcode );
    DEFINE_HANDLER(CMSG_GUILD_INVITE,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildInviteOpcode         );
    DEFINE_HANDLER(CMSG_GUILD_LEAVE,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildLeaveOpcode          );
    ...
    DEFINE_HANDLER(CMSG_GUILD_GET_ROSTER,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildGetRosterOpcode      );
    ...
    DEFINE_HANDLER(CMSG_JOIN_CHANNEL,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleJoinChannel               );
    DEFINE_HANDLER(CMSG_KEEP_ALIVE,                                       STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess            );
    DEFINE_HANDLER(CMSG_LEARN_PREVIEW_TALENTS,                            STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleLearnPreviewTalents       );
    DEFINE_HANDLER(CMSG_LEARN_PREVIEW_TALENTS_PET,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleLearnPreviewTalentsPet    );
    DEFINE_HANDLER(CMSG_LEARN_TALENT,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleLearnTalentOpcode         );
    DEFINE_HANDLER(CMSG_LEAVE_CHANNEL,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLeaveChannel              );
    DEFINE_HANDLER(CMSG_LFG_GET_STATUS,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleLfgGetStatus              );
    DEFINE_HANDLER(CMSG_LFG_JOIN,                                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgJoinOpcode             );
    ...
    DEFINE_HANDLER(CMSG_LFG_SET_ROLES,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetRolesOpcode         );
    DEFINE_HANDLER(CMSG_LFG_TELEPORT,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgTeleportOpcode         );
    ...
    DEFINE_HANDLER(CMSG_LF_GUILD_POST_REQUEST,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderPostRequest    );
    ...
    DEFINE_HANDLER(CMSG_LOOT,                                             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootOpcode                );
    DEFINE_HANDLER(CMSG_LOOT_CURRENCY,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootCurrencyOpcode        );
    DEFINE_HANDLER(CMSG_LOOT_MASTER_GIVE,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMasterGiveOpcode      );
    DEFINE_HANDLER(CMSG_LOOT_METHOD,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMethodOpcode          );
    ...
    DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_BATTLEGROUND,                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode    );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_GUILD,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode    );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_OFFICER,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode    );
    ...
    DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_RAID,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode    );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_ADDON_WHISPER,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode    );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_AFK,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_BATTLEGROUND,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_CHANNEL,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_DND,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_EMOTE,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_GUILD,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_OFFICER,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_PARTY,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_RAID,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_RAID_WARNING,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_SAY,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_WHISPER,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MESSAGECHAT_YELL,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode         );
    DEFINE_HANDLER(CMSG_MINIGAME_MOVE,                                    STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_MOUNTSPECIAL_ANIM,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMountSpecialAnimOpcode    );
    DEFINE_HANDLER(CMSG_MOVE_CHNG_TRANSPORT,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(CMSG_MOVE_FALL_RESET,                                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(CMSG_MOVE_FEATHER_FALL_ACK,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleFeatherFallAck            );
    ...
    DEFINE_HANDLER(CMSG_NAME_QUERY,                                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleNameQueryOpcode           );
    DEFINE_HANDLER(CMSG_NEXT_CINEMATIC_CAMERA,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNextCinematicCamera       );
    DEFINE_HANDLER(CMSG_NPC_TEXT_QUERY,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleNpcTextQueryOpcode        );
    ...
    DEFINE_HANDLER(CMSG_OFFER_PETITION,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleOfferPetitionOpcode       );
    ...
    DEFINE_HANDLER(CMSG_OPT_OUT_OF_LOOT,                                  STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleOptOutOfLootOpcode        );
    DEFINE_HANDLER(CMSG_PAGE_TEXT_QUERY,                                  STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePageTextQueryOpcode       );
    DEFINE_HANDLER(CMSG_PARTY_SILENCE,                                    STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_PARTY_UNSILENCE,                                  STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_PETITION_BUY,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionBuyOpcode         );
    DEFINE_HANDLER(CMSG_PETITION_QUERY,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionQueryOpcode       );
    DEFINE_HANDLER(CMSG_PETITION_SHOWLIST,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionShowListOpcode    );
    ...
    DEFINE_HANDLER(CMSG_PET_NAME_QUERY,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePetNameQuery              );
    ...
    DEFINE_HANDLER(CMSG_PLAYED_TIME,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePlayedTime                );
    ...
    DEFINE_HANDLER(CMSG_PLAY_DANCE,                                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(CMSG_QUESTGIVER_ACCEPT_QUEST,                          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverAcceptQuestOpcode);
    DEFINE_HANDLER(CMSG_QUESTGIVER_CHOOSE_REWARD,                         STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverChooseRewardOpcode);
    DEFINE_HANDLER(CMSG_QUESTGIVER_COMPLETE_QUEST,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverCompleteQuest   );
    DEFINE_HANDLER(CMSG_QUESTGIVER_HELLO,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverHelloOpcode     );
    DEFINE_HANDLER(CMSG_QUESTGIVER_QUERY_QUEST,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverQueryQuestOpcode);
    DEFINE_HANDLER(CMSG_QUESTGIVER_REQUEST_REWARD,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverRequestRewardOpcode);
    DEFINE_HANDLER(CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY,                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverStatusMultipleQuery);
    DEFINE_HANDLER(CMSG_QUESTGIVER_STATUS_QUERY,                          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverStatusQueryOpcode);
    ...
    DEFINE_HANDLER(CMSG_REALM_SPLIT,                                      STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleRealmSplitOpcode          );
    DEFINE_HANDLER(CMSG_RECLAIM_CORPSE,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReclaimCorpseOpcode       );
    DEFINE_HANDLER(CMSG_REFORGE_ITEM,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleReforgeItemOpcode         );
    DEFINE_HANDLER(CMSG_REORDER_CHARACTERS,                               STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandleReorderCharacters         );
    DEFINE_HANDLER(CMSG_REPAIR_ITEM,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRepairItemOpcode          );
    DEFINE_HANDLER(CMSG_REPOP_REQUEST,                                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRepopRequestOpcode        );
    DEFINE_HANDLER(CMSG_REPORT_PVP_AFK,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReportPvPAFK              );
    ...
    DEFINE_HANDLER(CMSG_REQUEST_RATED_BG_INFO,                            STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestRatedBgInfo        );
    DEFINE_HANDLER(CMSG_REQUEST_RATED_BG_STATS,                           STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestRatedBgStats       );
    ...
    DEFINE_HANDLER(CMSG_REQUEST_VEHICLE_NEXT_SEAT,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleChangeSeatsOnControlledVehicle);
    DEFINE_HANDLER(CMSG_REQUEST_VEHICLE_PREV_SEAT,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleChangeSeatsOnControlledVehicle);
    DEFINE_HANDLER(CMSG_REQUEST_VEHICLE_SWITCH_SEAT,                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleChangeSeatsOnControlledVehicle);
    DEFINE_HANDLER(CMSG_RESET_FACTION_CHEAT,                              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_RESET_INSTANCES,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleResetInstancesOpcode      );
    DEFINE_HANDLER(CMSG_RESURRECT_RESPONSE,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleResurrectResponseOpcode   );
    DEFINE_HANDLER(CMSG_RETURN_TO_GRAVEYARD,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReturnToGraveyard         );
    DEFINE_HANDLER(CMSG_ROLE_POLL_BEGIN,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRolePollBeginOpcode       );
    ...
    DEFINE_HANDLER(CMSG_SET_ACTIVE_VOICE_CHANNEL,                         STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetActiveVoiceChannel     ); // STATUS_AUTHED
    DEFINE_HANDLER(CMSG_SET_ALLOW_LOW_LEVEL_RAID1,                        STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_SET_ALLOW_LOW_LEVEL_RAID2,                        STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(CMSG_SET_RELATIVE_POSITION,                            STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(CMSG_SET_SELECTION,                                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetSelectionOpcode        );
    DEFINE_HANDLER(CMSG_SET_TAXI_BENCHMARK_MODE,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetTaxiBenchmarkOpcode    );
    ...
    DEFINE_HANDLER(CMSG_SET_VEHICLE_REC_ID_ACK,                           STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_SET_WATCHED_FACTION,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetWatchedFactionOpcode   );
    DEFINE_HANDLER(CMSG_SHOWING_CLOAK,                                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleShowingCloakOpcode        );
    DEFINE_HANDLER(CMSG_SHOWING_HELM,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleShowingHelmOpcode         );
    DEFINE_HANDLER(CMSG_SOCKET_GEMS,                                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSocketOpcode              );
    DEFINE_HANDLER(CMSG_SPELLCLICK,                                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSpellClick                );
    DEFINE_HANDLER(CMSG_SPIRIT_HEALER_ACTIVATE,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSpiritHealerActivateOpcode);
    ...
    DEFINE_HANDLER(CMSG_SUBMIT_BUG,                                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_SUBMIT_COMPLAIN,                                  STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_SUGGESTION_SUBMIT,                                STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(CMSG_SYNC_DANCE,                                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(CMSG_TURN_IN_PETITION,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTurnInPetitionOpcode      );
    DEFINE_HANDLER(CMSG_TUTORIAL_CLEAR,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTutorialClear             );
    ...
    DEFINE_HANDLER(CMSG_UPDATE_PROJECTILE_POSITION,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateProjectilePosition  );
    ...
    DEFINE_HANDLER(CMSG_VOICE_SESSION_ENABLE,                             STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleVoiceSessionEnableOpcode  );
    DEFINE_HANDLER(CMSG_VOID_STORAGE_QUERY,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleVoidStorageQuery          );
    DEFINE_HANDLER(CMSG_VOID_STORAGE_TRANSFER,                            STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleVoidStorageTransfer       );
    DEFINE_HANDLER(CMSG_VOID_STORAGE_UNLOCK,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleVoidStorageUnlock         );
    DEFINE_HANDLER(CMSG_VOID_SWAP_ITEM,                                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleVoidSwapItem              );
    DEFINE_HANDLER(CMSG_WARDEN_DATA,                                      STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleWardenDataOpcode          ); // STATUS_AUTHED
    DEFINE_HANDLER(CMSG_WARGAME_ACCEPT,                                   STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_WARGAME_START,                                    STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_WHO,                                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleWhoOpcode                 );
    DEFINE_HANDLER(CMSG_WHOIS,                                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleWhoisOpcode               );
    DEFINE_HANDLER(CMSG_WORLD_STATE_UI_TIMER_UPDATE,                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleWorldStateUITimerUpdate   );
    DEFINE_HANDLER(CMSG_WORLD_TELEPORT,                                   STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleWorldTeleportOpcode       );
    DEFINE_HANDLER(CMSG_WRAP_ITEM,                                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleWrapItemOpcode            );
    DEFINE_HANDLER(CMSG_ZONEUPDATE,                                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleZoneUpdateOpcode          );
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ACHIEVEMENT_DELETED,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ACHIEVEMENT_EARNED,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ACTION_BUTTONS,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ACTIVATETAXIREPLY,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AI_REACTION,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ALL_ACHIEVEMENT_DATA,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AREA_SPIRIT_HEALER_TIME,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AREA_TRIGGER_MESSAGE,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AREA_TRIGGER_MOVEMENT_UPDATE,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_ERROR,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_UNIT_DESTROYED,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_TEAM_CHANGE_FAILED_QUEUED,                  STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_TEAM_COMMAND_RESULT,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_TEAM_EVENT,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_TEAM_INVITE,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_TEAM_QUERY_RESPONSE,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_TEAM_ROSTER,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_TEAM_STATS,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ATTACKERSTATEUPDATE,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ATTACKSWING_BADFACING,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ATTACKSWING_CANT_ATTACK,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ATTACKSWING_DEADTARGET,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ATTACKSWING_NOTINRANGE,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AUCTION_BIDDER_LIST_RESULT,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AUCTION_BIDDER_NOTIFICATION,                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AUCTION_COMMAND_RESULT,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AUCTION_LIST_PENDING_SALES,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AUCTION_LIST_RESULT,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AUCTION_OWNER_LIST_RESULT,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AUCTION_OWNER_NOTIFICATION,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AUCTION_REMOVED_NOTIFICATION,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AURA_POINTS_DEPLETED,                             STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AURA_UPDATE,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AURA_UPDATE_ALL,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AVAILABLE_VOICE_CHANNEL,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EJECTED,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EJECT_PENDING,                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_ENTERED,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_ENTRY_INVITE,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EXIT_REQUEST,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_QUEUE_INVITE,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE,           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_STATE_CHANGE,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_PLAYER_POSITIONS,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_PORT_DENIED,                          STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_RATED_INFO,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS,                               STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_NEEDCONFIRMATION,              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_WAITFORGROUPS,                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEGROUND_PLAYER_JOINED,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEGROUND_PLAYER_LEFT,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BINDER_CONFIRM,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BINDPOINTUPDATE,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BUY_BANK_SLOT_RESULT,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BUY_FAILED,                                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BUY_ITEM,                                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CALENDAR_ARENA_TEAM,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CALENDAR_EVENT_MODERATOR_STATUS_ALERT,            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CALENDAR_EVENT_REMOVED_ALERT,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CALENDAR_EVENT_STATUS,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CALENDAR_EVENT_UPDATED_ALERT,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CALENDAR_FILTER_GUILD,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CAMERA_SHAKE,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CAST_FAILED,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHANNEL_LIST,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHANNEL_MEMBER_COUNT,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHAT_PLAYER_NOT_FOUND,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHAT_WRONG_FACTION,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CLEAR_BOSS_EMOTES,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CLEAR_COOLDOWN,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CLEAR_COOLDOWNS,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CLEAR_FAR_SIGHT_IMMEDIATE,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CLIENT_CONTROL_UPDATE,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_PARTY_INFO,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_PLAYER_INFO,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT1,               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT2,               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_STATE_CHANGED,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMPLAIN_RESULT,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMPRESSED_MOVES,                                 STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMSAT_CONNECT_FAIL,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMSAT_DISCONNECT,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMSAT_RECONNECT_TRY,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CORPSE_MAP_POSITION_QUERY_RESPONSE,               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CORPSE_NOT_IN_INSTANCE,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CORPSE_RECLAIM_DELAY,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CREATURE_QUERY_RESPONSE,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CRITERIA_DELETED,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CRITERIA_UPDATE,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CROSSED_INEBRIATION_THRESHOLD,                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CURRENCY_LOOT_REMOVED,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CURRENCY_LOOT_RESTORED,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CUSTOM_LOAD_SCREEN,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_DAMAGE_CALC_LOG,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_DANCE_QUERY_RESPONSE,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_DESTRUCTIBLE_BUILDING_DAMAGE,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_DISMOUNTRESULT,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_DISPEL_FAILED,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_DUEL_INBOUNDS,                                    STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_DUEL_OUTOFBOUNDS,                                 STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_EMOTE,                                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_EQUIPMENT_SET_LIST,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_EQUIPMENT_SET_SAVED,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_EQUIPMENT_SET_USE_RESULT,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_FORCE_ANIM,                                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GAMEOBJECT_CUSTOM_ANIM,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GAMEOBJECT_DESPAWN_ANIM,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GAMEOBJECT_PAGETEXT,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GAMEOBJECT_QUERY_RESPONSE,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GAMEOBJECT_RESET_STATE,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT,                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMRESPONSE_DB_ERROR,                              STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMRESPONSE_RECEIVED,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMRESPONSE_STATUS_UPDATE,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMTICKET_CREATE,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMTICKET_DELETETICKET,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMTICKET_GETTICKET,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMTICKET_SYSTEMSTATUS,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMTICKET_UPDATETEXT,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GM_MESSAGECHAT,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GODMODE,                                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_ACHIEVEMENT_DATA,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_CHALLENGE_UPDATED,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_COMMAND_RESULT_2,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_CRITERIA_DATA,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_CRITERIA_DELETED,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_DECLINE,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_EVENT,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_INVITE_CANCEL,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_MAX_DAILY_XP,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_XP,                                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_XP_GAIN,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_HEALTH_UPDATE,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_HIGHEST_THREAT_UPDATE,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_HOTFIX_INFO,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_HOTFIX_NOTIFY,                                    STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INITIALIZE_FACTIONS,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INITIAL_SPELLS,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INIT_CURRENCY,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INVALIDATE_DANCE,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_ADD_PASSIVE,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_PUSH_RESULT,                                 STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_REFUND_INFO_RESPONSE,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_REFUND_RESULT,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_REMOVE_PASSIVE,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_SEND_PASSIVE,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_TEXT_QUERY_RESPONSE,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LEARNED_DANCE_MOVES,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LEARNED_SPELL,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LEVELUP_INFO,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_BOOT_PROPOSAL_UPDATE,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_DISABLED,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_JOIN_RESULT,                                  STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_OFFER_CONTINUE,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_PARTY_INFO,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_ROLE_CHOSEN,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_UPDATE_SEARCH,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_UPDATE_STATUS,                                STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_UPDATE_STATUS_NONE,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_APPLICANT_LIST_UPDATED,                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_APPLICATIONS_LIST_CHANGED,               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_BROWSE_UPDATED,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_COMMAND_RESULT,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_MEMBERSHIP_LIST_UPDATED,                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_POST_UPDATED,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_RECRUIT_LIST_UPDATED,                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LIST_INVENTORY,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOAD_CUF_PROFILES,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOGIN_SETTIMESPEED,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOGIN_VERIFY_WORLD,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOGOUT_CANCEL_ACK,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_ALL_PASSED,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_MASTER_LIST,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_ROLL,                                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_ROLL_WON,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_SLOT_CHANGED,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_START_ROLL,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MIRRORIMAGE_DATA,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MISSILE_CANCEL,                                   STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MODIFY_COOLDOWN,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MONEY_NOTIFY,                                     STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MONSTER_MOVE,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MONSTER_MOVE_TRANSPORT,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOTD,                                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOUNTRESULT,                                      STATUS_UNHANDLED,   CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOUNTSPECIAL_ANIM,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_COLLISION_DISABLE,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_COLLISION_ENABLE,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_FEATHER_FALL,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_GRAVITY_DISABLE,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_GRAVITY_ENABLE,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_KNOCK_BACK,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_LAND_WALK,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_NORMAL_FALL,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_CAN_FLY,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY,     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_COLLISION_HEIGHT,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_COMPOUND_STATE,                          STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_FLIGHT_BACK_SPEED,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_FLIGHT_SPEED,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_HOVER,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_PITCH_RATE,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_RUN_BACK_SPEED,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_RUN_SPEED,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_SWIM_BACK_SPEED,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_SWIM_SPEED,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_TURN_RATE,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_WALK_SPEED,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UNROOT,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UNSET_CAN_FLY,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UNSET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY,   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UNSET_HOVER,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_COLLISION_HEIGHT,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_FLIGHT_BACK_SPEED,                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_FLIGHT_SPEED,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_KNOCK_BACK,                           STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_PITCH_RATE,                           STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_RUN_BACK_SPEED,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_RUN_SPEED,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_SWIM_BACK_SPEED,                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_SWIM_SPEED,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_TELEPORT,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_TURN_RATE,                            STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UPDATE_WALK_SPEED,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_WATER_WALK,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_NOTIFY_DANCE,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_NOTIFY_DEST_LOC_SPELL_CAST,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_NPC_TEXT_UPDATE,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_OFFER_PETITION_ERROR,                             STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA,             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_OPEN_CONTAINER,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_OPEN_LFG_DUNGEON_FINDER,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PARTYKILLLOG,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PARTY_COMMAND_RESULT,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PARTY_MEMBER_STATS,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PARTY_MEMBER_STATS_FULL,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PETITION_QUERY_RESPONSE,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PETITION_SHOWLIST,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PET_LEARNED_SPELL,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PET_NAME_QUERY_RESPONSE,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PET_REMOVED_SPELL,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PET_SPELLS,                                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PET_TAME_FAILURE,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PET_UPDATE_COMBO_POINTS,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PLAYER_MOVE,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PLAYER_SKINNED,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PLAYER_VEHICLE_DATA,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PROCRESIST,                                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUESTGIVER_STATUS_MULTIPLE,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUESTLOG_FULL,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_KILL,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_PVP_KILL,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_RAID_INSTANCE_INFO,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_RATED_BG_STATS,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_READ_ITEM_FAILED,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_READ_ITEM_OK,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_REALM_SPLIT,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_REAL_GROUP_UPDATE,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_RECEIVED_MAIL,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_REFORGE_RESULT,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_REMOVED_SPELL,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_RESEARCH_SETUP_HISTORY,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_RESPOND_INSPECT_ACHIEVEMENTS,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ROLE_POLL_BEGIN,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_RWHOIS,                                           STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SELL_ITEM,                                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SEND_MAIL_RESULT,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SEND_UNLEARN_SPELLS,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SERVERTIME,                                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SERVER_FIRST_ACHIEVEMENT,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SERVER_INFO_RESPONSE,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SERVER_MESSAGE,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_FACTION_ATWAR,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_FACTION_NOT_VISIBLE,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_FACTION_STANDING,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_FACTION_VISIBLE,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_FLAT_SPELL_MODIFIER,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_FORCED_REACTIONS,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_MELEE_ANIM_KIT,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_MOVEMENT_ANIM_KIT,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_PCT_SPELL_MODIFIER,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_PHASE_SHIFT,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_PROFICIENCY,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_PROJECTILE_POSITION,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SHOWTAXINODES,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SOCKET_GEMS_RESULT,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SOR_START_EXPERIENCE_INCOMPLETE,                  STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLBREAKLOG,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLDAMAGESHIELD,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLDISPELLOG,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLENERGIZELOG,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLHEALLOG,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLINSTAKILLLOG,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLINTERRUPTLOG,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLLOGEXECUTE,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLLOGMISS,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLNONMELEEDAMAGELOG,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLORDAMAGE_IMMUNE,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLSTEALLOG,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELL_CATEGORY_COOLDOWN,                          STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELL_COOLDOWN,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELL_DELAYED,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELL_FAILED_OTHER,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELL_FAILURE,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELL_GO,                                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELL_START,                                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELL_UPDATE_CHAIN_TARGETS,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPIRIT_HEALER_CONFIRM,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_DISABLE,                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_ENABLE,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_DISABLE,                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_GRAVITY_ENABLE,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_ROOT,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_ANIM,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FEATHER_FALL,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED,                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED,                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FLYING,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_HOVER,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_LAND_WALK,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_NORMAL_FALL,                      STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_PITCH_RATE,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED,                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_MODE,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_RUN_SPEED,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED,                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_SWIM_SPEED,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_TURN_RATE,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WALK_MODE,                        STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WALK_SPEED,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WATER_WALK,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_START_SWIM,                           STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_STOP_SWIM,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNROOT,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_FLYING,                         STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_UNSET_HOVER,                          STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_STABLE_RESULT,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_STANDSTATE_UPDATE,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_STOP_DANCE,                                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_STOP_MIRROR_TIMER,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_STREAMING_MOVIE,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SUMMON_CANCEL,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SUMMON_REQUEST,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SUPERCEDED_SPELL,                                 STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TALENTS_INFO,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TALENTS_INVOLUNTARILY_RESET,                      STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TAXINODE_STATUS,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TEST_DROP_RATE_RESULT,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TEXT_EMOTE,                                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_THREAT_CLEAR,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_THREAT_REMOVE,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_THREAT_UPDATE,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TIME_ADJUSTMENT,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TIME_SYNC_REQ,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TITLE_EARNED,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TOGGLE_XP_GAIN,                                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TOTEM_CREATED,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TRADE_STATUS,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TRADE_STATUS_EXTENDED,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TRAINER_BUY_FAILED,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TRAINER_BUY_SUCCEEDED,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TRAINER_LIST,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UNIT_HEALTH_FREQUENT,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UNIT_SPELLCAST_START,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_COMBO_POINTS,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_CURRENCY,                                  STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_CURRENCY_WEEK_LIMIT,                       STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT,                STATUS_UNHANDLED,   CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT,                   STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_OBJECT,                                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_SERVER_PLAYER_POSITION,                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_WORLD_STATE,                               STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_VOID_STORAGE_CONTENTS,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_VOID_STORAGE_FAILED,                              STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_VOID_STORAGE_TRANSFER_CHANGES,                    STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_VOID_TRANSFER_RESULT,                             STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_WARDEN_DATA,                                      STATUS_NEVER,       CONNECTION_TYPE_INSTANCE    );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_WEEKLY_RESET_CURRENCY,                            STATUS_NEVER,       CONNECTION_TYPE_REALM       );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_WORLD_SERVER_INFO,                                STATUS_NEVER,       CONNECTION_TYPE_REALM       );
...
#define DEFINE_MSG_OPCODE_HANDLER(opcode, status, processing, handler, con) \
    ValidateAndSetServerOpcode(OpcodeServer(opcode), #opcode, status, con); \
    ValidateAndSetClientOpcode<decltype(handler), handler>(OpcodeClient(opcode), #opcode, status, processing)

    DEFINE_MSG_OPCODE_HANDLER(MSG_AUCTION_HELLO,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionHelloOpcode,           CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_CHANNEL_START,                                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide,                  CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_CHANNEL_UPDATE,                                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide,                  CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_CORPSE_QUERY,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCorpseQueryOpcode,            CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_INSPECT_ARENA_TEAMS,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleInspectArenaTeamsOpcode,      CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_LIST_STABLED_PETS,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleListStabledPetsOpcode,        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MINIMAP_PING,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMinimapPingOpcode,            CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_CHARM_TELEPORT_CHEAT,                         STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL,                        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_FALL_LAND,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_HEARTBEAT,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_JUMP,                                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_FACING,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_PITCH,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_RUN_MODE,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_SET_WALK_MODE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_ASCEND,                                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_BACKWARD,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_DESCEND,                                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_FORWARD,                                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_PITCH_DOWN,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_PITCH_UP,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_LEFT,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_RIGHT,                           STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_SWIM,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_TURN_LEFT,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_START_TURN_RIGHT,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP,                                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_ASCEND,                                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_PITCH,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_STRAFE,                                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_SWIM,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_STOP_TURN,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TELEPORT,                                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide,                  CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TELEPORT_ACK,                                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveTeleportAck,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TELEPORT_CHEAT,                               STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL,                        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TIME_SKIPPED,                                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL,                        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_TOGGLE_COLLISION_CHEAT,                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL,                        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_MOVE_WORLDPORT_ACK,                                STATUS_TRANSFER,  PROCESS_THREADUNSAFE, &WorldSession::HandleMoveWorldportAckOpcode,       CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_NOTIFY_PARTY_SQUELCH,                              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL,                        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_PARTY_ASSIGNMENT,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePartyAssignmentOpcode,        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_PETITION_DECLINE,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionDeclineOpcode,        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_PETITION_RENAME,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionRenameOpcode,         CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_QUERY_NEXT_MAIL_TIME,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryNextMailTime,            CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_QUEST_PUSH_RESULT,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestPushResult,              CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RAID_READY_CHECK,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckOpcode,         CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RAID_READY_CHECK_CONFIRM,                          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL,                        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RAID_READY_CHECK_FINISHED,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckFinishedOpcode, CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RAID_TARGET_UPDATE,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidTargetUpdateOpcode,       CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_RANDOM_ROLL,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRandomRollOpcode,             CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_SAVE_GUILD_EMBLEM,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSaveGuildEmblemOpcode,        CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_SET_DUNGEON_DIFFICULTY,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetDungeonDifficultyOpcode,   CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_SET_RAID_DIFFICULTY,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetRaidDifficultyOpcode,      CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_TABARDVENDOR_ACTIVATE,                             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTabardVendorActivateOpcode,   CONNECTION_TYPE_REALM);
    DEFINE_MSG_OPCODE_HANDLER(MSG_TALENT_WIPE_CONFIRM,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTalentWipeConfirmOpcode,      CONNECTION_TYPE_REALM);
...
#undef DEFINE_MSG_OPCODE_HANDLER
  ...
  //DEFINE_OPCODE_HANDLER(CMSG_BUY_ITEM_IN_SLOT,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleBuyItemInSlotOpcode       );
  ...
  //DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_CANCEL,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverCancel          );
  //DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_QUEST_AUTOLAUNCH,                      STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverQuestAutoLaunch );
  //DEFINE_OPCODE_HANDLER(CMSG_QUESTLOG_SWAP_QUEST,                              STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestLogSwapQuest         );
  ...
  //DEFINE_OPCODE_HANDLER(CMSG_REMOVE_GLYPH,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRemoveGlyph               );
