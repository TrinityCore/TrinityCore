...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status) \
    ...
    DEFINE_HANDLER(CMSG_GUILD_ROSTER,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRosterOpcode         );
    ...
    DEFINE_HANDLER(CMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY_ACK, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                 );
    ...
    DEFINE_HANDLER(CMSG_REDIRECTION_AUTH_PROOF,                           STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(CMSG_SUSPEND_TOKEN,                                    STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_HANDLER(MSG_AUCTION_HELLO,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionHelloOpcode        );
    DEFINE_HANDLER(MSG_CHANNEL_START,                                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_HANDLER(MSG_CHANNEL_UPDATE,                                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_HANDLER(MSG_CORPSE_QUERY,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCorpseQueryOpcode         );
    DEFINE_HANDLER(MSG_INSPECT_ARENA_TEAMS,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleInspectArenaTeamsOpcode   );
    DEFINE_HANDLER(MSG_LIST_STABLED_PETS,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleListStabledPetsOpcode     );
    DEFINE_HANDLER(MSG_MINIMAP_PING,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMinimapPingOpcode         );
    DEFINE_HANDLER(MSG_MOVE_CHARM_TELEPORT_CHEAT,                         STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(MSG_MOVE_FALL_LAND,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_HEARTBEAT,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_JUMP,                                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_SET_FACING,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_SET_PITCH,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_SET_RUN_MODE,                                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleMovementOpcodes);
    DEFINE_HANDLER(MSG_MOVE_SET_WALK_MODE,                                STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleMovementOpcodes);
    DEFINE_HANDLER(MSG_MOVE_START_ASCEND,                                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_BACKWARD,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_DESCEND,                                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_FORWARD,                                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_PITCH_DOWN,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_PITCH_UP,                               STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_STRAFE_LEFT,                            STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_STRAFE_RIGHT,                           STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_SWIM,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_TURN_LEFT,                              STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_START_TURN_RIGHT,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_STOP,                                         STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_STOP_ASCEND,                                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_STOP_PITCH,                                   STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_STOP_STRAFE,                                  STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_STOP_SWIM,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_STOP_TURN,                                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    DEFINE_HANDLER(MSG_MOVE_TELEPORT,                                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_HANDLER(MSG_MOVE_TELEPORT_ACK,                                 STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveTeleportAck           );
    DEFINE_HANDLER(MSG_MOVE_TELEPORT_CHEAT,                               STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(MSG_MOVE_TIME_SKIPPED,                                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(MSG_MOVE_TOGGLE_COLLISION_CHEAT,                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(MSG_MOVE_WORLDPORT_ACK,                                STATUS_TRANSFER,  PROCESS_THREADUNSAFE, &WorldSession::HandleMoveWorldportAckOpcode    );
    DEFINE_HANDLER(MSG_NOTIFY_PARTY_SQUELCH,                              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(MSG_PARTY_ASSIGNMENT,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePartyAssignmentOpcode     );
    DEFINE_HANDLER(MSG_PETITION_DECLINE,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionDeclineOpcode     );
    DEFINE_HANDLER(MSG_PETITION_RENAME,                                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionRenameOpcode      );
    DEFINE_HANDLER(MSG_QUERY_NEXT_MAIL_TIME,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryNextMailTime         );
    DEFINE_HANDLER(MSG_QUEST_PUSH_RESULT,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestPushResult           );
    DEFINE_HANDLER(MSG_RAID_READY_CHECK,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckOpcode      );
    DEFINE_HANDLER(MSG_RAID_READY_CHECK_CONFIRM,                          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(MSG_RAID_READY_CHECK_FINISHED,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckFinishedOpcode);
    DEFINE_HANDLER(MSG_RAID_TARGET_UPDATE,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidTargetUpdateOpcode    );
    DEFINE_HANDLER(MSG_RANDOM_ROLL,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRandomRollOpcode          );
    DEFINE_HANDLER(MSG_SAVE_GUILD_EMBLEM,                                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSaveGuildEmblemOpcode     );
    DEFINE_HANDLER(MSG_SET_DUNGEON_DIFFICULTY,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetDungeonDifficultyOpcode);
    DEFINE_HANDLER(MSG_SET_RAID_DIFFICULTY,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetRaidDifficultyOpcode   );
    DEFINE_HANDLER(MSG_TABARDVENDOR_ACTIVATE,                             STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTabardVendorActivateOpcode);
    DEFINE_HANDLER(MSG_TALENT_WIPE_CONFIRM,                               STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTalentWipeConfirmOpcode   );
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AREA_TRIGGER_MOVEMENT_UPDATE,                     STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_ERROR,                                      STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ARENA_UNIT_DESTROYED,                             STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EJECTED,                          STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EJECT_PENDING,                    STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_ENTERED,                          STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_ENTRY_INVITE,                     STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EXIT_REQUEST,                     STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_QUEUE_INVITE,                     STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE,           STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_STATE_CHANGE,                     STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BATTLEFIELD_PLAYER_POSITIONS,                     STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_BUY_BANK_SLOT_RESULT,                             STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CHAT_IGNORED_ACCOUNT_MUTED,                       STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_MAP_INFO,                             STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_PARTY_INFO,                           STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_PLAYER_INFO,                          STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT1,               STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_SKIRMISH_QUEUE_RESULT2,               STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_COMMENTATOR_STATE_CHANGED,                        STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CORPSE_MAP_POSITION_QUERY_RESPONSE,               STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CORPSE_NOT_IN_INSTANCE,                           STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CURRENCY_LOOT_REMOVED,                            STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CURRENCY_LOOT_RESTORED,                           STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CUSTOM_LOAD_SCREEN,                               STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_DAMAGE_CALC_LOG,                                  STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_EQUIPMENT_SET_USE_RESULT,                         STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_FORCED_DEATH_UPDATE,                              STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMRESPONSE_RECEIVED,                              STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GMRESPONSE_STATUS_UPDATE,                         STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_ACHIEVEMENT_DATA,                           STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_CHALLENGE_UPDATED,                          STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_CHANGE_NAME_RESULT,                         STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_COMMAND_RESULT,                             STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_COMMAND_RESULT_2,                           STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_CRITERIA_DATA,                              STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_EVENT_LOG_QUERY_RESULT,                     STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_FLAGGED_FOR_RENAME,                         STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_NEWS_DELETED,                               STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_NEWS_UPDATE,                                STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_PARTY_STATE_RESPONSE,                       STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_RANK,                                       STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_RANKS_UPDATE,                               STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_RECIPES,                                    STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_RENAMED,                                    STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GUILD_UPDATE_ROSTER,                              STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INIT_CURRENCY,                                    STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INSPECT_TALENT,                                   STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_INSTANCE_LOCK_WARNING_QUERY,                      STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_ADD_PASSIVE,                                 STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_REFUND_INFO_RESPONSE,                        STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_REFUND_RESULT,                               STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_REMOVE_PASSIVE,                              STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ITEM_SEND_PASSIVE,                                STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LFG_ROLE_CHOSEN,                                  STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_BROWSE_UPDATED,                          STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_COMMAND_RESULT,                          STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_MEMBERSHIP_LIST_UPDATED,                 STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_POST_UPDATED,                            STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LF_GUILD_RECRUIT_LIST_UPDATED,                    STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_LOOT_SLOT_CHANGED,                                STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_COLLISION_DISABLE,                           STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_COLLISION_ENABLE,                            STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY,     STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_MOVE_UNSET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY,   STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PET_SLOT_UPDATED,                                 STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PLAYER_DIFFICULTY_CHANGE,                         STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PLAYER_MOVE,                                      STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PLAYER_SKINNED,                                   STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_PLAYER_VEHICLE_DATA,                              STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUERY_QUESTS_COMPLETED_RESPONSE,                  STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUEST_FORCE_REMOVE,                               STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_QUEST_NPC_QUERY_RESPONSE,                         STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_RESEARCH_SETUP_HISTORY,                           STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ROLE_POLL_BEGIN,                                  STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SET_PROJECTILE_POSITION,                          STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SOCKET_GEMS_RESULT,                               STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLINTERRUPTLOG,                                STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPELLORDAMAGE_IMMUNE,                             STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_DISABLE,                    STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_ENABLE,                     STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_ANIM,                             STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_FEATHER_FALL,                     STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_LAND_WALK,                        STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_NORMAL_FALL,                      STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SPLINE_MOVE_SET_WATER_WALK,                       STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_STREAMING_MOVIE,                                  STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_SUSPEND_COMMS,                                    STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TIME_ADJUSTMENT,                                  STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TIME_SYNC_REQ,                                    STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TITLE_EARNED,                                     STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TOGGLE_XP_GAIN,                                   STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TRAINER_BUY_SUCCEEDED,                            STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UNIT_HEALTH_FREQUENT,                             STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UNIT_SPELLCAST_START,                             STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_CURRENCY,                                  STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_CURRENCY_WEEK_LIMIT,                       STATUS_NEVER);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT,                STATUS_UNHANDLED);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT,                   STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_UPDATE_SERVER_PLAYER_POSITION,                    STATUS_NEVER);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_WEEKLY_RESET_CURRENCY,                            STATUS_NEVER);
