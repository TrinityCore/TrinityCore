...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_GUILD_BANK_TRANSFER_ITEM_TO_BANK,                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankTransferItemToBank);
    DEFINE_HANDLER(CMSG_GUILD_BANK_TRANSFER_ITEM_TO_PLAYER,                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankTransferItemToPlayer);
    DEFINE_HANDLER(CMSG_GUILD_BANK_MOVE_ITEM_IN_BANK,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankMoveItemInBank);
    DEFINE_HANDLER(CMSG_GUILD_BANK_COMBINE_ITEM_STACK_WITH_BANK,            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankCombineItemStackWithBank);
    DEFINE_HANDLER(CMSG_GUILD_BANK_TRANSFER_ITEM_STACK_TO_BANK,             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankTransferItemStackToBank);
    DEFINE_HANDLER(CMSG_GUILD_BANK_COMBINE_ITEM_STACK_WITH_PLAYER,          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankCombineItemStackWithPlayer);
    DEFINE_HANDLER(CMSG_GUILD_BANK_TRANSFER_ITEM_STACK_TO_PLAYER,           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankTransferItemStackToPlayer);
    DEFINE_HANDLER(CMSG_GUILD_BANK_TRANSFER_ITEM_TO_PLAYER_AUTOSTORE,       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankTransferItemToPlayerAutoStore);
    DEFINE_HANDLER(CMSG_GUILD_BANK_COMBINE_ITEM_STACK_IN_BANK,              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankCombineItemStackInBank);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_AREA_TRIGGER_SET_VISUAL_ANIM,            STATUS_UNHANDLED,    CONNECTION_TYPE_REALM);
