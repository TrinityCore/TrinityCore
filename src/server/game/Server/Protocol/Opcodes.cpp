...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CSMG_CHAT_CHANNEL_DECLINE_INVITE,                      STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_DISPLAY_LIST,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelDisplayListQuery   );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_INVITE,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelInvite             );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_KICK,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelKick               );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_LIST,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelList               );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_MODERATE,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelModerator          );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_MODERATOR,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelModerator          );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_MUTE,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelMute               );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_OWNER,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelOwner              );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_PASSWORD,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelPassword           );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_ROSTER_INFO,                         STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_SET_OWNER,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelSetOwner           );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_SILENCE_ALL,                         STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_SILENCE_VOICE,                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_UNBAN,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnban              );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_UNMODERATOR,                         STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnmoderator        );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_UNMUTE,                              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelUnmute             );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_UNSILENCE_ALL,                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_UNSILENCE_VOICE,                     STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_VOICE_OFF,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelVoiceOnOpcode      );
    DEFINE_HANDLER(CMSG_CHAT_CHANNEL_VOICE_ON,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChannelVoiceOnOpcode      );
