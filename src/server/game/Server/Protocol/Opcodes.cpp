...
#define DEFINE_HANDLER(opcode, status, processing, packetclass, handler) \
    ...
    DEFINE_HANDLER(CMSG_CHANNEL_BAN,                                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Channel::ChannelMisc1, &WorldSession::HandleChannelBan);
    ...
    DEFINE_HANDLER(CMSG_CHANNEL_INVITE,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Channel::ChannelMisc1, &WorldSession::HandleChannelInvite);
    DEFINE_HANDLER(CMSG_CHANNEL_KICK,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Channel::ChannelMisc1, &WorldSession::HandleChannelKick);
    ...
    DEFINE_HANDLER(CMSG_CHANNEL_MODERATOR,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Channel::ChannelMisc1, &WorldSession::HandleChannelModerator);
    DEFINE_HANDLER(CMSG_CHANNEL_MUTE,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Channel::ChannelMisc1, &WorldSession::HandleChannelMute);
    ...
    DEFINE_HANDLER(CMSG_CHANNEL_SET_OWNER,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Channel::ChannelMisc1, &WorldSession::HandleChannelSetOwner);
    ...
    DEFINE_HANDLER(CMSG_CHANNEL_UNBAN,                                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Channel::ChannelMisc1, &WorldSession::HandleChannelUnban);
    DEFINE_HANDLER(CMSG_CHANNEL_UNMODERATOR,                                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Channel::ChannelMisc1, &WorldSession::HandleChannelUnmoderator);
    DEFINE_HANDLER(CMSG_CHANNEL_UNMUTE,                                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, WorldPackets::Channel::ChannelMisc1, &WorldSession::HandleChannelUnmute);
