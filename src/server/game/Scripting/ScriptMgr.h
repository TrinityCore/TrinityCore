...
class PlayerScript : public UnitScript
{
    ...
    public:
        ...
        virtual void OnBindToInstance(Player* /*player*/, Difficulty /*difficulty*/, uint32 /*mapId*/, bool /*permanent*/, uint8 /*extend*/) { }
...
class ScriptMgr
{
    ...
    public: /* PlayerScript */
        ...
        void OnPlayerBindToInstance(Player* player, Difficulty difficulty, uint32 mapid, bool permanent, uint8 extend);
