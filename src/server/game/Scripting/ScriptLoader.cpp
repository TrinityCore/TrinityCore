...
void AddSC_instance_throne_of_tides();      // Throne of the Tides
...
void AddSC_instance_tolvir();               // Lost City of the Tol'vir
...
void AddSC_instance_vortex_pinnacle();      // The Vortex Pinnacle
void AddSC_instance_throne_of_four_winds(); // Throne of the Four Winds
...
void AddEasternKingdomsScripts()
{
    ...
    AddSC_instance_throne_of_tides();       // Throne of the Tides
...
void AddKalimdorScripts()
{
    ...
    AddSC_instance_tolvir();                // Lost City of the Tol'vir
    ...
    AddSC_instance_vortex_pinnacle();       // The Vortex Pinnacle
    AddSC_instance_throne_of_four_winds();  // Throne of the Four Winds
...
void AddNorthrendScripts()
{
    ...
    AddSC_boss_krik_thir();                 // Azjol-Nerub
    AddSC_boss_hadronox();
