...
enum HolidayIds
{
    ...
    HOLIDAY_CALL_TO_ARMS_ALTERAC_VALLEY            = 283,
    HOLIDAY_CALL_TO_ARMS_WARSONG_GULCH             = 284,
    HOLIDAY_CALL_TO_ARMS_ARATHI_BASIN              = 285,
    ...
    HOLIDAY_CALL_TO_ARMS_STRAND_OF_THE_ANCIENTS    = 400,
    HOLIDAY_PILGRIMS_BOUNTY                        = 404,
    HOLIDAY_WOTLK_LAUNCH                           = 406,
    HOLIDAY_DAY_OF_THE_DEAD                        = 409,
    HOLIDAY_CALL_TO_ARMS_ISLE_OF_CONQUEST          = 420,
    HOLIDAY_LOVE_IS_IN_THE_AIR                     = 423,
    HOLIDAY_KALU_AK_FISHING_DERBY                  = 424,
    HOLIDAY_CALL_TO_ARMS_THE_BATTLE_FOR_GILNEAS    = 435,
    HOLIDAY_CALL_TO_ARMS_TWIN_PEAKS                = 436,
    ...
    HOLIDAY_CALL_TO_ARMS_SILVERSHARD_MINES         = 488,
    HOLIDAY_CALL_TO_ARMS_TEMPLE_OF_KOTMOGU         = 489,
    // HOLIDAY_CALL_TO_ARMS_ALTERAC_VALLEY            = 490, duplicated
    // HOLIDAY_CALL_TO_ARMS_ARATHI_BASIN              = 491, duplicated
    // HOLIDAY_CALL_TO_ARMS_EYE_OF_STORM              = 492, duplicated
    // HOLIDAY_CALL_TO_ARMS_ISLE_OF_CONQUEST          = 493, duplicated
    // HOLIDAY_CALL_TO_ARMS_SILVERSHARD_MINES         = 494, duplicated
    // HOLIDAY_CALL_TO_ARMS_STRAND_OF_THE_ANCIENTS    = 495, duplicated
    // HOLIDAY_CALL_TO_ARMS_TEMPLE_OF_KOTMOGU         = 496, duplicated
    // HOLIDAY_CALL_TO_ARMS_THE_BATTLE_FOR_GILNEAS    = 497, duplicated
    // HOLIDAY_CALL_TO_ARMS_TWIN_PEAKS                = 498, duplicated
    // HOLIDAY_CALL_TO_ARMS_WARSONG_GULCH             = 499, duplicated
    HOLIDAY_ANNIVERSARY_9_YEARS                    = 509,
    HOLIDAY_ANNIVERSARY_10_YEARS                   = 514,
    HOLIDAY_CALL_TO_ARMS_DEEPWIND_GORGE            = 515,
    // HOLIDAY_CALL_TO_ARMS_DEEPWIND_GORGE            = 516, duplicated
    HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 559,
    HOLIDAY_APEXIS_BONUS_EVENT                     = 560,
    HOLIDAY_ARENA_SKIRMISH_BONUS_EVENT             = 561,
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 562, duplicated
    HOLIDAY_BATTLEGROUND_BONUS_EVENT               = 563,
    HOLIDAY_DRAENOR_DUNGEON_EVENT                  = 564,
    HOLIDAY_PET_BATTLE_BONUS_EVENT                 = 565,
    HOLIDAY_ANNIVERSARY_11_YEARS                   = 566,
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 587, duplicated
    HOLIDAY_ANNIVERSARY_12_YEARS                   = 589,
    HOLIDAY_ANNIVERSARY                            = 590,
    HOLIDAY_LEGION_DUNGEON_EVENT                   = 591,
    HOLIDAY_WORLD_QUEST_BONUS_EVENT                = 592,
    // HOLIDAY_APEXIS_BONUS_EVENT                     = 593, duplicated
    // HOLIDAY_APEXIS_BONUS_EVENT                     = 594, duplicated
    // HOLIDAY_APEXIS_BONUS_EVENT                     = 595, duplicated
    // HOLIDAY_DRAENOR_DUNGEON_EVENT                  = 596, duplicated
    // HOLIDAY_DRAENOR_DUNGEON_EVENT                  = 597, duplicated
    // HOLIDAY_DRAENOR_DUNGEON_EVENT                  = 598, duplicated
    // HOLIDAY_PET_BATTLE_BONUS_EVENT                 = 599, duplicated
    // HOLIDAY_PET_BATTLE_BONUS_EVENT                 = 600, duplicated
    // HOLIDAY_PET_BATTLE_BONUS_EVENT                 = 601, duplicated
    // HOLIDAY_BATTLEGROUND_BONUS_EVENT               = 602, duplicated
    // HOLIDAY_BATTLEGROUND_BONUS_EVENT               = 603, duplicated
    // HOLIDAY_BATTLEGROUND_BONUS_EVENT               = 604, duplicated
    // HOLIDAY_LEGION_DUNGEON_EVENT                   = 605, duplicated
    // HOLIDAY_LEGION_DUNGEON_EVENT                   = 606, duplicated
    // HOLIDAY_LEGION_DUNGEON_EVENT                   = 607, duplicated
    // HOLIDAY_ARENA_SKIRMISH_BONUS_EVENT             = 610, duplicated
    // HOLIDAY_ARENA_SKIRMISH_BONUS_EVENT             = 611, duplicated
    // HOLIDAY_ARENA_SKIRMISH_BONUS_EVENT             = 612, duplicated
    // HOLIDAY_WORLD_QUEST_BONUS_EVENT                = 613, duplicated
    // HOLIDAY_WORLD_QUEST_BONUS_EVENT                = 614, duplicated
    // HOLIDAY_WORLD_QUEST_BONUS_EVENT                = 615, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 616, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 617, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 618, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 622, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 623, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 624, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 628, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 629, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 630, duplicated
    ...
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 643, duplicated
    ...
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 652, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 654, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 656, duplicated
    HOLIDAY_FIREWORKS_CELEBRATION                  = 658,
    HOLIDAY_PVP_BRAWL_GRAVITY_LAPSE                = 659,
    HOLIDAY_PVP_BRAWL_SOUTHSHORE_VS_TARREN_MILL    = 660,
    // HOLIDAY_PVP_BRAWL_SOUTHSHORE_VS_TARREN_MILL    = 662, duplicated
    // HOLIDAY_PVP_BRAWL_GRAVITY_LAPSE                = 663, duplicated
    HOLIDAY_PVP_BRAWL_WARSONG_SCRAMBLE             = 664,
    HOLIDAY_PVP_BRAWL_ARATHI_BLIZZARD              = 666,
    HOLIDAY_PVP_BRAWL_PACKED_HOUSE                 = 667,
    // HOLIDAY_PVP_BRAWL_SOUTHSHORE_VS_TARREN_MILL    = 669, duplicated
    // HOLIDAY_PVP_BRAWL_GRAVITY_LAPSE                = 670, duplicated
    // HOLIDAY_PVP_BRAWL_WARSONG_SCRAMBLE             = 671, duplicated
    // HOLIDAY_PVP_BRAWL_ARATHI_BLIZZARD              = 673, duplicated
    // HOLIDAY_PVP_BRAWL_PACKED_HOUSE                 = 674, duplicated
    // HOLIDAY_PVP_BRAWL_SOUTHSHORE_VS_TARREN_MILL    = 676, duplicated
    // HOLIDAY_PVP_BRAWL_GRAVITY_LAPSE                = 677, duplicated
    // HOLIDAY_PVP_BRAWL_WARSONG_SCRAMBLE             = 678, duplicated
    // HOLIDAY_PVP_BRAWL_ARATHI_BLIZZARD              = 680, duplicated
    // HOLIDAY_PVP_BRAWL_PACKED_HOUSE                 = 681, duplicated
    // HOLIDAY_PVP_BRAWL_SOUTHSHORE_VS_TARREN_MILL    = 683, duplicated
    // HOLIDAY_PVP_BRAWL_GRAVITY_LAPSE                = 684, duplicated
    // HOLIDAY_PVP_BRAWL_WARSONG_SCRAMBLE             = 685, duplicated
    // HOLIDAY_PVP_BRAWL_ARATHI_BLIZZARD              = 687, duplicated
    // HOLIDAY_PVP_BRAWL_PACKED_HOUSE                 = 688, duplicated
    HOLIDAY_TRIAL_OF_STYLE                         = 691,
    HOLIDAY_AUCTION_HOUSE_DANCE_PARTY              = 692,
    HOLIDAY_ANNIVERSARY_13_YEARS                   = 693,
    HOLIDAY_MOOKIN_FESTIVAL                        = 694,
    HOLIDAY_THE_GREAT_GNOMEREGAN_RUN               = 696,
    // HOLIDAY_PVP_BRAWL_WARSONG_SCRAMBLE             = 701, duplicated
    HOLIDAY_PVP_BRAWL_DEEP_SIX                     = 702,
    // HOLIDAY_PVP_BRAWL_DEEP_SIX                     = 704, duplicated
    // HOLIDAY_PVP_BRAWL_DEEP_SIX                     = 705, duplicated
    // HOLIDAY_PVP_BRAWL_DEEP_SIX                     = 706, duplicated
    HOLIDAY_TOMB_OF_SARGERAS                       = 710,
    // HOLIDAY_TOMB_OF_SARGERAS                       = 711, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 712, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 713, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 714, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 715, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 716, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 717, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 718, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 719, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 720, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 721, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 722, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 723, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 724, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 725, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 726, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 727, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 728, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 729, duplicated
    // HOLIDAY_TOMB_OF_SARGERAS                       = 730, duplicated
    // HOLIDAY_PVP_BRAWL_DEEP_SIX                     = 736, duplicated
    // HOLIDAY_PVP_BRAWL_ARATHI_BLIZZARD              = 737, duplicated
    HOLIDAY_SHADOWS_OF_ARGUS_W2_UNLOCKS            = 744,
    HOLIDAY_SHADOWS_OF_ARGUS_W3_UNLOCKS            = 745,
    // HOLIDAY_SHADOWS_OF_ARGUS_W2_UNLOCKS            = 746, duplicated
    // HOLIDAY_SHADOWS_OF_ARGUS_W2_UNLOCKS            = 747, duplicated
    // HOLIDAY_SHADOWS_OF_ARGUS_W2_UNLOCKS            = 748, duplicated
    // HOLIDAY_SHADOWS_OF_ARGUS_W3_UNLOCKS            = 749, duplicated
    // HOLIDAY_SHADOWS_OF_ARGUS_W3_UNLOCKS            = 750, duplicated
    // HOLIDAY_SHADOWS_OF_ARGUS_W3_UNLOCKS            = 751, duplicated
    HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 756,
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 757, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 758, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 759, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 760, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 761, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 762, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 763, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 764, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 765, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 766, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 767, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 768, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 769, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 770, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 771, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 772, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 773, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 774, duplicated
    // HOLIDAY_ANTORUS_THE_BURNING_THRONE             = 776, duplicated
    HOLIDAY_ANNIVERSARY_14_YEARS                   = 807,
    HOLIDAY_ANNIVERSARY_15_YEARS                   = 808,
    HOLIDAY_WAR_OF_THE_THORNS                      = 918,
    HOLIDAY_ULDIR                                  = 920,
    // HOLIDAY_ULDIR                                  = 921, duplicated
    // HOLIDAY_ULDIR                                  = 922, duplicated
    // HOLIDAY_ULDIR                                  = 923, duplicated
    // HOLIDAY_ULDIR                                  = 924, duplicated
    // HOLIDAY_ULDIR                                  = 925, duplicated
    // HOLIDAY_ULDIR                                  = 926, duplicated
    // HOLIDAY_ULDIR                                  = 927, duplicated
    // HOLIDAY_ULDIR                                  = 928, duplicated
    // HOLIDAY_ULDIR                                  = 929, duplicated
    // HOLIDAY_ULDIR                                  = 930, duplicated
    // HOLIDAY_ULDIR                                  = 931, duplicated
    // HOLIDAY_ULDIR                                  = 932, duplicated
    // HOLIDAY_ULDIR                                  = 933, duplicated
    // HOLIDAY_ULDIR                                  = 934, duplicated
    // HOLIDAY_ULDIR                                  = 935, duplicated
    // HOLIDAY_ULDIR                                  = 936, duplicated
    HOLIDAY_BATTLE_FOR_AZEROTH_DUNGEON_EVENT       = 938,
    // HOLIDAY_BATTLE_FOR_AZEROTH_DUNGEON_EVENT       = 939, duplicated
    // HOLIDAY_BATTLE_FOR_AZEROTH_DUNGEON_EVENT       = 940, duplicated
    // HOLIDAY_BATTLE_FOR_AZEROTH_DUNGEON_EVENT       = 941, duplicated
    // HOLIDAY_WAR_OF_THE_THORNS                      = 956, duplicated
    // HOLIDAY_WAR_OF_THE_THORNS                      = 957, duplicated
    // HOLIDAY_WAR_OF_THE_THORNS                      = 958, duplicated
    // HOLIDAY_WAR_OF_THE_THORNS                      = 959, duplicated
    // HOLIDAY_WAR_OF_THE_THORNS                      = 965, duplicated
    // HOLIDAY_WAR_OF_THE_THORNS                      = 967, duplicated
    // HOLIDAY_WAR_OF_THE_THORNS                      = 973, duplicated
    // HOLIDAY_ULDIR                                  = 979, duplicated
    HOLIDAY_BATTLE_OF_DAZARALOR                    = 1025,
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1026, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1027, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1028, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1029, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1030, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1031, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1032, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1033, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1034, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1035, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1036, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1037, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1038, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1039, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1040, duplicated
    // HOLIDAY_BATTLE_OF_DAZARALOR                    = 1041, duplicated
    HOLIDAY_PVP_BRAWL_COOKING_IMPOSSIBLE           = 1047,
    // HOLIDAY_PVP_BRAWL_COOKING_IMPOSSIBLE           = 1048, duplicated
    // HOLIDAY_PVP_BRAWL_COOKING_IMPOSSIBLE           = 1049, duplicated
    // HOLIDAY_PVP_BRAWL_COOKING_IMPOSSIBLE           = 1050, duplicated
    // HOLIDAY_PVP_BRAWL_COOKING_IMPOSSIBLE           = 1051, duplicated
    HOLIDAY_WANDERERS_FESTIVAL                     = 1052,
    HOLIDAY_FREE_TSHIRT_DAY                        = 1053,
    HOLIDAY_LUMINOUS_LUMINARIES                    = 1054,
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 1056, duplicated
    // HOLIDAY_LUMINOUS_LUMINARIES                    = 1062, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 1063, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 1065, duplicated
    // HOLIDAY_TIMEWALKING_DUNGEON_EVENT              = 1068, duplicated
    HOLIDAY_CRUCIBLE_OF_STORMS                     = 1069,
    // HOLIDAY_CRUCIBLE_OF_STORMS                     = 1070, duplicated
    // HOLIDAY_CRUCIBLE_OF_STORMS                     = 1071, duplicated
    // HOLIDAY_CRUCIBLE_OF_STORMS                     = 1072, duplicated
    // HOLIDAY_CRUCIBLE_OF_STORMS                     = 1073, duplicated
    // HOLIDAY_CRUCIBLE_OF_STORMS                     = 1074, duplicated
    // HOLIDAY_CRUCIBLE_OF_STORMS                     = 1075, duplicated
    // HOLIDAY_CRUCIBLE_OF_STORMS                     = 1076, duplicated
    // HOLIDAY_CRUCIBLE_OF_STORMS                     = 1077, duplicated
    // HOLIDAY_CRUCIBLE_OF_STORMS                     = 1078, duplicated
    HOLIDAY_THE_ETERNAL_PALACE                     = 1098,
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1098, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1100, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1101, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1102, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1103, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1104, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1105, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1106, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1107, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1108, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1109, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1110, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1111, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1112, duplicated
    // HOLIDAY_THE_ETERNAL_PALACE                     = 1113, duplicated
    HOLIDAY_PVP_BRAWL_CLASSIC_ASHRAN               = 1120,
    // HOLIDAY_PVP_BRAWL_CLASSIC_ASHRAN               = 1121, duplicated
    // HOLIDAY_PVP_BRAWL_CLASSIC_ASHRAN               = 1122, duplicated
    // HOLIDAY_PVP_BRAWL_CLASSIC_ASHRAN               = 1123, duplicated
    // HOLIDAY_PVP_BRAWL_CLASSIC_ASHRAN               = 1124, duplicated
    HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1140,
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1141, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1142, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1143, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1144, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1145, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1146, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1147, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1148, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1149, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1150, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1151, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1152, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1153, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1154, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1155, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1156, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1157, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1158, duplicated
    // HOLIDAY_NYALOTHA_THE_WALKING_CITY              = 1159, duplicated
    HOLIDAY_PVP_BRAWL_TEMPLE_OF_HOTMOGU            = 1166,
    // HOLIDAY_PVP_BRAWL_TEMPLE_OF_HOTMOGU            = 1167, duplicated
    // HOLIDAY_PVP_BRAWL_TEMPLE_OF_HOTMOGU            = 1168, duplicated
    // HOLIDAY_PVP_BRAWL_TEMPLE_OF_HOTMOGU            = 1169, duplicated
    // HOLIDAY_PVP_BRAWL_TEMPLE_OF_HOTMOGU            = 1170, duplicated
    HOLIDAY_ANNIVERSARY_16_YEARS                   = 1181,
    HOLIDAY_CASTLE_NATHRIA                         = 1194,
    // HOLIDAY_CASTLE_NATHRIA                         = 1195, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1196, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1197, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1198, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1199, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1200, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1201, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1202, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1203, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1204, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1205, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1206, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1207, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1208, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1209, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1210, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1211, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1212, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1213, duplicated
    ...
    HOLIDAY_SHADOWLANDS_DUNGEON_EVENT              = 1217
    // HOLIDAY_SHADOWLANDS_DUNGEON_EVENT              = 1218, duplicated
    // HOLIDAY_SHADOWLANDS_DUNGEON_EVENT              = 1219, duplicated
    // HOLIDAY_SHADOWLANDS_DUNGEON_EVENT              = 1220, duplicated
    // HOLIDAY_PVP_BRAWL_WARSONG_SCRAMBLE             = 1221, duplicated
    // HOLIDAY_CASTLE_NATHRIA                         = 1222  duplicated
};
