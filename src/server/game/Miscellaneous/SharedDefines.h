...
enum SpellCastResult
{
    ...
    SPELL_FAILED_TARGET_IS_UNTARGETABLE_BY_ANYONE               = 280,
    SPELL_FAILED_SPELL_EFFECT_FAILED                            = 281,
    SPELL_FAILED_UNKNOWN                                        = 282,
...
enum SpellCustomErrors
{
    ...
    SPELL_CUSTOM_ERROR_YOU_MUST_BE_WIELDING_THE_UNDERLIGHT_ANGLER       = 323, // You must be wielding the Underlight Angler.
};
