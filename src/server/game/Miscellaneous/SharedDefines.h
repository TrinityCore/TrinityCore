...
enum Emote : uint32
{
    ...
    EMOTE_STATE_ONESHOT_ATTACKUNARMED_VAR1       = 1019,
    EMOTE_STATE_STATE_SIT_CHAIR_MED_EAT_LOOP     = 1021,
    EMOTE_STATE_ONESHOT_TALK_FRUSTRATED          = 1022,
    EMOTE_STATE_STATE_WALEAN03                   = 1023,
    EMOTE_STATE_STATE_SHOVEL_WITH_SHOVEL         = 1024,
    EMOTE_STATE_STATE_HOLD                       = 1027,
    EMOTE_STATE_STATE_WA2HIDLE                   = 1029,
    EMOTE_STATE_ONESHOT_FLYATTACKUNARMED_VAR0    = 1031,
    EMOTE_STATE_STATE_BARTENDEMOTETALK           = 1033,
    EMOTE_STATE_STATE_TALK_SUBDUED               = 1034,
    EMOTE_STATE_STATE_READYWEAPON                = 1035,
    EMOTE_STATE_STATE_READYWEAPON_ALLOW_MOVEMENT = 1036,
    EMOTE_STATE_ONESHOT_FLYCOMBATCRITICAL        = 1040,
    EMOTE_STATE_ONESHOT_FLYBATTLEROAR            = 1041,
    EMOTE_STATE_STATE_WORK_HAMMER_SOUND          = 1043,
    EMOTE_STATE_STATE_WORK_HAMMER                = 1044,
    EMOTE_STATE_STATE_TALK_EXCLAMATION           = 1048,
    EMOTE_STATE_STATE_MOUNT_CROUCH               = 1049,
    EMOTE_STATE_STATE_WORK_HERBALISM_SCYTE       = 1050,
    EMOTE_STATE_STATE_WORK_COOK_FRYING_PAN       = 1051,
    EMOTE_STATE_STATE_WORK_LEATHERWORKING_KNIFE  = 1052,
    STATE_BARSERVERSTAND = 1054,
    EMOTE_STATE_STATE_STAND_VAR2                 = 1055,
    EMOTE_STATE_STATE_STAND_VAR3                 = 1056,
    EMOTE_STATE_STATE_STAND_VAR4                 = 1057,
    EMOTE_STATE_STATE_BARSERVERSTAND             = 1058,
    EMOTE_STATE_ONESHOT_BARSERVER_EMOTETALK      = 1059,
    EMOTE_STATE_STATE_STAND_VAR4_FORCEVARIANTTEST = 1060,
    EMOTE_STATE_WADARTTARGETSTAND                = 1062,
    EMOTE_STATE_ONESHOT_THOUSANDFISTS            = 1068,
    EMOTE_STATE_ONESHOT_OFFER_START              = 1069,
    EMOTE_STATE_ONESHOT_OFFER_END                = 1070,
    EMOTE_STATE_STATE_OFFER_LOOP                 = 1071,
    EMOTE_STATE_ONESHOT_DANCE_VAR2               = 1075,
    EMOTE_STATE_STATE_KNEEL_INTERACT_INTERRUPT   = 1081,
    EMOTE_STATE_STATE_WA2HIDLE_UNSHEATH          = 1082,
    EMOTE_STATE_STATE_LEAN                       = 1084,
    EMOTE_STATE_ONESHOT_WALEAN01_VAR1            = 1093,
    EMOTE_STATE_ONESHOT_WALEAN01_VAR0            = 1094,
};
