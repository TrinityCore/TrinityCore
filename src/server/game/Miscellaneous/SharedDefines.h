...
inline constexpr uint64 MECHANIC_LOSS_CONTROL_MASK(\
    (1 << MECHANIC_CHARM) | (1 << MECHANIC_DISORIENTED) | (1 << MECHANIC_DISARM) | (1 << MECHANIC_FEAR) | (1 << MECHANIC_ROOT) | (1 << MECHANIC_SILENCE) | \
    (1 << MECHANIC_SLEEP) | (1 << MECHANIC_SNARE) | (1 << MECHANIC_STUN) | (1 << MECHANIC_FREEZE) | (1 << MECHANIC_KNOCKOUT) | (1 << MECHANIC_POLYMORPH) | \
    (1 << MECHANIC_BANISH) | (1 << MECHANIC_TURN) | (1 << MECHANIC_HORROR) | (1 << MECHANIC_INTERRUPT) | (1 << MECHANIC_DAZE) | (1 << MECHANIC_SAPPED));
...
enum class GameError : uint32
{
    ...
    ERR_LFG_LEFT_QUEUE                                              = 824,
    ERR_LFG_LEFT_LIST                                               = 825,
    ERR_LFG_ROLE_CHECK_ABORTED                                      = 826,
    ERR_LFG_READY_CHECK_ABORTED                                     = 827,
    ERR_LFG_CANT_USE_BATTLEGROUND                                   = 828,
    ERR_LFG_CANT_USE_DUNGEONS                                       = 829,
    ERR_LFG_REASON_TOO_MANY_LFG                                     = 830,
    ERR_LFG_FARM_LIMIT                                              = 831,
    ERR_LFG_NO_CROSS_FACTION_PARTIES                                = 832,
    ERR_INVALID_TELEPORT_LOCATION                                   = 833,
    ERR_TOO_FAR_TO_INTERACT                                         = 834,
    ERR_BATTLEGROUND_PLAYERS_FROM_DIFFERENT_REALMS                  = 835,
    ERR_DIFFICULTY_CHANGE_COOLDOWN_S                                = 836,
    ERR_DIFFICULTY_CHANGE_COMBAT_COOLDOWN_S                         = 837,
    ERR_DIFFICULTY_CHANGE_WORLDSTATE                                = 838,
    ERR_DIFFICULTY_CHANGE_ENCOUNTER                                 = 839,
    ERR_DIFFICULTY_CHANGE_COMBAT                                    = 840,
    ERR_DIFFICULTY_CHANGE_PLAYER_BUSY                               = 841,
    ERR_DIFFICULTY_CHANGE_PLAYER_ON_VEHICLE                         = 842,
    ERR_DIFFICULTY_CHANGE_ALREADY_STARTED                           = 843,
    ERR_DIFFICULTY_CHANGE_OTHER_HEROIC_S                            = 844,
    ERR_DIFFICULTY_CHANGE_HEROIC_INSTANCE_ALREADY_RUNNING           = 845,
    ERR_ARENA_TEAM_PARTY_SIZE                                       = 846,
    ERR_SOLO_SHUFFLE_WARGAME_GROUP_SIZE                             = 847,
    ERR_SOLO_SHUFFLE_WARGAME_GROUP_COMP                             = 848,
    ERR_SOLO_RBG_WARGAME_GROUP_SIZE                                 = 849,
    ERR_SOLO_RBG_WARGAME_GROUP_COMP                                 = 850,
    ERR_SOLO_MIN_ITEM_LEVEL                                         = 851,
    ERR_PVP_PLAYER_ABANDONED                                        = 852,
    ERR_BATTLEGROUND_JOIN_GROUP_QUEUE_WITHOUT_HEALER                = 853,
    ERR_QUEST_FORCE_REMOVED_S                                       = 854,
    ERR_ATTACK_NO_ACTIONS                                           = 855,
    ERR_IN_RANDOM_BG                                                = 856,
    ERR_IN_NON_RANDOM_BG                                            = 857,
    ERR_BN_FRIEND_SELF                                              = 858,
    ERR_BN_FRIEND_ALREADY                                           = 859,
    ERR_BN_FRIEND_BLOCKED                                           = 860,
    ERR_BN_FRIEND_LIST_FULL                                         = 861,
    ERR_BN_FRIEND_REQUEST_SENT                                      = 862,
    ERR_BN_BROADCAST_THROTTLE                                       = 863,
    ERR_BG_DEVELOPER_ONLY                                           = 864,
    ERR_CURRENCY_SPELL_SLOT_MISMATCH                                = 865,
    ERR_CURRENCY_NOT_TRADABLE                                       = 866,
    ERR_REQUIRES_EXPANSION_S                                        = 867,
    ERR_QUEST_FAILED_SPELL                                          = 868,
    ERR_TALENT_FAILED_UNSPENT_TALENT_POINTS                         = 869,
    ERR_TALENT_FAILED_NOT_ENOUGH_TALENTS_IN_PRIMARY_TREE            = 870,
    ERR_TALENT_FAILED_NO_PRIMARY_TREE_SELECTED                      = 871,
    ERR_TALENT_FAILED_CANT_REMOVE_TALENT                            = 872,
    ERR_TALENT_FAILED_UNKNOWN                                       = 873,
    ERR_TALENT_FAILED_IN_COMBAT                                     = 874,
    ERR_TALENT_FAILED_IN_PVP_MATCH                                  = 875,
    ERR_TALENT_FAILED_IN_MYTHIC_PLUS                                = 876,
    ERR_WARGAME_REQUEST_FAILURE                                     = 877,
    ERR_RANK_REQUIRES_AUTHENTICATOR                                 = 878,
    ERR_GUILD_BANK_VOUCHER_FAILED                                   = 879,
    ERR_WARGAME_REQUEST_SENT                                        = 880,
    ERR_REQUIRES_ACHIEVEMENT_I                                      = 881,
    ERR_REFUND_RESULT_EXCEED_MAX_CURRENCY                           = 882,
    ERR_CANT_BUY_QUANTITY                                           = 883,
    ERR_ITEM_IS_BATTLE_PAY_LOCKED                                   = 884,
    ERR_PARTY_ALREADY_IN_BATTLEGROUND_QUEUE                         = 885,
    ERR_PARTY_CONFIRMING_BATTLEGROUND_QUEUE                         = 886,
    ERR_BATTLEFIELD_TEAM_PARTY_SIZE                                 = 887,
    ERR_INSUFF_TRACKED_CURRENCY_IS                                  = 888,
    ERR_NOT_ON_TOURNAMENT_REALM                                     = 889,
    ERR_GUILD_TRIAL_ACCOUNT_TRIAL                                   = 890,
    ERR_GUILD_TRIAL_ACCOUNT_VETERAN                                 = 891,
    ERR_GUILD_UNDELETABLE_DUE_TO_LEVEL                              = 892,
    ERR_CANT_DO_THAT_IN_A_GROUP                                     = 893,
    ERR_GUILD_LEADER_REPLACED                                       = 894,
    ERR_TRANSMOGRIFY_CANT_EQUIP                                     = 895,
    ERR_TRANSMOGRIFY_INVALID_ITEM_TYPE                              = 896,
    ERR_TRANSMOGRIFY_NOT_SOULBOUND                                  = 897,
    ERR_TRANSMOGRIFY_INVALID_SOURCE                                 = 898,
    ERR_TRANSMOGRIFY_INVALID_DESTINATION                            = 899,
    ERR_TRANSMOGRIFY_MISMATCH                                       = 900,
    ERR_TRANSMOGRIFY_LEGENDARY                                      = 901,
    ERR_TRANSMOGRIFY_SAME_ITEM                                      = 902,
    ERR_TRANSMOGRIFY_SAME_APPEARANCE                                = 903,
    ERR_TRANSMOGRIFY_NOT_EQUIPPED                                   = 904,
    ERR_VOID_DEPOSIT_FULL                                           = 905,
    ERR_VOID_WITHDRAW_FULL                                          = 906,
    ERR_VOID_STORAGE_WRAPPED                                        = 907,
    ERR_VOID_STORAGE_STACKABLE                                      = 908,
    ERR_VOID_STORAGE_UNBOUND                                        = 909,
    ERR_VOID_STORAGE_REPAIR                                         = 910,
    ERR_VOID_STORAGE_CHARGES                                        = 911,
    ERR_VOID_STORAGE_QUEST                                          = 912,
    ERR_VOID_STORAGE_CONJURED                                       = 913,
    ERR_VOID_STORAGE_MAIL                                           = 914,
    ERR_VOID_STORAGE_BAG                                            = 915,
    ERR_VOID_TRANSFER_STORAGE_FULL                                  = 916,
    ERR_VOID_TRANSFER_INV_FULL                                      = 917,
    ERR_VOID_TRANSFER_INTERNAL_ERROR                                = 918,
    ERR_VOID_TRANSFER_ITEM_INVALID                                  = 919,
    ERR_DIFFICULTY_DISABLED_IN_LFG                                  = 920,
    ERR_VOID_STORAGE_UNIQUE                                         = 921,
    ERR_VOID_STORAGE_LOOT                                           = 922,
    ERR_VOID_STORAGE_HOLIDAY                                        = 923,
    ERR_VOID_STORAGE_DURATION                                       = 924,
    ERR_VOID_STORAGE_LOAD_FAILED                                    = 925,
    ERR_VOID_STORAGE_INVALID_ITEM                                   = 926,
    ERR_VOID_STORAGE_ACCOUNT_ITEM                                   = 927,
    ERR_PARENTAL_CONTROLS_CHAT_MUTED                                = 928,
    ERR_SOR_START_EXPERIENCE_INCOMPLETE                             = 929,
    ERR_SOR_INVALID_EMAIL                                           = 930,
    ERR_SOR_INVALID_COMMENT                                         = 931,
    ERR_CHALLENGE_MODE_RESET_COOLDOWN_S                             = 932,
    ERR_CHALLENGE_MODE_RESET_KEYSTONE                               = 933,
    ERR_PET_JOURNAL_ALREADY_IN_LOADOUT                              = 934,
    ERR_REPORT_SUBMITTED_SUCCESSFULLY                               = 935,
    ERR_REPORT_SUBMISSION_FAILED                                    = 936,
    ERR_SUGGESTION_SUBMITTED_SUCCESSFULLY                           = 937,
    ERR_BUG_SUBMITTED_SUCCESSFULLY                                  = 938,
    ERR_CHALLENGE_MODE_ENABLED                                      = 939,
    ERR_CHALLENGE_MODE_DISABLED                                     = 940,
    ERR_PETBATTLE_CREATE_FAILED                                     = 941,
    ERR_PETBATTLE_NOT_HERE                                          = 942,
    ERR_PETBATTLE_NOT_HERE_ON_TRANSPORT                             = 943,
    ERR_PETBATTLE_NOT_HERE_UNEVEN_GROUND                            = 944,
    ERR_PETBATTLE_NOT_HERE_OBSTRUCTED                               = 945,
    ERR_PETBATTLE_NOT_WHILE_IN_COMBAT                               = 946,
    ERR_PETBATTLE_NOT_WHILE_DEAD                                    = 947,
    ERR_PETBATTLE_NOT_WHILE_FLYING                                  = 948,
    ERR_PETBATTLE_TARGET_INVALID                                    = 949,
    ERR_PETBATTLE_TARGET_OUT_OF_RANGE                               = 950,
    ERR_PETBATTLE_TARGET_NOT_CAPTURABLE                             = 951,
    ERR_PETBATTLE_NOT_A_TRAINER                                     = 952,
    ERR_PETBATTLE_DECLINED                                          = 953,
    ERR_PETBATTLE_IN_BATTLE                                         = 954,
    ERR_PETBATTLE_INVALID_LOADOUT                                   = 955,
    ERR_PETBATTLE_ALL_PETS_DEAD                                     = 956,
    ERR_PETBATTLE_NO_PETS_IN_SLOTS                                  = 957,
    ERR_PETBATTLE_NO_ACCOUNT_LOCK                                   = 958,
    ERR_PETBATTLE_WILD_PET_TAPPED                                   = 959,
    ERR_PETBATTLE_RESTRICTED_ACCOUNT                                = 960,
    ERR_PETBATTLE_OPPONENT_NOT_AVAILABLE                            = 961,
    ERR_PETBATTLE_NOT_WHILE_IN_MATCHED_BATTLE                       = 962,
    ERR_CANT_HAVE_MORE_PETS_OF_THAT_TYPE                            = 963,
    ERR_CANT_HAVE_MORE_PETS                                         = 964,
    ERR_PVP_MAP_NOT_FOUND                                           = 965,
    ERR_PVP_MAP_NOT_SET                                             = 966,
    ERR_PETBATTLE_QUEUE_QUEUED                                      = 967,
    ERR_PETBATTLE_QUEUE_ALREADY_QUEUED                              = 968,
    ERR_PETBATTLE_QUEUE_JOIN_FAILED                                 = 969,
    ERR_PETBATTLE_QUEUE_JOURNAL_LOCK                                = 970,
    ERR_PETBATTLE_QUEUE_REMOVED                                     = 971,
    ERR_PETBATTLE_QUEUE_PROPOSAL_DECLINED                           = 972,
    ERR_PETBATTLE_QUEUE_PROPOSAL_TIMEOUT                            = 973,
    ERR_PETBATTLE_QUEUE_OPPONENT_DECLINED                           = 974,
    ERR_PETBATTLE_QUEUE_REQUEUED_INTERNAL                           = 975,
    ERR_PETBATTLE_QUEUE_REQUEUED_REMOVED                            = 976,
    ERR_PETBATTLE_QUEUE_SLOT_LOCKED                                 = 977,
    ERR_PETBATTLE_QUEUE_SLOT_EMPTY                                  = 978,
    ERR_PETBATTLE_QUEUE_SLOT_NO_TRACKER                             = 979,
    ERR_PETBATTLE_QUEUE_SLOT_NO_SPECIES                             = 980,
    ERR_PETBATTLE_QUEUE_SLOT_CANT_BATTLE                            = 981,
    ERR_PETBATTLE_QUEUE_SLOT_REVOKED                                = 982,
    ERR_PETBATTLE_QUEUE_SLOT_DEAD                                   = 983,
    ERR_PETBATTLE_QUEUE_SLOT_NO_PET                                 = 984,
    ERR_PETBATTLE_QUEUE_NOT_WHILE_NEUTRAL                           = 985,
    ERR_PETBATTLE_GAME_TIME_LIMIT_WARNING                           = 986,
    ERR_PETBATTLE_GAME_ROUNDS_LIMIT_WARNING                         = 987,
    ERR_HAS_RESTRICTION                                             = 988,
    ERR_ITEM_UPGRADE_ITEM_TOO_LOW_LEVEL                             = 989,
    ERR_ITEM_UPGRADE_NO_PATH                                        = 990,
    ERR_ITEM_UPGRADE_NO_MORE_UPGRADES                               = 991,
    ERR_BONUS_ROLL_EMPTY                                            = 992,
    ERR_CHALLENGE_MODE_FULL                                         = 993,
    ERR_CHALLENGE_MODE_IN_PROGRESS                                  = 994,
    ERR_CHALLENGE_MODE_INCORRECT_KEYSTONE                           = 995,
    ERR_BATTLETAG_FRIEND_NOT_FOUND                                  = 996,
    ERR_BATTLETAG_FRIEND_NOT_VALID                                  = 997,
    ERR_BATTLETAG_FRIEND_NOT_ALLOWED                                = 998,
    ERR_BATTLETAG_FRIEND_THROTTLED                                  = 999,
    ERR_BATTLETAG_FRIEND_SUCCESS                                    = 1000,
    ERR_PET_TOO_HIGH_LEVEL_TO_UNCAGE                                = 1001,
    ERR_PETBATTLE_INTERNAL                                          = 1002,
    ERR_CANT_CAGE_PET_YET                                           = 1003,
    ERR_NO_LOOT_IN_CHALLENGE_MODE                                   = 1004,
    ERR_QUEST_PET_BATTLE_VICTORIES_PVP_II                           = 1005,
    ERR_ROLE_CHECK_ALREADY_IN_PROGRESS                              = 1006,
    ERR_RECRUIT_A_FRIEND_ACCOUNT_LIMIT                              = 1007,
    ERR_RECRUIT_A_FRIEND_FAILED                                     = 1008,
    ERR_SET_LOOT_PERSONAL                                           = 1009,
    ERR_SET_LOOT_METHOD_FAILED_COMBAT                               = 1010,
    ERR_REAGENT_BANK_FULL                                           = 1011,
    ERR_REAGENT_BANK_LOCKED                                         = 1012,
    ERR_GARRISON_BUILDING_EXISTS                                    = 1013,
    ERR_GARRISON_INVALID_PLOT                                       = 1014,
    ERR_GARRISON_INVALID_BUILDINGID                                 = 1015,
    ERR_GARRISON_INVALID_PLOT_BUILDING                              = 1016,
    ERR_GARRISON_REQUIRES_BLUEPRINT                                 = 1017,
    ERR_GARRISON_NOT_ENOUGH_CURRENCY                                = 1018,
    ERR_GARRISON_NOT_ENOUGH_GOLD                                    = 1019,
    ERR_GARRISON_COMPLETE_MISSION_WRONG_FOLLOWER_TYPE               = 1020,
    ERR_ALREADY_USING_LFG_LIST                                      = 1021,
    ERR_RESTRICTED_ACCOUNT_LFG_LIST_TRIAL                           = 1022,
    ERR_TOY_USE_LIMIT_REACHED                                       = 1023,
    ERR_TOY_ALREADY_KNOWN                                           = 1024,
    ERR_TRANSMOG_SET_ALREADY_KNOWN                                  = 1025,
    ERR_NOT_ENOUGH_CURRENCY                                         = 1026,
    ERR_SPEC_IS_DISABLED                                            = 1027,
    ERR_FEATURE_RESTRICTED_TRIAL                                    = 1028,
    ERR_CANT_BE_OBLITERATED                                         = 1029,
    ERR_CANT_BE_SCRAPPED                                            = 1030,
    ERR_CANT_BE_RECRAFTED                                           = 1031,
    ERR_ARTIFACT_RELIC_DOES_NOT_MATCH_ARTIFACT                      = 1032,
    ERR_MUST_EQUIP_ARTIFACT                                         = 1033,
    ERR_CANT_DO_THAT_RIGHT_NOW                                      = 1034,
    ERR_AFFECTING_COMBAT                                            = 1035,
    ERR_EQUIPMENT_MANAGER_COMBAT_SWAP_S                             = 1036,
    ERR_EQUIPMENT_MANAGER_BAGS_FULL                                 = 1037,
    ERR_EQUIPMENT_MANAGER_MISSING_ITEM_S                            = 1038,
    ERR_MOVIE_RECORDING_WARNING_PERF                                = 1039,
    ERR_MOVIE_RECORDING_WARNING_DISK_FULL                           = 1040,
    ERR_MOVIE_RECORDING_WARNING_NO_MOVIE                            = 1041,
    ERR_MOVIE_RECORDING_WARNING_REQUIREMENTS                        = 1042,
    ERR_MOVIE_RECORDING_WARNING_COMPRESSING                         = 1043,
    ERR_NO_CHALLENGE_MODE_REWARD                                    = 1044,
    ERR_CLAIMED_CHALLENGE_MODE_REWARD                               = 1045,
    ERR_CHALLENGE_MODE_PERIOD_RESET_SS                              = 1046,
    ERR_CANT_DO_THAT_CHALLENGE_MODE_ACTIVE                          = 1047,
    ERR_TALENT_FAILED_REST_AREA                                     = 1048,
    ERR_CANNOT_ABANDON_LAST_PET                                     = 1049,
    ERR_TEST_CVAR_SET_SSS                                           = 1050,
    ERR_QUEST_TURN_IN_FAIL_REASON                                   = 1051,
    ERR_CLAIMED_CHALLENGE_MODE_REWARD_OLD                           = 1052,
    ERR_TALENT_GRANTED_BY_AURA                                      = 1053,
    ERR_CHALLENGE_MODE_ALREADY_COMPLETE                             = 1054,
    ERR_GLYPH_TARGET_NOT_AVAILABLE                                  = 1055,
    ERR_PVP_WARMODE_TOGGLE_ON                                       = 1056,
    ERR_PVP_WARMODE_TOGGLE_OFF                                      = 1057,
    ERR_SPELL_FAILED_LEVEL_REQUIREMENT                              = 1058,
    ERR_SPELL_FAILED_CANT_FLY_HERE                                  = 1059,
    ERR_BATTLEGROUND_JOIN_REQUIRES_LEVEL                            = 1060,
    ERR_BATTLEGROUND_JOIN_DISQUALIFIED                              = 1061,
    ERR_BATTLEGROUND_JOIN_DISQUALIFIED_NO_NAME                      = 1062,
    ERR_VOICE_CHAT_GENERIC_UNABLE_TO_CONNECT                        = 1063,
    ERR_VOICE_CHAT_SERVICE_LOST                                     = 1064,
    ERR_VOICE_CHAT_CHANNEL_NAME_TOO_SHORT                           = 1065,
    ERR_VOICE_CHAT_CHANNEL_NAME_TOO_LONG                            = 1066,
    ERR_VOICE_CHAT_CHANNEL_ALREADY_EXISTS                           = 1067,
    ERR_VOICE_CHAT_TARGET_NOT_FOUND                                 = 1068,
    ERR_VOICE_CHAT_TOO_MANY_REQUESTS                                = 1069,
    ERR_VOICE_CHAT_PLAYER_SILENCED                                  = 1070,
    ERR_VOICE_CHAT_PARENTAL_DISABLE_ALL                             = 1071,
    ERR_VOICE_CHAT_DISABLED                                         = 1072,
    ERR_NO_PVP_REWARD                                               = 1073,
    ERR_CLAIMED_PVP_REWARD                                          = 1074,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_ESSENCE_NOT_UNLOCKED       = 1075,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_CANT_REMOVE_ESSENCE        = 1076,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_CONDITION_FAILED           = 1077,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_REST_AREA                  = 1078,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_SLOT_LOCKED                = 1079,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_NOT_AT_FORGE               = 1080,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_HEART_LEVEL_TOO_LOW        = 1081,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_NOT_EQUIPPED               = 1082,
    ERR_SOCKETING_REQUIRES_PUNCHCARDRED_GEM                         = 1083,
    ERR_SOCKETING_PUNCHCARDRED_GEM_ONLY_IN_PUNCHCARDREDSLOT         = 1084,
    ERR_SOCKETING_REQUIRES_PUNCHCARDYELLOW_GEM                      = 1085,
    ERR_SOCKETING_PUNCHCARDYELLOW_GEM_ONLY_IN_PUNCHCARDYELLOWSLOT   = 1086,
    ERR_SOCKETING_REQUIRES_PUNCHCARDBLUE_GEM                        = 1087,
    ERR_SOCKETING_PUNCHCARDBLUE_GEM_ONLY_IN_PUNCHCARDBLUESLOT       = 1088,
    ERR_SOCKETING_REQUIRES_DOMINATION_SHARD                         = 1089,
    ERR_SOCKETING_DOMINATION_SHARD_ONLY_IN_DOMINATIONSLOT           = 1090,
    ERR_SOCKETING_REQUIRES_CYPHER_GEM                               = 1091,
    ERR_SOCKETING_CYPHER_GEM_ONLY_IN_CYPHERSLOT                     = 1092,
    ERR_SOCKETING_REQUIRES_TINKER_GEM                               = 1093,
    ERR_SOCKETING_TINKER_GEM_ONLY_IN_TINKERSLOT                     = 1094,
    ERR_SOCKETING_REQUIRES_PRIMORDIAL_GEM                           = 1095,
    ERR_SOCKETING_PRIMORDIAL_GEM_ONLY_IN_PRIMORDIALSLOT             = 1096,
    ERR_SOCKETING_REQUIRES_FRAGRANCE_GEM                            = 1097,
    ERR_SOCKETING_FRAGRANCE_GEM_ONLY_IN_FRAGRANCESLOT               = 1098,
    ERR_LEVEL_LINKING_RESULT_LINKED                                 = 1099,
    ERR_LEVEL_LINKING_RESULT_UNLINKED                               = 1100,
    ERR_CLUB_FINDER_ERROR_POST_CLUB                                 = 1101,
    ERR_CLUB_FINDER_ERROR_APPLY_CLUB                                = 1102,
    ERR_CLUB_FINDER_ERROR_RESPOND_APPLICANT                         = 1103,
    ERR_CLUB_FINDER_ERROR_CANCEL_APPLICATION                        = 1104,
    ERR_CLUB_FINDER_ERROR_TYPE_ACCEPT_APPLICATION                   = 1105,
    ERR_CLUB_FINDER_ERROR_TYPE_NO_INVITE_PERMISSIONS                = 1106,
    ERR_CLUB_FINDER_ERROR_TYPE_NO_POSTING_PERMISSIONS               = 1107,
    ERR_CLUB_FINDER_ERROR_TYPE_APPLICANT_LIST                       = 1108,
    ERR_CLUB_FINDER_ERROR_TYPE_APPLICANT_LIST_NO_PERM               = 1109,
    ERR_CLUB_FINDER_ERROR_TYPE_FINDER_NOT_AVAILABLE                 = 1110,
    ERR_CLUB_FINDER_ERROR_TYPE_GET_POSTING_IDS                      = 1111,
    ERR_CLUB_FINDER_ERROR_TYPE_JOIN_APPLICATION                     = 1112,
    ERR_CLUB_FINDER_ERROR_TYPE_REALM_NOT_ELIGIBLE                   = 1113,
    ERR_CLUB_FINDER_ERROR_TYPE_FLAGGED_RENAME                       = 1114,
    ERR_CLUB_FINDER_ERROR_TYPE_FLAGGED_DESCRIPTION_CHANGE           = 1115,
    ERR_ITEM_INTERACTION_NOT_ENOUGH_GOLD                            = 1116,
    ERR_ITEM_INTERACTION_NOT_ENOUGH_CURRENCY                        = 1117,
    ERR_ITEM_INTERACTION_NO_CONVERSION_OUTPUT                       = 1118,
    ERR_PLAYER_CHOICE_ERROR_PENDING_CHOICE                          = 1119,
    ERR_SOULBIND_INVALID_CONDUIT                                    = 1120,
    ERR_SOULBIND_INVALID_CONDUIT_ITEM                               = 1121,
    ERR_SOULBIND_INVALID_TALENT                                     = 1122,
    ERR_SOULBIND_DUPLICATE_CONDUIT                                  = 1123,
    ERR_ACTIVATE_SOULBIND_S                                         = 1124,
    ERR_ACTIVATE_SOULBIND_FAILED_REST_AREA                          = 1125,
    ERR_CANT_USE_PROFANITY                                          = 1126,
    ERR_NOT_IN_PET_BATTLE                                           = 1127,
    ERR_NOT_IN_NPE                                                  = 1128,
    ERR_NO_SPEC                                                     = 1129,
    ERR_NO_DOMINATIONSHARD_OVERWRITE                                = 1130,
    ERR_USE_WEEKLY_REWARDS_DISABLED                                 = 1131,
    ERR_CROSS_FACTION_GROUP_JOINED                                  = 1132,
    ERR_CANT_TARGET_UNFRIENDLY_IN_OVERWORLD                         = 1133,
    ERR_EQUIPABLESPELLS_SLOTS_FULL                                  = 1134,
    ERR_ITEM_MOD_APPEARANCE_GROUP_ALREADY_KNOWN                     = 1135,
    ERR_CANT_BULK_SELL_ITEM_WITH_REFUND                             = 1136,
    ERR_NO_SOULBOUND_ITEM_IN_ACCOUNT_BANK                           = 1137,
    ERR_NO_REFUNDABLE_ITEM_IN_ACCOUNT_BANK                          = 1138,
    ERR_CANT_DELETE_IN_ACCOUNT_BANK                                 = 1139,
    ERR_NO_IMMEDIATE_CONTAINER_IN_ACCOUNT_BANK                      = 1140,
    ERR_NO_OPEN_IMMEDIATE_CONTAINER_IN_ACCOUNT_BANK                 = 1141,
    ERR_CANT_TRADE_ACCOUNT_ITEM                                     = 1142,
    ERR_NO_ACCOUNT_INVENTORY_LOCK                                   = 1143,
    ERR_BANK_NOT_ACCESSIBLE                                         = 1144,
    ERR_TOO_MANY_ACCOUNT_BANK_TABS                                  = 1145,
    ERR_ACCOUNT_BANK_TAB_NOT_UNLOCKED                               = 1146,
    ERR_BANK_TAB_INVALID_NAME                                       = 1147,
    ERR_BANK_TAB_INVALID_TEXT                                       = 1148,
    ERR_WOW_LABS_PARTY_ERROR_TYPE_PARTY_IS_FULL                     = 1149,
    ERR_WOW_LABS_PARTY_ERROR_TYPE_MAX_INVITE_SENT                   = 1150,
    ERR_WOW_LABS_PARTY_ERROR_TYPE_PLAYER_ALREADY_INVITED            = 1151,
    ERR_WOW_LABS_PARTY_ERROR_TYPE_PARTY_INVITE_INVALID              = 1152,
    ERR_WOW_LABS_LOBBY_MATCHMAKER_ERROR_ENTER_QUEUE_FAILED          = 1153,
    ERR_WOW_LABS_LOBBY_MATCHMAKER_ERROR_LEAVE_QUEUE_FAILED          = 1154,
    ERR_TARGET_IS_SELF_FOUND_CANNOT_TRADE                           = 1155,
    ERR_PLAYER_IS_SELF_FOUND_CANNOT_TRADE                           = 1156,
    ERR_MAIL_RECEPIENT_IS_SELF_FOUND_CANNOT_RECEIVE_MAIL            = 1157,
    ERR_PLAYER_IS_SELF_FOUND_CANNOT_SEND_MAIL                       = 1158,
    ERR_PLAYER_IS_SELF_FOUND_CANNOT_USE_AUCTION_HOUSE               = 1159,
    ERR_MAIL_TARGET_CANNOT_RECEIVE_MAIL                             = 1160,
    ERR_REMIX_INVALID_TRANSFER_REQUEST                              = 1161,
    ERR_CURRENCY_TRANSFER_INVALID_CHARACTER                         = 1162,
    ERR_CURRENCY_TRANSFER_INVALID_CURRENCY                          = 1163,
    ERR_CURRENCY_TRANSFER_INSUFFICIENT_CURRENCY                     = 1164,
    ERR_CURRENCY_TRANSFER_MAX_QUANTITY                              = 1165,
    ERR_CURRENCY_TRANSFER_NO_VALID_SOURCE                           = 1166,
    ERR_CURRENCY_TRANSFER_CHARACTER_LOGGED_IN                       = 1167,
    ERR_CURRENCY_TRANSFER_SERVER_ERROR                              = 1168,
    ERR_CURRENCY_TRANSFER_UNMET_REQUIREMENTS                        = 1169,
    ERR_CURRENCY_TRANSFER_TRANSACTION_IN_PROGRESS                   = 1170,
};
