...
{
    CREATURE_TYPEFLAGS_TAMEABLE_PET                         = 0x00000001,   // Makes the mob tameable (must also be a beast and have family set)
    CREATURE_TYPEFLAGS_GHOST_VISIBLE                        = 0x00000002,   // Creature are also visible for not alive player. Allow gossip interaction if npcflag allow?
    CREATURE_TYPEFLAGS_BOSS_MOB                             = 0x00000004,   // Changes creature's visible level to "??" in the creature's portrait - Immune Knockback.
    ...
    CREATURE_TYPEFLAGS_CAN_INTERACT_WHILE_DEAD              = 0x00000080,   // Player can interact with the creature if its dead (not player dead)
    CREATURE_TYPEFLAGS_HERB_SKINNING_SKILL                  = 0x00000100,   // Can be looted by herbalist
    CREATURE_TYPEFLAGS_MINING_SKINNING_SKILL                = 0x00000200,   // Can be looted by miner
    CREATURE_TYPEFLAGS_DO_NOT_LOG_DEATH                     = 0x00000400,   // Death event will not show up in combat log
    CREATURE_TYPEFLAGS_MOUNTED_COMBAT_ALLOWED               = 0x00000800,   // Creature can remain mounted when entering combat
    CREATURE_TYPEFLAGS_CAN_ASSIST                           = 0x00001000,   // ? Can aid any player in combat if in range?
    CREATURE_TYPEFLAGS_IS_PET_BAR_USED                      = 0x00002000,
    CREATURE_TYPEFLAGS_MASK_UID                             = 0x00004000,
    CREATURE_TYPEFLAGS_ENGINEERING_SKINNING_SKILL           = 0x00008000,   // Can be looted by engineer
    CREATURE_TYPEFLAGS_EXOTIC_PET                           = 0x00010000,   // Can be tamed by hunter as exotic pet
    ...
    CREATURE_TYPEFLAGS_DOES_NOT_COLLIDE_WITH_MISSILES       = 0x00080000,   // Projectiles can collide with this creature - interacts with TARGET_DEST_TRAJ
    CREATURE_TYPEFLAGS_HIDE_NAME_PLATE                      = 0x00100000,
