...
enum SpellCastResult
{
    ...
    SPELL_FAILED_SPEC_DISABLED                                  = 270,
    SPELL_FAILED_CANT_BE_OBLITERATED                            = 271,
    SPELL_FAILED_FOLLOWER_CLASS_SPEC_CAP                        = 272,
    SPELL_FAILED_TRANSPORT_NOT_READY                            = 273,
    SPELL_FAILED_TRANSMOG_SET_ALREADY_KNOWN                     = 274,
    SPELL_FAILED_DISABLED_BY_AURA_LABEL                         = 275,
    SPELL_FAILED_DISABLED_BY_MAX_USABLE_LEVEL                   = 276,
    SPELL_FAILED_SPELL_ALREADY_KNOWN                            = 277,
    SPELL_FAILED_MUST_KNOW_SUPERCEDING_SPELL                    = 278,
    SPELL_FAILED_YOU_CANNOT_USE_THAT_IN_PVP_INSTANCE            = 279,
    SPELL_FAILED_NO_ARTIFACT_EQUIPPED                           = 280,
    SPELL_FAILED_WRONG_ARTIFACT_EQUIPPED                        = 281,
    SPELL_FAILED_TARGET_IS_UNTARGETABLE_BY_ANYONE               = 282,
    SPELL_FAILED_SPELL_EFFECT_FAILED                            = 283,
    SPELL_FAILED_NEED_ALL_PARTY_MEMBERS                         = 284,
    SPELL_FAILED_ARTIFACT_AT_FULL_POWER                         = 285,
    SPELL_FAILED_AP_ITEM_FROM_PREVIOUS_TIER                     = 286,
    SPELL_FAILED_UNKNOWN                                        = 287,
