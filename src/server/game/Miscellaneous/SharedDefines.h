...
enum class GameError : uint32
{
    ...
    ERR_CLUB_FINDER_SEARCHING_TOO_FAST                              = 487,
    ERR_TARGET_STUNNED                                              = 488,
    ERR_MUST_REPAIR_DURABILITY                                      = 489,
    ERR_RAID_YOU_JOINED                                             = 490,
    ERR_RAID_YOU_LEFT                                               = 491,
    ERR_INSTANCE_GROUP_JOINED_WITH_PARTY                            = 492,
    ERR_INSTANCE_GROUP_JOINED_WITH_RAID                             = 493,
    ERR_RAID_MEMBER_ADDED_S                                         = 494,
    ERR_RAID_MEMBER_REMOVED_S                                       = 495,
    ERR_INSTANCE_GROUP_ADDED_S                                      = 496,
    ERR_INSTANCE_GROUP_REMOVED_S                                    = 497,
    ERR_CLICK_ON_ITEM_TO_FEED                                       = 498,
    ERR_TOO_MANY_CHAT_CHANNELS                                      = 499,
    ERR_LOOT_ROLL_PENDING                                           = 500,
    ERR_LOOT_PLAYER_NOT_FOUND                                       = 501,
    ERR_NOT_IN_RAID                                                 = 502,
    ERR_LOGGING_OUT                                                 = 503,
    ERR_TARGET_LOGGING_OUT                                          = 504,
    ERR_NOT_WHILE_MOUNTED                                           = 505,
    ERR_NOT_WHILE_SHAPESHIFTED                                      = 506,
    ERR_NOT_IN_COMBAT                                               = 507,
    ERR_NOT_WHILE_DISARMED                                          = 508,
    ERR_PET_BROKEN                                                  = 509,
    ERR_TALENT_WIPE_ERROR                                           = 510,
    ERR_SPEC_WIPE_ERROR                                             = 511,
    ERR_GLYPH_WIPE_ERROR                                            = 512,
    ERR_PET_SPEC_WIPE_ERROR                                         = 513,
    ERR_FEIGN_DEATH_RESISTED                                        = 514,
    ERR_MEETING_STONE_IN_QUEUE_S                                    = 515,
    ERR_MEETING_STONE_LEFT_QUEUE_S                                  = 516,
    ERR_MEETING_STONE_OTHER_MEMBER_LEFT                             = 517,
    ERR_MEETING_STONE_PARTY_KICKED_FROM_QUEUE                       = 518,
    ERR_MEETING_STONE_MEMBER_STILL_IN_QUEUE                         = 519,
    ERR_MEETING_STONE_SUCCESS                                       = 520,
    ERR_MEETING_STONE_IN_PROGRESS                                   = 521,
    ERR_MEETING_STONE_MEMBER_ADDED_S                                = 522,
    ERR_MEETING_STONE_GROUP_FULL                                    = 523,
    ERR_MEETING_STONE_NOT_LEADER                                    = 524,
    ERR_MEETING_STONE_INVALID_LEVEL                                 = 525,
    ERR_MEETING_STONE_TARGET_NOT_IN_PARTY                           = 526,
    ERR_MEETING_STONE_TARGET_INVALID_LEVEL                          = 527,
    ERR_MEETING_STONE_MUST_BE_LEADER                                = 528,
    ERR_MEETING_STONE_NO_RAID_GROUP                                 = 529,
    ERR_MEETING_STONE_NEED_PARTY                                    = 530,
    ERR_MEETING_STONE_NOT_FOUND                                     = 531,
    ERR_MEETING_STONE_TARGET_IN_VEHICLE                             = 532,
    ERR_GUILDEMBLEM_SAME                                            = 533,
    ERR_EQUIP_TRADE_ITEM                                            = 534,
    ERR_PVP_TOGGLE_ON                                               = 535,
    ERR_PVP_TOGGLE_OFF                                              = 536,
    ERR_GROUP_JOIN_BATTLEGROUND_DESERTERS                           = 537,
    ERR_GROUP_JOIN_BATTLEGROUND_DEAD                                = 538,
    ERR_GROUP_JOIN_BATTLEGROUND_S                                   = 539,
    ERR_GROUP_JOIN_BATTLEGROUND_FAIL                                = 540,
    ERR_GROUP_JOIN_BATTLEGROUND_TOO_MANY                            = 541,
    ERR_SOLO_JOIN_BATTLEGROUND_S                                    = 542,
    ERR_JOIN_SINGLE_SCENARIO_S                                      = 543,
    ERR_BATTLEGROUND_TOO_MANY_QUEUES                                = 544,
    ERR_BATTLEGROUND_CANNOT_QUEUE_FOR_RATED                         = 545,
    ERR_BATTLEDGROUND_QUEUED_FOR_RATED                              = 546,
    ERR_BATTLEGROUND_TEAM_LEFT_QUEUE                                = 547,
    ERR_BATTLEGROUND_NOT_IN_BATTLEGROUND                            = 548,
    ERR_ALREADY_IN_ARENA_TEAM_S                                     = 549,
    ERR_INVALID_PROMOTION_CODE                                      = 550,
    ERR_BG_PLAYER_JOINED_SS                                         = 551,
    ERR_BG_PLAYER_LEFT_S                                            = 552,
    ERR_RESTRICTED_ACCOUNT                                          = 553,
    ERR_RESTRICTED_ACCOUNT_TRIAL                                    = 554,
    ERR_PLAY_TIME_EXCEEDED                                          = 555,
    ERR_APPROACHING_PARTIAL_PLAY_TIME                               = 556,
    ERR_APPROACHING_PARTIAL_PLAY_TIME_2                             = 557,
    ERR_APPROACHING_NO_PLAY_TIME                                    = 558,
    ERR_APPROACHING_NO_PLAY_TIME_2                                  = 559,
    ERR_UNHEALTHY_TIME                                              = 560,
    ERR_CHAT_RESTRICTED_TRIAL                                       = 561,
    ERR_CHAT_THROTTLED                                              = 562,
    ERR_MAIL_REACHED_CAP                                            = 563,
    ERR_INVALID_RAID_TARGET                                         = 564,
    ERR_RAID_LEADER_READY_CHECK_START_S                             = 565,
    ERR_READY_CHECK_IN_PROGRESS                                     = 566,
    ERR_READY_CHECK_THROTTLED                                       = 567,
    ERR_DUNGEON_DIFFICULTY_FAILED                                   = 568,
    ERR_DUNGEON_DIFFICULTY_CHANGED_S                                = 569,
    ERR_TRADE_WRONG_REALM                                           = 570,
    ERR_TRADE_NOT_ON_TAPLIST                                        = 571,
    ERR_CHAT_PLAYER_AMBIGUOUS_S                                     = 572,
    ERR_LOOT_CANT_LOOT_THAT_NOW                                     = 573,
    ERR_LOOT_MASTER_INV_FULL                                        = 574,
    ERR_LOOT_MASTER_UNIQUE_ITEM                                     = 575,
    ERR_LOOT_MASTER_OTHER                                           = 576,
    ERR_FILTERING_YOU_S                                             = 577,
    ERR_USE_PREVENTED_BY_MECHANIC_S                                 = 578,
    ERR_ITEM_UNIQUE_EQUIPPABLE                                      = 579,
    ERR_LFG_LEADER_IS_LFM_S                                         = 580,
    ERR_LFG_PENDING                                                 = 581,
    ERR_CANT_SPEAK_LANGAGE                                          = 582,
    ERR_VENDOR_MISSING_TURNINS                                      = 583,
    ERR_BATTLEGROUND_NOT_IN_TEAM                                    = 584,
    ERR_NOT_IN_BATTLEGROUND                                         = 585,
    ERR_NOT_ENOUGH_HONOR_POINTS                                     = 586,
    ERR_NOT_ENOUGH_ARENA_POINTS                                     = 587,
    ERR_SOCKETING_REQUIRES_META_GEM                                 = 588,
    ERR_SOCKETING_META_GEM_ONLY_IN_METASLOT                         = 589,
    ERR_SOCKETING_REQUIRES_HYDRAULIC_GEM                            = 590,
    ERR_SOCKETING_HYDRAULIC_GEM_ONLY_IN_HYDRAULICSLOT               = 591,
    ERR_SOCKETING_REQUIRES_COGWHEEL_GEM                             = 592,
    ERR_SOCKETING_COGWHEEL_GEM_ONLY_IN_COGWHEELSLOT                 = 593,
    ERR_SOCKETING_ITEM_TOO_LOW_LEVEL                                = 594,
    ERR_ITEM_MAX_COUNT_SOCKETED                                     = 595,
    ERR_SYSTEM_DISABLED                                             = 596,
    ERR_QUEST_FAILED_TOO_MANY_DAILY_QUESTS_I                        = 597,
    ERR_ITEM_MAX_COUNT_EQUIPPED_SOCKETED                            = 598,
    ERR_ITEM_UNIQUE_EQUIPPABLE_SOCKETED                             = 599,
    ERR_USER_SQUELCHED                                              = 600,
    ERR_ACCOUNT_SILENCED                                            = 601,
    ERR_TOO_MUCH_GOLD                                               = 602,
    ERR_NOT_BARBER_SITTING                                          = 603,
    ERR_QUEST_FAILED_CAIS                                           = 604,
    ERR_INVITE_RESTRICTED_TRIAL                                     = 605,
    ERR_VOICE_IGNORE_FULL                                           = 606,
    ERR_VOICE_IGNORE_SELF                                           = 607,
    ERR_VOICE_IGNORE_NOT_FOUND                                      = 608,
    ERR_VOICE_IGNORE_ALREADY_S                                      = 609,
    ERR_VOICE_IGNORE_ADDED_S                                        = 610,
    ERR_VOICE_IGNORE_REMOVED_S                                      = 611,
    ERR_VOICE_IGNORE_AMBIGUOUS                                      = 612,
    ERR_VOICE_IGNORE_DELETED                                        = 613,
    ERR_UNKNOWN_MACRO_OPTION_S                                      = 614,
    ERR_NOT_DURING_ARENA_MATCH                                      = 615,
    ERR_PLAYER_SILENCED                                             = 616,
    ERR_PLAYER_UNSILENCED                                           = 617,
    ERR_COMSAT_DISCONNECT                                           = 618,
    ERR_COMSAT_RECONNECT_ATTEMPT                                    = 619,
    ERR_COMSAT_CONNECT_FAIL                                         = 620,
    ERR_MAIL_INVALID_ATTACHMENT_SLOT                                = 621,
    ERR_MAIL_TOO_MANY_ATTACHMENTS                                   = 622,
    ERR_MAIL_INVALID_ATTACHMENT                                     = 623,
    ERR_MAIL_ATTACHMENT_EXPIRED                                     = 624,
    ERR_VOICE_CHAT_PARENTAL_DISABLE_MIC                             = 625,
    ERR_PROFANE_CHAT_NAME                                           = 626,
    ERR_PLAYER_SILENCED_ECHO                                        = 627,
    ERR_PLAYER_UNSILENCED_ECHO                                      = 628,
    ERR_LOOT_CANT_LOOT_THAT                                         = 629,
    ERR_ARENA_EXPIRED_CAIS                                          = 630,
    ERR_GROUP_ACTION_THROTTLED                                      = 631,
    ERR_ALREADY_PICKPOCKETED                                        = 632,
    ERR_NAME_INVALID                                                = 633,
    ERR_NAME_NO_NAME                                                = 634,
    ERR_NAME_TOO_SHORT                                              = 635,
    ERR_NAME_TOO_LONG                                               = 636,
    ERR_NAME_MIXED_LANGUAGES                                        = 637,
    ERR_NAME_PROFANE                                                = 638,
    ERR_NAME_RESERVED                                               = 639,
    ERR_NAME_THREE_CONSECUTIVE                                      = 640,
    ERR_NAME_INVALID_SPACE                                          = 641,
    ERR_NAME_CONSECUTIVE_SPACES                                     = 642,
    ERR_NAME_RUSSIAN_CONSECUTIVE_SILENT_CHARACTERS                  = 643,
    ERR_NAME_RUSSIAN_SILENT_CHARACTER_AT_BEGINNING_OR_END           = 644,
    ERR_NAME_DECLENSION_DOESNT_MATCH_BASE_NAME                      = 645,
    ERR_RECRUIT_A_FRIEND_NOT_LINKED                                 = 646,
    ERR_RECRUIT_A_FRIEND_NOT_NOW                                    = 647,
    ERR_RECRUIT_A_FRIEND_SUMMON_LEVEL_MAX                           = 648,
    ERR_RECRUIT_A_FRIEND_SUMMON_COOLDOWN                            = 649,
    ERR_RECRUIT_A_FRIEND_SUMMON_OFFLINE                             = 650,
    ERR_RECRUIT_A_FRIEND_INSUF_EXPAN_LVL                            = 651,
    ERR_RECRUIT_A_FRIEND_MAP_INCOMING_TRANSFER_NOT_ALLOWED          = 652,
    ERR_NOT_SAME_ACCOUNT                                            = 653,
    ERR_BAD_ON_USE_ENCHANT                                          = 654,
    ERR_TRADE_SELF                                                  = 655,
    ERR_TOO_MANY_SOCKETS                                            = 656,
    ERR_ITEM_MAX_LIMIT_CATEGORY_COUNT_EXCEEDED_IS                   = 657,
    ERR_TRADE_TARGET_MAX_LIMIT_CATEGORY_COUNT_EXCEEDED_IS           = 658,
    ERR_ITEM_MAX_LIMIT_CATEGORY_SOCKETED_EXCEEDED_IS                = 659,
    ERR_ITEM_MAX_LIMIT_CATEGORY_EQUIPPED_EXCEEDED_IS                = 660,
    ERR_SHAPESHIFT_FORM_CANNOT_EQUIP                                = 661,
    ERR_ITEM_INVENTORY_FULL_SATCHEL                                 = 662,
    ERR_SCALING_STAT_ITEM_LEVEL_EXCEEDED                            = 663,
    ERR_SCALING_STAT_ITEM_LEVEL_TOO_LOW                             = 664,
    ERR_PURCHASE_LEVEL_TOO_LOW                                      = 665,
    ERR_GROUP_SWAP_FAILED                                           = 666,
    ERR_INVITE_IN_COMBAT                                            = 667,
    ERR_INVALID_GLYPH_SLOT                                          = 668,
    ERR_GENERIC_NO_VALID_TARGETS                                    = 669,
    ERR_CALENDAR_EVENT_ALERT_S                                      = 670,
    ERR_PET_LEARN_SPELL_S                                           = 671,
    ERR_PET_LEARN_ABILITY_S                                         = 672,
    ERR_PET_SPELL_UNLEARNED_S                                       = 673,
    ERR_INVITE_UNKNOWN_REALM                                        = 674,
    ERR_INVITE_NO_PARTY_SERVER                                      = 675,
    ERR_INVITE_PARTY_BUSY                                           = 676,
    ERR_PARTY_TARGET_AMBIGUOUS                                      = 677,
    ERR_PARTY_LFG_INVITE_RAID_LOCKED                                = 678,
    ERR_PARTY_LFG_BOOT_LIMIT                                        = 679,
    ERR_PARTY_LFG_BOOT_COOLDOWN_S                                   = 680,
    ERR_PARTY_LFG_BOOT_NOT_ELIGIBLE_S                               = 681,
    ERR_PARTY_LFG_BOOT_INPATIENT_TIMER_S                            = 682,
    ERR_PARTY_LFG_BOOT_IN_PROGRESS                                  = 683,
    ERR_PARTY_LFG_BOOT_TOO_FEW_PLAYERS                              = 684,
    ERR_PARTY_LFG_BOOT_VOTE_SUCCEEDED                               = 685,
    ERR_PARTY_LFG_BOOT_VOTE_FAILED                                  = 686,
    ERR_PARTY_LFG_BOOT_IN_COMBAT                                    = 687,
    ERR_PARTY_LFG_BOOT_DUNGEON_COMPLETE                             = 688,
    ERR_PARTY_LFG_BOOT_LOOT_ROLLS                                   = 689,
    ERR_PARTY_LFG_BOOT_VOTE_REGISTERED                              = 690,
    ERR_PARTY_PRIVATE_GROUP_ONLY                                    = 691,
    ERR_PARTY_LFG_TELEPORT_IN_COMBAT                                = 692,
    ERR_RAID_DISALLOWED_BY_LEVEL                                    = 693,
    ERR_RAID_DISALLOWED_BY_CROSS_REALM                              = 694,
    ERR_PARTY_ROLE_NOT_AVAILABLE                                    = 695,
    ERR_JOIN_LFG_OBJECT_FAILED                                      = 696,
    ERR_LFG_REMOVED_LEVELUP                                         = 697,
    ERR_LFG_REMOVED_XP_TOGGLE                                       = 698,
    ERR_LFG_REMOVED_FACTION_CHANGE                                  = 699,
    ERR_BATTLEGROUND_INFO_THROTTLED                                 = 700,
    ERR_BATTLEGROUND_ALREADY_IN                                     = 701,
    ERR_ARENA_TEAM_CHANGE_FAILED_QUEUED                             = 702,
    ERR_ARENA_TEAM_PERMISSIONS                                      = 703,
    ERR_NOT_WHILE_FALLING                                           = 704,
    ERR_NOT_WHILE_MOVING                                            = 705,
    ERR_NOT_WHILE_FATIGUED                                          = 706,
    ERR_MAX_SOCKETS                                                 = 707,
    ERR_MULTI_CAST_ACTION_TOTEM_S                                   = 708,
    ERR_BATTLEGROUND_JOIN_LEVELUP                                   = 709,
    ERR_REMOVE_FROM_PVP_QUEUE_XP_GAIN                               = 710,
    ERR_BATTLEGROUND_JOIN_XP_GAIN                                   = 711,
    ERR_BATTLEGROUND_JOIN_MERCENARY                                 = 712,
    ERR_BATTLEGROUND_JOIN_TOO_MANY_HEALERS                          = 713,
    ERR_BATTLEGROUND_JOIN_RATED_TOO_MANY_HEALERS                    = 714,
    ERR_BATTLEGROUND_JOIN_TOO_MANY_TANKS                            = 715,
    ERR_BATTLEGROUND_JOIN_TOO_MANY_DAMAGE                           = 716,
    ERR_RAID_DIFFICULTY_FAILED                                      = 717,
    ERR_RAID_DIFFICULTY_CHANGED_S                                   = 718,
    ERR_LEGACY_RAID_DIFFICULTY_CHANGED_S                            = 719,
    ERR_RAID_LOCKOUT_CHANGED_S                                      = 720,
    ERR_RAID_CONVERTED_TO_PARTY                                     = 721,
    ERR_PARTY_CONVERTED_TO_RAID                                     = 722,
    ERR_PLAYER_DIFFICULTY_CHANGED_S                                 = 723,
    ERR_GMRESPONSE_DB_ERROR                                         = 724,
    ERR_BATTLEGROUND_JOIN_RANGE_INDEX                               = 725,
    ERR_ARENA_JOIN_RANGE_INDEX                                      = 726,
    ERR_REMOVE_FROM_PVP_QUEUE_FACTION_CHANGE                        = 727,
    ERR_BATTLEGROUND_JOIN_FAILED                                    = 728,
    ERR_BATTLEGROUND_JOIN_NO_VALID_SPEC_FOR_ROLE                    = 729,
    ERR_BATTLEGROUND_JOIN_RESPEC                                    = 730,
    ERR_BATTLEGROUND_INVITATION_DECLINED                            = 731,
    ERR_BATTLEGROUND_JOIN_TIMED_OUT                                 = 732,
    ERR_BATTLEGROUND_DUPE_QUEUE                                     = 733,
    ERR_BATTLEGROUND_JOIN_MUST_COMPLETE_QUEST                       = 734,
    ERR_IN_BATTLEGROUND_RESPEC                                      = 735,
    ERR_MAIL_LIMITED_DURATION_ITEM                                  = 736,
    ERR_YELL_RESTRICTED_TRIAL                                       = 737,
    ERR_CHAT_RAID_RESTRICTED_TRIAL                                  = 738,
    ERR_LFG_ROLE_CHECK_FAILED                                       = 739,
    ERR_LFG_ROLE_CHECK_FAILED_TIMEOUT                               = 740,
    ERR_LFG_ROLE_CHECK_FAILED_NOT_VIABLE                            = 741,
    ERR_LFG_READY_CHECK_FAILED                                      = 742,
    ERR_LFG_READY_CHECK_FAILED_TIMEOUT                              = 743,
    ERR_LFG_GROUP_FULL                                              = 744,
    ERR_LFG_NO_LFG_OBJECT                                           = 745,
    ERR_LFG_NO_SLOTS_PLAYER                                         = 746,
    ERR_LFG_NO_SLOTS_PARTY                                          = 747,
    ERR_LFG_NO_SPEC                                                 = 748,
    ERR_LFG_MISMATCHED_SLOTS                                        = 749,
    ERR_LFG_MISMATCHED_SLOTS_LOCAL_XREALM                           = 750,
    ERR_LFG_PARTY_PLAYERS_FROM_DIFFERENT_REALMS                     = 751,
    ERR_LFG_MEMBERS_NOT_PRESENT                                     = 752,
    ERR_LFG_GET_INFO_TIMEOUT                                        = 753,
    ERR_LFG_INVALID_SLOT                                            = 754,
    ERR_LFG_DESERTER_PLAYER                                         = 755,
    ERR_LFG_DESERTER_PARTY                                          = 756,
    ERR_LFG_DEAD                                                    = 757,
    ERR_LFG_RANDOM_COOLDOWN_PLAYER                                  = 758,
    ERR_LFG_RANDOM_COOLDOWN_PARTY                                   = 759,
    ERR_LFG_TOO_MANY_MEMBERS                                        = 760,
    ERR_LFG_TOO_FEW_MEMBERS                                         = 761,
    ERR_LFG_PROPOSAL_FAILED                                         = 762,
    ERR_LFG_PROPOSAL_DECLINED_SELF                                  = 763,
    ERR_LFG_PROPOSAL_DECLINED_PARTY                                 = 764,
    ERR_LFG_NO_SLOTS_SELECTED                                       = 765,
    ERR_LFG_NO_ROLES_SELECTED                                       = 766,
    ERR_LFG_ROLE_CHECK_INITIATED                                    = 767,
    ERR_LFG_READY_CHECK_INITIATED                                   = 768,
    ERR_LFG_PLAYER_DECLINED_ROLE_CHECK                              = 769,
    ERR_LFG_PLAYER_DECLINED_READY_CHECK                             = 770,
    ERR_LFG_JOINED_QUEUE                                            = 771,
    ERR_LFG_JOINED_FLEX_QUEUE                                       = 772,
    ERR_LFG_JOINED_RF_QUEUE                                         = 773,
    ERR_LFG_JOINED_SCENARIO_QUEUE                                   = 774,
    ERR_LFG_JOINED_WORLD_PVP_QUEUE                                  = 775,
    ERR_LFG_JOINED_BATTLEFIELD_QUEUE                                = 776,
    ERR_LFG_JOINED_LIST                                             = 777,
    ERR_LFG_LEFT_QUEUE                                              = 778,
    ERR_LFG_LEFT_LIST                                               = 779,
    ERR_LFG_ROLE_CHECK_ABORTED                                      = 780,
    ERR_LFG_READY_CHECK_ABORTED                                     = 781,
    ERR_LFG_CANT_USE_BATTLEGROUND                                   = 782,
    ERR_LFG_CANT_USE_DUNGEONS                                       = 783,
    ERR_LFG_REASON_TOO_MANY_LFG                                     = 784,
    ERR_INVALID_TELEPORT_LOCATION                                   = 785,
    ERR_TOO_FAR_TO_INTERACT                                         = 786,
    ERR_BATTLEGROUND_PLAYERS_FROM_DIFFERENT_REALMS                  = 787,
    ERR_DIFFICULTY_CHANGE_COOLDOWN_S                                = 788,
    ERR_DIFFICULTY_CHANGE_COMBAT_COOLDOWN_S                         = 789,
    ERR_DIFFICULTY_CHANGE_WORLDSTATE                                = 790,
    ERR_DIFFICULTY_CHANGE_ENCOUNTER                                 = 791,
    ERR_DIFFICULTY_CHANGE_COMBAT                                    = 792,
    ERR_DIFFICULTY_CHANGE_PLAYER_BUSY                               = 793,
    ERR_DIFFICULTY_CHANGE_ALREADY_STARTED                           = 794,
    ERR_DIFFICULTY_CHANGE_OTHER_HEROIC_S                            = 795,
    ERR_DIFFICULTY_CHANGE_HEROIC_INSTANCE_ALREADY_RUNNING           = 796,
    ERR_ARENA_TEAM_PARTY_SIZE                                       = 797,
    ERR_QUEST_FORCE_REMOVED_S                                       = 798,
    ERR_ATTACK_NO_ACTIONS                                           = 799,
    ERR_IN_RANDOM_BG                                                = 800,
    ERR_IN_NON_RANDOM_BG                                            = 801,
    ERR_AUCTION_ENOUGH_ITEMS                                        = 802,
    ERR_BN_FRIEND_SELF                                              = 803,
    ERR_BN_FRIEND_ALREADY                                           = 804,
    ERR_BN_FRIEND_BLOCKED                                           = 805,
    ERR_BN_FRIEND_LIST_FULL                                         = 806,
    ERR_BN_FRIEND_REQUEST_SENT                                      = 807,
    ERR_BN_BROADCAST_THROTTLE                                       = 808,
    ERR_BG_DEVELOPER_ONLY                                           = 809,
    ERR_CURRENCY_SPELL_SLOT_MISMATCH                                = 810,
    ERR_CURRENCY_NOT_TRADABLE                                       = 811,
    ERR_REQUIRES_EXPANSION_S                                        = 812,
    ERR_QUEST_FAILED_SPELL                                          = 813,
    ERR_TALENT_FAILED_NOT_ENOUGH_TALENTS_IN_PRIMARY_TREE            = 814,
    ERR_TALENT_FAILED_NO_PRIMARY_TREE_SELECTED                      = 815,
    ERR_TALENT_FAILED_CANT_REMOVE_TALENT                            = 816,
    ERR_TALENT_FAILED_UNKNOWN                                       = 817,
    ERR_WARGAME_REQUEST_FAILURE                                     = 818,
    ERR_RANK_REQUIRES_AUTHENTICATOR                                 = 819,
    ERR_GUILD_BANK_VOUCHER_FAILED                                   = 820,
    ERR_WARGAME_REQUEST_SENT                                        = 821,
    ERR_REQUIRES_ACHIEVEMENT_I                                      = 822,
    ERR_REFUND_RESULT_EXCEED_MAX_CURRENCY                           = 823,
    ERR_CANT_BUY_QUANTITY                                           = 824,
    ERR_ITEM_IS_BATTLE_PAY_LOCKED                                   = 825,
    ERR_PARTY_ALREADY_IN_BATTLEGROUND_QUEUE                         = 826,
    ERR_PARTY_CONFIRMING_BATTLEGROUND_QUEUE                         = 827,
    ERR_BATTLEFIELD_TEAM_PARTY_SIZE                                 = 828,
    ERR_INSUFF_TRACKED_CURRENCY_IS                                  = 829,
    ERR_NOT_ON_TOURNAMENT_REALM                                     = 830,
    ERR_GUILD_TRIAL_ACCOUNT_TRIAL                                   = 831,
    ERR_GUILD_TRIAL_ACCOUNT_VETERAN                                 = 832,
    ERR_GUILD_UNDELETABLE_DUE_TO_LEVEL                              = 833,
    ERR_CANT_DO_THAT_IN_A_GROUP                                     = 834,
    ERR_GUILD_LEADER_REPLACED                                       = 835,
    ERR_TRANSMOGRIFY_CANT_EQUIP                                     = 836,
    ERR_TRANSMOGRIFY_INVALID_ITEM_TYPE                              = 837,
    ERR_TRANSMOGRIFY_NOT_SOULBOUND                                  = 838,
    ERR_TRANSMOGRIFY_INVALID_SOURCE                                 = 839,
    ERR_TRANSMOGRIFY_INVALID_DESTINATION                            = 840,
    ERR_TRANSMOGRIFY_MISMATCH                                       = 841,
    ERR_TRANSMOGRIFY_LEGENDARY                                      = 842,
    ERR_TRANSMOGRIFY_SAME_ITEM                                      = 843,
    ERR_TRANSMOGRIFY_SAME_APPEARANCE                                = 844,
    ERR_TRANSMOGRIFY_NOT_EQUIPPED                                   = 845,
    ERR_VOID_DEPOSIT_FULL                                           = 846,
    ERR_VOID_WITHDRAW_FULL                                          = 847,
    ERR_VOID_STORAGE_WRAPPED                                        = 848,
    ERR_VOID_STORAGE_STACKABLE                                      = 849,
    ERR_VOID_STORAGE_UNBOUND                                        = 850,
    ERR_VOID_STORAGE_REPAIR                                         = 851,
    ERR_VOID_STORAGE_CHARGES                                        = 852,
    ERR_VOID_STORAGE_QUEST                                          = 853,
    ERR_VOID_STORAGE_CONJURED                                       = 854,
    ERR_VOID_STORAGE_MAIL                                           = 855,
    ERR_VOID_STORAGE_BAG                                            = 856,
    ERR_VOID_TRANSFER_STORAGE_FULL                                  = 857,
    ERR_VOID_TRANSFER_INV_FULL                                      = 858,
    ERR_VOID_TRANSFER_INTERNAL_ERROR                                = 859,
    ERR_VOID_TRANSFER_ITEM_INVALID                                  = 860,
    ERR_DIFFICULTY_DISABLED_IN_LFG                                  = 861,
    ERR_VOID_STORAGE_UNIQUE                                         = 862,
    ERR_VOID_STORAGE_LOOT                                           = 863,
    ERR_VOID_STORAGE_HOLIDAY                                        = 864,
    ERR_VOID_STORAGE_DURATION                                       = 865,
    ERR_VOID_STORAGE_LOAD_FAILED                                    = 866,
    ERR_VOID_STORAGE_INVALID_ITEM                                   = 867,
    ERR_PARENTAL_CONTROLS_CHAT_MUTED                                = 868,
    ERR_SOR_START_EXPERIENCE_INCOMPLETE                             = 869,
    ERR_SOR_INVALID_EMAIL                                           = 870,
    ERR_SOR_INVALID_COMMENT                                         = 871,
    ERR_CHALLENGE_MODE_RESET_COOLDOWN_S                             = 872,
    ERR_CHALLENGE_MODE_RESET_KEYSTONE                               = 873,
    ERR_PET_JOURNAL_ALREADY_IN_LOADOUT                              = 874,
    ERR_REPORT_SUBMITTED_SUCCESSFULLY                               = 875,
    ERR_REPORT_SUBMISSION_FAILED                                    = 876,
    ERR_SUGGESTION_SUBMITTED_SUCCESSFULLY                           = 877,
    ERR_BUG_SUBMITTED_SUCCESSFULLY                                  = 878,
    ERR_CHALLENGE_MODE_ENABLED                                      = 879,
    ERR_CHALLENGE_MODE_DISABLED                                     = 880,
    ERR_PETBATTLE_CREATE_FAILED                                     = 881,
    ERR_PETBATTLE_NOT_HERE                                          = 882,
    ERR_PETBATTLE_NOT_HERE_ON_TRANSPORT                             = 883,
    ERR_PETBATTLE_NOT_HERE_UNEVEN_GROUND                            = 884,
    ERR_PETBATTLE_NOT_HERE_OBSTRUCTED                               = 885,
    ERR_PETBATTLE_NOT_WHILE_IN_COMBAT                               = 886,
    ERR_PETBATTLE_NOT_WHILE_DEAD                                    = 887,
    ERR_PETBATTLE_NOT_WHILE_FLYING                                  = 888,
    ERR_PETBATTLE_TARGET_INVALID                                    = 889,
    ERR_PETBATTLE_TARGET_OUT_OF_RANGE                               = 890,
    ERR_PETBATTLE_TARGET_NOT_CAPTURABLE                             = 891,
    ERR_PETBATTLE_NOT_A_TRAINER                                     = 892,
    ERR_PETBATTLE_DECLINED                                          = 893,
    ERR_PETBATTLE_IN_BATTLE                                         = 894,
    ERR_PETBATTLE_INVALID_LOADOUT                                   = 895,
    ERR_PETBATTLE_ALL_PETS_DEAD                                     = 896,
    ERR_PETBATTLE_NO_PETS_IN_SLOTS                                  = 897,
    ERR_PETBATTLE_NO_ACCOUNT_LOCK                                   = 898,
    ERR_PETBATTLE_WILD_PET_TAPPED                                   = 899,
    ERR_PETBATTLE_RESTRICTED_ACCOUNT                                = 900,
    ERR_PETBATTLE_OPPONENT_NOT_AVAILABLE                            = 901,
    ERR_PETBATTLE_NOT_WHILE_IN_MATCHED_BATTLE                       = 902,
    ERR_CANT_HAVE_MORE_PETS_OF_THAT_TYPE                            = 903,
    ERR_CANT_HAVE_MORE_PETS                                         = 904,
    ERR_PVP_MAP_NOT_FOUND                                           = 905,
    ERR_PVP_MAP_NOT_SET                                             = 906,
    ERR_PETBATTLE_QUEUE_QUEUED                                      = 907,
    ERR_PETBATTLE_QUEUE_ALREADY_QUEUED                              = 908,
    ERR_PETBATTLE_QUEUE_JOIN_FAILED                                 = 909,
    ERR_PETBATTLE_QUEUE_JOURNAL_LOCK                                = 910,
    ERR_PETBATTLE_QUEUE_REMOVED                                     = 911,
    ERR_PETBATTLE_QUEUE_PROPOSAL_DECLINED                           = 912,
    ERR_PETBATTLE_QUEUE_PROPOSAL_TIMEOUT                            = 913,
    ERR_PETBATTLE_QUEUE_OPPONENT_DECLINED                           = 914,
    ERR_PETBATTLE_QUEUE_REQUEUED_INTERNAL                           = 915,
    ERR_PETBATTLE_QUEUE_REQUEUED_REMOVED                            = 916,
    ERR_PETBATTLE_QUEUE_SLOT_LOCKED                                 = 917,
    ERR_PETBATTLE_QUEUE_SLOT_EMPTY                                  = 918,
    ERR_PETBATTLE_QUEUE_SLOT_NO_TRACKER                             = 919,
    ERR_PETBATTLE_QUEUE_SLOT_NO_SPECIES                             = 920,
    ERR_PETBATTLE_QUEUE_SLOT_CANT_BATTLE                            = 921,
    ERR_PETBATTLE_QUEUE_SLOT_REVOKED                                = 922,
    ERR_PETBATTLE_QUEUE_SLOT_DEAD                                   = 923,
    ERR_PETBATTLE_QUEUE_SLOT_NO_PET                                 = 924,
    ERR_PETBATTLE_QUEUE_NOT_WHILE_NEUTRAL                           = 925,
    ERR_PETBATTLE_GAME_TIME_LIMIT_WARNING                           = 926,
    ERR_PETBATTLE_GAME_ROUNDS_LIMIT_WARNING                         = 927,
    ERR_HAS_RESTRICTION                                             = 928,
    ERR_ITEM_UPGRADE_ITEM_TOO_LOW_LEVEL                             = 929,
    ERR_ITEM_UPGRADE_NO_PATH                                        = 930,
    ERR_ITEM_UPGRADE_NO_MORE_UPGRADES                               = 931,
    ERR_BONUS_ROLL_EMPTY                                            = 932,
    ERR_CHALLENGE_MODE_FULL                                         = 933,
    ERR_CHALLENGE_MODE_IN_PROGRESS                                  = 934,
    ERR_CHALLENGE_MODE_INCORRECT_KEYSTONE                           = 935,
    ERR_BATTLETAG_FRIEND_NOT_FOUND                                  = 936,
    ERR_BATTLETAG_FRIEND_NOT_VALID                                  = 937,
    ERR_BATTLETAG_FRIEND_NOT_ALLOWED                                = 938,
    ERR_BATTLETAG_FRIEND_THROTTLED                                  = 939,
    ERR_BATTLETAG_FRIEND_SUCCESS                                    = 940,
    ERR_PET_TOO_HIGH_LEVEL_TO_UNCAGE                                = 941,
    ERR_PETBATTLE_INTERNAL                                          = 942,
    ERR_CANT_CAGE_PET_YET                                           = 943,
    ERR_NO_LOOT_IN_CHALLENGE_MODE                                   = 944,
    ERR_QUEST_PET_BATTLE_VICTORIES_PVP_II                           = 945,
    ERR_ROLE_CHECK_ALREADY_IN_PROGRESS                              = 946,
    ERR_RECRUIT_A_FRIEND_ACCOUNT_LIMIT                              = 947,
    ERR_RECRUIT_A_FRIEND_FAILED                                     = 948,
    ERR_SET_LOOT_PERSONAL                                           = 949,
    ERR_SET_LOOT_METHOD_FAILED_COMBAT                               = 950,
    ERR_REAGENT_BANK_FULL                                           = 951,
    ERR_REAGENT_BANK_LOCKED                                         = 952,
    ERR_GARRISON_BUILDING_EXISTS                                    = 953,
    ERR_GARRISON_INVALID_PLOT                                       = 954,
    ERR_GARRISON_INVALID_BUILDINGID                                 = 955,
    ERR_GARRISON_INVALID_PLOT_BUILDING                              = 956,
    ERR_GARRISON_REQUIRES_BLUEPRINT                                 = 957,
    ERR_GARRISON_NOT_ENOUGH_CURRENCY                                = 958,
    ERR_GARRISON_NOT_ENOUGH_GOLD                                    = 959,
    ERR_GARRISON_COMPLETE_MISSION_WRONG_FOLLOWER_TYPE               = 960,
    ERR_ALREADY_USING_LFG_LIST                                      = 961,
    ERR_RESTRICTED_ACCOUNT_LFG_LIST_TRIAL                           = 962,
    ERR_TOY_USE_LIMIT_REACHED                                       = 963,
    ERR_TOY_ALREADY_KNOWN                                           = 964,
    ERR_TRANSMOG_SET_ALREADY_KNOWN                                  = 965,
    ERR_NOT_ENOUGH_CURRENCY                                         = 966,
    ERR_SPEC_IS_DISABLED                                            = 967,
    ERR_FEATURE_RESTRICTED_TRIAL                                    = 968,
    ERR_CANT_BE_OBLITERATED                                         = 969,
    ERR_CANT_BE_SCRAPPED                                            = 970,
    ERR_ARTIFACT_RELIC_DOES_NOT_MATCH_ARTIFACT                      = 971,
    ERR_MUST_EQUIP_ARTIFACT                                         = 972,
    ERR_CANT_DO_THAT_RIGHT_NOW                                      = 973,
    ERR_AFFECTING_COMBAT                                            = 974,
    ERR_EQUIPMENT_MANAGER_COMBAT_SWAP_S                             = 975,
    ERR_EQUIPMENT_MANAGER_BAGS_FULL                                 = 976,
    ERR_EQUIPMENT_MANAGER_MISSING_ITEM_S                            = 977,
    ERR_MOVIE_RECORDING_WARNING_PERF                                = 978,
    ERR_MOVIE_RECORDING_WARNING_DISK_FULL                           = 979,
    ERR_MOVIE_RECORDING_WARNING_NO_MOVIE                            = 980,
    ERR_MOVIE_RECORDING_WARNING_REQUIREMENTS                        = 981,
    ERR_MOVIE_RECORDING_WARNING_COMPRESSING                         = 982,
    ERR_NO_CHALLENGE_MODE_REWARD                                    = 983,
    ERR_CLAIMED_CHALLENGE_MODE_REWARD                               = 984,
    ERR_CHALLENGE_MODE_PERIOD_RESET_SS                              = 985,
    ERR_CANT_DO_THAT_CHALLENGE_MODE_ACTIVE                          = 986,
    ERR_TALENT_FAILED_REST_AREA                                     = 987,
    ERR_CANNOT_ABANDON_LAST_PET                                     = 988,
    ERR_TEST_CVAR_SET_SSS                                           = 989,
    ERR_QUEST_TURN_IN_FAIL_REASON                                   = 990,
    ERR_CLAIMED_CHALLENGE_MODE_REWARD_OLD                           = 991,
    ERR_TALENT_GRANTED_BY_AURA                                      = 992,
    ERR_CHALLENGE_MODE_ALREADY_COMPLETE                             = 993,
    ERR_GLYPH_TARGET_NOT_AVAILABLE                                  = 994,
    ERR_PVP_WARMODE_TOGGLE_ON                                       = 995,
    ERR_PVP_WARMODE_TOGGLE_OFF                                      = 996,
    ERR_SPELL_FAILED_LEVEL_REQUIREMENT                              = 997,
    ERR_BATTLEGROUND_JOIN_REQUIRES_LEVEL                            = 998,
    ERR_BATTLEGROUND_JOIN_DISQUALIFIED                              = 999,
    ERR_BATTLEGROUND_JOIN_DISQUALIFIED_NO_NAME                      = 1000,
    ERR_VOICE_CHAT_GENERIC_UNABLE_TO_CONNECT                        = 1001,
    ERR_VOICE_CHAT_SERVICE_LOST                                     = 1002,
    ERR_VOICE_CHAT_CHANNEL_NAME_TOO_SHORT                           = 1003,
    ERR_VOICE_CHAT_CHANNEL_NAME_TOO_LONG                            = 1004,
    ERR_VOICE_CHAT_CHANNEL_ALREADY_EXISTS                           = 1005,
    ERR_VOICE_CHAT_TARGET_NOT_FOUND                                 = 1006,
    ERR_VOICE_CHAT_TOO_MANY_REQUESTS                                = 1007,
    ERR_VOICE_CHAT_PLAYER_SILENCED                                  = 1008,
    ERR_VOICE_CHAT_PARENTAL_DISABLE_ALL                             = 1009,
    ERR_VOICE_CHAT_DISABLED                                         = 1010,
    ERR_NO_PVP_REWARD                                               = 1011,
    ERR_CLAIMED_PVP_REWARD                                          = 1012,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_ESSENCE_NOT_UNLOCKED       = 1013,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_CANT_REMOVE_ESSENCE        = 1014,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_CONDITION_FAILED           = 1015,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_REST_AREA                  = 1016,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_SLOT_LOCKED                = 1017,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_NOT_AT_FORGE               = 1018,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_HEART_LEVEL_TOO_LOW        = 1019,
    ERR_AZERITE_ESSENCE_SELECTION_FAILED_NOT_EQUIPPED               = 1020,
    ERR_SOCKETING_REQUIRES_PUNCHCARDRED_GEM                         = 1021,
    ERR_SOCKETING_PUNCHCARDRED_GEM_ONLY_IN_PUNCHCARDREDSLOT         = 1022,
    ERR_SOCKETING_REQUIRES_PUNCHCARDYELLOW_GEM                      = 1023,
    ERR_SOCKETING_PUNCHCARDYELLOW_GEM_ONLY_IN_PUNCHCARDYELLOWSLOT   = 1024,
    ERR_SOCKETING_REQUIRES_PUNCHCARDBLUE_GEM                        = 1025,
    ERR_SOCKETING_PUNCHCARDBLUE_GEM_ONLY_IN_PUNCHCARDBLUESLOT       = 1026,
    ERR_LEVEL_LINKING_RESULT_LINKED                                 = 1027,
    ERR_LEVEL_LINKING_RESULT_UNLINKED                               = 1028,
    ERR_CLUB_FINDER_ERROR_POST_CLUB                                 = 1029,
    ERR_CLUB_FINDER_ERROR_APPLY_CLUB                                = 1030,
    ERR_CLUB_FINDER_ERROR_RESPOND_APPLICANT                         = 1031,
    ERR_CLUB_FINDER_ERROR_CANCEL_APPLICATION                        = 1032,
    ERR_CLUB_FINDER_ERROR_TYPE_ACCEPT_APPLICATION                   = 1033,
    ERR_CLUB_FINDER_ERROR_TYPE_NO_INVITE_PERMISSIONS                = 1034,
    ERR_CLUB_FINDER_ERROR_TYPE_NO_POSTING_PERMISSIONS               = 1035,
    ERR_CLUB_FINDER_ERROR_TYPE_APPLICANT_LIST                       = 1036,
    ERR_CLUB_FINDER_ERROR_TYPE_APPLICANT_LIST_NO_PERM               = 1037,
    ERR_CLUB_FINDER_ERROR_TYPE_FINDER_NOT_AVAILABLE                 = 1038,
    ERR_CLUB_FINDER_ERROR_TYPE_GET_POSTING_IDS                      = 1039,
    ERR_CLUB_FINDER_ERROR_TYPE_JOIN_APPLICATION                     = 1040,
