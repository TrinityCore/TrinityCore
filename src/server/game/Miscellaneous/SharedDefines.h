...
enum class GameError : uint32
{
    ...
    ERR_REVOKE_TRANSMOG_S                                   = 69,
    ERR_INVITE_PLAYER_S                                     = 70,
    ERR_INVITE_SELF                                         = 71,
    ERR_INVITED_TO_GROUP_SS                                 = 72,
    ERR_INVITED_ALREADY_IN_GROUP_SS                         = 73,
    ERR_ALREADY_IN_GROUP_S                                  = 74,
    ERR_CROSS_REALM_RAID_INVITE                             = 75,
    ERR_PLAYER_BUSY_S                                       = 76,
    ERR_NEW_LEADER_S                                        = 77,
    ERR_NEW_LEADER_YOU                                      = 78,
    ERR_NEW_GUIDE_S                                         = 79,
    ERR_NEW_GUIDE_YOU                                       = 80,
    ERR_LEFT_GROUP_S                                        = 81,
    ERR_LEFT_GROUP_YOU                                      = 82,
    ERR_GROUP_DISBANDED                                     = 83,
    ERR_DECLINE_GROUP_S                                     = 84,
    ERR_JOINED_GROUP_S                                      = 85,
    ERR_UNINVITE_YOU                                        = 86,
    ERR_BAD_PLAYER_NAME_S                                   = 87,
    ERR_NOT_IN_GROUP                                        = 88,
    ERR_TARGET_NOT_IN_GROUP_S                               = 89,
    ERR_TARGET_NOT_IN_INSTANCE_S                            = 90,
    ERR_NOT_IN_INSTANCE_GROUP                               = 91,
    ERR_GROUP_FULL                                          = 92,
    ERR_NOT_LEADER                                          = 93,
    ERR_PLAYER_DIED_S                                       = 94,
    ERR_GUILD_CREATE_S                                      = 95,
    ERR_GUILD_INVITE_S                                      = 96,
    ERR_INVITED_TO_GUILD_SSS                                = 97,
    ERR_ALREADY_IN_GUILD_S                                  = 98,
    ERR_ALREADY_INVITED_TO_GUILD_S                          = 99,
    ERR_INVITED_TO_GUILD                                    = 100,
    ERR_ALREADY_IN_GUILD                                    = 101,
    ERR_GUILD_ACCEPT                                        = 102,
    ERR_GUILD_DECLINE_S                                     = 103,
    ERR_GUILD_DECLINE_AUTO_S                                = 104,
    ERR_GUILD_PERMISSIONS                                   = 105,
    ERR_GUILD_JOIN_S                                        = 106,
    ERR_GUILD_FOUNDER_S                                     = 107,
    ERR_GUILD_PROMOTE_SSS                                   = 108,
    ERR_GUILD_DEMOTE_SS                                     = 109,
    ERR_GUILD_DEMOTE_SSS                                    = 110,
    ERR_GUILD_INVITE_SELF                                   = 111,
    ERR_GUILD_QUIT_S                                        = 112,
    ERR_GUILD_LEAVE_S                                       = 113,
    ERR_GUILD_REMOVE_SS                                     = 114,
    ERR_GUILD_REMOVE_SELF                                   = 115,
    ERR_GUILD_DISBAND_S                                     = 116,
    ERR_GUILD_DISBAND_SELF                                  = 117,
    ERR_GUILD_LEADER_S                                      = 118,
    ERR_GUILD_LEADER_SELF                                   = 119,
    ERR_GUILD_PLAYER_NOT_FOUND_S                            = 120,
    ERR_GUILD_PLAYER_NOT_IN_GUILD_S                         = 121,
    ERR_GUILD_PLAYER_NOT_IN_GUILD                           = 122,
    ERR_GUILD_CANT_PROMOTE_S                                = 123,
    ERR_GUILD_CANT_DEMOTE_S                                 = 124,
    ERR_GUILD_NOT_IN_A_GUILD                                = 125,
    ERR_GUILD_INTERNAL                                      = 126,
    ERR_GUILD_LEADER_IS_S                                   = 127,
    ERR_GUILD_LEADER_CHANGED_SS                             = 128,
    ERR_GUILD_DISBANDED                                     = 129,
    ERR_GUILD_NOT_ALLIED                                    = 130,
    ERR_GUILD_LEADER_LEAVE                                  = 131,
    ERR_GUILD_RANKS_LOCKED                                  = 132,
    ERR_GUILD_RANK_IN_USE                                   = 133,
    ERR_GUILD_RANK_TOO_HIGH_S                               = 134,
    ERR_GUILD_RANK_TOO_LOW_S                                = 135,
    ERR_GUILD_NAME_EXISTS_S                                 = 136,
    ERR_GUILD_WITHDRAW_LIMIT                                = 137,
    ERR_GUILD_NOT_ENOUGH_MONEY                              = 138,
    ERR_GUILD_TOO_MUCH_MONEY                                = 139,
    ERR_GUILD_BANK_CONJURED_ITEM                            = 140,
    ERR_GUILD_BANK_EQUIPPED_ITEM                            = 141,
    ERR_GUILD_BANK_BOUND_ITEM                               = 142,
    ERR_GUILD_BANK_QUEST_ITEM                               = 143,
    ERR_GUILD_BANK_WRAPPED_ITEM                             = 144,
    ERR_GUILD_BANK_FULL                                     = 145,
    ERR_GUILD_BANK_WRONG_TAB                                = 146,
    ERR_NO_GUILD_CHARTER                                    = 147,
    ERR_OUT_OF_RANGE                                        = 148,
    ERR_PLAYER_DEAD                                         = 149,
    ERR_CLIENT_LOCKED_OUT                                   = 150,
    ERR_KILLED_BY_S                                         = 151,
    ERR_LOOT_LOCKED                                         = 152,
    ERR_LOOT_TOO_FAR                                        = 153,
    ERR_LOOT_DIDNT_KILL                                     = 154,
    ERR_LOOT_BAD_FACING                                     = 155,
    ERR_LOOT_NOTSTANDING                                    = 156,
    ERR_LOOT_STUNNED                                        = 157,
    ERR_LOOT_NO_UI                                          = 158,
    ERR_LOOT_WHILE_INVULNERABLE                             = 159,
    ERR_NO_LOOT                                             = 160,
    ERR_QUEST_ACCEPTED_S                                    = 161,
    ERR_QUEST_COMPLETE_S                                    = 162,
    ERR_QUEST_FAILED_S                                      = 163,
    ERR_QUEST_FAILED_BAG_FULL_S                             = 164,
    ERR_QUEST_FAILED_MAX_COUNT_S                            = 165,
    ERR_QUEST_FAILED_LOW_LEVEL                              = 166,
    ERR_QUEST_FAILED_MISSING_ITEMS                          = 167,
    ERR_QUEST_FAILED_WRONG_RACE                             = 168,
    ERR_QUEST_FAILED_NOT_ENOUGH_MONEY                       = 169,
    ERR_QUEST_FAILED_EXPANSION                              = 170,
    ERR_QUEST_ONLY_ONE_TIMED                                = 171,
    ERR_QUEST_NEED_PREREQS                                  = 172,
    ERR_QUEST_NEED_PREREQS_CUSTOM                           = 173,
    ERR_QUEST_ALREADY_ON                                    = 174,
    ERR_QUEST_ALREADY_DONE                                  = 175,
    ERR_QUEST_ALREADY_DONE_DAILY                            = 176,
    ERR_QUEST_HAS_IN_PROGRESS                               = 177,
    ERR_QUEST_REWARD_EXP_I                                  = 178,
    ERR_QUEST_REWARD_MONEY_S                                = 179,
    ERR_QUEST_MUST_CHOOSE                                   = 180,
    ERR_QUEST_LOG_FULL                                      = 181,
    ERR_QUEST_IGNORED                                       = 182,
    ERR_QUEST_UNIGNORED                                     = 183,
    ...
    ERR_SPELL_FAILED_EQUIPPED_ITEM                          = 248,
    ERR_SPELL_FAILED_EQUIPPED_ITEM_CLASS_S                  = 249,
    ERR_SPELL_FAILED_SHAPESHIFT_FORM_S                      = 250,
    ERR_SPELL_FAILED_ANOTHER_IN_PROGRESS                    = 251,
    ERR_BADATTACKFACING                                     = 252,
    ERR_BADATTACKPOS                                        = 253,
    ERR_CHEST_IN_USE                                        = 254,
    ERR_USE_CANT_OPEN                                       = 255,
    ERR_USE_LOCKED                                          = 256,
    ERR_DOOR_LOCKED                                         = 257,
    ERR_BUTTON_LOCKED                                       = 258,
    ERR_USE_LOCKED_WITH_ITEM_S                              = 259,
    ERR_USE_LOCKED_WITH_SPELL_S                             = 260,
    ERR_USE_LOCKED_WITH_SPELL_KNOWN_SI                      = 261,
    ERR_USE_TOO_FAR                                         = 262,
    ERR_USE_BAD_ANGLE                                       = 263,
    ERR_USE_OBJECT_MOVING                                   = 264,
    ERR_USE_SPELL_FOCUS                                     = 265,
    ERR_USE_DESTROYED                                       = 266,
    ERR_SET_LOOT_FREEFORALL                                 = 267,
    ERR_SET_LOOT_ROUNDROBIN                                 = 268,
    ERR_SET_LOOT_MASTER                                     = 269,
    ERR_SET_LOOT_GROUP                                      = 270,
    ERR_SET_LOOT_THRESHOLD_S                                = 271,
    ERR_NEW_LOOT_MASTER_S                                   = 272,
    ERR_SPECIFY_MASTER_LOOTER                               = 273,
    ERR_LOOT_SPEC_CHANGED_S                                 = 274,
    ERR_TAME_FAILED                                         = 275,
    ERR_CHAT_WHILE_DEAD                                     = 276,
    ERR_CHAT_PLAYER_NOT_FOUND_S                             = 277,
    ERR_NEWTAXIPATH                                         = 278,
    ERR_NO_PET                                              = 279,
    ERR_NOTYOURPET                                          = 280,
    ERR_PET_NOT_RENAMEABLE                                  = 281,
    ERR_QUEST_OBJECTIVE_COMPLETE_S                          = 282,
    ERR_QUEST_UNKNOWN_COMPLETE                              = 283,
    ERR_QUEST_ADD_KILL_SII                                  = 284,
    ERR_QUEST_ADD_FOUND_SII                                 = 285,
    ERR_QUEST_ADD_ITEM_SII                                  = 286,
    ERR_QUEST_ADD_PLAYER_KILL_SII                           = 287,
    ERR_CANNOTCREATEDIRECTORY                               = 288,
    ERR_CANNOTCREATEFILE                                    = 289,
    ERR_PLAYER_WRONG_FACTION                                = 290,
    ERR_PLAYER_IS_NEUTRAL                                   = 291,
    ERR_BANKSLOT_FAILED_TOO_MANY                            = 292,
    ERR_BANKSLOT_INSUFFICIENT_FUNDS                         = 293,
    ERR_BANKSLOT_NOTBANKER                                  = 294,
    ERR_FRIEND_DB_ERROR                                     = 295,
    ERR_FRIEND_LIST_FULL                                    = 296,
    ERR_FRIEND_ADDED_S                                      = 297,
    ERR_BATTLETAG_FRIEND_ADDED_S                            = 298,
    ERR_FRIEND_ONLINE_SS                                    = 299,
    ERR_FRIEND_OFFLINE_S                                    = 300,
    ERR_FRIEND_NOT_FOUND                                    = 301,
    ERR_FRIEND_WRONG_FACTION                                = 302,
    ERR_FRIEND_REMOVED_S                                    = 303,
    ERR_BATTLETAG_FRIEND_REMOVED_S                          = 304,
    ERR_FRIEND_ERROR                                        = 305,
    ERR_FRIEND_ALREADY_S                                    = 306,
    ERR_FRIEND_SELF                                         = 307,
    ERR_FRIEND_DELETED                                      = 308,
    ERR_IGNORE_FULL                                         = 309,
    ERR_IGNORE_SELF                                         = 310,
    ERR_IGNORE_NOT_FOUND                                    = 311,
    ERR_IGNORE_ALREADY_S                                    = 312,
    ERR_IGNORE_ADDED_S                                      = 313,
    ERR_IGNORE_REMOVED_S                                    = 314,
    ERR_IGNORE_AMBIGUOUS                                    = 315,
    ERR_IGNORE_DELETED                                      = 316,
    ERR_ONLY_ONE_BOLT                                       = 317,
    ERR_ONLY_ONE_AMMO                                       = 318,
    ERR_SPELL_FAILED_EQUIPPED_SPECIFIC_ITEM                 = 319,
    ERR_WRONG_BAG_TYPE_SUBCLASS                             = 320,
    ERR_CANT_WRAP_STACKABLE                                 = 321,
    ERR_CANT_WRAP_EQUIPPED                                  = 322,
    ERR_CANT_WRAP_WRAPPED                                   = 323,
    ERR_CANT_WRAP_BOUND                                     = 324,
    ERR_CANT_WRAP_UNIQUE                                    = 325,
    ERR_CANT_WRAP_BAGS                                      = 326,
    ERR_OUT_OF_MANA                                         = 327,
    ERR_OUT_OF_RAGE                                         = 328,
    ERR_OUT_OF_FOCUS                                        = 329,
    ERR_OUT_OF_ENERGY                                       = 330,
    ERR_OUT_OF_CHI                                          = 331,
    ERR_OUT_OF_HEALTH                                       = 332,
    ERR_OUT_OF_RUNES                                        = 333,
    ERR_OUT_OF_RUNIC_POWER                                  = 334,
    ERR_OUT_OF_SOUL_SHARDS                                  = 335,
    ERR_OUT_OF_LUNAR_POWER                                  = 336,
    ERR_OUT_OF_HOLY_POWER                                   = 337,
    ERR_OUT_OF_MAELSTROM                                    = 338,
    ERR_OUT_OF_COMBO_POINTS                                 = 339,
    ERR_OUT_OF_INSANITY                                     = 340,
    ERR_OUT_OF_ARCANE_CHARGES                               = 341,
    ERR_OUT_OF_FURY                                         = 342,
    ERR_OUT_OF_PAIN                                         = 343,
    ERR_OUT_OF_POWER_DISPLAY                                = 344,
    ERR_LOOT_GONE                                           = 345,
    ERR_MOUNT_FORCEDDISMOUNT                                = 346,
    ERR_AUTOFOLLOW_TOO_FAR                                  = 347,
    ERR_UNIT_NOT_FOUND                                      = 348,
    ERR_INVALID_FOLLOW_TARGET                               = 349,
    ERR_INVALID_INSPECT_TARGET                              = 350,
    ERR_GUILDEMBLEM_SUCCESS                                 = 351,
    ERR_GUILDEMBLEM_INVALID_TABARD_COLORS                   = 352,
    ERR_GUILDEMBLEM_NOGUILD                                 = 353,
    ERR_GUILDEMBLEM_NOTGUILDMASTER                          = 354,
    ERR_GUILDEMBLEM_NOTENOUGHMONEY                          = 355,
    ERR_GUILDEMBLEM_INVALIDVENDOR                           = 356,
    ERR_EMBLEMERROR_NOTABARDGEOSET                          = 357,
    ERR_SPELL_OUT_OF_RANGE                                  = 358,
    ERR_COMMAND_NEEDS_TARGET                                = 359,
    ERR_NOAMMO_S                                            = 360,
    ERR_TOOBUSYTOFOLLOW                                     = 361,
    ERR_DUEL_REQUESTED                                      = 362,
    ERR_DUEL_CANCELLED                                      = 363,
    ERR_DEATHBINDALREADYBOUND                               = 364,
    ERR_DEATHBIND_SUCCESS_S                                 = 365,
    ERR_NOEMOTEWHILERUNNING                                 = 366,
    ERR_ZONE_EXPLORED                                       = 367,
    ERR_ZONE_EXPLORED_XP                                    = 368,
    ERR_INVALID_ITEM_TARGET                                 = 369,
    ERR_INVALID_QUEST_TARGET                                = 370,
    ERR_IGNORING_YOU_S                                      = 371,
    ERR_FISH_NOT_HOOKED                                     = 372,
    ERR_FISH_ESCAPED                                        = 373,
    ERR_SPELL_FAILED_NOTUNSHEATHED                          = 374,
    ERR_PETITION_OFFERED_S                                  = 375,
    ERR_PETITION_SIGNED                                     = 376,
    ERR_PETITION_SIGNED_S                                   = 377,
    ERR_PETITION_DECLINED_S                                 = 378,
    ERR_PETITION_ALREADY_SIGNED                             = 379,
    ERR_PETITION_RESTRICTED_ACCOUNT_TRIAL                   = 380,
    ERR_PETITION_ALREADY_SIGNED_OTHER                       = 381,
    ERR_PETITION_IN_GUILD                                   = 382,
    ERR_PETITION_CREATOR                                    = 383,
    ERR_PETITION_NOT_ENOUGH_SIGNATURES                      = 384,
    ERR_PETITION_NOT_SAME_SERVER                            = 385,
    ERR_PETITION_FULL                                       = 386,
    ERR_PETITION_ALREADY_SIGNED_BY_S                        = 387,
    ERR_GUILD_NAME_INVALID                                  = 388,
    ERR_SPELL_UNLEARNED_S                                   = 389,
    ERR_PET_SPELL_ROOTED                                    = 390,
    ERR_PET_SPELL_AFFECTING_COMBAT                          = 391,
    ERR_PET_SPELL_OUT_OF_RANGE                              = 392,
    ERR_PET_SPELL_NOT_BEHIND                                = 393,
    ERR_PET_SPELL_TARGETS_DEAD                              = 394,
    ERR_PET_SPELL_DEAD                                      = 395,
    ERR_PET_SPELL_NOPATH                                    = 396,
    ERR_ITEM_CANT_BE_DESTROYED                              = 397,
    ERR_TICKET_ALREADY_EXISTS                               = 398,
    ERR_TICKET_CREATE_ERROR                                 = 399,
    ERR_TICKET_UPDATE_ERROR                                 = 400,
    ERR_TICKET_DB_ERROR                                     = 401,
    ERR_TICKET_NO_TEXT                                      = 402,
    ERR_TICKET_TEXT_TOO_LONG                                = 403,
    ERR_OBJECT_IS_BUSY                                      = 404,
    ERR_EXHAUSTION_WELLRESTED                               = 405,
    ERR_EXHAUSTION_RESTED                                   = 406,
    ERR_EXHAUSTION_NORMAL                                   = 407,
    ERR_EXHAUSTION_TIRED                                    = 408,
    ERR_EXHAUSTION_EXHAUSTED                                = 409,
    ERR_NO_ITEMS_WHILE_SHAPESHIFTED                         = 410,
    ERR_CANT_INTERACT_SHAPESHIFTED                          = 411,
    ERR_REALM_NOT_FOUND                                     = 412,
    ERR_MAIL_QUEST_ITEM                                     = 413,
    ERR_MAIL_BOUND_ITEM                                     = 414,
    ERR_MAIL_CONJURED_ITEM                                  = 415,
    ERR_MAIL_BAG                                            = 416,
    ERR_MAIL_TO_SELF                                        = 417,
    ERR_MAIL_TARGET_NOT_FOUND                               = 418,
    ERR_MAIL_DATABASE_ERROR                                 = 419,
    ERR_MAIL_DELETE_ITEM_ERROR                              = 420,
    ERR_MAIL_WRAPPED_COD                                    = 421,
    ERR_MAIL_CANT_SEND_REALM                                = 422,
    ERR_MAIL_SENT                                           = 423,
    ERR_NOT_HAPPY_ENOUGH                                    = 424,
    ERR_USE_CANT_IMMUNE                                     = 425,
    ERR_CANT_BE_DISENCHANTED                                = 426,
    ERR_CANT_USE_DISARMED                                   = 427,
    ERR_AUCTION_QUEST_ITEM                                  = 428,
    ERR_AUCTION_BOUND_ITEM                                  = 429,
    ERR_AUCTION_CONJURED_ITEM                               = 430,
    ERR_AUCTION_LIMITED_DURATION_ITEM                       = 431,
    ERR_AUCTION_WRAPPED_ITEM                                = 432,
    ERR_AUCTION_LOOT_ITEM                                   = 433,
    ERR_AUCTION_BAG                                         = 434,
    ERR_AUCTION_EQUIPPED_BAG                                = 435,
    ERR_AUCTION_DATABASE_ERROR                              = 436,
    ERR_AUCTION_BID_OWN                                     = 437,
    ERR_AUCTION_BID_INCREMENT                               = 438,
    ERR_AUCTION_HIGHER_BID                                  = 439,
    ERR_AUCTION_MIN_BID                                     = 440,
    ERR_AUCTION_REPAIR_ITEM                                 = 441,
    ERR_AUCTION_USED_CHARGES                                = 442,
    ERR_AUCTION_ALREADY_BID                                 = 443,
    ERR_AUCTION_STARTED                                     = 444,
    ERR_AUCTION_REMOVED                                     = 445,
    ERR_AUCTION_OUTBID_S                                    = 446,
    ERR_AUCTION_WON_S                                       = 447,
    ERR_AUCTION_SOLD_S                                      = 448,
    ERR_AUCTION_EXPIRED_S                                   = 449,
    ERR_AUCTION_REMOVED_S                                   = 450,
    ERR_AUCTION_BID_PLACED                                  = 451,
    ERR_LOGOUT_FAILED                                       = 452,
    ERR_QUEST_PUSH_SUCCESS_S                                = 453,
    ERR_QUEST_PUSH_INVALID_S                                = 454,
    ERR_QUEST_PUSH_ACCEPTED_S                               = 455,
    ERR_QUEST_PUSH_DECLINED_S                               = 456,
    ERR_QUEST_PUSH_BUSY_S                                   = 457,
    ERR_QUEST_PUSH_DEAD_S                                   = 458,
    ERR_QUEST_PUSH_LOG_FULL_S                               = 459,
    ERR_QUEST_PUSH_ONQUEST_S                                = 460,
    ERR_QUEST_PUSH_ALREADY_DONE_S                           = 461,
    ERR_QUEST_PUSH_NOT_DAILY_S                              = 462,
    ERR_QUEST_PUSH_TIMER_EXPIRED_S                          = 463,
    ERR_QUEST_PUSH_NOT_IN_PARTY_S                           = 464,
    ERR_QUEST_PUSH_DIFFERENT_SERVER_DAILY_S                 = 465,
    ERR_QUEST_PUSH_NOT_ALLOWED_S                            = 466,
    ERR_RAID_GROUP_LOWLEVEL                                 = 467,
    ERR_RAID_GROUP_ONLY                                     = 468,
    ERR_RAID_GROUP_FULL                                     = 469,
    ERR_RAID_GROUP_REQUIREMENTS_UNMATCH                     = 470,
    ERR_CORPSE_IS_NOT_IN_INSTANCE                           = 471,
    ERR_PVP_KILL_HONORABLE                                  = 472,
    ERR_PVP_KILL_DISHONORABLE                               = 473,
    ERR_SPELL_FAILED_ALREADY_AT_FULL_HEALTH                 = 474,
    ERR_SPELL_FAILED_ALREADY_AT_FULL_MANA                   = 475,
    ERR_SPELL_FAILED_ALREADY_AT_FULL_POWER_S                = 476,
    ERR_AUTOLOOT_MONEY_S                                    = 477,
    ERR_GENERIC_STUNNED                                     = 478,
    ERR_TARGET_STUNNED                                      = 479,
    ERR_MUST_REPAIR_DURABILITY                              = 480,
    ERR_RAID_YOU_JOINED                                     = 481,
    ERR_RAID_YOU_LEFT                                       = 482,
    ERR_INSTANCE_GROUP_JOINED_WITH_PARTY                    = 483,
    ERR_INSTANCE_GROUP_JOINED_WITH_RAID                     = 484,
    ERR_RAID_MEMBER_ADDED_S                                 = 485,
    ERR_RAID_MEMBER_REMOVED_S                               = 486,
    ERR_INSTANCE_GROUP_ADDED_S                              = 487,
    ERR_INSTANCE_GROUP_REMOVED_S                            = 488,
    ERR_CLICK_ON_ITEM_TO_FEED                               = 489,
    ERR_TOO_MANY_CHAT_CHANNELS                              = 490,
    ERR_LOOT_ROLL_PENDING                                   = 491,
    ERR_LOOT_PLAYER_NOT_FOUND                               = 492,
    ERR_NOT_IN_RAID                                         = 493,
    ERR_LOGGING_OUT                                         = 494,
    ERR_TARGET_LOGGING_OUT                                  = 495,
    ERR_NOT_WHILE_MOUNTED                                   = 496,
    ERR_NOT_WHILE_SHAPESHIFTED                              = 497,
    ERR_NOT_IN_COMBAT                                       = 498,
    ERR_NOT_WHILE_DISARMED                                  = 499,
    ERR_PET_BROKEN                                          = 500,
    ERR_TALENT_WIPE_ERROR                                   = 501,
    ERR_SPEC_WIPE_ERROR                                     = 502,
    ERR_GLYPH_WIPE_ERROR                                    = 503,
    ERR_PET_SPEC_WIPE_ERROR                                 = 504,
    ERR_FEIGN_DEATH_RESISTED                                = 505,
    ERR_MEETING_STONE_IN_QUEUE_S                            = 506,
    ERR_MEETING_STONE_LEFT_QUEUE_S                          = 507,
    ERR_MEETING_STONE_OTHER_MEMBER_LEFT                     = 508,
    ERR_MEETING_STONE_PARTY_KICKED_FROM_QUEUE               = 509,
    ERR_MEETING_STONE_MEMBER_STILL_IN_QUEUE                 = 510,
    ERR_MEETING_STONE_SUCCESS                               = 511,
    ERR_MEETING_STONE_IN_PROGRESS                           = 512,
    ERR_MEETING_STONE_MEMBER_ADDED_S                        = 513,
    ERR_MEETING_STONE_GROUP_FULL                            = 514,
    ERR_MEETING_STONE_NOT_LEADER                            = 515,
    ERR_MEETING_STONE_INVALID_LEVEL                         = 516,
    ERR_MEETING_STONE_TARGET_NOT_IN_PARTY                   = 517,
    ERR_MEETING_STONE_TARGET_INVALID_LEVEL                  = 518,
    ERR_MEETING_STONE_MUST_BE_LEADER                        = 519,
    ERR_MEETING_STONE_NO_RAID_GROUP                         = 520,
    ERR_MEETING_STONE_NEED_PARTY                            = 521,
    ERR_MEETING_STONE_NOT_FOUND                             = 522,
    ERR_GUILDEMBLEM_SAME                                    = 523,
    ERR_EQUIP_TRADE_ITEM                                    = 524,
    ...
    ERR_DANCE_CREATE_DUPLICATE                              = 608,
    ERR_DANCE_SAVE_FAILED                                   = 609,
    ERR_DANCE_DELETE_FAILED                                 = 610,
    ERR_MAIL_INVALID_ATTACHMENT_SLOT                        = 611,
    ERR_MAIL_TOO_MANY_ATTACHMENTS                           = 612,
    ERR_MAIL_INVALID_ATTACHMENT                             = 613,
    ERR_MAIL_ATTACHMENT_EXPIRED                             = 614,
    ERR_VOICE_CHAT_PARENTAL_DISABLE_ALL                     = 615,
    ERR_VOICE_CHAT_PARENTAL_DISABLE_MIC                     = 616,
    ERR_PROFANE_CHAT_NAME                                   = 617,
    ERR_PLAYER_SILENCED_ECHO                                = 618,
    ERR_PLAYER_UNSILENCED_ECHO                              = 619,
    ERR_VOICESESSION_FULL                                   = 620,
    ...
    ERR_NOT_WHILE_FATIGUED                                  = 704,
    ERR_MAX_SOCKETS                                         = 705,
    ERR_MULTI_CAST_ACTION_TOTEM_S                           = 706,
    ERR_BATTLEGROUND_JOIN_LEVELUP                           = 707,
    ERR_REMOVE_FROM_PVP_QUEUE_XP_GAIN                       = 708,
    ERR_BATTLEGROUND_JOIN_XP_GAIN                           = 709,
    ERR_BATTLEGROUND_JOIN_MERCENARY                         = 710,
    ERR_BATTLEGROUND_JOIN_TOO_MANY_HEALERS                  = 711,
    ERR_BATTLEGROUND_JOIN_TOO_MANY_TANKS                    = 712,
    ERR_BATTLEGROUND_JOIN_TOO_MANY_DAMAGE                   = 713,
    ERR_RAID_DIFFICULTY_FAILED                              = 714,
    ERR_RAID_DIFFICULTY_CHANGED_S                           = 715,
    ERR_LEGACY_RAID_DIFFICULTY_CHANGED_S                    = 716,
    ERR_RAID_LOCKOUT_CHANGED_S                              = 717,
    ERR_RAID_CONVERTED_TO_PARTY                             = 718,
    ERR_PARTY_CONVERTED_TO_RAID                             = 719,
    ERR_PLAYER_DIFFICULTY_CHANGED_S                         = 720,
    ERR_GMRESPONSE_DB_ERROR                                 = 721,
    ERR_BATTLEGROUND_JOIN_RANGE_INDEX                       = 722,
    ERR_ARENA_JOIN_RANGE_INDEX                              = 723,
    ERR_REMOVE_FROM_PVP_QUEUE_FACTION_CHANGE                = 724,
    ERR_BATTLEGROUND_JOIN_FAILED                            = 725,
    ERR_BATTLEGROUND_JOIN_NO_VALID_SPEC_FOR_ROLE            = 726,
    ERR_BATTLEGROUND_JOIN_RESPEC                            = 727,
    ERR_BATTLEGROUND_INVITATION_DECLINED                    = 728,
    ERR_BATTLEGROUND_JOIN_TIMED_OUT                         = 729,
    ERR_BATTLEGROUND_DUPE_QUEUE                             = 730,
    ERR_BATTLEGROUND_JOIN_MUST_COMPLETE_QUEST               = 731,
    ERR_IN_BATTLEGROUND_RESPEC                              = 732,
    ERR_MAIL_LIMITED_DURATION_ITEM                          = 733,
    ERR_YELL_RESTRICTED_TRIAL                               = 734,
    ERR_CHAT_RAID_RESTRICTED_TRIAL                          = 735,
    ERR_LFG_ROLE_CHECK_FAILED                               = 736,
    ERR_LFG_ROLE_CHECK_FAILED_TIMEOUT                       = 737,
    ERR_LFG_ROLE_CHECK_FAILED_NOT_VIABLE                    = 738,
    ERR_LFG_READY_CHECK_FAILED                              = 739,
    ERR_LFG_READY_CHECK_FAILED_TIMEOUT                      = 740,
    ERR_LFG_GROUP_FULL                                      = 741,
    ERR_LFG_NO_LFG_OBJECT                                   = 742,
    ERR_LFG_NO_SLOTS_PLAYER                                 = 743,
    ERR_LFG_NO_SLOTS_PARTY                                  = 744,
    ERR_LFG_NO_SPEC                                         = 745,
    ERR_LFG_MISMATCHED_SLOTS                                = 746,
    ERR_LFG_MISMATCHED_SLOTS_LOCAL_XREALM                   = 747,
    ERR_LFG_PARTY_PLAYERS_FROM_DIFFERENT_REALMS             = 748,
    ERR_LFG_MEMBERS_NOT_PRESENT                             = 749,
    ERR_LFG_GET_INFO_TIMEOUT                                = 750,
    ERR_LFG_INVALID_SLOT                                    = 751,
    ERR_LFG_DESERTER_PLAYER                                 = 752,
    ERR_LFG_DESERTER_PARTY                                  = 753,
    ...
    ERR_MUST_EQUIP_ARTIFACT                                 = 962,
    ERR_CANT_DO_THAT_RIGHT_NOW                              = 963,
    ERR_AFFECTING_COMBAT                                    = 964,
    ERR_EQUIPMENT_MANAGER_COMBAT_SWAP_S                     = 965,
    ERR_EQUIPMENT_MANAGER_BAGS_FULL                         = 966,
    ERR_EQUIPMENT_MANAGER_MISSING_ITEM_S                    = 967,
    ERR_MOVIE_RECORDING_WARNING_PERF                        = 968,
    ERR_MOVIE_RECORDING_WARNING_DISK_FULL                   = 969,
    ERR_MOVIE_RECORDING_WARNING_NO_MOVIE                    = 970,
    ERR_MOVIE_RECORDING_WARNING_REQUIREMENTS                = 971,
    ERR_MOVIE_RECORDING_WARNING_COMPRESSING                 = 972,
    ERR_NO_CHALLENGE_MODE_REWARD                            = 973,
    ERR_CLAIMED_CHALLENGE_MODE_REWARD                       = 974,
    ERR_CHALLENGE_MODE_PERIOD_RESET_SS                      = 975,
    ERR_CANT_DO_THAT_CHALLENGE_MODE_ACTIVE                  = 976,
    ERR_TALENT_FAILED_REST_AREA                             = 977,
    ERR_CANNOT_ABANDON_LAST_PET                             = 978
};
