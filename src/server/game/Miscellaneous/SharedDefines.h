...
{
    SPELL_ATTR0_PROC_FAILURE_BURNS_CHARGE                           = 0x00000001, /*NYI*/ // Proc Failure Burns Charge
    ...
    SPELL_ATTR0_WEARER_CASTS_PROC_TRIGGER                           = 0x00000800, /*NYI*/ // Wearer Casts Proc Trigger
...
enum SpellAttr1 : uint32
{
    ...
    SPELL_ATTR1_REQUIRE_ALL_TARGETS                                 = 0x04000000, /*NYI, UNK*/ // Require All Targets
