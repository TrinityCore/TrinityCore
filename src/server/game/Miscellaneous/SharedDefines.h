...
enum class GameError : uint32
{
    ...
    ERR_NO_GUILD_CHARTER                                            = 155,
    ERR_OUT_OF_RANGE                                                = 156,
    ERR_PLAYER_DEAD                                                 = 157,
    ERR_CLIENT_LOCKED_OUT                                           = 158,
    ERR_CLIENT_ON_TRANSPORT                                         = 159,
    ERR_KILLED_BY_S                                                 = 160,
    ERR_LOOT_LOCKED                                                 = 161,
    ERR_LOOT_TOO_FAR                                                = 162,
    ERR_LOOT_DIDNT_KILL                                             = 163,
    ERR_LOOT_BAD_FACING                                             = 164,
    ERR_LOOT_NOTSTANDING                                            = 165,
    ERR_LOOT_STUNNED                                                = 166,
    ERR_LOOT_NO_UI                                                  = 167,
    ERR_LOOT_WHILE_INVULNERABLE                                     = 168,
    ERR_NO_LOOT                                                     = 169,
    ERR_QUEST_ACCEPTED_S                                            = 170,
    ERR_QUEST_COMPLETE_S                                            = 171,
    ERR_QUEST_FAILED_S                                              = 172,
    ERR_QUEST_FAILED_BAG_FULL_S                                     = 173,
    ERR_QUEST_FAILED_MAX_COUNT_S                                    = 174,
    ERR_QUEST_FAILED_LOW_LEVEL                                      = 175,
    ERR_QUEST_FAILED_MISSING_ITEMS                                  = 176,
    ERR_QUEST_FAILED_WRONG_RACE                                     = 177,
    ERR_QUEST_FAILED_NOT_ENOUGH_MONEY                               = 178,
    ERR_QUEST_FAILED_EXPANSION                                      = 179,
    ERR_QUEST_ONLY_ONE_TIMED                                        = 180,
    ERR_QUEST_NEED_PREREQS                                          = 181,
    ERR_QUEST_NEED_PREREQS_CUSTOM                                   = 182,
    ERR_QUEST_ALREADY_ON                                            = 183,
    ERR_QUEST_ALREADY_DONE                                          = 184,
    ERR_QUEST_ALREADY_DONE_DAILY                                    = 185,
    ERR_QUEST_HAS_IN_PROGRESS                                       = 186,
    ERR_QUEST_REWARD_EXP_I                                          = 187,
    ERR_QUEST_REWARD_MONEY_S                                        = 188,
    ERR_QUEST_MUST_CHOOSE                                           = 189,
    ERR_QUEST_LOG_FULL                                              = 190,
    ERR_COMBAT_DAMAGE_SSI                                           = 191,
    ERR_INSPECT_S                                                   = 192,
    ERR_CANT_USE_ITEM                                               = 193,
    ERR_CANT_USE_ITEM_IN_ARENA                                      = 194,
    ERR_CANT_USE_ITEM_IN_RATED_BATTLEGROUND                         = 195,
    ERR_MUST_EQUIP_ITEM                                             = 196,
    ERR_PASSIVE_ABILITY                                             = 197,
    ERR_2HSKILLNOTFOUND                                             = 198,
    ERR_NO_ATTACK_TARGET                                            = 199,
    ERR_INVALID_ATTACK_TARGET                                       = 200,
    ERR_ATTACK_PVP_TARGET_WHILE_UNFLAGGED                           = 201,
    ERR_ATTACK_STUNNED                                              = 202,
    ERR_ATTACK_PACIFIED                                             = 203,
    ERR_ATTACK_MOUNTED                                              = 204,
    ERR_ATTACK_FLEEING                                              = 205,
    ERR_ATTACK_CONFUSED                                             = 206,
    ERR_ATTACK_CHARMED                                              = 207,
    ERR_ATTACK_DEAD                                                 = 208,
    ERR_ATTACK_PREVENTED_BY_MECHANIC_S                              = 209,
    ERR_ATTACK_CHANNEL                                              = 210,
    ERR_TAXISAMENODE                                                = 211,
    ERR_TAXINOSUCHPATH                                              = 212,
    ERR_TAXIUNSPECIFIEDSERVERERROR                                  = 213,
    ERR_TAXINOTENOUGHMONEY                                          = 214,
    ERR_TAXITOOFARAWAY                                              = 215,
    ERR_TAXINOVENDORNEARBY                                          = 216,
    ERR_TAXINOTVISITED                                              = 217,
    ERR_TAXIPLAYERBUSY                                              = 218,
    ERR_TAXIPLAYERALREADYMOUNTED                                    = 219,
    ERR_TAXIPLAYERSHAPESHIFTED                                      = 220,
    ERR_TAXIPLAYERMOVING                                            = 221,
    ERR_TAXINOPATHS                                                 = 222,
    ERR_TAXINOTELIGIBLE                                             = 223,
    ERR_TAXINOTSTANDING                                             = 224,
    ERR_TAXIINCOMBAT                                                = 225,
    ERR_NO_REPLY_TARGET                                             = 226,
    ERR_GENERIC_NO_TARGET                                           = 227,
    ERR_INITIATE_TRADE_S                                            = 228,
    ERR_TRADE_REQUEST_S                                             = 229,
    ERR_TRADE_BLOCKED_S                                             = 230,
    ERR_TRADE_TARGET_DEAD                                           = 231,
    ERR_TRADE_TOO_FAR                                               = 232,
    ERR_TRADE_CANCELLED                                             = 233,
    ERR_TRADE_COMPLETE                                              = 234,
    ERR_TRADE_BAG_FULL                                              = 235,
    ERR_TRADE_TARGET_BAG_FULL                                       = 236,
    ERR_TRADE_MAX_COUNT_EXCEEDED                                    = 237,
    ERR_TRADE_TARGET_MAX_COUNT_EXCEEDED                             = 238,
    ERR_ALREADY_TRADING                                             = 239,
    ERR_MOUNT_INVALIDMOUNTEE                                        = 240,
    ERR_MOUNT_TOOFARAWAY                                            = 241,
    ERR_MOUNT_ALREADYMOUNTED                                        = 242,
    ERR_MOUNT_NOTMOUNTABLE                                          = 243,
    ERR_MOUNT_NOTYOURPET                                            = 244,
    ERR_MOUNT_OTHER                                                 = 245,
    ERR_MOUNT_LOOTING                                               = 246,
    ERR_MOUNT_RACECANTMOUNT                                         = 247,
    ERR_MOUNT_SHAPESHIFTED                                          = 248,
    ERR_MOUNT_NO_FAVORITES                                          = 249,
    ERR_MOUNT_NO_MOUNTS                                             = 250,
    ERR_DISMOUNT_NOPET                                              = 251,
    ERR_DISMOUNT_NOTMOUNTED                                         = 252,
    ERR_DISMOUNT_NOTYOURPET                                         = 253,
    ERR_SPELL_FAILED_TOTEMS                                         = 254,
    ERR_SPELL_FAILED_REAGENTS                                       = 255,
    ERR_SPELL_FAILED_REAGENTS_GENERIC                               = 256,
    ERR_CANT_TRADE_GOLD                                             = 257,
    ERR_SPELL_FAILED_EQUIPPED_ITEM                                  = 258,
    ERR_SPELL_FAILED_EQUIPPED_ITEM_CLASS_S                          = 259,
    ERR_SPELL_FAILED_SHAPESHIFT_FORM_S                              = 260,
    ERR_SPELL_FAILED_ANOTHER_IN_PROGRESS                            = 261,
    ERR_BADATTACKFACING                                             = 262,
    ERR_BADATTACKPOS                                                = 263,
    ERR_CHEST_IN_USE                                                = 264,
    ERR_USE_CANT_OPEN                                               = 265,
    ERR_USE_LOCKED                                                  = 266,
    ERR_DOOR_LOCKED                                                 = 267,
    ERR_BUTTON_LOCKED                                               = 268,
    ERR_USE_LOCKED_WITH_ITEM_S                                      = 269,
    ERR_USE_LOCKED_WITH_SPELL_S                                     = 270,
    ERR_USE_LOCKED_WITH_SPELL_KNOWN_SI                              = 271,
    ERR_USE_TOO_FAR                                                 = 272,
    ERR_USE_BAD_ANGLE                                               = 273,
    ERR_USE_OBJECT_MOVING                                           = 274,
    ERR_USE_SPELL_FOCUS                                             = 275,
    ERR_USE_DESTROYED                                               = 276,
    ERR_SET_LOOT_FREEFORALL                                         = 277,
    ERR_SET_LOOT_ROUNDROBIN                                         = 278,
    ERR_SET_LOOT_MASTER                                             = 279,
    ERR_SET_LOOT_GROUP                                              = 280,
    ERR_SET_LOOT_NBG                                                = 281,
    ERR_SET_LOOT_THRESHOLD_S                                        = 282,
    ERR_NEW_LOOT_MASTER_S                                           = 283,
    ERR_SPECIFY_MASTER_LOOTER                                       = 284,
    ERR_LOOT_SPEC_CHANGED_S                                         = 285,
    ERR_TAME_FAILED                                                 = 286,
    ERR_CHAT_WHILE_DEAD                                             = 287,
    ERR_CHAT_PLAYER_NOT_FOUND_S                                     = 288,
    ERR_NEWTAXIPATH                                                 = 289,
    ERR_NO_PET                                                      = 290,
    ERR_NOTYOURPET                                                  = 291,
    ERR_PET_NOT_RENAMEABLE                                          = 292,
    ERR_QUEST_OBJECTIVE_COMPLETE_S                                  = 293,
    ERR_QUEST_UNKNOWN_COMPLETE                                      = 294,
    ERR_QUEST_ADD_KILL_SII                                          = 295,
    ERR_QUEST_ADD_FOUND_SII                                         = 296,
    ERR_QUEST_ADD_ITEM_SII                                          = 297,
    ERR_QUEST_ADD_PLAYER_KILL_SII                                   = 298,
    ERR_CANNOTCREATEDIRECTORY                                       = 299,
    ERR_CANNOTCREATEFILE                                            = 300,
    ERR_PLAYER_WRONG_FACTION                                        = 301,
    ERR_PLAYER_IS_NEUTRAL                                           = 302,
    ERR_BANKSLOT_FAILED_TOO_MANY                                    = 303,
    ERR_BANKSLOT_INSUFFICIENT_FUNDS                                 = 304,
    ERR_BANKSLOT_NOTBANKER                                          = 305,
    ERR_FRIEND_DB_ERROR                                             = 306,
    ERR_FRIEND_LIST_FULL                                            = 307,
    ERR_FRIEND_ADDED_S                                              = 308,
    ERR_BATTLETAG_FRIEND_ADDED_S                                    = 309,
    ERR_FRIEND_ONLINE_SS                                            = 310,
    ERR_FRIEND_OFFLINE_S                                            = 311,
    ERR_FRIEND_NOT_FOUND                                            = 312,
    ERR_FRIEND_WRONG_FACTION                                        = 313,
    ERR_FRIEND_REMOVED_S                                            = 314,
    ERR_BATTLETAG_FRIEND_REMOVED_S                                  = 315,
    ERR_FRIEND_ERROR                                                = 316,
    ERR_FRIEND_ALREADY_S                                            = 317,
    ERR_FRIEND_SELF                                                 = 318,
    ERR_FRIEND_DELETED                                              = 319,
    ERR_IGNORE_FULL                                                 = 320,
    ERR_IGNORE_SELF                                                 = 321,
    ERR_IGNORE_NOT_FOUND                                            = 322,
    ERR_IGNORE_ALREADY_S                                            = 323,
    ERR_IGNORE_ADDED_S                                              = 324,
    ERR_IGNORE_REMOVED_S                                            = 325,
    ERR_IGNORE_AMBIGUOUS                                            = 326,
    ERR_IGNORE_DELETED                                              = 327,
    ERR_ONLY_ONE_BOLT                                               = 328,
    ERR_ONLY_ONE_AMMO                                               = 329,
    ERR_SPELL_FAILED_EQUIPPED_SPECIFIC_ITEM                         = 330,
    ERR_WRONG_BAG_TYPE_SUBCLASS                                     = 331,
    ERR_CANT_WRAP_STACKABLE                                         = 332,
    ERR_CANT_WRAP_EQUIPPED                                          = 333,
    ERR_CANT_WRAP_WRAPPED                                           = 334,
    ERR_CANT_WRAP_BOUND                                             = 335,
    ERR_CANT_WRAP_UNIQUE                                            = 336,
    ERR_CANT_WRAP_BAGS                                              = 337,
    ERR_OUT_OF_MANA                                                 = 338,
    ERR_OUT_OF_RAGE                                                 = 339,
    ERR_OUT_OF_FOCUS                                                = 340,
    ERR_OUT_OF_ENERGY                                               = 341,
    ERR_OUT_OF_CHI                                                  = 342,
    ERR_OUT_OF_HEALTH                                               = 343,
    ERR_OUT_OF_RUNES                                                = 344,
    ERR_OUT_OF_RUNIC_POWER                                          = 345,
    ERR_OUT_OF_SOUL_SHARDS                                          = 346,
    ERR_OUT_OF_LUNAR_POWER                                          = 347,
    ERR_OUT_OF_BALANCE_POSITIVE                                     = 348,
    ERR_OUT_OF_BALANCE_NEGATIVE                                     = 349,
    ERR_OUT_OF_HOLY_POWER                                           = 350,
    ERR_OUT_OF_MAELSTROM                                            = 351,
    ERR_OUT_OF_COMBO_POINTS                                         = 352,
    ERR_OUT_OF_INSANITY                                             = 353,
    ERR_OUT_OF_ARCANE_CHARGES                                       = 354,
    ERR_OUT_OF_FURY                                                 = 355,
    ERR_OUT_OF_PAIN                                                 = 356,
    ERR_OUT_OF_POWER_DISPLAY                                        = 357,
    ERR_LOOT_GONE                                                   = 358,
    ERR_MOUNT_FORCEDDISMOUNT                                        = 359,
    ERR_AUTOFOLLOW_TOO_FAR                                          = 360,
    ERR_UNIT_NOT_FOUND                                              = 361,
    ERR_INVALID_FOLLOW_TARGET                                       = 362,
    ERR_INVALID_FOLLOW_PVP_COMBAT                                   = 363,
    ERR_INVALID_FOLLOW_TARGET_PVP_COMBAT                            = 364,
    ERR_INVALID_INSPECT_TARGET                                      = 365,
    ERR_GUILDEMBLEM_SUCCESS                                         = 366,
    ERR_GUILDEMBLEM_INVALID_TABARD_COLORS                           = 367,
    ERR_GUILDEMBLEM_NOGUILD                                         = 368,
    ERR_GUILDEMBLEM_NOTGUILDMASTER                                  = 369,
    ERR_GUILDEMBLEM_NOTENOUGHMONEY                                  = 370,
    ERR_GUILDEMBLEM_INVALIDVENDOR                                   = 371,
    ERR_EMBLEMERROR_NOTABARDGEOSET                                  = 372,
    ERR_SPELL_OUT_OF_RANGE                                          = 373,
    ERR_COMMAND_NEEDS_TARGET                                        = 374,
    ERR_NOAMMO_S                                                    = 375,
    ERR_TOOBUSYTOFOLLOW                                             = 376,
    ERR_DUEL_REQUESTED                                              = 377,
    ERR_DUEL_CANCELLED                                              = 378,
    ERR_DUEL_TO_THE_DEATH_FORFEIT                                   = 379,
    ERR_DEATHBINDALREADYBOUND                                       = 380,
    ERR_DEATHBIND_SUCCESS_S                                         = 381,
    ERR_NOEMOTEWHILERUNNING                                         = 382,
    ERR_ZONE_EXPLORED                                               = 383,
    ERR_ZONE_EXPLORED_XP                                            = 384,
    ERR_INVALID_ITEM_TARGET                                         = 385,
    ERR_INVALID_QUEST_TARGET                                        = 386,
    ERR_IGNORING_YOU_S                                              = 387,
    ERR_FISH_NOT_HOOKED                                             = 388,
    ERR_FISH_ESCAPED                                                = 389,
    ERR_SPELL_FAILED_NOTUNSHEATHED                                  = 390,
    ERR_PETITION_OFFERED_S                                          = 391,
    ERR_PETITION_SIGNED                                             = 392,
    ERR_PETITION_SIGNED_S                                           = 393,
    ERR_PETITION_DECLINED_S                                         = 394,
    ERR_PETITION_ALREADY_SIGNED                                     = 395,
    ERR_PETITION_RESTRICTED_ACCOUNT_TRIAL                           = 396,
    ERR_PETITION_ALREADY_SIGNED_OTHER                               = 397,
    ERR_PETITION_IN_GUILD                                           = 398,
    ERR_PETITION_CREATOR                                            = 399,
    ERR_PETITION_NOT_ENOUGH_SIGNATURES                              = 400,
    ERR_PETITION_NOT_SAME_SERVER                                    = 401,
    ERR_PETITION_FULL                                               = 402,
    ERR_PETITION_ALREADY_SIGNED_BY_S                                = 403,
    ERR_PETITION_TEAMS_UNAVAILABLE                                  = 404,
    ERR_GUILD_NAME_INVALID                                          = 405,
    ERR_SPELL_UNLEARNED_S                                           = 406,
    ERR_PET_SPELL_ROOTED                                            = 407,
    ERR_PET_SPELL_AFFECTING_COMBAT                                  = 408,
    ERR_PET_SPELL_OUT_OF_RANGE                                      = 409,
    ERR_PET_SPELL_NOT_BEHIND                                        = 410,
    ERR_PET_SPELL_TARGETS_DEAD                                      = 411,
    ERR_PET_SPELL_DEAD                                              = 412,
    ERR_PET_SPELL_NOPATH                                            = 413,
    ERR_ITEM_CANT_BE_DESTROYED                                      = 414,
    ERR_TICKET_ALREADY_EXISTS                                       = 415,
    ERR_TICKET_CREATE_ERROR                                         = 416,
    ERR_TICKET_UPDATE_ERROR                                         = 417,
    ERR_TICKET_DB_ERROR                                             = 418,
    ERR_TICKET_NO_TEXT                                              = 419,
    ERR_TICKET_TEXT_TOO_LONG                                        = 420,
    ERR_OBJECT_IS_BUSY                                              = 421,
    ERR_EXHAUSTION_WELLRESTED                                       = 422,
    ERR_EXHAUSTION_RESTED                                           = 423,
    ERR_EXHAUSTION_NORMAL                                           = 424,
    ERR_EXHAUSTION_TIRED                                            = 425,
    ERR_EXHAUSTION_EXHAUSTED                                        = 426,
    ERR_NO_ITEMS_WHILE_SHAPESHIFTED                                 = 427,
    ERR_CANT_INTERACT_SHAPESHIFTED                                  = 428,
    ERR_REALM_NOT_FOUND                                             = 429,
    ERR_MAIL_QUEST_ITEM                                             = 430,
    ERR_MAIL_BOUND_ITEM                                             = 431,
    ERR_MAIL_CONJURED_ITEM                                          = 432,
    ERR_MAIL_BAG                                                    = 433,
    ERR_MAIL_TO_SELF                                                = 434,
    ERR_MAIL_TARGET_NOT_FOUND                                       = 435,
    ERR_MAIL_DATABASE_ERROR                                         = 436,
    ERR_MAIL_DELETE_ITEM_ERROR                                      = 437,
    ERR_MAIL_WRAPPED_COD                                            = 438,
    ERR_MAIL_CANT_SEND_REALM                                        = 439,
    ERR_MAIL_RECEPIENT_CANT_RECEIVE_MAIL                            = 440,
    ERR_MAIL_SENT                                                   = 441,
    ERR_NOT_HAPPY_ENOUGH                                            = 442,
    ERR_USE_CANT_IMMUNE                                             = 443,
    ERR_CANT_BE_DISENCHANTED                                        = 444,
    ERR_CANT_USE_DISARMED                                           = 445,
    ERR_AUCTION_QUEST_ITEM                                          = 446,
    ERR_AUCTION_BOUND_ITEM                                          = 447,
    ERR_AUCTION_CONJURED_ITEM                                       = 448,
    ERR_AUCTION_LIMITED_DURATION_ITEM                               = 449,
    ERR_AUCTION_WRAPPED_ITEM                                        = 450,
    ERR_AUCTION_LOOT_ITEM                                           = 451,
    ERR_AUCTION_BAG                                                 = 452,
    ERR_AUCTION_EQUIPPED_BAG                                        = 453,
    ERR_AUCTION_DATABASE_ERROR                                      = 454,
    ERR_AUCTION_BID_OWN                                             = 455,
    ERR_AUCTION_BID_INCREMENT                                       = 456,
    ERR_AUCTION_HIGHER_BID                                          = 457,
    ERR_AUCTION_MIN_BID                                             = 458,
    ERR_AUCTION_REPAIR_ITEM                                         = 459,
    ERR_AUCTION_USED_CHARGES                                        = 460,
    ERR_AUCTION_ALREADY_BID                                         = 461,
    ERR_AUCTION_HOUSE_UNAVAILABLE                                   = 462,
    ERR_AUCTION_HOUSE_BUSY                                          = 463,
    ERR_AUCTION_STARTED                                             = 464,
    ERR_AUCTION_REMOVED                                             = 465,
    ERR_AUCTION_OUTBID_S                                            = 466,
    ERR_AUCTION_WON_S                                               = 467,
    ERR_AUCTION_SOLD_S                                              = 468,
    ERR_AUCTION_EXPIRED_S                                           = 469,
    ERR_AUCTION_REMOVED_S                                           = 470,
    ERR_AUCTION_BID_PLACED                                          = 471,
    ERR_LOGOUT_FAILED                                               = 472,
    ERR_QUEST_PUSH_SUCCESS_S                                        = 473,
    ERR_QUEST_PUSH_INVALID_S                                        = 474,
    ERR_QUEST_PUSH_ACCEPTED_S                                       = 475,
    ERR_QUEST_PUSH_DECLINED_S                                       = 476,
    ERR_QUEST_PUSH_TOO_FAR_S                                        = 477,
    ERR_QUEST_PUSH_BUSY_S                                           = 478,
    ERR_QUEST_PUSH_DEAD_S                                           = 479,
    ERR_QUEST_PUSH_LOG_FULL_S                                       = 480,
    ERR_QUEST_PUSH_ONQUEST_S                                        = 481,
    ERR_QUEST_PUSH_ALREADY_DONE_S                                   = 482,
    ERR_QUEST_PUSH_NOT_DAILY_S                                      = 483,
    ERR_QUEST_PUSH_TIMER_EXPIRED_S                                  = 484,
    ERR_QUEST_PUSH_NOT_IN_PARTY_S                                   = 485,
    ERR_QUEST_PUSH_DIFFERENT_SERVER_DAILY_S                         = 486,
    ...
    ERR_GUILDEMBLEM_SAME                                            = 546,
    ERR_EQUIP_TRADE_ITEM                                            = 547,
    ERR_PVP_TOGGLE_ON                                               = 548,
    ERR_PVP_TOGGLE_OFF                                              = 549,
    ERR_GROUP_JOIN_BATTLEGROUND_DESERTERS                           = 550,
    ERR_GROUP_JOIN_BATTLEGROUND_DEAD                                = 551,
    ERR_GROUP_JOIN_BATTLEGROUND_S                                   = 552,
    ERR_GROUP_JOIN_BATTLEGROUND_FAIL                                = 553,
    ERR_GROUP_JOIN_BATTLEGROUND_TOO_MANY                            = 554,
    ERR_SOLO_JOIN_BATTLEGROUND_S                                    = 555,
    ERR_JOIN_SINGLE_SCENARIO_S                                      = 556,
    ERR_BATTLEGROUND_TOO_MANY_QUEUES                                = 557,
    ERR_BATTLEGROUND_CANNOT_QUEUE_FOR_RATED                         = 558,
    ERR_BATTLEDGROUND_QUEUED_FOR_RATED                              = 559,
    ERR_BATTLEGROUND_TEAM_LEFT_QUEUE                                = 560,
    ERR_BATTLEGROUND_NOT_IN_BATTLEGROUND                            = 561,
    ERR_INVALID_PROMOTION_CODE                                      = 562,
    ERR_BG_PLAYER_JOINED_SS                                         = 563,
    ERR_BG_PLAYER_LEFT_S                                            = 564,
    ERR_RESTRICTED_ACCOUNT                                          = 565,
    ERR_RESTRICTED_ACCOUNT_TRIAL                                    = 566,
    ERR_PLAY_TIME_EXCEEDED                                          = 567,
    ERR_APPROACHING_PARTIAL_PLAY_TIME                               = 568,
    ERR_APPROACHING_PARTIAL_PLAY_TIME_2                             = 569,
    ERR_APPROACHING_NO_PLAY_TIME                                    = 570,
    ERR_APPROACHING_NO_PLAY_TIME_2                                  = 571,
    ERR_UNHEALTHY_TIME                                              = 572,
    ERR_CHAT_RESTRICTED_TRIAL                                       = 573,
    ERR_CHAT_THROTTLED                                              = 574,
    ERR_MAIL_REACHED_CAP                                            = 575,
    ERR_INVALID_RAID_TARGET                                         = 576,
    ERR_RAID_LEADER_READY_CHECK_START_S                             = 577,
    ERR_READY_CHECK_IN_PROGRESS                                     = 578,
    ERR_READY_CHECK_THROTTLED                                       = 579,
    ERR_DUNGEON_DIFFICULTY_FAILED                                   = 580,
    ERR_DUNGEON_DIFFICULTY_CHANGED_S                                = 581,
    ERR_TRADE_WRONG_REALM                                           = 582,
    ERR_TRADE_NOT_ON_TAPLIST                                        = 583,
    ERR_CHAT_PLAYER_AMBIGUOUS_S                                     = 584,
    ERR_LOOT_CANT_LOOT_THAT_NOW                                     = 585,
    ERR_LOOT_MASTER_INV_FULL                                        = 586,
    ERR_LOOT_MASTER_UNIQUE_ITEM                                     = 587,
    ERR_LOOT_MASTER_OTHER                                           = 588,
    ERR_FILTERING_YOU_S                                             = 589,
    ERR_USE_PREVENTED_BY_MECHANIC_S                                 = 590,
    ERR_ITEM_UNIQUE_EQUIPPABLE                                      = 591,
    ERR_LFG_LEADER_IS_LFM_S                                         = 592,
    ERR_LFG_PENDING                                                 = 593,
    ERR_ARENA_NO_TEAM_II                                            = 594,
    ERR_ARENA_TEAM_CREATE_S                                         = 595,
    ERR_ARENA_TEAM_INVITE_SS                                        = 596,
    ERR_ARENA_TEAM_QUIT_S                                           = 597,
    ERR_ARENA_TEAM_FOUNDER_S                                        = 598,
    ERR_ARENA_TEAM_INTERNAL                                         = 599,
    ERR_ALREADY_IN_ARENA_TEAM                                       = 600,
    ERR_ALREADY_IN_ARENA_TEAM_S                                     = 601,
    ERR_INVITED_TO_ARENA_TEAM                                       = 602,
    ERR_ALREADY_INVITED_TO_ARENA_TEAM_S                             = 603,
    ERR_ARENA_TEAM_NAME_INVALID                                     = 604,
    ERR_ARENA_TEAM_NAME_EXISTS_S                                    = 605,
    ERR_ARENA_TEAM_LEADER_LEAVE_S                                   = 606,
    ERR_ARENA_TEAM_PERMISSIONS                                      = 607,
    ERR_ARENA_TEAM_PLAYER_NOT_IN_TEAM                               = 608,
    ERR_ARENA_TEAM_PLAYER_NOT_IN_TEAM_SS                            = 609,
    ERR_ARENA_TEAM_PLAYER_NOT_FOUND_S                               = 610,
    ERR_ARENA_TEAM_NOT_ALLIED                                       = 611,
    ERR_ARENA_TEAM_JOIN_SS                                          = 612,
    ERR_ARENA_TEAM_YOU_JOIN_S                                       = 613,
    ERR_ARENA_TEAM_LEAVE_SS                                         = 614,
    ERR_ARENA_TEAM_LEADER_IS_SS                                     = 615,
    ERR_ARENA_TEAM_LEADER_CHANGED_SSS                               = 616,
    ERR_ARENA_TEAM_REMOVE_SSS                                       = 617,
    ERR_ARENA_TEAM_DISBANDED_S                                      = 618,
    ERR_ARENA_TEAM_TARGET_TOO_LOW_S                                 = 619,
    ERR_ARENA_TEAM_TARGET_TOO_HIGH_S                                = 620,
    ERR_ARENA_TEAM_TOO_MANY_MEMBERS_S                               = 621,
    ERR_ARENA_TEAM_LEVEL_TOO_LOW_I                                  = 622,
    ERR_ARENA_TEAM_NOT_FOUND                                        = 623,
    ERR_ARENA_TEAMS_LOCKED                                          = 624,
    ERR_ARENA_TEAM_TOO_MANY_CREATE                                  = 625,
    ERR_ARENA_TEAM_DISQUALIFIED                                     = 626,
    ERR_NO_ARENA_CHARTER                                            = 627,
    ERR_CANT_SPEAK_LANGAGE                                          = 628,
    ERR_VENDOR_MISSING_TURNINS                                      = 629,
    ERR_BATTLEGROUND_NOT_IN_TEAM                                    = 630,
    ERR_NOT_IN_BATTLEGROUND                                         = 631,
    ERR_NOT_ENOUGH_HONOR_POINTS                                     = 632,
    ERR_NOT_ENOUGH_ARENA_POINTS                                     = 633,
    ERR_SOCKETING_REQUIRES_META_GEM                                 = 634,
    ERR_SOCKETING_META_GEM_ONLY_IN_METASLOT                         = 635,
    ERR_SOCKETING_REQUIRES_HYDRAULIC_GEM                            = 636,
    ERR_SOCKETING_HYDRAULIC_GEM_ONLY_IN_HYDRAULICSLOT               = 637,
    ERR_SOCKETING_REQUIRES_COGWHEEL_GEM                             = 638,
    ERR_SOCKETING_COGWHEEL_GEM_ONLY_IN_COGWHEELSLOT                 = 639,
    ERR_SOCKETING_ITEM_TOO_LOW_LEVEL                                = 640,
    ERR_ITEM_MAX_COUNT_SOCKETED                                     = 641,
    ERR_SYSTEM_DISABLED                                             = 642,
    ERR_QUEST_FAILED_TOO_MANY_DAILY_QUESTS_I                        = 643,
    ERR_ITEM_MAX_COUNT_EQUIPPED_SOCKETED                            = 644,
    ERR_ITEM_UNIQUE_EQUIPPABLE_SOCKETED                             = 645,
    ERR_USER_SQUELCHED                                              = 646,
    ERR_TOO_MUCH_GOLD                                               = 647,
    ERR_ACCOUNT_SILENCED                                            = 648,
    ERR_PARTY_MEMBER_SILENCED                                       = 649,
    ERR_PARTY_MEMBER_SILENCED_LFG_DELIST                            = 650,
    ERR_NOT_BARBER_SITTING                                          = 651,
    ERR_QUEST_FAILED_CAIS                                           = 652,
    ERR_INVITE_RESTRICTED_TRIAL                                     = 653,
    ERR_VOICE_IGNORE_FULL                                           = 654,
    ERR_VOICE_IGNORE_SELF                                           = 655,
    ERR_VOICE_IGNORE_NOT_FOUND                                      = 656,
    ERR_VOICE_IGNORE_ALREADY_S                                      = 657,
    ERR_VOICE_IGNORE_ADDED_S                                        = 658,
    ERR_VOICE_IGNORE_REMOVED_S                                      = 659,
    ERR_VOICE_IGNORE_AMBIGUOUS                                      = 660,
    ERR_VOICE_IGNORE_DELETED                                        = 661,
    ERR_UNKNOWN_MACRO_OPTION_S                                      = 662,
    ERR_NOT_DURING_ARENA_MATCH                                      = 663,
    ERR_PLAYER_SILENCED                                             = 664,
    ERR_PLAYER_UNSILENCED                                           = 665,
    ERR_COMSAT_DISCONNECT                                           = 666,
    ERR_COMSAT_RECONNECT_ATTEMPT                                    = 667,
    ERR_COMSAT_CONNECT_FAIL                                         = 668,
    ERR_MAIL_INVALID_ATTACHMENT_SLOT                                = 669,
    ERR_MAIL_TOO_MANY_ATTACHMENTS                                   = 670,
    ERR_MAIL_INVALID_ATTACHMENT                                     = 671,
    ERR_MAIL_ATTACHMENT_EXPIRED                                     = 672,
    ERR_VOICE_CHAT_PARENTAL_DISABLE_MIC                             = 673,
    ERR_PROFANE_CHAT_NAME                                           = 674,
    ERR_PLAYER_SILENCED_ECHO                                        = 675,
    ERR_PLAYER_UNSILENCED_ECHO                                      = 676,
    ERR_LOOT_CANT_LOOT_THAT                                         = 677,
    ERR_ARENA_EXPIRED_CAIS                                          = 678,
    ERR_GROUP_ACTION_THROTTLED                                      = 679,
    ERR_ALREADY_PICKPOCKETED                                        = 680,
    ERR_NAME_INVALID                                                = 681,
    ERR_NAME_NO_NAME                                                = 682,
    ERR_NAME_TOO_SHORT                                              = 683,
    ERR_NAME_TOO_LONG                                               = 684,
    ERR_NAME_MIXED_LANGUAGES                                        = 685,
    ERR_INVALID_PETNAME                                             = 686,
    ERR_NAME_PROFANE                                                = 687,
    ERR_NAME_RESERVED                                               = 688,
    ERR_NAME_THREE_CONSECUTIVE                                      = 689,
    ERR_NAME_INVALID_SPACE                                          = 690,
    ERR_NAME_CONSECUTIVE_SPACES                                     = 691,
    ERR_NAME_RUSSIAN_CONSECUTIVE_SILENT_CHARACTERS                  = 692,
    ERR_NAME_RUSSIAN_SILENT_CHARACTER_AT_BEGINNING_OR_END           = 693,
    ERR_NAME_DECLENSION_DOESNT_MATCH_BASE_NAME                      = 694,
    ERR_REFER_A_FRIEND_NOT_REFERRED_BY                              = 695,
    ERR_REFER_A_FRIEND_TARGET_TOO_HIGH                              = 696,
    ERR_REFER_A_FRIEND_INSUFFICIENT_GRANTABLE_LEVELS                = 697,
    ERR_REFER_A_FRIEND_TOO_FAR                                      = 698,
    ERR_REFER_A_FRIEND_DIFFERENT_FACTION                            = 699,
    ERR_REFER_A_FRIEND_NOT_NOW                                      = 700,
    ERR_REFER_A_FRIEND_GRANT_LEVEL_MAX_I                            = 701,
    ERR_REFER_A_FRIEND_SUMMON_LEVEL_MAX_I                           = 702,
    ERR_REFER_A_FRIEND_SUMMON_COOLDOWN                              = 703,
    ERR_REFER_A_FRIEND_SUMMON_OFFLINE_S                             = 704,
    ERR_REFER_A_FRIEND_INSUF_EXPAN_LVL                              = 705,
    ERR_REFER_A_FRIEND_NOT_IN_LFG                                   = 706,
    ERR_REFER_A_FRIEND_NO_XREALM                                    = 707,
    ERR_REFER_A_FRIEND_MAP_INCOMING_TRANSFER_NOT_ALLOWED            = 708,
    ...
    ERR_PARTY_LFG_BOOT_IN_COMBAT                                    = 745,
    ...
    ERR_NOT_WHILE_FALLING                                           = 761,
    ERR_NOT_WHILE_MOVING                                            = 762,
    ERR_NOT_WHILE_FATIGUED                                          = 763,
    ERR_MAX_SOCKETS                                                 = 764,
    ERR_MULTI_CAST_ACTION_TOTEM_S                                   = 765,
    ERR_BATTLEGROUND_JOIN_LEVELUP                                   = 766,
    ERR_REMOVE_FROM_PVP_QUEUE_XP_GAIN                               = 767,
    ERR_BATTLEGROUND_JOIN_XP_GAIN                                   = 768,
    ERR_BATTLEGROUND_JOIN_MERCENARY                                 = 769,
    ERR_BATTLEGROUND_JOIN_TOO_MANY_HEALERS                          = 770,
    ...
    ERR_LFG_JOINED_QUEUE                                            = 828,
    ERR_LFG_JOINED_FLEX_QUEUE                                       = 829,
    ERR_LFG_JOINED_RF_QUEUE                                         = 830,
    ERR_LFG_JOINED_SCENARIO_QUEUE                                   = 831,
    ERR_LFG_JOINED_WORLD_PVP_QUEUE                                  = 832,
    ERR_LFG_JOINED_BATTLEFIELD_QUEUE                                = 833,
    ERR_LFG_JOINED_LIST                                             = 834,
    ERR_LFG_LEFT_QUEUE                                              = 835,
    ERR_LFG_LEFT_LIST                                               = 836,
    ERR_LFG_ROLE_CHECK_ABORTED                                      = 837,
    ERR_LFG_READY_CHECK_ABORTED                                     = 838,
    ERR_LFG_CANT_USE_BATTLEGROUND                                   = 839,
    ERR_LFG_CANT_USE_DUNGEONS                                       = 840,
    ERR_LFG_REASON_TOO_MANY_LFG                                     = 841,
    ERR_LFG_FARM_LIMIT                                              = 842,
    ERR_LFG_NO_CROSS_FACTION_PARTIES                                = 843,
    ERR_INVALID_TELEPORT_LOCATION                                   = 844,
    ERR_TOO_FAR_TO_INTERACT                                         = 845,
    ERR_BATTLEGROUND_PLAYERS_FROM_DIFFERENT_REALMS                  = 846,
    ERR_DIFFICULTY_CHANGE_COOLDOWN_S                                = 847,
    ERR_DIFFICULTY_CHANGE_COMBAT_COOLDOWN_S                         = 848,
    ERR_DIFFICULTY_CHANGE_WORLDSTATE                                = 849,
    ERR_DIFFICULTY_CHANGE_ENCOUNTER                                 = 850,
    ERR_DIFFICULTY_CHANGE_COMBAT                                    = 851,
    ERR_DIFFICULTY_CHANGE_PLAYER_BUSY                               = 852,
    ERR_DIFFICULTY_CHANGE_ALREADY_STARTED                           = 853,
    ERR_DIFFICULTY_CHANGE_OTHER_HEROIC_S                            = 854,
    ERR_DIFFICULTY_CHANGE_HEROIC_INSTANCE_ALREADY_RUNNING           = 855,
    ERR_ARENA_TEAM_PARTY_SIZE                                       = 856,
    ERR_QUEST_FORCE_REMOVED_S                                       = 857,
    ERR_ATTACK_NO_ACTIONS                                           = 858,
    ERR_IN_RANDOM_BG                                                = 859,
    ERR_IN_NON_RANDOM_BG                                            = 860,
    ERR_AUCTION_ENOUGH_ITEMS                                        = 861,
    ERR_BN_FRIEND_SELF                                              = 862,
    ERR_BN_FRIEND_ALREADY                                           = 863,
    ERR_BN_FRIEND_BLOCKED                                           = 864,
    ERR_BN_FRIEND_LIST_FULL                                         = 865,
    ERR_BN_FRIEND_REQUEST_SENT                                      = 866,
    ERR_BN_BROADCAST_THROTTLE                                       = 867,
    ERR_BG_DEVELOPER_ONLY                                           = 868,
    ERR_CURRENCY_SPELL_SLOT_MISMATCH                                = 869,
    ERR_CURRENCY_NOT_TRADABLE                                       = 870,
    ERR_REQUIRES_EXPANSION_S                                        = 871,
    ERR_QUEST_FAILED_SPELL                                          = 872,
    ERR_TALENT_FAILED_UNSPENT_TALENT_POINTS                         = 873,
    ERR_TALENT_FAILED_NOT_ENOUGH_TALENTS_IN_PRIMARY_TREE            = 874,
    ERR_TALENT_FAILED_NO_PRIMARY_TREE_SELECTED                      = 875,
    ERR_TALENT_FAILED_CANT_REMOVE_TALENT                            = 876,
    ERR_TALENT_FAILED_UNKNOWN                                       = 877,
    ERR_TALENT_FAILED_IN_COMBAT                                     = 878,
    ERR_TALENT_FAILED_IN_PVP_MATCH                                  = 879,
    ERR_TALENT_FAILED_IN_MYTHIC_PLUS                                = 880,
    ERR_REFORGE_SRC_STAT_NOT_FOUND                                  = 881,
    ERR_REFORGE_INSUFFICIENT_SRC_STAT                               = 882,
    ERR_REFORGE_ALREADY_HAS_DST_STAT                                = 883,
    ERR_REFORGE_ITEM_TOO_LOW_LEVEL                                  = 884,
    ERR_WARGAME_REQUEST_FAILURE                                     = 885,
    ERR_RANK_REQUIRES_AUTHENTICATOR                                 = 886,
    ERR_GUILD_BANK_VOUCHER_FAILED                                   = 887,
    ERR_WARGAME_REQUEST_SENT                                        = 888,
    ERR_REQUIRES_ACHIEVEMENT_I                                      = 889,
    ERR_REFUND_RESULT_EXCEED_MAX_CURRENCY                           = 890,
    ERR_CANT_BUY_QUANTITY                                           = 891,
    ERR_ITEM_IS_BATTLE_PAY_LOCKED                                   = 892,
    ERR_PARTY_ALREADY_IN_BATTLEGROUND_QUEUE                         = 893,
    ERR_PARTY_CONFIRMING_BATTLEGROUND_QUEUE                         = 894,
    ERR_BATTLEFIELD_TEAM_PARTY_SIZE                                 = 895,
    ERR_INSUFF_TRACKED_CURRENCY_IS                                  = 896,
    ERR_NOT_ON_TOURNAMENT_REALM                                     = 897,
    ERR_GUILD_TRIAL_ACCOUNT_TRIAL                                   = 898,
    ERR_GUILD_TRIAL_ACCOUNT_VETERAN                                 = 899,
    ERR_GUILD_UNDELETABLE_DUE_TO_LEVEL                              = 900,
    ERR_CANT_DO_THAT_IN_A_GROUP                                     = 901,
    ERR_GUILD_LEADER_REPLACED                                       = 902,
    ERR_TRANSMOGRIFY_CANT_EQUIP                                     = 903,
    ERR_TRANSMOGRIFY_INVALID_ITEM_TYPE                              = 904,
    ERR_TRANSMOGRIFY_NOT_SOULBOUND                                  = 905,
    ERR_TRANSMOGRIFY_INVALID_SOURCE                                 = 906,
    ERR_TRANSMOGRIFY_INVALID_DESTINATION                            = 907,
    ERR_TRANSMOGRIFY_MISMATCH                                       = 908,
    ERR_TRANSMOGRIFY_LEGENDARY                                      = 909,
    ERR_TRANSMOGRIFY_SAME_ITEM                                      = 910,
    ERR_TRANSMOGRIFY_SAME_APPEARANCE                                = 911,
    ERR_TRANSMOGRIFY_NOT_EQUIPPED                                   = 912,
    ERR_VOID_DEPOSIT_FULL                                           = 913,
    ERR_VOID_WITHDRAW_FULL                                          = 914,
    ERR_VOID_STORAGE_WRAPPED                                        = 915,
    ERR_VOID_STORAGE_STACKABLE                                      = 916,
    ERR_VOID_STORAGE_UNBOUND                                        = 917,
    ERR_VOID_STORAGE_REPAIR                                         = 918,
    ERR_VOID_STORAGE_CHARGES                                        = 919,
    ERR_VOID_STORAGE_QUEST                                          = 920,
    ERR_VOID_STORAGE_CONJURED                                       = 921,
    ERR_VOID_STORAGE_MAIL                                           = 922,
    ERR_VOID_STORAGE_BAG                                            = 923,
    ERR_VOID_TRANSFER_STORAGE_FULL                                  = 924,
    ERR_VOID_TRANSFER_INV_FULL                                      = 925,
    ERR_VOID_TRANSFER_INTERNAL_ERROR                                = 926,
    ERR_VOID_TRANSFER_ITEM_INVALID                                  = 927,
    ERR_DIFFICULTY_DISABLED_IN_LFG                                  = 928,
    ERR_VOID_STORAGE_UNIQUE                                         = 929,
    ERR_VOID_STORAGE_LOOT                                           = 930,
    ERR_VOID_STORAGE_HOLIDAY                                        = 931,
    ERR_VOID_STORAGE_DURATION                                       = 932,
    ERR_VOID_STORAGE_LOAD_FAILED                                    = 933,
    ERR_VOID_STORAGE_INVALID_ITEM                                   = 934,
    ERR_PARENTAL_CONTROLS_CHAT_MUTED                                = 935,
    ERR_SOR_START_EXPERIENCE_INCOMPLETE                             = 936,
    ERR_SOR_INVALID_EMAIL                                           = 937,
    ERR_SOR_INVALID_COMMENT                                         = 938,
    ERR_CHALLENGE_MODE_RESET_COOLDOWN_S                             = 939,
    ERR_CHALLENGE_MODE_RESET_KEYSTONE                               = 940,
    ERR_PET_JOURNAL_ALREADY_IN_LOADOUT                              = 941,
    ERR_REPORT_SUBMITTED_SUCCESSFULLY                               = 942,
    ERR_REPORT_SUBMISSION_FAILED                                    = 943,
    ERR_SUGGESTION_SUBMITTED_SUCCESSFULLY                           = 944,
    ERR_BUG_SUBMITTED_SUCCESSFULLY                                  = 945,
    ERR_CHALLENGE_MODE_ENABLED                                      = 946,
    ERR_CHALLENGE_MODE_DISABLED                                     = 947,
    ERR_PETBATTLE_CREATE_FAILED                                     = 948,
    ERR_PETBATTLE_NOT_HERE                                          = 949,
    ERR_PETBATTLE_NOT_HERE_ON_TRANSPORT                             = 950,
    ERR_PETBATTLE_NOT_HERE_UNEVEN_GROUND                            = 951,
    ERR_PETBATTLE_NOT_HERE_OBSTRUCTED                               = 952,
    ERR_PETBATTLE_NOT_WHILE_IN_COMBAT                               = 953,
    ERR_PETBATTLE_NOT_WHILE_DEAD                                    = 954,
    ERR_PETBATTLE_NOT_WHILE_FLYING                                  = 955,
    ERR_PETBATTLE_TARGET_INVALID                                    = 956,
    ERR_PETBATTLE_TARGET_OUT_OF_RANGE                               = 957,
    ERR_PETBATTLE_TARGET_NOT_CAPTURABLE                             = 958,
    ERR_PETBATTLE_NOT_A_TRAINER                                     = 959,
    ERR_PETBATTLE_DECLINED                                          = 960,
    ERR_PETBATTLE_IN_BATTLE                                         = 961,
    ERR_PETBATTLE_INVALID_LOADOUT                                   = 962,
    ERR_PETBATTLE_ALL_PETS_DEAD                                     = 963,
    ERR_PETBATTLE_NO_PETS_IN_SLOTS                                  = 964,
    ERR_PETBATTLE_NO_ACCOUNT_LOCK                                   = 965,
    ERR_PETBATTLE_WILD_PET_TAPPED                                   = 966,
    ERR_PETBATTLE_RESTRICTED_ACCOUNT                                = 967,
    ERR_PETBATTLE_OPPONENT_NOT_AVAILABLE                            = 968,
    ERR_PETBATTLE_NOT_WHILE_IN_MATCHED_BATTLE                       = 969,
    ERR_CANT_HAVE_MORE_PETS_OF_THAT_TYPE                            = 970,
    ERR_CANT_HAVE_MORE_PETS                                         = 971,
    ERR_PVP_MAP_NOT_FOUND                                           = 972,
    ERR_PVP_MAP_NOT_SET                                             = 973,
    ERR_PETBATTLE_QUEUE_QUEUED                                      = 974,
    ERR_PETBATTLE_QUEUE_ALREADY_QUEUED                              = 975,
    ERR_PETBATTLE_QUEUE_JOIN_FAILED                                 = 976,
    ERR_PETBATTLE_QUEUE_JOURNAL_LOCK                                = 977,
    ERR_PETBATTLE_QUEUE_REMOVED                                     = 978,
    ERR_PETBATTLE_QUEUE_PROPOSAL_DECLINED                           = 979,
    ERR_PETBATTLE_QUEUE_PROPOSAL_TIMEOUT                            = 980,
    ERR_PETBATTLE_QUEUE_OPPONENT_DECLINED                           = 981,
    ERR_PETBATTLE_QUEUE_REQUEUED_INTERNAL                           = 982,
    ERR_PETBATTLE_QUEUE_REQUEUED_REMOVED                            = 983,
    ERR_PETBATTLE_QUEUE_SLOT_LOCKED                                 = 984,
    ERR_PETBATTLE_QUEUE_SLOT_EMPTY                                  = 985,
    ERR_PETBATTLE_QUEUE_SLOT_NO_TRACKER                             = 986,
    ERR_PETBATTLE_QUEUE_SLOT_NO_SPECIES                             = 987,
    ERR_PETBATTLE_QUEUE_SLOT_CANT_BATTLE                            = 988,
    ERR_PETBATTLE_QUEUE_SLOT_REVOKED                                = 989,
    ERR_PETBATTLE_QUEUE_SLOT_DEAD                                   = 990,
    ERR_PETBATTLE_QUEUE_SLOT_NO_PET                                 = 991,
    ERR_PETBATTLE_QUEUE_NOT_WHILE_NEUTRAL                           = 992,
    ERR_PETBATTLE_GAME_TIME_LIMIT_WARNING                           = 993,
    ERR_PETBATTLE_GAME_ROUNDS_LIMIT_WARNING                         = 994,
    ERR_HAS_RESTRICTION                                             = 995,
    ERR_ITEM_UPGRADE_ITEM_TOO_LOW_LEVEL                             = 996,
    ERR_ITEM_UPGRADE_NO_PATH                                        = 997,
    ERR_ITEM_UPGRADE_NO_MORE_UPGRADES                               = 998,
    ERR_BONUS_ROLL_EMPTY                                            = 999,
    ERR_CHALLENGE_MODE_FULL                                         = 1000,
    ERR_CHALLENGE_MODE_IN_PROGRESS                                  = 1001,
    ERR_CHALLENGE_MODE_INCORRECT_KEYSTONE                           = 1002,
    ERR_BATTLETAG_FRIEND_NOT_FOUND                                  = 1003,
    ERR_BATTLETAG_FRIEND_NOT_VALID                                  = 1004,
    ERR_BATTLETAG_FRIEND_NOT_ALLOWED                                = 1005,
    ERR_BATTLETAG_FRIEND_THROTTLED                                  = 1006,
    ERR_BATTLETAG_FRIEND_SUCCESS                                    = 1007,
    ERR_PET_TOO_HIGH_LEVEL_TO_UNCAGE                                = 1008,
    ERR_PETBATTLE_INTERNAL                                          = 1009,
    ERR_CANT_CAGE_PET_YET                                           = 1010,
    ERR_NO_LOOT_IN_CHALLENGE_MODE                                   = 1011,
    ERR_QUEST_PET_BATTLE_VICTORIES_PVP_II                           = 1012,
    ERR_ROLE_CHECK_ALREADY_IN_PROGRESS                              = 1013,
    ERR_RECRUIT_A_FRIEND_ACCOUNT_LIMIT                              = 1014,
    ERR_RECRUIT_A_FRIEND_FAILED                                     = 1015,
    ERR_SET_LOOT_PERSONAL                                           = 1016,
    ERR_SET_LOOT_METHOD_FAILED_COMBAT                               = 1017,
    ERR_GARRISON_BUILDING_EXISTS                                    = 1018,
    ERR_GARRISON_INVALID_PLOT                                       = 1019,
    ERR_GARRISON_INVALID_BUILDINGID                                 = 1020,
    ERR_GARRISON_INVALID_PLOT_BUILDING                              = 1021,
    ERR_GARRISON_REQUIRES_BLUEPRINT                                 = 1022,
    ERR_GARRISON_NOT_ENOUGH_CURRENCY                                = 1023,
    ERR_GARRISON_NOT_ENOUGH_GOLD                                    = 1024,
    ERR_GARRISON_COMPLETE_MISSION_WRONG_FOLLOWER_TYPE               = 1025,
    ERR_ALREADY_USING_LFG_LIST                                      = 1026,
    ERR_RESTRICTED_ACCOUNT_LFG_LIST_TRIAL                           = 1027,
    ERR_TOY_USE_LIMIT_REACHED                                       = 1028,
    ERR_TOY_ALREADY_KNOWN                                           = 1029,
    ERR_TRANSMOG_SET_ALREADY_KNOWN                                  = 1030,
    ERR_NOT_ENOUGH_CURRENCY                                         = 1031,
    ERR_SPEC_IS_DISABLED                                            = 1032,
    ERR_FEATURE_RESTRICTED_TRIAL                                    = 1033,
    ERR_CANT_BE_OBLITERATED                                         = 1034,
    ERR_CANT_BE_SCRAPPED                                            = 1035,
    ERR_ARTIFACT_RELIC_DOES_NOT_MATCH_ARTIFACT                      = 1036,
    ERR_MUST_EQUIP_ARTIFACT                                         = 1037,
    ERR_CANT_DO_THAT_RIGHT_NOW                                      = 1038,
    ERR_AFFECTING_COMBAT                                            = 1039,
    ERR_EQUIPMENT_MANAGER_COMBAT_SWAP_S                             = 1040,
    ERR_EQUIPMENT_MANAGER_BAGS_FULL                                 = 1041,
    ERR_EQUIPMENT_MANAGER_MISSING_ITEM_S                            = 1042,
    ERR_MOVIE_RECORDING_WARNING_PERF                                = 1043,
    ERR_MOVIE_RECORDING_WARNING_DISK_FULL                           = 1044,
    ERR_MOVIE_RECORDING_WARNING_NO_MOVIE                            = 1045,
    ERR_MOVIE_RECORDING_WARNING_REQUIREMENTS                        = 1046,
    ERR_MOVIE_RECORDING_WARNING_COMPRESSING                         = 1047,
    ERR_NO_CHALLENGE_MODE_REWARD                                    = 1048,
    ERR_CLAIMED_CHALLENGE_MODE_REWARD                               = 1049,
    ERR_CHALLENGE_MODE_PERIOD_RESET_SS                              = 1050,
    ERR_CANT_DO_THAT_CHALLENGE_MODE_ACTIVE                          = 1051,
    ERR_TALENT_FAILED_REST_AREA                                     = 1052,
    ERR_CANNOT_ABANDON_LAST_PET                                     = 1053,
    ERR_TEST_CVAR_SET_SSS                                           = 1054,
    ERR_QUEST_TURN_IN_FAIL_REASON                                   = 1055,
    ERR_CLAIMED_CHALLENGE_MODE_REWARD_OLD                           = 1056,
    ERR_TALENT_GRANTED_BY_AURA                                      = 1057,
    ERR_CHALLENGE_MODE_ALREADY_COMPLETE                             = 1058,
    ERR_GLYPH_TARGET_NOT_AVAILABLE                                  = 1059,
    ERR_PVP_WARMODE_TOGGLE_ON                                       = 1060,
    ERR_PVP_WARMODE_TOGGLE_OFF                                      = 1061,
    ERR_SPELL_FAILED_LEVEL_REQUIREMENT                              = 1062,
    ...
    ERR_BATTLEGROUND_NOT_ENABLED                                    = 1066,
    ERR_VOICE_CHAT_GENERIC_UNABLE_TO_CONNECT                        = 1067,
    ERR_VOICE_CHAT_SERVICE_LOST                                     = 1068,
    ERR_VOICE_CHAT_CHANNEL_NAME_TOO_SHORT                           = 1069,
    ERR_VOICE_CHAT_CHANNEL_NAME_TOO_LONG                            = 1070,
    ERR_VOICE_CHAT_CHANNEL_ALREADY_EXISTS                           = 1071,
    ERR_VOICE_CHAT_TARGET_NOT_FOUND                                 = 1072,
    ERR_VOICE_CHAT_TOO_MANY_REQUESTS                                = 1073,
    ERR_VOICE_CHAT_PLAYER_SILENCED                                  = 1074,
    ERR_VOICE_CHAT_PARENTAL_DISABLE_ALL                             = 1075,
    ERR_VOICE_CHAT_DISABLED                                         = 1076,
    ERR_NO_PVP_REWARD                                               = 1077,
    ERR_CLAIMED_PVP_REWARD                                          = 1078,
    ERR_CLUB_FINDER_ERROR_POST_CLUB                                 = 1079,
    ERR_CLUB_FINDER_ERROR_APPLY_CLUB                                = 1080,
    ERR_CLUB_FINDER_ERROR_RESPOND_APPLICANT                         = 1081,
    ERR_CLUB_FINDER_ERROR_CANCEL_APPLICATION                        = 1082,
    ERR_CLUB_FINDER_ERROR_TYPE_ACCEPT_APPLICATION                   = 1083,
    ERR_CLUB_FINDER_ERROR_TYPE_NO_INVITE_PERMISSIONS                = 1084,
    ERR_CLUB_FINDER_ERROR_TYPE_NO_POSTING_PERMISSIONS               = 1085,
    ERR_CLUB_FINDER_ERROR_TYPE_APPLICANT_LIST                       = 1086,
    ERR_CLUB_FINDER_ERROR_TYPE_APPLICANT_LIST_NO_PERM               = 1087,
    ERR_CLUB_FINDER_ERROR_TYPE_FINDER_NOT_AVAILABLE                 = 1088,
    ERR_CLUB_FINDER_ERROR_TYPE_GET_POSTING_IDS                      = 1089,
    ERR_CLUB_FINDER_ERROR_TYPE_JOIN_APPLICATION                     = 1090,
    ERR_CLUB_FINDER_ERROR_TYPE_REALM_NOT_ELIGIBLE                   = 1091,
    ERR_CLUB_FINDER_ERROR_TYPE_FLAGGED_RENAME                       = 1092,
    ERR_CLUB_FINDER_ERROR_TYPE_FLAGGED_DESCRIPTION_CHANGE           = 1093,
    ERR_CANT_USE_PROFANITY                                          = 1094,
    ERR_TARGET_IS_SELF_FOUND_CANNOT_TRADE                           = 1095,
    ERR_PLAYER_IS_SELF_FOUND_CANNOT_TRADE                           = 1096,
    ERR_MAIL_RECEPIENT_IS_SELF_FOUND_CANNOT_RECEIVE_MAIL            = 1097,
    ERR_PLAYER_IS_SELF_FOUND_CANNOT_SEND_MAIL                       = 1098,
    ERR_PLAYER_IS_SELF_FOUND_CANNOT_USE_AUCTION_HOUSE               = 1099,
    ERR_MAIL_TARGET_CANNOT_RECEIVE_MAIL                             = 1100,
};
