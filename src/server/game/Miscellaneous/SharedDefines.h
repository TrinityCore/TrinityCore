...
inline constexpr uint64 MECHANIC_LOSS_CONTROL_MASK(\
    (1 << MECHANIC_CHARM) | (1 << MECHANIC_FEAR) | (1 << MECHANIC_STUN) | (1 << MECHANIC_KNOCKOUT) | \
    (1 << MECHANIC_SLEEP) | (1 << MECHANIC_DISORIENTED) | (1 << MECHANIC_POLYMORPH) | \
    (1 << MECHANIC_BANISH) | (1 << MECHANIC_HORROR));
