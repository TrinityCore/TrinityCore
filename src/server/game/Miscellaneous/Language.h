...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_JAIL_GM_INFO_BANS      = 12131,    // '%s was multiple times jailed and has already %u bans!', '%s wurde bereits mehrfach eingebuchtet, und hat bereits %u Bannung(en)!'
    LANG_JAIL_GM_INFO_ONLY_BANS = 12132,    // 'The account of this character has further %u bans!','Der Account von ihm wurde ausserdem bereits %u mal gebannt!'
    LANG_JAIL_GM_ALREADY_JAILED = 12133,    // '%s is already in the Jail!','%s ist bereits im Knast!'
    LANG_JAIL_GM_NO_DELETE      = 12134,    // 'You can not reset a Jail entry with a banned account!','Das Löschen eines Jaileintrags, dessen Account gebannt wurde, ist nicht möglich!'
