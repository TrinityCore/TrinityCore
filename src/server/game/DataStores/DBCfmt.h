...
char const AreaTableEntryfmt[] = "iiinixxxxxisiiiiiffixxxxxxxxx";
...
char const CreatureDisplayInfoExtrafmt[] = "niiiiiiiiiiiiiiiiiiixx";
char const CreatureFamilyfmt[] = "nfifiiiiixsx";
char const CreatureModelDatafmt[] = "niiifiifffiiiiffffffffffffffffffif";
char const CreatureSpellDatafmt[] = "niiiiiiii";
...
char const DungeonEncounterfmt[] = "niiiisiii";
...
char const LFGDungeonEntryfmt[] = "nsiiiiiiiiiisiiisiiiiiiiiiiii";
char const LightEntryfmt[] = "nifffffiiiiiiii";
char const LiquidTypefmt[] = "nsiiiiffffifiiissssssiiiiiiiiffffffffffffffffffiiii";
...
char const SpecializationSpellsEntryfmt[] = "niiii";
...
char const TalentEntryfmt[] = "niixiiiiiix";
