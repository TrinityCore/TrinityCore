...
enum CurrencyConsts
{
    CURRENCY_TYPE_CURRENCY_TOKEN_TEST_TOKEN_4               = 1,   // Text that describes this item can be found here.
    CURRENCY_TYPE_CURRENCY_TOKEN_TEST_TOKEN_2               = 2,   //
    CURRENCY_TYPE_CURRENCY_TOKEN_TEST_TOKEN_5               = 4,   //
    CURRENCY_TYPE_BIRMINGHAM_TEST_ITEM_3                    = 22,  //
    CURRENCY_TYPE_BADGE_OF_JUSTICE                          = 42,  //
    CURRENCY_TYPE_DALARAN_JEWELCRAFTERS_TOKEN               = 61,  // Dalaran Jewelcrafter's Token
    CURRENCY_TYPE_EPICUREANS_AWARD                          = 81,  // Visit special cooking vendors in capital cities and Northrend Dalaran to purchase unusual cooking recipes, spices, and even a fine hat!
    CURRENCY_TYPE_EMBLEM_OF_HEROISM                         = 101, //
    CURRENCY_TYPE_EMBLEM_OF_VALOR                           = 102, //
    CURRENCY_TYPE_ARENA_POINTS                              = 103, //
    CURRENCY_TYPE_HONOR_POINTS_DEPRECATED                   = 104, // If you can read this, you've found a bug. REPORT IT!
    ...
    CURRENCY_TYPE_WWARSONG_GULCH_MARK_OF_HONOR              = 125, //
    CURRENCY_TYPE_WINTERGRASP_MARK_OF_HONOR                 = 126, //
    CURRENCY_TYPE_STONE_KEEPERS_SHARD                       = 161, //
    CURRENCY_TYPE_HONOR_POINTS_DEPRECATED2                  = 181, // If you can read this, you've found a bug. REPORT IT!
    CURRENCY_TYPE_VENTURE_COIN                              = 201, //
    CURRENCY_TYPE_EMBLEM_OF_CONQUEST                        = 221, //
    CURRENCY_TYPE_CHAMPIONS_SEAL                            = 241, // Awarded for valiant acts in the Crusader's Coliseum.
    CURRENCY_TYPE_EMBLEM_OF_TRIUMPH                         = 301, //
    CURRENCY_TYPE_ISLE_OF_CONQUEST_MARK_OF_HONOR            = 321, //
    CURRENCY_TYPE_EMBLEM_OF_FROST                           = 341, //
    CURRENCY_TYPE_ILLUSTRIOUS_JEWELCRAFTERS_TOKEN           = 361, // Awarded for demonstrating great skill in jewelcrafting, these tokens can be used to purchase unique jewelcrafting plans and the fabulous Chimera's Eye.
    CURRENCY_TYPE_DWARF_ARCHAEOLOFY_FRAGMENT                = 384, //
    CURRENCY_TYPE_TROLL_ARCHAEOLOFY_FRAGMENT                = 385, //
    CURRENCY_TYPE_TOL_BARAD_COMMENDATION                    = 391, // Awarded for brave deeds performed on Tol Barad.
    CURRENCY_TYPE_FOSSIL_ARCHAEOLOFY_FRAGMENT               = 393, //
    CURRENCY_TYPE_NIGHT_ELF_ARCHAEOLOFY_FRAGMENT            = 394, //
    CURRENCY_TYPE_ORC_ARCHAEOLOFY_FRAGMENT                  = 397, //
    CURRENCY_TYPE_DRAENEI_ARCHAEOLOFY_FRAGMENT              = 398, //
    CURRENCY_TYPE_VRYKUL_ARCHAEOLOFY_FRAGMENT               = 399, //
    CURRENCY_TYPE_NERUBIAN_ARCHAEOLOFY_FRAGMENT             = 400, //
    CURRENCY_TYPE_TOLVIR_ARCHAEOLOFY_FRAGMENT               = 401, //
    CURRENCY_TYPE_IRONPAW_TOKEN                             = 402, // Represents your credit with the Ironpaw family of cooks. Can be redeemed for Cooking ingredients and other things at the Stockmaster in Halfhill Market.
    CURRENCY_TYPE_MARK_OF_THE_WORLD_TREE                    = 416, // Granted by the Guardians of Hyjal. Can be used to purchase reinforcements for the Invasion of the Firelands.
    CURRENCY_TYPE_CONQUEST_ARENA_META                       = 483, //
    CURRENCY_TYPE_CONQUEST_RATED_BG_META                    = 484, //
    CURRENCY_TYPE_DARKMOON_PRIZE_TICKET                     = 515, // Awarded for winning games or doing favors at the Darkmoon Faire.
    CURRENCY_TYPE_MOTE_OF_DARKNESS                          = 614, // Extracted from the forces of Deathwing, this dark energy can be used to power amazing magics.
    CURRENCY_TYPE_ESSENCE_OF_CORRUPTED_DEATHWING            = 615, // Extracted from Deathwing himself, this dark energy powers the most fearsome of incantations.
    CURRENCY_TYPE_PANDAREN_ARCHAEOLOFY_FRAGMENT             = 676, //
    CURRENCY_TYPE_MOGU_ARCHAEOLOFY_FRAGMENT                 = 677, //
    CURRENCY_TYPE_CONQUEST_RANDOM_BG_META                   = 692, //
    CURRENCY_TYPE_ELDER_CHARM_OF_GOOD_FORTUNE               = 697, // Possession of the Elder Charm of Good Fortune allows its lucky owner to risk a coin to receive a bonus reward from Mogu'shan Vaults, Heart of Fear, Terrace of Endless Spring, Sha of Anger, or Salyis' Warband.
    CURRENCY_TYPE_ZEN_JEWELCRAFTERS_TOKEN                   = 698, // Awarded for demonstrating great skill in jewelcrafting, these tokens can be used to purchase unique jewelcrafting plans and the beautiful Serpent's Eye.
    CURRENCY_TYPE_LESSER_CHARM_OF_GOOD_FORTUNE              = 738, // Possession of the Lesser Charms of Good Fortune will result in great happiness and the eventual conversion into Warforged Seals, which allow players to risk a coin to receive a bonus reward from raid encounters.
    CURRENCY_TYPE_MOGU_RUNE_OF_FATE                         = 752, // Possession of the Mogu Rune of Fate allows its lucky owner to risk a rune to receive a bonus reward from the Throne of Thunder, Nalak or Oondasta.
    CURRENCY_TYPE_MANTID_ARCHAEOLOFY_FRAGMENT               = 754, //
    CURRENCY_TYPE_WARFORGED_SEAL                            = 776, // Possession of the Warforged Seal allows its lucky owner to risk a seal to receive a bonus reward from the Siege of Orgrimmar, the Celestial Trials, and Ordos.
    CURRENCY_TYPE_TIMELESS_COIN                             = 777, // You feel the shadowy fingers of previous and future owners of this coin playing across your hand, as if time itself blurs. Spend upon the Timeless Isle to earn powerful and fluid rewards.
    CURRENCY_TYPE_BLOOFY_COIN                               = 789, // Pulled from the steaming corpses of foes vanquished in the mists of the Timeless Isle.
    CURRENCY_TYPE_BLACK_IRON_FRAGMENT                       = 810, // Scavenged from the shattered armor and weapons of Iron Horde invaders.
    CURRENCY_TYPE_DRAENOR_ARCHAEOLOFY_FRAGMENT              = 821, //
    CURRENCY_TYPE_APEXIS_CRYSTAL                            = 823, // The enduring legacy of a lost civilization, Apexis crystals contain untold reserves of magical power.
    CURRENCY_TYPE_GARRISON_RESOURCES                        = 824, // Earn resources to build-up and expand your garrison.
    CURRENCY_TYPE_OGRE_ARCHAEOLOFY_FRAGMENT                 = 828, //
    CURRENCY_TYPE_ARAKKOA_ARCHAEOLOFY_FRAGMENT              = 829, //
    CURRENCY_TYPE_NA                                        = 830, //
    CURRENCY_TYPE_UNUSED                                    = 897, //
    CURRENCY_TYPE_SECRET_OF_DRAENOR_ALCHEMY                 = 910, // Allows you to obtain new Alchemy recipes from the Alchemist's Lab.
    CURRENCY_TYPE_ARTIFACT_FRAGMENT                         = 944, // A tiny fragment of an Ashran lost artifact, treasured by the Highmaul Ogres.
    CURRENCY_TYPE_DINGY_IRON_COINS                          = 980, // Perhaps they're more valuable than they appear on the surface.
    CURRENCY_TYPE_SEAL_OF_TEMPERED_FATE                     = 994, // Twists fate to provide an opportunity for additional treasure in Highmaul or Blackrock Foundry raids.
    CURRENCY_TYPE_SECRET_OF_DRAENOR_TAILORING               = 999, // Allows you to obtain Tailoring recipes from the Tailoring Emporium.
    CURRENCY_TYPE_SECRET_OF_DRAENOR_JEWELCRAFTING           = 1008, // Allows you to obtain new Jewelcrafting recipes.
    CURRENCY_TYPE_SECRET_OF_DRAENOR_LEATHERWORKING          = 1017, // Allows you to obtain Leatherworking recipes from the Tannery.
    CURRENCY_TYPE_SECRET_OF_DRAENOR_BLACKSMITHING           = 1020, // Allows you to obtain new Blacksmithing recipes.
    CURRENCY_TYPE_OIL                                       = 1101, // Found primarily in Tanaan Jungle, Oil is used to fuel naval missions.
    CURRENCY_TYPE_SEAL_OF_INEVITABLE_FATE                   = 1129, // Twists fate to provide an opportunity for additional treasure in Hellfire Citadel or Draenor Mythic Dungeons.
    CURRENCY_TYPE_SIGHTLESS_EYE                             = 1149, // A rough, hand-minted coin. It bears a symbol similar to that of the Kirin Tor, with one key difference: the eye is closed.
    CURRENCY_TYPE_SHADOWY_COINS                             = 1154, // Prized by pickpockets and marks alike. Can be spent in the Underbelly below Dalaran.
    CURRENCY_TYPE_ANCIENT_MANA                              = 1155, // Concentrated magic from the ancient leylines beneath Suramar.
    CURRENCY_TYPE_TIMEWARPED_BADGE                          = 1166, // Earned in Timewalking dungeons. Exchanged for goods from Timewalking Vendors in capital cities.
    CURRENCY_TYPE_HIGHBORNE_ARCHAEOLOFY_FRAGMENT            = 1172, //
    CURRENCY_TYPE_HIGHMOUNTAIN_TAUREN_ARCHAEOLOFY_FRAGMENT  = 1173, //
    CURRENCY_TYPE_DEMONIC_ARCHAEOLOFY_FRAGMENT              = 1174, //
    CURRENCY_TYPE_ORDER_RESOURCES                           = 1220, // Used to recruit troops, run missions, and research upgrades for your order hall.
    CURRENCY_TYPE_NETHERSHARD                               = 1226, // A fragment of crystallized nether brought to Azeroth by the Legion.
    CURRENCY_TYPE_TIMEWORN_ARTIFACT                         = 1268, // A mysterious naga artifact from the depths of the Great Sea. King Mrgl-Mrgl is looking for these at Timeworn Strand.
    CURRENCY_TYPE_SEAL_OF_BROKEN_FATE                       = 1273, // Twists fate to provide an opportunity for additional treasure from Legion raid and Mythic dungeon bosses.
    CURRENCY_TYPE_CURIOUS_COIN                              = 1275, // This unusual coin is warm to the touch and vibrates gently in your hand. Used to procure items from Xur'ios in Dalaran.
    CURRENCY_TYPE_BRAWLERS_GOLD                             = 1299, // Awarded to victors of the Brawler's Guild. Use it to purchase Rumble Cards and other world-altering items at the Brawler's Gold Exchange vendor.
    CURRENCY_TYPE_LINGERING_SOUL_FRAGMENT                   = 1314, // Soul fragment once belonging to a powerful enemy.
    CURRENCY_TYPE_LEGIONFALL_WAR_SUPPLIES                   = 1342, // Used to further the construction of valuable structures on the Broken Shore.
    CURRENCY_TYPE_FELESSENCE                                = 1355, // Concentrated demonic essence which can be captured and used to create armor of great power.
    ...
    CURRENCY_TYPE_TRIAL_OF_STYLE_TOKEN                      = 1379, // Earned by participating in the Trial of Style. Can be exchanged for transmoggable gear in most major cities.
    CURRENCY_TYPE_ARMOR_SCRAPS                              = 1388, // Gathered from enemy troops and vehicles throughout the warfront. Used in the training of troops and advancing research.
    CURRENCY_TYPE_STRONGHOLD_SUPPLIES                       = 1401, // Used to build structures and perform research upgrades within a Warfront.
    CURRENCY_TYPE_COINS_OF_AIR                              = 1416, // Evaporate into mist after a while.
    CURRENCY_TYPE_VEILED_ARGUNITE                           = 1508, // This dull-colored crystal is highly valued by ethereal traders, especially Thaumaturge Vashreen aboard the Vindicaar.
    CURRENCY_TYPE_WAKENING_ESSENCE                          = 1533, // Used by Arcanomancer Vridiel in Dalaran above the Broken Isles to create or upgrade Legion Legendary items.
    CURRENCY_TYPE_ZANDALARI_ARCHAEOLOFY_FRAGMENT            = 1534, //
    CURRENCY_TYPE_DRUST_ARCHAEOLOFY_FRAGMENT                = 1535, //
    CURRENCY_TYPE_AZERITE                                   = 1553, // Azerite
    CURRENCY_TYPE_WAR_RESOURCES                             = 1560, // Used to recruit troops, run missions, and research upgrades for your war effort.
    CURRENCY_TYPE_RICH_AZERITE_FRAGMENT                     = 1565, // A fragment of rich Azerite. Turn-in to a nearby War Master for rewards.
    CURRENCY_TYPE_SEAL_OF_WARTORN_FATE                      = 1580, // Twists fate to provide an opportunity for additional treasure from Battle for Azeroth raid and dungeon bosses.
    CURRENCY_TYPE_WARBAND_WIDE_HONOR                        = 1585, // Warband Wide Honor
    CURRENCY_TYPE_HONOR_LEVEL                               = 1586, // Honor Level
    CURRENCY_TYPE_WAR_SUPPLIES                              = 1587, // Used to raise a force for the Battle of Stromgarde
    CURRENCY_TYPE_CONQUEST                                  = 1602, // Earned from Rated PvP activities. Used to purchase Rated PvP equipment.
    CURRENCY_TYPE_SPIRIT_SHARD                              = 1704, // The shard pulses with energy.
    CURRENCY_TYPE_SEAFARCERS_DUBLOON                        = 1710, // Currency used by the many varied tribes of the Great Sea. Used to procure items from traders on Island Expeditions.
    CURRENCY_TYPE_PROGENITOR_SHARD                          = 1715, // TEST
    CURRENCY_TYPE_HONORBOUND_SERVICE_MEDAL                  = 1716, // A badge of merit for action taken on the battlefields of Kul Tiras, Zandalar, and active Warfronts. Sought by Provisioner Mukra at the port of Zandalar. For the Horde!
    CURRENCY_TYPE_7TH_LEGION_SERVICE_MEDAL                  = 1717, // A badge of merit for action taken on the battlefields of Kul Tiras, Zandalar, and active Warfronts. Sought by Provisioner Stoutforge in Boralus. For the Alliance!
    CURRENCY_TYPE_TITAN_RESIDUUM                            = 1718, // Unpowered remnants of Azerite armor coveted by ethereal traders in Boralus and Zandalar. Obtained from Mythic Keystone weekly chests and by scrapping or disenchanting Azerite armor.
    CURRENCY_TYPE_CORRUPTED_MEMENTOS                        = 1719, // Fragments of memory from Horrific Visions of N'Zoth which can be analyzed at the Titanic Research Archive in the Chamber of Heart.
    CURRENCY_TYPE_PRISMATIC_MANAPEARL                       = 1721, // A glistening sphere of arcane energy found around Nazjatar. These can be traded for rare and powerful items, or used to empower Benthic armor.
    CURRENCY_TYPE_FAKE_ANIMA_FOR_QUEST_TRACKING             = 1743, // Use 1813 for anything real
    CURRENCY_TYPE_ARGENT_COMMENDATION                       = 1754, // Commendation from the Argent Crusade in northern Icecrown for actions taken against the invading forces of the Shadowlands.
    CURRENCY_TYPE_COALESCING_VISIONS                        = 1755, // Wrathion can manipulate these visions into a vessel that will allow you to gain access to a Horrific Vision of N'Zoth.
    CURRENCY_TYPE_STYGIA                                    = 1767, // The byproduct of the violent destruction of a Soul within the Maw.
    CURRENCY_TYPE_HONOR                                     = 1792, // Used to purchase Unrated PvP equipment.
    CURRENCY_TYPE_SHADOWLANDS_PVP_WEEKLY_REWARD_PROGRESS    = 1802, // Acquire this currency to attain rewards from the weekly chest in Oribos.
    CURRENCY_TYPE_ECHOES_OF_NYALOTHA                        = 1803, // Scoured of N'Zoth's corruption, MOTHER can use this substance to synthesize essences in the Chamber of Heart.
    CURRENCY_TYPE_ZZOLDSANCTUM_ARCHITECT                    = 1811, //
    CURRENCY_TYPE_ZZOLDSANCTUM_ANIMA_WEAVER                 = 1812, //
    CURRENCY_TYPE_RESERVOIR_ANIMA                           = 1813, // A measure of the anima your covenant has at its disposal.
    CURRENCY_TYPE_SINSTONE_FRAGMENTS                        = 1816, // Archivist Fane can use these to recreate Inquisitor Sinstones, which will allow you to hunt inquisitors in the Halls of Atonement.
    CURRENCY_TYPE_MEDALLION_OF_SERVICE                      = 1819, // A mark of service to Bastion. Used in Ascension Crafting.
    CURRENCY_TYPE_INFUSED_RUBY                              = 1820, // Used to power shrines and devices that run on anima in Revendreth. With the drought, various dredgers have begun trading goods for them as well.
    CURRENCY_TYPE_SOUL_ASH                                  = 1828, // A raw source of power found within Torghast. Used to fuel the Runecarver's Chamber.
    CURRENCY_TYPE_RENOWN_KYRIAN                             = 1829, // It's Renown
    CURRENCY_TYPE_RENOWN_VENTHYR                            = 1830, // It's Renown
    CURRENCY_TYPE_RENOWN_NIGHTFAE                           = 1831, // It's Renown
    CURRENCY_TYPE_RENOWN_NECROLORD                          = 1832, // It's Renown
    CURRENCY_TYPE_LINKED_CURRENCY_TEST_SRC_PTH              = 1835, // A test source currency for the new linked currency feature.
    CURRENCY_TYPE_LINKED_CURRENCY_TEST_TEST_DST             = 1836, // A test destination currency for the new linked currency feature.
    CURRENCY_TYPE_RESERVOIR_ANIMA_KYRIAN                    = 1859, //
    CURRENCY_TYPE_RESERVOIR_ANIMA_VENTHYR                   = 1860, //
    CURRENCY_TYPE_RESERVOIR_ANIMA_NIGHT_FAE                 = 1861, //
    CURRENCY_TYPE_RESERVOIR_ANIMA_NECROLORD                 = 1862, //
    CURRENCY_TYPE_REDEEMED_SOUL_KYRIAN                      = 1863, //
    CURRENCY_TYPE_REDEEMED_SOUL_VENTHYR                     = 1864, //
    CURRENCY_TYPE_REDEEMED_SOUL_NIGHT_FAE                   = 1865, //
    CURRENCY_TYPE_REDEEMED_SOUL_NECROLORD                   = 1866, //
    CURRENCY_TYPE_SANCTUM_ARCHITECT_KYRIAN                  = 1867, //
    CURRENCY_TYPE_SANCTUM_ARCHITECT_VENTHYR                 = 1868, //
    CURRENCY_TYPE_SANCTUM_ARCHITECT_NIGHT_FAE               = 1869, //
    CURRENCY_TYPE_SANCTUM_ARCHITECT_NECROLORD               = 1870, //
    CURRENCY_TYPE_SANCTUM_ANIMA_KYRIAN                      = 1871, //
    CURRENCY_TYPE_SANCTUM_ANIMA_VENTHYR                     = 1872, //
    CURRENCY_TYPE_SANCTUM_ANIMA_NIGHT_FAE                   = 1873, //
    CURRENCY_TYPE_SANCTUM_ANIMA_NECROLORD                   = 1874, //
    CURRENCY_TYPE_GRATEFUL_OFFERING                         = 1885, // A gift from the denizens of the Shadowlands, grateful for the return of anima. Acquired from conducting anima to a location and performing activities associated with the inhabitants.
    CURRENCY_TYPE_TOWER_KNOWLEDGE                           = 1904, // Manifestation of knowledge gained in Torghast. Used to unlock the power within The Box of Many Things.
    CURRENCY_TYPE_SOUL_CINDERS                              = 1906, // A raw source of power found within only the most dangerous layers of Torghast. Used to fuel the Runecarver's Chamber.
    CURRENCY_TYPE_CATALOGED_RESEARCH                        = 1931, // As you bring the Archivist relics he will catalog it which will allow you to start Field Studies to learn more about them or identify relics in his care that you can use in the field.
    CURRENCY_TYPE_STYGIAN_EMBER                             = 1977, // Once a brave warrior, now reduced to a sliver of undeath. Bonesmith Heirmir in Korthia can use these to improve Shards of Domination.
    CURRENCY_TYPE_CYPHERS_OF_THE_FIRST_ONES                 = 1979, // |L290-Echoes of the power used to forge reality itself. Can be deciphered at Firim's Cypher Console in Exile's Hollow.|l
    CURRENCY_TYPE_PADEN_TEST_CURRENCY                       = 2001, // Paden Test Currency
    ...
    CURRENCY_TYPE_DRUID_TALENT_POINTS_DNT                   = 2005, //
    CURRENCY_TYPE_RESTORATION_TALENT_POINTS_DNT             = 2006, //
    CURRENCY_TYPE_COSMIC_FLUX                               = 2009, // Swirling fragments of creation energy that enable transformation, Cosmic Flux can be used to empower equipment at the Creation Catalyst in Zereth Mortis or fuel the Runecarver's Chamber in Torghast.
    CURRENCY_TYPE_DNT_BYRON_TEST_CURRENCY                   = 2010, // A currency used to test currencies.
    CURRENCY_TYPE_EFFIGY_ADORNMENTS                         = 2011, // Crafted by the Shikaar, these adornments can enhance Major Hunt effigies.
    CURRENCY_TYPE_DEATH_KNIGHT_TALENT_POINTS_DNT            = 2012, //
    CURRENCY_TYPE_FROST_TALENT_POINTS_DNT                   = 2013, //
    CURRENCY_TYPE_UNHOLY_TALENT_POINTS_DNT                  = 2014, //
    CURRENCY_TYPE_BLOOD_TALENT_POINTS_DNT                   = 2015, //
    CURRENCY_TYPE_TRADERS_TENDER                            = 2032, // Trader's Tender is exchanged for goods with the Trading Post.
    CURRENCY_TYPE_DRAGON_GLYPH_EMBERS                       = 2045, // Proof of being bathed in the dragonfire of Dragon Glyphs. Can be turned in to Dragonrider trainers for enhanced training.
    CURRENCY_TYPE_AC_MAJOR_FACTION_TEST_CURRENCY            = 2073, //
    CURRENCY_TYPE_PURIFIED_ARCANE_ENERGY                    = 2105, // This arcane energy has been stabilized and can be used throughout the Cobalt Assembly.
    CURRENCY_TYPE_ELEMENTAL_OVERFLOW                        = 2118, // The essence of fallen foes imbued with the power of a primal storm. Used to procure items from Mythressa in Valdrakken and various vendors in Morqut village.
    CURRENCY_TYPE_STORM_SIGIL                               = 2122, // A symbol of recognition for the brave adventurers who quelled the primal storms. Used to upgrade Primal Storm gear.
    CURRENCY_TYPE_BLOODY_TOKENS                             = 2123, // Earned from War Mode activities. Used to purchase War Mode equipment.
    CURRENCY_TYPE_COBALT_ASSEMBLY                           = 2134, // Grants Cobalt Assembly Reputation
    CURRENCY_TYPE_DARKMOON_PRIZE_TICKET_VOID                = 2230, // Darkmoon Prize Ticket (Void)
    CURRENCY_TYPE_FLIGHSTONES                               = 2245, // Earned from completing world quests, raids, dungeons, battlegrounds, arena matches, and other activities. Used to upgrade max-level gear.
    CURRENCY_TYPE_ZZOLD_DELVING_GEMS                        = 2531, // Payment for recovering various lost artifacts within delves.
    CURRENCY_TYPE_RIDERS_OF_AZEROTH_BADGE                   = 2588, // Earned in Riders of Azeroth contests. Exchanged for goods from Riders of Azeroth vendors in Valdrakken.
    CURRENCY_TYPE_LOST_TRANSCRIPTS                          = 2590, // Various Earthen treasures and relics previously thought to be lost.
    CURRENCY_TYPE_11_0_DELVES_SCORE_INSIDE                  = 2591, // Payment for recovering various lost artifacts within delves.
    CURRENCY_TYPE_11_0_DELVES_REPUTATION_SCORE              = 2592, // Payment for recovering various lost artifacts within delves.
    CURRENCY_TYPE_PARACAUSAL_FLAKES                         = 2594, // Specks of temporal energy imbued with enough power to be tangible. Valuable to vendors in the Tyrhold Reservoir.
    CURRENCY_TYPE_EMERALD_DEWDROP                           = 2650, // Dew infused with the nurturing properties of the Emerald Dream which can make any plant bloom. Used to revitalize the plants in the Emerald Dream.
    CURRENCY_TYPE_SEEDBLOOM                                 = 2651, // The blooms from plants infused with Lifebloom Essence. These have powerful aesthetic and revitalizing properties. Used to procure items from Talia Whisperbloom in the Central Encampment.
    CURRENCY_TYPE_MYSTERIOUS_FRAGMENT                       = 2657, // Obtained by assisting the Azerothian Archivists in the Dragon Isles. Bring them to Provisioner Aristta in Thaldraszus to exchange for items.
    CURRENCY_TYPE_DREAM_INFUSION                            = 2777, // Used to draw forth a creature's dreaming essence. Elianna at the Central Encampment would be interested in this.
    CURRENCY_TYPE_BRONZE                                    = 2778, // Eternus' Infinite allies trade using loose threads of time compressed into bronze coins.
    CURRENCY_TYPE_TROPHY_OF_STRIFE                          = 2797, // Proof of your combat prowess throughout the Dragon Isles. Acquired from the Sparks of Life weekly quest. Used to purchase War Mode gear.
    CURRENCY_TYPE_UNDERCOIN                                 = 2803, // A currency commonly used by explorers looking to trade secrets and tales of wealth.
    CURRENCY_TYPE_WHELPLINGS_AWAKENED_CREST                 = 2806, // Earned from many outdoor activities, Raid Finder raids, and Heroic dungeons during Dragonflight Season 4.
    CURRENCY_TYPE_DRAKES_AWAKENED_CREST                     = 2807, // Earned from some outdoor activities, Normal difficulty raids, and Mythic 0 dungeons during Dragonflight Season 4.
    CURRENCY_TYPE_WYRMS_AWAKENED_CREST                      = 2809, // Earned from Heroic difficulty raids and Mythic Keystone dungeons up to +5 during Dragonflight Season 4.
    CURRENCY_TYPE_ASPECTS_AWAKENED_CREST                    = 2812, // Earned from Mythic difficulty raids and Mythic Keystone dungeons from +6 and up during Dragonflight Season 4.
    CURRENCY_TYPE_RESONANCE_CRYSTALS                        = 2815, // Formed by the energies of the Worldsoul interacting with the stone in and beneath Khaz Algar, these revered objects are used to purchase rewards unlocked from renown.
    CURRENCY_TYPE_DNT_CORGI_CACHE                           = 2822, // [DNT] Corgi Cache
    CURRENCY_TYPE_DNT_AWAKENING_CURRENCY                    = 2839, //
    CURRENCY_TYPE_WEATHERED_HARBINGER_CREST                 = 2914, // Earned from many outdoor activities, Raid Finder Nerub-ar Palace, and Heroic dungeons during The War Within Season 1.
    CURRENCY_TYPE_CARVED_HARBINGER_CREST                    = 2915, // Earned from some outdoor activities, Normal Nerub-ar Palace, Mythic dungeons, and Mythic Keystone dungeons up to +3 during The War Within Season 1.
    CURRENCY_TYPE_RUNED_HARBINGER_CREST                     = 2916, // Earned from Heroic Nerub-ar Palace and Mythic Keystone dungeons from +4 to +7 during The War Within Season 1.
    CURRENCY_TYPE_GILDED_HARBINGER_CREST                    = 2917, // Earned from Mythic Nerub-ar Palace and Mythic Keystone dungeons from +8 and up during The War Within Season 1.
    CURRENCY_TYPE_VALORSTONERS                              = 3008, // Earned from completing quests, raids, dungeons, battlegrounds, arena matches, and other activities at max level. Used to upgrade max-level gear.
    CURRENCY_TYPE_RESTORED_COFFER_KEY                       = 3028, // Restored from combining 100 Coffer Key Shards obtained from the outdoors. Opens a Bountiful Coffer within a Bountiful Delve.
    CURRENCY_TYPE_MERELDAR_DERBY_MARK                       = 3055, // A record of a unique catch during the Mereldar Fishing Derby.
    CURRENCY_TYPE_KEJ                                       = 3056, // Wealth woven into strands and saturated with aromas that convey their value to any vendor of Azj-Kahet.
    CURRENCY_TYPE_RESIDUAL_MEMORIES                         = 3089, // Half-forgotten memories can be glimpsed in the light playing across this iridescent powder.
    CURRENCY_TYPE_FLAME_BLESSED_IRON                        = 3090, // Ore infused with mysterious properties after prolonged exposure to the Siren Crystal.
    CURRENCY_TYPE_NERUB_AR_FINERY                           = 3093, // Adorning the armor of the devoted, these insignias are a symbol of high society among the privileged inhabitants of Nerub-ar. Inside the palace, Anub'azal can smuggle these out to The Severed Threads and in exchange, strengthen your assault.
    CURRENCY_TYPE_BRONZE_CELEBRATION_TOKEN                  = 3100, // Earned from weekly activities during the 20th Bronze Celebration. Exchanged for new items at the Bronze Celebration outside the Caverns of Time.
    CURRENCY_TYPE_WEEKLY_LIMIT_TEST_CURRENCY                = 3180, // Weekly Limit Test Currency

    // Currency Max Cap
    CURRENCY_MAX_CAP_DWARF_ARCHAEOLOFY_FRAGMENT                 = 200,
    CURRENCY_MAX_CAP_TROLL_ARCHAEOLOFY_FRAGMENT                 = 200,
    CURRENCY_MAX_CAP_FOSSIL_ARCHAEOLOFY_FRAGMENT                = 200,
    CURRENCY_MAX_CAP_NIGHT_ELF_ARCHAEOLOFY_FRAGMENT             = 200,
    CURRENCY_MAX_CAP_ORC_ARCHAEOLOFY_FRAGMENT                   = 200,
    CURRENCY_MAX_CAP_DRAENEI_ARCHAEOLOFY_FRAGMENT               = 200,
    CURRENCY_MAX_CAP_VRYKUL_ARCHAEOLOFY_FRAGMENT                = 200,
    CURRENCY_MAX_CAP_NERUBIAN_ARCHAEOLOFY_FRAGMENT              = 200,
    CURRENCY_MAX_CAP_TOLVIR_ARCHAEOLOFY_FRAGMENT                = 200,
    CURRENCY_MAX_CAP_PANDAREN_ARCHAEOLOFY_FRAGMENT              = 200,
    CURRENCY_MAX_CAP_MOGU_ARCHAEOLOFY_FRAGMENT                  = 200,
    CURRENCY_MAX_CAP_ELDER_CHARM_OF_GOOD_FORTUNE                = 20,
    CURRENCY_MAX_CAP_MOGU_RUNE_OF_FATE                          = 20,
    CURRENCY_MAX_CAP_MANTID_ARCHAEOLOFY_FRAGMENT                = 200,
    CURRENCY_MAX_CAP_WARFORGED_SEAL                             = 20,
    CURRENCY_MAX_CAP_DRAENOR_ARCHAEOLOFY_FRAGMENT               = 250,
    CURRENCY_MAX_CAP_GARRISON_RESOURCES                         = 10000,
    CURRENCY_MAX_CAP_OGRE_ARCHAEOLOFY_FRAGMENT                  = 250,
    CURRENCY_MAX_CAP_ARAKKOA_ARCHAEOLOFY_FRAGMENT               = 250,
    CURRENCY_MAX_CAP_UNUSED                                     = 100,
    CURRENCY_MAX_CAP_ARTIFACT_FRAGMENT                          = 100000,
    CURRENCY_MAX_CAP_DINGY_IRON_COINS                           = 2000000,
    CURRENCY_MAX_CAP_SEAL_OF_TEMPERED_FATE                      = 20,
    CURRENCY_MAX_CAP_OIL                                        = 100000,
    CURRENCY_MAX_CAP_SEAL_OF_INEVITABLE_FATE                    = 20,
    CURRENCY_MAX_CAP_SIGHTLESS_EYE                              = 5000,
    CURRENCY_MAX_CAP_SHADOWY_COINS                              = 500,
    CURRENCY_MAX_CAP_ANCIENT_MANA                               = 300,
    CURRENCY_MAX_CAP_HIGHBORNE_ARCHAEOLOFY_FRAGMENT             = 200,
    CURRENCY_MAX_CAP_HIGHMOUNTAIN_TAUREN_ARCHAEOLOFY_FRAGMENT   = 200,
    CURRENCY_MAX_CAP_DEMONIC_ARCHAEOLOFY_FRAGMENT               = 200,
    CURRENCY_MAX_CAP_TIMEWORN_ARTIFACT                          = 100000,
    CURRENCY_MAX_CAP_SEAL_OF_BROKEN_FATE                        = 6,
    CURRENCY_MAX_CAP_LINGERING_SOUL_FRAGMENT                    = 40,
    CURRENCY_MAX_CAP_LEGIONFALL_WAR_SUPPLIES                    = 1000,
    CURRENCY_MAX_CAP_COINS_OF_AIR                               = 2000000,
    CURRENCY_MAX_CAP_VEILED_ARGUNITE                            = 2000,
    CURRENCY_MAX_CAP_TRIAL_OF_STYLE_TOKEN                       = 200,
    CURRENCY_MAX_CAP_ARMOR_SCRAPS                               = 500,
    CURRENCY_MAX_CAP_STRONGHOLD_SUPPLIES                        = 1000,
    CURRENCY_MAX_CAP_ZANDALARI_ARCHAEOLOFY_FRAGMENT             = 200,
    CURRENCY_MAX_CAP_DRUST_ARCHAEOLOFY_FRAGMENT                 = 200,
    CURRENCY_MAX_CAP_BRAWLERS_GOLD                              = 5000,
    CURRENCY_MAX_CAP_RICH_AZERITE_FRAGMENT                      = 100000,
    CURRENCY_MAX_CAP_SEAL_OF_WARTORN_FATE                       = 5,
    CURRENCY_MAX_CAP_WAR_SUPPLIES                               = 1000,
    CURRENCY_MAX_CAP_SPIRIT_SHARD                               = 200,
    CURRENCY_MAX_CAP_SEAFARCERS_DUBLOON                         = 5000,
    CURRENCY_MAX_CAP_RESERVOIR_ANIMA                            = 200000,
    CURRENCY_MAX_CAP_INFUSED_RUBY                               = 100,
    CURRENCY_MAX_CAP_RENOWN_KYRIAN                              = 79,
    CURRENCY_MAX_CAP_RENOWN_VENTHYR                             = 79,
    CURRENCY_MAX_CAP_RENOWN_NIGHTFAE                            = 79,
    CURRENCY_MAX_CAP_RENOWN_NECROLORD                           = 79,
    CURRENCY_MAX_CAP_LINKED_CURRENCY_TEST_TEST_DST              = 100,
    CURRENCY_MAX_CAP_RESERVOIR_ANIMA_KYRIAN                     = 200000,
    CURRENCY_MAX_CAP_RESERVOIR_ANIMA_VENTHYR                    = 200000,
    CURRENCY_MAX_CAP_RESERVOIR_ANIMA_NIGHT_FAE                  = 200000,
    CURRENCY_MAX_CAP_RESERVOIR_ANIMA_NECROLORD                  = 200000,
    CURRENCY_MAX_CAP_HONOR                                      = 15000,
    CURRENCY_MAX_CAP_AC_MAJOR_FACTION_TEST_CURRENCY             = 80000,
    CURRENCY_MAX_CAP_FLIGHSTONES                                = 2000,
    CURRENCY_MAX_CAP_ZZOLD_DELVING_GEMS                         = 2000,
    CURRENCY_MAX_CAP_LOST_TRANSCRIPTS                           = 2000,
    CURRENCY_MAX_CAP_11_0_DELVES_SCORE_INSIDE                   = 2000,
    CURRENCY_MAX_CAP_11_0_DELVES_REPUTATION_SCORE               = 2000,
    CURRENCY_MAX_CAP_BRONZE                                     = 2000000,
    CURRENCY_MAX_CAP_WHELPLINGS_AWAKENED_CREST                  = 90,
    CURRENCY_MAX_CAP_DRAKES_AWAKENED_CREST                      = 90,
    CURRENCY_MAX_CAP_WYRMS_AWAKENED_CREST                       = 90,
    CURRENCY_MAX_CAP_ASPECTS_AWAKENED_CREST                     = 90,
    CURRENCY_MAX_CAP_WEATHERED_HARBINGER_CREST                  = 90,
    CURRENCY_MAX_CAP_CARVED_HARBINGER_CREST                     = 90,
    CURRENCY_MAX_CAP_RUNED_HARBINGER_CREST                      = 90,
    CURRENCY_MAX_CAP_GILDED_HARBINGER_CREST                     = 90,
    CURRENCY_MAX_CAP_VALORSTONERS                               = 2000,
    CURRENCY_MAX_CAP_NERUB_AR_FINERY                            = 8,
    CURRENCY_MAX_CAP_WEEKLY_LIMIT_TEST_CURRENCY                 = 100
};
