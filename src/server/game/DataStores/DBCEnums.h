...
enum class CriteriaType : uint8
{
    ...
    RunInstance                                    = 19,  // Run an instance which handles at most {#Max Players} players
    KilledByCreature                               = 20,  // Get killed by "{Creature}"
    CompleteInternalCriteria                       = 21,  // Designer Value{`Uses Record ID}
    ...
    EarnChallengeModeMedal                         = 25,  // Earn a challenge mode medal of "{#Challenge Mode Medal (OBSOLETE)}" (OBSOLETE)
    ...
    EarnTeamArenaRating                            = 38,  // Earn a team arena rating of {#Arena Rating}
    ...
    EarnTitle                                      = 44,  // Deprecated PVP Titles
    ...
    CompleteQuestsInSort                           = 58,  // Complete quests in "{QuestSort}"
    ...
    CreatedItemsByCastingSpellWithLimit            = 79,  // Created items by casting a spell (limit 1 per create...)
    MoneyEarnedFromAuctions                        = 80,  // Money earned from auctions
    BattlePetAchievementPointsEarned               = 81,  // Battle pet achievement points earned
    ...
    ReleasedSpirit                                 = 95,  // Released Spirit
    AccountKnownPet                                = 96,  // Account knows pet "{Creature}" (Backtracked)
    ...
    RollDisenchant                                 = 116, // Roll disenchant and get {#Disenchant Roll}
    RollAnyDisenchant                              = 117, // Roll any number on disenchant
    ...
    KickInitiatorInLFGDungeon                      = 120, // Kicked in an LFG dungeon (initiator)
    KickVoterInLFGDungeon                          = 121, // Kicked in an LFG dungeon (voter)
    KickTargetInLFGDungeon                         = 122, // Kicked in an LFG dungeon (target)
    AbandonedLFGDungeon                            = 123, // Abandoned an LFG dungeon
    MoneySpentOnGuildRepair                        = 124, // Guild repair amount spent
    GuildAttainedLevel                             = 125, // Guild attained level
    CreatedItemsByCastingSpell                     = 126, // Created items by casting a spell
    FishInAnyPool                                  = 127, // Fish in any pool
    GuildBankTabsPurchased                         = 128, // Guild bank tabs purchased
    EarnGuildAchievementPoints                     = 129, // Earn guild achievement points
    WinAnyBattleground                             = 130, // Win any battleground
    ParticipateInAnyBattleground                   = 131, // Participate in any battleground
    EarnBattlegroundRating                         = 132, // Earn a battleground rating
    GuildTabardCreated                             = 133, // Guild tabard created
    CompleteQuestsCountForGuild                    = 134, // Count of complete quests for guild (Quest count)
    HonorableKillsForGuild                         = 135, // Honorable kills for Guild
    KillAnyCreatureForGuild                        = 136, // Kill any NPC for Guild
    GroupedTankLeftEarlyInLFGDungeon               = 137, // Grouped tank left early in an LFG dungeon
    CompleteGuildChallenge                         = 138, // Complete a "{$Guild Challenge}" guild challenge
    CompleteAnyGuildChallenge                      = 139, // Complete any guild challenge
    MarkedAFKInBattleground                        = 140, // Marked AFK in a battleground
    RemovedAFKInBattleground                       = 141, // Removed for being AFK in a battleground
    StartAnyBattleground                           = 142, // Start any battleground (AFK tracking)
    CompleteAnyBattleground                        = 143, // Complete any battleground (AFK tracking)
    MarkedSomeoneAFKInBattleground                 = 144, // Marked someone for being AFK in a battleground
    CompletedLFRDungeon                            = 145, // Completed an LFR dungeon
    AbandonedLFRDungeon                            = 146, // Abandoned an LFR dungeon
    KickInitiatorInLFRDungeon                      = 147, // Kicked in an LFR dungeon (initiator)
    KickVoterInLFRDungeon                          = 148, // Kicked in an LFR dungeon (voter)
    KickTargetInLFRDungeon                         = 149, // Kicked in an LFR dungeon (target)
    GroupedTankLeftEarlyInLFRDungeon               = 150, // Grouped tank left early in an LFR dungeon
    ...
    AccountObtainPetThroughBattle                  = 157, // (Account Only) Obtain a pet through battle
    ...
    PlayerObtainPetThroughBattle                   = 161, // (Player) Obtain a pet through battle
    ...
    PlaceAnyGarrisonBuilding                       = 166, // Garrison Building: Place any
    ...
    ActivateGarrisonBuilding                       = 169, // Garrison Building: Activate "{GarrBuilding}"
    UpgradeGarrison                                = 170, // Garrison: Upgrade Garrison to Tier "{#Tier:2,3}"
    StartAnyGarrisonMissionWithFollowerType        = 171, // Garrison Mission: Start any with FollowerType "{GarrFollowerType}"
    StartGarrisonMission                           = 172, // Garrison Mission: Start "{GarrMission}"
    SucceedAnyGarrisonMissionWithFollowerType      = 173, // Garrison Mission: Succeed any with FollowerType "{GarrFollowerType}"
    SucceedGarrisonMission                         = 174, // Garrison Mission: Succeed "{GarrMission}"
    RecruitAnyGarrisonFollower                     = 175, // Garrison Follower: Recruit any
    RecruitGarrisonFollower                        = 176, // Garrison Follower: Recruit "{GarrFollower}"
    AcquireGarrison                                = 177, // Garrison: Acquire a Garrison
    LearnAnyGarrisonBlueprint                      = 178, // Garrison Blueprint: Learn any
    LearnGarrisonBlueprint                         = 179, // Garrison Blueprint: Learn "{GarrBuilding}"
    LearnAnyGarrisonSpecialization                 = 180, // Garrison Specialization: Learn any
    LearnGarrisonSpecialization                    = 181, // Garrison Specialization: Learn "{GarrSpecialization}"
    ...
    PrestigeLevelIncrease                          = 195, // (Player) prestige level increase
    ActivelyReachLevel                             = 196, // Actively level to level {#Level}
    CompleteResearchAnyGarrisonTalent              = 197, // Garrison Talent: Complete Research Any
    CompleteResearchGarrisonTalent                 = 198, // Garrison Talent: Complete Research "{GarrTalent}"
    ...
    CompleteAnyQuest                               = 203, // Complete Any Quest
    EarnLicense                                    = 204, // Earn License "{BattlePayDeliverable}" (does NOT work for box level)
    ...
    KillCreatureScenario                           = 208, // Kill NPC "{Creature}" (scenario criteria only, do not use for player)
    ArtifactPowerRankPurchased                     = 209, // Artifact Power Rank of "{ArtifactPower}" Purchased
    ChooseAnyRelicTalent                           = 210, // Choose any Relic Talent
    ChooseRelicTalent                              = 211, // Choose Relic Talent "{ArtifactPower}"
    EarnExpansionLevel                             = 212, // Earn Expansion Level "{$Expansion Level}"
    AccountHonorLevelReached                       = 213, // (Account Only) honor level {#Level} reached
    ...
    ScenarioGroupCompleted                         = 217, // Scenario Group Completed
    ...
    MemorizeSpell                                  = 222, // Memorize Spell "{Spell}"
    LearnTransmogIllusion                          = 223, // Learn Transmog Illusion
    ...
    ObtainAnyItemWithCurrencyValue                 = 229, // Obtain Any Item With Currency Value "{CurrencyTypes}"
    MythicPlusRatingAttained                       = 230, // (Player) Mythic+ Rating "{#DungeonScore}" attained
    SpentTalentPoint                               = 231, // (Player) spent talent point
