...
struct ItemLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { false, FT_SHORT, "ModifiedCraftingReagentItemID" },
            { true, FT_INT, "IconFileDataID" },
...
struct ItemSparseLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static constexpr DB2FieldMeta fields[] =
        {
            ...
            { true, FT_SHORT, "StatModifier_bonusAmount1" },
            { true, FT_SHORT, "StatModifier_bonusAmount2" },
            { true, FT_SHORT, "StatModifier_bonusAmount3" },
            { true, FT_SHORT, "StatModifier_bonusAmount4" },
            { true, FT_SHORT, "StatModifier_bonusAmount5" },
            { true, FT_SHORT, "StatModifier_bonusAmount6" },
            { true, FT_SHORT, "StatModifier_bonusAmount7" },
            { true, FT_SHORT, "StatModifier_bonusAmount8" },
            { true, FT_SHORT, "StatModifier_bonusAmount9" },
            { true, FT_SHORT, "StatModifier_bonusAmount10" },
