...
enum WintergraspWorldStates
{
    ...
    // Archavon's Log entries
    BATTLEFIELD_WG_WORLD_STATE_LOG_CAPTURED_H    = 4022,
    BATTLEFIELD_WG_WORLD_STATE_LOG_CAPTURED_A    = 4023,
    BATTLEFIELD_WG_WORLD_STATE_LOG_DEFENDED_H    = 4024,
    BATTLEFIELD_WG_WORLD_STATE_LOG_DEFENDED_A    = 4025
};
