...
class TC_GAME_API Group
{
 ...
 static void   ConvertLeaderInstancesToGroup(Player* player, Group* group, bool switchLeader);
        ...
        void SendLootRoll(ObjectGuid SourceGuid, ObjectGuid TargetGuid, int8 RollNumber, uint8 RollType, const Roll &r);
        void SendLootRollWon(ObjectGuid SourceGuid, ObjectGuid TargetGuid, int8 RollNumber, uint8 RollType, const Roll &r);
