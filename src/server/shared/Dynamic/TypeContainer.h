...
#ifndef GreenPis_TYPECONTAINER_H
#define GreenPis_TYPECONTAINER_H
...
{
    public:
        template<class SPECIFIC_TYPE> size_t Count() const { return GreenPis::Count(i_elements, (SPECIFIC_TYPE*)NULL); }

        /// inserts a specific object into the container
        template<class SPECIFIC_TYPE> bool insert(SPECIFIC_TYPE *obj)
        {
            SPECIFIC_TYPE* t = GreenPis::Insert(i_elements, obj);
            return (t != NULL);
        }
        ...
        //{
        //    SPECIFIC_TYPE* t = GreenPis::Remove(i_elements, obj);
        //    return (t != NULL);
        //}
