...
private:
    ...
    void UpdateRealm(Battlenet::RealmHandle const& id, uint32 build, const std::string& name, boost::asio::ip::address const& address, boost::asio::ip::address const& localAddr,
