...
template <>
TC_API_EXPORT size_t EnumUtils<SpellCastResult>::Count() { return 188; }
...
TC_API_EXPORT SpellCastResult EnumUtils<SpellCastResult>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 1: return SPELL_FAILED_ALREADY_AT_FULL_HEALTH;
        case 2: return SPELL_FAILED_ALREADY_AT_FULL_MANA;
        case 3: return SPELL_FAILED_ALREADY_AT_FULL_POWER;
        case 4: return SPELL_FAILED_ALREADY_BEING_TAMED;
        case 5: return SPELL_FAILED_ALREADY_HAVE_CHARM;
        case 6: return SPELL_FAILED_ALREADY_HAVE_SUMMON;
        case 7: return SPELL_FAILED_ALREADY_OPEN;
        case 8: return SPELL_FAILED_AURA_BOUNCED;
        case 9: return SPELL_FAILED_AUTOTRACK_INTERRUPTED;
        case 10: return SPELL_FAILED_BAD_IMPLICIT_TARGETS;
        case 11: return SPELL_FAILED_BAD_TARGETS;
        case 12: return SPELL_FAILED_CANT_BE_CHARMED;
        case 13: return SPELL_FAILED_CANT_BE_DISENCHANTED;
        case 14: return SPELL_FAILED_CANT_BE_DISENCHANTED_SKILL;
        case 15: return SPELL_FAILED_CANT_BE_MILLED;
        case 16: return SPELL_FAILED_CANT_BE_PROSPECTED;
        case 17: return SPELL_FAILED_CANT_CAST_ON_TAPPED;
        case 18: return SPELL_FAILED_CANT_DUEL_WHILE_INVISIBLE;
        case 19: return SPELL_FAILED_CANT_DUEL_WHILE_STEALTHED;
        case 20: return SPELL_FAILED_CANT_STEALTH;
        case 21: return SPELL_FAILED_CASTER_AURASTATE;
        case 22: return SPELL_FAILED_CASTER_DEAD;
        case 23: return SPELL_FAILED_CHARMED;
        case 24: return SPELL_FAILED_CHEST_IN_USE;
        case 25: return SPELL_FAILED_CONFUSED;
        case 26: return SPELL_FAILED_DONT_REPORT;
        case 27: return SPELL_FAILED_EQUIPPED_ITEM;
        case 28: return SPELL_FAILED_EQUIPPED_ITEM_CLASS;
        case 29: return SPELL_FAILED_EQUIPPED_ITEM_CLASS_MAINHAND;
        case 30: return SPELL_FAILED_EQUIPPED_ITEM_CLASS_OFFHAND;
        case 31: return SPELL_FAILED_ERROR;
        case 32: return SPELL_FAILED_FIZZLE;
        case 33: return SPELL_FAILED_FLEEING;
        case 34: return SPELL_FAILED_FOOD_LOWLEVEL;
        case 35: return SPELL_FAILED_HIGHLEVEL;
        case 36: return SPELL_FAILED_HUNGER_SATIATED;
        case 37: return SPELL_FAILED_IMMUNE;
        case 38: return SPELL_FAILED_INCORRECT_AREA;
        case 39: return SPELL_FAILED_INTERRUPTED;
        case 40: return SPELL_FAILED_INTERRUPTED_COMBAT;
        case 41: return SPELL_FAILED_ITEM_ALREADY_ENCHANTED;
        case 42: return SPELL_FAILED_ITEM_GONE;
        case 43: return SPELL_FAILED_ITEM_NOT_FOUND;
        case 44: return SPELL_FAILED_ITEM_NOT_READY;
        case 45: return SPELL_FAILED_LEVEL_REQUIREMENT;
        case 46: return SPELL_FAILED_LINE_OF_SIGHT;
        case 47: return SPELL_FAILED_LOWLEVEL;
        case 48: return SPELL_FAILED_LOW_CASTLEVEL;
        case 49: return SPELL_FAILED_MAINHAND_EMPTY;
        case 50: return SPELL_FAILED_MOVING;
        case 51: return SPELL_FAILED_NEED_AMMO;
        case 52: return SPELL_FAILED_NEED_AMMO_POUCH;
        case 53: return SPELL_FAILED_NEED_EXOTIC_AMMO;
        case 54: return SPELL_FAILED_NEED_MORE_ITEMS;
        case 55: return SPELL_FAILED_NOPATH;
        case 56: return SPELL_FAILED_NOT_BEHIND;
        case 57: return SPELL_FAILED_NOT_FISHABLE;
        case 58: return SPELL_FAILED_NOT_FLYING;
        case 59: return SPELL_FAILED_NOT_HERE;
        case 60: return SPELL_FAILED_NOT_INFRONT;
        case 61: return SPELL_FAILED_NOT_IN_CONTROL;
        case 62: return SPELL_FAILED_NOT_KNOWN;
        case 63: return SPELL_FAILED_NOT_MOUNTED;
        case 64: return SPELL_FAILED_NOT_ON_TAXI;
        case 65: return SPELL_FAILED_NOT_ON_TRANSPORT;
        case 66: return SPELL_FAILED_NOT_READY;
        case 67: return SPELL_FAILED_NOT_SHAPESHIFT;
        case 68: return SPELL_FAILED_NOT_STANDING;
        case 69: return SPELL_FAILED_NOT_TRADEABLE;
        case 70: return SPELL_FAILED_NOT_TRADING;
        case 71: return SPELL_FAILED_NOT_UNSHEATHED;
        case 72: return SPELL_FAILED_NOT_WHILE_GHOST;
        case 73: return SPELL_FAILED_NOT_WHILE_LOOTING;
        case 74: return SPELL_FAILED_NO_AMMO;
        case 75: return SPELL_FAILED_NO_CHARGES_REMAIN;
        case 76: return SPELL_FAILED_NO_CHAMPION;
        case 77: return SPELL_FAILED_NO_COMBO_POINTS;
        case 78: return SPELL_FAILED_NO_DUELING;
        case 79: return SPELL_FAILED_NO_ENDURANCE;
        case 80: return SPELL_FAILED_NO_FISH;
        case 81: return SPELL_FAILED_NO_ITEMS_WHILE_SHAPESHIFTED;
        case 82: return SPELL_FAILED_NO_MOUNTS_ALLOWED;
        case 83: return SPELL_FAILED_NO_PET;
        case 84: return SPELL_FAILED_NO_POWER;
        case 85: return SPELL_FAILED_NOTHING_TO_DISPEL;
        case 86: return SPELL_FAILED_NOTHING_TO_STEAL;
        case 87: return SPELL_FAILED_ONLY_ABOVEWATER;
        case 88: return SPELL_FAILED_ONLY_DAYTIME;
        case 89: return SPELL_FAILED_ONLY_INDOORS;
        case 90: return SPELL_FAILED_ONLY_MOUNTED;
        case 91: return SPELL_FAILED_ONLY_NIGHTTIME;
        case 92: return SPELL_FAILED_ONLY_OUTDOORS;
        case 93: return SPELL_FAILED_ONLY_SHAPESHIFT;
        case 94: return SPELL_FAILED_ONLY_STEALTHED;
        case 95: return SPELL_FAILED_ONLY_UNDERWATER;
        case 96: return SPELL_FAILED_OUT_OF_RANGE;
        case 97: return SPELL_FAILED_PACIFIED;
        case 98: return SPELL_FAILED_POSSESSED;
        case 99: return SPELL_FAILED_REAGENTS;
        case 100: return SPELL_FAILED_REQUIRES_AREA;
        case 101: return SPELL_FAILED_REQUIRES_SPELL_FOCUS;
        case 102: return SPELL_FAILED_ROOTED;
        case 103: return SPELL_FAILED_SILENCED;
        case 104: return SPELL_FAILED_SPELL_IN_PROGRESS;
        case 105: return SPELL_FAILED_SPELL_LEARNED;
        case 106: return SPELL_FAILED_SPELL_UNAVAILABLE;
        case 107: return SPELL_FAILED_STUNNED;
        case 108: return SPELL_FAILED_TARGETS_DEAD;
        case 109: return SPELL_FAILED_TARGET_AFFECTING_COMBAT;
        case 110: return SPELL_FAILED_TARGET_AURASTATE;
        case 111: return SPELL_FAILED_TARGET_DUELING;
        case 112: return SPELL_FAILED_TARGET_ENEMY;
        case 113: return SPELL_FAILED_TARGET_ENRAGED;
        case 114: return SPELL_FAILED_TARGET_FRIENDLY;
        case 115: return SPELL_FAILED_TARGET_IN_COMBAT;
        case 116: return SPELL_FAILED_TARGET_IS_PLAYER;
        case 117: return SPELL_FAILED_TARGET_IS_PLAYER_CONTROLLED;
        case 118: return SPELL_FAILED_TARGET_NOT_DEAD;
        case 119: return SPELL_FAILED_TARGET_NOT_IN_PARTY;
        case 120: return SPELL_FAILED_TARGET_NOT_LOOTED;
        case 121: return SPELL_FAILED_TARGET_NOT_PLAYER;
        case 122: return SPELL_FAILED_TARGET_NO_POCKETS;
        case 123: return SPELL_FAILED_TARGET_NO_WEAPONS;
        case 124: return SPELL_FAILED_TARGET_NO_RANGED_WEAPONS;
        case 125: return SPELL_FAILED_TARGET_UNSKINNABLE;
        case 126: return SPELL_FAILED_THIRST_SATIATED;
        case 127: return SPELL_FAILED_TOO_CLOSE;
        case 128: return SPELL_FAILED_TOO_MANY_OF_ITEM;
        case 129: return SPELL_FAILED_TOTEM_CATEGORY;
        case 130: return SPELL_FAILED_TOTEMS;
        case 131: return SPELL_FAILED_TRY_AGAIN;
        case 132: return SPELL_FAILED_UNIT_NOT_BEHIND;
        case 133: return SPELL_FAILED_UNIT_NOT_INFRONT;
        case 134: return SPELL_FAILED_WRONG_PET_FOOD;
        case 135: return SPELL_FAILED_NOT_WHILE_FATIGUED;
        case 136: return SPELL_FAILED_TARGET_NOT_IN_INSTANCE;
        case 137: return SPELL_FAILED_NOT_WHILE_TRADING;
        case 138: return SPELL_FAILED_TARGET_NOT_IN_RAID;
        case 139: return SPELL_FAILED_TARGET_FREEFORALL;
        case 140: return SPELL_FAILED_NO_EDIBLE_CORPSES;
        case 141: return SPELL_FAILED_ONLY_BATTLEGROUNDS;
        case 142: return SPELL_FAILED_TARGET_NOT_GHOST;
        case 143: return SPELL_FAILED_TRANSFORM_UNUSABLE;
        case 144: return SPELL_FAILED_WRONG_WEATHER;
        case 145: return SPELL_FAILED_DAMAGE_IMMUNE;
        case 146: return SPELL_FAILED_PREVENTED_BY_MECHANIC;
        case 147: return SPELL_FAILED_PLAY_TIME;
        case 148: return SPELL_FAILED_REPUTATION;
        case 149: return SPELL_FAILED_MIN_SKILL;
        case 150: return SPELL_FAILED_NOT_IN_ARENA;
        case 151: return SPELL_FAILED_NOT_ON_SHAPESHIFT;
        case 152: return SPELL_FAILED_NOT_ON_STEALTHED;
        case 153: return SPELL_FAILED_NOT_ON_DAMAGE_IMMUNE;
        case 154: return SPELL_FAILED_NOT_ON_MOUNTED;
        case 155: return SPELL_FAILED_TOO_SHALLOW;
        case 156: return SPELL_FAILED_TARGET_NOT_IN_SANCTUARY;
        case 157: return SPELL_FAILED_TARGET_IS_TRIVIAL;
        case 158: return SPELL_FAILED_BM_OR_INVISGOD;
        case 159: return SPELL_FAILED_EXPERT_RIDING_REQUIREMENT;
        case 160: return SPELL_FAILED_ARTISAN_RIDING_REQUIREMENT;
        case 161: return SPELL_FAILED_NOT_IDLE;
        case 162: return SPELL_FAILED_NOT_INACTIVE;
        case 163: return SPELL_FAILED_PARTIAL_PLAYTIME;
        case 164: return SPELL_FAILED_NO_PLAYTIME;
        case 165: return SPELL_FAILED_NOT_IN_BATTLEGROUND;
        case 166: return SPELL_FAILED_NOT_IN_RAID_INSTANCE;
        case 167: return SPELL_FAILED_ONLY_IN_ARENA;
        case 168: return SPELL_FAILED_TARGET_LOCKED_TO_RAID_INSTANCE;
        case 169: return SPELL_FAILED_ON_USE_ENCHANT;
        case 170: return SPELL_FAILED_NOT_ON_GROUND;
        case 171: return SPELL_FAILED_CUSTOM_ERROR;
        case 172: return SPELL_FAILED_CANT_DO_THAT_RIGHT_NOW;
        case 173: return SPELL_FAILED_TOO_MANY_SOCKETS;
        case 174: return SPELL_FAILED_INVALID_GLYPH;
        case 175: return SPELL_FAILED_UNIQUE_GLYPH;
        case 176: return SPELL_FAILED_GLYPH_SOCKET_LOCKED;
        case 177: return SPELL_FAILED_NO_VALID_TARGETS;
        case 178: return SPELL_FAILED_ITEM_AT_MAX_CHARGES;
        case 179: return SPELL_FAILED_NOT_IN_BARBERSHOP;
        case 180: return SPELL_FAILED_FISHING_TOO_LOW;
        case 181: return SPELL_FAILED_ITEM_ENCHANT_TRADE_WINDOW;
        case 182: return SPELL_FAILED_SUMMON_PENDING;
        case 183: return SPELL_FAILED_MAX_SOCKETS;
        case 184: return SPELL_FAILED_PET_CAN_RENAME;
        case 185: return SPELL_FAILED_TARGET_CANNOT_BE_RESURRECTED;
        case 186: return SPELL_FAILED_UNKNOWN;
        case 187: return SPELL_CAST_OK;
        default: throw std::out_of_range("index");
    }
}
...
TC_API_EXPORT size_t EnumUtils<SpellCastResult>::ToIndex(SpellCastResult value)
{
    switch (value)
    {
        case SPELL_FAILED_AFFECTING_COMBAT: return 0;
        case SPELL_FAILED_ALREADY_AT_FULL_HEALTH: return 1;
        case SPELL_FAILED_ALREADY_AT_FULL_MANA: return 2;
        case SPELL_FAILED_ALREADY_AT_FULL_POWER: return 3;
        case SPELL_FAILED_ALREADY_BEING_TAMED: return 4;
        case SPELL_FAILED_ALREADY_HAVE_CHARM: return 5;
        case SPELL_FAILED_ALREADY_HAVE_SUMMON: return 6;
        case SPELL_FAILED_ALREADY_OPEN: return 7;
        case SPELL_FAILED_AURA_BOUNCED: return 8;
        case SPELL_FAILED_AUTOTRACK_INTERRUPTED: return 9;
        case SPELL_FAILED_BAD_IMPLICIT_TARGETS: return 10;
        case SPELL_FAILED_BAD_TARGETS: return 11;
        case SPELL_FAILED_CANT_BE_CHARMED: return 12;
        case SPELL_FAILED_CANT_BE_DISENCHANTED: return 13;
        case SPELL_FAILED_CANT_BE_DISENCHANTED_SKILL: return 14;
        case SPELL_FAILED_CANT_BE_MILLED: return 15;
        case SPELL_FAILED_CANT_BE_PROSPECTED: return 16;
        case SPELL_FAILED_CANT_CAST_ON_TAPPED: return 17;
        case SPELL_FAILED_CANT_DUEL_WHILE_INVISIBLE: return 18;
        case SPELL_FAILED_CANT_DUEL_WHILE_STEALTHED: return 19;
        case SPELL_FAILED_CANT_STEALTH: return 20;
        case SPELL_FAILED_CASTER_AURASTATE: return 21;
        case SPELL_FAILED_CASTER_DEAD: return 22;
        case SPELL_FAILED_CHARMED: return 23;
        case SPELL_FAILED_CHEST_IN_USE: return 24;
        case SPELL_FAILED_CONFUSED: return 25;
        case SPELL_FAILED_DONT_REPORT: return 26;
        case SPELL_FAILED_EQUIPPED_ITEM: return 27;
        case SPELL_FAILED_EQUIPPED_ITEM_CLASS: return 28;
        case SPELL_FAILED_EQUIPPED_ITEM_CLASS_MAINHAND: return 29;
        case SPELL_FAILED_EQUIPPED_ITEM_CLASS_OFFHAND: return 30;
        case SPELL_FAILED_ERROR: return 31;
        case SPELL_FAILED_FIZZLE: return 32;
        case SPELL_FAILED_FLEEING: return 33;
        case SPELL_FAILED_FOOD_LOWLEVEL: return 34;
        case SPELL_FAILED_HIGHLEVEL: return 35;
        case SPELL_FAILED_HUNGER_SATIATED: return 36;
        case SPELL_FAILED_IMMUNE: return 37;
        case SPELL_FAILED_INCORRECT_AREA: return 38;
        case SPELL_FAILED_INTERRUPTED: return 39;
        case SPELL_FAILED_INTERRUPTED_COMBAT: return 40;
        case SPELL_FAILED_ITEM_ALREADY_ENCHANTED: return 41;
        case SPELL_FAILED_ITEM_GONE: return 42;
        case SPELL_FAILED_ITEM_NOT_FOUND: return 43;
        case SPELL_FAILED_ITEM_NOT_READY: return 44;
        case SPELL_FAILED_LEVEL_REQUIREMENT: return 45;
        case SPELL_FAILED_LINE_OF_SIGHT: return 46;
        case SPELL_FAILED_LOWLEVEL: return 47;
        case SPELL_FAILED_LOW_CASTLEVEL: return 48;
        case SPELL_FAILED_MAINHAND_EMPTY: return 49;
        case SPELL_FAILED_MOVING: return 50;
        case SPELL_FAILED_NEED_AMMO: return 51;
        case SPELL_FAILED_NEED_AMMO_POUCH: return 52;
        case SPELL_FAILED_NEED_EXOTIC_AMMO: return 53;
        case SPELL_FAILED_NEED_MORE_ITEMS: return 54;
        case SPELL_FAILED_NOPATH: return 55;
        case SPELL_FAILED_NOT_BEHIND: return 56;
        case SPELL_FAILED_NOT_FISHABLE: return 57;
        case SPELL_FAILED_NOT_FLYING: return 58;
        case SPELL_FAILED_NOT_HERE: return 59;
        case SPELL_FAILED_NOT_INFRONT: return 60;
        case SPELL_FAILED_NOT_IN_CONTROL: return 61;
        case SPELL_FAILED_NOT_KNOWN: return 62;
        case SPELL_FAILED_NOT_MOUNTED: return 63;
        case SPELL_FAILED_NOT_ON_TAXI: return 64;
        case SPELL_FAILED_NOT_ON_TRANSPORT: return 65;
        case SPELL_FAILED_NOT_READY: return 66;
        case SPELL_FAILED_NOT_SHAPESHIFT: return 67;
        case SPELL_FAILED_NOT_STANDING: return 68;
        case SPELL_FAILED_NOT_TRADEABLE: return 69;
        case SPELL_FAILED_NOT_TRADING: return 70;
        case SPELL_FAILED_NOT_UNSHEATHED: return 71;
        case SPELL_FAILED_NOT_WHILE_GHOST: return 72;
        case SPELL_FAILED_NOT_WHILE_LOOTING: return 73;
        case SPELL_FAILED_NO_AMMO: return 74;
        case SPELL_FAILED_NO_CHARGES_REMAIN: return 75;
        case SPELL_FAILED_NO_CHAMPION: return 76;
        case SPELL_FAILED_NO_COMBO_POINTS: return 77;
        case SPELL_FAILED_NO_DUELING: return 78;
        case SPELL_FAILED_NO_ENDURANCE: return 79;
        case SPELL_FAILED_NO_FISH: return 80;
        case SPELL_FAILED_NO_ITEMS_WHILE_SHAPESHIFTED: return 81;
        case SPELL_FAILED_NO_MOUNTS_ALLOWED: return 82;
        case SPELL_FAILED_NO_PET: return 83;
        case SPELL_FAILED_NO_POWER: return 84;
        case SPELL_FAILED_NOTHING_TO_DISPEL: return 85;
        case SPELL_FAILED_NOTHING_TO_STEAL: return 86;
        case SPELL_FAILED_ONLY_ABOVEWATER: return 87;
        case SPELL_FAILED_ONLY_DAYTIME: return 88;
        case SPELL_FAILED_ONLY_INDOORS: return 89;
        case SPELL_FAILED_ONLY_MOUNTED: return 90;
        case SPELL_FAILED_ONLY_NIGHTTIME: return 91;
        case SPELL_FAILED_ONLY_OUTDOORS: return 92;
        case SPELL_FAILED_ONLY_SHAPESHIFT: return 93;
        case SPELL_FAILED_ONLY_STEALTHED: return 94;
        case SPELL_FAILED_ONLY_UNDERWATER: return 95;
        case SPELL_FAILED_OUT_OF_RANGE: return 96;
        case SPELL_FAILED_PACIFIED: return 97;
        case SPELL_FAILED_POSSESSED: return 98;
        case SPELL_FAILED_REAGENTS: return 99;
        case SPELL_FAILED_REQUIRES_AREA: return 100;
        case SPELL_FAILED_REQUIRES_SPELL_FOCUS: return 101;
        case SPELL_FAILED_ROOTED: return 102;
        case SPELL_FAILED_SILENCED: return 103;
        case SPELL_FAILED_SPELL_IN_PROGRESS: return 104;
        case SPELL_FAILED_SPELL_LEARNED: return 105;
        case SPELL_FAILED_SPELL_UNAVAILABLE: return 106;
        case SPELL_FAILED_STUNNED: return 107;
        case SPELL_FAILED_TARGETS_DEAD: return 108;
        case SPELL_FAILED_TARGET_AFFECTING_COMBAT: return 109;
        case SPELL_FAILED_TARGET_AURASTATE: return 110;
        case SPELL_FAILED_TARGET_DUELING: return 111;
        case SPELL_FAILED_TARGET_ENEMY: return 112;
        case SPELL_FAILED_TARGET_ENRAGED: return 113;
        case SPELL_FAILED_TARGET_FRIENDLY: return 114;
        case SPELL_FAILED_TARGET_IN_COMBAT: return 115;
        case SPELL_FAILED_TARGET_IS_PLAYER: return 116;
        case SPELL_FAILED_TARGET_IS_PLAYER_CONTROLLED: return 117;
        case SPELL_FAILED_TARGET_NOT_DEAD: return 118;
        case SPELL_FAILED_TARGET_NOT_IN_PARTY: return 119;
        case SPELL_FAILED_TARGET_NOT_LOOTED: return 120;
        case SPELL_FAILED_TARGET_NOT_PLAYER: return 121;
        case SPELL_FAILED_TARGET_NO_POCKETS: return 122;
        case SPELL_FAILED_TARGET_NO_WEAPONS: return 123;
        case SPELL_FAILED_TARGET_NO_RANGED_WEAPONS: return 124;
        case SPELL_FAILED_TARGET_UNSKINNABLE: return 125;
        case SPELL_FAILED_THIRST_SATIATED: return 126;
        case SPELL_FAILED_TOO_CLOSE: return 127;
        case SPELL_FAILED_TOO_MANY_OF_ITEM: return 128;
        case SPELL_FAILED_TOTEM_CATEGORY: return 129;
        case SPELL_FAILED_TOTEMS: return 130;
        case SPELL_FAILED_TRY_AGAIN: return 131;
        case SPELL_FAILED_UNIT_NOT_BEHIND: return 132;
        case SPELL_FAILED_UNIT_NOT_INFRONT: return 133;
        case SPELL_FAILED_WRONG_PET_FOOD: return 134;
        case SPELL_FAILED_NOT_WHILE_FATIGUED: return 135;
        case SPELL_FAILED_TARGET_NOT_IN_INSTANCE: return 136;
        case SPELL_FAILED_NOT_WHILE_TRADING: return 137;
        case SPELL_FAILED_TARGET_NOT_IN_RAID: return 138;
        case SPELL_FAILED_TARGET_FREEFORALL: return 139;
        case SPELL_FAILED_NO_EDIBLE_CORPSES: return 140;
        case SPELL_FAILED_ONLY_BATTLEGROUNDS: return 141;
        case SPELL_FAILED_TARGET_NOT_GHOST: return 142;
        case SPELL_FAILED_TRANSFORM_UNUSABLE: return 143;
        case SPELL_FAILED_WRONG_WEATHER: return 144;
        case SPELL_FAILED_DAMAGE_IMMUNE: return 145;
        case SPELL_FAILED_PREVENTED_BY_MECHANIC: return 146;
        case SPELL_FAILED_PLAY_TIME: return 147;
        case SPELL_FAILED_REPUTATION: return 148;
        case SPELL_FAILED_MIN_SKILL: return 149;
        case SPELL_FAILED_NOT_IN_ARENA: return 150;
        case SPELL_FAILED_NOT_ON_SHAPESHIFT: return 151;
        case SPELL_FAILED_NOT_ON_STEALTHED: return 152;
        case SPELL_FAILED_NOT_ON_DAMAGE_IMMUNE: return 153;
        case SPELL_FAILED_NOT_ON_MOUNTED: return 154;
        case SPELL_FAILED_TOO_SHALLOW: return 155;
        case SPELL_FAILED_TARGET_NOT_IN_SANCTUARY: return 156;
        case SPELL_FAILED_TARGET_IS_TRIVIAL: return 157;
        case SPELL_FAILED_BM_OR_INVISGOD: return 158;
        case SPELL_FAILED_EXPERT_RIDING_REQUIREMENT: return 159;
        case SPELL_FAILED_ARTISAN_RIDING_REQUIREMENT: return 160;
        case SPELL_FAILED_NOT_IDLE: return 161;
        case SPELL_FAILED_NOT_INACTIVE: return 162;
        case SPELL_FAILED_PARTIAL_PLAYTIME: return 163;
        case SPELL_FAILED_NO_PLAYTIME: return 164;
        case SPELL_FAILED_NOT_IN_BATTLEGROUND: return 165;
        case SPELL_FAILED_NOT_IN_RAID_INSTANCE: return 166;
        case SPELL_FAILED_ONLY_IN_ARENA: return 167;
        case SPELL_FAILED_TARGET_LOCKED_TO_RAID_INSTANCE: return 168;
        case SPELL_FAILED_ON_USE_ENCHANT: return 169;
        case SPELL_FAILED_NOT_ON_GROUND: return 170;
        case SPELL_FAILED_CUSTOM_ERROR: return 171;
        case SPELL_FAILED_CANT_DO_THAT_RIGHT_NOW: return 172;
        case SPELL_FAILED_TOO_MANY_SOCKETS: return 173;
        case SPELL_FAILED_INVALID_GLYPH: return 174;
        case SPELL_FAILED_UNIQUE_GLYPH: return 175;
        case SPELL_FAILED_GLYPH_SOCKET_LOCKED: return 176;
        case SPELL_FAILED_NO_VALID_TARGETS: return 177;
        case SPELL_FAILED_ITEM_AT_MAX_CHARGES: return 178;
        case SPELL_FAILED_NOT_IN_BARBERSHOP: return 179;
        case SPELL_FAILED_FISHING_TOO_LOW: return 180;
        case SPELL_FAILED_ITEM_ENCHANT_TRADE_WINDOW: return 181;
        case SPELL_FAILED_SUMMON_PENDING: return 182;
        case SPELL_FAILED_MAX_SOCKETS: return 183;
        case SPELL_FAILED_PET_CAN_RENAME: return 184;
        case SPELL_FAILED_TARGET_CANNOT_BE_RESURRECTED: return 185;
        case SPELL_FAILED_UNKNOWN: return 186;
        case SPELL_CAST_OK: return 187;
        default: throw std::out_of_range("value");
    }
}
