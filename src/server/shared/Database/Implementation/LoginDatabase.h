...
enum LoginDatabaseStatements
{
    ...
    */
    ...
    LOGIN_DEL_OLD_LOGS,
    LOGIN_DEL_RBAC_PERMISSION_LEVEL,
    LOGIN_DEL_RBAC_PERMISSION_LEVEL_BY_REALM,
    LOGIN_INS_RBAC_PERMISSION_LEVEL,
    LOGIN_GET_ACCOUNT_ID_BY_USERNAME,
    LOGIN_GET_RBAC_PERMISSION_LEVEL,
    LOGIN_GET_RBAC_PERMISSION_LEVEL_BY_REALMID,
    LOGIN_GET_USERNAME_BY_ID,
    LOGIN_SEL_CHECK_PASSWORD,
    LOGIN_SEL_CHECK_PASSWORD_BY_NAME,
    LOGIN_SEL_PINFO,
    LOGIN_SEL_PINFO_BANS,
    LOGIN_SEL_RBAC_PERMISSION_LEVEL_ACCOUNTS,
    LOGIN_SEL_ACCOUNT_INFO,
    LOGIN_SEL_RBAC_PERMISSION_LEVEL_TEST,
    LOGIN_SEL_RBAC_PERMISSION_LEVEL,
    ...
    LOGIN_SEL_RBAC_PERMISSION_LEVEL_BY_ID,
