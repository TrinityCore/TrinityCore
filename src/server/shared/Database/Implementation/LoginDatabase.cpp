...
void LoginDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(LOGIN_SEL_REALM_ENABLED_CLASSES_RACES, "SELECT class, race FROM realm_races_classes_access WHERE realmId = ? AND race = ? and class = ?", CONNECTION_SYNCH);
