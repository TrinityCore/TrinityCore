...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_SEL_GUILD_MEMBER, "SELECT g.guildid, rank,NAME,rname,pnote,offnote FROM guild g JOIN guild_member gm ON g.guildid=gm.guildid JOIN guild_rank gr ON g.guildid=gr.guildid WHERE gm.guid = ?", CONNECTION_BOTH);
