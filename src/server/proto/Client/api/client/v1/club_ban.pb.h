...
#define PROTOBUF_api_2fclient_2fv1_2fclub_5fban_2eproto__INCLUDED
...
class TC_PROTO_API AddBanOptions : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:bgs.protocol.club.v1.client.AddBanOptions)
 private:
...
class TC_PROTO_API ClubBan : public ::google::protobuf::Message {
 public:
  ...
  // optional .bgs.protocol.club.v1.client.MemberDescription creator = 3;
  ...
  // @@protoc_insertion_point(class_scope:bgs.protocol.club.v1.client.ClubBan)
 private:
...
inline const ::bgs::protocol::club::v1::MemberId& AddBanOptions::target_id() const {
  // @@protoc_insertion_point(field_get:bgs.protocol.club.v1.client.AddBanOptions.target_id)
...
inline ::bgs::protocol::club::v1::MemberId* AddBanOptions::mutable_target_id() {
  ...
  // @@protoc_insertion_point(field_mutable:bgs.protocol.club.v1.client.AddBanOptions.target_id)
  return target_id_;
}
...
inline void AddBanOptions::set_allocated_target_id(::bgs::protocol::club::v1::MemberId* target_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:bgs.protocol.club.v1.client.AddBanOptions.target_id)
}
...
inline const ::bgs::protocol::v2::Attribute& AddBanOptions::attribute(int index) const {
  // @@protoc_insertion_point(field_get:bgs.protocol.club.v1.client.AddBanOptions.attribute)
  return attribute_.Get(index);
}
inline ::bgs::protocol::v2::Attribute* AddBanOptions::mutable_attribute(int index) {
  // @@protoc_insertion_point(field_mutable:bgs.protocol.club.v1.client.AddBanOptions.attribute)
  return attribute_.Mutable(index);
}
inline ::bgs::protocol::v2::Attribute* AddBanOptions::add_attribute() {
  // @@protoc_insertion_point(field_add:bgs.protocol.club.v1.client.AddBanOptions.attribute)
  return attribute_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::bgs::protocol::v2::Attribute >&
AddBanOptions::attribute() const {
  // @@protoc_insertion_point(field_list:bgs.protocol.club.v1.client.AddBanOptions.attribute)
  return attribute_;
}
inline ::google::protobuf::RepeatedPtrField< ::bgs::protocol::v2::Attribute >*
AddBanOptions::mutable_attribute() {
  // @@protoc_insertion_point(field_mutable_list:bgs.protocol.club.v1.client.AddBanOptions.attribute)
  return &attribute_;
}
...
inline const ::std::string& AddBanOptions::reason() const {
  // @@protoc_insertion_point(field_get:bgs.protocol.club.v1.client.AddBanOptions.reason)
  return *reason_;
}
inline void AddBanOptions::set_reason(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:bgs.protocol.club.v1.client.AddBanOptions.reason)
}
inline void AddBanOptions::set_reason(const char* value) {
  ...
  reason_->assign(value);
  // @@protoc_insertion_point(field_set_char:bgs.protocol.club.v1.client.AddBanOptions.reason)
}
inline void AddBanOptions::set_reason(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:bgs.protocol.club.v1.client.AddBanOptions.reason)
}
inline ::std::string* AddBanOptions::mutable_reason() {
  ...
  // @@protoc_insertion_point(field_mutable:bgs.protocol.club.v1.client.AddBanOptions.reason)
  return reason_;
}
...
inline void AddBanOptions::set_allocated_reason(::std::string* reason) {
  ...
  // @@protoc_insertion_point(field_set_allocated:bgs.protocol.club.v1.client.AddBanOptions.reason)
}
...
inline const ::bgs::protocol::club::v1::MemberId& ClubBan::id() const {
  // @@protoc_insertion_point(field_get:bgs.protocol.club.v1.client.ClubBan.id)
  return id_ != NULL ? *id_ : *default_instance_->id_;
}
inline ::bgs::protocol::club::v1::MemberId* ClubBan::mutable_id() {
  set_has_id();
  if (id_ == NULL) id_ = new ::bgs::protocol::club::v1::MemberId;
  // @@protoc_insertion_point(field_mutable:bgs.protocol.club.v1.client.ClubBan.id)
  return id_;
}
...
inline void ClubBan::set_allocated_id(::bgs::protocol::club::v1::MemberId* id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:bgs.protocol.club.v1.client.ClubBan.id)
}
...
inline const ::std::string& ClubBan::battle_tag() const {
  // @@protoc_insertion_point(field_get:bgs.protocol.club.v1.client.ClubBan.battle_tag)
  return *battle_tag_;
}
inline void ClubBan::set_battle_tag(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:bgs.protocol.club.v1.client.ClubBan.battle_tag)
}
inline void ClubBan::set_battle_tag(const char* value) {
  ...
  battle_tag_->assign(value);
  // @@protoc_insertion_point(field_set_char:bgs.protocol.club.v1.client.ClubBan.battle_tag)
}
inline void ClubBan::set_battle_tag(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:bgs.protocol.club.v1.client.ClubBan.battle_tag)
}
inline ::std::string* ClubBan::mutable_battle_tag() {
  ...
  // @@protoc_insertion_point(field_mutable:bgs.protocol.club.v1.client.ClubBan.battle_tag)
  return battle_tag_;
}
...
inline void ClubBan::set_allocated_battle_tag(::std::string* battle_tag) {
  ...
  // @@protoc_insertion_point(field_set_allocated:bgs.protocol.club.v1.client.ClubBan.battle_tag)
}
...
inline const ::bgs::protocol::club::v1::client::MemberDescription& ClubBan::creator() const {
  // @@protoc_insertion_point(field_get:bgs.protocol.club.v1.client.ClubBan.creator)
  return creator_ != NULL ? *creator_ : *default_instance_->creator_;
}
inline ::bgs::protocol::club::v1::client::MemberDescription* ClubBan::mutable_creator() {
  set_has_creator();
  if (creator_ == NULL) creator_ = new ::bgs::protocol::club::v1::client::MemberDescription;
  // @@protoc_insertion_point(field_mutable:bgs.protocol.club.v1.client.ClubBan.creator)
  return creator_;
}
inline ::bgs::protocol::club::v1::client::MemberDescription* ClubBan::release_creator() {
  clear_has_creator();
  ::bgs::protocol::club::v1::client::MemberDescription* temp = creator_;
  creator_ = NULL;
  return temp;
}
inline void ClubBan::set_allocated_creator(::bgs::protocol::club::v1::client::MemberDescription* creator) {
  delete creator_;
  creator_ = creator;
  if (creator) {
    set_has_creator();
  ...
  // @@protoc_insertion_point(field_set_allocated:bgs.protocol.club.v1.client.ClubBan.creator)
}
...
inline const ::bgs::protocol::v2::Attribute& ClubBan::attribute(int index) const {
  // @@protoc_insertion_point(field_get:bgs.protocol.club.v1.client.ClubBan.attribute)
  return attribute_.Get(index);
}
inline ::bgs::protocol::v2::Attribute* ClubBan::mutable_attribute(int index) {
  // @@protoc_insertion_point(field_mutable:bgs.protocol.club.v1.client.ClubBan.attribute)
  return attribute_.Mutable(index);
}
inline ::bgs::protocol::v2::Attribute* ClubBan::add_attribute() {
  // @@protoc_insertion_point(field_add:bgs.protocol.club.v1.client.ClubBan.attribute)
  return attribute_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::bgs::protocol::v2::Attribute >&
ClubBan::attribute() const {
  // @@protoc_insertion_point(field_list:bgs.protocol.club.v1.client.ClubBan.attribute)
  return attribute_;
}
inline ::google::protobuf::RepeatedPtrField< ::bgs::protocol::v2::Attribute >*
ClubBan::mutable_attribute() {
  // @@protoc_insertion_point(field_mutable_list:bgs.protocol.club.v1.client.ClubBan.attribute)
  return &attribute_;
}
...
inline const ::std::string& ClubBan::reason() const {
  // @@protoc_insertion_point(field_get:bgs.protocol.club.v1.client.ClubBan.reason)
  return *reason_;
}
inline void ClubBan::set_reason(const ::std::string& value) {
  ...
  reason_->assign(value);
  // @@protoc_insertion_point(field_set:bgs.protocol.club.v1.client.ClubBan.reason)
}
inline void ClubBan::set_reason(const char* value) {
  ...
  reason_->assign(value);
  // @@protoc_insertion_point(field_set_char:bgs.protocol.club.v1.client.ClubBan.reason)
}
inline void ClubBan::set_reason(const char* value, size_t size) {
  ...
  reason_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:bgs.protocol.club.v1.client.ClubBan.reason)
}
inline ::std::string* ClubBan::mutable_reason() {
  ...
  // @@protoc_insertion_point(field_mutable:bgs.protocol.club.v1.client.ClubBan.reason)
  return reason_;
}
...
inline void ClubBan::set_allocated_reason(::std::string* reason) {
  ...
  // @@protoc_insertion_point(field_set_allocated:bgs.protocol.club.v1.client.ClubBan.reason)
}
...
inline ::google::protobuf::uint64 ClubBan::creation_time() const {
  // @@protoc_insertion_point(field_get:bgs.protocol.club.v1.client.ClubBan.creation_time)
  return creation_time_;
}
inline void ClubBan::set_creation_time(::google::protobuf::uint64 value) {
  set_has_creation_time();
  creation_time_ = value;
  // @@protoc_insertion_point(field_set:bgs.protocol.club.v1.client.ClubBan.creation_time)
}
