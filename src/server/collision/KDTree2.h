            ...
            void intersectRay(
                ...
                bool intersectCallbackIsFast) const {
                    ...
                    if ((firstChild != NONE) && child[firstChild]) {
                        child[firstChild]->intersectRay(ray, intersectCallback, distance, stopAtFirstHit, intersectCallbackIsFast);
                    }
                    ...
                    if ((secondChild != NONE) && child[secondChild]) {
                        child[secondChild]->intersectRay(ray, intersectCallback, distance, stopAtFirstHit, intersectCallbackIsFast);
                    }
...
#           endif
    ...
    public:
        ...
        KDTree2(const KDTree2& src) : root(NULL) {
            *this = src;
        }


        KDTree2& operator=(const KDTree2& src) {
            delete root;
        ...
        */
        ...
        void intersectRay(
            ...
            bool intersectCallbackIsFast = false
                ...
                root->intersectRay(ray, intersectCallback, distance, stopAtFirstHit, intersectCallbackIsFast);
        }
