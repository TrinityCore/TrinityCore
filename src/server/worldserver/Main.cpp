...
extern int main(int argc, char** argv)
{
	...
	TC_LOG_INFO("server.worldserver", " ");
	TC_LOG_INFO("server.worldserver", "  SSSSs   Ss                SSs            SSSSSs");
	TC_LOG_INFO("server.worldserver", " Ss   Ss                     Ss           Ss    Ss");
	TC_LOG_INFO("server.worldserver", "Ss     S  Ss Ss           SS Ss  SSSSS   Ss         SSSSs   Ss SSs   SSSSSs");
	TC_LOG_INFO("server.worldserver", " Ss      SSs Sssss    SSSSSs Ss Ss    Ss Ss        Ss   Ss  SSSs Ss Ss    Ss");
	TC_LOG_INFO("server.worldserver", "  SSSSs   Ss Ss  Ss  Ss   Ss Ss Ss    Ss Ss       Ss     Ss Ss      Ss    Ss");
	TC_LOG_INFO("server.worldserver", "      Ss  Ss Ss   Ss Ss   Ss Ss SSSSSS   Ss       Ss     Ss Ss      SSSSSSs");
	TC_LOG_INFO("server.worldserver", " S     Ss Ss Ss   Ss Ss   Ss Ss Ss       Ss       Ss     Ss Ss      Ss");
	TC_LOG_INFO("server.worldserver", " Ss   Ss  Ss Ss   Ss  SSSSSs Ss Ss     s  Ss    S  Ss   Ss  Ss      Ss");
	TC_LOG_INFO("server.worldserver", "  SSSSs   Ss Ss   Ss      Ss Ss  SSSSSs    SSSSS    SSSSs   Ss       SSSSSSs");
	TC_LOG_INFO("server.worldserver", "                          Ss");
	TC_LOG_INFO("server.worldserver", "                      SSSSs");
	TC_LOG_INFO("server.worldserver", " ");
	TC_LOG_INFO("server.worldserver", "https://github.com/conan513/SingleCore_TC ");
