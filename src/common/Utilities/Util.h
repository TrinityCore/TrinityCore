...
template <typename C> std::string ByteArrayToHexStr(C const& container, bool reverse = false) { return ByteArrayToHexStr(std::data(container), std::size(container), reverse); }
