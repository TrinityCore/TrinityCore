...
struct CinematicCameraLoadInfo
{
    static DB2FileLoadInfo const* Instance()
    {
        ...
        static DB2Meta meta(1294214, -1, 4, 4, 0x20C5E540, fields, -1);
...
struct GameobjectDisplayInfoLoadInfo
{
    static DB2FileLoadInfo const* Instance()
    {
        ...
        static DB2Meta meta(1266277, -1, 5, 5, 0x7A816799, fields, -1);
        static DB2FileLoadInfo const loadInfo(&loadedFields[0], std::extent<decltype(loadedFields)>::value, &meta);
        return &loadInfo;
    }
};
...
struct LiquidMaterialLoadInfo
{
    static DB2FileLoadInfo const* Instance()
    {
        ...
        static DB2Meta meta(1132538, -1, 2, 2, 0x6A7287A2, fields, -1);
        static DB2FileLoadInfo const loadInfo(&loadedFields[0], std::extent<decltype(loadedFields)>::value, &meta);
        return &loadInfo;
    }
};
...
struct LiquidObjectLoadInfo
{
    static DB2FileLoadInfo const* Instance()
    {
        ...
        static DB2Meta meta(1308058, -1, 5, 5, 0x7AF380AA, fields, -1);
        static DB2FileLoadInfo const loadInfo(&loadedFields[0], std::extent<decltype(loadedFields)>::value, &meta);
        return &loadInfo;
    }
};
...
struct LiquidTypeLoadInfo
{
    static DB2FileLoadInfo const* Instance()
    {
        ...
        static DB2Meta meta(1371380, -1, 21, 21, 0x29F8C65E, fields, -1);
        static DB2FileLoadInfo const loadInfo(&loadedFields[0], std::extent<decltype(loadedFields)>::value, &meta);
        return &loadInfo;
    }
};
...
struct MapLoadInfo
{
    static DB2FileLoadInfo const* Instance()
    {
        ...
        static DB2Meta meta(1349477, -1, 23, 23, 0xB290D217, fields, -1);
        static DB2FileLoadInfo const loadInfo(&loadedFields[0], std::extent<decltype(loadedFields)>::value, &meta);
        return &loadInfo;
    }
};
