...
namespace Connection_Patcher
{
    namespace Patches
    {
        struct Common
        {
            ...
            static std::vector<unsigned char> RSAModulus()
            {
                return
                {
			...
			static std::vector<unsigned char> CryptoEd25519PublicKey()
			{
				return
				{
			...
			static std::vector<unsigned char> Debug() { return { 'p', 'a', 't', 'c', 'h', 'e', 'd' }; }
        };
    }
}
