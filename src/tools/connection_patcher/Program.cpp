...
#include <src/tools/connection_patcher/Helper.hpp>
#include <src/tools/connection_patcher/Patcher.hpp>
#include <src/tools/connection_patcher/Patches/Mac.hpp>
#include <src/tools/connection_patcher/Patches/Windows.hpp>
