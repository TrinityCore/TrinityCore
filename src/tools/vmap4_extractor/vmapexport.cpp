...
bool fillArchiveNameVector(std::vector<std::string>& pArchiveNames)
{
    ...
    //pArchiveNames.push_back(input_path + string("wow-update-13914.MPQ"));
    //pArchiveNames.push_back(input_path + string("wow-update-14007.MPQ"));
    //pArchiveNames.push_back(input_path + string("wow-update-14333.MPQ"));
    //pArchiveNames.push_back(input_path + string("wow-update-14480.MPQ"));
    //pArchiveNames.push_back(input_path + string("wow-update-14545.MPQ"));
