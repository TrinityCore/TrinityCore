...
bool GossipHello_npc_highlord_demitrian(Player* pPlayer, Creature *_Creature)
{
...
bool GossipHello_npcs_rutgar_and_frankal(Player* pPlayer, Creature *_Creature)
{
    if (_Creature->isQuestGiver())
        pPlayer->PrepareQuestMenu(_Creature->GetGUID());
