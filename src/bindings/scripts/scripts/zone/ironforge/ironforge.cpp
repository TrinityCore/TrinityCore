...
bool GossipHello_npc_royal_historian_archesonus(Player* pPlayer, Creature *_Creature)
{
    ...
    if (pPlayer->GetQuestStatus(3702) == QUEST_STATUS_INCOMPLETE)
    {
        ...
        pPlayer->SEND_GOSSIP_MENU(2235, _Creature->GetGUID());
    }
    else
