...
if (ZMQ_INCLUDE_DIR AND ZMQ_LIBRARY AND NOT ZMQ_LIBRARY-NOTFOUND)
  ...
  message(STATUS "Found ZMQ headers: ${ZMQ_INCLUDE_DIR}")
    ...
    if (MSVC)
      set(ZMQ_FOUND 1)
      set(ZMQ_ROOT_DIR ${CMAKE_SOURCE_DIR}/dep/zmq)
      set(ZMQ_INCLUDE_DIR ${ZMQ_ROOT_DIR}/include)
	
      if (PLATFORM EQUAL 64)
        set(ZMQ_ROOT_DIR ${ZMQ_ROOT_DIR}/lib/x64)
        set(ZMQ_LIBRARY ${ZMQ_ROOT_DIR}/libzmq_64.lib)
        set(ZMQ_LIBRARY_DLL ${ZMQ_ROOT_DIR}/libzmq_64.dll)
      else()
        set(ZMQ_ROOT_DIR ${ZMQ_ROOT_DIR}/lib/x86)
        set(ZMQ_LIBRARY_DLL ${ZMQ_ROOT_DIR}/libzmq.dll)
      endif()
