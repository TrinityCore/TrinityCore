...
if("${SCRIPTS}" MATCHES "dynamic")
  message(FATAL_ERROR "Packaging doesn't support dynamic scripts.")
  return()
endif()
...
set(rev_database_version "${rev_version_major}${rev_version_minor}${rev_version_patch}")
set(FULL_DATABASE_URL "https://github.com/TrinityCore/TrinityCore/releases/download/TDB335.${rev_database_version}/TDB_full_world_335.${rev_database_version}_${rev_database_date}.7z")
message("* Package database URL   : ${FULL_DATABASE_URL}")
